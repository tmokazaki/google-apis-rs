...
impl<C> common::Hub for WorkflowExecutions<C> {}

impl<'a, C> WorkflowExecutions<C> {
    pub fn new<A: 'static + common::GetToken>(
        client: common::Client<C>,
        auth: A,
    ) -> WorkflowExecutions<C> {
        WorkflowExecutions {
            client,
            auth: Box::new(auth),
...
impl common::Part for Exception {}
...
impl common::RequestValue for Execution {}
impl common::ResponseResult for Execution {}
...
impl common::ResponseResult for ExportDataResponse {}
...
impl common::ResponseResult for ListCallbacksResponse {}
...
impl common::ResponseResult for ListExecutionsResponse {}
...
impl common::ResponseResult for ListStepEntriesResponse {}
...
impl common::Part for NavigationInfo {}
...
impl common::Part for StackTrace {}
...
impl common::Part for StackTraceElement {}
...
impl common::Part for StateError {}
...
impl common::Part for StepEntryMetadata {}
...
impl<'a, C> ProjectMethods<'a, C> {
    ...
    pub fn locations_workflows_executions_callbacks_list(
        &self,
        parent: &str,
    ) -> ProjectLocationWorkflowExecutionCallbackListCall<'a, C> {
    ...
    pub fn locations_workflows_executions_step_entries_get(
        &self,
        name: &str,
    ...
    pub fn locations_workflows_executions_export_data(
        &self,
        name: &str,
    ) -> ProjectLocationWorkflowExecutionExportDataCall<'a, C> {
    ...
    pub fn locations_workflows_trigger_pubsub_execution(
        &self,
        request: TriggerPubsubExecutionRequest,
        workflow: &str,
    ) -> ProjectLocationWorkflowTriggerPubsubExecutionCall<'a, C> {
...
/// Returns a list of active callbacks that belong to the execution with the given name. The returned callbacks are ordered by callback ID.
///
/// A builder for the *locations.workflows.executions.callbacks.list* method supported by a *project* resource.
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().locations_workflows_executions_callbacks_list("parent")
///              .page_token("voluptua.")
///              .page_size(-27)
///              .doit().await;
/// # }
/// ```
pub struct ProjectLocationWorkflowExecutionCallbackListCall<'a, C>
where
    C: 'a,
{
    hub: &'a WorkflowExecutions<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationWorkflowExecutionCallbackListCall<'a, C> {}

impl<'a, C> ProjectLocationWorkflowExecutionCallbackListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, ListCallbacksResponse)> {
        use std::borrow::Cow;
        ...
        let mut url = self.hub._base_url.clone() + "v1/{+parent}/callbacks";
    ...
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationWorkflowExecutionCallbackListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Gets a step entry.
///
/// A builder for the *locations.workflows.executions.stepEntries.get* method supported by a *project* resource.
/// It is not used directly, but through a [`ProjectMethods`] instance.
///
/// # Example
///
...
/// # }
/// ```
pub struct ProjectLocationWorkflowExecutionStepEntryGetCall<'a, C>
where
    C: 'a,
{
    hub: &'a WorkflowExecutions<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationWorkflowExecutionStepEntryGetCall<'a, C> {}

impl<'a, C> ProjectLocationWorkflowExecutionStepEntryGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, StepEntry)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationWorkflowExecutionStepEntryGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Lists step entries for the corresponding workflow execution. Returned entries are ordered by their create_time.
///
/// A builder for the *locations.workflows.executions.stepEntries.list* method supported by a *project* resource.
/// It is not used directly, but through a [`ProjectMethods`] instance.
///
/// # Example
///
...
/// # }
/// ```
pub struct ProjectLocationWorkflowExecutionStepEntryListCall<'a, C>
where
    C: 'a,
{
    hub: &'a WorkflowExecutions<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationWorkflowExecutionStepEntryListCall<'a, C> {}

impl<'a, C> ProjectLocationWorkflowExecutionStepEntryListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, ListStepEntriesResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
        ...
        params.push("alt", "json");
        let mut url = self.hub._base_url.clone() + "v1/{+parent}/stepEntries";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string());
        }
    ...
    ///
    /// Sets the *skip* query property to the given value.
    pub fn skip(
        mut self,
        new_value: i32,
    ) -> ProjectLocationWorkflowExecutionStepEntryListCall<'a, C> {
        self._skip = Some(new_value);
        self
    }
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationWorkflowExecutionStepEntryListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Cancels an execution of the given name.
///
/// A builder for the *locations.workflows.executions.cancel* method supported by a *project* resource.
/// It is not used directly, but through a [`ProjectMethods`] instance.
///
/// # Example
///
...
impl<'a, C> common::CallBuilder for ProjectLocationWorkflowExecutionCancelCall<'a, C> {}

impl<'a, C> ProjectLocationWorkflowExecutionCancelCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, Execution)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    pub fn request(
        mut self,
        new_value: CancelExecutionRequest,
    ) -> ProjectLocationWorkflowExecutionCancelCall<'a, C> {
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationWorkflowExecutionCancelCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationWorkflowExecutionCancelCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Creates a new execution using the latest revision of the given workflow. For more information, see Execute a workflow.
///
/// A builder for the *locations.workflows.executions.create* method supported by a *project* resource.
/// It is not used directly, but through a [`ProjectMethods`] instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_workflowexecutions1 as workflowexecutions1;
/// use workflowexecutions1::api::Execution;
/// # async fn dox() {
/// # use workflowexecutions1::{WorkflowExecutions, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().locations_workflows_executions_create(req, "parent")
///              .doit().await;
/// # }
/// ```
...
impl<'a, C> common::CallBuilder for ProjectLocationWorkflowExecutionCreateCall<'a, C> {}

impl<'a, C> ProjectLocationWorkflowExecutionCreateCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationWorkflowExecutionCreateCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationWorkflowExecutionCreateCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().locations_workflows_executions_export_data("name")
///              .doit().await;
/// # }
/// ```
pub struct ProjectLocationWorkflowExecutionExportDataCall<'a, C>
where
    C: 'a,
{
    hub: &'a WorkflowExecutions<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationWorkflowExecutionExportDataCall<'a, C> {}

impl<'a, C> ProjectLocationWorkflowExecutionExportDataCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, ExportDataResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
        ...
        params.push("alt", "json");
        let mut url = self.hub._base_url.clone() + "v1/{+name}:exportData";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string());
        }
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationWorkflowExecutionExportDataCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Returns an execution of the given name.
///
/// A builder for the *locations.workflows.executions.get* method supported by a *project* resource.
/// It is not used directly, but through a [`ProjectMethods`] instance.
///
/// # Example
///
...
impl<'a, C> common::CallBuilder for ProjectLocationWorkflowExecutionGetCall<'a, C> {}

impl<'a, C> ProjectLocationWorkflowExecutionGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationWorkflowExecutionGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationWorkflowExecutionGetCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationWorkflowExecutionGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Returns a list of executions which belong to the workflow with the given name. The method returns executions of all workflow revisions. Returned executions are ordered by their start time (newest first).
///
/// A builder for the *locations.workflows.executions.list* method supported by a *project* resource.
/// It is not used directly, but through a [`ProjectMethods`] instance.
///
/// # Example
///
...
impl<'a, C> common::CallBuilder for ProjectLocationWorkflowExecutionListCall<'a, C> {}

impl<'a, C> ProjectLocationWorkflowExecutionListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, ListExecutionsResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    ///
    /// Sets the *order by* query property to the given value.
    pub fn order_by(mut self, new_value: &str) -> ProjectLocationWorkflowExecutionListCall<'a, C> {
        self._order_by = Some(new_value.to_string());
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationWorkflowExecutionListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationWorkflowExecutionListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationWorkflowExecutionListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Triggers a new execution using the latest revision of the given workflow by a Pub/Sub push notification.
///
/// A builder for the *locations.workflows.triggerPubsubExecution* method supported by a *project* resource.
/// It is not used directly, but through a [`ProjectMethods`] instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_workflowexecutions1 as workflowexecutions1;
/// use workflowexecutions1::api::TriggerPubsubExecutionRequest;
/// # async fn dox() {
/// # use workflowexecutions1::{WorkflowExecutions, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = TriggerPubsubExecutionRequest::default();
///
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().locations_workflows_trigger_pubsub_execution(req, "workflow")
///              .doit().await;
/// # }
/// ```
pub struct ProjectLocationWorkflowTriggerPubsubExecutionCall<'a, C>
where
    C: 'a,
{
    hub: &'a WorkflowExecutions<C>,
    _request: TriggerPubsubExecutionRequest,
    _workflow: String,
    _delegate: Option<&'a mut dyn common::Delegate>,
    _additional_params: HashMap<String, String>,
    _scopes: BTreeSet<String>,
...
impl<'a, C> common::CallBuilder for ProjectLocationWorkflowTriggerPubsubExecutionCall<'a, C> {}

impl<'a, C> ProjectLocationWorkflowTriggerPubsubExecutionCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, Execution)> {
        ...
        for &field in ["alt", "workflow"].iter() {
            if self._additional_params.contains_key(field) {
                dlg.finished(false);
                return Err(common::Error::FieldClash(field));
            }
        ...
        params.push("alt", "json");
        let mut url = self.hub._base_url.clone() + "v1/{+workflow}:triggerPubsubExecution";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string());
        }
        ...
        #[allow(clippy::single_element_loop)]
        for &(find_this, param_name) in [("{+workflow}", "workflow")].iter() {
            url = params.uri_replacement(url, param_name, find_this, true);
        }
        {
            let to_remove = ["workflow"];
            params.remove_params(&to_remove);
        }
    ...
    pub fn request(
        mut self,
        new_value: TriggerPubsubExecutionRequest,
    ) -> ProjectLocationWorkflowTriggerPubsubExecutionCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    ///
    /// Sets the *workflow* path property to the given value.
    ///
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn workflow(
        ...
        self._workflow = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    /// while executing the actual API request.
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationWorkflowTriggerPubsubExecutionCall<'a, C> {
        self._scopes.clear();
        self
    }
}
