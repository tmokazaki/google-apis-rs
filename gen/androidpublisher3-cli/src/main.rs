...
use google_androidpublisher3::{api, yup_oauth2, Error};
...
{
    async fn _applications_data_safety(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        ...
        let mut request: api::SafetyLabelsUpdateRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .applications()
            .data_safety(request, opt.value_of("package-name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _applications_device_tier_configs_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::DeviceTierConfig = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .applications()
            .device_tier_configs_create(request, opt.value_of("package-name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            .iter()
        {
            ...
            match key {
                "allow-unknown-devices" => {
                    call = call.allow_unknown_devices(
                        value
                            .map(|v| arg_from_str(v, err, "allow-unknown-devices", "boolean"))
                            .unwrap_or(false),
                    );
                }
                _ => {
    ...
    async fn _applications_device_tier_configs_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _applications_device_tier_configs_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .applications()
            .device_tier_configs_list(opt.value_of("package-name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _apprecovery_add_targeting(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                "targeting-update.all-users.is-all-users-requested" => Some((
                    "targetingUpdate.allUsers.isAllUsersRequested",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "targeting-update.android-sdks.sdk-levels" => Some((
                    "targetingUpdate.androidSdks.sdkLevels",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "targeting-update.regions.region-code" => Some((
                    "targetingUpdate.regions.regionCode",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
    ...
    async fn _apprecovery_app_recoveries(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .apprecovery()
            .app_recoveries(opt.value_of("package-name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            .iter()
        {
            ...
            match key {
                "version-code" => {
                    call = call.version_code(
                        value
                            .map(|v| arg_from_str(v, err, "version-code", "int64"))
                            .unwrap_or(-0),
                    );
                }
                _ => {
    ...
    async fn _apprecovery_create(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                "remote-in-app-update.is-remote-in-app-update-requested" => Some((
                    "remoteInAppUpdate.isRemoteInAppUpdateRequested",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "targeting.all-users.is-all-users-requested" => Some((
                    "targeting.allUsers.isAllUsersRequested",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "targeting.android-sdks.sdk-levels" => Some((
                    "targeting.androidSdks.sdkLevels",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "targeting.regions.region-code" => Some((
                    "targeting.regions.regionCode",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "targeting.version-list.version-codes" => Some((
                ...
                "targeting.version-range.version-code-end" => Some((
                    "targeting.versionRange.versionCodeEnd",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "targeting.version-range.version-code-start" => Some((
                    "targeting.versionRange.versionCodeStart",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
        ...
        let mut request: api::CreateDraftAppRecoveryRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .apprecovery()
            .create(request, opt.value_of("package-name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _edits_apks_addexternallyhosted(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                "externally-hosted-apk.application-label" => Some((
                ...
                "externally-hosted-apk.certificate-base64s" => Some((
                ...
                "externally-hosted-apk.externally-hosted-url" => Some((
                ...
                "externally-hosted-apk.file-sha1-base64" => Some((
                ...
                "externally-hosted-apk.file-sha256-base64" => Some((
                ...
                "externally-hosted-apk.file-size" => Some((
                ...
                "externally-hosted-apk.icon-base64" => Some((
                ...
                "externally-hosted-apk.maximum-sdk" => Some((
                ...
                "externally-hosted-apk.minimum-sdk" => Some((
                ...
                "externally-hosted-apk.native-codes" => Some((
                ...
                "externally-hosted-apk.package-name" => Some((
                ...
                "externally-hosted-apk.uses-features" => Some((
                ...
                "externally-hosted-apk.version-code" => Some((
                ...
                "externally-hosted-apk.version-name" => Some((
        ...
        let mut request: api::ApksAddExternallyHostedRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.edits().apks_addexternallyhosted(
            request,
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("edit-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _edits_apks_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.edits().apks_list(
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("edit-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _edits_apks_upload(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.edits().apks_upload(
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("edit-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _edits_bundles_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.edits().bundles_list(
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("edit-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _edits_bundles_upload(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.edits().bundles_upload(
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("edit-id").unwrap_or(""),
        );
        for parg in opt
            ...
            .iter()
        {
            ...
            match key {
                ...
                "ack-bundle-installation-warning" => {
                    call = call.ack_bundle_installation_warning(
                        value
                            .map(|v| {
                                arg_from_str(v, err, "ack-bundle-installation-warning", "boolean")
                            })
                            .unwrap_or(false),
                    );
                }
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["ack-bundle-installation-warning", "device-tier-config-id"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _edits_commit(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.edits().commit(
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("edit-id").unwrap_or(""),
        );
        for parg in opt
            ...
            .iter()
        {
            ...
            match key {
                "changes-not-sent-for-review" => {
                    call = call.changes_not_sent_for_review(
                        value
                            .map(|v| arg_from_str(v, err, "changes-not-sent-for-review", "boolean"))
                            .unwrap_or(false),
                    );
                }
                _ => {
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                let mut v = Vec::new();
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(["changes-not-sent-for-review"].iter().map(|v| *v));
                                v
                            }));
                    }
                }
    ...
    async fn _edits_countryavailability_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.edits().countryavailability_get(
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("edit-id").unwrap_or(""),
            opt.value_of("track").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _edits_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.edits().delete(
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("edit-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _edits_deobfuscationfiles_upload(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let apk_version_code: i32 = arg_from_str(
        ...
        let mut call = self.hub.edits().deobfuscationfiles_upload(
            ...
            opt.value_of("edit-id").unwrap_or(""),
            apk_version_code,
            opt.value_of("deobfuscation-file-type").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _edits_details_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.edits().details_get(
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("edit-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _edits_details_patch(
        ...
        let mut request: api::AppDetails = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.edits().details_patch(
            request,
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("edit-id").unwrap_or(""),
        );
    ...
    async fn _edits_details_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::AppDetails = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.edits().details_update(
            request,
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("edit-id").unwrap_or(""),
        );
    ...
    async fn _edits_expansionfiles_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self.hub.edits().expansionfiles_get(
            ...
            opt.value_of("edit-id").unwrap_or(""),
            apk_version_code,
            opt.value_of("expansion-file-type").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _edits_expansionfiles_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion =
                        FieldCursor::did_you_mean(key, &vec!["file-size", "references-version"]);
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
                        value.map(|v| v.to_string()),
        ...
        let mut request: api::ExpansionFile = serde_json::value::from_value(object).unwrap();
        let apk_version_code: i32 = arg_from_str(
            &opt.value_of("apk-version-code").unwrap_or(""),
            err,
            "<apk-version-code>",
    ...
    async fn _edits_expansionfiles_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _edits_expansionfiles_upload(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _edits_get(
        ...
        let mut call = self.hub.edits().get(
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("edit-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _edits_images_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.edits().images_delete(
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("edit-id").unwrap_or(""),
            opt.value_of("language").unwrap_or(""),
            opt.value_of("image-type").unwrap_or(""),
            opt.value_of("image-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _edits_images_deleteall(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.edits().images_deleteall(
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("edit-id").unwrap_or(""),
            opt.value_of("language").unwrap_or(""),
            opt.value_of("image-type").unwrap_or(""),
    ...
    async fn _edits_images_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.edits().images_list(
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("edit-id").unwrap_or(""),
            opt.value_of("language").unwrap_or(""),
            opt.value_of("image-type").unwrap_or(""),
    ...
    async fn _edits_images_upload(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.edits().images_upload(
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("edit-id").unwrap_or(""),
            opt.value_of("language").unwrap_or(""),
            opt.value_of("image-type").unwrap_or(""),
    ...
    async fn _edits_insert(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion =
                        FieldCursor::did_you_mean(key, &vec!["expiry-time-seconds", "id"]);
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
                        value.map(|v| v.to_string()),
        ...
        let mut request: api::AppEdit = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .edits()
            .insert(request, opt.value_of("package-name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _edits_listings_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.edits().listings_delete(
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("edit-id").unwrap_or(""),
            opt.value_of("language").unwrap_or(""),
        );
    ...
    async fn _edits_listings_deleteall(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.edits().listings_deleteall(
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("edit-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _edits_listings_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.edits().listings_get(
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("edit-id").unwrap_or(""),
            opt.value_of("language").unwrap_or(""),
        );
    ...
    async fn _edits_listings_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.edits().listings_list(
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("edit-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _edits_listings_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::Listing = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.edits().listings_patch(
            request,
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("edit-id").unwrap_or(""),
            opt.value_of("language").unwrap_or(""),
    ...
    async fn _edits_listings_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::Listing = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.edits().listings_update(
            request,
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("edit-id").unwrap_or(""),
            opt.value_of("language").unwrap_or(""),
    ...
    async fn _edits_testers_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.edits().testers_get(
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("edit-id").unwrap_or(""),
            opt.value_of("track").unwrap_or(""),
        );
    ...
    async fn _edits_testers_patch(
        ...
        let mut request: api::Testers = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.edits().testers_patch(
            request,
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("edit-id").unwrap_or(""),
            opt.value_of("track").unwrap_or(""),
    ...
    async fn _edits_testers_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::Testers = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.edits().testers_update(
            request,
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("edit-id").unwrap_or(""),
            opt.value_of("track").unwrap_or(""),
    ...
    async fn _edits_tracks_create(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion =
                        FieldCursor::did_you_mean(key, &vec!["form-factor", "track", "type"]);
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
                        value.map(|v| v.to_string()),
        ...
        let mut request: api::TrackConfig = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.edits().tracks_create(
            request,
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("edit-id").unwrap_or(""),
        );
    ...
    async fn _edits_tracks_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.edits().tracks_get(
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("edit-id").unwrap_or(""),
            opt.value_of("track").unwrap_or(""),
        );
    ...
    async fn _edits_tracks_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.edits().tracks_list(
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("edit-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _edits_tracks_patch(
        ...
        let mut request: api::Track = serde_json::value::from_value(object).unwrap();
    ...
    async fn _edits_tracks_update(
        ...
        let mut request: api::Track = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.edits().tracks_update(
            request,
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("edit-id").unwrap_or(""),
            opt.value_of("track").unwrap_or(""),
    ...
    async fn _edits_validate(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.edits().validate(
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("edit-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _externaltransactions_createexternaltransaction(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "current-pre-tax-amount.currency" => Some((
                ...
                "current-pre-tax-amount.price-micros" => Some((
                    "currentPreTaxAmount.priceMicros",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "current-tax-amount.currency" => Some((
                    "currentTaxAmount.currency",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "current-tax-amount.price-micros" => Some((
                    "currentTaxAmount.priceMicros",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "external-transaction-id" => Some((
                ...
                "one-time-transaction.external-transaction-token" => Some((
                ...
                "original-pre-tax-amount.currency" => Some((
                    "originalPreTaxAmount.currency",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "original-pre-tax-amount.price-micros" => Some((
                    "originalPreTaxAmount.priceMicros",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "original-tax-amount.currency" => Some((
                    "originalTaxAmount.currency",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "original-tax-amount.price-micros" => Some((
                    "originalTaxAmount.priceMicros",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                ...
                "recurring-transaction.external-subscription.subscription-type" => Some((
                ...
                "recurring-transaction.external-transaction-token" => Some((
                    "recurringTransaction.externalTransactionToken",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "recurring-transaction.initial-external-transaction-id" => Some((
                    "recurringTransaction.initialExternalTransactionId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "recurring-transaction.migrated-transaction-program" => Some((
                    "recurringTransaction.migratedTransactionProgram",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "transaction-program-code" => Some((
                ...
                "user-tax-address.administrative-area" => Some((
                    "userTaxAddress.administrativeArea",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "user-tax-address.region-code" => Some((
        ...
        let mut request: api::ExternalTransaction = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .externaltransactions()
            .createexternaltransaction(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _externaltransactions_getexternaltransaction(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .externaltransactions()
            .getexternaltransaction(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _externaltransactions_refundexternaltransaction(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "partial-refund.refund-pre-tax-amount.currency" => Some((
                    "partialRefund.refundPreTaxAmount.currency",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "partial-refund.refund-pre-tax-amount.price-micros" => Some((
                    "partialRefund.refundPreTaxAmount.priceMicros",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
        ...
        let mut request: api::RefundExternalTransactionRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .externaltransactions()
            .refundexternaltransaction(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _generatedapks_download(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let version_code: i32 = arg_from_str(
        ...
        let mut call = self.hub.generatedapks().download(
            opt.value_of("package-name").unwrap_or(""),
            version_code,
            opt.value_of("download-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _generatedapks_list(
        ...
        let mut call = self
            .hub
            .generatedapks()
            .list(opt.value_of("package-name").unwrap_or(""), version_code);
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _grants_create(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec!["app-level-permissions", "name", "package-name"],
                    );
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
        ...
        let mut request: api::Grant = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .grants()
            .create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _grants_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.grants().delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _inappproducts_batch_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::InappproductsBatchDeleteRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .inappproducts()
            .batch_delete(request, opt.value_of("package-name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _inappproducts_batch_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .inappproducts()
            .batch_get(opt.value_of("package-name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _inappproducts_batch_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::InappproductsBatchUpdateRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .inappproducts()
            .batch_update(request, opt.value_of("package-name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _inappproducts_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.inappproducts().delete(
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("sku").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _inappproducts_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.inappproducts().get(
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("sku").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _inappproducts_insert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "default-price.price-micros" => Some((
                ...
                "managed-product-taxes-and-compliance-settings.eea-withdrawal-right-type" => {
                    Some((
                ...
                "managed-product-taxes-and-compliance-settings.is-tokenized-digital-asset" => {
                    Some((
                        "managedProductTaxesAndComplianceSettings.isTokenizedDigitalAsset",
                        JsonTypeInfo {
                            jtype: JsonType::Boolean,
                            ctype: ComplexType::Pod,
                        },
                ...
                "subscription-taxes-and-compliance-settings.eea-withdrawal-right-type" => Some((
                ...
                "subscription-taxes-and-compliance-settings.is-tokenized-digital-asset" => Some((
                    "subscriptionTaxesAndComplianceSettings.isTokenizedDigitalAsset",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
        ...
        let mut request: api::InAppProduct = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .inappproducts()
            .insert(request, opt.value_of("package-name").unwrap_or(""));
            ...
            .iter()
        {
            ...
            match key {
                "auto-convert-missing-prices" => {
                    call = call.auto_convert_missing_prices(
                        value
                            .map(|v| arg_from_str(v, err, "auto-convert-missing-prices", "boolean"))
                            .unwrap_or(false),
                    );
                }
                _ => {
    ...
    async fn _inappproducts_list(
        ...
        let mut call = self
            .hub
            .inappproducts()
            .list(opt.value_of("package-name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            ...
            match key {
                ...
                "start-index" => {
                    call = call.start_index(
                        value
                            .map(|v| arg_from_str(v, err, "start-index", "uint32"))
                            .unwrap_or(0),
                    );
                }
                "max-results" => {
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["max-results", "start-index", "token"].iter().map(|v| *v),
                                );
                                v
                            }));
                    }
    ...
    async fn _inappproducts_patch(
        ...
        let mut request: api::InAppProduct = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.inappproducts().patch(
            request,
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("sku").unwrap_or(""),
        );
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["auto-convert-missing-prices", "latency-tolerance"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _inappproducts_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::InAppProduct = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.inappproducts().update(
            request,
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("sku").unwrap_or(""),
        );
    ...
    async fn _internalappsharingartifacts_uploadapk(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            ...
            .uploadapk(opt.value_of("package-name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _internalappsharingartifacts_uploadbundle(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .internalappsharingartifacts()
            .uploadbundle(opt.value_of("package-name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _monetization_convert_region_prices(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec!["currency-code", "nanos", "price", "units"],
                    );
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
        ...
        let mut request: api::ConvertRegionPricesRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .monetization()
            .convert_region_prices(request, opt.value_of("package-name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _monetization_subscriptions_archive(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::ArchiveSubscriptionRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.monetization().subscriptions_archive(
            request,
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("product-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _monetization_subscriptions_base_plans_activate(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::ActivateBasePlanRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.monetization().subscriptions_base_plans_activate(
            request,
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("product-id").unwrap_or(""),
            opt.value_of("base-plan-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _monetization_subscriptions_base_plans_batch_migrate_prices(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::BatchMigrateBasePlanPricesRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .monetization()
    ...
    async fn _monetization_subscriptions_base_plans_batch_update_states(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::BatchUpdateBasePlanStatesRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .monetization()
            .subscriptions_base_plans_batch_update_states(
                request,
                opt.value_of("package-name").unwrap_or(""),
                opt.value_of("product-id").unwrap_or(""),
            );
    ...
    async fn _monetization_subscriptions_base_plans_deactivate(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::DeactivateBasePlanRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.monetization().subscriptions_base_plans_deactivate(
            request,
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("product-id").unwrap_or(""),
            opt.value_of("base-plan-id").unwrap_or(""),
    ...
    async fn _monetization_subscriptions_base_plans_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.monetization().subscriptions_base_plans_delete(
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("product-id").unwrap_or(""),
            opt.value_of("base-plan-id").unwrap_or(""),
        );
    ...
    async fn _monetization_subscriptions_base_plans_migrate_prices(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::MigrateBasePlanPricesRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .monetization()
            .subscriptions_base_plans_migrate_prices(
                request,
                opt.value_of("package-name").unwrap_or(""),
                opt.value_of("product-id").unwrap_or(""),
                opt.value_of("base-plan-id").unwrap_or(""),
    ...
    async fn _monetization_subscriptions_base_plans_offers_activate(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::ActivateSubscriptionOfferRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .monetization()
            .subscriptions_base_plans_offers_activate(
                request,
                opt.value_of("package-name").unwrap_or(""),
                opt.value_of("product-id").unwrap_or(""),
                opt.value_of("base-plan-id").unwrap_or(""),
                opt.value_of("offer-id").unwrap_or(""),
            );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _monetization_subscriptions_base_plans_offers_batch_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::BatchGetSubscriptionOffersRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .monetization()
            .subscriptions_base_plans_offers_batch_get(
                request,
                opt.value_of("package-name").unwrap_or(""),
                opt.value_of("product-id").unwrap_or(""),
                opt.value_of("base-plan-id").unwrap_or(""),
    ...
    async fn _monetization_subscriptions_base_plans_offers_batch_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::BatchUpdateSubscriptionOffersRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .monetization()
            .subscriptions_base_plans_offers_batch_update(
                request,
                opt.value_of("package-name").unwrap_or(""),
                opt.value_of("product-id").unwrap_or(""),
                opt.value_of("base-plan-id").unwrap_or(""),
    ...
    async fn _monetization_subscriptions_base_plans_offers_batch_update_states(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::BatchUpdateSubscriptionOfferStatesRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .monetization()
            .subscriptions_base_plans_offers_batch_update_states(
                request,
                opt.value_of("package-name").unwrap_or(""),
                opt.value_of("product-id").unwrap_or(""),
                opt.value_of("base-plan-id").unwrap_or(""),
    ...
    async fn _monetization_subscriptions_base_plans_offers_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "other-regions-config.other-regions-new-subscriber-availability" => Some((
                    "otherRegionsConfig.otherRegionsNewSubscriberAvailability",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                ...
                "targeting.acquisition-rule.scope.specific-subscription-in-app" => Some((
                ...
                "targeting.upgrade-rule.billing-period-duration" => Some((
                    "targeting.upgradeRule.billingPeriodDuration",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "targeting.upgrade-rule.once-per-user" => Some((
                    "targeting.upgradeRule.oncePerUser",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "targeting.upgrade-rule.scope.specific-subscription-in-app" => Some((
                    "targeting.upgradeRule.scope.specificSubscriptionInApp",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
        ...
        let mut request: api::SubscriptionOffer = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .monetization()
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["offer-id", "regions-version-version"].iter().map(|v| *v),
                                );
                                v
                            }));
                    }
    ...
    async fn _monetization_subscriptions_base_plans_offers_deactivate(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::DeactivateSubscriptionOfferRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .monetization()
    ...
    async fn _monetization_subscriptions_base_plans_offers_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .monetization()
            .subscriptions_base_plans_offers_delete(
                opt.value_of("package-name").unwrap_or(""),
                opt.value_of("product-id").unwrap_or(""),
                opt.value_of("base-plan-id").unwrap_or(""),
                opt.value_of("offer-id").unwrap_or(""),
    ...
    async fn _monetization_subscriptions_base_plans_offers_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.monetization().subscriptions_base_plans_offers_get(
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("product-id").unwrap_or(""),
            opt.value_of("base-plan-id").unwrap_or(""),
            opt.value_of("offer-id").unwrap_or(""),
    ...
    async fn _monetization_subscriptions_base_plans_offers_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .monetization()
            .subscriptions_base_plans_offers_list(
                opt.value_of("package-name").unwrap_or(""),
                opt.value_of("product-id").unwrap_or(""),
                opt.value_of("base-plan-id").unwrap_or(""),
            );
    ...
    async fn _monetization_subscriptions_base_plans_offers_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .monetization()
            .subscriptions_base_plans_offers_patch(
                request,
                opt.value_of("package-name").unwrap_or(""),
                opt.value_of("product-id").unwrap_or(""),
                opt.value_of("base-plan-id").unwrap_or(""),
    ...
    async fn _monetization_subscriptions_batch_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .monetization()
            .subscriptions_batch_get(opt.value_of("package-name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _monetization_subscriptions_batch_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::BatchUpdateSubscriptionsRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .monetization()
            .subscriptions_batch_update(request, opt.value_of("package-name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _monetization_subscriptions_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "restricted-payment-countries.region-codes" => Some((
                ...
                "tax-and-compliance-settings.eea-withdrawal-right-type" => Some((
                ...
                "tax-and-compliance-settings.is-tokenized-digital-asset" => Some((
                    "taxAndComplianceSettings.isTokenizedDigitalAsset",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
        ...
        let mut call = self
            .hub
            .monetization()
            .subscriptions_create(request, opt.value_of("package-name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["product-id", "regions-version-version"].iter().map(|v| *v),
                                );
                                v
                            }));
                    }
    ...
    async fn _monetization_subscriptions_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.monetization().subscriptions_delete(
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("product-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _monetization_subscriptions_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.monetization().subscriptions_get(
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("product-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _monetization_subscriptions_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .monetization()
            .subscriptions_list(opt.value_of("package-name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            .iter()
        {
            ...
            match key {
                "show-archived" => {
                    call = call.show_archived(
                        value
                            .map(|v| arg_from_str(v, err, "show-archived", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "page-token" => {
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["page-size", "page-token", "show-archived"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _monetization_subscriptions_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::Subscription = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.monetization().subscriptions_patch(
            request,
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("product-id").unwrap_or(""),
        );
    ...
    async fn _orders_refund(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.orders().refund(
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("order-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            ...
            .iter()
        {
            ...
            match key {
                "revoke" => {
                    call = call.revoke(
                        value
                            .map(|v| arg_from_str(v, err, "revoke", "boolean"))
                            .unwrap_or(false),
                    );
                }
                _ => {
    ...
    async fn _purchases_products_acknowledge(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::ProductPurchasesAcknowledgeRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.purchases().products_acknowledge(
            request,
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("product-id").unwrap_or(""),
            opt.value_of("token").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _purchases_products_consume(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.purchases().products_consume(
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("product-id").unwrap_or(""),
            opt.value_of("token").unwrap_or(""),
        );
    ...
    async fn _purchases_products_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.purchases().products_get(
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("product-id").unwrap_or(""),
            opt.value_of("token").unwrap_or(""),
        );
    ...
    async fn _purchases_subscriptions_acknowledge(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::SubscriptionPurchasesAcknowledgeRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.purchases().subscriptions_acknowledge(
            request,
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("subscription-id").unwrap_or(""),
            opt.value_of("token").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
    ...
    async fn _purchases_subscriptions_cancel(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.purchases().subscriptions_cancel(
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("subscription-id").unwrap_or(""),
            opt.value_of("token").unwrap_or(""),
        );
    ...
    async fn _purchases_subscriptions_defer(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                "deferral-info.desired-expiry-time-millis" => Some((
                ...
                "deferral-info.expected-expiry-time-millis" => Some((
        ...
        let mut request: api::SubscriptionPurchasesDeferRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.purchases().subscriptions_defer(
            request,
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("subscription-id").unwrap_or(""),
            opt.value_of("token").unwrap_or(""),
    ...
    async fn _purchases_subscriptions_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.purchases().subscriptions_get(
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("subscription-id").unwrap_or(""),
            opt.value_of("token").unwrap_or(""),
        );
    ...
    async fn _purchases_subscriptions_refund(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.purchases().subscriptions_refund(
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("subscription-id").unwrap_or(""),
            opt.value_of("token").unwrap_or(""),
        );
    ...
    async fn _purchases_subscriptions_revoke(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.purchases().subscriptions_revoke(
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("subscription-id").unwrap_or(""),
            opt.value_of("token").unwrap_or(""),
        );
    ...
    async fn _purchases_subscriptionsv2_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.purchases().subscriptionsv2_get(
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("token").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _purchases_subscriptionsv2_revoke(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::RevokeSubscriptionPurchaseRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.purchases().subscriptionsv2_revoke(
            request,
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("token").unwrap_or(""),
        );
    ...
    async fn _purchases_voidedpurchases_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .purchases()
            .voidedpurchases_list(opt.value_of("package-name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            .iter()
        {
            ...
            match key {
                "type" => {
                    call = call.type_(
                        value
                            .map(|v| arg_from_str(v, err, "type", "int32"))
                            .unwrap_or(-0),
                    );
                }
                "token" => {
                ...
                "start-time" => {
                    call = call.start_time(
                        value
                            .map(|v| arg_from_str(v, err, "start-time", "int64"))
                            .unwrap_or(-0),
                    );
                }
                "start-index" => {
                ...
                "include-quantity-based-partial-refund" => {
                    call = call.include_quantity_based_partial_refund(
                        value
                            .map(|v| {
                                arg_from_str(
                                    v,
                ...
                "end-time" => {
                    call = call.end_time(
                        value
                            .map(|v| arg_from_str(v, err, "end-time", "int64"))
                            .unwrap_or(-0),
                    );
                }
                _ => {
    ...
    async fn _reviews_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.reviews().get(
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("review-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _reviews_reply(
        ...
        let mut request: api::ReviewsReplyRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.reviews().reply(
            request,
            opt.value_of("package-name").unwrap_or(""),
            opt.value_of("review-id").unwrap_or(""),
        );
    ...
    async fn _systemapks_variants_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                "device-spec.screen-density" => Some((
                    "deviceSpec.screenDensity",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                )),
                "device-spec.supported-abis" => Some((
                ...
                "device-spec.supported-locales" => Some((
                    "deviceSpec.supportedLocales",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "options.rotated" => Some((
                    "options.rotated",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                ...
                "options.uncompressed-dex-files" => Some((
                    "options.uncompressedDexFiles",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "options.uncompressed-native-libraries" => Some((
                    "options.uncompressedNativeLibraries",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
    ...
    async fn _systemapks_variants_download(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _systemapks_variants_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _systemapks_variants_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _users_create(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "developer-account-permissions" => Some((
    ...
    async fn _users_delete(
        ...
        let mut call = self.hub.users().delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _users_list(
        ...
        let mut call = self.hub.users().list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _doit(
        ...
        match self.opt.subcommand() {
            ("applications", Some(opt)) => match opt.subcommand() {
                ...
                ("device-tier-configs-create", Some(opt)) => {
                    call_result = self
                        ._applications_device_tier_configs_create(opt, dry_run, &mut err)
                        .await;
                }
                ("device-tier-configs-get", Some(opt)) => {
                    call_result = self
                        ._applications_device_tier_configs_get(opt, dry_run, &mut err)
                        .await;
                }
                ("device-tier-configs-list", Some(opt)) => {
                    call_result = self
                        ._applications_device_tier_configs_list(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("applications".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("apprecovery", Some(opt)) => match opt.subcommand() {
                ("add-targeting", Some(opt)) => {
                    call_result = self
                        ._apprecovery_add_targeting(opt, dry_run, &mut err)
                        .await;
                }
                ("app-recoveries", Some(opt)) => {
                    call_result = self
                        ._apprecovery_app_recoveries(opt, dry_run, &mut err)
                        .await;
                }
                ("cancel", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("apprecovery".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("edits", Some(opt)) => match opt.subcommand() {
                ("apks-addexternallyhosted", Some(opt)) => {
                    call_result = self
                        ._edits_apks_addexternallyhosted(opt, dry_run, &mut err)
                        .await;
                }
                ("apks-list", Some(opt)) => {
                ...
                ("countryavailability-get", Some(opt)) => {
                    call_result = self
                        ._edits_countryavailability_get(opt, dry_run, &mut err)
                        .await;
                }
                ("delete", Some(opt)) => {
                ...
                ("deobfuscationfiles-upload", Some(opt)) => {
                    call_result = self
                        ._edits_deobfuscationfiles_upload(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("expansionfiles-patch", Some(opt)) => {
                    call_result = self
                        ._edits_expansionfiles_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("expansionfiles-update", Some(opt)) => {
                    call_result = self
                        ._edits_expansionfiles_update(opt, dry_run, &mut err)
                        .await;
                }
                ("expansionfiles-upload", Some(opt)) => {
                    call_result = self
                        ._edits_expansionfiles_upload(opt, dry_run, &mut err)
                        .await;
                }
                ("get", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("edits".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("externaltransactions", Some(opt)) => match opt.subcommand() {
                ("createexternaltransaction", Some(opt)) => {
                    call_result = self
                        ._externaltransactions_createexternaltransaction(opt, dry_run, &mut err)
                        .await;
                }
                ("getexternaltransaction", Some(opt)) => {
                    call_result = self
                        ._externaltransactions_getexternaltransaction(opt, dry_run, &mut err)
                        .await;
                }
                ("refundexternaltransaction", Some(opt)) => {
                    call_result = self
                        ._externaltransactions_refundexternaltransaction(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues.push(CLIError::MissingMethodError(
                        "externaltransactions".to_string(),
                    ));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("generatedapks", Some(opt)) => match opt.subcommand() {
                ("download", Some(opt)) => {
                    call_result = self._generatedapks_download(opt, dry_run, &mut err).await;
                }
                ("list", Some(opt)) => {
                    call_result = self._generatedapks_list(opt, dry_run, &mut err).await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("generatedapks".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("grants", Some(opt)) => match opt.subcommand() {
                ("create", Some(opt)) => {
                    call_result = self._grants_create(opt, dry_run, &mut err).await;
                }
                ("delete", Some(opt)) => {
                    call_result = self._grants_delete(opt, dry_run, &mut err).await;
                }
                ("patch", Some(opt)) => {
                    call_result = self._grants_patch(opt, dry_run, &mut err).await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("grants".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("inappproducts", Some(opt)) => match opt.subcommand() {
                ("batch-delete", Some(opt)) => {
                    call_result = self
                        ._inappproducts_batch_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("batch-get", Some(opt)) => {
                ...
                ("batch-update", Some(opt)) => {
                    call_result = self
                        ._inappproducts_batch_update(opt, dry_run, &mut err)
                        .await;
                }
                ("delete", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("inappproducts".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("internalappsharingartifacts", Some(opt)) => match opt.subcommand() {
                ("uploadapk", Some(opt)) => {
                    call_result = self
                        ._internalappsharingartifacts_uploadapk(opt, dry_run, &mut err)
                        .await;
                }
                ("uploadbundle", Some(opt)) => {
                    call_result = self
                        ._internalappsharingartifacts_uploadbundle(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues.push(CLIError::MissingMethodError(
                        "internalappsharingartifacts".to_string(),
                    ));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("monetization", Some(opt)) => match opt.subcommand() {
                ("convert-region-prices", Some(opt)) => {
                    call_result = self
                        ._monetization_convert_region_prices(opt, dry_run, &mut err)
                        .await;
                }
                ("subscriptions-archive", Some(opt)) => {
                    call_result = self
                        ._monetization_subscriptions_archive(opt, dry_run, &mut err)
                        .await;
                }
                ("subscriptions-base-plans-activate", Some(opt)) => {
                    call_result = self
                        ._monetization_subscriptions_base_plans_activate(opt, dry_run, &mut err)
                        .await;
                }
                ("subscriptions-base-plans-batch-migrate-prices", Some(opt)) => {
                    call_result = self
                        ._monetization_subscriptions_base_plans_batch_migrate_prices(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("subscriptions-base-plans-batch-update-states", Some(opt)) => {
                    call_result = self
                        ._monetization_subscriptions_base_plans_batch_update_states(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("subscriptions-base-plans-deactivate", Some(opt)) => {
                    call_result = self
                        ._monetization_subscriptions_base_plans_deactivate(opt, dry_run, &mut err)
                        .await;
                }
                ("subscriptions-base-plans-delete", Some(opt)) => {
                    call_result = self
                        ._monetization_subscriptions_base_plans_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("subscriptions-base-plans-migrate-prices", Some(opt)) => {
                    call_result = self
                        ._monetization_subscriptions_base_plans_migrate_prices(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("subscriptions-base-plans-offers-activate", Some(opt)) => {
                    call_result = self
                        ._monetization_subscriptions_base_plans_offers_activate(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("subscriptions-base-plans-offers-batch-get", Some(opt)) => {
                    call_result = self
                        ._monetization_subscriptions_base_plans_offers_batch_get(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("subscriptions-base-plans-offers-batch-update", Some(opt)) => {
                    call_result = self
                        ._monetization_subscriptions_base_plans_offers_batch_update(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("subscriptions-base-plans-offers-batch-update-states", Some(opt)) => {
                    call_result = self
                        ._monetization_subscriptions_base_plans_offers_batch_update_states(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("subscriptions-base-plans-offers-create", Some(opt)) => {
                    call_result = self
                        ._monetization_subscriptions_base_plans_offers_create(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("subscriptions-base-plans-offers-deactivate", Some(opt)) => {
                    call_result = self
                        ._monetization_subscriptions_base_plans_offers_deactivate(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("subscriptions-base-plans-offers-delete", Some(opt)) => {
                    call_result = self
                        ._monetization_subscriptions_base_plans_offers_delete(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("subscriptions-base-plans-offers-get", Some(opt)) => {
                    call_result = self
                        ._monetization_subscriptions_base_plans_offers_get(opt, dry_run, &mut err)
                        .await;
                }
                ("subscriptions-base-plans-offers-list", Some(opt)) => {
                    call_result = self
                        ._monetization_subscriptions_base_plans_offers_list(opt, dry_run, &mut err)
                        .await;
                }
                ("subscriptions-base-plans-offers-patch", Some(opt)) => {
                    call_result = self
                        ._monetization_subscriptions_base_plans_offers_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("subscriptions-batch-get", Some(opt)) => {
                    call_result = self
                        ._monetization_subscriptions_batch_get(opt, dry_run, &mut err)
                        .await;
                }
                ("subscriptions-batch-update", Some(opt)) => {
                    call_result = self
                        ._monetization_subscriptions_batch_update(opt, dry_run, &mut err)
                        .await;
                }
                ("subscriptions-create", Some(opt)) => {
                    call_result = self
                        ._monetization_subscriptions_create(opt, dry_run, &mut err)
                        .await;
                }
                ("subscriptions-delete", Some(opt)) => {
                    call_result = self
                        ._monetization_subscriptions_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("subscriptions-get", Some(opt)) => {
                    call_result = self
                        ._monetization_subscriptions_get(opt, dry_run, &mut err)
                        .await;
                }
                ("subscriptions-list", Some(opt)) => {
                    call_result = self
                        ._monetization_subscriptions_list(opt, dry_run, &mut err)
                        .await;
                }
                ("subscriptions-patch", Some(opt)) => {
                    call_result = self
                        ._monetization_subscriptions_patch(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("monetization".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("orders", Some(opt)) => match opt.subcommand() {
                ("refund", Some(opt)) => {
                    call_result = self._orders_refund(opt, dry_run, &mut err).await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("orders".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("purchases", Some(opt)) => match opt.subcommand() {
                ("products-acknowledge", Some(opt)) => {
                    call_result = self
                        ._purchases_products_acknowledge(opt, dry_run, &mut err)
                        .await;
                }
                ("products-consume", Some(opt)) => {
                    call_result = self
                        ._purchases_products_consume(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("subscriptions-acknowledge", Some(opt)) => {
                    call_result = self
                        ._purchases_subscriptions_acknowledge(opt, dry_run, &mut err)
                        .await;
                }
                ("subscriptions-cancel", Some(opt)) => {
                    call_result = self
                        ._purchases_subscriptions_cancel(opt, dry_run, &mut err)
                        .await;
                }
                ("subscriptions-defer", Some(opt)) => {
                    call_result = self
                        ._purchases_subscriptions_defer(opt, dry_run, &mut err)
                        .await;
                }
                ("subscriptions-get", Some(opt)) => {
                    call_result = self
                        ._purchases_subscriptions_get(opt, dry_run, &mut err)
                        .await;
                }
                ("subscriptions-refund", Some(opt)) => {
                    call_result = self
                        ._purchases_subscriptions_refund(opt, dry_run, &mut err)
                        .await;
                }
                ("subscriptions-revoke", Some(opt)) => {
                    call_result = self
                        ._purchases_subscriptions_revoke(opt, dry_run, &mut err)
                        .await;
                }
                ("subscriptionsv2-get", Some(opt)) => {
                    call_result = self
                        ._purchases_subscriptionsv2_get(opt, dry_run, &mut err)
                        .await;
                }
                ("subscriptionsv2-revoke", Some(opt)) => {
                    call_result = self
                        ._purchases_subscriptionsv2_revoke(opt, dry_run, &mut err)
                        .await;
                }
                ("voidedpurchases-list", Some(opt)) => {
                    call_result = self
                        ._purchases_voidedpurchases_list(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("purchases".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("reviews", Some(opt)) => match opt.subcommand() {
                ("get", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("reviews".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("systemapks", Some(opt)) => match opt.subcommand() {
                ("variants-create", Some(opt)) => {
                    call_result = self
                        ._systemapks_variants_create(opt, dry_run, &mut err)
                        .await;
                }
                ("variants-download", Some(opt)) => {
                    call_result = self
                        ._systemapks_variants_download(opt, dry_run, &mut err)
                        .await;
                }
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("systemapks".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "androidpublisher3-secret.json",
    ...
    let arg_data = [
        ("applications", "methods: 'data-safety', 'device-tier-configs-create', 'device-tier-configs-get' and 'device-tier-configs-list'", vec![
            ...
            ("countryavailability-get",
                    Some(r##"Gets country availability."##),
                    "Details at http://byron.github.io/google-apis-rs/google_androidpublisher3_cli/edits_countryavailability-get",
                  vec![
                    (Some(r##"package-name"##),
                     None,
                     Some(r##"Package name of the app."##),
            ...
            ("generatedapks", "methods: 'download' and 'list'", vec![
            ("download",
                    Some(r##"Downloads a single signed APK generated from an app bundle."##),
                    "Details at http://byron.github.io/google-apis-rs/google_androidpublisher3_cli/generatedapks_download",
                  vec![
                    (Some(r##"package-name"##),
                     None,
                     Some(r##"Package name of the app."##),
                    ...
                    (Some(r##"version-code"##),
                     None,
                     Some(r##"Version code of the app bundle."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"download-id"##),
                     None,
                     Some(r##"Download ID, which uniquely identifies the APK to download. Can be obtained from the response of `generatedapks.list` method."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("list",
                    Some(r##"Returns download metadata for all APKs that were generated from a given app bundle."##),
                    "Details at http://byron.github.io/google-apis-rs/google_androidpublisher3_cli/generatedapks_list",
                  vec![
                    (Some(r##"package-name"##),
                     None,
                     Some(r##"Package name of the app."##),
            ...
            ("grants", "methods: 'create', 'delete' and 'patch'", vec![
            ("create",
                    Some(r##"Grant access for a user to the given package."##),
                    "Details at http://byron.github.io/google-apis-rs/google_androidpublisher3_cli/grants_create",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The user which needs permission. Format: developers/{developer}/users/{user}"##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("delete",
                    Some(r##"Removes all access for the user to the given package or developer account."##),
                    "Details at http://byron.github.io/google-apis-rs/google_androidpublisher3_cli/grants_delete",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The name of the grant to delete. Format: developers/{developer}/users/{email}/grants/{package_name}"##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("patch",
                    Some(r##"Updates access for the user to the given package."##),
                    "Details at http://byron.github.io/google-apis-rs/google_androidpublisher3_cli/grants_patch",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("users", "methods: 'create', 'delete', 'list' and 'patch'", vec![
            ("create",
                    Some(r##"Grant access for a user to the given developer account."##),
                    "Details at http://byron.github.io/google-apis-rs/google_androidpublisher3_cli/users_create",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The developer account to add the user to. Format: developers/{developer}"##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("delete",
                    Some(r##"Removes all access for the user to the given developer account."##),
                    "Details at http://byron.github.io/google-apis-rs/google_androidpublisher3_cli/users_delete",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The name of the user to delete. Format: developers/{developer}/users/{email}"##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("list",
                    Some(r##"Lists all users with access to a developer account."##),
                    "Details at http://byron.github.io/google-apis-rs/google_androidpublisher3_cli/users_list",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The developer account to fetch users from. Format: developers/{developer}"##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("patch",
                    Some(r##"Updates access for the user to the developer account."##),
                    "Details at http://byron.github.io/google-apis-rs/google_androidpublisher3_cli/users_patch",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. Resource name for this user, following the pattern "developers/{developer}/users/{email}"."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
