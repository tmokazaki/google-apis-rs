...
/// # extern crate hyper_rustls;
/// # extern crate google_domains1 as domains1;
/// use domains1::api::ImportDomainRequest;
/// # async fn dox() {
/// # use domains1::{CloudDomains, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
    ...
    C: common::Connector,
{
    ...
    pub async fn doit(mut self) -> common::Result<(common::Response, Operation)> {
        ...
        params.push("alt", "json");
        let mut url = self.hub._base_url.clone() + "v1/{+parent}/registrations:import";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string());
        }
...
/// # extern crate hyper_rustls;
/// # extern crate google_domains1 as domains1;
/// use domains1::api::InitiatePushTransferRequest;
/// # async fn dox() {
/// # use domains1::{CloudDomains, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
    ...
    C: common::Connector,
{
    ...
    pub async fn doit(mut self) -> common::Result<(common::Response, Operation)> {
        ...
        params.push("alt", "json");
        let mut url = self.hub._base_url.clone() + "v1/{+registration}:initiatePushTransfer";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string());
        }
...
/// # extern crate hyper_rustls;
/// # extern crate google_domains1 as domains1;
/// use domains1::api::RenewDomainRequest;
/// # async fn dox() {
/// # use domains1::{CloudDomains, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
    ...
    C: common::Connector,
{
    ...
    pub async fn doit(mut self) -> common::Result<(common::Response, Operation)> {
        ...
        params.push("alt", "json");
        let mut url = self.hub._base_url.clone() + "v1/{+registration}:renewDomain";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string());
        }
    ...
    C: common::Connector,
{
    ...
    pub async fn doit(
        ...
        params.push("alt", "json");
        let mut url =
            self.hub._base_url.clone() + "v1/{+registration}:retrieveGoogleDomainsDnsRecords";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string());
        }
    ...
    C: common::Connector,
{
    ...
    pub async fn doit(
        ...
        params.push("alt", "json");
        let mut url =
            self.hub._base_url.clone() + "v1/{+registration}:retrieveGoogleDomainsForwardingConfig";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string());
        }
    ...
    C: common::Connector,
{
    ...
    pub async fn doit(
        ...
        params.push("alt", "json");
        let mut url =
            self.hub._base_url.clone() + "v1/{+location}/registrations:retrieveImportableDomains";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string());
        }
    ...
    C: common::Connector,
{
    ...
    pub async fn doit(
        ...
        params.push("alt", "json");
        let mut url =
            self.hub._base_url.clone() + "v1/{+location}/registrations:retrieveRegisterParameters";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string());
        }
    ...
    C: common::Connector,
{
    ...
    pub async fn doit(
        ...
        params.push("alt", "json");
        let mut url =
            self.hub._base_url.clone() + "v1/{+location}/registrations:retrieveTransferParameters";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string());
        }
