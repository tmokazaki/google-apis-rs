...
use google_ml1::{api, yup_oauth2, Error};
...
struct Engine<'n, C> {
    opt: ArgMatches<'n>,
    hub: api::CloudMachineLearningEngine<C>,
    gp: Vec<&'static str>,
    ...
    C: apis_common::Connector,
{
    async fn _projects_explain(
        ...
        let mut request: api::GoogleCloudMlV1__ExplainRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .explain(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_jobs_cancel(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::GoogleCloudMlV1__CancelJobRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .jobs_cancel(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_jobs_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "prediction-input.batch-size" => Some((
                ...
                "prediction-input.data-format" => Some((
                ...
                "prediction-input.input-paths" => Some((
                ...
                "prediction-input.max-worker-count" => Some((
                ...
                "prediction-input.model-name" => Some((
                ...
                "prediction-input.output-data-format" => Some((
                ...
                "prediction-input.output-path" => Some((
                ...
                "prediction-input.runtime-version" => Some((
                ...
                "prediction-input.signature-name" => Some((
                ...
                "prediction-input.version-name" => Some((
                ...
                "prediction-output.error-count" => Some((
                ...
                "prediction-output.node-hours" => Some((
                ...
                "prediction-output.output-path" => Some((
                ...
                "prediction-output.prediction-count" => Some((
                ...
                "training-input.enable-web-access" => Some((
                    "trainingInput.enableWebAccess",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "training-input.encryption-config.kms-key-name" => Some((
                ...
                "training-input.evaluator-config.accelerator-config.count" => Some((
                    "trainingInput.evaluatorConfig.acceleratorConfig.count",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "training-input.evaluator-config.accelerator-config.type" => Some((
                    "trainingInput.evaluatorConfig.acceleratorConfig.type",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "training-input.evaluator-config.container-args" => Some((
                    "trainingInput.evaluatorConfig.containerArgs",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "training-input.evaluator-config.container-command" => Some((
                    "trainingInput.evaluatorConfig.containerCommand",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "training-input.evaluator-config.disk-config.boot-disk-size-gb" => Some((
                    "trainingInput.evaluatorConfig.diskConfig.bootDiskSizeGb",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                )),
                "training-input.evaluator-config.disk-config.boot-disk-type" => Some((
                    "trainingInput.evaluatorConfig.diskConfig.bootDiskType",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "training-input.evaluator-config.image-uri" => Some((
                    "trainingInput.evaluatorConfig.imageUri",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "training-input.evaluator-config.tpu-tf-version" => Some((
                    "trainingInput.evaluatorConfig.tpuTfVersion",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "training-input.evaluator-count" => Some((
                ...
                "training-input.evaluator-type" => Some((
                    "trainingInput.evaluatorType",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "training-input.hyperparameters.algorithm" => Some((
                ...
                "training-input.hyperparameters.enable-trial-early-stopping" => Some((
                ...
                "training-input.hyperparameters.goal" => Some((
                ...
                "training-input.hyperparameters.hyperparameter-metric-tag" => Some((
                ...
                "training-input.hyperparameters.max-failed-trials" => Some((
                ...
                "training-input.hyperparameters.max-parallel-trials" => Some((
                ...
                "training-input.hyperparameters.max-trials" => Some((
                ...
                "training-input.hyperparameters.resume-previous-job-id" => Some((
                ...
                "training-input.master-config.accelerator-config.count" => Some((
                ...
                "training-input.master-config.accelerator-config.type" => Some((
                ...
                "training-input.master-config.container-args" => Some((
                    "trainingInput.masterConfig.containerArgs",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "training-input.master-config.container-command" => Some((
                    "trainingInput.masterConfig.containerCommand",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "training-input.master-config.disk-config.boot-disk-size-gb" => Some((
                    "trainingInput.masterConfig.diskConfig.bootDiskSizeGb",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                )),
                "training-input.master-config.disk-config.boot-disk-type" => Some((
                    "trainingInput.masterConfig.diskConfig.bootDiskType",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "training-input.master-config.image-uri" => Some((
                ...
                "training-input.master-config.tpu-tf-version" => Some((
                    "trainingInput.masterConfig.tpuTfVersion",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "training-input.master-type" => Some((
                ...
                "training-input.network" => Some((
                    "trainingInput.network",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "training-input.package-uris" => Some((
                ...
                "training-input.parameter-server-config.accelerator-config.count" => Some((
                ...
                "training-input.parameter-server-config.accelerator-config.type" => Some((
                ...
                "training-input.parameter-server-config.container-args" => Some((
                    "trainingInput.parameterServerConfig.containerArgs",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "training-input.parameter-server-config.container-command" => Some((
                    "trainingInput.parameterServerConfig.containerCommand",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "training-input.parameter-server-config.disk-config.boot-disk-size-gb" => Some((
                    "trainingInput.parameterServerConfig.diskConfig.bootDiskSizeGb",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                )),
                "training-input.parameter-server-config.disk-config.boot-disk-type" => Some((
                    "trainingInput.parameterServerConfig.diskConfig.bootDiskType",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "training-input.parameter-server-config.image-uri" => Some((
                ...
                "training-input.parameter-server-config.tpu-tf-version" => Some((
                    "trainingInput.parameterServerConfig.tpuTfVersion",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "training-input.parameter-server-count" => Some((
                ...
                "training-input.parameter-server-type" => Some((
                ...
                "training-input.python-module" => Some((
                ...
                "training-input.python-version" => Some((
                ...
                "training-input.runtime-version" => Some((
                ...
                "training-input.scale-tier" => Some((
                ...
                "training-input.scheduling.max-running-time" => Some((
                    "trainingInput.scheduling.maxRunningTime",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "training-input.scheduling.max-wait-time" => Some((
                    "trainingInput.scheduling.maxWaitTime",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "training-input.scheduling.priority" => Some((
                    "trainingInput.scheduling.priority",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                )),
                "training-input.service-account" => Some((
                ...
                "training-input.use-chief-in-tf-config" => Some((
                ...
                "training-input.worker-config.accelerator-config.count" => Some((
                ...
                "training-input.worker-config.accelerator-config.type" => Some((
                ...
                "training-input.worker-config.container-args" => Some((
                    "trainingInput.workerConfig.containerArgs",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "training-input.worker-config.container-command" => Some((
                    "trainingInput.workerConfig.containerCommand",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "training-input.worker-config.disk-config.boot-disk-size-gb" => Some((
                    "trainingInput.workerConfig.diskConfig.bootDiskSizeGb",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                )),
                "training-input.worker-config.disk-config.boot-disk-type" => Some((
                    "trainingInput.workerConfig.diskConfig.bootDiskType",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "training-input.worker-config.image-uri" => Some((
                ...
                "training-input.worker-config.tpu-tf-version" => Some((
                    "trainingInput.workerConfig.tpuTfVersion",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "training-input.worker-count" => Some((
                ...
                "training-input.worker-type" => Some((
                ...
                "training-output.built-in-algorithm-output.framework" => Some((
                ...
                "training-output.built-in-algorithm-output.model-path" => Some((
                ...
                "training-output.built-in-algorithm-output.python-version" => Some((
                ...
                "training-output.built-in-algorithm-output.runtime-version" => Some((
                ...
                "training-output.completed-trial-count" => Some((
                ...
                "training-output.consumed-ml-units" => Some((
                ...
                "training-output.hyperparameter-metric-tag" => Some((
                ...
                "training-output.is-built-in-algorithm-job" => Some((
                ...
                "training-output.is-hyperparameter-tuning-job" => Some((
                ...
                "training-output.web-access-uris" => Some((
                    "trainingOutput.webAccessUris",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Map,
                    },
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        ...
                        &vec![
                            ...
                            "framework",
                            "goal",
                            "hyperparameter-metric-tag",
                            "hyperparameters",
                            "image-uri",
                            "input-paths",
                            "is-built-in-algorithm-job",
                            "is-hyperparameter-tuning-job",
                            "job-dir",
                            "job-id",
                            "job-position",
                            "kms-key-name",
        ...
        let mut request: api::GoogleCloudMlV1__Job = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .jobs_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_jobs_get(
        ...
        let mut call = self
            .hub
            .projects()
            .jobs_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_jobs_get_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .jobs_get_iam_policy(opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_jobs_list(
        ...
        let mut call = self
            .hub
            .projects()
            .jobs_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_jobs_patch(
        ...
        let mut call = self
            .hub
            .projects()
            .jobs_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_jobs_set_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::GoogleIamV1__SetIamPolicyRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .jobs_set_iam_policy(request, opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_jobs_test_iam_permissions(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::GoogleIamV1__TestIamPermissionsRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .jobs_test_iam_permissions(request, opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_list(
        ...
        let mut call = self
            .hub
            .projects()
            .locations_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_studies_create(
        ...
        let mut request: api::GoogleCloudMlV1__Study =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
    ...
    async fn _projects_locations_studies_trials_add_measurement(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec!["elapsed-time", "measurement", "step-count"],
                    );
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
        ...
        let mut request: api::GoogleCloudMlV1__AddTrialMeasurementRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_studies_trials_add_measurement(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_studies_trials_check_early_stopping_state(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::GoogleCloudMlV1__CheckTrialEarlyStoppingStateRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_studies_trials_check_early_stopping_state(
                request,
    ...
    async fn _projects_locations_studies_trials_complete(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                "final-measurement.elapsed-time" => Some((
        ...
        let mut request: api::GoogleCloudMlV1__CompleteTrialRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
    ...
    async fn _projects_locations_studies_trials_create(
        ...
        let mut request: api::GoogleCloudMlV1__Trial =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
    ...
    async fn _projects_locations_studies_trials_list_optimal_trials(
        ...
        let mut request: api::GoogleCloudMlV1__ListOptimalTrialsRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
    ...
    async fn _projects_locations_studies_trials_stop(
        ...
        let mut request: api::GoogleCloudMlV1__StopTrialRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
    ...
    async fn _projects_locations_studies_trials_suggest(
        ...
        let mut request: api::GoogleCloudMlV1__SuggestTrialsRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
    ...
    async fn _projects_models_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::GoogleCloudMlV1__Model =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .models_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_models_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .models_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_models_get_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .models_get_iam_policy(opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_models_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .models_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_models_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .models_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_models_set_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .models_set_iam_policy(request, opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_models_test_iam_permissions(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .models_test_iam_permissions(request, opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_models_versions_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "auto-scaling.max-nodes" => Some((
                    "autoScaling.maxNodes",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                )),
                "auto-scaling.min-nodes" => Some((
                ...
                "explanation-config.integrated-gradients-attribution.num-integral-steps" => Some((
                    "explanationConfig.integratedGradientsAttribution.numIntegralSteps",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                )),
                "explanation-config.sampled-shapley-attribution.num-paths" => Some((
                    "explanationConfig.sampledShapleyAttribution.numPaths",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                )),
                "explanation-config.xrai-attribution.num-integral-steps" => Some((
                    "explanationConfig.xraiAttribution.numIntegralSteps",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                ...
                "request-logging-config.bigquery-table-name" => Some((
                ...
                "request-logging-config.sampling-percentage" => Some((
                    "requestLoggingConfig.samplingPercentage",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
        ...
        let mut request: api::GoogleCloudMlV1__Version =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .models_versions_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_models_versions_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .models_versions_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_models_versions_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .models_versions_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_models_versions_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .models_versions_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_models_versions_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .models_versions_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_models_versions_set_default(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::GoogleCloudMlV1__SetDefaultVersionRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .models_versions_set_default(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_predict(
        ...
        let mut request: api::GoogleCloudMlV1__PredictRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .predict(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
        ...
        match self.opt.subcommand() {
            ("projects", Some(opt)) => match opt.subcommand() {
                ...
                ("jobs-get-iam-policy", Some(opt)) => {
                    call_result = self
                        ._projects_jobs_get_iam_policy(opt, dry_run, &mut err)
                        .await;
                }
                ("jobs-list", Some(opt)) => {
                ...
                ("jobs-set-iam-policy", Some(opt)) => {
                    call_result = self
                        ._projects_jobs_set_iam_policy(opt, dry_run, &mut err)
                        .await;
                }
                ("jobs-test-iam-permissions", Some(opt)) => {
                    call_result = self
                        ._projects_jobs_test_iam_permissions(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("locations-studies-create", Some(opt)) => {
                    call_result = self
                        ._projects_locations_studies_create(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-studies-delete", Some(opt)) => {
                    call_result = self
                        ._projects_locations_studies_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-studies-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_studies_get(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-studies-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_studies_list(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-studies-trials-add-measurement", Some(opt)) => {
                    call_result = self
                        ._projects_locations_studies_trials_add_measurement(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-studies-trials-check-early-stopping-state", Some(opt)) => {
                    call_result = self
                        ._projects_locations_studies_trials_check_early_stopping_state(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-studies-trials-complete", Some(opt)) => {
                    call_result = self
                        ._projects_locations_studies_trials_complete(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-studies-trials-create", Some(opt)) => {
                    call_result = self
                        ._projects_locations_studies_trials_create(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-studies-trials-delete", Some(opt)) => {
                    call_result = self
                        ._projects_locations_studies_trials_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-studies-trials-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_studies_trials_get(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-studies-trials-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_studies_trials_list(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-studies-trials-list-optimal-trials", Some(opt)) => {
                    call_result = self
                        ._projects_locations_studies_trials_list_optimal_trials(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-studies-trials-stop", Some(opt)) => {
                    call_result = self
                        ._projects_locations_studies_trials_stop(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-studies-trials-suggest", Some(opt)) => {
                    call_result = self
                        ._projects_locations_studies_trials_suggest(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("models-get-iam-policy", Some(opt)) => {
                    call_result = self
                        ._projects_models_get_iam_policy(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("models-set-iam-policy", Some(opt)) => {
                    call_result = self
                        ._projects_models_set_iam_policy(opt, dry_run, &mut err)
                        .await;
                }
                ("models-test-iam-permissions", Some(opt)) => {
                    call_result = self
                        ._projects_models_test_iam_permissions(opt, dry_run, &mut err)
                        .await;
                }
                ("models-versions-create", Some(opt)) => {
                    call_result = self
                        ._projects_models_versions_create(opt, dry_run, &mut err)
                        .await;
                }
                ("models-versions-delete", Some(opt)) => {
                    call_result = self
                        ._projects_models_versions_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("models-versions-get", Some(opt)) => {
                    call_result = self
                        ._projects_models_versions_get(opt, dry_run, &mut err)
                        .await;
                }
                ("models-versions-list", Some(opt)) => {
                    call_result = self
                        ._projects_models_versions_list(opt, dry_run, &mut err)
                        .await;
                }
                ("models-versions-patch", Some(opt)) => {
                    call_result = self
                        ._projects_models_versions_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("models-versions-set-default", Some(opt)) => {
                    call_result = self
                        ._projects_models_versions_set_default(opt, dry_run, &mut err)
                        .await;
                }
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "ml1-secret.json",
        ...
        .persist_tokens_to_disk(format!("{}/ml1", config_dir))
        .build()
        .await
        .unwrap();
