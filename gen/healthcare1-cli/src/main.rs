...
use google_healthcare1::{api, yup_oauth2, Error};
...
{
    async fn _projects_locations_datasets_consent_stores_attribute_definitions_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "data-mapping-default-value" => Some((
        ...
        let mut request: api::AttributeDefinition = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_datasets_consent_stores_attribute_definitions_create(
                request,
    ...
    async fn _projects_locations_datasets_consent_stores_attribute_definitions_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_consent_stores_attribute_definitions_delete(
    ...
    async fn _projects_locations_datasets_consent_stores_attribute_definitions_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_consent_stores_attribute_definitions_get(
                opt.value_of("name").unwrap_or(""),
            );
        for parg in opt
            .values_of("v")
    ...
    async fn _projects_locations_datasets_consent_stores_attribute_definitions_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_consent_stores_attribute_definitions_list(
                opt.value_of("parent").unwrap_or(""),
            );
        for parg in opt
            .values_of("v")
    ...
    async fn _projects_locations_datasets_consent_stores_attribute_definitions_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_consent_stores_attribute_definitions_patch(
                request,
                opt.value_of("name").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_datasets_consent_stores_check_data_access(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::CheckDataAccessRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_datasets_consent_stores_check_data_access(
                request,
                opt.value_of("consent-store").unwrap_or(""),
            );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _projects_locations_datasets_consent_stores_consent_artifacts_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "guardian-signature.image.gcs-uri" => Some((
                    "guardianSignature.image.gcsUri",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "guardian-signature.image.raw-bytes" => Some((
                    "guardianSignature.image.rawBytes",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "guardian-signature.metadata" => Some((
                    "guardianSignature.metadata",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Map,
                    },
                )),
                "guardian-signature.signature-time" => Some((
                    "guardianSignature.signatureTime",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "guardian-signature.user-id" => Some((
                    "guardianSignature.userId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                ...
                "user-signature.image.gcs-uri" => Some((
                    "userSignature.image.gcsUri",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "user-signature.image.raw-bytes" => Some((
                    "userSignature.image.rawBytes",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "user-signature.metadata" => Some((
                ...
                "user-signature.signature-time" => Some((
                    "userSignature.signatureTime",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "user-signature.user-id" => Some((
                ...
                "witness-signature.image.gcs-uri" => Some((
                    "witnessSignature.image.gcsUri",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "witness-signature.image.raw-bytes" => Some((
                    "witnessSignature.image.rawBytes",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "witness-signature.metadata" => Some((
                    "witnessSignature.metadata",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Map,
                    },
                )),
                "witness-signature.signature-time" => Some((
                    "witnessSignature.signatureTime",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "witness-signature.user-id" => Some((
                    "witnessSignature.userId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
        ...
        let mut request: api::ConsentArtifact = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_datasets_consent_stores_consent_artifacts_create(
                request,
                opt.value_of("parent").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_datasets_consent_stores_consent_artifacts_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_locations_datasets_consent_stores_consent_artifacts_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_consent_stores_consent_artifacts_get(
                opt.value_of("name").unwrap_or(""),
            );
        for parg in opt
            .values_of("v")
    ...
    async fn _projects_locations_datasets_consent_stores_consent_artifacts_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_consent_stores_consent_artifacts_list(
                opt.value_of("parent").unwrap_or(""),
            );
        for parg in opt
            .values_of("v")
    ...
    async fn _projects_locations_datasets_consent_stores_consents_activate(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec!["consent-artifact", "expire-time", "ttl"],
                    );
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
        ...
        let mut request: api::ActivateConsentRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_datasets_consent_stores_consents_activate(
                request,
                opt.value_of("name").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_datasets_consent_stores_consents_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::Consent = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_datasets_consent_stores_consents_create(
                request,
                opt.value_of("parent").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_datasets_consent_stores_consents_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_consent_stores_consents_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_datasets_consent_stores_consents_delete_revision(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_consent_stores_consents_delete_revision(
                opt.value_of("name").unwrap_or(""),
            );
        for parg in opt
            .values_of("v")
    ...
    async fn _projects_locations_datasets_consent_stores_consents_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_consent_stores_consents_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_datasets_consent_stores_consents_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_consent_stores_consents_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_datasets_consent_stores_consents_list_revisions(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_consent_stores_consents_list_revisions(
                opt.value_of("name").unwrap_or(""),
            );
        for parg in opt
            .values_of("v")
    ...
    async fn _projects_locations_datasets_consent_stores_consents_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_consent_stores_consents_patch(
                request,
                opt.value_of("name").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_datasets_consent_stores_consents_reject(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::RejectConsentRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
    ...
    async fn _projects_locations_datasets_consent_stores_consents_revoke(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::RevokeConsentRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
    ...
    async fn _projects_locations_datasets_consent_stores_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "enable-consent-create-on-update" => Some((
        ...
        let mut request: api::ConsentStore = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
    ...
    async fn _projects_locations_datasets_consent_stores_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_consent_stores_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_datasets_consent_stores_evaluate_user_consents(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::EvaluateUserConsentsRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_datasets_consent_stores_evaluate_user_consents(
                request,
                opt.value_of("consent-store").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_datasets_consent_stores_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_consent_stores_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_datasets_consent_stores_get_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_consent_stores_get_iam_policy(
    ...
    async fn _projects_locations_datasets_consent_stores_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_consent_stores_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_datasets_consent_stores_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_consent_stores_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_datasets_consent_stores_query_accessible_data(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                "gcs-destination.uri-prefix" => Some((
        ...
        let mut request: api::QueryAccessibleDataRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
    ...
    async fn _projects_locations_datasets_consent_stores_set_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_consent_stores_set_iam_policy(
                request,
                opt.value_of("resource").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_datasets_consent_stores_test_iam_permissions(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_consent_stores_test_iam_permissions(
                request,
                opt.value_of("resource").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_datasets_consent_stores_user_data_mappings_archive(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::ArchiveUserDataMappingRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_datasets_consent_stores_user_data_mappings_archive(
                request,
                opt.value_of("name").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_datasets_consent_stores_user_data_mappings_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec!["archive-time", "archived", "data-id", "name", "user-id"],
                    );
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
        ...
        let mut request: api::UserDataMapping = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_datasets_consent_stores_user_data_mappings_create(
                request,
                opt.value_of("parent").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_datasets_consent_stores_user_data_mappings_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_consent_stores_user_data_mappings_delete(
                opt.value_of("name").unwrap_or(""),
            );
        for parg in opt
            .values_of("v")
    ...
    async fn _projects_locations_datasets_consent_stores_user_data_mappings_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_consent_stores_user_data_mappings_get(
                opt.value_of("name").unwrap_or(""),
            );
        for parg in opt
            .values_of("v")
    ...
    async fn _projects_locations_datasets_consent_stores_user_data_mappings_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_consent_stores_user_data_mappings_list(
                opt.value_of("parent").unwrap_or(""),
            );
        for parg in opt
            .values_of("v")
    ...
    async fn _projects_locations_datasets_consent_stores_user_data_mappings_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_consent_stores_user_data_mappings_patch(
                request,
                opt.value_of("name").unwrap_or(""),
            );
        for parg in opt
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec!["encryption-spec", "kms-key-name", "name", "time-zone"],
                    );
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
    ...
    async fn _projects_locations_datasets_data_mapper_workspaces_get_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_data_mapper_workspaces_get_iam_policy(
                opt.value_of("resource").unwrap_or(""),
            );
        for parg in opt
            .values_of("v")
    ...
    async fn _projects_locations_datasets_data_mapper_workspaces_set_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_locations_datasets_data_mapper_workspaces_test_iam_permissions(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_locations_datasets_deidentify(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                "config.dicom.filter-profile" => Some((
                    "config.dicom.filterProfile",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "config.dicom.keep-list.tags" => Some((
                    "config.dicom.keepList.tags",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "config.dicom.remove-list.tags" => Some((
                    "config.dicom.removeList.tags",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "config.dicom.skip-id-redaction" => Some((
                    "config.dicom.skipIdRedaction",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "config.fhir.default-keep-extensions" => Some((
                    "config.fhir.defaultKeepExtensions",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "config.image.text-redaction-mode" => Some((
                    "config.image.textRedactionMode",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "config.text.exclude-info-types" => Some((
                    "config.text.excludeInfoTypes",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "config.use-regional-data-processing" => Some((
                    "config.useRegionalDataProcessing",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "destination-dataset" => Some((
                    "destinationDataset",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
        ...
        let mut request: api::DeidentifyDatasetRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_datasets_deidentify(request, opt.value_of("source-dataset").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_datasets_dicom_stores_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "notification-config.send-for-bulk-import" => Some((
        ...
        let mut request: api::DicomStore = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_datasets_dicom_stores_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_datasets_dicom_stores_deidentify(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "filter-config.resource-paths-gcs-uri" => Some((
                    "filterConfig.resourcePathsGcsUri",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
        ...
        let mut request: api::DeidentifyDicomStoreRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_datasets_dicom_stores_deidentify(
                request,
                opt.value_of("source-store").unwrap_or(""),
            );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _projects_locations_datasets_dicom_stores_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_dicom_stores_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_datasets_dicom_stores_dicom_web_studies_get_study_metrics(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_locations_datasets_dicom_stores_dicom_web_studies_series_get_series_metrics(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_dicom_stores_dicom_web_studies_series_get_series_metrics(
                opt.value_of("series").unwrap_or(""),
            );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _projects_locations_datasets_dicom_stores_export(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                "bigquery-destination.force" => Some((
                ...
                "bigquery-destination.table-uri" => Some((
                ...
                "bigquery-destination.write-disposition" => Some((
                ...
                "gcs-destination.mime-type" => Some((
        ...
        let mut request: api::ExportDicomDataRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_datasets_dicom_stores_export(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_datasets_dicom_stores_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_dicom_stores_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_datasets_dicom_stores_get_dicom_store_metrics(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_dicom_stores_get_dicom_store_metrics(
                opt.value_of("name").unwrap_or(""),
            );
        for parg in opt
            .values_of("v")
    ...
    async fn _projects_locations_datasets_dicom_stores_get_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_dicom_stores_get_iam_policy(opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_datasets_dicom_stores_import(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::ImportDicomDataRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_datasets_dicom_stores_import(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_datasets_dicom_stores_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_dicom_stores_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_datasets_dicom_stores_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_dicom_stores_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_datasets_dicom_stores_search_for_instances(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_dicom_stores_search_for_instances(
                opt.value_of("parent").unwrap_or(""),
                opt.value_of("dicom-web-path").unwrap_or(""),
            );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _projects_locations_datasets_dicom_stores_search_for_series(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_locations_datasets_dicom_stores_search_for_studies(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_locations_datasets_dicom_stores_set_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_dicom_stores_set_iam_policy(
                request,
                opt.value_of("resource").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_datasets_dicom_stores_store_instances(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::HttpBody = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_datasets_dicom_stores_store_instances(
                request,
                opt.value_of("parent").unwrap_or(""),
                opt.value_of("dicom-web-path").unwrap_or(""),
            );
    ...
    async fn _projects_locations_datasets_dicom_stores_studies_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_dicom_stores_studies_delete(
                opt.value_of("parent").unwrap_or(""),
                opt.value_of("dicom-web-path").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_datasets_dicom_stores_studies_retrieve_metadata(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_dicom_stores_studies_retrieve_metadata(
                opt.value_of("parent").unwrap_or(""),
                opt.value_of("dicom-web-path").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_datasets_dicom_stores_studies_retrieve_study(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_dicom_stores_studies_retrieve_study(
                opt.value_of("parent").unwrap_or(""),
                opt.value_of("dicom-web-path").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_datasets_dicom_stores_studies_search_for_instances(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_dicom_stores_studies_search_for_instances(
                opt.value_of("parent").unwrap_or(""),
                opt.value_of("dicom-web-path").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_datasets_dicom_stores_studies_search_for_series(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_dicom_stores_studies_search_for_series(
                opt.value_of("parent").unwrap_or(""),
                opt.value_of("dicom-web-path").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_datasets_dicom_stores_studies_series_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_locations_datasets_dicom_stores_studies_series_instances_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_locations_datasets_dicom_stores_studies_series_instances_frames_retrieve_frames(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_locations_datasets_dicom_stores_studies_series_instances_frames_retrieve_rendered(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_locations_datasets_dicom_stores_studies_series_instances_retrieve_instance(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_locations_datasets_dicom_stores_studies_series_instances_retrieve_metadata(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_locations_datasets_dicom_stores_studies_series_instances_retrieve_rendered(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_locations_datasets_dicom_stores_studies_series_retrieve_metadata(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_dicom_stores_studies_series_retrieve_metadata(
                opt.value_of("parent").unwrap_or(""),
                opt.value_of("dicom-web-path").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_datasets_dicom_stores_studies_series_retrieve_series(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_dicom_stores_studies_series_retrieve_series(
                opt.value_of("parent").unwrap_or(""),
                opt.value_of("dicom-web-path").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_datasets_dicom_stores_studies_series_search_for_instances(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_dicom_stores_studies_series_search_for_instances(
                opt.value_of("parent").unwrap_or(""),
                opt.value_of("dicom-web-path").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_datasets_dicom_stores_studies_store_instances(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_dicom_stores_studies_store_instances(
                request,
                opt.value_of("parent").unwrap_or(""),
                opt.value_of("dicom-web-path").unwrap_or(""),
            );
    ...
    async fn _projects_locations_datasets_dicom_stores_test_iam_permissions(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_dicom_stores_test_iam_permissions(
                request,
                opt.value_of("resource").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_datasets_fhir_stores_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                "complex-data-type-reference-parsing" => Some((
                ...
                "default-search-handling-strict" => Some((
                ...
                "disable-referential-integrity" => Some((
                ...
                "disable-resource-versioning" => Some((
                ...
                "validation-config.disable-fhirpath-validation" => Some((
                    "validationConfig.disableFhirpathValidation",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "validation-config.disable-profile-validation" => Some((
                    "validationConfig.disableProfileValidation",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "validation-config.disable-reference-type-validation" => Some((
                    "validationConfig.disableReferenceTypeValidation",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "validation-config.disable-required-field-validation" => Some((
                    "validationConfig.disableRequiredFieldValidation",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "validation-config.enabled-implementation-guides" => Some((
                    "validationConfig.enabledImplementationGuides",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
        ...
        let mut request: api::FhirStore = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_datasets_fhir_stores_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_datasets_fhir_stores_deidentify(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "resource-filter.resources.resources" => Some((
        ...
        let mut request: api::DeidentifyFhirStoreRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_datasets_fhir_stores_deidentify(
                request,
                opt.value_of("source-store").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_datasets_fhir_stores_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_fhir_stores_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_datasets_fhir_stores_export(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::ExportResourcesRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_datasets_fhir_stores_export(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_datasets_fhir_stores_fhir__patient_everything(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            match key {
                ...
                "-count" => {
                    call = call._count(
                        value
                            .map(|v| arg_from_str(v, err, "-count", "int32"))
                            .unwrap_or(-0),
                    );
                }
                _ => {
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["-count", "-page-token", "-since", "-type", "end", "start"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _projects_locations_datasets_fhir_stores_fhir__resource_purge(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_locations_datasets_fhir_stores_fhir__resource_validate(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_locations_datasets_fhir_stores_fhir_capabilities(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_fhir_stores_fhir_capabilities(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_datasets_fhir_stores_fhir_conditional_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_fhir_stores_fhir_conditional_delete(
                opt.value_of("parent").unwrap_or(""),
                opt.value_of("type").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_datasets_fhir_stores_fhir_conditional_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_fhir_stores_fhir_conditional_patch(
                request,
                opt.value_of("parent").unwrap_or(""),
                opt.value_of("type").unwrap_or(""),
            );
    ...
    async fn _projects_locations_datasets_fhir_stores_fhir_conditional_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_fhir_stores_fhir_conditional_update(
                request,
                opt.value_of("parent").unwrap_or(""),
                opt.value_of("type").unwrap_or(""),
            );
    ...
    async fn _projects_locations_datasets_fhir_stores_fhir_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_fhir_stores_fhir_create(
                request,
                opt.value_of("parent").unwrap_or(""),
                opt.value_of("type").unwrap_or(""),
            );
    ...
    async fn _projects_locations_datasets_fhir_stores_fhir_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_fhir_stores_fhir_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_datasets_fhir_stores_fhir_execute_bundle(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_fhir_stores_fhir_execute_bundle(
                request,
                opt.value_of("parent").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_datasets_fhir_stores_fhir_history(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_fhir_stores_fhir_history(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_datasets_fhir_stores_fhir_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_fhir_stores_fhir_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_datasets_fhir_stores_fhir_read(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_fhir_stores_fhir_read(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_datasets_fhir_stores_fhir_search(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::SearchResourcesRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_datasets_fhir_stores_fhir_search(
                request,
                opt.value_of("parent").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_datasets_fhir_stores_fhir_search_type(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_fhir_stores_fhir_search_type(
                request,
                opt.value_of("parent").unwrap_or(""),
                opt.value_of("resource-type").unwrap_or(""),
            );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _projects_locations_datasets_fhir_stores_fhir_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_fhir_stores_fhir_update(
                request,
                opt.value_of("name").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_datasets_fhir_stores_fhir_vread(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_fhir_stores_fhir_vread(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_datasets_fhir_stores_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_fhir_stores_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_datasets_fhir_stores_get_fhir_store_metrics(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_fhir_stores_get_fhir_store_metrics(
                opt.value_of("name").unwrap_or(""),
            );
        for parg in opt
            .values_of("v")
    ...
    async fn _projects_locations_datasets_fhir_stores_get_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_fhir_stores_get_iam_policy(opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_datasets_fhir_stores_import(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec!["content-structure", "gcs-source", "uri"],
                    );
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
        ...
        let mut request: api::ImportResourcesRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_datasets_fhir_stores_import(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_datasets_fhir_stores_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_fhir_stores_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_datasets_fhir_stores_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_fhir_stores_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_datasets_fhir_stores_rollback(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "filtering-fields.metadata-filter" => Some((
                    "filteringFields.metadataFilter",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "filtering-fields.operation-ids" => Some((
                    "filteringFields.operationIds",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
        ...
        let mut request: api::RollbackFhirResourcesRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_datasets_fhir_stores_rollback(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_datasets_fhir_stores_set_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_fhir_stores_set_iam_policy(
                request,
                opt.value_of("resource").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_datasets_fhir_stores_test_iam_permissions(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_fhir_stores_test_iam_permissions(
                request,
                opt.value_of("resource").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_datasets_get_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_get_iam_policy(opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_datasets_hl7_v2_stores_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "parser-config.allow-null-header" => Some((
                    "parserConfig.allowNullHeader",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "parser-config.schema.ignore-min-occurs" => Some((
                    "parserConfig.schema.ignoreMinOccurs",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "parser-config.schema.schematized-parsing-type" => Some((
                    "parserConfig.schema.schematizedParsingType",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "parser-config.schema.unexpected-segment-handling" => Some((
                    "parserConfig.schema.unexpectedSegmentHandling",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "parser-config.segment-terminator" => Some((
                    "parserConfig.segmentTerminator",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "parser-config.version" => Some((
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        ...
                        &vec![
                            ...
                            "schema",
                            "schematized-parsing-type",
                            "segment-terminator",
                            "unexpected-segment-handling",
                            "version",
                        ],
                    );
                    err.issues.push(CLIError::Field(FieldError::Unknown(
        ...
        let mut request: api::Hl7V2Store = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_datasets_hl7_v2_stores_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_datasets_hl7_v2_stores_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_hl7_v2_stores_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_datasets_hl7_v2_stores_export(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "gcs-destination.content-structure" => Some((
                ...
                "gcs-destination.message-view" => Some((
                    "gcsDestination.messageView",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                ...
                "pubsub-destination.pubsub-topic" => Some((
                    "pubsubDestination.pubsubTopic",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
        ...
        let mut request: api::ExportMessagesRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_datasets_hl7_v2_stores_export(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_datasets_hl7_v2_stores_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_hl7_v2_stores_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_datasets_hl7_v2_stores_get_hl7v2_store_metrics(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_hl7_v2_stores_get_hl7v2_store_metrics(
                opt.value_of("name").unwrap_or(""),
            );
        for parg in opt
            .values_of("v")
    ...
    async fn _projects_locations_datasets_hl7_v2_stores_get_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_hl7_v2_stores_get_iam_policy(
                opt.value_of("resource").unwrap_or(""),
            );
        for parg in opt
            .values_of("v")
    ...
    async fn _projects_locations_datasets_hl7_v2_stores_import(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::ImportMessagesRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_datasets_hl7_v2_stores_import(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_datasets_hl7_v2_stores_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_hl7_v2_stores_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_datasets_hl7_v2_stores_messages_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "message.schematized-data.data" => Some((
                    "message.schematizedData.data",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "message.schematized-data.error" => Some((
                    "message.schematizedData.error",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "message.send-facility" => Some((
                    "message.sendFacility",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "message.send-time" => Some((
                    "message.sendTime",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
        ...
        let mut request: api::CreateMessageRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_datasets_hl7_v2_stores_messages_create(
                request,
                opt.value_of("parent").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_datasets_hl7_v2_stores_messages_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_hl7_v2_stores_messages_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_datasets_hl7_v2_stores_messages_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_hl7_v2_stores_messages_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_datasets_hl7_v2_stores_messages_ingest(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::IngestMessageRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_datasets_hl7_v2_stores_messages_ingest(
                request,
                opt.value_of("parent").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_datasets_hl7_v2_stores_messages_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_hl7_v2_stores_messages_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_datasets_hl7_v2_stores_messages_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "schematized-data.error" => Some((
                    "schematizedData.error",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
        ...
        let mut request: api::Message = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_datasets_hl7_v2_stores_messages_patch(
                request,
                opt.value_of("name").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_datasets_hl7_v2_stores_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_hl7_v2_stores_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_datasets_hl7_v2_stores_set_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_hl7_v2_stores_set_iam_policy(
                request,
                opt.value_of("resource").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_datasets_hl7_v2_stores_test_iam_permissions(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_hl7_v2_stores_test_iam_permissions(
                request,
                opt.value_of("resource").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_datasets_operations_cancel(
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_operations_cancel(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_datasets_set_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_datasets_set_iam_policy(request, opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_datasets_test_iam_permissions(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::TestIamPermissionsRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.projects().locations_datasets_test_iam_permissions(
            request,
            opt.value_of("resource").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _projects_locations_services_nlp_analyze_entities(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                "alternative-output-format" => Some((
        ...
        let mut request: api::AnalyzeEntitiesRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.projects().locations_services_nlp_analyze_entities(
            request,
            opt.value_of("nlp-service").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "healthcare1-secret.json",
        ...
        .persist_tokens_to_disk(format!("{}/healthcare1", config_dir))
        .build()
        .await
        .unwrap();
    ...
    let arg_data = [
        ("projects", "methods: 'locations-datasets-consent-stores-attribute-definitions-create', 'locations-datasets-consent-stores-attribute-definitions-delete', 'locations-datasets-consent-stores-attribute-definitions-get', 'locations-datasets-consent-stores-attribute-definitions-list', 'locations-datasets-consent-stores-attribute-definitions-patch', 'locations-datasets-consent-stores-check-data-access', 'locations-datasets-consent-stores-consent-artifacts-create', 'locations-datasets-consent-stores-consent-artifacts-delete', 'locations-datasets-consent-stores-consent-artifacts-get', 'locations-datasets-consent-stores-consent-artifacts-list', 'locations-datasets-consent-stores-consents-activate', 'locations-datasets-consent-stores-consents-create', 'locations-datasets-consent-stores-consents-delete', 'locations-datasets-consent-stores-consents-delete-revision', 'locations-datasets-consent-stores-consents-get', 'locations-datasets-consent-stores-consents-list', 'locations-datasets-consent-stores-consents-list-revisions', 'locations-datasets-consent-stores-consents-patch', 'locations-datasets-consent-stores-consents-reject', 'locations-datasets-consent-stores-consents-revoke', 'locations-datasets-consent-stores-create', 'locations-datasets-consent-stores-delete', 'locations-datasets-consent-stores-evaluate-user-consents', 'locations-datasets-consent-stores-get', 'locations-datasets-consent-stores-get-iam-policy', 'locations-datasets-consent-stores-list', 'locations-datasets-consent-stores-patch', 'locations-datasets-consent-stores-query-accessible-data', 'locations-datasets-consent-stores-set-iam-policy', 'locations-datasets-consent-stores-test-iam-permissions', 'locations-datasets-consent-stores-user-data-mappings-archive', 'locations-datasets-consent-stores-user-data-mappings-create', 'locations-datasets-consent-stores-user-data-mappings-delete', 'locations-datasets-consent-stores-user-data-mappings-get', 'locations-datasets-consent-stores-user-data-mappings-list', 'locations-datasets-consent-stores-user-data-mappings-patch', 'locations-datasets-create', 'locations-datasets-data-mapper-workspaces-get-iam-policy', 'locations-datasets-data-mapper-workspaces-set-iam-policy', 'locations-datasets-data-mapper-workspaces-test-iam-permissions', 'locations-datasets-deidentify', 'locations-datasets-delete', 'locations-datasets-dicom-stores-create', 'locations-datasets-dicom-stores-deidentify', 'locations-datasets-dicom-stores-delete', 'locations-datasets-dicom-stores-dicom-web-studies-get-study-metrics', 'locations-datasets-dicom-stores-dicom-web-studies-series-get-series-metrics', 'locations-datasets-dicom-stores-export', 'locations-datasets-dicom-stores-get', 'locations-datasets-dicom-stores-get-dicom-store-metrics', 'locations-datasets-dicom-stores-get-iam-policy', 'locations-datasets-dicom-stores-import', 'locations-datasets-dicom-stores-list', 'locations-datasets-dicom-stores-patch', 'locations-datasets-dicom-stores-search-for-instances', 'locations-datasets-dicom-stores-search-for-series', 'locations-datasets-dicom-stores-search-for-studies', 'locations-datasets-dicom-stores-set-iam-policy', 'locations-datasets-dicom-stores-store-instances', 'locations-datasets-dicom-stores-studies-delete', 'locations-datasets-dicom-stores-studies-retrieve-metadata', 'locations-datasets-dicom-stores-studies-retrieve-study', 'locations-datasets-dicom-stores-studies-search-for-instances', 'locations-datasets-dicom-stores-studies-search-for-series', 'locations-datasets-dicom-stores-studies-series-delete', 'locations-datasets-dicom-stores-studies-series-instances-delete', 'locations-datasets-dicom-stores-studies-series-instances-frames-retrieve-frames', 'locations-datasets-dicom-stores-studies-series-instances-frames-retrieve-rendered', 'locations-datasets-dicom-stores-studies-series-instances-retrieve-instance', 'locations-datasets-dicom-stores-studies-series-instances-retrieve-metadata', 'locations-datasets-dicom-stores-studies-series-instances-retrieve-rendered', 'locations-datasets-dicom-stores-studies-series-retrieve-metadata', 'locations-datasets-dicom-stores-studies-series-retrieve-series', 'locations-datasets-dicom-stores-studies-series-search-for-instances', 'locations-datasets-dicom-stores-studies-store-instances', 'locations-datasets-dicom-stores-test-iam-permissions', 'locations-datasets-fhir-stores-create', 'locations-datasets-fhir-stores-deidentify', 'locations-datasets-fhir-stores-delete', 'locations-datasets-fhir-stores-export', 'locations-datasets-fhir-stores-fhir--patient-everything', 'locations-datasets-fhir-stores-fhir--resource-purge', 'locations-datasets-fhir-stores-fhir--resource-validate', 'locations-datasets-fhir-stores-fhir-capabilities', 'locations-datasets-fhir-stores-fhir-conditional-delete', 'locations-datasets-fhir-stores-fhir-conditional-patch', 'locations-datasets-fhir-stores-fhir-conditional-update', 'locations-datasets-fhir-stores-fhir-create', 'locations-datasets-fhir-stores-fhir-delete', 'locations-datasets-fhir-stores-fhir-execute-bundle', 'locations-datasets-fhir-stores-fhir-history', 'locations-datasets-fhir-stores-fhir-patch', 'locations-datasets-fhir-stores-fhir-read', 'locations-datasets-fhir-stores-fhir-search', 'locations-datasets-fhir-stores-fhir-search-type', 'locations-datasets-fhir-stores-fhir-update', 'locations-datasets-fhir-stores-fhir-vread', 'locations-datasets-fhir-stores-get', 'locations-datasets-fhir-stores-get-fhir-store-metrics', 'locations-datasets-fhir-stores-get-iam-policy', 'locations-datasets-fhir-stores-import', 'locations-datasets-fhir-stores-list', 'locations-datasets-fhir-stores-patch', 'locations-datasets-fhir-stores-rollback', 'locations-datasets-fhir-stores-set-iam-policy', 'locations-datasets-fhir-stores-test-iam-permissions', 'locations-datasets-get', 'locations-datasets-get-iam-policy', 'locations-datasets-hl7-v2-stores-create', 'locations-datasets-hl7-v2-stores-delete', 'locations-datasets-hl7-v2-stores-export', 'locations-datasets-hl7-v2-stores-get', 'locations-datasets-hl7-v2-stores-get-hl7v2-store-metrics', 'locations-datasets-hl7-v2-stores-get-iam-policy', 'locations-datasets-hl7-v2-stores-import', 'locations-datasets-hl7-v2-stores-list', 'locations-datasets-hl7-v2-stores-messages-create', 'locations-datasets-hl7-v2-stores-messages-delete', 'locations-datasets-hl7-v2-stores-messages-get', 'locations-datasets-hl7-v2-stores-messages-ingest', 'locations-datasets-hl7-v2-stores-messages-list', 'locations-datasets-hl7-v2-stores-messages-patch', 'locations-datasets-hl7-v2-stores-patch', 'locations-datasets-hl7-v2-stores-set-iam-policy', 'locations-datasets-hl7-v2-stores-test-iam-permissions', 'locations-datasets-list', 'locations-datasets-operations-cancel', 'locations-datasets-operations-get', 'locations-datasets-operations-list', 'locations-datasets-patch', 'locations-datasets-set-iam-policy', 'locations-datasets-test-iam-permissions', 'locations-get', 'locations-list' and 'locations-services-nlp-analyze-entities'", vec![
            ...
            ("locations-datasets-consent-stores-attribute-definitions-delete",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_healthcare1_cli/projects_locations-datasets-consent-stores-attribute-definitions-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-datasets-consent-stores-attribute-definitions-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_healthcare1_cli/projects_locations-datasets-consent-stores-attribute-definitions-get",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-datasets-consent-stores-attribute-definitions-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_healthcare1_cli/projects_locations-datasets-consent-stores-attribute-definitions-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("locations-datasets-consent-stores-attribute-definitions-patch",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_healthcare1_cli/projects_locations-datasets-consent-stores-attribute-definitions-patch",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-datasets-consent-stores-check-data-access",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_healthcare1_cli/projects_locations-datasets-consent-stores-check-data-access",
                  vec![
            ...
            ("locations-datasets-consent-stores-consent-artifacts-create",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_healthcare1_cli/projects_locations-datasets-consent-stores-consent-artifacts-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("locations-datasets-consent-stores-consent-artifacts-delete",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_healthcare1_cli/projects_locations-datasets-consent-stores-consent-artifacts-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-datasets-consent-stores-consent-artifacts-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_healthcare1_cli/projects_locations-datasets-consent-stores-consent-artifacts-get",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-datasets-consent-stores-consent-artifacts-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_healthcare1_cli/projects_locations-datasets-consent-stores-consent-artifacts-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("locations-datasets-consent-stores-consents-activate",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_healthcare1_cli/projects_locations-datasets-consent-stores-consents-activate",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-datasets-consent-stores-consents-create",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_healthcare1_cli/projects_locations-datasets-consent-stores-consents-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("locations-datasets-consent-stores-consents-delete",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_healthcare1_cli/projects_locations-datasets-consent-stores-consents-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-datasets-consent-stores-consents-delete-revision",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_healthcare1_cli/projects_locations-datasets-consent-stores-consents-delete-revision",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-datasets-consent-stores-consents-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_healthcare1_cli/projects_locations-datasets-consent-stores-consents-get",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-datasets-consent-stores-consents-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_healthcare1_cli/projects_locations-datasets-consent-stores-consents-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("locations-datasets-consent-stores-consents-list-revisions",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_healthcare1_cli/projects_locations-datasets-consent-stores-consents-list-revisions",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-datasets-consent-stores-consents-patch",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_healthcare1_cli/projects_locations-datasets-consent-stores-consents-patch",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-datasets-consent-stores-consents-reject",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_healthcare1_cli/projects_locations-datasets-consent-stores-consents-reject",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-datasets-consent-stores-consents-revoke",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_healthcare1_cli/projects_locations-datasets-consent-stores-consents-revoke",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-datasets-consent-stores-create",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_healthcare1_cli/projects_locations-datasets-consent-stores-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("locations-datasets-consent-stores-delete",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_healthcare1_cli/projects_locations-datasets-consent-stores-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-datasets-consent-stores-evaluate-user-consents",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_healthcare1_cli/projects_locations-datasets-consent-stores-evaluate-user-consents",
                  vec![
                    (Some(r##"consent-store"##),
                     None,
            ...
            ("locations-datasets-consent-stores-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_healthcare1_cli/projects_locations-datasets-consent-stores-get",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-datasets-consent-stores-get-iam-policy",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_healthcare1_cli/projects_locations-datasets-consent-stores-get-iam-policy",
                  vec![
                    (Some(r##"resource"##),
                     None,
            ...
            ("locations-datasets-consent-stores-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_healthcare1_cli/projects_locations-datasets-consent-stores-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("locations-datasets-consent-stores-patch",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_healthcare1_cli/projects_locations-datasets-consent-stores-patch",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-datasets-consent-stores-query-accessible-data",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_healthcare1_cli/projects_locations-datasets-consent-stores-query-accessible-data",
                  vec![
                    (Some(r##"consent-store"##),
                     None,
                     Some(r##"Required. Name of the consent store to retrieve User data mappings from."##),
            ...
            ("locations-datasets-consent-stores-set-iam-policy",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_healthcare1_cli/projects_locations-datasets-consent-stores-set-iam-policy",
                  vec![
                    (Some(r##"resource"##),
                     None,
            ...
            ("locations-datasets-consent-stores-test-iam-permissions",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_healthcare1_cli/projects_locations-datasets-consent-stores-test-iam-permissions",
                  vec![
                    (Some(r##"resource"##),
                     None,
            ...
            ("locations-datasets-consent-stores-user-data-mappings-archive",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_healthcare1_cli/projects_locations-datasets-consent-stores-user-data-mappings-archive",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-datasets-consent-stores-user-data-mappings-create",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_healthcare1_cli/projects_locations-datasets-consent-stores-user-data-mappings-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. Name of the consent store."##),
            ...
            ("locations-datasets-consent-stores-user-data-mappings-delete",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_healthcare1_cli/projects_locations-datasets-consent-stores-user-data-mappings-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-datasets-consent-stores-user-data-mappings-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_healthcare1_cli/projects_locations-datasets-consent-stores-user-data-mappings-get",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-datasets-consent-stores-user-data-mappings-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_healthcare1_cli/projects_locations-datasets-consent-stores-user-data-mappings-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. Name of the consent store to retrieve User data mappings from."##),
            ...
            ("locations-datasets-consent-stores-user-data-mappings-patch",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_healthcare1_cli/projects_locations-datasets-consent-stores-user-data-mappings-patch",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-datasets-dicom-stores-export",
                    Some(r##"Exports data to the specified destination by copying it from the DICOM store. Errors are also logged to Cloud Logging. For more information, see [Viewing error logs in Cloud Logging](https://cloud.google.com/healthcare/docs/how-tos/logging). The metadata field type is OperationMetadata."##),
            ...
            ("locations-datasets-fhir-stores-fhir--resource-validate",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_healthcare1_cli/projects_locations-datasets-fhir-stores-fhir--resource-validate",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("locations-datasets-fhir-stores-fhir-patch",
                    Some(r##"Updates part of an existing resource by applying the operations specified in a [JSON Patch](http://jsonpatch.com/) document. Implements the FHIR standard patch interaction ([STU3](http://hl7.org/implement/standards/fhir/STU3/http.html#patch), [R4](http://hl7.org/implement/standards/fhir/R4/http.html#patch)). DSTU2 doesn't define a patch method, but the server supports it in the same way it supports STU3. The request body must contain a JSON Patch document, and the request headers must contain `Content-Type: application/json-patch+json`. On success, the response body contains a JSON-encoded representation of the updated resource, including the server-assigned version ID. Errors generated by the FHIR store contain a JSON-encoded `OperationOutcome` resource describing the reason for the error. If the request cannot be mapped to a valid API method on a FHIR store, a generic GCP error might be returned instead. For samples that show how to call `patch`, see [Patching a FHIR resource](https://cloud.google.com/healthcare/docs/how-tos/fhir-resources#patching_a_fhir_resource)."##),
            ...
            ("locations-datasets-fhir-stores-fhir-update",
                    Some(r##"Updates the entire contents of a resource. Implements the FHIR standard update interaction ([DSTU2](http://hl7.org/implement/standards/fhir/DSTU2/http.html#update), [STU3](http://hl7.org/implement/standards/fhir/STU3/http.html#update), [R4](http://hl7.org/implement/standards/fhir/R4/http.html#update)). If the specified resource does not exist and the FHIR store has enable_update_create set, creates the resource with the client-specified ID. It is strongly advised not to include or encode any sensitive data such as patient identifiers in client-specified resource IDs. Those IDs are part of the FHIR resource path recorded in Cloud Audit Logs and Pub/Sub notifications. Those IDs can also be contained in reference fields within other resources. The request body must contain a JSON-encoded FHIR resource, and the request headers must contain `Content-Type: application/fhir+json`. The resource must contain an `id` element having an identical value to the ID in the REST path of the request. On success, the response body contains a JSON-encoded representation of the updated resource, including the server-assigned version ID. Errors generated by the FHIR store contain a JSON-encoded `OperationOutcome` resource describing the reason for the error. If the request cannot be mapped to a valid API method on a FHIR store, a generic GCP error might be returned instead. For samples that show how to call `update`, see [Updating a FHIR resource](https://cloud.google.com/healthcare/docs/how-tos/fhir-resources#updating_a_fhir_resource)."##),
            ...
            ("locations-datasets-fhir-stores-patch",
                  ...
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Output only. Identifier. Resource name of the FHIR store, of the form `projects/{project_id}/locations/{location}/datasets/{dataset_id}/fhirStores/{fhir_store_id}`."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("locations-datasets-hl7-v2-stores-export",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_healthcare1_cli/projects_locations-datasets-hl7-v2-stores-export",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-datasets-hl7-v2-stores-import",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_healthcare1_cli/projects_locations-datasets-hl7-v2-stores-import",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-datasets-hl7-v2-stores-messages-patch",
                    Some(r##"Update the message. The contents of the message in Message.data and data extracted from the contents such as Message.create_time cannot be altered. Only the Message.labels field is allowed to be updated. The labels in the request are merged with the existing set of labels. Existing labels with the same keys are updated."##),
            ...
            ("locations-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_healthcare1_cli/projects_locations-get",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_healthcare1_cli/projects_locations-list",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-services-nlp-analyze-entities",
                    Some(r##"Analyze heathcare entity in a document. Its response includes the recognized entity mentions and the relationships between them. AnalyzeEntities uses context aware models to detect entities."##),
                    "Details at http://byron.github.io/google-apis-rs/google_healthcare1_cli/projects_locations-services-nlp-analyze-entities",
                  vec![
                    (Some(r##"nlp-service"##),
                     None,
