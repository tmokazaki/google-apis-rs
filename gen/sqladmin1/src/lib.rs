...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/sqladmin1).
//! # Features
//!
...
//! * [users](api::User)
//!  * [*delete*](api::UserDeleteCall), [*get*](api::UserGetCall), [*insert*](api::UserInsertCall), [*list*](api::UserListCall) and [*update*](api::UserUpdateCall)
//!
//!
//!
//!
