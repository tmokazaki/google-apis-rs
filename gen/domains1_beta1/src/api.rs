...
impl<C> common::Hub for CloudDomains<C> {}

impl<'a, C> CloudDomains<C> {
...
impl common::ResponseResult for AuthorizationCode {}
...
impl common::RequestValue for ConfigureContactSettingsRequest {}
...
impl common::RequestValue for ConfigureDnsSettingsRequest {}
...
impl common::RequestValue for ConfigureManagementSettingsRequest {}
...
impl common::Part for ContactSettings {}
...
impl common::Part for CustomDns {}
...
pub struct DnsSettings {
    ...
    #[serde(rename = "googleDomainsRedirectsDataAvailable")]
    pub google_domains_redirects_data_available: Option<bool>,
}

impl common::Part for DnsSettings {}
...
impl common::Part for DomainForwarding {}
...
pub struct EmailForwarding {
    ...
    #[serde(rename = "targetEmailAddress")]
    pub target_email_address: Option<String>,
}

impl common::Part for EmailForwarding {}
...
impl common::RequestValue for ExportRegistrationRequest {}
...
impl common::Part for GeoPolicy {}
...
pub struct GeoPolicyItem {
    ...
    #[serde(rename = "signatureRrdata")]
    pub signature_rrdata: Option<Vec<String>>,
}

impl common::Part for GeoPolicyItem {}
...
impl common::Part for GlueRecord {}
...
impl common::Part for GoogleDomainsDns {}
...
pub struct HealthCheckTargets {
    ...
    #[serde(rename = "internalLoadBalancer")]
    pub internal_load_balancer: Option<Vec<LoadBalancerTarget>>,
}

impl common::Part for HealthCheckTargets {}
...
impl common::RequestValue for ImportDomainRequest {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [locations registrations initiate push transfer projects](ProjectLocationRegistrationInitiatePushTransferCall) (request)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
...
impl common::RequestValue for InitiatePushTransferRequest {}
...
impl common::ResponseResult for ListRegistrationsResponse {}
...
impl common::Part for LoadBalancerTarget {}
...
pub struct ManagementSettings {
    ...
    #[serde(rename = "effectiveTransferLockState")]
...
impl common::Part for ManagementSettings {}
...
/// * [locations registrations initiate push transfer projects](ProjectLocationRegistrationInitiatePushTransferCall) (response)
...
/// * [locations registrations renew domain projects](ProjectLocationRegistrationRenewDomainCall) (response)
...
impl common::Part for PostalAddress {}
...
impl common::Part for PrimaryBackupPolicy {}
...
impl common::RequestValue for RegisterDomainRequest {}
...
impl common::Part for RegisterParameters {}
...
impl common::RequestValue for Registration {}
impl common::ResponseResult for Registration {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [locations registrations renew domain projects](ProjectLocationRegistrationRenewDomainCall) (request)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
...
impl common::RequestValue for RenewDomainRequest {}
...
impl common::RequestValue for ResetAuthorizationCodeRequest {}
...
impl common::Part for ResourceRecordSet {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [locations registrations retrieve google domains dns records projects](ProjectLocationRegistrationRetrieveGoogleDomainsDnsRecordCall) (response)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
...
impl common::ResponseResult for RetrieveGoogleDomainsDnsRecordsResponse {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [locations registrations retrieve google domains forwarding config projects](ProjectLocationRegistrationRetrieveGoogleDomainsForwardingConfigCall) (response)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
pub struct RetrieveGoogleDomainsForwardingConfigResponse {
    ...
    #[serde(rename = "domainForwardings")]
    ...
    #[serde(rename = "emailForwardings")]
    pub email_forwardings: Option<Vec<EmailForwarding>>,
}

impl common::ResponseResult for RetrieveGoogleDomainsForwardingConfigResponse {}
...
impl common::ResponseResult for RetrieveImportableDomainsResponse {}
...
impl common::ResponseResult for RetrieveRegisterParametersResponse {}
...
impl common::ResponseResult for RetrieveTransferParametersResponse {}
...
impl common::ResponseResult for SearchDomainsResponse {}
...
impl common::RequestValue for TransferDomainRequest {}
...
impl common::Part for TransferParameters {}
...
impl common::Part for WrrPolicy {}
...
impl common::Part for WrrPolicyItem {}
...
impl<'a, C> ProjectMethods<'a, C> {
    ...
    pub fn locations_registrations_configure_contact_settings(
        &self,
    ...
    pub fn locations_registrations_configure_dns_settings(
        &self,
    ...
    pub fn locations_registrations_configure_management_settings(
        &self,
    ...
    pub fn locations_registrations_delete(
        &self,
        name: &str,
    ...
    pub fn locations_registrations_export(
        &self,
    ...
    pub fn locations_registrations_get(
        &self,
        name: &str,
    ...
    pub fn locations_registrations_get_iam_policy(
        &self,
        resource: &str,
    ...
    pub fn locations_registrations_import(
        &self,
    ...
    ///
    /// * `request` - No description provided.
    /// * `registration` - Required. The name of the `Registration` for which the push transfer is initiated, in the format `projects/*/locations/*/registrations/*`.
    pub fn locations_registrations_initiate_push_transfer(
        &self,
        request: InitiatePushTransferRequest,
        registration: &str,
    ) -> ProjectLocationRegistrationInitiatePushTransferCall<'a, C> {
        ProjectLocationRegistrationInitiatePushTransferCall {
            hub: self.hub,
            _request: request,
            _registration: registration.to_string(),
            _delegate: Default::default(),
    ...
    pub fn locations_registrations_list(
        &self,
        parent: &str,
    ...
    pub fn locations_registrations_patch(
        &self,
    ...
    /// * `request` - No description provided.
    /// * `parent` - Required. The parent resource of the `Registration`. Must be in the format `projects/*/locations/*`.
    pub fn locations_registrations_register(
        &self,
    ...
    ///
    /// * `request` - No description provided.
    /// * `registration` - Required. The name of the `Registration` whish is being renewed, in the format `projects/*/locations/*/registrations/*`.
    pub fn locations_registrations_renew_domain(
        &self,
        request: RenewDomainRequest,
        registration: &str,
    ) -> ProjectLocationRegistrationRenewDomainCall<'a, C> {
        ProjectLocationRegistrationRenewDomainCall {
            hub: self.hub,
            _request: request,
            _registration: registration.to_string(),
            _delegate: Default::default(),
    ...
    pub fn locations_registrations_reset_authorization_code(
        &self,
        request: ResetAuthorizationCodeRequest,
        registration: &str,
    ) -> ProjectLocationRegistrationResetAuthorizationCodeCall<'a, C> {
    ...
    pub fn locations_registrations_retrieve_authorization_code(
        &self,
        registration: &str,
    ) -> ProjectLocationRegistrationRetrieveAuthorizationCodeCall<'a, C> {
    ...
    /// # Arguments
    ///
    /// * `registration` - Required. The name of the `Registration` whose Google Domains DNS records details you are retrieving, in the format `projects/*/locations/*/registrations/*`.
    pub fn locations_registrations_retrieve_google_domains_dns_records(
        &self,
        registration: &str,
    ) -> ProjectLocationRegistrationRetrieveGoogleDomainsDnsRecordCall<'a, C> {
        ProjectLocationRegistrationRetrieveGoogleDomainsDnsRecordCall {
            hub: self.hub,
            _registration: registration.to_string(),
            _page_token: Default::default(),
            _page_size: Default::default(),
    ...
    /// # Arguments
    ///
    /// * `registration` - Required. The name of the `Registration` whose Google Domains forwarding configuration details are being retrieved, in the format `projects/*/locations/*/registrations/*`.
    pub fn locations_registrations_retrieve_google_domains_forwarding_config(
        &self,
        registration: &str,
    ) -> ProjectLocationRegistrationRetrieveGoogleDomainsForwardingConfigCall<'a, C> {
        ProjectLocationRegistrationRetrieveGoogleDomainsForwardingConfigCall {
            hub: self.hub,
            _registration: registration.to_string(),
            _delegate: Default::default(),
            _additional_params: Default::default(),
    ...
    pub fn locations_registrations_retrieve_importable_domains(
        &self,
        location: &str,
    ...
    ///
    /// * `location` - Required. The location. Must be in the format `projects/*/locations/*`.
    pub fn locations_registrations_retrieve_register_parameters(
        &self,
        location: &str,
    ...
    ///
    /// * `location` - Required. The location. Must be in the format `projects/*/locations/*`.
    pub fn locations_registrations_retrieve_transfer_parameters(
        &self,
        location: &str,
    ...
    ///
    /// * `location` - Required. The location. Must be in the format `projects/*/locations/*`.
    pub fn locations_registrations_search_domains(
        &self,
        location: &str,
    ...
    pub fn locations_registrations_set_iam_policy(
        &self,
    ...
    pub fn locations_registrations_test_iam_permissions(
        &self,
    ...
    /// * `request` - No description provided.
    /// * `parent` - Required. The parent resource of the `Registration`. Must be in the format `projects/*/locations/*`.
    pub fn locations_registrations_transfer(
        &self,
...
/// # }
/// ```
pub struct ProjectLocationRegistrationConfigureContactSettingCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudDomains<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationRegistrationConfigureContactSettingCall<'a, C> {}

impl<'a, C> ProjectLocationRegistrationConfigureContactSettingCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, Operation)> {
        ...
        params.push("registration", self._registration);

        params.extend(self._additional_params.iter());

        params.push("alt", "json");
        let mut url =
            self.hub._base_url.clone() + "v1beta1/{+registration}:configureContactSettings";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string());
        }
    ...
    pub fn request(
        mut self,
        new_value: ConfigureContactSettingsRequest,
    ) -> ProjectLocationRegistrationConfigureContactSettingCall<'a, C> {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationRegistrationConfigureContactSettingCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationRegistrationConfigureDnsSettingCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudDomains<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationRegistrationConfigureDnsSettingCall<'a, C> {}

impl<'a, C> ProjectLocationRegistrationConfigureDnsSettingCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    pub fn request(
        mut self,
        new_value: ConfigureDnsSettingsRequest,
    ) -> ProjectLocationRegistrationConfigureDnsSettingCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationRegistrationConfigureDnsSettingCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationRegistrationConfigureManagementSettingCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudDomains<C>,
...
impl<'a, C> common::CallBuilder
    for ProjectLocationRegistrationConfigureManagementSettingCall<'a, C>
{
}

impl<'a, C> ProjectLocationRegistrationConfigureManagementSettingCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, Operation)> {
        ...
        params.push("alt", "json");
        let mut url =
            self.hub._base_url.clone() + "v1beta1/{+registration}:configureManagementSettings";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string());
        }
    ...
    pub fn request(
        mut self,
        new_value: ConfigureManagementSettingsRequest,
    ) -> ProjectLocationRegistrationConfigureManagementSettingCall<'a, C> {
        self._request = new_value;
        self
    }
...
/// # }
/// ```
pub struct ProjectLocationRegistrationDeleteCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudDomains<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationRegistrationDeleteCall<'a, C> {}

impl<'a, C> ProjectLocationRegistrationDeleteCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationRegistrationDeleteCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationRegistrationDeleteCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationRegistrationDeleteCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationRegistrationDeleteCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationRegistrationDeleteCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationRegistrationExportCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudDomains<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationRegistrationExportCall<'a, C> {}

impl<'a, C> ProjectLocationRegistrationExportCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    pub fn request(
        mut self,
        new_value: ExportRegistrationRequest,
    ) -> ProjectLocationRegistrationExportCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationRegistrationExportCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationRegistrationExportCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationRegistrationExportCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationRegistrationExportCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationRegistrationExportCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationRegistrationGetCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudDomains<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationRegistrationGetCall<'a, C> {}

impl<'a, C> ProjectLocationRegistrationGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, Registration)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationRegistrationGetCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationRegistrationGetCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationRegistrationGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationRegistrationGetCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationRegistrationGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationRegistrationGetIamPolicyCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudDomains<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationRegistrationGetIamPolicyCall<'a, C> {}

impl<'a, C> ProjectLocationRegistrationGetIamPolicyCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationRegistrationGetIamPolicyCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationRegistrationGetIamPolicyCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Deprecated: For more information, see [Cloud Domains feature deprecation](https://cloud.google.com/domains/docs/deprecations/feature-deprecations) Imports a domain name from [Google Domains](https://domains.google/) for use in Cloud Domains. To transfer a domain from another registrar, use the `TransferDomain` method instead. Since individual users can own domains in Google Domains, the calling user must have ownership permission on the domain.
///
/// A builder for the *locations.registrations.import* method supported by a *project* resource.
/// It is not used directly, but through a [`ProjectMethods`] instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_domains1_beta1 as domains1_beta1;
/// use domains1_beta1::api::ImportDomainRequest;
/// # async fn dox() {
/// # use domains1_beta1::{CloudDomains, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = ImportDomainRequest::default();
///
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().locations_registrations_import(req, "parent")
///              .doit().await;
/// # }
/// ```
pub struct ProjectLocationRegistrationImportCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudDomains<C>,
    _request: ImportDomainRequest,
    _parent: String,
    _delegate: Option<&'a mut dyn common::Delegate>,
    _additional_params: HashMap<String, String>,
    _scopes: BTreeSet<String>,
...
impl<'a, C> common::CallBuilder for ProjectLocationRegistrationImportCall<'a, C> {}

impl<'a, C> ProjectLocationRegistrationImportCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, Operation)> {
        ...
        params.push("alt", "json");
        let mut url = self.hub._base_url.clone() + "v1beta1/{+parent}/registrations:import";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string());
        }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> ProjectLocationRegistrationImportCall<'a, C> {
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationRegistrationImportCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationRegistrationImportCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationRegistrationImportCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationRegistrationImportCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Initiates the `Push Transfer` process to transfer the domain to another registrar. The process might complete instantly or might require confirmation or additional work. Check the emails sent to the email address of the registrant. The process is aborted after a timeout if it's not completed. This method is only supported for domains that have the `REQUIRE_PUSH_TRANSFER` property in the list of `domain_properties`. The domain must also be unlocked before it can be transferred to a different registrar. For more information, see [Transfer a registered domain to another registrar](https://cloud.google.com/domains/docs/transfer-domain-to-another-registrar).
///
/// A builder for the *locations.registrations.initiatePushTransfer* method supported by a *project* resource.
/// It is not used directly, but through a [`ProjectMethods`] instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_domains1_beta1 as domains1_beta1;
/// use domains1_beta1::api::InitiatePushTransferRequest;
/// # async fn dox() {
/// # use domains1_beta1::{CloudDomains, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = InitiatePushTransferRequest::default();
///
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().locations_registrations_initiate_push_transfer(req, "registration")
///              .doit().await;
/// # }
/// ```
pub struct ProjectLocationRegistrationInitiatePushTransferCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudDomains<C>,
    _request: InitiatePushTransferRequest,
    _registration: String,
    _delegate: Option<&'a mut dyn common::Delegate>,
    _additional_params: HashMap<String, String>,
    _scopes: BTreeSet<String>,
...
impl<'a, C> common::CallBuilder for ProjectLocationRegistrationInitiatePushTransferCall<'a, C> {}

impl<'a, C> ProjectLocationRegistrationInitiatePushTransferCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, Operation)> {
        ...
        params.push("alt", "json");
        let mut url = self.hub._base_url.clone() + "v1beta1/{+registration}:initiatePushTransfer";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string());
        }
    ...
    pub fn request(
        mut self,
        new_value: InitiatePushTransferRequest,
    ) -> ProjectLocationRegistrationInitiatePushTransferCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationRegistrationInitiatePushTransferCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationRegistrationListCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudDomains<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationRegistrationListCall<'a, C> {}

impl<'a, C> ProjectLocationRegistrationListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, ListRegistrationsResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> ProjectLocationRegistrationListCall<'a, C> {
        self._parent = new_value.to_string();
        self
    }
    ...
    ///
    /// Sets the *page token* query property to the given value.
    pub fn page_token(mut self, new_value: &str) -> ProjectLocationRegistrationListCall<'a, C> {
        self._page_token = Some(new_value.to_string());
        self
    }
    ...
    ///
    /// Sets the *page size* query property to the given value.
    pub fn page_size(mut self, new_value: i32) -> ProjectLocationRegistrationListCall<'a, C> {
        self._page_size = Some(new_value);
        self
    }
    ...
    ///
    /// Sets the *filter* query property to the given value.
    pub fn filter(mut self, new_value: &str) -> ProjectLocationRegistrationListCall<'a, C> {
        self._filter = Some(new_value.to_string());
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationRegistrationListCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationRegistrationListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationRegistrationListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationRegistrationListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationRegistrationPatchCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudDomains<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationRegistrationPatchCall<'a, C> {}

impl<'a, C> ProjectLocationRegistrationPatchCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationRegistrationPatchCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationRegistrationPatchCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationRegistrationPatchCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationRegistrationPatchCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationRegistrationPatchCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationRegistrationRegisterCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudDomains<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationRegistrationRegisterCall<'a, C> {}

impl<'a, C> ProjectLocationRegistrationRegisterCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    pub fn request(
        mut self,
        new_value: RegisterDomainRequest,
    ) -> ProjectLocationRegistrationRegisterCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> ProjectLocationRegistrationRegisterCall<'a, C> {
        self._parent = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationRegistrationRegisterCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationRegistrationRegisterCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationRegistrationRegisterCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationRegistrationRegisterCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Renews a recently expired domain. This method can only be called on domains that expired in the previous 30 days. After the renewal, the new expiration time of the domain is one year after the old expiration time and you are charged a `yearly_price` for the renewal.
///
/// A builder for the *locations.registrations.renewDomain* method supported by a *project* resource.
/// It is not used directly, but through a [`ProjectMethods`] instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_domains1_beta1 as domains1_beta1;
/// use domains1_beta1::api::RenewDomainRequest;
/// # async fn dox() {
/// # use domains1_beta1::{CloudDomains, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = RenewDomainRequest::default();
///
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().locations_registrations_renew_domain(req, "registration")
///              .doit().await;
/// # }
/// ```
pub struct ProjectLocationRegistrationRenewDomainCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudDomains<C>,
    _request: RenewDomainRequest,
    _registration: String,
    _delegate: Option<&'a mut dyn common::Delegate>,
    _additional_params: HashMap<String, String>,
    _scopes: BTreeSet<String>,
...
impl<'a, C> common::CallBuilder for ProjectLocationRegistrationRenewDomainCall<'a, C> {}

impl<'a, C> ProjectLocationRegistrationRenewDomainCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, Operation)> {
        ...
        params.push("alt", "json");
        let mut url = self.hub._base_url.clone() + "v1beta1/{+registration}:renewDomain";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string());
        }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationRegistrationRenewDomainCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationRegistrationRenewDomainCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationRegistrationResetAuthorizationCodeCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudDomains<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationRegistrationResetAuthorizationCodeCall<'a, C> {}

impl<'a, C> ProjectLocationRegistrationResetAuthorizationCodeCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, AuthorizationCode)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    pub fn request(
        mut self,
        new_value: ResetAuthorizationCodeRequest,
    ) -> ProjectLocationRegistrationResetAuthorizationCodeCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationRegistrationResetAuthorizationCodeCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationRegistrationRetrieveAuthorizationCodeCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudDomains<C>,
...
impl<'a, C> common::CallBuilder
    for ProjectLocationRegistrationRetrieveAuthorizationCodeCall<'a, C>
{
}

impl<'a, C> ProjectLocationRegistrationRetrieveAuthorizationCodeCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, AuthorizationCode)> {
        ...
        params.push("alt", "json");
        let mut url =
            self.hub._base_url.clone() + "v1beta1/{+registration}:retrieveAuthorizationCode";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string());
        }
...
/// Lists the DNS records from the Google Domains DNS zone for domains that use the deprecated `google_domains_dns` in the `Registration`'s `dns_settings`.
///
/// A builder for the *locations.registrations.retrieveGoogleDomainsDnsRecords* method supported by a *project* resource.
/// It is not used directly, but through a [`ProjectMethods`] instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().locations_registrations_retrieve_google_domains_dns_records("registration")
///              .page_token("est")
///              .page_size(-50)
///              .doit().await;
/// # }
/// ```
pub struct ProjectLocationRegistrationRetrieveGoogleDomainsDnsRecordCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudDomains<C>,
...
impl<'a, C> common::CallBuilder
    for ProjectLocationRegistrationRetrieveGoogleDomainsDnsRecordCall<'a, C>
{
}

impl<'a, C> ProjectLocationRegistrationRetrieveGoogleDomainsDnsRecordCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(
        mut self,
    ) -> common::Result<(common::Response, RetrieveGoogleDomainsDnsRecordsResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
        ...
        for &field in ["alt", "registration", "pageToken", "pageSize"].iter() {
            if self._additional_params.contains_key(field) {
                dlg.finished(false);
                return Err(common::Error::FieldClash(field));
            }
        ...
        params.push("alt", "json");
        let mut url =
            self.hub._base_url.clone() + "v1beta1/{+registration}:retrieveGoogleDomainsDnsRecords";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string());
        }
...
/// Lists the deprecated domain and email forwarding configurations you set up in the deprecated Google Domains UI. The configuration is present only for domains with the `google_domains_redirects_data_available` set to `true` in the `Registration`'s `dns_settings`. A forwarding configuration might not work correctly if required DNS records are not present in the domain's authoritative DNS Zone.
///
/// A builder for the *locations.registrations.retrieveGoogleDomainsForwardingConfig* method supported by a *project* resource.
/// It is not used directly, but through a [`ProjectMethods`] instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().locations_registrations_retrieve_google_domains_forwarding_config("registration")
///              .doit().await;
/// # }
/// ```
pub struct ProjectLocationRegistrationRetrieveGoogleDomainsForwardingConfigCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudDomains<C>,
...
impl<'a, C> common::CallBuilder
    for ProjectLocationRegistrationRetrieveGoogleDomainsForwardingConfigCall<'a, C>
{
}

impl<'a, C> ProjectLocationRegistrationRetrieveGoogleDomainsForwardingConfigCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(
        ...
        let mut url = self.hub._base_url.clone()
            + "v1beta1/{+registration}:retrieveGoogleDomainsForwardingConfig";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string());
        }
...
/// Deprecated: For more information, see [Cloud Domains feature deprecation](https://cloud.google.com/domains/docs/deprecations/feature-deprecations) Lists domain names from [Google Domains](https://domains.google/) that can be imported to Cloud Domains using the `ImportDomain` method. Since individual users can own domains in Google Domains, the list of domains returned depends on the individual user making the call. Domains already managed by Cloud Domains are not returned.
///
/// A builder for the *locations.registrations.retrieveImportableDomains* method supported by a *project* resource.
/// It is not used directly, but through a [`ProjectMethods`] instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().locations_registrations_retrieve_importable_domains("location")
///              .page_token("gubergren")
///              .page_size(-17)
///              .doit().await;
/// # }
/// ```
pub struct ProjectLocationRegistrationRetrieveImportableDomainCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudDomains<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationRegistrationRetrieveImportableDomainCall<'a, C> {}

impl<'a, C> ProjectLocationRegistrationRetrieveImportableDomainCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(
        mut self,
    ) -> common::Result<(common::Response, RetrieveImportableDomainsResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
        ...
        for &field in ["alt", "location", "pageToken", "pageSize"].iter() {
            if self._additional_params.contains_key(field) {
                dlg.finished(false);
                return Err(common::Error::FieldClash(field));
            }
...
/// # }
/// ```
pub struct ProjectLocationRegistrationRetrieveRegisterParameterCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudDomains<C>,
...
impl<'a, C> common::CallBuilder
    for ProjectLocationRegistrationRetrieveRegisterParameterCall<'a, C>
{
}

impl<'a, C> ProjectLocationRegistrationRetrieveRegisterParameterCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(
        mut self,
    ) -> common::Result<(common::Response, RetrieveRegisterParametersResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
...
/// # }
/// ```
pub struct ProjectLocationRegistrationRetrieveTransferParameterCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudDomains<C>,
...
impl<'a, C> common::CallBuilder
    for ProjectLocationRegistrationRetrieveTransferParameterCall<'a, C>
{
}

impl<'a, C> ProjectLocationRegistrationRetrieveTransferParameterCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(
        mut self,
    ) -> common::Result<(common::Response, RetrieveTransferParametersResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
...
/// # }
/// ```
pub struct ProjectLocationRegistrationSearchDomainCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudDomains<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationRegistrationSearchDomainCall<'a, C> {}

impl<'a, C> ProjectLocationRegistrationSearchDomainCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, SearchDomainsResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
        ...
        params.push("alt", "json");
        let mut url =
            self.hub._base_url.clone() + "v1beta1/{+location}/registrations:searchDomains";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string());
        }
    ...
    pub fn query(mut self, new_value: &str) -> ProjectLocationRegistrationSearchDomainCall<'a, C> {
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationRegistrationSearchDomainCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationRegistrationSearchDomainCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationRegistrationSetIamPolicyCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudDomains<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationRegistrationSetIamPolicyCall<'a, C> {}

impl<'a, C> ProjectLocationRegistrationSetIamPolicyCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationRegistrationSetIamPolicyCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationRegistrationSetIamPolicyCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationRegistrationTestIamPermissionCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudDomains<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationRegistrationTestIamPermissionCall<'a, C> {}

impl<'a, C> ProjectLocationRegistrationTestIamPermissionCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationRegistrationTestIamPermissionCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationRegistrationTransferCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudDomains<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationRegistrationTransferCall<'a, C> {}

impl<'a, C> ProjectLocationRegistrationTransferCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    pub fn request(
        mut self,
        new_value: TransferDomainRequest,
    ) -> ProjectLocationRegistrationTransferCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> ProjectLocationRegistrationTransferCall<'a, C> {
        self._parent = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationRegistrationTransferCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationRegistrationTransferCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationRegistrationTransferCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationRegistrationTransferCall<'a, C> {
        self._scopes.clear();
        self
    }
}
