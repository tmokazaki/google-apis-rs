...
use google_datastream1::{api, yup_oauth2, Error};
    ...
    C: apis_common::Connector,
{
    ...
    async fn _projects_locations_connection_profiles_discover(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::DiscoverConnectionProfileRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_connection_profiles_discover(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["force", "request-id", "update-mask", "validate-only"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _projects_locations_private_connections_routes_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::Route = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_private_connections_routes_create(
                request,
            ...
            .iter()
        {
            ...
            match key {
                "route-id" => {
                    call = call.route_id(value.unwrap_or(""));
                }
                "request-id" => {
                    call = call.request_id(value.unwrap_or(""));
                }
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                let mut v = Vec::new();
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(["request-id", "route-id"].iter().map(|v| *v));
                                v
                            }));
                    }
                }
    ...
    async fn _projects_locations_private_connections_routes_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_private_connections_routes_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_private_connections_routes_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_private_connections_routes_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_private_connections_routes_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_private_connections_routes_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_streams_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    ...
                    "destination-config.gcs-destination-config.json-file-format.compression" => Some(("destinationConfig.gcsDestinationConfig.jsonFileFormat.compression", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "destination-config.gcs-destination-config.json-file-format.schema-file-format" => Some(("destinationConfig.gcsDestinationConfig.jsonFileFormat.schemaFileFormat", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
        ...
        let mut request: api::Stream = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_streams_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["force", "request-id", "stream-id", "validate-only"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _projects_locations_streams_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_streams_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_streams_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_streams_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_streams_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_streams_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_streams_objects_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_streams_objects_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_streams_objects_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_streams_objects_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_streams_objects_lookup(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "source-object-identifier.mysql-identifier.table" => Some((
                    "sourceObjectIdentifier.mysqlIdentifier.table",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "source-object-identifier.oracle-identifier.schema" => Some((
                    "sourceObjectIdentifier.oracleIdentifier.schema",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "source-object-identifier.oracle-identifier.table" => Some((
                    "sourceObjectIdentifier.oracleIdentifier.table",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "source-object-identifier.postgresql-identifier.schema" => Some((
                    "sourceObjectIdentifier.postgresqlIdentifier.schema",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "source-object-identifier.postgresql-identifier.table" => Some((
                    "sourceObjectIdentifier.postgresqlIdentifier.table",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                ...
                "source-object-identifier.sql-server-identifier.table" => Some((
                    "sourceObjectIdentifier.sqlServerIdentifier.table",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
        ...
        let mut request: api::LookupStreamObjectRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_streams_objects_lookup(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_streams_objects_start_backfill_job(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::StartBackfillJobRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_streams_objects_start_backfill_job(
                request,
    ...
    async fn _projects_locations_streams_objects_stop_backfill_job(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::StopBackfillJobRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_streams_objects_stop_backfill_job(
                request,
                opt.value_of("object").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_streams_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_streams_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_streams_run(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::RunStreamRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_streams_run(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _doit(
        ...
        match self.opt.subcommand() {
            ("projects", Some(opt)) => match opt.subcommand() {
                ...
                ("locations-connection-profiles-discover", Some(opt)) => {
                    call_result = self
                        ._projects_locations_connection_profiles_discover(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("locations-private-connections-routes-create", Some(opt)) => {
                    call_result = self
                        ._projects_locations_private_connections_routes_create(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-private-connections-routes-delete", Some(opt)) => {
                    call_result = self
                        ._projects_locations_private_connections_routes_delete(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-private-connections-routes-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_private_connections_routes_get(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-private-connections-routes-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_private_connections_routes_list(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-streams-create", Some(opt)) => {
                    call_result = self
                        ._projects_locations_streams_create(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-streams-delete", Some(opt)) => {
                    call_result = self
                        ._projects_locations_streams_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-streams-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_streams_get(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-streams-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_streams_list(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-streams-objects-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_streams_objects_get(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-streams-objects-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_streams_objects_list(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-streams-objects-lookup", Some(opt)) => {
                    call_result = self
                        ._projects_locations_streams_objects_lookup(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-streams-objects-start-backfill-job", Some(opt)) => {
                    call_result = self
                        ._projects_locations_streams_objects_start_backfill_job(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-streams-objects-stop-backfill-job", Some(opt)) => {
                    call_result = self
                        ._projects_locations_streams_objects_stop_backfill_job(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-streams-patch", Some(opt)) => {
                    call_result = self
                        ._projects_locations_streams_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-streams-run", Some(opt)) => {
                    call_result = self
                        ._projects_locations_streams_run(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "datastream1-secret.json",
        ...
        ("projects", "methods: 'locations-connection-profiles-create', 'locations-connection-profiles-delete', 'locations-connection-profiles-discover', 'locations-connection-profiles-get', 'locations-connection-profiles-list', 'locations-connection-profiles-patch', 'locations-fetch-static-ips', 'locations-get', 'locations-list', 'locations-operations-cancel', 'locations-operations-delete', 'locations-operations-get', 'locations-operations-list', 'locations-private-connections-create', 'locations-private-connections-delete', 'locations-private-connections-get', 'locations-private-connections-list', 'locations-private-connections-routes-create', 'locations-private-connections-routes-delete', 'locations-private-connections-routes-get', 'locations-private-connections-routes-list', 'locations-streams-create', 'locations-streams-delete', 'locations-streams-get', 'locations-streams-list', 'locations-streams-objects-get', 'locations-streams-objects-list', 'locations-streams-objects-lookup', 'locations-streams-objects-start-backfill-job', 'locations-streams-objects-stop-backfill-job', 'locations-streams-patch' and 'locations-streams-run'", vec![
            ("locations-connection-profiles-create",
                  ...
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The parent that owns the collection of ConnectionProfiles."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("locations-connection-profiles-delete",
                    Some(r##"Use this method to delete a connection profile."##),
                    "Details at http://byron.github.io/google-apis-rs/google_datastream1_cli/projects_locations-connection-profiles-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The name of the connection profile resource to delete."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("locations-connection-profiles-discover",
                    Some(r##"Use this method to discover a connection profile. The discover API call exposes the data objects and metadata belonging to the profile. Typically, a request returns children data objects of a parent data object that's optionally supplied in the request."##),
                    "Details at http://byron.github.io/google-apis-rs/google_datastream1_cli/projects_locations-connection-profiles-discover",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The parent resource of the connection profile type. Must be in the format `projects/*/locations/*`."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("locations-connection-profiles-get",
                    Some(r##"Use this method to get details about a connection profile."##),
                    "Details at http://byron.github.io/google-apis-rs/google_datastream1_cli/projects_locations-connection-profiles-get",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The name of the connection profile resource to get."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("locations-connection-profiles-list",
                    Some(r##"Use this method to list connection profiles created in a project and location."##),
                    "Details at http://byron.github.io/google-apis-rs/google_datastream1_cli/projects_locations-connection-profiles-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The parent that owns the collection of connection profiles."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("locations-connection-profiles-patch",
                    Some(r##"Use this method to update the parameters of a connection profile."##),
                    "Details at http://byron.github.io/google-apis-rs/google_datastream1_cli/projects_locations-connection-profiles-patch",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-fetch-static-ips",
                    Some(r##"The FetchStaticIps API call exposes the static IP addresses used by Datastream."##),
                    "Details at http://byron.github.io/google-apis-rs/google_datastream1_cli/projects_locations-fetch-static-ips",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_datastream1_cli/projects_locations-get",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_datastream1_cli/projects_locations-list",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-operations-delete",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_datastream1_cli/projects_locations-operations-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-operations-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_datastream1_cli/projects_locations-operations-get",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-private-connections-create",
                    Some(r##"Use this method to create a private connectivity configuration."##),
                    "Details at http://byron.github.io/google-apis-rs/google_datastream1_cli/projects_locations-private-connections-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("locations-private-connections-delete",
                    Some(r##"Use this method to delete a private connectivity configuration."##),
                    "Details at http://byron.github.io/google-apis-rs/google_datastream1_cli/projects_locations-private-connections-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The name of the private connectivity configuration to delete."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("locations-private-connections-get",
                    Some(r##"Use this method to get details about a private connectivity configuration."##),
                    "Details at http://byron.github.io/google-apis-rs/google_datastream1_cli/projects_locations-private-connections-get",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The name of the private connectivity configuration to get."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("locations-private-connections-list",
                    Some(r##"Use this method to list private connectivity configurations in a project and location."##),
                    "Details at http://byron.github.io/google-apis-rs/google_datastream1_cli/projects_locations-private-connections-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The parent that owns the collection of private connectivity configurations."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("locations-private-connections-routes-create",
                    Some(r##"Use this method to create a route for a private connectivity configuration in a project and location."##),
                    "Details at http://byron.github.io/google-apis-rs/google_datastream1_cli/projects_locations-private-connections-routes-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The parent that owns the collection of Routes."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("locations-private-connections-routes-delete",
                    Some(r##"Use this method to delete a route."##),
                    "Details at http://byron.github.io/google-apis-rs/google_datastream1_cli/projects_locations-private-connections-routes-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The name of the Route resource to delete."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("locations-private-connections-routes-get",
                    Some(r##"Use this method to get details about a route."##),
                    "Details at http://byron.github.io/google-apis-rs/google_datastream1_cli/projects_locations-private-connections-routes-get",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The name of the Route resource to get."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("locations-private-connections-routes-list",
                    Some(r##"Use this method to list routes created for a private connectivity configuration in a project and location."##),
                    "Details at http://byron.github.io/google-apis-rs/google_datastream1_cli/projects_locations-private-connections-routes-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The parent that owns the collection of Routess."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("locations-streams-create",
                    Some(r##"Use this method to create a stream."##),
                    "Details at http://byron.github.io/google-apis-rs/google_datastream1_cli/projects_locations-streams-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The parent that owns the collection of streams."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("locations-streams-delete",
                    Some(r##"Use this method to delete a stream."##),
                    "Details at http://byron.github.io/google-apis-rs/google_datastream1_cli/projects_locations-streams-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The name of the stream resource to delete."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("locations-streams-get",
                    Some(r##"Use this method to get details about a stream."##),
                    "Details at http://byron.github.io/google-apis-rs/google_datastream1_cli/projects_locations-streams-get",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The name of the stream resource to get."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("locations-streams-list",
                    Some(r##"Use this method to list streams in a project and location."##),
                    "Details at http://byron.github.io/google-apis-rs/google_datastream1_cli/projects_locations-streams-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The parent that owns the collection of streams."##),
            ...
            ("locations-streams-objects-get",
                    Some(r##"Use this method to get details about a stream object."##),
                    "Details at http://byron.github.io/google-apis-rs/google_datastream1_cli/projects_locations-streams-objects-get",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The name of the stream object resource to get."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("locations-streams-objects-list",
                    Some(r##"Use this method to list the objects of a specific stream."##),
                    "Details at http://byron.github.io/google-apis-rs/google_datastream1_cli/projects_locations-streams-objects-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The parent stream that owns the collection of objects."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("locations-streams-objects-lookup",
                    Some(r##"Use this method to look up a stream object by its source object identifier."##),
                    "Details at http://byron.github.io/google-apis-rs/google_datastream1_cli/projects_locations-streams-objects-lookup",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The parent stream that owns the collection of objects."##),
            ...
            ("locations-streams-objects-start-backfill-job",
                    Some(r##"Use this method to start a backfill job for the specified stream object."##),
                    "Details at http://byron.github.io/google-apis-rs/google_datastream1_cli/projects_locations-streams-objects-start-backfill-job",
                  vec![
                    (Some(r##"object"##),
                     None,
                     Some(r##"Required. The name of the stream object resource to start a backfill job for."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("locations-streams-objects-stop-backfill-job",
                    Some(r##"Use this method to stop a backfill job for the specified stream object."##),
                    "Details at http://byron.github.io/google-apis-rs/google_datastream1_cli/projects_locations-streams-objects-stop-backfill-job",
                  vec![
                    (Some(r##"object"##),
                     None,
                     Some(r##"Required. The name of the stream object resource to stop the backfill job for."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("locations-streams-patch",
                    Some(r##"Use this method to update the configuration of a stream."##),
                    "Details at http://byron.github.io/google-apis-rs/google_datastream1_cli/projects_locations-streams-patch",
                  vec![
                    (Some(r##"name"##),
                     None,
