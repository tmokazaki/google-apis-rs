...
use google_memcache1::{api, yup_oauth2, Error};
    ...
    C: apis_common::Connector,
{
    ...
    async fn _projects_locations_instances_upgrade(
        ...
        let mut request: api::GoogleCloudMemcacheV1UpgradeInstanceRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "memcache1-secret.json",
        ...
        .persist_tokens_to_disk(format!("{}/memcache1", config_dir))
        .build()
        .await
        .unwrap();
    ...
    let arg_data = [
        ("projects", "methods: 'locations-get', 'locations-instances-apply-parameters', 'locations-instances-create', 'locations-instances-delete', 'locations-instances-get', 'locations-instances-list', 'locations-instances-patch', 'locations-instances-reschedule-maintenance', 'locations-instances-update-parameters', 'locations-instances-upgrade', 'locations-list', 'locations-operations-cancel', 'locations-operations-delete', 'locations-operations-get' and 'locations-operations-list'", vec![
            ...
            ("locations-instances-apply-parameters",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_memcache1_cli/projects_locations-instances-apply-parameters",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-instances-create",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_memcache1_cli/projects_locations-instances-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("locations-instances-delete",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_memcache1_cli/projects_locations-instances-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-instances-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_memcache1_cli/projects_locations-instances-get",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. Memcached instance resource name in the format: `projects/{project_id}/locations/{location_id}/instances/{instance_id}` where `location_id` refers to a GCP region"##),
            ...
            ("locations-instances-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_memcache1_cli/projects_locations-instances-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The resource name of the instance location using the form: `projects/{project_id}/locations/{location_id}` where `location_id` refers to a GCP region"##),
            ...
            ("locations-instances-patch",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_memcache1_cli/projects_locations-instances-patch",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-operations-cancel",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_memcache1_cli/projects_locations-operations-cancel",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-operations-delete",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_memcache1_cli/projects_locations-operations-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-operations-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_memcache1_cli/projects_locations-operations-get",
                  vec![
                    (Some(r##"name"##),
                     None,
