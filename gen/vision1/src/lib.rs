...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/vision1).
//! # Features
//!
//! Handle the following *Resources* with ease from the central [hub](Vision) ...
//!
//! * files
//!  * [*annotate*](api::FileAnnotateCall) and [*async batch annotate*](api::FileAsyncBatchAnnotateCall)
//! * [images](api::Image)
//!  * [*annotate*](api::ImageAnnotateCall) and [*async batch annotate*](api::ImageAsyncBatchAnnotateCall)
//! * locations
//!  * [*operations get*](api::LocationOperationGetCall)
