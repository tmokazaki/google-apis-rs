...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/blogger3).
//! # Features
//!
//! Handle the following *Resources* with ease from the central [hub](Blogger) ...
//!
//! * [blog user infos](api::BlogUserInfo)
//!  * [*get*](api::BlogUserInfoGetCall)
//! * [blogs](api::Blog)
//!  * [*get*](api::BlogGetCall), [*get by url*](api::BlogGetByUrlCall) and [*list by user*](api::BlogListByUserCall)
//! * [comments](api::Comment)
//!  * [*approve*](api::CommentApproveCall), [*delete*](api::CommentDeleteCall), [*get*](api::CommentGetCall), [*list*](api::CommentListCall), [*list by blog*](api::CommentListByBlogCall), [*mark as spam*](api::CommentMarkAsSpamCall) and [*remove content*](api::CommentRemoveContentCall)
//! * page views
//!  * [*get*](api::PageViewGetCall)
//! * [pages](api::Page)
//!  * [*delete*](api::PageDeleteCall), [*get*](api::PageGetCall), [*insert*](api::PageInsertCall), [*list*](api::PageListCall), [*patch*](api::PagePatchCall), [*publish*](api::PagePublishCall), [*revert*](api::PageRevertCall) and [*update*](api::PageUpdateCall)
//! * [post user infos](api::PostUserInfo)
//!  * [*get*](api::PostUserInfoGetCall) and [*list*](api::PostUserInfoListCall)
//! * [posts](api::Post)
//!  * [*delete*](api::PostDeleteCall), [*get*](api::PostGetCall), [*get by path*](api::PostGetByPathCall), [*insert*](api::PostInsertCall), [*list*](api::PostListCall), [*patch*](api::PostPatchCall), [*publish*](api::PostPublishCall), [*revert*](api::PostRevertCall), [*search*](api::PostSearchCall) and [*update*](api::PostUpdateCall)
//! * [users](api::User)
//!  * [*get*](api::UserGetCall)
//!
//!
