...
use google_run2::{api, yup_oauth2, Error};
...
{
    async fn _projects_locations_export_image(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        ...
        let mut request: api::GoogleCloudRunV2ExportImageRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_export_image(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_export_image_metadata(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_export_image_metadata(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_export_metadata(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_export_metadata(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_jobs_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "binary-authorization.breakglass-justification" => Some((
                ...
                "binary-authorization.policy" => Some((
                ...
                "binary-authorization.use-default" => Some((
                ...
                "latest-created-execution.completion-time" => Some((
                ...
                "latest-created-execution.create-time" => Some((
                ...
                "latest-created-execution.name" => Some((
                ...
                "template.template.encryption-key" => Some((
                    "template.template.encryptionKey",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "template.template.execution-environment" => Some((
                ...
                "template.template.max-retries" => Some((
                ...
                "template.template.service-account" => Some((
                ...
                "template.template.timeout" => Some((
                ...
                "template.template.vpc-access.connector" => Some((
                ...
                "template.template.vpc-access.egress" => Some((
                ...
                "terminal-condition.execution-reason" => Some((
                ...
                "terminal-condition.last-transition-time" => Some((
                ...
                "terminal-condition.message" => Some((
                ...
                "terminal-condition.reason" => Some((
                ...
                "terminal-condition.revision-reason" => Some((
                ...
                "terminal-condition.severity" => Some((
        ...
        let mut request: api::GoogleCloudRunV2Job = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_jobs_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            .iter()
        {
            ...
            match key {
                ...
                "job-id" => {
                    call = call.job_id(value.unwrap_or(""));
                }
                _ => {
                    let mut found = false;
                    for param in &self.gp {
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                let mut v = Vec::new();
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(["job-id", "validate-only"].iter().map(|v| *v));
                                v
                            }));
                    }
                }
    ...
    async fn _projects_locations_jobs_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_jobs_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_jobs_executions_cancel(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::GoogleCloudRunV2CancelExecutionRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_jobs_executions_cancel(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_jobs_executions_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_jobs_executions_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_jobs_executions_export_status(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.projects().locations_jobs_executions_export_status(
    ...
    async fn _projects_locations_jobs_executions_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_jobs_executions_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_jobs_executions_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_jobs_executions_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_jobs_executions_tasks_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_jobs_executions_tasks_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_jobs_executions_tasks_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_jobs_executions_tasks_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_jobs_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_jobs_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_jobs_get_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_jobs_get_iam_policy(opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_jobs_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_jobs_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_jobs_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_jobs_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_jobs_run(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::GoogleCloudRunV2RunJobRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_jobs_run(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_jobs_set_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_jobs_set_iam_policy(request, opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_jobs_test_iam_permissions(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_jobs_test_iam_permissions(request, opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_operations_wait(
        ...
        let mut request: api::GoogleLongrunningWaitOperationRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
    ...
    async fn _projects_locations_services_create(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "scaling.min-instance-count" => Some((
                ...
                "template.execution-environment" => Some((
                ...
                "template.health-check-disabled" => Some((
                    "template.healthCheckDisabled",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                ...
                "template.max-instance-request-concurrency" => Some((
                ...
                "template.node-selector.accelerator" => Some((
                    "template.nodeSelector.accelerator",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "template.revision" => Some((
                    "template.revision",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                ...
                "template.scaling.max-instance-count" => Some((
                ...
                "template.scaling.min-instance-count" => Some((
                ...
                "template.session-affinity" => Some((
                ...
                "template.vpc-access.connector" => Some((
                ...
                "template.vpc-access.egress" => Some((
        ...
        let mut request: api::GoogleCloudRunV2Service =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                let mut v = Vec::new();
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(["service-id", "validate-only"].iter().map(|v| *v));
                                v
                            }));
                    }
                }
    ...
    async fn _projects_locations_services_revisions_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_services_revisions_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_services_revisions_export_status(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_services_revisions_export_status(
                opt.value_of("name").unwrap_or(""),
                opt.value_of("operation-id").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_services_revisions_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_services_revisions_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_services_revisions_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_services_revisions_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
        ...
        match self.opt.subcommand() {
            ("projects", Some(opt)) => match opt.subcommand() {
                ("locations-export-image", Some(opt)) => {
                    call_result = self
                        ._projects_locations_export_image(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-export-image-metadata", Some(opt)) => {
                    call_result = self
                        ._projects_locations_export_image_metadata(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-export-metadata", Some(opt)) => {
                    call_result = self
                        ._projects_locations_export_metadata(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-jobs-create", Some(opt)) => {
                    call_result = self
                        ._projects_locations_jobs_create(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-jobs-delete", Some(opt)) => {
                    call_result = self
                        ._projects_locations_jobs_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-jobs-executions-cancel", Some(opt)) => {
                    call_result = self
                        ._projects_locations_jobs_executions_cancel(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-jobs-executions-delete", Some(opt)) => {
                    call_result = self
                        ._projects_locations_jobs_executions_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-jobs-executions-export-status", Some(opt)) => {
                    call_result = self
                        ._projects_locations_jobs_executions_export_status(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-jobs-executions-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_jobs_executions_get(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-jobs-executions-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_jobs_executions_list(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-jobs-executions-tasks-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_jobs_executions_tasks_get(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-jobs-executions-tasks-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_jobs_executions_tasks_list(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-jobs-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_jobs_get(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-jobs-get-iam-policy", Some(opt)) => {
                    call_result = self
                        ._projects_locations_jobs_get_iam_policy(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-jobs-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_jobs_list(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-jobs-patch", Some(opt)) => {
                    call_result = self
                        ._projects_locations_jobs_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-jobs-run", Some(opt)) => {
                    call_result = self
                        ._projects_locations_jobs_run(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-jobs-set-iam-policy", Some(opt)) => {
                    call_result = self
                        ._projects_locations_jobs_set_iam_policy(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-jobs-test-iam-permissions", Some(opt)) => {
                    call_result = self
                        ._projects_locations_jobs_test_iam_permissions(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("locations-services-revisions-delete", Some(opt)) => {
                    call_result = self
                        ._projects_locations_services_revisions_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-services-revisions-export-status", Some(opt)) => {
                    call_result = self
                        ._projects_locations_services_revisions_export_status(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-services-revisions-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_services_revisions_get(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-services-revisions-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_services_revisions_list(opt, dry_run, &mut err)
                        .await;
                }
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "run2-secret.json",
        ...
        .persist_tokens_to_disk(format!("{}/run2", config_dir))
        .build()
        .await
        .unwrap();
        ...
        ("projects", "methods: 'locations-export-image', 'locations-export-image-metadata', 'locations-export-metadata', 'locations-jobs-create', 'locations-jobs-delete', 'locations-jobs-executions-cancel', 'locations-jobs-executions-delete', 'locations-jobs-executions-export-status', 'locations-jobs-executions-get', 'locations-jobs-executions-list', 'locations-jobs-executions-tasks-get', 'locations-jobs-executions-tasks-list', 'locations-jobs-get', 'locations-jobs-get-iam-policy', 'locations-jobs-list', 'locations-jobs-patch', 'locations-jobs-run', 'locations-jobs-set-iam-policy', 'locations-jobs-test-iam-permissions', 'locations-operations-delete', 'locations-operations-get', 'locations-operations-list', 'locations-operations-wait', 'locations-services-create', 'locations-services-delete', 'locations-services-get', 'locations-services-get-iam-policy', 'locations-services-list', 'locations-services-patch', 'locations-services-revisions-delete', 'locations-services-revisions-export-status', 'locations-services-revisions-get', 'locations-services-revisions-list', 'locations-services-set-iam-policy' and 'locations-services-test-iam-permissions'", vec![
            ...
            ("locations-jobs-create",
                  ...
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The location and project in which this Job should be created. Format: projects/{project}/locations/{location}, where {project} can be project id or number."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("locations-jobs-delete",
                    Some(r##"Deletes a Job."##),
                    "Details at http://byron.github.io/google-apis-rs/google_run2_cli/projects_locations-jobs-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The full name of the Job. Format: projects/{project}/locations/{location}/jobs/{job}, where {project} can be project id or number."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("locations-jobs-executions-tasks-get",
                    Some(r##"Gets information about a Task."##),
                    "Details at http://byron.github.io/google-apis-rs/google_run2_cli/projects_locations-jobs-executions-tasks-get",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The full name of the Task. Format: projects/{project}/locations/{location}/jobs/{job}/executions/{execution}/tasks/{task}"##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("locations-jobs-executions-tasks-list",
                    Some(r##"Lists Tasks from an Execution of a Job."##),
                    "Details at http://byron.github.io/google-apis-rs/google_run2_cli/projects_locations-jobs-executions-tasks-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The Execution from which the Tasks should be listed. To list all Tasks across Executions of a Job, use "-" instead of Execution name. To list all Tasks across Jobs, use "-" instead of Job name. Format: projects/{project}/locations/{location}/jobs/{job}/executions/{execution}"##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("locations-jobs-get",
                    Some(r##"Gets information about a Job."##),
                    "Details at http://byron.github.io/google-apis-rs/google_run2_cli/projects_locations-jobs-get",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The full name of the Job. Format: projects/{project}/locations/{location}/jobs/{job}, where {project} can be project id or number."##),
            ...
            ("locations-jobs-get-iam-policy",
                    Some(r##"Gets the IAM Access Control policy currently in effect for the given Job. This result does not include any inherited policies."##),
                    "Details at http://byron.github.io/google-apis-rs/google_run2_cli/projects_locations-jobs-get-iam-policy",
                  vec![
                    (Some(r##"resource"##),
                     None,
            ...
            ("locations-jobs-list",
                  ...
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The location and project to list resources on. Format: projects/{project}/locations/{location}, where {project} can be project id or number."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("locations-jobs-patch",
                    Some(r##"Updates a Job."##),
                    "Details at http://byron.github.io/google-apis-rs/google_run2_cli/projects_locations-jobs-patch",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"The fully qualified name of this Job. Format: projects/{project}/locations/{location}/jobs/{job}"##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("locations-jobs-run",
                    Some(r##"Triggers creation of a new Execution of this Job."##),
                    "Details at http://byron.github.io/google-apis-rs/google_run2_cli/projects_locations-jobs-run",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The full name of the Job. Format: projects/{project}/locations/{location}/jobs/{job}, where {project} can be project id or number."##),
            ...
            ("locations-jobs-set-iam-policy",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_run2_cli/projects_locations-jobs-set-iam-policy",
                  vec![
                    (Some(r##"resource"##),
                     None,
            ...
            ("locations-jobs-test-iam-permissions",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_run2_cli/projects_locations-jobs-test-iam-permissions",
                  vec![
                    (Some(r##"resource"##),
                     None,
            ...
            ("locations-operations-delete",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_run2_cli/projects_locations-operations-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-operations-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_run2_cli/projects_locations-operations-get",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-operations-wait",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_run2_cli/projects_locations-operations-wait",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-services-create",
                    Some(r##"Creates a new Service in a given project and location."##),
                    "Details at http://byron.github.io/google-apis-rs/google_run2_cli/projects_locations-services-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The location and project in which this service should be created. Format: projects/{project}/locations/{location}, where {project} can be project id or number. Only lowercase characters, digits, and hyphens."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("locations-services-delete",
                    Some(r##"Deletes a Service. This will cause the Service to stop serving traffic and will delete all revisions."##),
                    "Details at http://byron.github.io/google-apis-rs/google_run2_cli/projects_locations-services-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The full name of the Service. Format: projects/{project}/locations/{location}/services/{service}, where {project} can be project id or number."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("locations-services-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_run2_cli/projects_locations-services-get",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The full name of the Service. Format: projects/{project}/locations/{location}/services/{service}, where {project} can be project id or number."##),
            ...
            ("locations-services-get-iam-policy",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_run2_cli/projects_locations-services-get-iam-policy",
                  vec![
                    (Some(r##"resource"##),
                     None,
                     Some(r##"REQUIRED: The resource for which the policy is being requested. See [Resource names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for this field."##),
            ...
            ("locations-services-list",
                  ...
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The location and project to list resources on. Location must be a valid Google Cloud region, and cannot be the "-" wildcard. Format: projects/{project}/locations/{location}, where {project} can be project id or number."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("locations-services-patch",
                    Some(r##"Updates a Service."##),
                    "Details at http://byron.github.io/google-apis-rs/google_run2_cli/projects_locations-services-patch",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"The fully qualified name of this Service. In CreateServiceRequest, this field is ignored, and instead composed from CreateServiceRequest.parent and CreateServiceRequest.service_id. Format: projects/{project}/locations/{location}/services/{service_id}"##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("locations-services-revisions-delete",
                    Some(r##"Deletes a Revision."##),
                    "Details at http://byron.github.io/google-apis-rs/google_run2_cli/projects_locations-services-revisions-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The name of the Revision to delete. Format: projects/{project}/locations/{location}/services/{service}/revisions/{revision}"##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("locations-services-revisions-get",
                  ...
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The full name of the Revision. Format: projects/{project}/locations/{location}/services/{service}/revisions/{revision}"##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("locations-services-revisions-list",
                  ...
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The Service from which the Revisions should be listed. To list all Revisions across Services, use "-" instead of Service name. Format: projects/{project}/locations/{location}/services/{service}"##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("locations-services-set-iam-policy",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_run2_cli/projects_locations-services-set-iam-policy",
                  vec![
                    (Some(r##"resource"##),
                     None,
                     Some(r##"REQUIRED: The resource for which the policy is being specified. See [Resource names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for this field."##),
            ...
            ("locations-services-test-iam-permissions",
                    Some(r##"Returns permissions that a caller has on the specified Project. There are no permissions required for making this API call."##),
                    "Details at http://byron.github.io/google-apis-rs/google_run2_cli/projects_locations-services-test-iam-permissions",
                  vec![
                    (Some(r##"resource"##),
                     None,
                     Some(r##"REQUIRED: The resource for which the policy detail is being requested. See [Resource names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for this field."##),
