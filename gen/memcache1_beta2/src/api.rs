...
/// ```
#[derive(Clone)]
pub struct CloudMemorystoreForMemcached<C> {
...
impl<C> common::Hub for CloudMemorystoreForMemcached<C> {}

impl<'a, C> CloudMemorystoreForMemcached<C> {
    pub fn new<A: 'static + common::GetToken>(
        client: common::Client<C>,
        auth: A,
    ) -> CloudMemorystoreForMemcached<C> {
...
impl common::RequestValue for ApplyParametersRequest {}
...
impl common::RequestValue for ApplySoftwareUpdateRequest {}
...
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
pub struct GoogleCloudMemcacheV1beta2MaintenancePolicy {
...
impl common::Part for GoogleCloudMemcacheV1beta2MaintenancePolicy {}
...
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
pub struct GoogleCloudMemcacheV1beta2UpgradeInstanceRequest {
...
impl common::RequestValue for GoogleCloudMemcacheV1beta2UpgradeInstanceRequest {}
...
pub struct Instance {
    ...
    pub maintenance_policy: Option<GoogleCloudMemcacheV1beta2MaintenancePolicy>,
    ...
    #[serde(rename = "reservedIpRangeId")]
...
impl common::Part for InstanceMessage {}
...
impl common::Part for MemcacheParameters {}
...
impl common::RequestValue for UpdateParametersRequest {}
...
where
    C: 'a,
{
    hub: &'a CloudMemorystoreForMemcached<C>,
}
...
impl<'a, C> ProjectMethods<'a, C> {
    ...
    pub fn locations_instances_apply_parameters(
        &self,
        request: ApplyParametersRequest,
        name: &str,
    ) -> ProjectLocationInstanceApplyParameterCall<'a, C> {
    ...
    pub fn locations_instances_apply_software_update(
        &self,
        request: ApplySoftwareUpdateRequest,
        instance: &str,
    ) -> ProjectLocationInstanceApplySoftwareUpdateCall<'a, C> {
    ...
    pub fn locations_instances_update_parameters(
        &self,
        request: UpdateParametersRequest,
        name: &str,
    ) -> ProjectLocationInstanceUpdateParameterCall<'a, C> {
    ...
    pub fn locations_instances_upgrade(
        &self,
        request: GoogleCloudMemcacheV1beta2UpgradeInstanceRequest,
        name: &str,
...
/// # }
/// ```
pub struct ProjectLocationInstanceApplyParameterCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudMemorystoreForMemcached<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationInstanceApplyParameterCall<'a, C> {}

impl<'a, C> ProjectLocationInstanceApplyParameterCall<'a, C>
where
    C: common::Connector,
{
    ...
    pub fn request(
        mut self,
        new_value: ApplyParametersRequest,
    ) -> ProjectLocationInstanceApplyParameterCall<'a, C> {
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationInstanceApplyParameterCall<'a, C> {
    ...
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationInstanceApplyParameterCall<'a, C>
    where
        T: AsRef<str>,
    {
    ...
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationInstanceApplyParameterCall<'a, C>
    where
        St: AsRef<str>,
    {
    ...
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationInstanceApplyParameterCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationInstanceApplySoftwareUpdateCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudMemorystoreForMemcached<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationInstanceApplySoftwareUpdateCall<'a, C> {}

impl<'a, C> ProjectLocationInstanceApplySoftwareUpdateCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    pub fn request(
        mut self,
        new_value: ApplySoftwareUpdateRequest,
    ) -> ProjectLocationInstanceApplySoftwareUpdateCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationInstanceApplySoftwareUpdateCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # extern crate hyper_rustls;
/// # extern crate google_memcache1_beta2 as memcache1_beta2;
/// use memcache1_beta2::api::RescheduleMaintenanceRequest;
/// # async fn dox() {
/// # use memcache1_beta2::{CloudMemorystoreForMemcached, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().locations_instances_reschedule_maintenance(req, "instance")
///              .doit().await;
/// # }
/// ```
    ...
    C: common::Connector,
{
    ...
    pub async fn doit(mut self) -> common::Result<(common::Response, Operation)> {
        ...
        params.push("alt", "json");
        let mut url = self.hub._base_url.clone() + "v1beta2/{+instance}:rescheduleMaintenance";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string());
        }
...
/// # }
/// ```
pub struct ProjectLocationInstanceUpdateParameterCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudMemorystoreForMemcached<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationInstanceUpdateParameterCall<'a, C> {}

impl<'a, C> ProjectLocationInstanceUpdateParameterCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    pub fn request(
        mut self,
        new_value: UpdateParametersRequest,
    ) -> ProjectLocationInstanceUpdateParameterCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationInstanceUpdateParameterCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationInstanceUpdateParameterCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationInstanceUpdateParameterCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # extern crate hyper_rustls;
/// # extern crate google_memcache1_beta2 as memcache1_beta2;
/// use memcache1_beta2::api::GoogleCloudMemcacheV1beta2UpgradeInstanceRequest;
/// # async fn dox() {
/// # use memcache1_beta2::{CloudMemorystoreForMemcached, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = GoogleCloudMemcacheV1beta2UpgradeInstanceRequest::default();
///
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
...
{
    hub: &'a CloudMemorystoreForMemcached<C>,
    _request: GoogleCloudMemcacheV1beta2UpgradeInstanceRequest,
    _name: String,
    _delegate: Option<&'a mut dyn common::Delegate>,
    _additional_params: HashMap<String, String>,
    _scopes: BTreeSet<String>,
    ...
    C: common::Connector,
{
    ...
    pub async fn doit(mut self) -> common::Result<(common::Response, Operation)> {
        ...
        params.push("alt", "json");
        let mut url = self.hub._base_url.clone() + "v1beta2/{+name}:upgrade";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string());
        }
    ...
    pub fn request(
        mut self,
        new_value: GoogleCloudMemcacheV1beta2UpgradeInstanceRequest,
    ) -> ProjectLocationInstanceUpgradeCall<'a, C> {
        self._request = new_value;
        self
    }
