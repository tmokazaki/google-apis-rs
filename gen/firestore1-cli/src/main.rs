...
use google_firestore1::{api, yup_oauth2, Error};
...
{
    async fn _projects_databases_backup_schedules_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        ...
        let mut request: api::GoogleFirestoreAdminV1BackupSchedule =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .databases_backup_schedules_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_databases_backup_schedules_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .databases_backup_schedules_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_databases_backup_schedules_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .databases_backup_schedules_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_databases_backup_schedules_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .databases_backup_schedules_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_databases_backup_schedules_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .databases_backup_schedules_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_databases_bulk_delete_documents(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion =
                        FieldCursor::did_you_mean(key, &vec!["collection-ids", "namespace-ids"]);
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
                        value.map(|v| v.to_string()),
        ...
        let mut request: api::GoogleFirestoreAdminV1BulkDeleteDocumentsRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
    ...
    async fn _projects_databases_collection_groups_fields_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .databases_collection_groups_fields_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_databases_collection_groups_fields_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .databases_collection_groups_fields_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_databases_collection_groups_fields_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                "index-config.ancestor-field" => Some((
                ...
                "index-config.uses-ancestor-config" => Some((
        ...
        let mut request: api::GoogleFirestoreAdminV1Field =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .databases_collection_groups_fields_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_databases_collection_groups_indexes_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::GoogleFirestoreAdminV1Index =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .databases_collection_groups_indexes_create(
                request,
    ...
    async fn _projects_databases_collection_groups_indexes_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .databases_collection_groups_indexes_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_databases_collection_groups_indexes_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .databases_collection_groups_indexes_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_databases_collection_groups_indexes_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .databases_collection_groups_indexes_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_databases_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                "app-engine-integration-mode" => Some((
                ...
                "cmek-config.active-key-version" => Some((
                ...
                "point-in-time-recovery-enablement" => Some((
        ...
        let mut request: api::GoogleFirestoreAdminV1Database =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .databases_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            .iter()
        {
            ...
            match key {
                "database-id" => {
                    call = call.database_id(value.unwrap_or(""));
                }
                _ => {
                    let mut found = false;
                    for param in &self.gp {
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                let mut v = Vec::new();
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(["database-id"].iter().map(|v| *v));
                                v
                            }));
                    }
                }
    ...
    async fn _projects_databases_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .databases_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_databases_documents_batch_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::BatchGetDocumentsRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .databases_documents_batch_get(request, opt.value_of("database").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_databases_documents_batch_write(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::BatchWriteRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .databases_documents_batch_write(request, opt.value_of("database").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_databases_documents_begin_transaction(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                "options.read-only.read-time" => Some((
                    "options.readOnly.readTime",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "options.read-write.retry-transaction" => Some((
        ...
        let mut request: api::BeginTransactionRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .databases_documents_begin_transaction(request, opt.value_of("database").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_databases_documents_commit(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::CommitRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .databases_documents_commit(request, opt.value_of("database").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_databases_documents_create_document(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion =
                        FieldCursor::did_you_mean(key, &vec!["create-time", "name", "update-time"]);
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
                        value.map(|v| v.to_string()),
        ...
        let mut request: api::Document = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.projects().databases_documents_create_document(
            request,
            opt.value_of("parent").unwrap_or(""),
            opt.value_of("collection-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _projects_databases_documents_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .databases_documents_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            .iter()
        {
            ...
            match key {
                "current-document-update-time" => {
                    call = call.current_document_update_time(
                        value
                            .map(|v| {
                                arg_from_str(
                                    v,
                ...
                "current-document-exists" => {
                    call = call.current_document_exists(
                        value
                            .map(|v| arg_from_str(v, err, "current-document-exists", "boolean"))
                            .unwrap_or(false),
                    );
                }
                _ => {
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["current-document-exists", "current-document-update-time"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _projects_databases_documents_get(
        ...
        let mut call = self
            .hub
            .projects()
            .databases_documents_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            ...
            match key {
                "transaction" => {
                    call = call.transaction(
                        value
                            .map(|v| arg_from_str(v, err, "transaction", "byte"))
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["mask-field-paths", "read-time", "transaction"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _projects_databases_documents_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.projects().databases_documents_list(
            opt.value_of("parent").unwrap_or(""),
            opt.value_of("collection-id").unwrap_or(""),
        );
        for parg in opt
            ...
            .iter()
        {
            ...
            match key {
                ...
                "show-missing" => {
                    call = call.show_missing(
                        value
                            .map(|v| arg_from_str(v, err, "show-missing", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "read-time" => {
    ...
    async fn _projects_databases_documents_list_collection_ids(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec!["page-size", "page-token", "read-time"],
                    );
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
        ...
        let mut request: api::ListCollectionIdsRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .databases_documents_list_collection_ids(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_databases_documents_list_documents(
        ...
        let mut call = self.hub.projects().databases_documents_list_documents(
            opt.value_of("parent").unwrap_or(""),
            opt.value_of("collection-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _projects_databases_documents_listen(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::ListenRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .databases_documents_listen(request, opt.value_of("database").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_databases_documents_partition_query(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "structured-query.end-at.before" => Some((
                    "structuredQuery.endAt.before",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "structured-query.find-nearest.distance-measure" => Some((
                ...
                "structured-query.find-nearest.query-vector.boolean-value" => Some((
                    "structuredQuery.findNearest.queryVector.booleanValue",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "structured-query.find-nearest.query-vector.bytes-value" => Some((
                    "structuredQuery.findNearest.queryVector.bytesValue",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "structured-query.find-nearest.query-vector.double-value" => Some((
                ...
                "structured-query.find-nearest.query-vector.geo-point-value.latitude" => Some((
                    "structuredQuery.findNearest.queryVector.geoPointValue.latitude",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "structured-query.find-nearest.query-vector.geo-point-value.longitude" => Some((
                    "structuredQuery.findNearest.queryVector.geoPointValue.longitude",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "structured-query.find-nearest.query-vector.integer-value" => Some((
                    "structuredQuery.findNearest.queryVector.integerValue",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "structured-query.find-nearest.query-vector.null-value" => Some((
                    "structuredQuery.findNearest.queryVector.nullValue",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "structured-query.find-nearest.query-vector.reference-value" => Some((
                    "structuredQuery.findNearest.queryVector.referenceValue",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "structured-query.find-nearest.query-vector.string-value" => Some((
                    "structuredQuery.findNearest.queryVector.stringValue",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "structured-query.find-nearest.query-vector.timestamp-value" => Some((
                    "structuredQuery.findNearest.queryVector.timestampValue",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "structured-query.find-nearest.vector-field.field-path" => Some((
                    "structuredQuery.findNearest.vectorField.fieldPath",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "structured-query.limit" => Some((
                ...
                "structured-query.start-at.before" => Some((
                    "structuredQuery.startAt.before",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "structured-query.where.composite-filter.op" => Some((
                    "structuredQuery.where.compositeFilter.op",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "structured-query.where.field-filter.field.field-path" => Some((
                    "structuredQuery.where.fieldFilter.field.fieldPath",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "structured-query.where.field-filter.op" => Some((
                    "structuredQuery.where.fieldFilter.op",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "structured-query.where.field-filter.value.boolean-value" => Some((
                    "structuredQuery.where.fieldFilter.value.booleanValue",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "structured-query.where.field-filter.value.bytes-value" => Some((
                    "structuredQuery.where.fieldFilter.value.bytesValue",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "structured-query.where.field-filter.value.double-value" => Some((
                    "structuredQuery.where.fieldFilter.value.doubleValue",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                ...
                "structured-query.where.field-filter.value.geo-point-value.longitude" => Some((
                    "structuredQuery.where.fieldFilter.value.geoPointValue.longitude",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "structured-query.where.field-filter.value.integer-value" => Some((
                    "structuredQuery.where.fieldFilter.value.integerValue",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "structured-query.where.field-filter.value.null-value" => Some((
                    "structuredQuery.where.fieldFilter.value.nullValue",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "structured-query.where.field-filter.value.reference-value" => Some((
                    "structuredQuery.where.fieldFilter.value.referenceValue",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "structured-query.where.field-filter.value.string-value" => Some((
                ...
                "structured-query.where.field-filter.value.timestamp-value" => Some((
                    "structuredQuery.where.fieldFilter.value.timestampValue",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "structured-query.where.unary-filter.field.field-path" => Some((
                    "structuredQuery.where.unaryFilter.field.fieldPath",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "structured-query.where.unary-filter.op" => Some((
                    "structuredQuery.where.unaryFilter.op",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
        ...
        let mut request: api::PartitionQueryRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .databases_documents_partition_query(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_databases_documents_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .databases_documents_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_databases_documents_rollback(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::RollbackRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .databases_documents_rollback(request, opt.value_of("database").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_databases_documents_run_aggregation_query(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::RunAggregationQueryRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .databases_documents_run_aggregation_query(
                request,
                opt.value_of("parent").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_databases_documents_run_query(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .databases_documents_run_query(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_databases_documents_write(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec!["labels", "stream-id", "stream-token"],
                    );
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
        ...
        let mut request: api::WriteRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .databases_documents_write(request, opt.value_of("database").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_databases_export_documents(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::GoogleFirestoreAdminV1ExportDocumentsRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .databases_export_documents(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_databases_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .databases_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_databases_import_documents(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec!["collection-ids", "input-uri-prefix", "namespace-ids"],
                    );
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
        ...
        let mut request: api::GoogleFirestoreAdminV1ImportDocumentsRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .databases_import_documents(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_databases_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .databases_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_databases_operations_cancel(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .databases_operations_cancel(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_databases_operations_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .databases_operations_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_databases_operations_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .databases_operations_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_databases_operations_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .databases_operations_list(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_databases_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .databases_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_databases_restore(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::GoogleFirestoreAdminV1RestoreDatabaseRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
    ...
    async fn _projects_locations_backups_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_backups_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_backups_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_backups_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_backups_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_backups_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _doit(
        ...
        match self.opt.subcommand() {
            ("projects", Some(opt)) => match opt.subcommand() {
                ("databases-backup-schedules-create", Some(opt)) => {
                    call_result = self
                        ._projects_databases_backup_schedules_create(opt, dry_run, &mut err)
                        .await;
                }
                ("databases-backup-schedules-delete", Some(opt)) => {
                    call_result = self
                        ._projects_databases_backup_schedules_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("databases-backup-schedules-get", Some(opt)) => {
                    call_result = self
                        ._projects_databases_backup_schedules_get(opt, dry_run, &mut err)
                        .await;
                }
                ("databases-backup-schedules-list", Some(opt)) => {
                    call_result = self
                        ._projects_databases_backup_schedules_list(opt, dry_run, &mut err)
                        .await;
                }
                ("databases-backup-schedules-patch", Some(opt)) => {
                    call_result = self
                        ._projects_databases_backup_schedules_patch(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("databases-collection-groups-fields-list", Some(opt)) => {
                    call_result = self
                        ._projects_databases_collection_groups_fields_list(opt, dry_run, &mut err)
                        .await;
                }
                ("databases-collection-groups-fields-patch", Some(opt)) => {
                    call_result = self
                        ._projects_databases_collection_groups_fields_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("databases-collection-groups-indexes-create", Some(opt)) => {
                    call_result = self
                        ._projects_databases_collection_groups_indexes_create(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("databases-collection-groups-indexes-delete", Some(opt)) => {
                    call_result = self
                        ._projects_databases_collection_groups_indexes_delete(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("databases-collection-groups-indexes-get", Some(opt)) => {
                    call_result = self
                        ._projects_databases_collection_groups_indexes_get(opt, dry_run, &mut err)
                        .await;
                }
                ("databases-collection-groups-indexes-list", Some(opt)) => {
                    call_result = self
                        ._projects_databases_collection_groups_indexes_list(opt, dry_run, &mut err)
                        .await;
                }
                ("databases-create", Some(opt)) => {
                    call_result = self
                        ._projects_databases_create(opt, dry_run, &mut err)
                        .await;
                }
                ("databases-delete", Some(opt)) => {
                    call_result = self
                        ._projects_databases_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("databases-documents-batch-get", Some(opt)) => {
                    call_result = self
                        ._projects_databases_documents_batch_get(opt, dry_run, &mut err)
                        .await;
                }
                ("databases-documents-batch-write", Some(opt)) => {
                    call_result = self
                        ._projects_databases_documents_batch_write(opt, dry_run, &mut err)
                        .await;
                }
                ("databases-documents-begin-transaction", Some(opt)) => {
                    call_result = self
                        ._projects_databases_documents_begin_transaction(opt, dry_run, &mut err)
                        .await;
                }
                ("databases-documents-commit", Some(opt)) => {
                    call_result = self
                        ._projects_databases_documents_commit(opt, dry_run, &mut err)
                        .await;
                }
                ("databases-documents-create-document", Some(opt)) => {
                    call_result = self
                        ._projects_databases_documents_create_document(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("databases-documents-list", Some(opt)) => {
                    call_result = self
                        ._projects_databases_documents_list(opt, dry_run, &mut err)
                        .await;
                }
                ("databases-documents-list-collection-ids", Some(opt)) => {
                    call_result = self
                        ._projects_databases_documents_list_collection_ids(opt, dry_run, &mut err)
                        .await;
                }
                ("databases-documents-list-documents", Some(opt)) => {
                    call_result = self
                        ._projects_databases_documents_list_documents(opt, dry_run, &mut err)
                        .await;
                }
                ("databases-documents-listen", Some(opt)) => {
                    call_result = self
                        ._projects_databases_documents_listen(opt, dry_run, &mut err)
                        .await;
                }
                ("databases-documents-partition-query", Some(opt)) => {
                    call_result = self
                        ._projects_databases_documents_partition_query(opt, dry_run, &mut err)
                        .await;
                }
                ("databases-documents-patch", Some(opt)) => {
                    call_result = self
                        ._projects_databases_documents_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("databases-documents-rollback", Some(opt)) => {
                    call_result = self
                        ._projects_databases_documents_rollback(opt, dry_run, &mut err)
                        .await;
                }
                ("databases-documents-run-aggregation-query", Some(opt)) => {
                    call_result = self
                        ._projects_databases_documents_run_aggregation_query(opt, dry_run, &mut err)
                        .await;
                }
                ("databases-documents-run-query", Some(opt)) => {
                    call_result = self
                        ._projects_databases_documents_run_query(opt, dry_run, &mut err)
                        .await;
                }
                ("databases-documents-write", Some(opt)) => {
                    call_result = self
                        ._projects_databases_documents_write(opt, dry_run, &mut err)
                        .await;
                }
                ("databases-export-documents", Some(opt)) => {
                    call_result = self
                        ._projects_databases_export_documents(opt, dry_run, &mut err)
                        .await;
                }
                ("databases-get", Some(opt)) => {
                    call_result = self._projects_databases_get(opt, dry_run, &mut err).await;
                }
                ("databases-import-documents", Some(opt)) => {
                    call_result = self
                        ._projects_databases_import_documents(opt, dry_run, &mut err)
                        .await;
                }
                ("databases-list", Some(opt)) => {
                    call_result = self._projects_databases_list(opt, dry_run, &mut err).await;
                }
                ("databases-operations-cancel", Some(opt)) => {
                    call_result = self
                        ._projects_databases_operations_cancel(opt, dry_run, &mut err)
                        .await;
                }
                ("databases-operations-delete", Some(opt)) => {
                    call_result = self
                        ._projects_databases_operations_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("databases-operations-get", Some(opt)) => {
                    call_result = self
                        ._projects_databases_operations_get(opt, dry_run, &mut err)
                        .await;
                }
                ("databases-operations-list", Some(opt)) => {
                    call_result = self
                        ._projects_databases_operations_list(opt, dry_run, &mut err)
                        .await;
                }
                ("databases-patch", Some(opt)) => {
                    call_result = self._projects_databases_patch(opt, dry_run, &mut err).await;
                }
                ("databases-restore", Some(opt)) => {
                    call_result = self
                ...
                ("locations-backups-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_backups_get(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-backups-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_backups_list(opt, dry_run, &mut err)
                        .await;
                }
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "firestore1-secret.json",
        ...
        ("projects", "methods: 'databases-backup-schedules-create', 'databases-backup-schedules-delete', 'databases-backup-schedules-get', 'databases-backup-schedules-list', 'databases-backup-schedules-patch', 'databases-bulk-delete-documents', 'databases-collection-groups-fields-get', 'databases-collection-groups-fields-list', 'databases-collection-groups-fields-patch', 'databases-collection-groups-indexes-create', 'databases-collection-groups-indexes-delete', 'databases-collection-groups-indexes-get', 'databases-collection-groups-indexes-list', 'databases-create', 'databases-delete', 'databases-documents-batch-get', 'databases-documents-batch-write', 'databases-documents-begin-transaction', 'databases-documents-commit', 'databases-documents-create-document', 'databases-documents-delete', 'databases-documents-get', 'databases-documents-list', 'databases-documents-list-collection-ids', 'databases-documents-list-documents', 'databases-documents-listen', 'databases-documents-partition-query', 'databases-documents-patch', 'databases-documents-rollback', 'databases-documents-run-aggregation-query', 'databases-documents-run-query', 'databases-documents-write', 'databases-export-documents', 'databases-get', 'databases-import-documents', 'databases-list', 'databases-operations-cancel', 'databases-operations-delete', 'databases-operations-get', 'databases-operations-list', 'databases-patch', 'databases-restore', 'locations-backups-delete', 'locations-backups-get', 'locations-backups-list', 'locations-get' and 'locations-list'", vec![
            ("databases-backup-schedules-create",
                  ...
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The parent database. Format `projects/{project}/databases/{database}`"##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("databases-backup-schedules-delete",
                    Some(r##"Deletes a backup schedule."##),
                    "Details at http://byron.github.io/google-apis-rs/google_firestore1_cli/projects_databases-backup-schedules-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("databases-backup-schedules-get",
                    Some(r##"Gets information about a backup schedule."##),
                    "Details at http://byron.github.io/google-apis-rs/google_firestore1_cli/projects_databases-backup-schedules-get",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The name of the backup schedule. Format `projects/{project}/databases/{database}/backupSchedules/{backup_schedule}`"##),
            ...
            ("databases-backup-schedules-list",
                    Some(r##"List backup schedules."##),
                    "Details at http://byron.github.io/google-apis-rs/google_firestore1_cli/projects_databases-backup-schedules-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The parent database. Format is `projects/{project}/databases/{database}`."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("databases-backup-schedules-patch",
                    Some(r##"Updates a backup schedule."##),
                    "Details at http://byron.github.io/google-apis-rs/google_firestore1_cli/projects_databases-backup-schedules-patch",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Output only. The unique backup schedule identifier across all locations and databases for the given project. This will be auto-assigned. Format is `projects/{project}/databases/{database}/backupSchedules/{backup_schedule}`"##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("databases-collection-groups-fields-get",
                  ...
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. A name of the form `projects/{project_id}/databases/{database_id}/collectionGroups/{collection_id}/fields/{field_id}`"##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("databases-collection-groups-fields-list",
                    Some(r##"Lists the field configuration and metadata for this database. Currently, FirestoreAdmin.ListFields only supports listing fields that have been explicitly overridden. To issue this query, call FirestoreAdmin.ListFields with the filter set to `indexConfig.usesAncestorConfig:false` or `ttlConfig:*`."##),
                    "Details at http://byron.github.io/google-apis-rs/google_firestore1_cli/projects_databases-collection-groups-fields-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. A parent name of the form `projects/{project_id}/databases/{database_id}/collectionGroups/{collection_id}`"##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("databases-collection-groups-fields-patch",
                    Some(r##"Updates a field configuration. Currently, field updates apply only to single field index configuration. However, calls to FirestoreAdmin.UpdateField should provide a field mask to avoid changing any configuration that the caller isn't aware of. The field mask should be specified as: `{ paths: "index_config" }`. This call returns a google.longrunning.Operation which may be used to track the status of the field update. The metadata for the operation will be the type FieldOperationMetadata. To configure the default field settings for the database, use the special `Field` with resource name: `projects/{project_id}/databases/{database_id}/collectionGroups/__default__/fields/*`."##),
                    "Details at http://byron.github.io/google-apis-rs/google_firestore1_cli/projects_databases-collection-groups-fields-patch",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("databases-collection-groups-indexes-create",
                    Some(r##"Creates a composite index. This returns a google.longrunning.Operation which may be used to track the status of the creation. The metadata for the operation will be the type IndexOperationMetadata."##),
                    "Details at http://byron.github.io/google-apis-rs/google_firestore1_cli/projects_databases-collection-groups-indexes-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. A parent name of the form `projects/{project_id}/databases/{database_id}/collectionGroups/{collection_id}`"##),
            ...
            ("databases-collection-groups-indexes-delete",
                    Some(r##"Deletes a composite index."##),
                    "Details at http://byron.github.io/google-apis-rs/google_firestore1_cli/projects_databases-collection-groups-indexes-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. A name of the form `projects/{project_id}/databases/{database_id}/collectionGroups/{collection_id}/indexes/{index_id}`"##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("databases-collection-groups-indexes-get",
                    Some(r##"Gets a composite index."##),
                    "Details at http://byron.github.io/google-apis-rs/google_firestore1_cli/projects_databases-collection-groups-indexes-get",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. A name of the form `projects/{project_id}/databases/{database_id}/collectionGroups/{collection_id}/indexes/{index_id}`"##),
            ...
            ("databases-collection-groups-indexes-list",
                    Some(r##"Lists composite indexes."##),
                    "Details at http://byron.github.io/google-apis-rs/google_firestore1_cli/projects_databases-collection-groups-indexes-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. A parent name of the form `projects/{project_id}/databases/{database_id}/collectionGroups/{collection_id}`"##),
            ...
            ("databases-create",
                    Some(r##"Create a database."##),
                    "Details at http://byron.github.io/google-apis-rs/google_firestore1_cli/projects_databases-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. A parent name of the form `projects/{project_id}`"##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("databases-delete",
                    Some(r##"Deletes a database."##),
                    "Details at http://byron.github.io/google-apis-rs/google_firestore1_cli/projects_databases-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. A name of the form `projects/{project_id}/databases/{database_id}`"##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("databases-documents-batch-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_firestore1_cli/projects_databases-documents-batch-get",
                  vec![
                    (Some(r##"database"##),
                     None,
            ...
            ("databases-documents-batch-write",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_firestore1_cli/projects_databases-documents-batch-write",
                  vec![
                    (Some(r##"database"##),
                     None,
                     Some(r##"Required. The database name. In the format: `projects/{project_id}/databases/{database_id}`."##),
            ...
            ("databases-documents-begin-transaction",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_firestore1_cli/projects_databases-documents-begin-transaction",
                  vec![
                    (Some(r##"database"##),
                     None,
                     Some(r##"Required. The database name. In the format: `projects/{project_id}/databases/{database_id}`."##),
            ...
            ("databases-documents-commit",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_firestore1_cli/projects_databases-documents-commit",
                  vec![
                    (Some(r##"database"##),
                     None,
                     Some(r##"Required. The database name. In the format: `projects/{project_id}/databases/{database_id}`."##),
            ...
            ("databases-documents-create-document",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_firestore1_cli/projects_databases-documents-create-document",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("databases-documents-delete",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_firestore1_cli/projects_databases-documents-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("databases-documents-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_firestore1_cli/projects_databases-documents-get",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("databases-documents-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_firestore1_cli/projects_databases-documents-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("databases-documents-list-collection-ids",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_firestore1_cli/projects_databases-documents-list-collection-ids",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("databases-documents-list-documents",
                    Some(r##"Lists documents."##),
                    "Details at http://byron.github.io/google-apis-rs/google_firestore1_cli/projects_databases-documents-list-documents",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The parent resource name. In the format: `projects/{project_id}/databases/{database_id}/documents` or `projects/{project_id}/databases/{database_id}/documents/{document_path}`. For example: `projects/my-project/databases/my-database/documents` or `projects/my-project/databases/my-database/documents/chatrooms/my-chatroom`"##),
            ...
            ("databases-documents-listen",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_firestore1_cli/projects_databases-documents-listen",
                  vec![
                    (Some(r##"database"##),
                     None,
                     Some(r##"Required. The database name. In the format: `projects/{project_id}/databases/{database_id}`."##),
            ...
            ("databases-documents-partition-query",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_firestore1_cli/projects_databases-documents-partition-query",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("databases-documents-patch",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_firestore1_cli/projects_databases-documents-patch",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("databases-documents-rollback",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_firestore1_cli/projects_databases-documents-rollback",
                  vec![
                    (Some(r##"database"##),
                     None,
                     Some(r##"Required. The database name. In the format: `projects/{project_id}/databases/{database_id}`."##),
            ...
            ("databases-documents-run-aggregation-query",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_firestore1_cli/projects_databases-documents-run-aggregation-query",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The parent resource name. In the format: `projects/{project_id}/databases/{database_id}/documents` or `projects/{project_id}/databases/{database_id}/documents/{document_path}`. For example: `projects/my-project/databases/my-database/documents` or `projects/my-project/databases/my-database/documents/chatrooms/my-chatroom`"##),
            ...
            ("databases-documents-run-query",
                    Some(r##"Runs a query."##),
                    "Details at http://byron.github.io/google-apis-rs/google_firestore1_cli/projects_databases-documents-run-query",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The parent resource name. In the format: `projects/{project_id}/databases/{database_id}/documents` or `projects/{project_id}/databases/{database_id}/documents/{document_path}`. For example: `projects/my-project/databases/my-database/documents` or `projects/my-project/databases/my-database/documents/chatrooms/my-chatroom`"##),
            ...
            ("databases-documents-write",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_firestore1_cli/projects_databases-documents-write",
                  vec![
                    (Some(r##"database"##),
                     None,
            ...
            ("databases-export-documents",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_firestore1_cli/projects_databases-export-documents",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. Database to export. Should be of the form: `projects/{project_id}/databases/{database_id}`."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("databases-get",
                    Some(r##"Gets information about a database."##),
                    "Details at http://byron.github.io/google-apis-rs/google_firestore1_cli/projects_databases-get",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. A name of the form `projects/{project_id}/databases/{database_id}`"##),
            ...
            ("databases-import-documents",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_firestore1_cli/projects_databases-import-documents",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. Database to import into. Should be of the form: `projects/{project_id}/databases/{database_id}`."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("databases-list",
                    Some(r##"List all the databases in the project."##),
                    "Details at http://byron.github.io/google-apis-rs/google_firestore1_cli/projects_databases-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. A parent name of the form `projects/{project_id}`"##),
            ...
            ("databases-operations-delete",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_firestore1_cli/projects_databases-operations-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("databases-operations-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_firestore1_cli/projects_databases-operations-get",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("databases-operations-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_firestore1_cli/projects_databases-operations-list",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("databases-patch",
                    Some(r##"Updates a database."##),
                    "Details at http://byron.github.io/google-apis-rs/google_firestore1_cli/projects_databases-patch",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"The resource name of the Database. Format: `projects/{project}/databases/{database}`"##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("databases-restore",
                    Some(r##"Creates a new database by restoring from an existing backup. The new database must be in the same cloud region or multi-region location as the existing backup. This behaves similar to FirestoreAdmin.CreateDatabase except instead of creating a new empty database, a new database is created with the database type, index configuration, and documents from an existing backup. The long-running operation can be used to track the progress of the restore, with the Operation's metadata field type being the RestoreDatabaseMetadata. The response type is the Database if the restore was successful. The new database is not readable or writeable until the LRO has completed."##),
                    "Details at http://byron.github.io/google-apis-rs/google_firestore1_cli/projects_databases-restore",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The project to restore the database in. Format is `projects/{project_id}`."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("locations-backups-delete",
                  ...
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. Name of the backup to delete. format is `projects/{project}/locations/{location}/backups/{backup}`."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("locations-backups-get",
                    Some(r##"Gets information about a backup."##),
                    "Details at http://byron.github.io/google-apis-rs/google_firestore1_cli/projects_locations-backups-get",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. Name of the backup to fetch. Format is `projects/{project}/locations/{location}/backups/{backup}`."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("locations-backups-list",
                    Some(r##"Lists all the backups."##),
                    "Details at http://byron.github.io/google-apis-rs/google_firestore1_cli/projects_locations-backups-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The location to list backups from. Format is `projects/{project}/locations/{location}`. Use `{location} = '-'` to list backups from all locations for the given project. This allows listing backups from a single location or from all locations."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("locations-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_firestore1_cli/projects_locations-get",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_firestore1_cli/projects_locations-list",
                  vec![
                    (Some(r##"name"##),
                     None,
