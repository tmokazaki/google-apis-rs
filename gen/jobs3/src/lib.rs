...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/jobs3).
//! # Features
//!
//! Handle the following *Resources* with ease from the central [hub](CloudTalentSolution) ...
//!
//! * projects
//!  * [*client events create*](api::ProjectClientEventCreateCall), [*companies create*](api::ProjectCompanyCreateCall), [*companies delete*](api::ProjectCompanyDeleteCall), [*companies get*](api::ProjectCompanyGetCall), [*companies list*](api::ProjectCompanyListCall), [*companies patch*](api::ProjectCompanyPatchCall), [*complete*](api::ProjectCompleteCall), [*jobs batch delete*](api::ProjectJobBatchDeleteCall), [*jobs create*](api::ProjectJobCreateCall), [*jobs delete*](api::ProjectJobDeleteCall), [*jobs get*](api::ProjectJobGetCall), [*jobs list*](api::ProjectJobListCall), [*jobs patch*](api::ProjectJobPatchCall), [*jobs search*](api::ProjectJobSearchCall) and [*jobs search for alert*](api::ProjectJobSearchForAlertCall)
//!
//!
//!
//!
...
pub mod api;
pub use api::CloudTalentSolution;
