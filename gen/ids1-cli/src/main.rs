...
use google_ids1::{api, yup_oauth2, Error};
    ...
    C: apis_common::Connector,
{
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(["endpoint-id", "request-id"].iter().map(|v| *v));
                                v
                            }));
                    }
                }
    ...
    async fn _projects_locations_endpoints_get_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_endpoints_get_iam_policy(opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_endpoints_set_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_endpoints_set_iam_policy(request, opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_endpoints_test_iam_permissions(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_endpoints_test_iam_permissions(
                request,
        ...
        match self.opt.subcommand() {
            ("projects", Some(opt)) => match opt.subcommand() {
                ("locations-endpoints-create", Some(opt)) => {
                    call_result = self
                        ._projects_locations_endpoints_create(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-endpoints-delete", Some(opt)) => {
                    call_result = self
                        ._projects_locations_endpoints_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-endpoints-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_endpoints_get(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-endpoints-get-iam-policy", Some(opt)) => {
                    call_result = self
                        ._projects_locations_endpoints_get_iam_policy(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-endpoints-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_endpoints_list(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-endpoints-patch", Some(opt)) => {
                    call_result = self
                        ._projects_locations_endpoints_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-endpoints-set-iam-policy", Some(opt)) => {
                    call_result = self
                        ._projects_locations_endpoints_set_iam_policy(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-endpoints-test-iam-permissions", Some(opt)) => {
                    call_result = self
                        ._projects_locations_endpoints_test_iam_permissions(opt, dry_run, &mut err)
                        .await;
                }
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "ids1-secret.json",
        ...
        .persist_tokens_to_disk(format!("{}/ids1", config_dir))
        .build()
        .await
        .unwrap();
...
async fn main() {
    ...
    let arg_data = [
        ("projects", "methods: 'locations-endpoints-create', 'locations-endpoints-delete', 'locations-endpoints-get', 'locations-endpoints-get-iam-policy', 'locations-endpoints-list', 'locations-endpoints-patch', 'locations-endpoints-set-iam-policy', 'locations-endpoints-test-iam-permissions', 'locations-get', 'locations-list', 'locations-operations-cancel', 'locations-operations-delete', 'locations-operations-get' and 'locations-operations-list'", vec![
            ("locations-endpoints-create",
                    Some(r##"Creates a new Endpoint in a given project and location."##),
                    "Details at http://byron.github.io/google-apis-rs/google_ids1_cli/projects_locations-endpoints-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The endpoint's parent."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("locations-endpoints-delete",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_ids1_cli/projects_locations-endpoints-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-endpoints-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_ids1_cli/projects_locations-endpoints-get",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The name of the endpoint to retrieve. Format: projects/{project}/locations/{location}/endpoints/{endpoint}"##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("locations-endpoints-get-iam-policy",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_ids1_cli/projects_locations-endpoints-get-iam-policy",
                  vec![
                    (Some(r##"resource"##),
                     None,
            ...
            ("locations-endpoints-list",
                    Some(r##"Lists Endpoints in a given project and location."##),
                    "Details at http://byron.github.io/google-apis-rs/google_ids1_cli/projects_locations-endpoints-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The parent, which owns this collection of endpoints."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("locations-endpoints-patch",
                    Some(r##"Updates the parameters of a single Endpoint."##),
                    "Details at http://byron.github.io/google-apis-rs/google_ids1_cli/projects_locations-endpoints-patch",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Output only. The name of the endpoint."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("locations-endpoints-set-iam-policy",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_ids1_cli/projects_locations-endpoints-set-iam-policy",
                  vec![
                    (Some(r##"resource"##),
                     None,
            ...
            ("locations-endpoints-test-iam-permissions",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_ids1_cli/projects_locations-endpoints-test-iam-permissions",
                  vec![
                    (Some(r##"resource"##),
                     None,
            ...
            ("locations-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_ids1_cli/projects_locations-get",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_ids1_cli/projects_locations-list",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-operations-cancel",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_ids1_cli/projects_locations-operations-cancel",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-operations-delete",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_ids1_cli/projects_locations-operations-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-operations-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_ids1_cli/projects_locations-operations-get",
                  vec![
                    (Some(r##"name"##),
                     None,
