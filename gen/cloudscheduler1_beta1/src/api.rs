...
impl<C> common::Hub for CloudScheduler<C> {}

impl<'a, C> CloudScheduler<C> {
...
pub struct Job {
    ...
    pub attempt_deadline: Option<chrono::Duration>,
    ...
    pub user_update_time: Option<chrono::DateTime<chrono::offset::Utc>>,
}
...
impl common::RequestValue for PauseJobRequest {}
...
impl common::Part for PubsubTarget {}
...
impl common::RequestValue for ResumeJobRequest {}
...
pub struct RetryConfig {
    ...
    #[serde_as(as = "Option<common::serde::duration::Wrapper>")]
    pub max_backoff_duration: Option<chrono::Duration>,
    ...
    #[serde_as(as = "Option<common::serde::duration::Wrapper>")]
    pub min_backoff_duration: Option<chrono::Duration>,
...
impl common::RequestValue for RunJobRequest {}
    ...
    C: common::Connector,
{
    ...
    pub async fn doit(mut self) -> common::Result<(common::Response, Empty)> {
        ...
        if let Some(value) = self._legacy_app_engine_cron.as_ref() {
    ...
    C: common::Connector,
{
    ...
    ///
    /// Sets the *legacy app engine cron* query property to the given value.
    pub fn legacy_app_engine_cron(mut self, new_value: bool) -> ProjectLocationJobListCall<'a, C> {
        self._legacy_app_engine_cron = Some(new_value);
        self
    }
    ...
    C: common::Connector,
{
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: Job) -> ProjectLocationJobPatchCall<'a, C> {
        self._request = new_value;
        self
    }
    /// Optionally caller-specified in CreateJob, after which it becomes output only. The job name. For example: `projects/PROJECT_ID/locations/LOCATION_ID/jobs/JOB_ID`. * `PROJECT_ID` can contain letters ([A-Za-z]), numbers ([0-9]), hyphens (-), colons (:), or periods (.). For more information, see [Identifying projects](https://cloud.google.com/resource-manager/docs/creating-managing-projects#identifying_projects) * `LOCATION_ID` is the canonical ID for the job's location. The list of available locations can be obtained by calling ListLocations. For more information, see https://cloud.google.com/about/locations/. * `JOB_ID` can contain only letters ([A-Za-z]), numbers ([0-9]), hyphens (-), or underscores (_). The maximum length is 500 characters.
...
/// # }
/// ```
pub struct ProjectLocationJobPauseCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudScheduler<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationJobPauseCall<'a, C> {}

impl<'a, C> ProjectLocationJobPauseCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: PauseJobRequest) -> ProjectLocationJobPauseCall<'a, C> {
        self._request = new_value;
        self
    }
    /// Required. The job name. For example: `projects/PROJECT_ID/locations/LOCATION_ID/jobs/JOB_ID`.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationJobPauseCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationJobPauseCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationJobPauseCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationJobPauseCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationJobPauseCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationJobResumeCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudScheduler<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationJobResumeCall<'a, C> {}

impl<'a, C> ProjectLocationJobResumeCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: ResumeJobRequest) -> ProjectLocationJobResumeCall<'a, C> {
        self._request = new_value;
        self
    }
    /// Required. The job name. For example: `projects/PROJECT_ID/locations/LOCATION_ID/jobs/JOB_ID`.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationJobResumeCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationJobResumeCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationJobResumeCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationJobResumeCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationJobResumeCall<'a, C> {
        self._scopes.clear();
        self
    }
}
    ...
    C: common::Connector,
{
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: RunJobRequest) -> ProjectLocationJobRunCall<'a, C> {
        self._request = new_value;
        self
    }
    /// Required. The job name. For example: `projects/PROJECT_ID/locations/LOCATION_ID/jobs/JOB_ID`.
