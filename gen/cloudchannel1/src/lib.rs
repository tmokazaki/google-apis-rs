...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/cloudchannel1).
//! # Features
//!
...
//! * products
//!  * [*list*](api::ProductListCall) and [*skus list*](api::ProductSkuListCall)
//!
//!
//!
//!
