...
use google_speech1::{api, yup_oauth2, Error};
    ...
    C: apis_common::Connector,
{
    ...
    async fn _projects_locations_custom_classes_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "custom-class.custom-class-id" => Some((
                ...
                "custom-class.display-name" => Some((
                ...
                "custom-class.kms-key-name" => Some((
                ...
                "custom-class.kms-key-version-name" => Some((
        ...
        let mut request: api::CreateCustomClassRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_custom_classes_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_custom_classes_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_custom_classes_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_custom_classes_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_custom_classes_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_custom_classes_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_custom_classes_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_custom_classes_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::CustomClass = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_custom_classes_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_phrase_sets_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "phrase-set.kms-key-version-name" => Some((
        ...
        let mut request: api::CreatePhraseSetRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_phrase_sets_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_phrase_sets_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_phrase_sets_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_phrase_sets_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_phrase_sets_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_phrase_sets_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_phrase_sets_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_phrase_sets_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::PhraseSet = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_phrase_sets_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _speech_longrunningrecognize(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "config.adaptation.abnf-grammar.abnf-strings" => Some((
                    "config.adaptation.abnfGrammar.abnfStrings",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "config.adaptation.phrase-set-references" => Some((
                ...
                "config.alternative-language-codes" => Some((
                ...
                "config.audio-channel-count" => Some((
                ...
                "config.diarization-config.enable-speaker-diarization" => Some((
                    "config.diarizationConfig.enableSpeakerDiarization",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "config.diarization-config.max-speaker-count" => Some((
                    "config.diarizationConfig.maxSpeakerCount",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                )),
                "config.diarization-config.min-speaker-count" => Some((
                    "config.diarizationConfig.minSpeakerCount",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                )),
                "config.diarization-config.speaker-tag" => Some((
                    "config.diarizationConfig.speakerTag",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                )),
                "config.enable-automatic-punctuation" => Some((
                ...
                "config.enable-separate-recognition-per-channel" => Some((
                    "config.enableSeparateRecognitionPerChannel",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "config.enable-spoken-emojis" => Some((
                    "config.enableSpokenEmojis",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "config.enable-spoken-punctuation" => Some((
                    "config.enableSpokenPunctuation",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "config.enable-word-confidence" => Some((
                    "config.enableWordConfidence",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "config.enable-word-time-offsets" => Some((
                ...
                "config.metadata.audio-topic" => Some((
                    "config.metadata.audioTopic",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "config.metadata.industry-naics-code-of-audio" => Some((
                    "config.metadata.industryNaicsCodeOfAudio",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                )),
                "config.metadata.interaction-type" => Some((
                ...
                "config.metadata.microphone-distance" => Some((
                ...
                "config.metadata.original-media-type" => Some((
                ...
                "config.metadata.original-mime-type" => Some((
                    "config.metadata.originalMimeType",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "config.metadata.recording-device-name" => Some((
                    "config.metadata.recordingDeviceName",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "config.metadata.recording-device-type" => Some((
        ...
        let mut request: api::LongRunningRecognizeRequest =
            serde_json::value::from_value(object).unwrap();
    ...
    async fn _speech_recognize(
        ...
        let mut request: api::RecognizeRequest = serde_json::value::from_value(object).unwrap();
        ...
        match self.opt.subcommand() {
            ...
            ("projects", Some(opt)) => match opt.subcommand() {
                ("locations-custom-classes-create", Some(opt)) => {
                    call_result = self
                        ._projects_locations_custom_classes_create(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-custom-classes-delete", Some(opt)) => {
                    call_result = self
                        ._projects_locations_custom_classes_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-custom-classes-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_custom_classes_get(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-custom-classes-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_custom_classes_list(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-custom-classes-patch", Some(opt)) => {
                    call_result = self
                        ._projects_locations_custom_classes_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-phrase-sets-create", Some(opt)) => {
                    call_result = self
                        ._projects_locations_phrase_sets_create(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-phrase-sets-delete", Some(opt)) => {
                    call_result = self
                        ._projects_locations_phrase_sets_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-phrase-sets-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_phrase_sets_get(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-phrase-sets-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_phrase_sets_list(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-phrase-sets-patch", Some(opt)) => {
                    call_result = self
                        ._projects_locations_phrase_sets_patch(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
            ...
            ("speech", Some(opt)) => match opt.subcommand() {
                ("longrunningrecognize", Some(opt)) => {
                    call_result = self
                        ._speech_longrunningrecognize(opt, dry_run, &mut err)
                        .await;
                }
                ("recognize", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("speech".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            _ => {
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "speech1-secret.json",
        ...
        .persist_tokens_to_disk(format!("{}/speech1", config_dir))
        .build()
        .await
        .unwrap();
