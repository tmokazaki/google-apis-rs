...
use google_runtimeconfig1_beta1::{api, yup_oauth2, Error};
...
{
    async fn _projects_configs_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        ...
        let mut request: api::RuntimeConfig = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .configs_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_configs_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .configs_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_configs_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .configs_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_configs_get_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .configs_get_iam_policy(opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_configs_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .configs_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_configs_operations_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .configs_operations_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_configs_operations_test_iam_permissions(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self.hub.projects().configs_operations_test_iam_permissions(
            request,
    ...
    async fn _projects_configs_set_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .configs_set_iam_policy(request, opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_configs_test_iam_permissions(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .configs_test_iam_permissions(request, opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_configs_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .configs_update(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_configs_variables_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec!["name", "state", "text", "update-time", "value"],
                    );
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
        ...
        let mut call = self
            .hub
            .projects()
            .configs_variables_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_configs_variables_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .configs_variables_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_configs_variables_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .configs_variables_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_configs_variables_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .configs_variables_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            .iter()
        {
            ...
            match key {
                "return-values" => {
                    call = call.return_values(
                        value
                            .map(|v| arg_from_str(v, err, "return-values", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "page-token" => {
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["filter", "page-size", "page-token", "return-values"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _projects_configs_variables_test_iam_permissions(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::TestIamPermissionsRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.projects().configs_variables_test_iam_permissions(
            request,
            opt.value_of("resource").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _projects_configs_variables_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .configs_variables_update(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_configs_variables_watch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(key, &vec!["newer-than"]);
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
                        value.map(|v| v.to_string()),
        ...
        let mut request: api::WatchVariableRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .configs_variables_watch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_configs_waiters_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "failure.cardinality.number" => Some((
                ...
                "success.cardinality.number" => Some((
        ...
        let mut request: api::Waiter = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .configs_waiters_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_configs_waiters_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .configs_waiters_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_configs_waiters_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .configs_waiters_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_configs_waiters_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .configs_waiters_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_configs_waiters_test_iam_permissions(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .configs_waiters_test_iam_permissions(request, opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
        ...
        match self.opt.subcommand() {
            ("projects", Some(opt)) => match opt.subcommand() {
                ...
                ("configs-get-iam-policy", Some(opt)) => {
                    call_result = self
                        ._projects_configs_get_iam_policy(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("configs-operations-get", Some(opt)) => {
                    call_result = self
                        ._projects_configs_operations_get(opt, dry_run, &mut err)
                        .await;
                }
                ("configs-operations-test-iam-permissions", Some(opt)) => {
                    call_result = self
                        ._projects_configs_operations_test_iam_permissions(opt, dry_run, &mut err)
                        .await;
                }
                ("configs-set-iam-policy", Some(opt)) => {
                    call_result = self
                        ._projects_configs_set_iam_policy(opt, dry_run, &mut err)
                        .await;
                }
                ("configs-test-iam-permissions", Some(opt)) => {
                    call_result = self
                        ._projects_configs_test_iam_permissions(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("configs-variables-create", Some(opt)) => {
                    call_result = self
                        ._projects_configs_variables_create(opt, dry_run, &mut err)
                        .await;
                }
                ("configs-variables-delete", Some(opt)) => {
                    call_result = self
                        ._projects_configs_variables_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("configs-variables-get", Some(opt)) => {
                    call_result = self
                        ._projects_configs_variables_get(opt, dry_run, &mut err)
                        .await;
                }
                ("configs-variables-list", Some(opt)) => {
                    call_result = self
                        ._projects_configs_variables_list(opt, dry_run, &mut err)
                        .await;
                }
                ("configs-variables-test-iam-permissions", Some(opt)) => {
                    call_result = self
                        ._projects_configs_variables_test_iam_permissions(opt, dry_run, &mut err)
                        .await;
                }
                ("configs-variables-update", Some(opt)) => {
                    call_result = self
                        ._projects_configs_variables_update(opt, dry_run, &mut err)
                        .await;
                }
                ("configs-variables-watch", Some(opt)) => {
                    call_result = self
                        ._projects_configs_variables_watch(opt, dry_run, &mut err)
                        .await;
                }
                ("configs-waiters-create", Some(opt)) => {
                    call_result = self
                        ._projects_configs_waiters_create(opt, dry_run, &mut err)
                        .await;
                }
                ("configs-waiters-delete", Some(opt)) => {
                    call_result = self
                        ._projects_configs_waiters_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("configs-waiters-get", Some(opt)) => {
                    call_result = self
                        ._projects_configs_waiters_get(opt, dry_run, &mut err)
                        .await;
                }
                ("configs-waiters-list", Some(opt)) => {
                    call_result = self
                        ._projects_configs_waiters_list(opt, dry_run, &mut err)
                        .await;
                }
                ("configs-waiters-test-iam-permissions", Some(opt)) => {
                    call_result = self
                        ._projects_configs_waiters_test_iam_permissions(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "runtimeconfig1-beta1-secret.json",
        ...
        .persist_tokens_to_disk(format!("{}/runtimeconfig1-beta1", config_dir))
        .build()
        .await
        .unwrap();
...
async fn main() {
    ...
    let arg_data = [
        ("projects", "methods: 'configs-create', 'configs-delete', 'configs-get', 'configs-get-iam-policy', 'configs-list', 'configs-operations-get', 'configs-operations-test-iam-permissions', 'configs-set-iam-policy', 'configs-test-iam-permissions', 'configs-update', 'configs-variables-create', 'configs-variables-delete', 'configs-variables-get', 'configs-variables-list', 'configs-variables-test-iam-permissions', 'configs-variables-update', 'configs-variables-watch', 'configs-waiters-create', 'configs-waiters-delete', 'configs-waiters-get', 'configs-waiters-list' and 'configs-waiters-test-iam-permissions'", vec![
            ...
            ("configs-delete",
                    Some(r##"Deletes a RuntimeConfig resource."##),
                    "Details at http://byron.github.io/google-apis-rs/google_runtimeconfig1_beta1_cli/projects_configs-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("configs-get",
                    Some(r##"Gets information about a RuntimeConfig resource."##),
                    "Details at http://byron.github.io/google-apis-rs/google_runtimeconfig1_beta1_cli/projects_configs-get",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("configs-list",
                    Some(r##"Lists all the RuntimeConfig resources within project."##),
                    "Details at http://byron.github.io/google-apis-rs/google_runtimeconfig1_beta1_cli/projects_configs-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"The [project ID](https://support.google.com/cloud/answer/6158840?hl=en&ref_topic=6158848) for this request, in the format `projects/[PROJECT_ID]`."##),
            ...
            ("configs-update",
                    Some(r##"Updates a RuntimeConfig resource. The configuration must exist beforehand."##),
                    "Details at http://byron.github.io/google-apis-rs/google_runtimeconfig1_beta1_cli/projects_configs-update",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("configs-variables-get",
                    Some(r##"Gets information about a single variable."##),
                    "Details at http://byron.github.io/google-apis-rs/google_runtimeconfig1_beta1_cli/projects_configs-variables-get",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("configs-variables-update",
                    Some(r##"Updates an existing variable with a new value."##),
                    "Details at http://byron.github.io/google-apis-rs/google_runtimeconfig1_beta1_cli/projects_configs-variables-update",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("configs-waiters-delete",
                    Some(r##"Deletes the waiter with the specified name."##),
                    "Details at http://byron.github.io/google-apis-rs/google_runtimeconfig1_beta1_cli/projects_configs-waiters-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("configs-waiters-get",
                    Some(r##"Gets information about a single waiter."##),
                    "Details at http://byron.github.io/google-apis-rs/google_runtimeconfig1_beta1_cli/projects_configs-waiters-get",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("configs-waiters-list",
                    Some(r##"List waiters within the given configuration."##),
                    "Details at http://byron.github.io/google-apis-rs/google_runtimeconfig1_beta1_cli/projects_configs-waiters-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
