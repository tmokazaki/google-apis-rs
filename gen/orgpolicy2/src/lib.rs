...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/orgpolicy2).
//! # Features
//!
//! Handle the following *Resources* with ease from the central [hub](OrgPolicyAPI) ...
//!
//! * folders
//!  * [*constraints list*](api::FolderConstraintListCall), [*policies create*](api::FolderPolicyCreateCall), [*policies delete*](api::FolderPolicyDeleteCall), [*policies get*](api::FolderPolicyGetCall), [*policies get effective policy*](api::FolderPolicyGetEffectivePolicyCall), [*policies list*](api::FolderPolicyListCall) and [*policies patch*](api::FolderPolicyPatchCall)
//! * organizations
//!  * [*constraints list*](api::OrganizationConstraintListCall), [*custom constraints create*](api::OrganizationCustomConstraintCreateCall), [*custom constraints delete*](api::OrganizationCustomConstraintDeleteCall), [*custom constraints get*](api::OrganizationCustomConstraintGetCall), [*custom constraints list*](api::OrganizationCustomConstraintListCall), [*custom constraints patch*](api::OrganizationCustomConstraintPatchCall), [*policies create*](api::OrganizationPolicyCreateCall), [*policies delete*](api::OrganizationPolicyDeleteCall), [*policies get*](api::OrganizationPolicyGetCall), [*policies get effective policy*](api::OrganizationPolicyGetEffectivePolicyCall), [*policies list*](api::OrganizationPolicyListCall) and [*policies patch*](api::OrganizationPolicyPatchCall)
//! * projects
//!  * [*constraints list*](api::ProjectConstraintListCall), [*policies create*](api::ProjectPolicyCreateCall), [*policies delete*](api::ProjectPolicyDeleteCall), [*policies get*](api::ProjectPolicyGetCall), [*policies get effective policy*](api::ProjectPolicyGetEffectivePolicyCall), [*policies list*](api::ProjectPolicyListCall) and [*policies patch*](api::ProjectPolicyPatchCall)
//!
//!
//!
//!
