...
impl<C> common::Hub for DeploymentManager<C> {}
...
impl common::Part for BulkInsertOperationStatus {}
...
impl common::Part for ConfigFile {}
...
impl common::Part for DeploymentLabelEntry {}
...
impl common::Part for DeploymentUpdate {}
...
impl common::Part for DeploymentUpdateLabelEntry {}
...
impl common::RequestValue for DeploymentsCancelPreviewRequest {}
...
impl common::RequestValue for DeploymentsStopRequest {}
...
impl common::RequestValue for GlobalSetPolicyRequest {}
...
impl common::Part for ImportFile {}
...
impl common::Part for InstancesBulkInsertOperationMetadata {}
...
impl common::Resource for Manifest {}
impl common::ResponseResult for Manifest {}
...
impl common::ResponseResult for ManifestsListResponse {}
...
impl common::Resource for Resource {}
impl common::ResponseResult for Resource {}
...
impl common::Part for ResourceAccessControl {}
...
impl common::Part for ResourceUpdate {}
...
impl common::ResponseResult for ResourcesListResponse {}
...
pub struct SetCommonInstanceMetadataOperationMetadata {
    ...
    pub per_location_operations:
        Option<HashMap<String, SetCommonInstanceMetadataOperationMetadataPerLocationOperationInfo>>,
}

impl common::Part for SetCommonInstanceMetadataOperationMetadata {}
...
impl common::Part for SetCommonInstanceMetadataOperationMetadataPerLocationOperationInfo {}
...
impl common::Part for TargetConfiguration {}
...
impl common::RequestValue for TestPermissionsRequest {}
...
impl common::ResponseResult for TestPermissionsResponse {}
...
impl common::ResponseResult for TypesListResponse {}
...
impl common::NestedType for ResourceWarnings {}
impl common::Part for ResourceWarnings {}
...
impl common::NestedType for ResourceWarningsData {}
impl common::Part for ResourceWarningsData {}
...
impl common::NestedType for ResourceUpdateError {}
impl common::Part for ResourceUpdateError {}
...
impl common::NestedType for ResourceUpdateErrorErrors {}
impl common::Part for ResourceUpdateErrorErrors {}
...
impl common::NestedType for ResourceUpdateWarnings {}
impl common::Part for ResourceUpdateWarnings {}
...
impl common::NestedType for ResourceUpdateWarningsData {}
impl common::Part for ResourceUpdateWarningsData {}
...
impl<'a, C> common::MethodsBuilder for ManifestMethods<'a, C> {}
...
impl<'a, C> common::MethodsBuilder for ResourceMethods<'a, C> {}
...
impl<'a, C> common::MethodsBuilder for TypeMethods<'a, C> {}
...
impl<'a, C> common::CallBuilder for DeploymentCancelPreviewCall<'a, C> {}

impl<'a, C> DeploymentCancelPreviewCall<'a, C>
where
    C: common::Connector,
{
    ...
    pub async fn doit(mut self) -> common::Result<(common::Response, Operation)> {
        ...
        for &(find_this, param_name) in
            [("{project}", "project"), ("{deployment}", "deployment")].iter()
        {
    ...
    pub fn request(
        mut self,
        new_value: DeploymentsCancelPreviewRequest,
    ) -> DeploymentCancelPreviewCall<'a, C> {
    ...
    pub fn add_scope<St>(mut self, scope: St) -> DeploymentCancelPreviewCall<'a, C>
    where
        St: AsRef<str>,
    {
    ...
    pub fn add_scopes<I, St>(mut self, scopes: I) -> DeploymentCancelPreviewCall<'a, C>
    where
    ...
    /// for details).
    pub fn clear_scopes(mut self) -> DeploymentCancelPreviewCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for DeploymentGetIamPolicyCall<'a, C> {}

impl<'a, C> DeploymentGetIamPolicyCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, Policy)> {
        ...
        #[allow(clippy::single_element_loop)]
        for &(find_this, param_name) in
            [("{project}", "project"), ("{resource}", "resource")].iter()
        {
            url = params.uri_replacement(url, param_name, find_this, false);
        }
        {
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> DeploymentGetIamPolicyCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> DeploymentGetIamPolicyCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> DeploymentGetIamPolicyCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for DeploymentPatchCall<'a, C> {}

impl<'a, C> DeploymentPatchCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> DeploymentPatchCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> DeploymentPatchCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> DeploymentPatchCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for DeploymentSetIamPolicyCall<'a, C> {}

impl<'a, C> DeploymentSetIamPolicyCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    pub fn request(
        mut self,
        new_value: GlobalSetPolicyRequest,
    ) -> DeploymentSetIamPolicyCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> DeploymentSetIamPolicyCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> DeploymentSetIamPolicyCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> DeploymentSetIamPolicyCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for DeploymentStopCall<'a, C> {}

impl<'a, C> DeploymentStopCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> DeploymentStopCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> DeploymentStopCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> DeploymentStopCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for DeploymentTestIamPermissionCall<'a, C> {}

impl<'a, C> DeploymentTestIamPermissionCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, TestPermissionsResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    pub fn request(
        mut self,
        new_value: TestPermissionsRequest,
    ) -> DeploymentTestIamPermissionCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> DeploymentTestIamPermissionCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> DeploymentTestIamPermissionCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> DeploymentTestIamPermissionCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for DeploymentUpdateCall<'a, C> {}

impl<'a, C> DeploymentUpdateCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> DeploymentUpdateCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> DeploymentUpdateCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> DeploymentUpdateCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for ManifestGetCall<'a, C> {}

impl<'a, C> ManifestGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, Manifest)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> ManifestGetCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ManifestGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ManifestGetCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ManifestGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for ManifestListCall<'a, C> {}

impl<'a, C> ManifestListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, ManifestsListResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> ManifestListCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ManifestListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ManifestListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ManifestListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for ResourceGetCall<'a, C> {}

impl<'a, C> ResourceGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, Resource)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> ResourceGetCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ResourceGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ResourceGetCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ResourceGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for ResourceListCall<'a, C> {}

impl<'a, C> ResourceListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, ResourcesListResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> ResourceListCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ResourceListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ResourceListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ResourceListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for TypeListCall<'a, C> {}

impl<'a, C> TypeListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, TypesListResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
        ...
        params.push("alt", "json");
        let mut url =
            self.hub._base_url.clone() + "deploymentmanager/v2/projects/{project}/global/types";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::NdevCloudmanReadonly.as_ref().to_string());
        }
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> TypeListCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> TypeListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> TypeListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> TypeListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
