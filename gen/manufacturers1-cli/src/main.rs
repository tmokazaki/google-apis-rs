...
use google_manufacturers1::{api, yup_oauth2, Error};
...
{
    async fn _accounts_languages_product_certifications_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        ...
        let mut call = self
            .hub
            .accounts()
            .languages_product_certifications_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_languages_product_certifications_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .languages_product_certifications_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_languages_product_certifications_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .languages_product_certifications_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_languages_product_certifications_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::ProductCertification = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .accounts()
            .languages_product_certifications_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_products_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.accounts().products_delete(
    ...
    async fn _accounts_products_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "grocery.active-ingredients" => Some((
                ...
                "grocery.alcohol-by-volume" => Some((
                    "grocery.alcoholByVolume",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "grocery.allergens" => Some((
                    "grocery.allergens",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                ...
                "grocery.derived-nutrition-claim" => Some((
                    "grocery.derivedNutritionClaim",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "grocery.directions" => Some((
                    "grocery.directions",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                ...
                "grocery.nutrition-claim" => Some((
                    "grocery.nutritionClaim",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "grocery.storage-instructions" => Some((
                    "grocery.storageInstructions",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                ...
                "nutrition.added-sugars.amount" => Some((
                ...
                "nutrition.added-sugars.unit" => Some((
                    "nutrition.addedSugars.unit",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "nutrition.added-sugars-daily-percentage" => Some((
                    "nutrition.addedSugarsDailyPercentage",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "nutrition.calcium.amount" => Some((
                ...
                "nutrition.calcium.unit" => Some((
                    "nutrition.calcium.unit",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "nutrition.calcium-daily-percentage" => Some((
                    "nutrition.calciumDailyPercentage",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "nutrition.cholesterol.amount" => Some((
                ...
                "nutrition.cholesterol.unit" => Some((
                    "nutrition.cholesterol.unit",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "nutrition.cholesterol-daily-percentage" => Some((
                    "nutrition.cholesterolDailyPercentage",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "nutrition.dietary-fiber.amount" => Some((
                    "nutrition.dietaryFiber.amount",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "nutrition.dietary-fiber.unit" => Some((
                    "nutrition.dietaryFiber.unit",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "nutrition.dietary-fiber-daily-percentage" => Some((
                    "nutrition.dietaryFiberDailyPercentage",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "nutrition.energy.amount" => Some((
                    "nutrition.energy.amount",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "nutrition.energy.unit" => Some((
                ...
                "nutrition.energy-from-fat.amount" => Some((
                    "nutrition.energyFromFat.amount",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "nutrition.energy-from-fat.unit" => Some((
                    "nutrition.energyFromFat.unit",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "nutrition.folate-daily-percentage" => Some((
                    "nutrition.folateDailyPercentage",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "nutrition.folate-folic-acid.amount" => Some((
                    "nutrition.folateFolicAcid.amount",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "nutrition.folate-folic-acid.unit" => Some((
                    "nutrition.folateFolicAcid.unit",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "nutrition.folate-mcg-dfe" => Some((
                    "nutrition.folateMcgDfe",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "nutrition.iron.amount" => Some((
                ...
                "nutrition.iron-daily-percentage" => Some((
                    "nutrition.ironDailyPercentage",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "nutrition.monounsaturated-fat.amount" => Some((
                ...
                "nutrition.monounsaturated-fat.unit" => Some((
                    "nutrition.monounsaturatedFat.unit",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "nutrition.nutrition-fact-measure" => Some((
                    "nutrition.nutritionFactMeasure",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "nutrition.polyols.amount" => Some((
                    "nutrition.polyols.amount",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "nutrition.polyols.unit" => Some((
                    "nutrition.polyols.unit",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "nutrition.polyunsaturated-fat.amount" => Some((
                ...
                "nutrition.polyunsaturated-fat.unit" => Some((
                    "nutrition.polyunsaturatedFat.unit",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "nutrition.potassium.amount" => Some((
                ...
                "nutrition.potassium.unit" => Some((
                    "nutrition.potassium.unit",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "nutrition.potassium-daily-percentage" => Some((
                    "nutrition.potassiumDailyPercentage",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "nutrition.prepared-size-description" => Some((
                    "nutrition.preparedSizeDescription",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "nutrition.protein.amount" => Some((
                ...
                "nutrition.protein-daily-percentage" => Some((
                    "nutrition.proteinDailyPercentage",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "nutrition.saturated-fat.amount" => Some((
                ...
                "nutrition.saturated-fat.unit" => Some((
                ...
                "nutrition.saturated-fat-daily-percentage" => Some((
                    "nutrition.saturatedFatDailyPercentage",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "nutrition.serving-size-description" => Some((
                    "nutrition.servingSizeDescription",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "nutrition.serving-size-measure.amount" => Some((
                    "nutrition.servingSizeMeasure.amount",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "nutrition.serving-size-measure.unit" => Some((
                    "nutrition.servingSizeMeasure.unit",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "nutrition.servings-per-container" => Some((
                ...
                "nutrition.sodium-daily-percentage" => Some((
                    "nutrition.sodiumDailyPercentage",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "nutrition.starch.amount" => Some((
                    "nutrition.starch.amount",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "nutrition.starch.unit" => Some((
                ...
                "nutrition.total-carbohydrate.amount" => Some((
                    "nutrition.totalCarbohydrate.amount",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "nutrition.total-carbohydrate.unit" => Some((
                    "nutrition.totalCarbohydrate.unit",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "nutrition.total-carbohydrate-daily-percentage" => Some((
                    "nutrition.totalCarbohydrateDailyPercentage",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "nutrition.total-fat.amount" => Some((
                    "nutrition.totalFat.amount",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "nutrition.total-fat.unit" => Some((
                    "nutrition.totalFat.unit",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "nutrition.total-fat-daily-percentage" => Some((
                    "nutrition.totalFatDailyPercentage",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "nutrition.total-sugars.amount" => Some((
                    "nutrition.totalSugars.amount",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "nutrition.total-sugars.unit" => Some((
                    "nutrition.totalSugars.unit",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "nutrition.total-sugars-daily-percentage" => Some((
                    "nutrition.totalSugarsDailyPercentage",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "nutrition.trans-fat.amount" => Some((
                ...
                "nutrition.trans-fat.unit" => Some((
                    "nutrition.transFat.unit",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "nutrition.trans-fat-daily-percentage" => Some((
                    "nutrition.transFatDailyPercentage",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "nutrition.vitamin-d.amount" => Some((
                    "nutrition.vitaminD.amount",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "nutrition.vitamin-d.unit" => Some((
                    "nutrition.vitaminD.unit",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "nutrition.vitamin-d-daily-percentage" => Some((
                    "nutrition.vitaminDDailyPercentage",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                ...
                "suggested-retail-price.amount" => Some((
                ...
                "suggested-retail-price.currency" => Some((
                    "suggestedRetailPrice.currency",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "target-client-id" => Some((
                    "targetClientId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
        ...
        let mut call = self.hub.accounts().products_update(
            request,
            opt.value_of("parent").unwrap_or(""),
            opt.value_of("name").unwrap_or(""),
        );
        ...
        match self.opt.subcommand() {
            ("accounts", Some(opt)) => match opt.subcommand() {
                ("languages-product-certifications-delete", Some(opt)) => {
                    call_result = self
                        ._accounts_languages_product_certifications_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("languages-product-certifications-get", Some(opt)) => {
                    call_result = self
                        ._accounts_languages_product_certifications_get(opt, dry_run, &mut err)
                        .await;
                }
                ("languages-product-certifications-list", Some(opt)) => {
                    call_result = self
                        ._accounts_languages_product_certifications_list(opt, dry_run, &mut err)
                        .await;
                }
                ("languages-product-certifications-patch", Some(opt)) => {
                    call_result = self
                        ._accounts_languages_product_certifications_patch(opt, dry_run, &mut err)
                        .await;
                }
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "manufacturers1-secret.json",
