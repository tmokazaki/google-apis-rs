...
use google_firebase1_beta1::{api, yup_oauth2, Error};
...
{
    async fn _available_projects_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
    ...
    async fn _projects_add_firebase(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(key, &vec!["location-id"]);
        ...
        let mut request: api::AddFirebaseRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .add_firebase(request, opt.value_of("project").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_add_google_analytics(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec!["analytics-account-id", "analytics-property-id"],
                    );
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
        ...
        let mut request: api::AddGoogleAnalyticsRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .add_google_analytics(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_android_apps_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::AndroidApp = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .android_apps_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_android_apps_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .android_apps_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_android_apps_get_config(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .android_apps_get_config(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_android_apps_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .android_apps_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_android_apps_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .android_apps_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_android_apps_remove(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec!["allow-missing", "etag", "immediate", "validate-only"],
                    );
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
        ...
        let mut request: api::RemoveAndroidAppRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .android_apps_remove(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_android_apps_sha_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion =
                        FieldCursor::did_you_mean(key, &vec!["cert-type", "name", "sha-hash"]);
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
                        value.map(|v| v.to_string()),
        ...
        let mut request: api::ShaCertificate = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .android_apps_sha_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_android_apps_sha_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .android_apps_sha_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_android_apps_sha_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .android_apps_sha_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_android_apps_undelete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::UndeleteAndroidAppRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .android_apps_undelete(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_available_locations_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .available_locations_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_default_location_finalize(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::FinalizeDefaultLocationRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .default_location_finalize(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_get_admin_sdk_config(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .get_admin_sdk_config(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_get_analytics_details(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .get_analytics_details(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_ios_apps_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::IosApp = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .ios_apps_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_ios_apps_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .ios_apps_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_ios_apps_get_config(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .ios_apps_get_config(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_ios_apps_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .ios_apps_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_ios_apps_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .ios_apps_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_ios_apps_remove(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::RemoveIosAppRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .ios_apps_remove(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_ios_apps_undelete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::UndeleteIosAppRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .ios_apps_undelete(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_patch(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "resources.hosting-site" => Some((
                    "resources.hostingSite",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "resources.location-id" => Some((
                ...
                "resources.realtime-database-instance" => Some((
                    "resources.realtimeDatabaseInstance",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "resources.storage-bucket" => Some((
                    "resources.storageBucket",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
        ...
        let mut request: api::FirebaseProject = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
    ...
    async fn _projects_remove_analytics(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::RemoveAnalyticsRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .remove_analytics(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_search_apps(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .search_apps(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_web_apps_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_web_apps_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_web_apps_get_config(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .web_apps_get_config(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_web_apps_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_web_apps_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_web_apps_remove(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::RemoveWebAppRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .web_apps_remove(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_web_apps_undelete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::UndeleteWebAppRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .web_apps_undelete(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
        ...
        match self.opt.subcommand() {
            ...
            ("projects", Some(opt)) => match opt.subcommand() {
                ...
                ("add-google-analytics", Some(opt)) => {
                    call_result = self
                        ._projects_add_google_analytics(opt, dry_run, &mut err)
                        .await;
                }
                ("android-apps-create", Some(opt)) => {
                    call_result = self
                        ._projects_android_apps_create(opt, dry_run, &mut err)
                        .await;
                }
                ("android-apps-get", Some(opt)) => {
                    call_result = self
                        ._projects_android_apps_get(opt, dry_run, &mut err)
                        .await;
                }
                ("android-apps-get-config", Some(opt)) => {
                    call_result = self
                        ._projects_android_apps_get_config(opt, dry_run, &mut err)
                        .await;
                }
                ("android-apps-list", Some(opt)) => {
                    call_result = self
                        ._projects_android_apps_list(opt, dry_run, &mut err)
                        .await;
                }
                ("android-apps-patch", Some(opt)) => {
                    call_result = self
                        ._projects_android_apps_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("android-apps-remove", Some(opt)) => {
                    call_result = self
                        ._projects_android_apps_remove(opt, dry_run, &mut err)
                        .await;
                }
                ("android-apps-sha-create", Some(opt)) => {
                    call_result = self
                        ._projects_android_apps_sha_create(opt, dry_run, &mut err)
                        .await;
                }
                ("android-apps-sha-delete", Some(opt)) => {
                    call_result = self
                        ._projects_android_apps_sha_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("android-apps-sha-list", Some(opt)) => {
                    call_result = self
                        ._projects_android_apps_sha_list(opt, dry_run, &mut err)
                        .await;
                }
                ("android-apps-undelete", Some(opt)) => {
                    call_result = self
                        ._projects_android_apps_undelete(opt, dry_run, &mut err)
                        .await;
                }
                ("available-locations-list", Some(opt)) => {
                    call_result = self
                        ._projects_available_locations_list(opt, dry_run, &mut err)
                        .await;
                }
                ("default-location-finalize", Some(opt)) => {
                    call_result = self
                        ._projects_default_location_finalize(opt, dry_run, &mut err)
                        .await;
                }
                ("get", Some(opt)) => {
                ...
                ("get-admin-sdk-config", Some(opt)) => {
                    call_result = self
                        ._projects_get_admin_sdk_config(opt, dry_run, &mut err)
                        .await;
                }
                ("get-analytics-details", Some(opt)) => {
                    call_result = self
                        ._projects_get_analytics_details(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("ios-apps-get-config", Some(opt)) => {
                    call_result = self
                        ._projects_ios_apps_get_config(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("ios-apps-remove", Some(opt)) => {
                    call_result = self._projects_ios_apps_remove(opt, dry_run, &mut err).await;
                }
                ("ios-apps-undelete", Some(opt)) => {
                    call_result = self
                        ._projects_ios_apps_undelete(opt, dry_run, &mut err)
                        .await;
                }
                ("list", Some(opt)) => {
                ...
                ("remove-analytics", Some(opt)) => {
                    call_result = self
                        ._projects_remove_analytics(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("web-apps-get-config", Some(opt)) => {
                    call_result = self
                        ._projects_web_apps_get_config(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("web-apps-remove", Some(opt)) => {
                    call_result = self._projects_web_apps_remove(opt, dry_run, &mut err).await;
                }
                ("web-apps-undelete", Some(opt)) => {
                    call_result = self
                        ._projects_web_apps_undelete(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "firebase1-beta1-secret.json",
        ...
        .persist_tokens_to_disk(format!("{}/firebase1-beta1", config_dir))
        .build()
        .await
        .unwrap();
...
async fn main() {
    ...
    let arg_data = [
        ("available-projects", "methods: 'list'", vec![
            ...
            ("projects", "methods: 'add-firebase', 'add-google-analytics', 'android-apps-create', 'android-apps-get', 'android-apps-get-config', 'android-apps-list', 'android-apps-patch', 'android-apps-remove', 'android-apps-sha-create', 'android-apps-sha-delete', 'android-apps-sha-list', 'android-apps-undelete', 'available-locations-list', 'default-location-finalize', 'get', 'get-admin-sdk-config', 'get-analytics-details', 'ios-apps-create', 'ios-apps-get', 'ios-apps-get-config', 'ios-apps-list', 'ios-apps-patch', 'ios-apps-remove', 'ios-apps-undelete', 'list', 'patch', 'remove-analytics', 'search-apps', 'web-apps-create', 'web-apps-get', 'web-apps-get-config', 'web-apps-list', 'web-apps-patch', 'web-apps-remove' and 'web-apps-undelete'", vec![
            ("add-firebase",
            ...
            ("android-apps-remove",
                    Some(r##"Removes the specified AndroidApp from the FirebaseProject."##),
                    "Details at http://byron.github.io/google-apis-rs/google_firebase1_beta1_cli/projects_android-apps-remove",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The resource name of the AndroidApp, in the format: projects/ PROJECT_IDENTIFIER/androidApps/APP_ID Since an APP_ID is a unique identifier, the Unique Resource from Sub-Collection access pattern may be used here, in the format: projects/-/androidApps/APP_ID Refer to the AndroidApp [name](../projects.androidApps#AndroidApp.FIELDS.name) field for details about PROJECT_IDENTIFIER and APP_ID values."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("android-apps-undelete",
                    Some(r##"Restores the specified AndroidApp to the FirebaseProject."##),
                    "Details at http://byron.github.io/google-apis-rs/google_firebase1_beta1_cli/projects_android-apps-undelete",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The resource name of the AndroidApp, in the format: projects/ PROJECT_IDENTIFIER/androidApps/APP_ID Since an APP_ID is a unique identifier, the Unique Resource from Sub-Collection access pattern may be used here, in the format: projects/-/androidApps/APP_ID Refer to the AndroidApp [name](../projects.androidApps#AndroidApp.FIELDS.name) field for details about PROJECT_IDENTIFIER and APP_ID values."##),
            ...
            ("ios-apps-get-config",
                    Some(r##"Gets the configuration artifact associated with the specified IosApp."##),
                    "Details at http://byron.github.io/google-apis-rs/google_firebase1_beta1_cli/projects_ios-apps-get-config",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("ios-apps-remove",
                    Some(r##"Removes the specified IosApp from the FirebaseProject."##),
                    "Details at http://byron.github.io/google-apis-rs/google_firebase1_beta1_cli/projects_ios-apps-remove",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The resource name of the IosApp, in the format: projects/ PROJECT_IDENTIFIER/iosApps/APP_ID Since an APP_ID is a unique identifier, the Unique Resource from Sub-Collection access pattern may be used here, in the format: projects/-/iosApps/APP_ID Refer to the IosApp [name](../projects.iosApps#IosApp.FIELDS.name) field for details about PROJECT_IDENTIFIER and APP_ID values."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("ios-apps-undelete",
                    Some(r##"Restores the specified IosApp to the FirebaseProject."##),
                    "Details at http://byron.github.io/google-apis-rs/google_firebase1_beta1_cli/projects_ios-apps-undelete",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The resource name of the IosApp, in the format: projects/ PROJECT_IDENTIFIER/iosApps/APP_ID Since an APP_ID is a unique identifier, the Unique Resource from Sub-Collection access pattern may be used here, in the format: projects/-/iosApps/APP_ID Refer to the IosApp [name](../projects.iosApps#IosApp.FIELDS.name) field for details about PROJECT_IDENTIFIER and APP_ID values."##),
            ...
            ("web-apps-get-config",
                    Some(r##"Gets the configuration artifact associated with the specified WebApp."##),
                    "Details at http://byron.github.io/google-apis-rs/google_firebase1_beta1_cli/projects_web-apps-get-config",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("web-apps-remove",
                    Some(r##"Removes the specified WebApp from the FirebaseProject."##),
                    "Details at http://byron.github.io/google-apis-rs/google_firebase1_beta1_cli/projects_web-apps-remove",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The resource name of the WebApp, in the format: projects/ PROJECT_IDENTIFIER/webApps/APP_ID Since an APP_ID is a unique identifier, the Unique Resource from Sub-Collection access pattern may be used here, in the format: projects/-/webApps/APP_ID Refer to the WebApp [name](../projects.webApps#WebApp.FIELDS.name) field for details about PROJECT_IDENTIFIER and APP_ID values."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("web-apps-undelete",
                    Some(r##"Restores the specified WebApp to the FirebaseProject."##),
                    "Details at http://byron.github.io/google-apis-rs/google_firebase1_beta1_cli/projects_web-apps-undelete",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The resource name of the WebApp, in the format: projects/ PROJECT_IDENTIFIER/webApps/APP_ID Since an APP_ID is a unique identifier, the Unique Resource from Sub-Collection access pattern may be used here, in the format: projects/-/webApps/APP_ID Refer to the WebApp [name](../projects.webApps#WebApp.FIELDS.name) field for details about PROJECT_IDENTIFIER and APP_ID values."##),
