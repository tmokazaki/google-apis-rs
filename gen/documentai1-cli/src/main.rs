...
use google_documentai1::{api, yup_oauth2, Error};
    ...
    C: apis_common::Connector,
{
    ...
    async fn _projects_locations_fetch_processor_types(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_fetch_processor_types(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_processor_types_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_processor_types_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_processor_types_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_processor_types_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_processors_batch_process(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            {
                "document-output-config.gcs-output-config.field-mask" => Some((
                    "documentOutputConfig.gcsOutputConfig.fieldMask",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "document-output-config.gcs-output-config.gcs-uri" => Some((
                    "documentOutputConfig.gcsOutputConfig.gcsUri",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "document-output-config.gcs-output-config.sharding-config.pages-overlap" => Some((
                    "documentOutputConfig.gcsOutputConfig.shardingConfig.pagesOverlap",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                )),
                "document-output-config.gcs-output-config.sharding-config.pages-per-shard" => {
                    Some((
                        "documentOutputConfig.gcsOutputConfig.shardingConfig.pagesPerShard",
                        JsonTypeInfo {
                            jtype: JsonType::Int,
                            ctype: ComplexType::Pod,
                        },
                ...
                "input-documents.gcs-prefix.gcs-uri-prefix" => Some((
                    "inputDocuments.gcsPrefix.gcsUriPrefix",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                ...
                "process-options.from-start" => Some((
                ...
                "process-options.individual-page-selector.pages" => Some((
                ...
                "process-options.layout-config.chunking-config.chunk-size" => Some((
                    "processOptions.layoutConfig.chunkingConfig.chunkSize",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                )),
                "process-options.layout-config.chunking-config.include-ancestor-headings" => {
                    Some((
                        "processOptions.layoutConfig.chunkingConfig.includeAncestorHeadings",
                        JsonTypeInfo {
                ...
                "process-options.ocr-config.advanced-ocr-options" => Some((
                ...
                "process-options.ocr-config.compute-style-info" => Some((
                    "processOptions.ocrConfig.computeStyleInfo",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "process-options.ocr-config.disable-character-boxes-detection" => Some((
                    "processOptions.ocrConfig.disableCharacterBoxesDetection",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "process-options.ocr-config.enable-image-quality-scores" => Some((
                ...
                "process-options.ocr-config.enable-native-pdf-parsing" => Some((
                    "processOptions.ocrConfig.enableNativePdfParsing",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "process-options.ocr-config.enable-symbol" => Some((
                    "processOptions.ocrConfig.enableSymbol",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "process-options.ocr-config.hints.language-hints" => Some((
                    "processOptions.ocrConfig.hints.languageHints",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "process-options.ocr-config.premium-features.compute-style-info" => Some((
                    "processOptions.ocrConfig.premiumFeatures.computeStyleInfo",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "process-options.ocr-config.premium-features.enable-math-ocr" => Some((
                    "processOptions.ocrConfig.premiumFeatures.enableMathOcr",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "process-options.ocr-config.premium-features.enable-selection-mark-detection" => {
                    Some((
                        "processOptions.ocrConfig.premiumFeatures.enableSelectionMarkDetection",
                        JsonTypeInfo {
                            jtype: JsonType::Boolean,
                            ctype: ComplexType::Pod,
                        },
                ...
                "process-options.schema-override.description" => Some((
                    "processOptions.schemaOverride.description",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "process-options.schema-override.display-name" => Some((
                    "processOptions.schemaOverride.displayName",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "process-options.schema-override.metadata.document-allow-multiple-labels" => {
                    Some((
                        "processOptions.schemaOverride.metadata.documentAllowMultipleLabels",
                        JsonTypeInfo {
                            jtype: JsonType::Boolean,
                            ctype: ComplexType::Pod,
                        },
                ...
                "process-options.schema-override.metadata.document-splitter" => Some((
                    "processOptions.schemaOverride.metadata.documentSplitter",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "process-options.schema-override.metadata.prefixed-naming-on-properties" => Some((
                    "processOptions.schemaOverride.metadata.prefixedNamingOnProperties",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "process-options.schema-override.metadata.skip-naming-validation" => Some((
                    "processOptions.schemaOverride.metadata.skipNamingValidation",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "skip-human-review" => Some((
                    "skipHumanReview",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        ...
                        &vec![
                            ...
                            "compute-style-info",
                            "description",
                            "disable-character-boxes-detection",
                            "display-name",
                            "document-allow-multiple-labels",
                            "document-output-config",
                            "document-splitter",
                            "enable-image-quality-scores",
                            "enable-math-ocr",
                            "enable-native-pdf-parsing",
                            "enable-selection-mark-detection",
                            "enable-symbol",
                            "field-mask",
                            "from-end",
                            "from-start",
        ...
        let mut request: api::GoogleCloudDocumentaiV1BatchProcessRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_processors_batch_process(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_processors_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "default-processor-version" => Some((
        ...
        let mut request: api::GoogleCloudDocumentaiV1Processor =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_processors_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_processors_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_processors_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_processors_disable(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::GoogleCloudDocumentaiV1DisableProcessorRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_processors_disable(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_processors_enable(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::GoogleCloudDocumentaiV1EnableProcessorRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_processors_enable(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_processors_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_processors_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_processors_human_review_config_review_document(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                "document-schema.description" => Some((
                ...
                "document-schema.display-name" => Some((
                ...
                "document-schema.metadata.document-allow-multiple-labels" => Some((
                    "documentSchema.metadata.documentAllowMultipleLabels",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "document-schema.metadata.document-splitter" => Some((
                    "documentSchema.metadata.documentSplitter",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "document-schema.metadata.prefixed-naming-on-properties" => Some((
                    "documentSchema.metadata.prefixedNamingOnProperties",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "document-schema.metadata.skip-naming-validation" => Some((
                    "documentSchema.metadata.skipNamingValidation",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "enable-schema-validation" => Some((
                ...
                "inline-document.error.code" => Some((
                    "inlineDocument.error.code",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                )),
                "inline-document.error.message" => Some((
                    "inlineDocument.error.message",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "inline-document.mime-type" => Some((
                    "inlineDocument.mimeType",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "inline-document.shard-info.shard-count" => Some((
                    "inlineDocument.shardInfo.shardCount",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                )),
                "inline-document.shard-info.shard-index" => Some((
                    "inlineDocument.shardInfo.shardIndex",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "inline-document.shard-info.text-offset" => Some((
                    "inlineDocument.shardInfo.textOffset",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "inline-document.text" => Some((
                    "inlineDocument.text",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
        ...
        let mut request: api::GoogleCloudDocumentaiV1ReviewDocumentRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_processors_human_review_config_review_document(
                request,
                opt.value_of("human-review-config").unwrap_or(""),
            );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _projects_locations_processors_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_processors_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_processors_process(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "raw-document.display-name" => Some((
        ...
        let mut request: api::GoogleCloudDocumentaiV1ProcessRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_processors_process(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_processors_processor_versions_batch_process(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_processors_processor_versions_batch_process(
                request,
    ...
    async fn _projects_locations_processors_processor_versions_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_processors_processor_versions_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_processors_processor_versions_deploy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::GoogleCloudDocumentaiV1DeployProcessorVersionRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_processors_processor_versions_deploy(
                request,
                opt.value_of("name").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_processors_processor_versions_evaluate_processor_version(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                "evaluation-documents.gcs-prefix.gcs-uri-prefix" => Some((
                    "evaluationDocuments.gcsPrefix.gcsUriPrefix",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec!["evaluation-documents", "gcs-prefix", "gcs-uri-prefix"],
                    );
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
        ...
        let mut request: api::GoogleCloudDocumentaiV1EvaluateProcessorVersionRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_processors_processor_versions_evaluate_processor_version(
                request,
                opt.value_of("processor-version").unwrap_or(""),
            );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _projects_locations_processors_processor_versions_evaluations_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_processors_processor_versions_evaluations_get(
                opt.value_of("name").unwrap_or(""),
            );
        for parg in opt
            .values_of("v")
    ...
    async fn _projects_locations_processors_processor_versions_evaluations_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_processors_processor_versions_evaluations_list(
    ...
    async fn _projects_locations_processors_processor_versions_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_processors_processor_versions_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_processors_processor_versions_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_processors_processor_versions_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_processors_processor_versions_process(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_processors_processor_versions_process(
                request,
                opt.value_of("name").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_processors_processor_versions_train(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::GoogleCloudDocumentaiV1TrainProcessorVersionRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_processors_processor_versions_train(
                request,
                opt.value_of("parent").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_processors_processor_versions_undeploy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::GoogleCloudDocumentaiV1UndeployProcessorVersionRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_processors_processor_versions_undeploy(
                request,
                opt.value_of("name").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_processors_set_default_processor_version(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion =
                        FieldCursor::did_you_mean(key, &vec!["default-processor-version"]);
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
                        value.map(|v| v.to_string()),
        ...
        let mut request: api::GoogleCloudDocumentaiV1SetDefaultProcessorVersionRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_processors_set_default_processor_version(
                request,
                opt.value_of("processor").unwrap_or(""),
            );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
        ...
        match self.opt.subcommand() {
            ...
            ("projects", Some(opt)) => match opt.subcommand() {
                ("locations-fetch-processor-types", Some(opt)) => {
                    call_result = self
                        ._projects_locations_fetch_processor_types(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("locations-processor-types-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_processor_types_get(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-processor-types-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_processor_types_list(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-processors-batch-process", Some(opt)) => {
                    call_result = self
                        ._projects_locations_processors_batch_process(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-processors-create", Some(opt)) => {
                    call_result = self
                        ._projects_locations_processors_create(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-processors-delete", Some(opt)) => {
                    call_result = self
                        ._projects_locations_processors_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-processors-disable", Some(opt)) => {
                    call_result = self
                        ._projects_locations_processors_disable(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-processors-enable", Some(opt)) => {
                    call_result = self
                        ._projects_locations_processors_enable(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-processors-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_processors_get(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-processors-human-review-config-review-document", Some(opt)) => {
                    call_result = self
                        ._projects_locations_processors_human_review_config_review_document(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-processors-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_processors_list(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-processors-process", Some(opt)) => {
                    call_result = self
                        ._projects_locations_processors_process(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-processors-processor-versions-batch-process", Some(opt)) => {
                    call_result = self
                        ._projects_locations_processors_processor_versions_batch_process(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-processors-processor-versions-delete", Some(opt)) => {
                    call_result = self
                        ._projects_locations_processors_processor_versions_delete(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-processors-processor-versions-deploy", Some(opt)) => {
                    call_result = self
                        ._projects_locations_processors_processor_versions_deploy(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ...
                ("locations-processors-processor-versions-evaluations-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_processors_processor_versions_evaluations_get(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-processors-processor-versions-evaluations-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_processors_processor_versions_evaluations_list(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-processors-processor-versions-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_processors_processor_versions_get(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-processors-processor-versions-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_processors_processor_versions_list(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-processors-processor-versions-process", Some(opt)) => {
                    call_result = self
                        ._projects_locations_processors_processor_versions_process(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-processors-processor-versions-train", Some(opt)) => {
                    call_result = self
                        ._projects_locations_processors_processor_versions_train(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-processors-processor-versions-undeploy", Some(opt)) => {
                    call_result = self
                        ._projects_locations_processors_processor_versions_undeploy(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-processors-set-default-processor-version", Some(opt)) => {
                    call_result = self
                        ._projects_locations_processors_set_default_processor_version(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "documentai1-secret.json",
        ...
        .persist_tokens_to_disk(format!("{}/documentai1", config_dir))
        .build()
        .await
        .unwrap();
