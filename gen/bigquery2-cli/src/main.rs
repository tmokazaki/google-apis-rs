...
async fn main() {
    ...
    let arg_data = [
        ("datasets", "methods: 'delete', 'get', 'insert', 'list', 'patch', 'undelete' and 'update'", vec![
            ...
            ("routines", "methods: 'delete', 'get', 'get-iam-policy', 'insert', 'list', 'set-iam-policy' and 'update'", vec![
            ("delete",
