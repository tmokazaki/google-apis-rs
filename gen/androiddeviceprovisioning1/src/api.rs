...
/// ```
#[derive(Clone)]
pub struct AndroidProvisioningPartner<C> {
...
impl<C> common::Hub for AndroidProvisioningPartner<C> {}

impl<'a, C> AndroidProvisioningPartner<C> {
    pub fn new<A: 'static + common::GetToken>(
        client: common::Client<C>,
        auth: A,
    ) -> AndroidProvisioningPartner<C> {
...
impl common::RequestValue for ClaimDeviceRequest {}
...
impl common::ResponseResult for ClaimDeviceResponse {}
...
impl common::RequestValue for ClaimDevicesRequest {}
...
pub struct Configuration {
    ...
    pub forced_reset_time: Option<chrono::Duration>,
...
impl common::RequestValue for Configuration {}
impl common::ResponseResult for Configuration {}
...
impl common::RequestValue for CreateCustomerRequest {}
...
impl common::RequestValue for CustomerApplyConfigurationRequest {}
...
impl common::ResponseResult for CustomerListConfigurationsResponse {}
...
impl common::ResponseResult for CustomerListCustomersResponse {}
...
impl common::ResponseResult for CustomerListDevicesResponse {}
...
impl common::ResponseResult for CustomerListDpcsResponse {}
...
impl common::RequestValue for CustomerRemoveConfigurationRequest {}
...
impl common::RequestValue for CustomerUnclaimDeviceRequest {}
...
pub struct DeviceClaim {
    ...
    pub vacation_mode_expire_time: Option<chrono::DateTime<chrono::offset::Utc>>,
    ...
    pub vacation_mode_start_time: Option<chrono::DateTime<chrono::offset::Utc>>,
}

impl common::Part for DeviceClaim {}
...
impl common::Part for DeviceIdentifier {}
...
impl common::ResponseResult for DeviceMetadata {}
...
impl common::Part for DeviceReference {}
...
impl common::RequestValue for FindDevicesByDeviceIdentifierRequest {}
...
impl common::ResponseResult for FindDevicesByDeviceIdentifierResponse {}
...
impl common::RequestValue for FindDevicesByOwnerRequest {}
...
impl common::ResponseResult for FindDevicesByOwnerResponse {}
...
impl common::RequestValue for GetDeviceSimLockStateRequest {}
...
impl common::ResponseResult for GetDeviceSimLockStateResponse {}
...
impl common::Part for GoogleWorkspaceAccount {}
...
impl common::ResponseResult for ListCustomersResponse {}
...
impl common::ResponseResult for ListVendorCustomersResponse {}
...
impl common::ResponseResult for ListVendorsResponse {}
...
impl common::Part for PartnerClaim {}
...
impl common::Part for PartnerUnclaim {}
...
impl common::RequestValue for UnclaimDeviceRequest {}
...
impl common::RequestValue for UnclaimDevicesRequest {}
...
impl common::RequestValue for UpdateDeviceMetadataInBatchRequest {}
...
impl common::RequestValue for UpdateDeviceMetadataRequest {}
...
impl common::Part for UpdateMetadataArguments {}
...
where
    C: 'a,
{
    hub: &'a AndroidProvisioningPartner<C>,
}
...
impl<'a, C> PartnerMethods<'a, C> {
    ...
    pub fn devices_get_sim_lock_state(
        &self,
...
/// # }
/// ```
pub struct CustomerConfigurationCreateCall<'a, C>
where
    C: 'a,
{
    hub: &'a AndroidProvisioningPartner<C>,
...
impl<'a, C> common::CallBuilder for CustomerConfigurationCreateCall<'a, C> {}

impl<'a, C> CustomerConfigurationCreateCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, Configuration)> {
        use std::borrow::Cow;
    ...
    pub fn request(mut self, new_value: Configuration) -> CustomerConfigurationCreateCall<'a, C> {
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> CustomerConfigurationCreateCall<'a, C> {
    ...
    pub fn param<T>(mut self, name: T, value: T) -> CustomerConfigurationCreateCall<'a, C>
    where
        T: AsRef<str>,
    {
...
/// # }
/// ```
pub struct CustomerConfigurationDeleteCall<'a, C>
where
    C: 'a,
{
    hub: &'a AndroidProvisioningPartner<C>,
...
impl<'a, C> common::CallBuilder for CustomerConfigurationDeleteCall<'a, C> {}

impl<'a, C> CustomerConfigurationDeleteCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> CustomerConfigurationDeleteCall<'a, C> {
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> CustomerConfigurationDeleteCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
...
/// # }
/// ```
pub struct CustomerConfigurationGetCall<'a, C>
where
    C: 'a,
{
    hub: &'a AndroidProvisioningPartner<C>,
...
impl<'a, C> common::CallBuilder for CustomerConfigurationGetCall<'a, C> {}

impl<'a, C> CustomerConfigurationGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> CustomerConfigurationGetCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> CustomerConfigurationGetCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
...
/// # }
/// ```
pub struct CustomerConfigurationListCall<'a, C>
where
    C: 'a,
{
    hub: &'a AndroidProvisioningPartner<C>,
...
impl<'a, C> common::CallBuilder for CustomerConfigurationListCall<'a, C> {}

impl<'a, C> CustomerConfigurationListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(
        mut self,
    ) -> common::Result<(common::Response, CustomerListConfigurationsResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> CustomerConfigurationListCall<'a, C> {
        self._parent = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> CustomerConfigurationListCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
...
/// # }
/// ```
pub struct CustomerConfigurationPatchCall<'a, C>
where
    C: 'a,
{
    hub: &'a AndroidProvisioningPartner<C>,
...
impl<'a, C> common::CallBuilder for CustomerConfigurationPatchCall<'a, C> {}

impl<'a, C> CustomerConfigurationPatchCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: Configuration) -> CustomerConfigurationPatchCall<'a, C> {
        self._request = new_value;
        self
    }
    /// Output only. The API resource name in the format `customers/[CUSTOMER_ID]/configurations/[CONFIGURATION_ID]`. Assigned by the server.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> CustomerConfigurationPatchCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// Required. The field mask applied to the target `Configuration` before updating the fields. To learn more about using field masks, read [FieldMask](https://developers.google.com/protocol-buffers/docs/reference/google.protobuf#fieldmask) in the Protocol Buffers documentation.
    ///
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> CustomerConfigurationPatchCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
...
/// # }
/// ```
pub struct CustomerDeviceApplyConfigurationCall<'a, C>
where
    C: 'a,
{
    hub: &'a AndroidProvisioningPartner<C>,
...
impl<'a, C> common::CallBuilder for CustomerDeviceApplyConfigurationCall<'a, C> {}

impl<'a, C> CustomerDeviceApplyConfigurationCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    pub fn request(
        mut self,
        new_value: CustomerApplyConfigurationRequest,
    ) -> CustomerDeviceApplyConfigurationCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> CustomerDeviceApplyConfigurationCall<'a, C> {
        self._parent = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> CustomerDeviceApplyConfigurationCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
...
impl<'a, C> common::CallBuilder for CustomerDeviceGetCall<'a, C> {}

impl<'a, C> CustomerDeviceGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
...
impl<'a, C> common::CallBuilder for CustomerDeviceListCall<'a, C> {}

impl<'a, C> CustomerDeviceListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, CustomerListDevicesResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    pub fn page_size(mut self, new_value: i64) -> CustomerDeviceListCall<'a, C> {
...
/// # }
/// ```
pub struct CustomerDeviceRemoveConfigurationCall<'a, C>
where
    C: 'a,
{
    hub: &'a AndroidProvisioningPartner<C>,
...
impl<'a, C> common::CallBuilder for CustomerDeviceRemoveConfigurationCall<'a, C> {}

impl<'a, C> CustomerDeviceRemoveConfigurationCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    pub fn request(
        mut self,
        new_value: CustomerRemoveConfigurationRequest,
    ) -> CustomerDeviceRemoveConfigurationCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> CustomerDeviceRemoveConfigurationCall<'a, C> {
        self._parent = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> CustomerDeviceRemoveConfigurationCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
...
/// # }
/// ```
pub struct CustomerDeviceUnclaimCall<'a, C>
where
    C: 'a,
{
    hub: &'a AndroidProvisioningPartner<C>,
...
impl<'a, C> common::CallBuilder for CustomerDeviceUnclaimCall<'a, C> {}

impl<'a, C> CustomerDeviceUnclaimCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    pub fn request(
        mut self,
        new_value: CustomerUnclaimDeviceRequest,
    ) -> CustomerDeviceUnclaimCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> CustomerDeviceUnclaimCall<'a, C> {
        self._parent = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> CustomerDeviceUnclaimCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
...
/// # }
/// ```
pub struct CustomerDpcListCall<'a, C>
where
    C: 'a,
{
    hub: &'a AndroidProvisioningPartner<C>,
...
impl<'a, C> common::CallBuilder for CustomerDpcListCall<'a, C> {}

impl<'a, C> CustomerDpcListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, CustomerListDpcsResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> CustomerDpcListCall<'a, C> {
        self._parent = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> CustomerDpcListCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
...
impl<'a, C> common::CallBuilder for CustomerListCall<'a, C> {}

impl<'a, C> CustomerListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(
        mut self,
    ) -> common::Result<(common::Response, CustomerListCustomersResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> CustomerListCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
...
/// # }
/// ```
pub struct PartnerCustomerCreateCall<'a, C>
where
    C: 'a,
{
    hub: &'a AndroidProvisioningPartner<C>,
...
impl<'a, C> common::CallBuilder for PartnerCustomerCreateCall<'a, C> {}

impl<'a, C> PartnerCustomerCreateCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: CreateCustomerRequest) -> PartnerCustomerCreateCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> PartnerCustomerCreateCall<'a, C> {
        self._parent = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> PartnerCustomerCreateCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.partners().customers_list(-88)
///              .page_token("amet")
///              .page_size(-20)
///              .doit().await;
/// # }
/// ```
pub struct PartnerCustomerListCall<'a, C>
where
    C: 'a,
{
    hub: &'a AndroidProvisioningPartner<C>,
...
impl<'a, C> common::CallBuilder for PartnerCustomerListCall<'a, C> {}

impl<'a, C> PartnerCustomerListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, ListCustomersResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn partner_id(mut self, new_value: i64) -> PartnerCustomerListCall<'a, C> {
    ...
    ///
    /// Sets the *page token* query property to the given value.
    pub fn page_token(mut self, new_value: &str) -> PartnerCustomerListCall<'a, C> {
        self._page_token = Some(new_value.to_string());
        self
    }
    ...
    ///
    /// Sets the *page size* query property to the given value.
    pub fn page_size(mut self, new_value: i32) -> PartnerCustomerListCall<'a, C> {
        self._page_size = Some(new_value);
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> PartnerCustomerListCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.partners().devices_claim(req, -50)
///              .doit().await;
/// # }
/// ```
pub struct PartnerDeviceClaimCall<'a, C>
where
    C: 'a,
{
    hub: &'a AndroidProvisioningPartner<C>,
...
impl<'a, C> common::CallBuilder for PartnerDeviceClaimCall<'a, C> {}

impl<'a, C> PartnerDeviceClaimCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, ClaimDeviceResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: ClaimDeviceRequest) -> PartnerDeviceClaimCall<'a, C> {
        self._request = new_value;
        self
    }
    /// Required. The ID of the reseller partner.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn partner_id(mut self, new_value: i64) -> PartnerDeviceClaimCall<'a, C> {
        self._partner_id = new_value;
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> PartnerDeviceClaimCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.partners().devices_claim_async(req, -93)
///              .doit().await;
/// # }
/// ```
pub struct PartnerDeviceClaimAsyncCall<'a, C>
where
    C: 'a,
{
    hub: &'a AndroidProvisioningPartner<C>,
...
impl<'a, C> common::CallBuilder for PartnerDeviceClaimAsyncCall<'a, C> {}

impl<'a, C> PartnerDeviceClaimAsyncCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: ClaimDevicesRequest) -> PartnerDeviceClaimAsyncCall<'a, C> {
        self._request = new_value;
        self
    }
    /// Required. The ID of the reseller partner.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn partner_id(mut self, new_value: i64) -> PartnerDeviceClaimAsyncCall<'a, C> {
        self._partner_id = new_value;
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> PartnerDeviceClaimAsyncCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.partners().devices_find_by_identifier(req, -37)
///              .doit().await;
/// # }
/// ```
pub struct PartnerDeviceFindByIdentifierCall<'a, C>
where
    C: 'a,
{
    hub: &'a AndroidProvisioningPartner<C>,
...
impl<'a, C> common::CallBuilder for PartnerDeviceFindByIdentifierCall<'a, C> {}

impl<'a, C> PartnerDeviceFindByIdentifierCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(
        mut self,
    ) -> common::Result<(common::Response, FindDevicesByDeviceIdentifierResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
        ...
        params.push("alt", "json");
        let mut url =
            self.hub._base_url.clone() + "v1/partners/{+partnerId}/devices:findByIdentifier";
    ...
    pub fn request(
        mut self,
        new_value: FindDevicesByDeviceIdentifierRequest,
    ) -> PartnerDeviceFindByIdentifierCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn partner_id(mut self, new_value: i64) -> PartnerDeviceFindByIdentifierCall<'a, C> {
        self._partner_id = new_value;
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> PartnerDeviceFindByIdentifierCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.partners().devices_find_by_owner(req, -12)
///              .doit().await;
/// # }
/// ```
pub struct PartnerDeviceFindByOwnerCall<'a, C>
where
    C: 'a,
{
    hub: &'a AndroidProvisioningPartner<C>,
...
impl<'a, C> common::CallBuilder for PartnerDeviceFindByOwnerCall<'a, C> {}

impl<'a, C> PartnerDeviceFindByOwnerCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, FindDevicesByOwnerResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    pub fn request(
        mut self,
        new_value: FindDevicesByOwnerRequest,
    ) -> PartnerDeviceFindByOwnerCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn partner_id(mut self, new_value: i64) -> PartnerDeviceFindByOwnerCall<'a, C> {
        self._partner_id = new_value;
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> PartnerDeviceFindByOwnerCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
...
/// # }
/// ```
pub struct PartnerDeviceGetCall<'a, C>
where
    C: 'a,
{
    hub: &'a AndroidProvisioningPartner<C>,
...
impl<'a, C> common::CallBuilder for PartnerDeviceGetCall<'a, C> {}

impl<'a, C> PartnerDeviceGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> PartnerDeviceGetCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> PartnerDeviceGetCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
...
/// # }
/// ```
pub struct PartnerDeviceGetSimLockStateCall<'a, C>
where
    C: 'a,
{
    hub: &'a AndroidProvisioningPartner<C>,
...
impl<'a, C> common::CallBuilder for PartnerDeviceGetSimLockStateCall<'a, C> {}

impl<'a, C> PartnerDeviceGetSimLockStateCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(
        mut self,
    ) -> common::Result<(common::Response, GetDeviceSimLockStateResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
        ...
        params.push("alt", "json");
        let mut url =
            self.hub._base_url.clone() + "v1/partners/{+partnerId}/devices:getSimLockState";
    ...
    pub fn request(
        mut self,
        new_value: GetDeviceSimLockStateRequest,
    ) -> PartnerDeviceGetSimLockStateCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn partner_id(mut self, new_value: i64) -> PartnerDeviceGetSimLockStateCall<'a, C> {
        self._partner_id = new_value;
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> PartnerDeviceGetSimLockStateCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
...
/// # }
/// ```
pub struct PartnerDeviceMetadataCall<'a, C>
where
    C: 'a,
{
    hub: &'a AndroidProvisioningPartner<C>,
    _request: UpdateDeviceMetadataRequest,
    _metadata_owner_id: i64,
    _device_id: i64,
    _delegate: Option<&'a mut dyn common::Delegate>,
    _additional_params: HashMap<String, String>,
}

impl<'a, C> common::CallBuilder for PartnerDeviceMetadataCall<'a, C> {}

impl<'a, C> PartnerDeviceMetadataCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, DeviceMetadata)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
        ...
        {
            let to_remove = ["deviceId", "metadataOwnerId"];
            params.remove_params(&to_remove);
        }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn metadata_owner_id(mut self, new_value: i64) -> PartnerDeviceMetadataCall<'a, C> {
        self._metadata_owner_id = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn device_id(mut self, new_value: i64) -> PartnerDeviceMetadataCall<'a, C> {
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> PartnerDeviceMetadataCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
...
/// # }
/// ```
pub struct PartnerDeviceUnclaimCall<'a, C>
where
    C: 'a,
{
    hub: &'a AndroidProvisioningPartner<C>,
...
impl<'a, C> common::CallBuilder for PartnerDeviceUnclaimCall<'a, C> {}

impl<'a, C> PartnerDeviceUnclaimCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: UnclaimDeviceRequest) -> PartnerDeviceUnclaimCall<'a, C> {
        self._request = new_value;
        self
    }
    /// Required. The ID of the reseller partner.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn partner_id(mut self, new_value: i64) -> PartnerDeviceUnclaimCall<'a, C> {
        self._partner_id = new_value;
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> PartnerDeviceUnclaimCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
...
/// # }
/// ```
pub struct PartnerDeviceUnclaimAsyncCall<'a, C>
where
    C: 'a,
{
    hub: &'a AndroidProvisioningPartner<C>,
...
impl<'a, C> common::CallBuilder for PartnerDeviceUnclaimAsyncCall<'a, C> {}

impl<'a, C> PartnerDeviceUnclaimAsyncCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    pub fn request(
        mut self,
        new_value: UnclaimDevicesRequest,
    ) -> PartnerDeviceUnclaimAsyncCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn partner_id(mut self, new_value: i64) -> PartnerDeviceUnclaimAsyncCall<'a, C> {
        self._partner_id = new_value;
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> PartnerDeviceUnclaimAsyncCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
...
/// # }
/// ```
pub struct PartnerDeviceUpdateMetadataAsyncCall<'a, C>
where
    C: 'a,
{
    hub: &'a AndroidProvisioningPartner<C>,
...
impl<'a, C> common::CallBuilder for PartnerDeviceUpdateMetadataAsyncCall<'a, C> {}

impl<'a, C> PartnerDeviceUpdateMetadataAsyncCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, Operation)> {
        ...
        params.push("alt", "json");
        let mut url =
            self.hub._base_url.clone() + "v1/partners/{+partnerId}/devices:updateMetadataAsync";
    ...
    pub fn request(
        mut self,
        new_value: UpdateDeviceMetadataInBatchRequest,
    ) -> PartnerDeviceUpdateMetadataAsyncCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn partner_id(mut self, new_value: i64) -> PartnerDeviceUpdateMetadataAsyncCall<'a, C> {
        self._partner_id = new_value;
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> PartnerDeviceUpdateMetadataAsyncCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
...
/// # }
/// ```
pub struct PartnerVendorCustomerListCall<'a, C>
where
    C: 'a,
{
    hub: &'a AndroidProvisioningPartner<C>,
...
impl<'a, C> common::CallBuilder for PartnerVendorCustomerListCall<'a, C> {}

impl<'a, C> PartnerVendorCustomerListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, ListVendorCustomersResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> PartnerVendorCustomerListCall<'a, C> {
        self._parent = new_value.to_string();
        self
    }
    /// A token identifying a page of results returned by the server.
    ///
    /// Sets the *page token* query property to the given value.
    pub fn page_token(mut self, new_value: &str) -> PartnerVendorCustomerListCall<'a, C> {
        self._page_token = Some(new_value.to_string());
        self
    }
    ...
    ///
    /// Sets the *page size* query property to the given value.
    pub fn page_size(mut self, new_value: i32) -> PartnerVendorCustomerListCall<'a, C> {
        self._page_size = Some(new_value);
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> PartnerVendorCustomerListCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
...
/// # }
/// ```
pub struct PartnerVendorListCall<'a, C>
where
    C: 'a,
{
    hub: &'a AndroidProvisioningPartner<C>,
...
impl<'a, C> common::CallBuilder for PartnerVendorListCall<'a, C> {}

impl<'a, C> PartnerVendorListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, ListVendorsResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> PartnerVendorListCall<'a, C> {
        self._parent = new_value.to_string();
        self
    }
    /// A token identifying a page of results returned by the server.
    ///
    /// Sets the *page token* query property to the given value.
    pub fn page_token(mut self, new_value: &str) -> PartnerVendorListCall<'a, C> {
        self._page_token = Some(new_value.to_string());
        self
    }
    /// The maximum number of results to be returned.
    ///
    /// Sets the *page size* query property to the given value.
    pub fn page_size(mut self, new_value: i32) -> PartnerVendorListCall<'a, C> {
        self._page_size = Some(new_value);
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> PartnerVendorListCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
