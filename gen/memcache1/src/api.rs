...
impl common::Part for GoogleCloudMemcacheV1MaintenancePolicy {}
...
impl common::RequestValue for GoogleCloudMemcacheV1UpgradeInstanceRequest {}
...
impl<'a, C> ProjectMethods<'a, C> {
    ...
    pub fn locations_instances_upgrade(
        &self,
        request: GoogleCloudMemcacheV1UpgradeInstanceRequest,
        name: &str,
...
/// # extern crate hyper_rustls;
/// # extern crate google_memcache1 as memcache1;
/// use memcache1::api::RescheduleMaintenanceRequest;
/// # async fn dox() {
/// # use memcache1::{CloudMemorystoreForMemcached, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
    ...
    C: common::Connector,
{
    ...
    pub async fn doit(mut self) -> common::Result<(common::Response, Operation)> {
        ...
        params.push("alt", "json");
        let mut url = self.hub._base_url.clone() + "v1/{+instance}:rescheduleMaintenance";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string());
        }
...
/// # extern crate hyper_rustls;
/// # extern crate google_memcache1 as memcache1;
/// use memcache1::api::GoogleCloudMemcacheV1UpgradeInstanceRequest;
/// # async fn dox() {
/// # use memcache1::{CloudMemorystoreForMemcached, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = GoogleCloudMemcacheV1UpgradeInstanceRequest::default();
///
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
...
{
    hub: &'a CloudMemorystoreForMemcached<C>,
    _request: GoogleCloudMemcacheV1UpgradeInstanceRequest,
    _name: String,
    _delegate: Option<&'a mut dyn common::Delegate>,
    _additional_params: HashMap<String, String>,
    _scopes: BTreeSet<String>,
    ...
    C: common::Connector,
{
    ...
    pub fn request(
        mut self,
        new_value: GoogleCloudMemcacheV1UpgradeInstanceRequest,
    ) -> ProjectLocationInstanceUpgradeCall<'a, C> {
        self._request = new_value;
        self
    }
