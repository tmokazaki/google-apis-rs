...
use google_books1::{api, yup_oauth2, Error};
...
{
    async fn _bookshelves_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.bookshelves().get(
    ...
    async fn _bookshelves_list(
        ...
        let mut call = self
            .hub
            .bookshelves()
            .list(opt.value_of("user-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _bookshelves_volumes_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.bookshelves().volumes_list(
            opt.value_of("user-id").unwrap_or(""),
            opt.value_of("shelf").unwrap_or(""),
        );
        for parg in opt
            ...
            .iter()
        {
            ...
            match key {
                ...
                "show-preorders" => {
                    call = call.show_preorders(
                        value
                            .map(|v| arg_from_str(v, err, "show-preorders", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "max-results" => {
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["max-results", "show-preorders", "source", "start-index"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _cloudloading_add_book(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _cloudloading_delete_book(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .cloudloading()
            .delete_book(opt.value_of("volume-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _cloudloading_update_book(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec!["author", "processing-state", "title", "volume-id"],
                    );
        ...
        let mut request: api::BooksCloudloadingResource =
    ...
    async fn _dictionary_list_offline_metadata(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .dictionary()
            .list_offline_metadata(opt.value_of("cpksver").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _familysharing_get_family_info(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _familysharing_unshare(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _layers_annotation_data_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.layers().annotation_data_get(
            opt.value_of("volume-id").unwrap_or(""),
            opt.value_of("layer-id").unwrap_or(""),
            opt.value_of("annotation-data-id").unwrap_or(""),
            opt.value_of("content-version").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            ...
            .iter()
        {
            ...
            match key {
                "w" => {
                    call = call.w(value
                        .map(|v| arg_from_str(v, err, "w", "int32"))
                        .unwrap_or(-0));
                }
                "source" => {
                    call = call.source(value.unwrap_or(""));
                ...
                "scale" => {
                    call = call.scale(
                        value
                            .map(|v| arg_from_str(v, err, "scale", "int32"))
                            .unwrap_or(-0),
                    );
                }
                "locale" => {
                ...
                "h" => {
                    call = call.h(value
                        .map(|v| arg_from_str(v, err, "h", "int32"))
                        .unwrap_or(-0));
                }
                "allow-web-definitions" => {
                    call = call.allow_web_definitions(
                        value
                            .map(|v| arg_from_str(v, err, "allow-web-definitions", "boolean"))
                            .unwrap_or(false),
                    );
                }
                _ => {
    ...
    async fn _layers_annotation_data_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.layers().annotation_data_list(
            opt.value_of("volume-id").unwrap_or(""),
            opt.value_of("layer-id").unwrap_or(""),
            opt.value_of("content-version").unwrap_or(""),
        );
    ...
    async fn _layers_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.layers().get(
            opt.value_of("volume-id").unwrap_or(""),
            opt.value_of("summary-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _layers_list(
        ...
        let mut call = self
            .hub
            .layers()
            .list(opt.value_of("volume-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["content-version", "max-results", "page-token", "source"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _layers_volume_annotations_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.layers().volume_annotations_get(
            opt.value_of("volume-id").unwrap_or(""),
            opt.value_of("layer-id").unwrap_or(""),
            opt.value_of("annotation-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _layers_volume_annotations_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.layers().volume_annotations_list(
            opt.value_of("volume-id").unwrap_or(""),
            opt.value_of("layer-id").unwrap_or(""),
            opt.value_of("content-version").unwrap_or(""),
        );
    ...
    async fn _myconfig_get_user_settings(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _myconfig_release_download_access(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self.hub.myconfig().release_download_access(
            opt.value_of("cpksver").unwrap_or(""),
            &opt.values_of("volume-ids")
                .map(|i| i.collect())
                .unwrap_or(Vec::new())
                .iter()
                .map(|&v| v.to_string())
    ...
    async fn _myconfig_request_access(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self.hub.myconfig().request_access(
            opt.value_of("cpksver").unwrap_or(""),
            opt.value_of("nonce").unwrap_or(""),
            opt.value_of("source").unwrap_or(""),
            opt.value_of("volume-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
    ...
    async fn _myconfig_sync_volume_licenses(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            match key {
                ...
                "include-non-comics-series" => {
                    call = call.include_non_comics_series(
                        value
                            .map(|v| arg_from_str(v, err, "include-non-comics-series", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "features" => {
    ...
    async fn _myconfig_update_user_settings(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "notes-export.is-enabled" => Some((
                    "notesExport.isEnabled",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "notification.match-my-interests.opted-state" => Some((
                ...
                "notification.more-from-authors.opted-state" => Some((
                    "notification.moreFromAuthors.opted_state",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "notification.more-from-series.opted-state" => Some((
                ...
                "notification.price-drop.opted-state" => Some((
                    "notification.priceDrop.opted_state",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "notification.reward-expirations.opted-state" => Some((
                    "notification.rewardExpirations.opted_state",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
        ...
        let mut request: api::Usersettings = serde_json::value::from_value(object).unwrap();
    ...
    async fn _mylibrary_annotations_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .mylibrary()
            .annotations_delete(opt.value_of("annotation-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _mylibrary_annotations_insert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "client-version-ranges.cfi-range.end-offset" => Some((
                ...
                "client-version-ranges.cfi-range.end-position" => Some((
                    "clientVersionRanges.cfiRange.endPosition",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "client-version-ranges.cfi-range.start-offset" => Some((
                    "clientVersionRanges.cfiRange.startOffset",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "client-version-ranges.cfi-range.start-position" => Some((
                    "clientVersionRanges.cfiRange.startPosition",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "client-version-ranges.content-version" => Some((
                    "clientVersionRanges.contentVersion",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "client-version-ranges.gb-image-range.end-offset" => Some((
                    "clientVersionRanges.gbImageRange.endOffset",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "client-version-ranges.gb-image-range.end-position" => Some((
                    "clientVersionRanges.gbImageRange.endPosition",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "client-version-ranges.gb-image-range.start-offset" => Some((
                    "clientVersionRanges.gbImageRange.startOffset",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "client-version-ranges.gb-image-range.start-position" => Some((
                    "clientVersionRanges.gbImageRange.startPosition",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "client-version-ranges.gb-text-range.end-offset" => Some((
                    "clientVersionRanges.gbTextRange.endOffset",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "client-version-ranges.gb-text-range.end-position" => Some((
                    "clientVersionRanges.gbTextRange.endPosition",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "client-version-ranges.gb-text-range.start-offset" => Some((
                    "clientVersionRanges.gbTextRange.startOffset",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "client-version-ranges.gb-text-range.start-position" => Some((
                    "clientVersionRanges.gbTextRange.startPosition",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "client-version-ranges.image-cfi-range.end-offset" => Some((
                    "clientVersionRanges.imageCfiRange.endOffset",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "client-version-ranges.image-cfi-range.end-position" => Some((
                    "clientVersionRanges.imageCfiRange.endPosition",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "client-version-ranges.image-cfi-range.start-offset" => Some((
                    "clientVersionRanges.imageCfiRange.startOffset",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "client-version-ranges.image-cfi-range.start-position" => Some((
                    "clientVersionRanges.imageCfiRange.startPosition",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                ...
                "current-version-ranges.cfi-range.end-offset" => Some((
                    "currentVersionRanges.cfiRange.endOffset",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "current-version-ranges.cfi-range.end-position" => Some((
                    "currentVersionRanges.cfiRange.endPosition",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "current-version-ranges.cfi-range.start-offset" => Some((
                    "currentVersionRanges.cfiRange.startOffset",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "current-version-ranges.cfi-range.start-position" => Some((
                    "currentVersionRanges.cfiRange.startPosition",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "current-version-ranges.content-version" => Some((
                    "currentVersionRanges.contentVersion",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "current-version-ranges.gb-image-range.end-offset" => Some((
                    "currentVersionRanges.gbImageRange.endOffset",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "current-version-ranges.gb-image-range.end-position" => Some((
                    "currentVersionRanges.gbImageRange.endPosition",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "current-version-ranges.gb-image-range.start-offset" => Some((
                    "currentVersionRanges.gbImageRange.startOffset",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "current-version-ranges.gb-image-range.start-position" => Some((
                    "currentVersionRanges.gbImageRange.startPosition",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "current-version-ranges.gb-text-range.end-offset" => Some((
                    "currentVersionRanges.gbTextRange.endOffset",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "current-version-ranges.gb-text-range.end-position" => Some((
                    "currentVersionRanges.gbTextRange.endPosition",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "current-version-ranges.gb-text-range.start-offset" => Some((
                    "currentVersionRanges.gbTextRange.startOffset",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "current-version-ranges.gb-text-range.start-position" => Some((
                    "currentVersionRanges.gbTextRange.startPosition",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "current-version-ranges.image-cfi-range.end-offset" => Some((
                    "currentVersionRanges.imageCfiRange.endOffset",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "current-version-ranges.image-cfi-range.end-position" => Some((
                    "currentVersionRanges.imageCfiRange.endPosition",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "current-version-ranges.image-cfi-range.start-offset" => Some((
                    "currentVersionRanges.imageCfiRange.startOffset",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "current-version-ranges.image-cfi-range.start-position" => Some((
                    "currentVersionRanges.imageCfiRange.startPosition",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                ...
                "layer-summary.allowed-character-count" => Some((
                ...
                "layer-summary.limit-type" => Some((
                    "layerSummary.limitType",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "layer-summary.remaining-character-count" => Some((
                    "layerSummary.remainingCharacterCount",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
        ...
        let mut request: api::Annotation = serde_json::value::from_value(object).unwrap();
            ...
            .iter()
        {
            ...
            match key {
                ...
                "show-only-summary-in-response" => {
                    call = call.show_only_summary_in_response(
                        value
                            .map(|v| {
                                arg_from_str(v, err, "show-only-summary-in-response", "boolean")
                            })
                            .unwrap_or(false),
                    );
                }
    ...
    async fn _mylibrary_annotations_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _mylibrary_annotations_summary(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _mylibrary_annotations_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .mylibrary()
            .annotations_update(request, opt.value_of("annotation-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _mylibrary_bookshelves_add_volume(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.mylibrary().bookshelves_add_volume(
            opt.value_of("shelf").unwrap_or(""),
            opt.value_of("volume-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _mylibrary_bookshelves_clear_volumes(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .mylibrary()
            .bookshelves_clear_volumes(opt.value_of("shelf").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _mylibrary_bookshelves_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .mylibrary()
            .bookshelves_get(opt.value_of("shelf").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _mylibrary_bookshelves_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _mylibrary_bookshelves_move_volume(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let volume_position: i32 = arg_from_str(
    ...
    async fn _mylibrary_bookshelves_remove_volume(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.mylibrary().bookshelves_remove_volume(
            opt.value_of("shelf").unwrap_or(""),
            opt.value_of("volume-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _mylibrary_bookshelves_volumes_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .mylibrary()
            .bookshelves_volumes_list(opt.value_of("shelf").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _mylibrary_readingpositions_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .mylibrary()
            .readingpositions_get(opt.value_of("volume-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _mylibrary_readingpositions_set_position(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.mylibrary().readingpositions_set_position(
            opt.value_of("volume-id").unwrap_or(""),
            opt.value_of("position").unwrap_or(""),
            opt.value_of("timestamp").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["action", "content-version", "device-cookie", "source"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _notification_get(
        ...
        let mut call = self
            .hub
            .notification()
            .get(opt.value_of("notification-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _onboarding_list_categories(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _onboarding_list_category_volumes(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            match key {
                ...
                "page-size" => {
                    call = call.page_size(
                        value
                            .map(|v| arg_from_str(v, err, "page-size", "uint32"))
                            .unwrap_or(0),
                    );
                }
    ...
    async fn _personalizedstream_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["locale", "max-allowed-maturity-rating", "source"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _series_membership_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .series()
            .membership_get(opt.value_of("series-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _volumes_associated_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .volumes()
            .associated_list(opt.value_of("volume-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _volumes_get(
        ...
        let mut call = self
            .hub
            .volumes()
            .get(opt.value_of("volume-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            .iter()
        {
            ...
            match key {
                "user-library-consistent-read" => {
                    call = call.user_library_consistent_read(
                        value
                            .map(|v| {
                                arg_from_str(v, err, "user-library-consistent-read", "boolean")
                            })
                            .unwrap_or(false),
                    );
                }
    ...
    async fn _volumes_mybooks_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _volumes_recommended_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _volumes_recommended_rate(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _volumes_useruploaded_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _doit(
        ...
        match self.opt.subcommand() {
            ("bookshelves", Some(opt)) => match opt.subcommand() {
                ("get", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("bookshelves".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("cloudloading", Some(opt)) => match opt.subcommand() {
                ("add-book", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("cloudloading".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("dictionary", Some(opt)) => match opt.subcommand() {
                ("list-offline-metadata", Some(opt)) => {
                    call_result = self
                        ._dictionary_list_offline_metadata(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("dictionary".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("familysharing", Some(opt)) => match opt.subcommand() {
                ("get-family-info", Some(opt)) => {
                    call_result = self
                        ._familysharing_get_family_info(opt, dry_run, &mut err)
                        .await;
                }
                ("share", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("familysharing".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("layers", Some(opt)) => match opt.subcommand() {
                ("annotation-data-get", Some(opt)) => {
                    call_result = self
                        ._layers_annotation_data_get(opt, dry_run, &mut err)
                        .await;
                }
                ("annotation-data-list", Some(opt)) => {
                    call_result = self
                        ._layers_annotation_data_list(opt, dry_run, &mut err)
                        .await;
                }
                ("get", Some(opt)) => {
                ...
                ("volume-annotations-get", Some(opt)) => {
                    call_result = self
                        ._layers_volume_annotations_get(opt, dry_run, &mut err)
                        .await;
                }
                ("volume-annotations-list", Some(opt)) => {
                    call_result = self
                        ._layers_volume_annotations_list(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("layers".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("myconfig", Some(opt)) => match opt.subcommand() {
                ("get-user-settings", Some(opt)) => {
                    call_result = self
                        ._myconfig_get_user_settings(opt, dry_run, &mut err)
                        .await;
                }
                ("release-download-access", Some(opt)) => {
                    call_result = self
                        ._myconfig_release_download_access(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("sync-volume-licenses", Some(opt)) => {
                    call_result = self
                        ._myconfig_sync_volume_licenses(opt, dry_run, &mut err)
                        .await;
                }
                ("update-user-settings", Some(opt)) => {
                    call_result = self
                        ._myconfig_update_user_settings(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("myconfig".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("mylibrary", Some(opt)) => match opt.subcommand() {
                ("annotations-delete", Some(opt)) => {
                    call_result = self
                        ._mylibrary_annotations_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("annotations-insert", Some(opt)) => {
                    call_result = self
                        ._mylibrary_annotations_insert(opt, dry_run, &mut err)
                        .await;
                }
                ("annotations-list", Some(opt)) => {
                    call_result = self
                        ._mylibrary_annotations_list(opt, dry_run, &mut err)
                        .await;
                }
                ("annotations-summary", Some(opt)) => {
                    call_result = self
                        ._mylibrary_annotations_summary(opt, dry_run, &mut err)
                        .await;
                }
                ("annotations-update", Some(opt)) => {
                    call_result = self
                        ._mylibrary_annotations_update(opt, dry_run, &mut err)
                        .await;
                }
                ("bookshelves-add-volume", Some(opt)) => {
                    call_result = self
                        ._mylibrary_bookshelves_add_volume(opt, dry_run, &mut err)
                        .await;
                }
                ("bookshelves-clear-volumes", Some(opt)) => {
                    call_result = self
                        ._mylibrary_bookshelves_clear_volumes(opt, dry_run, &mut err)
                        .await;
                }
                ("bookshelves-get", Some(opt)) => {
                    call_result = self
                        ._mylibrary_bookshelves_get(opt, dry_run, &mut err)
                        .await;
                }
                ("bookshelves-list", Some(opt)) => {
                    call_result = self
                        ._mylibrary_bookshelves_list(opt, dry_run, &mut err)
                        .await;
                }
                ("bookshelves-move-volume", Some(opt)) => {
                    call_result = self
                        ._mylibrary_bookshelves_move_volume(opt, dry_run, &mut err)
                        .await;
                }
                ("bookshelves-remove-volume", Some(opt)) => {
                    call_result = self
                        ._mylibrary_bookshelves_remove_volume(opt, dry_run, &mut err)
                        .await;
                }
                ("bookshelves-volumes-list", Some(opt)) => {
                    call_result = self
                        ._mylibrary_bookshelves_volumes_list(opt, dry_run, &mut err)
                        .await;
                }
                ("readingpositions-get", Some(opt)) => {
                    call_result = self
                        ._mylibrary_readingpositions_get(opt, dry_run, &mut err)
                        .await;
                }
                ("readingpositions-set-position", Some(opt)) => {
                    call_result = self
                        ._mylibrary_readingpositions_set_position(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("mylibrary".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("notification", Some(opt)) => match opt.subcommand() {
                ("get", Some(opt)) => {
                    call_result = self._notification_get(opt, dry_run, &mut err).await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("notification".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("onboarding", Some(opt)) => match opt.subcommand() {
                ("list-categories", Some(opt)) => {
                    call_result = self
                        ._onboarding_list_categories(opt, dry_run, &mut err)
                        .await;
                }
                ("list-category-volumes", Some(opt)) => {
                    call_result = self
                        ._onboarding_list_category_volumes(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("onboarding".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("personalizedstream", Some(opt)) => match opt.subcommand() {
                ("get", Some(opt)) => {
                    call_result = self._personalizedstream_get(opt, dry_run, &mut err).await;
                }
                _ => {
                    err.issues.push(CLIError::MissingMethodError(
                        "personalizedstream".to_string(),
                    ));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("promooffer", Some(opt)) => match opt.subcommand() {
                ("accept", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("promooffer".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("series", Some(opt)) => match opt.subcommand() {
                ("get", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("series".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("volumes", Some(opt)) => match opt.subcommand() {
                ...
                ("useruploaded-list", Some(opt)) => {
                    call_result = self
                        ._volumes_useruploaded_list(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("volumes".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            _ => {
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "books1-secret.json",
