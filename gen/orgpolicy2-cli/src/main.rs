...
use google_orgpolicy2::{api, yup_oauth2, Error};
...
{
    async fn _folders_constraints_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        ...
        let mut call = self
            .hub
            .folders()
            .constraints_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _folders_policies_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "alternate.spec.inherit-from-parent" => Some((
                    "alternate.spec.inheritFromParent",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "alternate.spec.reset" => Some((
                    "alternate.spec.reset",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "alternate.spec.update-time" => Some((
                    "alternate.spec.updateTime",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "dry-run-spec.etag" => Some((
                    "dryRunSpec.etag",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                ...
                "dry-run-spec.inherit-from-parent" => Some((
                ...
                "dry-run-spec.update-time" => Some((
                    "dryRunSpec.updateTime",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
        ...
        let mut request: api::GoogleCloudOrgpolicyV2Policy =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .folders()
            .policies_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _folders_policies_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _folders_policies_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _folders_policies_get_effective_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .folders()
            .policies_get_effective_policy(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _folders_policies_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _folders_policies_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _organizations_constraints_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _organizations_custom_constraints_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::GoogleCloudOrgpolicyV2CustomConstraint =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .organizations()
            .custom_constraints_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _organizations_custom_constraints_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .organizations()
            .custom_constraints_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _organizations_custom_constraints_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .organizations()
            .custom_constraints_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _organizations_custom_constraints_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .organizations()
            .custom_constraints_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _organizations_custom_constraints_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .organizations()
            .custom_constraints_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _organizations_policies_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _organizations_policies_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _organizations_policies_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _organizations_policies_get_effective_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _organizations_policies_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _organizations_policies_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_constraints_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_policies_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_policies_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_policies_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_policies_get_effective_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_policies_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_policies_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _doit(
        ...
        match self.opt.subcommand() {
            ("folders", Some(opt)) => match opt.subcommand() {
                ("constraints-list", Some(opt)) => {
                    call_result = self._folders_constraints_list(opt, dry_run, &mut err).await;
                }
                ("policies-create", Some(opt)) => {
                    call_result = self._folders_policies_create(opt, dry_run, &mut err).await;
                }
                ("policies-delete", Some(opt)) => {
                    call_result = self._folders_policies_delete(opt, dry_run, &mut err).await;
                }
                ("policies-get", Some(opt)) => {
                    call_result = self._folders_policies_get(opt, dry_run, &mut err).await;
                }
                ("policies-get-effective-policy", Some(opt)) => {
                    call_result = self
                        ._folders_policies_get_effective_policy(opt, dry_run, &mut err)
                        .await;
                }
                ("policies-list", Some(opt)) => {
                    call_result = self._folders_policies_list(opt, dry_run, &mut err).await;
                }
                ("policies-patch", Some(opt)) => {
                    call_result = self._folders_policies_patch(opt, dry_run, &mut err).await;
                }
                _ => {
                    err.issues
            ...
            ("organizations", Some(opt)) => match opt.subcommand() {
                ("constraints-list", Some(opt)) => {
                    call_result = self
                        ._organizations_constraints_list(opt, dry_run, &mut err)
                        .await;
                }
                ("custom-constraints-create", Some(opt)) => {
                    call_result = self
                        ._organizations_custom_constraints_create(opt, dry_run, &mut err)
                        .await;
                }
                ("custom-constraints-delete", Some(opt)) => {
                    call_result = self
                        ._organizations_custom_constraints_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("custom-constraints-get", Some(opt)) => {
                    call_result = self
                        ._organizations_custom_constraints_get(opt, dry_run, &mut err)
                        .await;
                }
                ("custom-constraints-list", Some(opt)) => {
                    call_result = self
                        ._organizations_custom_constraints_list(opt, dry_run, &mut err)
                        .await;
                }
                ("custom-constraints-patch", Some(opt)) => {
                    call_result = self
                        ._organizations_custom_constraints_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("policies-create", Some(opt)) => {
                    call_result = self
                        ._organizations_policies_create(opt, dry_run, &mut err)
                        .await;
                }
                ("policies-delete", Some(opt)) => {
                    call_result = self
                        ._organizations_policies_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("policies-get", Some(opt)) => {
                    call_result = self
                        ._organizations_policies_get(opt, dry_run, &mut err)
                        .await;
                }
                ("policies-get-effective-policy", Some(opt)) => {
                    call_result = self
                        ._organizations_policies_get_effective_policy(opt, dry_run, &mut err)
                        .await;
                }
                ("policies-list", Some(opt)) => {
                    call_result = self
                        ._organizations_policies_list(opt, dry_run, &mut err)
                        .await;
                }
                ("policies-patch", Some(opt)) => {
                    call_result = self
                        ._organizations_policies_patch(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
            ...
            ("projects", Some(opt)) => match opt.subcommand() {
                ("constraints-list", Some(opt)) => {
                    call_result = self
                        ._projects_constraints_list(opt, dry_run, &mut err)
                        .await;
                }
                ("policies-create", Some(opt)) => {
                    call_result = self._projects_policies_create(opt, dry_run, &mut err).await;
                }
                ("policies-delete", Some(opt)) => {
                    call_result = self._projects_policies_delete(opt, dry_run, &mut err).await;
                }
                ("policies-get", Some(opt)) => {
                    call_result = self._projects_policies_get(opt, dry_run, &mut err).await;
                }
                ("policies-get-effective-policy", Some(opt)) => {
                    call_result = self
                        ._projects_policies_get_effective_policy(opt, dry_run, &mut err)
                        .await;
                }
                ("policies-list", Some(opt)) => {
                    call_result = self._projects_policies_list(opt, dry_run, &mut err).await;
                }
                ("policies-patch", Some(opt)) => {
                    call_result = self._projects_policies_patch(opt, dry_run, &mut err).await;
                }
                _ => {
                    err.issues
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "orgpolicy2-secret.json",
        ...
        let engine = Engine {
            opt,
            hub: api::OrgPolicyAPI::new(client, auth),
            gp: vec![
                "$-xgafv",
                "access-token",
                "alt",
        ...
        ("folders", "methods: 'constraints-list', 'policies-create', 'policies-delete', 'policies-get', 'policies-get-effective-policy', 'policies-list' and 'policies-patch'", vec![
            ...
            ("custom-constraints-create",
                  ...
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. Must be in the following form: * `organizations/{organization_id}`"##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
