...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/mybusinessnotifications1).
//! # Features
//!
//! Handle the following *Resources* with ease from the central [hub](MyBusinessNotificationSettings) ...
//!
//! * accounts
//!  * [*get notification setting*](api::AccountGetNotificationSettingCall) and [*update notification setting*](api::AccountUpdateNotificationSettingCall)
//!
//!
//!
//!
...
//!
//! * **[Hub](MyBusinessNotificationSettings)**
...
pub mod api;
pub use api::MyBusinessNotificationSettings;
