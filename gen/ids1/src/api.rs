...
impl<'a, C> ProjectMethods<'a, C> {
    ...
    pub fn locations_endpoints_get_iam_policy(
        &self,
        resource: &str,
    ) -> ProjectLocationEndpointGetIamPolicyCall<'a, C> {
    ...
    pub fn locations_endpoints_set_iam_policy(
        &self,
        request: SetIamPolicyRequest,
        resource: &str,
    ) -> ProjectLocationEndpointSetIamPolicyCall<'a, C> {
    ...
    pub fn locations_endpoints_test_iam_permissions(
        &self,
        request: TestIamPermissionsRequest,
        resource: &str,
    ) -> ProjectLocationEndpointTestIamPermissionCall<'a, C> {
...
/// # }
/// ```
pub struct ProjectLocationEndpointGetIamPolicyCall<'a, C>
where
    C: 'a,
{
    hub: &'a IDS<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationEndpointGetIamPolicyCall<'a, C> {}

impl<'a, C> ProjectLocationEndpointGetIamPolicyCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn resource(mut self, new_value: &str) -> ProjectLocationEndpointGetIamPolicyCall<'a, C> {
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationEndpointGetIamPolicyCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationEndpointGetIamPolicyCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationEndpointGetIamPolicyCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationEndpointGetIamPolicyCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationEndpointSetIamPolicyCall<'a, C>
where
    C: 'a,
{
    hub: &'a IDS<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationEndpointSetIamPolicyCall<'a, C> {}

impl<'a, C> ProjectLocationEndpointSetIamPolicyCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn resource(mut self, new_value: &str) -> ProjectLocationEndpointSetIamPolicyCall<'a, C> {
        self._resource = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationEndpointSetIamPolicyCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationEndpointSetIamPolicyCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationEndpointSetIamPolicyCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationEndpointSetIamPolicyCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationEndpointTestIamPermissionCall<'a, C>
where
    C: 'a,
{
    hub: &'a IDS<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationEndpointTestIamPermissionCall<'a, C> {}

impl<'a, C> ProjectLocationEndpointTestIamPermissionCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationEndpointTestIamPermissionCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationEndpointTestIamPermissionCall<'a, C> {
        self._scopes.clear();
        self
    }
}
