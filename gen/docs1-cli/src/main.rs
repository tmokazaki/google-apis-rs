...
use google_docs1::{api, yup_oauth2, Error};
...
{
    async fn _documents_batch_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
            ...
            .iter()
        {
            ...
            {
                "write-control.required-revision-id" => Some((
                ...
                "write-control.target-revision-id" => Some((
        ...
        let mut request: api::BatchUpdateDocumentRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .documents()
            .batch_update(request, opt.value_of("document-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _documents_create(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "document-style.background.color.color.rgb-color.blue" => Some((
                    "documentStyle.background.color.color.rgbColor.blue",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "document-style.background.color.color.rgb-color.green" => Some((
                    "documentStyle.background.color.color.rgbColor.green",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "document-style.background.color.color.rgb-color.red" => Some((
                    "documentStyle.background.color.color.rgbColor.red",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "document-style.default-footer-id" => Some((
                ...
                "document-style.default-header-id" => Some((
                ...
                "document-style.even-page-header-id" => Some((
                    "documentStyle.evenPageHeaderId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "document-style.first-page-footer-id" => Some((
                ...
                "document-style.first-page-header-id" => Some((
                ...
                "document-style.flip-page-orientation" => Some((
                    "documentStyle.flipPageOrientation",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "document-style.margin-bottom.magnitude" => Some((
                    "documentStyle.marginBottom.magnitude",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "document-style.margin-bottom.unit" => Some((
                    "documentStyle.marginBottom.unit",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "document-style.margin-footer.magnitude" => Some((
                    "documentStyle.marginFooter.magnitude",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "document-style.margin-footer.unit" => Some((
                    "documentStyle.marginFooter.unit",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "document-style.margin-header.magnitude" => Some((
                    "documentStyle.marginHeader.magnitude",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "document-style.margin-header.unit" => Some((
                    "documentStyle.marginHeader.unit",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "document-style.margin-left.magnitude" => Some((
                    "documentStyle.marginLeft.magnitude",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "document-style.margin-left.unit" => Some((
                    "documentStyle.marginLeft.unit",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "document-style.margin-right.magnitude" => Some((
                    "documentStyle.marginRight.magnitude",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "document-style.margin-right.unit" => Some((
                    "documentStyle.marginRight.unit",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "document-style.margin-top.magnitude" => Some((
                    "documentStyle.marginTop.magnitude",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "document-style.margin-top.unit" => Some((
                    "documentStyle.marginTop.unit",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "document-style.page-number-start" => Some((
                    "documentStyle.pageNumberStart",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                )),
                "document-style.page-size.height.magnitude" => Some((
                    "documentStyle.pageSize.height.magnitude",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "document-style.page-size.height.unit" => Some((
                    "documentStyle.pageSize.height.unit",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "document-style.page-size.width.magnitude" => Some((
                    "documentStyle.pageSize.width.magnitude",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "document-style.page-size.width.unit" => Some((
                    "documentStyle.pageSize.width.unit",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "document-style.use-custom-header-footer-margins" => Some((
                    "documentStyle.useCustomHeaderFooterMargins",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "document-style.use-even-page-header-footer" => Some((
                ...
                "document-style.use-first-page-header-footer" => Some((
        ...
        let mut call = self.hub.documents().create(request);
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _documents_get(
        ...
        let mut call = self
            .hub
            .documents()
            .get(opt.value_of("document-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "docs1-secret.json",
        ...
        ("documents", "methods: 'batch-update', 'create' and 'get'", vec![
            ("batch-update",
                  ...
                  vec![
                    (Some(r##"document-id"##),
                     None,
                     Some(r##"The ID of the document to update."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("get",
                    Some(r##"Gets the latest version of the specified document."##),
                    "Details at http://byron.github.io/google-apis-rs/google_docs1_cli/documents_get",
                  vec![
                    (Some(r##"document-id"##),
                     None,
                     Some(r##"The ID of the document to retrieve."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
