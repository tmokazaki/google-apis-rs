...
use google_deploymentmanager2::{api, yup_oauth2, Error};
...
{
    async fn _deployments_cancel_preview(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        ...
        let mut request: api::DeploymentsCancelPreviewRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.deployments().cancel_preview(
            request,
            opt.value_of("project").unwrap_or(""),
            opt.value_of("deployment").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _deployments_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.deployments().delete(
            opt.value_of("project").unwrap_or(""),
            opt.value_of("deployment").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _deployments_get(
        ...
        let mut call = self.hub.deployments().get(
            opt.value_of("project").unwrap_or(""),
            opt.value_of("deployment").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _deployments_get_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.deployments().get_iam_policy(
            opt.value_of("project").unwrap_or(""),
    ...
    async fn _deployments_insert(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "operation.client-operation-id" => Some((
                ...
                "operation.creation-timestamp" => Some((
                ...
                "operation.http-error-status-code" => Some((
                ...
                "operation.operation-group-id" => Some((
                ...
                "operation.set-common-instance-metadata-operation-metadata.client-operation-id" => {
                    Some((
                        "operation.setCommonInstanceMetadataOperationMetadata.clientOperationId",
                        JsonTypeInfo {
                            jtype: JsonType::String,
                            ctype: ComplexType::Pod,
                        },
        ...
        let mut request: api::Deployment = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .deployments()
            ...
            .iter()
        {
            ...
            match key {
                "preview" => {
                    call = call.preview(
                        value
                            .map(|v| arg_from_str(v, err, "preview", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "create-policy" => {
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["filter", "max-results", "order-by", "page-token"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _deployments_patch(
        ...
        let mut request: api::Deployment = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.deployments().patch(
            request,
            opt.value_of("project").unwrap_or(""),
            opt.value_of("deployment").unwrap_or(""),
        );
    ...
    async fn _deployments_set_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::GlobalSetPolicyRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.deployments().set_iam_policy(
            request,
            opt.value_of("project").unwrap_or(""),
            opt.value_of("resource").unwrap_or(""),
        );
    ...
    async fn _deployments_stop(
        ...
        let mut request: api::DeploymentsStopRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.deployments().stop(
            request,
            opt.value_of("project").unwrap_or(""),
            opt.value_of("deployment").unwrap_or(""),
        );
    ...
    async fn _deployments_test_iam_permissions(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::TestPermissionsRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.deployments().test_iam_permissions(
            request,
            opt.value_of("project").unwrap_or(""),
            opt.value_of("resource").unwrap_or(""),
        );
    ...
    async fn _deployments_update(
        ...
        let mut request: api::Deployment = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.deployments().update(
            request,
            opt.value_of("project").unwrap_or(""),
            opt.value_of("deployment").unwrap_or(""),
        );
    ...
    async fn _manifests_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.manifests().get(
            opt.value_of("project").unwrap_or(""),
            opt.value_of("deployment").unwrap_or(""),
            opt.value_of("manifest").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _manifests_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.manifests().list(
            opt.value_of("project").unwrap_or(""),
            opt.value_of("deployment").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _resources_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.resources().get(
            opt.value_of("project").unwrap_or(""),
            opt.value_of("deployment").unwrap_or(""),
            opt.value_of("resource").unwrap_or(""),
        );
    ...
    async fn _resources_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.resources().list(
            opt.value_of("project").unwrap_or(""),
            opt.value_of("deployment").unwrap_or(""),
        );
        for parg in opt
        ...
        match self.opt.subcommand() {
            ("deployments", Some(opt)) => match opt.subcommand() {
                ("cancel-preview", Some(opt)) => {
                    call_result = self
                        ._deployments_cancel_preview(opt, dry_run, &mut err)
                        .await;
                }
                ("delete", Some(opt)) => {
                ...
                ("get-iam-policy", Some(opt)) => {
                    call_result = self
                        ._deployments_get_iam_policy(opt, dry_run, &mut err)
                        .await;
                }
                ("insert", Some(opt)) => {
                ...
                ("set-iam-policy", Some(opt)) => {
                    call_result = self
                        ._deployments_set_iam_policy(opt, dry_run, &mut err)
                        .await;
                }
                ("stop", Some(opt)) => {
                ...
                ("test-iam-permissions", Some(opt)) => {
                    call_result = self
                        ._deployments_test_iam_permissions(opt, dry_run, &mut err)
                        .await;
                }
                ("update", Some(opt)) => {
            ...
            ("manifests", Some(opt)) => match opt.subcommand() {
                ("get", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("manifests".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ...
            ("resources", Some(opt)) => match opt.subcommand() {
                ("get", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("resources".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("types", Some(opt)) => match opt.subcommand() {
                ("list", Some(opt)) => {
                    call_result = self._types_list(opt, dry_run, &mut err).await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("types".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            _ => {
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "deploymentmanager2-secret.json",
...
async fn main() {
    ...
    let arg_data = [
        ("deployments", "methods: 'cancel-preview', 'delete', 'get', 'get-iam-policy', 'insert', 'list', 'patch', 'set-iam-policy', 'stop', 'test-iam-permissions' and 'update'", vec![
            ("cancel-preview",
                    Some(r##"Cancels and removes the preview currently associated with the deployment."##),
                    "Details at http://byron.github.io/google-apis-rs/google_deploymentmanager2_cli/deployments_cancel-preview",
                  vec![
                    (Some(r##"project"##),
                     None,
                    ...
                    (Some(r##"deployment"##),
                     None,
                     Some(r##"The name of the deployment for this request."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("delete",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_deploymentmanager2_cli/deployments_delete",
                  vec![
                    (Some(r##"project"##),
                     None,
                     Some(r##"The project ID for this request."##),
            ...
            ("get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_deploymentmanager2_cli/deployments_get",
                  vec![
                    (Some(r##"project"##),
                     None,
                     Some(r##"The project ID for this request."##),
            ...
            ("get-iam-policy",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_deploymentmanager2_cli/deployments_get-iam-policy",
                  vec![
                    (Some(r##"project"##),
                     None,
            ...
            ("insert",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_deploymentmanager2_cli/deployments_insert",
                  vec![
                    (Some(r##"project"##),
                     None,
                     Some(r##"The project ID for this request."##),
            ...
            ("list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_deploymentmanager2_cli/deployments_list",
                  vec![
                    (Some(r##"project"##),
                     None,
                     Some(r##"The project ID for this request."##),
            ...
            ("set-iam-policy",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_deploymentmanager2_cli/deployments_set-iam-policy",
                  vec![
                    (Some(r##"project"##),
                     None,
                     Some(r##"Project ID for this request."##),
            ...
            ("stop",
                    Some(r##"Stops an ongoing operation. This does not roll back any work that has already been completed, but prevents any new work from being started."##),
                    "Details at http://byron.github.io/google-apis-rs/google_deploymentmanager2_cli/deployments_stop",
                  vec![
                    (Some(r##"project"##),
                     None,
                     Some(r##"The project ID for this request."##),
            ...
            ("test-iam-permissions",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_deploymentmanager2_cli/deployments_test-iam-permissions",
                  vec![
                    (Some(r##"project"##),
                     None,
                     Some(r##"Project ID for this request."##),
            ...
            ("update",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_deploymentmanager2_cli/deployments_update",
                  vec![
                    (Some(r##"project"##),
                     None,
                     Some(r##"The project ID for this request."##),
            ...
            ("get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_deploymentmanager2_cli/manifests_get",
                  vec![
                    (Some(r##"project"##),
                     None,
                     Some(r##"The project ID for this request."##),
                    ...
                    (Some(r##"manifest"##),
                     None,
                     Some(r##"The name of the manifest for this request."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_deploymentmanager2_cli/manifests_list",
                  vec![
                    (Some(r##"project"##),
                     None,
                     Some(r##"The project ID for this request."##),
            ...
            ("get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_deploymentmanager2_cli/operations_get",
                  vec![
                    (Some(r##"project"##),
                     None,
                     Some(r##"The project ID for this request."##),
                    ...
                    (Some(r##"operation"##),
                     None,
                     Some(r##"The name of the operation for this request."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_deploymentmanager2_cli/operations_list",
                  vec![
                    (Some(r##"project"##),
                     None,
                     Some(r##"The project ID for this request."##),
            ...
            ("get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_deploymentmanager2_cli/resources_get",
                  vec![
                    (Some(r##"project"##),
                     None,
                     Some(r##"The project ID for this request."##),
                    ...
                    (Some(r##"resource"##),
                     None,
                     Some(r##"The name of the resource for this request."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_deploymentmanager2_cli/resources_list",
                  vec![
                    (Some(r##"project"##),
                     None,
                     Some(r##"The project ID for this request."##),
            ...
            ("list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_deploymentmanager2_cli/types_list",
                  vec![
                    (Some(r##"project"##),
                     None,
                     Some(r##"The project ID for this request."##),
