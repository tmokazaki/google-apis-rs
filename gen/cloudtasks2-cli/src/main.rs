...
use google_cloudtasks2::{api, yup_oauth2, Error};
    ...
    C: apis_common::Connector,
{
    ...
    async fn _projects_locations_queues_create(
            ...
            .iter()
        {
            ...
            {
                "app-engine-routing-override.host" => Some((
                ...
                "app-engine-routing-override.instance" => Some((
                    "appEngineRoutingOverride.instance",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "app-engine-routing-override.service" => Some((
                    "appEngineRoutingOverride.service",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "app-engine-routing-override.version" => Some((
                    "appEngineRoutingOverride.version",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                ...
                "rate-limits.max-concurrent-dispatches" => Some((
                ...
                "rate-limits.max-dispatches-per-second" => Some((
                ...
                "stackdriver-logging-config.sampling-ratio" => Some((
    ...
    async fn _projects_locations_queues_tasks_create(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "task.app-engine-http-request.body" => Some((
                ...
                "task.app-engine-http-request.relative-uri" => Some((
                    "task.appEngineHttpRequest.relativeUri",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                ...
                "task.first-attempt.dispatch-time" => Some((
                    "task.firstAttempt.dispatchTime",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "task.first-attempt.response-status.code" => Some((
                    "task.firstAttempt.responseStatus.code",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                )),
                "task.first-attempt.response-status.message" => Some((
                    "task.firstAttempt.responseStatus.message",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "task.first-attempt.response-time" => Some((
                    "task.firstAttempt.responseTime",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "task.first-attempt.schedule-time" => Some((
                    "task.firstAttempt.scheduleTime",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                ...
                "task.last-attempt.dispatch-time" => Some((
                    "task.lastAttempt.dispatchTime",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "task.last-attempt.response-status.code" => Some((
                    "task.lastAttempt.responseStatus.code",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                )),
                "task.last-attempt.response-status.message" => Some((
                ...
                "task.last-attempt.response-time" => Some((
                    "task.lastAttempt.responseTime",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "task.last-attempt.schedule-time" => Some((
                    "task.lastAttempt.scheduleTime",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "cloudtasks2-secret.json",
        ...
        .persist_tokens_to_disk(format!("{}/cloudtasks2", config_dir))
        .build()
        .await
        .unwrap();
    ...
    let arg_data = [
        ("projects", "methods: 'locations-get', 'locations-get-cmek-config', 'locations-list', 'locations-queues-create', 'locations-queues-delete', 'locations-queues-get', 'locations-queues-get-iam-policy', 'locations-queues-list', 'locations-queues-patch', 'locations-queues-pause', 'locations-queues-purge', 'locations-queues-resume', 'locations-queues-set-iam-policy', 'locations-queues-tasks-buffer', 'locations-queues-tasks-create', 'locations-queues-tasks-delete', 'locations-queues-tasks-get', 'locations-queues-tasks-list', 'locations-queues-tasks-run', 'locations-queues-test-iam-permissions' and 'locations-update-cmek-config'", vec![
            ("locations-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_cloudtasks2_cli/projects_locations-get",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-get-cmek-config",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_cloudtasks2_cli/projects_locations-get-cmek-config",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_cloudtasks2_cli/projects_locations-list",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-queues-create",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_cloudtasks2_cli/projects_locations-queues-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("locations-queues-delete",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_cloudtasks2_cli/projects_locations-queues-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-queues-get",
                    Some(r##"Gets a queue."##),
                    "Details at http://byron.github.io/google-apis-rs/google_cloudtasks2_cli/projects_locations-queues-get",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-queues-get-iam-policy",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_cloudtasks2_cli/projects_locations-queues-get-iam-policy",
                  vec![
                    (Some(r##"resource"##),
                     None,
            ...
            ("locations-queues-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_cloudtasks2_cli/projects_locations-queues-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("locations-queues-patch",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_cloudtasks2_cli/projects_locations-queues-patch",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-queues-pause",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_cloudtasks2_cli/projects_locations-queues-pause",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-queues-purge",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_cloudtasks2_cli/projects_locations-queues-purge",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The queue name. For example: `projects/PROJECT_ID/location/LOCATION_ID/queues/QUEUE_ID`"##),
            ...
            ("locations-queues-resume",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_cloudtasks2_cli/projects_locations-queues-resume",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The queue name. For example: `projects/PROJECT_ID/location/LOCATION_ID/queues/QUEUE_ID`"##),
            ...
            ("locations-queues-set-iam-policy",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_cloudtasks2_cli/projects_locations-queues-set-iam-policy",
                  vec![
                    (Some(r##"resource"##),
                     None,
            ...
            ("locations-queues-tasks-buffer",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_cloudtasks2_cli/projects_locations-queues-tasks-buffer",
                  vec![
                    (Some(r##"queue"##),
                     None,
                    ...
                    (Some(r##"task-id"##),
                     None,
                     Some(r##"Optional. Task ID for the task being created. If not provided, Cloud Tasks generates an ID for the task."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("locations-queues-tasks-create",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_cloudtasks2_cli/projects_locations-queues-tasks-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("locations-queues-tasks-delete",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_cloudtasks2_cli/projects_locations-queues-tasks-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-queues-tasks-get",
                    Some(r##"Gets a task."##),
                    "Details at http://byron.github.io/google-apis-rs/google_cloudtasks2_cli/projects_locations-queues-tasks-get",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The task name. For example: `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID/tasks/TASK_ID`"##),
            ...
            ("locations-queues-tasks-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_cloudtasks2_cli/projects_locations-queues-tasks-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The queue name. For example: `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID`"##),
            ...
            ("locations-queues-tasks-run",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_cloudtasks2_cli/projects_locations-queues-tasks-run",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The task name. For example: `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID/tasks/TASK_ID`"##),
            ...
            ("locations-queues-test-iam-permissions",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_cloudtasks2_cli/projects_locations-queues-test-iam-permissions",
                  vec![
                    (Some(r##"resource"##),
                     None,
            ...
            ("locations-update-cmek-config",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_cloudtasks2_cli/projects_locations-update-cmek-config",
                  vec![
                    (Some(r##"name"##),
                     None,
