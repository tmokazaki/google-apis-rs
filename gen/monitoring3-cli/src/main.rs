...
use google_monitoring3::{api, yup_oauth2, Error};
...
{
    async fn _folders_time_series_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        ...
        let mut call = self
            .hub
            .folders()
            .time_series_list(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            .iter()
        {
            ...
            match key {
                ...
                "secondary-aggregation-alignment-period" => {
                    call = call.secondary_aggregation_alignment_period(
                        value
                            .map(|v| {
                                arg_from_str(
                                    v,
                ...
                "interval-start-time" => {
                    call = call.interval_start_time(
                        value
                            .map(|v| arg_from_str(v, err, "interval-start-time", "google-datetime"))
                            .unwrap_or(chrono::Utc::now()),
                    );
                }
                "interval-end-time" => {
                    call = call.interval_end_time(
                        value
                            .map(|v| arg_from_str(v, err, "interval-end-time", "google-datetime"))
                            .unwrap_or(chrono::Utc::now()),
                    );
                }
                "filter" => {
                ...
                "aggregation-alignment-period" => {
                    call = call.aggregation_alignment_period(
                        value
                            .map(|v| {
                                arg_from_str(
                                    v,
    ...
    async fn _organizations_time_series_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_alert_policies_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            {
                "alert-strategy.auto-close" => Some((
                ...
                "creation-record.mutate-time" => Some((
                ...
                "creation-record.mutated-by" => Some((
                ...
                "mutation-record.mutate-time" => Some((
                ...
                "mutation-record.mutated-by" => Some((
        ...
        let mut request: api::AlertPolicy = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .alert_policies_create(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_alert_policies_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .alert_policies_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_alert_policies_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .alert_policies_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_alert_policies_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .alert_policies_list(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_alert_policies_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .alert_policies_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_collectd_time_series_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec!["collectd-version", "labels", "resource", "type"],
                    );
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
        ...
        let mut request: api::CreateCollectdTimeSeriesRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .collectd_time_series_create(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_groups_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .groups_create(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_groups_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .groups_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            .iter()
        {
            ...
            match key {
                "recursive" => {
                    call = call.recursive(
                        value
                            .map(|v| arg_from_str(v, err, "recursive", "boolean"))
                            .unwrap_or(false),
                    );
                }
                _ => {
    ...
    async fn _projects_groups_get(
        ...
        let mut call = self
            .hub
            .projects()
            .groups_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_groups_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .groups_list(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            .iter()
        {
            ...
            match key {
                ...
                "children-of-group" => {
                    call = call.children_of_group(value.unwrap_or(""));
                }
                "ancestors-of-group" => {
                    call = call.ancestors_of_group(value.unwrap_or(""));
                }
                _ => {
                    let mut found = false;
                    for param in &self.gp {
    ...
    async fn _projects_groups_members_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .groups_members_list(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_groups_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .groups_update(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_metric_descriptors_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::MetricDescriptor = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .metric_descriptors_create(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_metric_descriptors_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .metric_descriptors_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_metric_descriptors_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .metric_descriptors_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_metric_descriptors_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .metric_descriptors_list(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_monitored_resource_descriptors_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .monitored_resource_descriptors_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_monitored_resource_descriptors_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .monitored_resource_descriptors_list(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_notification_channel_descriptors_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .notification_channel_descriptors_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_notification_channel_descriptors_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .notification_channel_descriptors_list(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_notification_channels_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::NotificationChannel = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .notification_channels_create(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_notification_channels_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .notification_channels_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_notification_channels_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .notification_channels_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_notification_channels_get_verification_code(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(key, &vec!["expire-time"]);
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
                        value.map(|v| v.to_string()),
        ...
        let mut request: api::GetNotificationChannelVerificationCodeRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .notification_channels_get_verification_code(
                request,
    ...
    async fn _projects_notification_channels_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .notification_channels_list(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_notification_channels_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .notification_channels_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_notification_channels_send_verification_code(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::SendNotificationChannelVerificationCodeRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
    ...
    async fn _projects_notification_channels_verify(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(key, &vec!["code"]);
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
                        value.map(|v| v.to_string()),
        ...
        let mut request: api::VerifyNotificationChannelRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .notification_channels_verify(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_snoozes_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::Snooze = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .snoozes_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_snoozes_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .snoozes_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_snoozes_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .snoozes_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_snoozes_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .snoozes_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_time_series_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .time_series_create(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_time_series_create_service(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .time_series_create_service(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_time_series_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_time_series_query(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::QueryTimeSeriesRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .time_series_query(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_uptime_check_configs_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "http-check.auth-info.password" => Some((
                ...
                "http-check.auth-info.username" => Some((
                ...
                "http-check.custom-content-type" => Some((
                ...
                "http-check.ping-config.pings-count" => Some((
                    "httpCheck.pingConfig.pingsCount",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                )),
                "http-check.port" => Some((
                    "httpCheck.port",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                ...
                "http-check.request-method" => Some((
                ...
                "http-check.service-agent-authentication.type" => Some((
                    "httpCheck.serviceAgentAuthentication.type",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "http-check.use-ssl" => Some((
                    "httpCheck.useSsl",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                ...
                "monitored-resource.labels" => Some((
                ...
                "resource-group.resource-type" => Some((
                ...
                "synthetic-monitor.cloud-function-v2.cloud-run-revision.labels" => Some((
                    "syntheticMonitor.cloudFunctionV2.cloudRunRevision.labels",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Map,
                    },
                )),
                "synthetic-monitor.cloud-function-v2.cloud-run-revision.type" => Some((
                    "syntheticMonitor.cloudFunctionV2.cloudRunRevision.type",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "synthetic-monitor.cloud-function-v2.name" => Some((
                    "syntheticMonitor.cloudFunctionV2.name",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "tcp-check.ping-config.pings-count" => Some((
        ...
        let mut request: api::UptimeCheckConfig = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .uptime_check_configs_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_uptime_check_configs_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .uptime_check_configs_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_uptime_check_configs_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .uptime_check_configs_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_uptime_check_configs_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .uptime_check_configs_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_uptime_check_configs_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .uptime_check_configs_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _services_create(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "basic-service.service-labels" => Some((
                ...
                "basic-service.service-type" => Some((
                ...
                "cluster-istio.cluster-name" => Some((
                ...
                "cluster-istio.service-name" => Some((
                ...
                "cluster-istio.service-namespace" => Some((
                ...
                "gke-namespace.cluster-name" => Some((
                ...
                "gke-namespace.namespace-name" => Some((
                ...
                "gke-service.namespace-name" => Some((
                ...
                "gke-workload.cluster-name" => Some((
                ...
                "gke-workload.namespace-name" => Some((
                ...
                "gke-workload.top-level-controller-name" => Some((
                ...
                "gke-workload.top-level-controller-type" => Some((
                ...
                "istio-canonical-service.canonical-service" => Some((
                ...
                "istio-canonical-service.canonical-service-namespace" => Some((
                ...
                "istio-canonical-service.mesh-uid" => Some((
                ...
                "mesh-istio.service-namespace" => Some((
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        ...
                        &vec![
                            ...
                            "service-type",
                            "telemetry",
                            "top-level-controller-name",
                            "top-level-controller-type",
                            "user-labels",
                        ],
                    );
                    err.issues.push(CLIError::Field(FieldError::Unknown(
    ...
    async fn _services_service_level_objectives_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::ServiceLevelObjective =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .services()
            .service_level_objectives_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _services_service_level_objectives_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .services()
            .service_level_objectives_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _services_service_level_objectives_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .services()
            .service_level_objectives_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _services_service_level_objectives_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .services()
            .service_level_objectives_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _services_service_level_objectives_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .services()
            .service_level_objectives_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _uptime_check_ips_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _doit(
        ...
        match self.opt.subcommand() {
            ...
            ("organizations", Some(opt)) => match opt.subcommand() {
                ("time-series-list", Some(opt)) => {
                    call_result = self
                        ._organizations_time_series_list(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
            ...
            ("projects", Some(opt)) => match opt.subcommand() {
                ("alert-policies-create", Some(opt)) => {
                    call_result = self
                        ._projects_alert_policies_create(opt, dry_run, &mut err)
                        .await;
                }
                ("alert-policies-delete", Some(opt)) => {
                    call_result = self
                        ._projects_alert_policies_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("alert-policies-get", Some(opt)) => {
                    call_result = self
                        ._projects_alert_policies_get(opt, dry_run, &mut err)
                        .await;
                }
                ("alert-policies-list", Some(opt)) => {
                    call_result = self
                        ._projects_alert_policies_list(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("groups-members-list", Some(opt)) => {
                    call_result = self
                        ._projects_groups_members_list(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("metric-descriptors-create", Some(opt)) => {
                    call_result = self
                        ._projects_metric_descriptors_create(opt, dry_run, &mut err)
                        .await;
                }
                ("metric-descriptors-delete", Some(opt)) => {
                    call_result = self
                        ._projects_metric_descriptors_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("metric-descriptors-get", Some(opt)) => {
                    call_result = self
                        ._projects_metric_descriptors_get(opt, dry_run, &mut err)
                        .await;
                }
                ("metric-descriptors-list", Some(opt)) => {
                    call_result = self
                        ._projects_metric_descriptors_list(opt, dry_run, &mut err)
                        .await;
                }
                ("monitored-resource-descriptors-get", Some(opt)) => {
                    call_result = self
                        ._projects_monitored_resource_descriptors_get(opt, dry_run, &mut err)
                        .await;
                }
                ("monitored-resource-descriptors-list", Some(opt)) => {
                    call_result = self
                        ._projects_monitored_resource_descriptors_list(opt, dry_run, &mut err)
                        .await;
                }
                ("notification-channel-descriptors-get", Some(opt)) => {
                    call_result = self
                        ._projects_notification_channel_descriptors_get(opt, dry_run, &mut err)
                        .await;
                }
                ("notification-channel-descriptors-list", Some(opt)) => {
                    call_result = self
                        ._projects_notification_channel_descriptors_list(opt, dry_run, &mut err)
                        .await;
                }
                ("notification-channels-create", Some(opt)) => {
                    call_result = self
                        ._projects_notification_channels_create(opt, dry_run, &mut err)
                        .await;
                }
                ("notification-channels-delete", Some(opt)) => {
                    call_result = self
                        ._projects_notification_channels_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("notification-channels-get", Some(opt)) => {
                    call_result = self
                        ._projects_notification_channels_get(opt, dry_run, &mut err)
                        .await;
                }
                ("notification-channels-get-verification-code", Some(opt)) => {
                    call_result = self
                        ._projects_notification_channels_get_verification_code(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("notification-channels-list", Some(opt)) => {
                    call_result = self
                        ._projects_notification_channels_list(opt, dry_run, &mut err)
                        .await;
                }
                ("notification-channels-patch", Some(opt)) => {
                    call_result = self
                        ._projects_notification_channels_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("notification-channels-send-verification-code", Some(opt)) => {
                    call_result = self
                        ._projects_notification_channels_send_verification_code(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("notification-channels-verify", Some(opt)) => {
                    call_result = self
                        ._projects_notification_channels_verify(opt, dry_run, &mut err)
                        .await;
                }
                ("snoozes-create", Some(opt)) => {
                    call_result = self._projects_snoozes_create(opt, dry_run, &mut err).await;
                }
                ("snoozes-get", Some(opt)) => {
                    call_result = self._projects_snoozes_get(opt, dry_run, &mut err).await;
                }
                ("snoozes-list", Some(opt)) => {
                    call_result = self._projects_snoozes_list(opt, dry_run, &mut err).await;
                }
                ("snoozes-patch", Some(opt)) => {
                    call_result = self._projects_snoozes_patch(opt, dry_run, &mut err).await;
                }
                ("time-series-create", Some(opt)) => {
                    call_result = self
                        ._projects_time_series_create(opt, dry_run, &mut err)
                        .await;
                }
                ("time-series-create-service", Some(opt)) => {
                    call_result = self
                        ._projects_time_series_create_service(opt, dry_run, &mut err)
                        .await;
                }
                ("time-series-list", Some(opt)) => {
                    call_result = self
                        ._projects_time_series_list(opt, dry_run, &mut err)
                        .await;
                }
                ("time-series-query", Some(opt)) => {
                    call_result = self
                        ._projects_time_series_query(opt, dry_run, &mut err)
                        .await;
                }
                ("uptime-check-configs-create", Some(opt)) => {
                    call_result = self
                        ._projects_uptime_check_configs_create(opt, dry_run, &mut err)
                        .await;
                }
                ("uptime-check-configs-delete", Some(opt)) => {
                    call_result = self
                        ._projects_uptime_check_configs_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("uptime-check-configs-get", Some(opt)) => {
                    call_result = self
                        ._projects_uptime_check_configs_get(opt, dry_run, &mut err)
                        .await;
                }
                ("uptime-check-configs-list", Some(opt)) => {
                    call_result = self
                        ._projects_uptime_check_configs_list(opt, dry_run, &mut err)
                        .await;
                }
                ("uptime-check-configs-patch", Some(opt)) => {
                    call_result = self
                        ._projects_uptime_check_configs_patch(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
            ...
            ("services", Some(opt)) => match opt.subcommand() {
                ("create", Some(opt)) => {
                ...
                ("service-level-objectives-create", Some(opt)) => {
                    call_result = self
                        ._services_service_level_objectives_create(opt, dry_run, &mut err)
                        .await;
                }
                ("service-level-objectives-delete", Some(opt)) => {
                    call_result = self
                        ._services_service_level_objectives_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("service-level-objectives-get", Some(opt)) => {
                    call_result = self
                        ._services_service_level_objectives_get(opt, dry_run, &mut err)
                        .await;
                }
                ("service-level-objectives-list", Some(opt)) => {
                    call_result = self
                        ._services_service_level_objectives_list(opt, dry_run, &mut err)
                        .await;
                }
                ("service-level-objectives-patch", Some(opt)) => {
                    call_result = self
                        ._services_service_level_objectives_patch(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("services".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("uptime-check-ips", Some(opt)) => match opt.subcommand() {
                ("list", Some(opt)) => {
                    call_result = self._uptime_check_ips_list(opt, dry_run, &mut err).await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("uptime-check-ips".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            _ => {
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "monitoring3-secret.json",
        ...
        ("folders", "methods: 'time-series-list'", vec![
            ("time-series-list",
                  ...
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The project (https://cloud.google.com/monitoring/api/v3#project_name), organization or folder on which to execute the request. The format is: projects/[PROJECT_ID_OR_NUMBER] organizations/[ORGANIZATION_ID] folders/[FOLDER_ID] "##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("alert-policies-create",
                  ...
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The project (https://cloud.google.com/monitoring/api/v3#project_name) in which to create the alerting policy. The format is: projects/[PROJECT_ID_OR_NUMBER] Note that this field names the parent container in which the alerting policy will be written, not the name of the created policy. |name| must be a host project of a Metrics Scope, otherwise INVALID_ARGUMENT error will return. The alerting policy that is returned will have a name that contains a normalized representation of this name as a prefix but adds a suffix of the form /alertPolicies/[ALERT_POLICY_ID], identifying the policy in the container."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("alert-policies-delete",
                    Some(r##"Deletes an alerting policy.Design your application to single-thread API calls that modify the state of alerting policies in a single project. This includes calls to CreateAlertPolicy, DeleteAlertPolicy and UpdateAlertPolicy."##),
                    "Details at http://byron.github.io/google-apis-rs/google_monitoring3_cli/projects_alert-policies-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("alert-policies-get",
                    Some(r##"Gets a single alerting policy."##),
                    "Details at http://byron.github.io/google-apis-rs/google_monitoring3_cli/projects_alert-policies-get",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("alert-policies-patch",
                    Some(r##"Updates an alerting policy. You can either replace the entire policy with a new one or replace only certain fields in the current alerting policy by specifying the fields to be updated via updateMask. Returns the updated alerting policy.Design your application to single-thread API calls that modify the state of alerting policies in a single project. This includes calls to CreateAlertPolicy, DeleteAlertPolicy and UpdateAlertPolicy."##),
                    "Details at http://byron.github.io/google-apis-rs/google_monitoring3_cli/projects_alert-policies-patch",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("collectd-time-series-create",
                    Some(r##"Cloud Monitoring Agent only: Creates a new time series.This method is only for use by the Cloud Monitoring Agent. Use projects.timeSeries.create instead."##),
                    "Details at http://byron.github.io/google-apis-rs/google_monitoring3_cli/projects_collectd-time-series-create",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"The project (https://cloud.google.com/monitoring/api/v3#project_name) in which to create the time series. The format is: projects/[PROJECT_ID_OR_NUMBER] "##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("groups-create",
                    Some(r##"Creates a new group."##),
                    "Details at http://byron.github.io/google-apis-rs/google_monitoring3_cli/projects_groups-create",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The project (https://cloud.google.com/monitoring/api/v3#project_name) in which to create the group. The format is: projects/[PROJECT_ID_OR_NUMBER] "##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("groups-delete",
                    Some(r##"Deletes an existing group."##),
                    "Details at http://byron.github.io/google-apis-rs/google_monitoring3_cli/projects_groups-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("groups-get",
                    Some(r##"Gets a single group."##),
                    "Details at http://byron.github.io/google-apis-rs/google_monitoring3_cli/projects_groups-get",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("groups-list",
                    Some(r##"Lists the existing groups."##),
                    "Details at http://byron.github.io/google-apis-rs/google_monitoring3_cli/projects_groups-list",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("groups-members-list",
                    Some(r##"Lists the monitored resources that are members of a group."##),
                    "Details at http://byron.github.io/google-apis-rs/google_monitoring3_cli/projects_groups-members-list",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("metric-descriptors-create",
                    Some(r##"Creates a new metric descriptor. The creation is executed asynchronously. User-created metric descriptors define custom metrics (https://cloud.google.com/monitoring/custom-metrics). The metric descriptor is updated if it already exists, except that metric labels are never removed."##),
                    "Details at http://byron.github.io/google-apis-rs/google_monitoring3_cli/projects_metric-descriptors-create",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The project (https://cloud.google.com/monitoring/api/v3#project_name) on which to execute the request. The format is: 4 projects/PROJECT_ID_OR_NUMBER"##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("metric-descriptors-list",
                  ...
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The project (https://cloud.google.com/monitoring/api/v3#project_name) on which to execute the request. The format is: projects/[PROJECT_ID_OR_NUMBER] "##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("notification-channel-descriptors-get",
                    Some(r##"Gets a single channel descriptor. The descriptor indicates which fields are expected / permitted for a notification channel of the given type."##),
                    "Details at http://byron.github.io/google-apis-rs/google_monitoring3_cli/projects_notification-channel-descriptors-get",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("notification-channel-descriptors-list",
                    Some(r##"Lists the descriptors for supported channel types. The use of descriptors makes it possible for new channel types to be dynamically added."##),
                    "Details at http://byron.github.io/google-apis-rs/google_monitoring3_cli/projects_notification-channel-descriptors-list",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("notification-channels-create",
                    Some(r##"Creates a new notification channel, representing a single notification endpoint such as an email address, SMS number, or PagerDuty service.Design your application to single-thread API calls that modify the state of notification channels in a single project. This includes calls to CreateNotificationChannel, DeleteNotificationChannel and UpdateNotificationChannel."##),
                    "Details at http://byron.github.io/google-apis-rs/google_monitoring3_cli/projects_notification-channels-create",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The project (https://cloud.google.com/monitoring/api/v3#project_name) on which to execute the request. The format is: projects/[PROJECT_ID_OR_NUMBER] This names the container into which the channel will be written, this does not name the newly created channel. The resulting channel's name will have a normalized version of this field as a prefix, but will add /notificationChannels/[CHANNEL_ID] to identify the channel."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("notification-channels-delete",
                    Some(r##"Deletes a notification channel.Design your application to single-thread API calls that modify the state of notification channels in a single project. This includes calls to CreateNotificationChannel, DeleteNotificationChannel and UpdateNotificationChannel."##),
                    "Details at http://byron.github.io/google-apis-rs/google_monitoring3_cli/projects_notification-channels-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("notification-channels-get",
                    Some(r##"Gets a single notification channel. The channel includes the relevant configuration details with which the channel was created. However, the response may truncate or omit passwords, API keys, or other private key matter and thus the response may not be 100% identical to the information that was supplied in the call to the create method."##),
                    "Details at http://byron.github.io/google-apis-rs/google_monitoring3_cli/projects_notification-channels-get",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The channel for which to execute the request. The format is: projects/[PROJECT_ID_OR_NUMBER]/notificationChannels/[CHANNEL_ID] "##),
            ...
            ("notification-channels-get-verification-code",
                    Some(r##"Requests a verification code for an already verified channel that can then be used in a call to VerifyNotificationChannel() on a different channel with an equivalent identity in the same or in a different project. This makes it possible to copy a channel between projects without requiring manual reverification of the channel. If the channel is not in the verified state, this method will fail (in other words, this may only be used if the SendNotificationChannelVerificationCode and VerifyNotificationChannel paths have already been used to put the given channel into the verified state).There is no guarantee that the verification codes returned by this method will be of a similar structure or form as the ones that are delivered to the channel via SendNotificationChannelVerificationCode; while VerifyNotificationChannel() will recognize both the codes delivered via SendNotificationChannelVerificationCode() and returned from GetNotificationChannelVerificationCode(), it is typically the case that the verification codes delivered via SendNotificationChannelVerificationCode() will be shorter and also have a shorter expiration (e.g. codes such as "G-123456") whereas GetVerificationCode() will typically return a much longer, websafe base 64 encoded string that has a longer expiration time."##),
                    "Details at http://byron.github.io/google-apis-rs/google_monitoring3_cli/projects_notification-channels-get-verification-code",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("notification-channels-list",
                    Some(r##"Lists the notification channels that have been created for the project. To list the types of notification channels that are supported, use the ListNotificationChannelDescriptors method."##),
                    "Details at http://byron.github.io/google-apis-rs/google_monitoring3_cli/projects_notification-channels-list",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("notification-channels-patch",
                    Some(r##"Updates a notification channel. Fields not specified in the field mask remain unchanged.Design your application to single-thread API calls that modify the state of notification channels in a single project. This includes calls to CreateNotificationChannel, DeleteNotificationChannel and UpdateNotificationChannel."##),
                    "Details at http://byron.github.io/google-apis-rs/google_monitoring3_cli/projects_notification-channels-patch",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("notification-channels-send-verification-code",
                    Some(r##"Causes a verification code to be delivered to the channel. The code can then be supplied in VerifyNotificationChannel to verify the channel."##),
                    "Details at http://byron.github.io/google-apis-rs/google_monitoring3_cli/projects_notification-channels-send-verification-code",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("notification-channels-verify",
                    Some(r##"Verifies a NotificationChannel by proving receipt of the code delivered to the channel as a result of calling SendNotificationChannelVerificationCode."##),
                    "Details at http://byron.github.io/google-apis-rs/google_monitoring3_cli/projects_notification-channels-verify",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("snoozes-create",
                    Some(r##"Creates a Snooze that will prevent alerts, which match the provided criteria, from being opened. The Snooze applies for a specific time interval."##),
                    "Details at http://byron.github.io/google-apis-rs/google_monitoring3_cli/projects_snoozes-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The project (https://cloud.google.com/monitoring/api/v3#project_name) in which a Snooze should be created. The format is: projects/[PROJECT_ID_OR_NUMBER] "##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("snoozes-get",
                    Some(r##"Retrieves a Snooze by name."##),
                    "Details at http://byron.github.io/google-apis-rs/google_monitoring3_cli/projects_snoozes-get",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The ID of the Snooze to retrieve. The format is: projects/[PROJECT_ID_OR_NUMBER]/snoozes/[SNOOZE_ID] "##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("snoozes-list",
                    Some(r##"Lists the Snoozes associated with a project. Can optionally pass in filter, which specifies predicates to match Snoozes."##),
                    "Details at http://byron.github.io/google-apis-rs/google_monitoring3_cli/projects_snoozes-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The project (https://cloud.google.com/monitoring/api/v3#project_name) whose Snoozes should be listed. The format is: projects/[PROJECT_ID_OR_NUMBER] "##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("snoozes-patch",
                    Some(r##"Updates a Snooze, identified by its name, with the parameters in the given Snooze object."##),
                    "Details at http://byron.github.io/google-apis-rs/google_monitoring3_cli/projects_snoozes-patch",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("time-series-create",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_monitoring3_cli/projects_time-series-create",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The project (https://cloud.google.com/monitoring/api/v3#project_name) on which to execute the request. The format is: projects/[PROJECT_ID_OR_NUMBER] "##),
            ...
            ("time-series-create-service",
                    Some(r##"Creates or adds data to one or more service time series. A service time series is a time series for a metric from a Google Cloud service. The response is empty if all time series in the request were written. If any time series could not be written, a corresponding failure message is included in the error response. This endpoint rejects writes to user-defined metrics. This method is only for use by Google Cloud services. Use projects.timeSeries.create instead."##),
                    "Details at http://byron.github.io/google-apis-rs/google_monitoring3_cli/projects_time-series-create-service",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The project (https://cloud.google.com/monitoring/api/v3#project_name) on which to execute the request. The format is: projects/[PROJECT_ID_OR_NUMBER] "##),
            ...
            ("uptime-check-configs-create",
                  ...
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The project (https://cloud.google.com/monitoring/api/v3#project_name) in which to create the Uptime check. The format is: projects/[PROJECT_ID_OR_NUMBER] "##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("uptime-check-configs-list",
                  ...
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The project (https://cloud.google.com/monitoring/api/v3#project_name) whose Uptime check configurations are listed. The format is: projects/[PROJECT_ID_OR_NUMBER] "##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("uptime-check-configs-patch",
                  ...
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Identifier. A unique resource name for this Uptime check configuration. The format is: projects/[PROJECT_ID_OR_NUMBER]/uptimeCheckConfigs/[UPTIME_CHECK_ID] [PROJECT_ID_OR_NUMBER] is the Workspace host project associated with the Uptime check.This field should be omitted when creating the Uptime check configuration; on create, the resource name is assigned by the server and included in the response."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("create",
                  ...
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. Resource name (https://cloud.google.com/monitoring/api/v3#project_name) of the parent Metrics Scope. The format is: projects/[PROJECT_ID_OR_NUMBER] "##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("list",
                    Some(r##"List Services for this Metrics Scope."##),
            ...
            ("service-level-objectives-list",
                  ...
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. Resource name of the parent containing the listed SLOs, either a project or a Monitoring Metrics Scope. The formats are: projects/[PROJECT_ID_OR_NUMBER]/services/[SERVICE_ID] workspaces/[HOST_PROJECT_ID_OR_NUMBER]/services/- "##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
