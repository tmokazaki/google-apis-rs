...
impl<C> common::Hub for PolicySimulator<C> {}
...
impl common::Part for GoogleCloudPolicysimulatorV1AccessStateDiff {}
...
impl common::Part for GoogleCloudPolicysimulatorV1AccessTuple {}
...
pub struct GoogleCloudPolicysimulatorV1BindingExplanation {
    ...
    pub memberships:
        Option<HashMap<String, GoogleCloudPolicysimulatorV1BindingExplanationAnnotatedMembership>>,
...
impl common::Part for GoogleCloudPolicysimulatorV1BindingExplanation {}
...
impl common::Part for GoogleCloudPolicysimulatorV1BindingExplanationAnnotatedMembership {}
...
impl common::Part for GoogleCloudPolicysimulatorV1ExplainedAccess {}
...
impl common::Part for GoogleCloudPolicysimulatorV1ExplainedPolicy {}
...
impl common::ResponseResult for GoogleCloudPolicysimulatorV1ListReplayResultsResponse {}
...
impl common::RequestValue for GoogleCloudPolicysimulatorV1Replay {}
impl common::ResponseResult for GoogleCloudPolicysimulatorV1Replay {}
...
impl common::Part for GoogleCloudPolicysimulatorV1ReplayConfig {}
...
impl common::Part for GoogleCloudPolicysimulatorV1ReplayDiff {}
...
impl common::Part for GoogleCloudPolicysimulatorV1ReplayResult {}
...
impl common::Part for GoogleCloudPolicysimulatorV1ReplayResultsSummary {}
...
impl common::Part for GoogleIamV1Policy {}
...
impl<'a, C> FolderMethods<'a, C> {
    ...
    pub fn locations_org_policy_violations_previews_operations_get(
        &self,
        name: &str,
    ) -> FolderLocationOrgPolicyViolationsPreviewOperationGetCall<'a, C> {
    ...
    ///
    /// * `name` - The name of the operation resource.
    pub fn locations_replays_operations_get(
        &self,
        name: &str,
    ) -> FolderLocationReplayOperationGetCall<'a, C> {
    ...
    pub fn locations_replays_operations_list(
        &self,
        name: &str,
    ) -> FolderLocationReplayOperationListCall<'a, C> {
    ...
    pub fn locations_replays_results_list(
        &self,
        parent: &str,
    ) -> FolderLocationReplayResultListCall<'a, C> {
    ...
    pub fn locations_replays_create(
        ...
        parent: &str,
    ) -> FolderLocationReplayCreateCall<'a, C> {
...
impl<'a, C> OrganizationMethods<'a, C> {
    ...
    pub fn locations_org_policy_violations_previews_operations_get(
        &self,
        name: &str,
    ) -> OrganizationLocationOrgPolicyViolationsPreviewOperationGetCall<'a, C> {
    ...
    pub fn locations_replays_operations_get(
        &self,
        name: &str,
    ) -> OrganizationLocationReplayOperationGetCall<'a, C> {
    ...
    pub fn locations_replays_operations_list(
        &self,
        name: &str,
    ) -> OrganizationLocationReplayOperationListCall<'a, C> {
    ...
    pub fn locations_replays_results_list(
        &self,
        parent: &str,
    ) -> OrganizationLocationReplayResultListCall<'a, C> {
    ...
    pub fn locations_replays_create(
        ...
        request: GoogleCloudPolicysimulatorV1Replay,
        parent: &str,
    ) -> OrganizationLocationReplayCreateCall<'a, C> {
...
impl<'a, C> ProjectMethods<'a, C> {
    ...
    pub fn locations_org_policy_violations_previews_operations_get(
        &self,
        name: &str,
    ) -> ProjectLocationOrgPolicyViolationsPreviewOperationGetCall<'a, C> {
    ...
    pub fn locations_replays_operations_get(
        &self,
        name: &str,
    ) -> ProjectLocationReplayOperationGetCall<'a, C> {
    ...
    pub fn locations_replays_operations_list(
        &self,
        name: &str,
    ) -> ProjectLocationReplayOperationListCall<'a, C> {
    ...
    pub fn locations_replays_results_list(
        &self,
        parent: &str,
    ) -> ProjectLocationReplayResultListCall<'a, C> {
    ...
    pub fn locations_replays_create(
        ...
        request: GoogleCloudPolicysimulatorV1Replay,
        parent: &str,
    ) -> ProjectLocationReplayCreateCall<'a, C> {
...
/// Gets the latest state of a long-running operation. Clients can use this method to poll the operation result at intervals as recommended by the API service.
///
/// A builder for the *locations.orgPolicyViolationsPreviews.operations.get* method supported by a *folder* resource.
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.folders().locations_org_policy_violations_previews_operations_get("name")
///              .doit().await;
/// # }
/// ```
pub struct FolderLocationOrgPolicyViolationsPreviewOperationGetCall<'a, C>
where
    C: 'a,
{
    hub: &'a PolicySimulator<C>,
...
impl<'a, C> common::CallBuilder
    for FolderLocationOrgPolicyViolationsPreviewOperationGetCall<'a, C>
{
}

impl<'a, C> FolderLocationOrgPolicyViolationsPreviewOperationGetCall<'a, C>
where
    C: common::Connector,
{
...
/// # }
/// ```
pub struct FolderLocationReplayOperationGetCall<'a, C>
where
    C: 'a,
{
    hub: &'a PolicySimulator<C>,
...
impl<'a, C> common::CallBuilder for FolderLocationReplayOperationGetCall<'a, C> {}

impl<'a, C> FolderLocationReplayOperationGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> FolderLocationReplayOperationGetCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> FolderLocationReplayOperationGetCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> FolderLocationReplayOperationGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> FolderLocationReplayOperationGetCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> FolderLocationReplayOperationGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct FolderLocationReplayOperationListCall<'a, C>
where
    C: 'a,
{
    hub: &'a PolicySimulator<C>,
...
impl<'a, C> common::CallBuilder for FolderLocationReplayOperationListCall<'a, C> {}

impl<'a, C> FolderLocationReplayOperationListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> FolderLocationReplayOperationListCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    ...
    pub fn page_token(mut self, new_value: &str) -> FolderLocationReplayOperationListCall<'a, C> {
    ...
    pub fn page_size(mut self, new_value: i32) -> FolderLocationReplayOperationListCall<'a, C> {
    ...
    pub fn filter(mut self, new_value: &str) -> FolderLocationReplayOperationListCall<'a, C> {
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> FolderLocationReplayOperationListCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> FolderLocationReplayOperationListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> FolderLocationReplayOperationListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> FolderLocationReplayOperationListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for FolderLocationReplayResultListCall<'a, C> {}

impl<'a, C> FolderLocationReplayResultListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> FolderLocationReplayResultListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> FolderLocationReplayResultListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> FolderLocationReplayResultListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for FolderLocationReplayCreateCall<'a, C> {}

impl<'a, C> FolderLocationReplayCreateCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    pub fn request(
        mut self,
        new_value: GoogleCloudPolicysimulatorV1Replay,
    ) -> FolderLocationReplayCreateCall<'a, C> {
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> FolderLocationReplayCreateCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> FolderLocationReplayCreateCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> FolderLocationReplayCreateCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for FolderLocationReplayGetCall<'a, C> {}

impl<'a, C> FolderLocationReplayGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(
        mut self,
    ) -> common::Result<(common::Response, GoogleCloudPolicysimulatorV1Replay)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    pub fn delegate(
        mut self,
        new_value: &'a mut dyn common::Delegate,
    ) -> FolderLocationReplayGetCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> FolderLocationReplayGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> FolderLocationReplayGetCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> FolderLocationReplayGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Gets the latest state of a long-running operation. Clients can use this method to poll the operation result at intervals as recommended by the API service.
///
/// A builder for the *locations.orgPolicyViolationsPreviews.operations.get* method supported by a *organization* resource.
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.organizations().locations_org_policy_violations_previews_operations_get("name")
///              .doit().await;
/// # }
/// ```
pub struct OrganizationLocationOrgPolicyViolationsPreviewOperationGetCall<'a, C>
where
    C: 'a,
{
    hub: &'a PolicySimulator<C>,
...
impl<'a, C> common::CallBuilder
    for OrganizationLocationOrgPolicyViolationsPreviewOperationGetCall<'a, C>
{
}

impl<'a, C> OrganizationLocationOrgPolicyViolationsPreviewOperationGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, GoogleLongrunningOperation)> {
        ...
        let mut dd = common::DefaultDelegate;
        let mut dlg: &mut dyn common::Delegate = self._delegate.unwrap_or(&mut dd);
        dlg.begin(common::MethodInfo { id: "policysimulator.organizations.locations.orgPolicyViolationsPreviews.operations.get",
                               http_method: hyper::Method::GET });
...
/// # }
/// ```
pub struct OrganizationLocationReplayOperationGetCall<'a, C>
where
    C: 'a,
{
    hub: &'a PolicySimulator<C>,
...
impl<'a, C> common::CallBuilder for OrganizationLocationReplayOperationGetCall<'a, C> {}

impl<'a, C> OrganizationLocationReplayOperationGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> OrganizationLocationReplayOperationGetCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> OrganizationLocationReplayOperationGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> OrganizationLocationReplayOperationGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct OrganizationLocationReplayOperationListCall<'a, C>
where
    C: 'a,
{
    hub: &'a PolicySimulator<C>,
...
impl<'a, C> common::CallBuilder for OrganizationLocationReplayOperationListCall<'a, C> {}

impl<'a, C> OrganizationLocationReplayOperationListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> OrganizationLocationReplayOperationListCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The standard list page token.
    ...
    ///
    /// Sets the *filter* query property to the given value.
    pub fn filter(mut self, new_value: &str) -> OrganizationLocationReplayOperationListCall<'a, C> {
        self._filter = Some(new_value.to_string());
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> OrganizationLocationReplayOperationListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> OrganizationLocationReplayOperationListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for OrganizationLocationReplayResultListCall<'a, C> {}

impl<'a, C> OrganizationLocationReplayResultListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> OrganizationLocationReplayResultListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> OrganizationLocationReplayResultListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> OrganizationLocationReplayResultListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for OrganizationLocationReplayCreateCall<'a, C> {}

impl<'a, C> OrganizationLocationReplayCreateCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> OrganizationLocationReplayCreateCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> OrganizationLocationReplayCreateCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> OrganizationLocationReplayCreateCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for OrganizationLocationReplayGetCall<'a, C> {}

impl<'a, C> OrganizationLocationReplayGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    pub fn delegate(
        mut self,
        new_value: &'a mut dyn common::Delegate,
    ) -> OrganizationLocationReplayGetCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> OrganizationLocationReplayGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> OrganizationLocationReplayGetCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> OrganizationLocationReplayGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Gets the latest state of a long-running operation. Clients can use this method to poll the operation result at intervals as recommended by the API service.
///
/// A builder for the *locations.orgPolicyViolationsPreviews.operations.get* method supported by a *project* resource.
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().locations_org_policy_violations_previews_operations_get("name")
///              .doit().await;
/// # }
/// ```
pub struct ProjectLocationOrgPolicyViolationsPreviewOperationGetCall<'a, C>
where
    C: 'a,
{
    hub: &'a PolicySimulator<C>,
...
impl<'a, C> common::CallBuilder
    for ProjectLocationOrgPolicyViolationsPreviewOperationGetCall<'a, C>
{
}

impl<'a, C> ProjectLocationOrgPolicyViolationsPreviewOperationGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
...
/// # }
/// ```
pub struct ProjectLocationReplayOperationGetCall<'a, C>
where
    C: 'a,
{
    hub: &'a PolicySimulator<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationReplayOperationGetCall<'a, C> {}

impl<'a, C> ProjectLocationReplayOperationGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationReplayOperationGetCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationReplayOperationGetCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationReplayOperationGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationReplayOperationGetCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationReplayOperationGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationReplayOperationListCall<'a, C>
where
    C: 'a,
{
    hub: &'a PolicySimulator<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationReplayOperationListCall<'a, C> {}

impl<'a, C> ProjectLocationReplayOperationListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationReplayOperationListCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The standard list page token.
    ///
    /// Sets the *page token* query property to the given value.
    pub fn page_token(mut self, new_value: &str) -> ProjectLocationReplayOperationListCall<'a, C> {
        self._page_token = Some(new_value.to_string());
        self
    }
    /// The standard list page size.
    ///
    /// Sets the *page size* query property to the given value.
    pub fn page_size(mut self, new_value: i32) -> ProjectLocationReplayOperationListCall<'a, C> {
        self._page_size = Some(new_value);
        self
    }
    /// The standard list filter.
    ///
    /// Sets the *filter* query property to the given value.
    pub fn filter(mut self, new_value: &str) -> ProjectLocationReplayOperationListCall<'a, C> {
        self._filter = Some(new_value.to_string());
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationReplayOperationListCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationReplayOperationListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationReplayOperationListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationReplayOperationListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for ProjectLocationReplayResultListCall<'a, C> {}

impl<'a, C> ProjectLocationReplayResultListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationReplayResultListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationReplayResultListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationReplayResultListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for ProjectLocationReplayCreateCall<'a, C> {}

impl<'a, C> ProjectLocationReplayCreateCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationReplayCreateCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationReplayCreateCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationReplayCreateCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for ProjectLocationReplayGetCall<'a, C> {}

impl<'a, C> ProjectLocationReplayGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    pub fn delegate(
        mut self,
        new_value: &'a mut dyn common::Delegate,
    ) -> ProjectLocationReplayGetCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationReplayGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationReplayGetCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationReplayGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
