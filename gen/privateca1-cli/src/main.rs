...
use google_privateca1::{api, yup_oauth2, Error};
...
struct Engine<'n, C> {
    opt: ArgMatches<'n>,
    hub: api::CertificateAuthorityService<C>,
    gp: Vec<&'static str>,
...
{
    async fn _projects_locations_ca_pools_certificate_authorities_activate(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "subordinate-config.certificate-authority" => Some((
                ...
                "subordinate-config.pem-issuer-chain.pem-certificates" => Some((
        ...
        let mut request: api::ActivateCertificateAuthorityRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_ca_pools_certificate_authorities_activate(
                request,
    ...
    async fn _projects_locations_ca_pools_certificate_authorities_certificate_revocation_lists_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_ca_pools_certificate_authorities_certificate_revocation_lists_get(
                opt.value_of("name").unwrap_or(""),
            );
        for parg in opt
            .values_of("v")
    ...
    async fn _projects_locations_ca_pools_certificate_authorities_certificate_revocation_lists_get_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_ca_pools_certificate_authorities_certificate_revocation_lists_get_iam_policy(
    ...
    async fn _projects_locations_ca_pools_certificate_authorities_certificate_revocation_lists_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_locations_ca_pools_certificate_authorities_certificate_revocation_lists_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::CertificateRevocationList =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_ca_pools_certificate_authorities_certificate_revocation_lists_patch(
                request,
                opt.value_of("name").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_ca_pools_certificate_authorities_certificate_revocation_lists_set_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_ca_pools_certificate_authorities_certificate_revocation_lists_set_iam_policy(
                request,
                opt.value_of("resource").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_ca_pools_certificate_authorities_certificate_revocation_lists_test_iam_permissions(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_locations_ca_pools_certificate_authorities_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                "access-urls.ca-certificate-access-url" => Some((
                ...
                "access-urls.crl-access-urls" => Some((
                ...
                "config.subject-config.subject.common-name" => Some((
                ...
                "config.subject-config.subject.country-code" => Some((
                ...
                "config.subject-config.subject.locality" => Some((
                ...
                "config.subject-config.subject.organization" => Some((
                ...
                "config.subject-config.subject.organizational-unit" => Some((
                ...
                "config.subject-config.subject.postal-code" => Some((
                ...
                "config.subject-config.subject.province" => Some((
                ...
                "config.subject-config.subject.street-address" => Some((
                ...
                "config.subject-config.subject-alt-name.dns-names" => Some((
                ...
                "config.subject-config.subject-alt-name.email-addresses" => Some((
                ...
                "config.subject-config.subject-alt-name.ip-addresses" => Some((
                ...
                "config.subject-config.subject-alt-name.uris" => Some((
                ...
                "config.subject-key-id.key-id" => Some((
                    "config.subjectKeyId.keyId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "config.x509-config.aia-ocsp-servers" => Some((
                ...
                "config.x509-config.ca-options.is-ca" => Some((
                ...
                "config.x509-config.ca-options.max-issuer-path-length" => Some((
                ...
                "config.x509-config.key-usage.base-key-usage.cert-sign" => Some((
                ...
                "config.x509-config.key-usage.base-key-usage.content-commitment" => Some((
                ...
                "config.x509-config.key-usage.base-key-usage.crl-sign" => Some((
                ...
                "config.x509-config.key-usage.base-key-usage.data-encipherment" => Some((
                ...
                "config.x509-config.key-usage.base-key-usage.decipher-only" => Some((
                ...
                "config.x509-config.key-usage.base-key-usage.digital-signature" => Some((
                ...
                "config.x509-config.key-usage.base-key-usage.encipher-only" => Some((
                ...
                "config.x509-config.key-usage.base-key-usage.key-agreement" => Some((
                ...
                "config.x509-config.key-usage.base-key-usage.key-encipherment" => Some((
                ...
                "config.x509-config.key-usage.extended-key-usage.client-auth" => Some((
                ...
                "config.x509-config.key-usage.extended-key-usage.code-signing" => Some((
                ...
                "config.x509-config.key-usage.extended-key-usage.email-protection" => Some((
                ...
                "config.x509-config.key-usage.extended-key-usage.ocsp-signing" => Some((
                ...
                "config.x509-config.key-usage.extended-key-usage.server-auth" => Some((
                ...
                "config.x509-config.key-usage.extended-key-usage.time-stamping" => Some((
                ...
                "config.x509-config.name-constraints.critical" => Some((
                    "config.x509Config.nameConstraints.critical",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "config.x509-config.name-constraints.excluded-dns-names" => Some((
                    "config.x509Config.nameConstraints.excludedDnsNames",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "config.x509-config.name-constraints.excluded-email-addresses" => Some((
                    "config.x509Config.nameConstraints.excludedEmailAddresses",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "config.x509-config.name-constraints.excluded-ip-ranges" => Some((
                    "config.x509Config.nameConstraints.excludedIpRanges",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "config.x509-config.name-constraints.excluded-uris" => Some((
                    "config.x509Config.nameConstraints.excludedUris",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "config.x509-config.name-constraints.permitted-dns-names" => Some((
                    "config.x509Config.nameConstraints.permittedDnsNames",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "config.x509-config.name-constraints.permitted-email-addresses" => Some((
                    "config.x509Config.nameConstraints.permittedEmailAddresses",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "config.x509-config.name-constraints.permitted-ip-ranges" => Some((
                    "config.x509Config.nameConstraints.permittedIpRanges",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "config.x509-config.name-constraints.permitted-uris" => Some((
                    "config.x509Config.nameConstraints.permittedUris",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                ...
                "key-spec.cloud-kms-key-version" => Some((
                    "keySpec.cloudKmsKeyVersion",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
        ...
        let mut request: api::CertificateAuthority = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["certificate-authority-id", "request-id"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _projects_locations_ca_pools_certificate_authorities_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_ca_pools_certificate_authorities_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            .iter()
        {
            ...
            match key {
                "skip-grace-period" => {
                    call = call.skip_grace_period(
                        value
                            .map(|v| arg_from_str(v, err, "skip-grace-period", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "request-id" => {
                ...
                "ignore-dependent-resources" => {
                    call = call.ignore_dependent_resources(
                        value
                            .map(|v| arg_from_str(v, err, "ignore-dependent-resources", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "ignore-active-certificates" => {
                    call = call.ignore_active_certificates(
                        value
                            .map(|v| arg_from_str(v, err, "ignore-active-certificates", "boolean"))
                            .unwrap_or(false),
                    );
                }
                _ => {
    ...
    async fn _projects_locations_ca_pools_certificate_authorities_disable(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                "ignore-dependent-resources" => Some((
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec!["ignore-dependent-resources", "request-id"],
                    );
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
        ...
        let mut request: api::DisableCertificateAuthorityRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_ca_pools_certificate_authorities_disable(
                request,
                opt.value_of("name").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_ca_pools_certificate_authorities_enable(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::EnableCertificateAuthorityRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_ca_pools_certificate_authorities_enable(
                request,
                opt.value_of("name").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_ca_pools_certificate_authorities_fetch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_ca_pools_certificate_authorities_fetch(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_ca_pools_certificate_authorities_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_ca_pools_certificate_authorities_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_ca_pools_certificate_authorities_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_ca_pools_certificate_authorities_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_ca_pools_certificate_authorities_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_ca_pools_certificate_authorities_patch(
                request,
                opt.value_of("name").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_ca_pools_certificate_authorities_undelete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::UndeleteCertificateAuthorityRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_ca_pools_certificate_authorities_undelete(
                request,
                opt.value_of("name").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_ca_pools_certificates_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_ca_pools_certificates_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_ca_pools_certificates_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_ca_pools_certificates_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_ca_pools_certificates_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_ca_pools_certificates_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_ca_pools_certificates_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_ca_pools_certificates_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_ca_pools_certificates_revoke(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::RevokeCertificateRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_ca_pools_certificates_revoke(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_ca_pools_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "issuance-policy.allowed-issuance-modes.allow-csr-based-issuance" => Some((
                ...
                "issuance-policy.baseline-values.aia-ocsp-servers" => Some((
                ...
                "issuance-policy.baseline-values.ca-options.is-ca" => Some((
                ...
                "issuance-policy.baseline-values.ca-options.max-issuer-path-length" => Some((
                ...
                "issuance-policy.baseline-values.key-usage.base-key-usage.cert-sign" => Some((
                ...
                "issuance-policy.baseline-values.key-usage.base-key-usage.content-commitment" => {
                    Some((
                ...
                "issuance-policy.baseline-values.key-usage.base-key-usage.crl-sign" => Some((
                ...
                "issuance-policy.baseline-values.key-usage.base-key-usage.data-encipherment" => {
                    Some((
                ...
                "issuance-policy.baseline-values.key-usage.base-key-usage.decipher-only" => Some((
                ...
                "issuance-policy.baseline-values.key-usage.base-key-usage.digital-signature" => {
                    Some((
                ...
                "issuance-policy.baseline-values.key-usage.base-key-usage.encipher-only" => Some((
                ...
                "issuance-policy.baseline-values.key-usage.base-key-usage.key-agreement" => Some((
                ...
                "issuance-policy.baseline-values.key-usage.base-key-usage.key-encipherment" => {
                    Some((
                ...
                "issuance-policy.baseline-values.key-usage.extended-key-usage.client-auth" => {
                    Some((
                ...
                "issuance-policy.baseline-values.key-usage.extended-key-usage.code-signing" => {
                    Some((
                ...
                "issuance-policy.baseline-values.key-usage.extended-key-usage.email-protection" => {
                    Some((
                ...
                "issuance-policy.baseline-values.key-usage.extended-key-usage.ocsp-signing" => {
                    Some((
                ...
                "issuance-policy.baseline-values.key-usage.extended-key-usage.server-auth" => {
                    Some((
                ...
                "issuance-policy.baseline-values.key-usage.extended-key-usage.time-stamping" => {
                    Some((
                ...
                "issuance-policy.baseline-values.name-constraints.critical" => Some((
                    "issuancePolicy.baselineValues.nameConstraints.critical",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "issuance-policy.baseline-values.name-constraints.excluded-dns-names" => Some((
                    "issuancePolicy.baselineValues.nameConstraints.excludedDnsNames",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "issuance-policy.baseline-values.name-constraints.excluded-email-addresses" => {
                    Some((
                        "issuancePolicy.baselineValues.nameConstraints.excludedEmailAddresses",
                        JsonTypeInfo {
                            jtype: JsonType::String,
                            ctype: ComplexType::Vec,
                        },
                ...
                "issuance-policy.baseline-values.name-constraints.excluded-ip-ranges" => Some((
                    "issuancePolicy.baselineValues.nameConstraints.excludedIpRanges",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "issuance-policy.baseline-values.name-constraints.excluded-uris" => Some((
                    "issuancePolicy.baselineValues.nameConstraints.excludedUris",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "issuance-policy.baseline-values.name-constraints.permitted-dns-names" => Some((
                    "issuancePolicy.baselineValues.nameConstraints.permittedDnsNames",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "issuance-policy.baseline-values.name-constraints.permitted-email-addresses" => {
                    Some((
                        "issuancePolicy.baselineValues.nameConstraints.permittedEmailAddresses",
                        JsonTypeInfo {
                            jtype: JsonType::String,
                            ctype: ComplexType::Vec,
                        },
                ...
                "issuance-policy.baseline-values.name-constraints.permitted-ip-ranges" => Some((
                    "issuancePolicy.baselineValues.nameConstraints.permittedIpRanges",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "issuance-policy.baseline-values.name-constraints.permitted-uris" => Some((
                    "issuancePolicy.baselineValues.nameConstraints.permittedUris",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "issuance-policy.identity-constraints.allow-subject-alt-names-passthrough" => {
                    Some((
                ...
                "issuance-policy.identity-constraints.allow-subject-passthrough" => Some((
                ...
                "issuance-policy.identity-constraints.cel-expression.description" => Some((
                ...
                "issuance-policy.identity-constraints.cel-expression.expression" => Some((
                ...
                "issuance-policy.identity-constraints.cel-expression.location" => Some((
                ...
                "issuance-policy.identity-constraints.cel-expression.title" => Some((
                ...
                "issuance-policy.maximum-lifetime" => Some((
                ...
                "issuance-policy.passthrough-extensions.known-extensions" => Some((
                ...
                "publishing-options.encoding-format" => Some((
                ...
                "publishing-options.publish-ca-cert" => Some((
                ...
                "publishing-options.publish-crl" => Some((
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        ...
                        &vec![
                            "aia-ocsp-servers",
                            "allow-config-based-issuance",
                            "allow-csr-based-issuance",
        ...
        let mut request: api::CaPool = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_ca_pools_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_ca_pools_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_ca_pools_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["ignore-dependent-resources", "request-id"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _projects_locations_ca_pools_fetch_ca_certs(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::FetchCaCertsRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_ca_pools_fetch_ca_certs(request, opt.value_of("ca-pool").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_ca_pools_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_ca_pools_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_ca_pools_get_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_ca_pools_get_iam_policy(opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_ca_pools_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_ca_pools_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_ca_pools_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_ca_pools_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_ca_pools_set_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_ca_pools_set_iam_policy(request, opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_ca_pools_test_iam_permissions(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::TestIamPermissionsRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.projects().locations_ca_pools_test_iam_permissions(
            request,
            opt.value_of("resource").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _projects_locations_certificate_templates_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "identity-constraints.allow-subject-alt-names-passthrough" => Some((
                ...
                "identity-constraints.allow-subject-passthrough" => Some((
                ...
                "identity-constraints.cel-expression.description" => Some((
                ...
                "identity-constraints.cel-expression.expression" => Some((
                ...
                "identity-constraints.cel-expression.location" => Some((
                ...
                "identity-constraints.cel-expression.title" => Some((
                ...
                "passthrough-extensions.known-extensions" => Some((
                ...
                "predefined-values.aia-ocsp-servers" => Some((
                ...
                "predefined-values.ca-options.is-ca" => Some((
                ...
                "predefined-values.ca-options.max-issuer-path-length" => Some((
                ...
                "predefined-values.key-usage.base-key-usage.cert-sign" => Some((
                ...
                "predefined-values.key-usage.base-key-usage.content-commitment" => Some((
                ...
                "predefined-values.key-usage.base-key-usage.crl-sign" => Some((
                ...
                "predefined-values.key-usage.base-key-usage.data-encipherment" => Some((
                ...
                "predefined-values.key-usage.base-key-usage.decipher-only" => Some((
                ...
                "predefined-values.key-usage.base-key-usage.digital-signature" => Some((
                ...
                "predefined-values.key-usage.base-key-usage.encipher-only" => Some((
                ...
                "predefined-values.key-usage.base-key-usage.key-agreement" => Some((
                ...
                "predefined-values.key-usage.base-key-usage.key-encipherment" => Some((
                ...
                "predefined-values.key-usage.extended-key-usage.client-auth" => Some((
                ...
                "predefined-values.key-usage.extended-key-usage.code-signing" => Some((
                ...
                "predefined-values.key-usage.extended-key-usage.email-protection" => Some((
                ...
                "predefined-values.key-usage.extended-key-usage.ocsp-signing" => Some((
                ...
                "predefined-values.key-usage.extended-key-usage.server-auth" => Some((
                ...
                "predefined-values.key-usage.extended-key-usage.time-stamping" => Some((
                ...
                "predefined-values.name-constraints.critical" => Some((
                    "predefinedValues.nameConstraints.critical",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "predefined-values.name-constraints.excluded-dns-names" => Some((
                    "predefinedValues.nameConstraints.excludedDnsNames",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "predefined-values.name-constraints.excluded-email-addresses" => Some((
                    "predefinedValues.nameConstraints.excludedEmailAddresses",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "predefined-values.name-constraints.excluded-ip-ranges" => Some((
                    "predefinedValues.nameConstraints.excludedIpRanges",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "predefined-values.name-constraints.excluded-uris" => Some((
                    "predefinedValues.nameConstraints.excludedUris",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "predefined-values.name-constraints.permitted-dns-names" => Some((
                    "predefinedValues.nameConstraints.permittedDnsNames",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "predefined-values.name-constraints.permitted-email-addresses" => Some((
                    "predefinedValues.nameConstraints.permittedEmailAddresses",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "predefined-values.name-constraints.permitted-ip-ranges" => Some((
                    "predefinedValues.nameConstraints.permittedIpRanges",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "predefined-values.name-constraints.permitted-uris" => Some((
                    "predefinedValues.nameConstraints.permittedUris",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
        ...
        let mut request: api::CertificateTemplate = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_certificate_templates_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["certificate-template-id", "request-id"].iter().map(|v| *v),
                                );
                                v
                            }));
                    }
    ...
    async fn _projects_locations_certificate_templates_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_certificate_templates_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_certificate_templates_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_certificate_templates_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_certificate_templates_get_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_certificate_templates_get_iam_policy(opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_certificate_templates_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_certificate_templates_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_certificate_templates_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_certificate_templates_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_certificate_templates_set_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_locations_certificate_templates_test_iam_permissions(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_certificate_templates_test_iam_permissions(
                request,
                opt.value_of("resource").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "privateca1-secret.json",
