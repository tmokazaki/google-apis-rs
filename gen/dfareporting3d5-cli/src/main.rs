...
use google_dfareporting3d5::{api, yup_oauth2, Error};
    ...
    C: apis_common::Connector,
{
    async fn _media_upload(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "id-dimension-value.dimension-name" => Some((
                ...
                "id-dimension-value.match-type" => Some((
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "dfareporting3d5-secret.json",
