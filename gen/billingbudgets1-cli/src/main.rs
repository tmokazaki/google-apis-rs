...
use google_billingbudgets1::{api, yup_oauth2, Error};
    ...
    C: apis_common::Connector,
{
    async fn _billing_accounts_budgets_create(
            ...
            .iter()
        {
            ...
            {
                "amount.specified-amount.currency-code" => Some((
                ...
                "amount.specified-amount.nanos" => Some((
                ...
                "amount.specified-amount.units" => Some((
                ...
                "budget-filter.calendar-period" => Some((
                ...
                "budget-filter.credit-types" => Some((
                ...
                "budget-filter.credit-types-treatment" => Some((
                ...
                "budget-filter.custom-period.end-date.day" => Some((
                ...
                "budget-filter.custom-period.end-date.month" => Some((
                ...
                "budget-filter.custom-period.end-date.year" => Some((
                ...
                "budget-filter.custom-period.start-date.day" => Some((
                ...
                "budget-filter.custom-period.start-date.month" => Some((
                ...
                "budget-filter.custom-period.start-date.year" => Some((
                ...
                "budget-filter.resource-ancestors" => Some((
                ...
                "budget-filter.subaccounts" => Some((
                ...
                "notifications-rule.disable-default-iam-recipients" => Some((
                ...
                "notifications-rule.enable-project-level-recipients" => Some((
                ...
                "notifications-rule.monitoring-notification-channels" => Some((
                ...
                "notifications-rule.pubsub-topic" => Some((
                ...
                "notifications-rule.schema-version" => Some((
        ...
        let mut request: api::GoogleCloudBillingBudgetsV1Budget =
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "billingbudgets1-secret.json",
        ...
        .persist_tokens_to_disk(format!("{}/billingbudgets1", config_dir))
        .build()
        .await
        .unwrap();
