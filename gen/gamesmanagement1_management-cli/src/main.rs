...
use google_gamesmanagement1_management::{api, yup_oauth2, Error};
    ...
    C: apis_common::Connector,
{
    async fn _achievements_reset(
        ...
        let mut call = self
            .hub
            .achievements()
            .reset(opt.value_of("achievement-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _achievements_reset_all(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _achievements_reset_all_for_all_players(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _achievements_reset_for_all_players(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .achievements()
            .reset_for_all_players(opt.value_of("achievement-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _achievements_reset_multiple_for_all_players(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion =
                        FieldCursor::did_you_mean(key, &vec!["achievement-ids", "kind"]);
        ...
        let mut request: api::AchievementResetMultipleForAllRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .achievements()
            .reset_multiple_for_all_players(request);
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _applications_list_hidden(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .applications()
            .list_hidden(opt.value_of("application-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _events_reset(
        ...
        let mut call = self
            .hub
            .events()
            .reset(opt.value_of("event-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _events_reset_all_for_all_players(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _events_reset_for_all_players(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .events()
            .reset_for_all_players(opt.value_of("event-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _events_reset_multiple_for_all_players(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(key, &vec!["event-ids", "kind"]);
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
                        value.map(|v| v.to_string()),
        ...
        let mut request: api::EventsResetMultipleForAllRequest =
            serde_json::value::from_value(object).unwrap();
    ...
    async fn _players_hide(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.players().hide(
            opt.value_of("application-id").unwrap_or(""),
    ...
    async fn _players_unhide(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.players().unhide(
            opt.value_of("application-id").unwrap_or(""),
            opt.value_of("player-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _scores_reset(
        ...
        let mut call = self
            .hub
            .scores()
            .reset(opt.value_of("leaderboard-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _scores_reset_all_for_all_players(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _scores_reset_for_all_players(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .scores()
            .reset_for_all_players(opt.value_of("leaderboard-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _scores_reset_multiple_for_all_players(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion =
                        FieldCursor::did_you_mean(key, &vec!["kind", "leaderboard-ids"]);
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
                        value.map(|v| v.to_string()),
        ...
        let mut request: api::ScoresResetMultipleForAllRequest =
            serde_json::value::from_value(object).unwrap();
        ...
        match self.opt.subcommand() {
            ("achievements", Some(opt)) => match opt.subcommand() {
                ...
                ("reset-all-for-all-players", Some(opt)) => {
                    call_result = self
                        ._achievements_reset_all_for_all_players(opt, dry_run, &mut err)
                        .await;
                }
                ("reset-for-all-players", Some(opt)) => {
                    call_result = self
                        ._achievements_reset_for_all_players(opt, dry_run, &mut err)
                        .await;
                }
                ("reset-multiple-for-all-players", Some(opt)) => {
                    call_result = self
                        ._achievements_reset_multiple_for_all_players(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
            ...
            ("events", Some(opt)) => match opt.subcommand() {
                ...
                ("reset-all-for-all-players", Some(opt)) => {
                    call_result = self
                        ._events_reset_all_for_all_players(opt, dry_run, &mut err)
                        .await;
                }
                ("reset-for-all-players", Some(opt)) => {
                    call_result = self
                        ._events_reset_for_all_players(opt, dry_run, &mut err)
                        .await;
                }
                ("reset-multiple-for-all-players", Some(opt)) => {
                    call_result = self
                        ._events_reset_multiple_for_all_players(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
            ...
            ("scores", Some(opt)) => match opt.subcommand() {
                ...
                ("reset-all-for-all-players", Some(opt)) => {
                    call_result = self
                        ._scores_reset_all_for_all_players(opt, dry_run, &mut err)
                        .await;
                }
                ("reset-for-all-players", Some(opt)) => {
                    call_result = self
                        ._scores_reset_for_all_players(opt, dry_run, &mut err)
                        .await;
                }
                ("reset-multiple-for-all-players", Some(opt)) => {
                    call_result = self
                        ._scores_reset_multiple_for_all_players(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "gamesmanagement1-management-secret.json",
        ...
        .persist_tokens_to_disk(format!("{}/gamesmanagement1-management", config_dir))
        .build()
        .await
        .unwrap();
