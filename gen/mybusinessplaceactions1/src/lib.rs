...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/mybusinessplaceactions1).
//! # Features
//!
//! Handle the following *Resources* with ease from the central [hub](MyBusinessPlaceActions) ...
//!
//! * locations
//!  * [*place action links create*](api::LocationPlaceActionLinkCreateCall), [*place action links delete*](api::LocationPlaceActionLinkDeleteCall), [*place action links get*](api::LocationPlaceActionLinkGetCall), [*place action links list*](api::LocationPlaceActionLinkListCall) and [*place action links patch*](api::LocationPlaceActionLinkPatchCall)
//! * [place action type metadata](api::PlaceActionTypeMetadata)
//!  * [*list*](api::PlaceActionTypeMetadataListCall)
//!
//!
//!
//!
...
pub mod api;
pub use api::MyBusinessPlaceActions;
