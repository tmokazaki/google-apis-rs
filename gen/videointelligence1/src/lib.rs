...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/videointelligence1).
//! # Features
//!
//! Handle the following *Resources* with ease from the central [hub](CloudVideoIntelligence) ...
//!
//! * operations
//!  * [*projects locations operations cancel*](api::OperationProjectLocationOperationCancelCall), [*projects locations operations delete*](api::OperationProjectLocationOperationDeleteCall) and [*projects locations operations get*](api::OperationProjectLocationOperationGetCall)
//! * projects
//!  * [*locations operations cancel*](api::ProjectLocationOperationCancelCall), [*locations operations delete*](api::ProjectLocationOperationDeleteCall), [*locations operations get*](api::ProjectLocationOperationGetCall) and [*locations operations list*](api::ProjectLocationOperationListCall)
//! * videos
//!  * [*annotate*](api::VideoAnnotateCall)
//!
//!
//!
//!
...
pub mod api;
pub use api::CloudVideoIntelligence;
