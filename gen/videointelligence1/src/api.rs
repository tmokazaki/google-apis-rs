...
impl common::RequestValue for GoogleCloudVideointelligenceV1_AnnotateVideoRequest {}
...
impl common::Part for GoogleCloudVideointelligenceV1_ExplicitContentDetectionConfig {}
...
impl common::Part for GoogleCloudVideointelligenceV1_FaceDetectionConfig {}
...
impl common::Part for GoogleCloudVideointelligenceV1_LabelDetectionConfig {}
...
impl common::Part for GoogleCloudVideointelligenceV1_ObjectTrackingConfig {}
...
impl common::Part for GoogleCloudVideointelligenceV1_PersonDetectionConfig {}
...
impl common::Part for GoogleCloudVideointelligenceV1_ShotChangeDetectionConfig {}
...
impl common::Part for GoogleCloudVideointelligenceV1_SpeechContext {}
...
impl common::Part for GoogleCloudVideointelligenceV1_SpeechTranscriptionConfig {}
...
impl common::Part for GoogleCloudVideointelligenceV1_TextDetectionConfig {}
...
pub struct GoogleCloudVideointelligenceV1_VideoContext {
    ...
    pub explicit_content_detection_config:
        Option<GoogleCloudVideointelligenceV1_ExplicitContentDetectionConfig>,
    /// Config for FACE_DETECTION.
    ...
    pub shot_change_detection_config:
        Option<GoogleCloudVideointelligenceV1_ShotChangeDetectionConfig>,
    /// Config for SPEECH_TRANSCRIPTION.
    #[serde(rename = "speechTranscriptionConfig")]
    pub speech_transcription_config:
        Option<GoogleCloudVideointelligenceV1_SpeechTranscriptionConfig>,
    /// Config for TEXT_DETECTION.
    #[serde(rename = "textDetectionConfig")]
    pub text_detection_config: Option<GoogleCloudVideointelligenceV1_TextDetectionConfig>,
}

impl common::Part for GoogleCloudVideointelligenceV1_VideoContext {}
...
impl common::Part for GoogleCloudVideointelligenceV1_VideoSegment {}
...
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
pub struct GoogleLongrunning_CancelOperationRequest {
    _never_set: Option<bool>,
}

impl common::RequestValue for GoogleLongrunning_CancelOperationRequest {}
...
impl common::ResponseResult for GoogleLongrunning_ListOperationsResponse {}
...
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
pub struct GoogleProtobuf_Empty {
    _never_set: Option<bool>,
}

impl common::ResponseResult for GoogleProtobuf_Empty {}
...
impl<'a, C> OperationMethods<'a, C> {
    ...
    pub fn projects_locations_operations_cancel(
        &self,
        name: &str,
    ) -> OperationProjectLocationOperationCancelCall<'a, C> {
    ...
    pub fn projects_locations_operations_delete(
        &self,
        name: &str,
    ) -> OperationProjectLocationOperationDeleteCall<'a, C> {
    ...
    pub fn projects_locations_operations_get(
        &self,
        name: &str,
    ) -> OperationProjectLocationOperationGetCall<'a, C> {
...
impl<'a, C> ProjectMethods<'a, C> {
    ...
    pub fn locations_operations_cancel(
        &self,
        request: GoogleLongrunning_CancelOperationRequest,
        name: &str,
...
impl<'a, C> VideoMethods<'a, C> {
    ...
    pub fn annotate(
        &self,
        request: GoogleCloudVideointelligenceV1_AnnotateVideoRequest,
...
/// # }
/// ```
pub struct OperationProjectLocationOperationCancelCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudVideoIntelligence<C>,
...
impl<'a, C> common::CallBuilder for OperationProjectLocationOperationCancelCall<'a, C> {}

impl<'a, C> OperationProjectLocationOperationCancelCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, GoogleProtobuf_Empty)> {
        use std::borrow::Cow;
    ...
    pub fn name(mut self, new_value: &str) -> OperationProjectLocationOperationCancelCall<'a, C> {
    ...
    pub fn add_scope<St>(mut self, scope: St) -> OperationProjectLocationOperationCancelCall<'a, C>
    where
        St: AsRef<str>,
    {
    ...
    /// for details).
    pub fn clear_scopes(mut self) -> OperationProjectLocationOperationCancelCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct OperationProjectLocationOperationDeleteCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudVideoIntelligence<C>,
...
impl<'a, C> common::CallBuilder for OperationProjectLocationOperationDeleteCall<'a, C> {}

impl<'a, C> OperationProjectLocationOperationDeleteCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> OperationProjectLocationOperationDeleteCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> OperationProjectLocationOperationDeleteCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> OperationProjectLocationOperationDeleteCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct OperationProjectLocationOperationGetCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudVideoIntelligence<C>,
...
impl<'a, C> common::CallBuilder for OperationProjectLocationOperationGetCall<'a, C> {}

impl<'a, C> OperationProjectLocationOperationGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> OperationProjectLocationOperationGetCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> OperationProjectLocationOperationGetCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> OperationProjectLocationOperationGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> OperationProjectLocationOperationGetCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> OperationProjectLocationOperationGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
    ...
    C: common::Connector,
{
    ...
    pub fn request(
        mut self,
        new_value: GoogleLongrunning_CancelOperationRequest,
    ) -> ProjectLocationOperationCancelCall<'a, C> {
    ...
    C: common::Connector,
{
    ...
    pub async fn doit(
        mut self,
    ) -> common::Result<(common::Response, GoogleLongrunning_ListOperationsResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    C: common::Connector,
{
    ...
    pub fn request(
        mut self,
        new_value: GoogleCloudVideointelligenceV1_AnnotateVideoRequest,
    ) -> VideoAnnotateCall<'a, C> {
        self._request = new_value;
        self
    }
