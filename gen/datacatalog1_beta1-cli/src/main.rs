...
use google_datacatalog1_beta1::{api, yup_oauth2, Error};
    ...
    C: apis_common::Connector,
{
    async fn _catalog_search(
        ...
        let mut request: api::GoogleCloudDatacatalogV1beta1SearchCatalogRequest =
    ...
    async fn _projects_locations_entry_groups_create(
        ...
        let mut request: api::GoogleCloudDatacatalogV1beta1EntryGroup =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
    ...
    async fn _projects_locations_entry_groups_entries_create(
        ...
        let mut request: api::GoogleCloudDatacatalogV1beta1Entry =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
    ...
    async fn _projects_locations_entry_groups_entries_tags_create(
        ...
        let mut request: api::GoogleCloudDatacatalogV1beta1Tag =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
    ...
    async fn _projects_locations_tag_templates_create(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec!["dataplex-transfer-status", "display-name", "name"],
                    );
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
        ...
        let mut request: api::GoogleCloudDatacatalogV1beta1TagTemplate =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
    ...
    async fn _projects_locations_tag_templates_fields_create(
        ...
        let mut request: api::GoogleCloudDatacatalogV1beta1TagTemplateField =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
    ...
    async fn _projects_locations_tag_templates_fields_enum_values_rename(
        ...
        let mut request: api::GoogleCloudDatacatalogV1beta1RenameTagTemplateFieldEnumValueRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
    ...
    async fn _projects_locations_tag_templates_fields_rename(
        ...
        let mut request: api::GoogleCloudDatacatalogV1beta1RenameTagTemplateFieldRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
    ...
    async fn _projects_locations_taxonomies_create(
        ...
        let mut request: api::GoogleCloudDatacatalogV1beta1Taxonomy =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
    ...
    async fn _projects_locations_taxonomies_import(
        ...
        let mut request: api::GoogleCloudDatacatalogV1beta1ImportTaxonomiesRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
    ...
    async fn _projects_locations_taxonomies_policy_tags_create(
        ...
        let mut request: api::GoogleCloudDatacatalogV1beta1PolicyTag =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "datacatalog1-beta1-secret.json",
        ...
        .persist_tokens_to_disk(format!("{}/datacatalog1-beta1", config_dir))
        .build()
        .await
        .unwrap();
    ...
    let arg_data = [
        ("catalog", "methods: 'search'", vec![
            ...
            ("locations-entry-groups-entries-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_datacatalog1_beta1_cli/projects_locations-entry-groups-entries-get",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The name of the entry. Example: * projects/{project_id}/locations/{location}/entryGroups/{entry_group_id}/entries/{entry_id}"##),
            ...
            ("locations-entry-groups-entries-list",
                    Some(r##"Lists entries."##),
                    "Details at http://byron.github.io/google-apis-rs/google_datacatalog1_beta1_cli/projects_locations-entry-groups-entries-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("locations-entry-groups-entries-patch",
                  ...
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Output only. Identifier. The Data Catalog resource name of the entry in URL format. Example: * projects/{project_id}/locations/{location}/entryGroups/{entry_group_id}/entries/{entry_id} Note that this Entry and its child resources may not actually be stored in the location in this name."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("locations-entry-groups-entries-tags-delete",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_datacatalog1_beta1_cli/projects_locations-entry-groups-entries-tags-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-entry-groups-entries-tags-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_datacatalog1_beta1_cli/projects_locations-entry-groups-entries-tags-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("locations-entry-groups-entries-tags-patch",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_datacatalog1_beta1_cli/projects_locations-entry-groups-entries-tags-patch",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Identifier. The resource name of the tag in URL format. Example: * projects/{project_id}/locations/{location}/entrygroups/{entry_group_id}/entries/{entry_id}/tags/{tag_id} where `tag_id` is a system-generated identifier. Note that this Tag may not actually be stored in the location in this name."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("locations-entry-groups-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_datacatalog1_beta1_cli/projects_locations-entry-groups-get",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The name of the entry group. For example, `projects/{project_id}/locations/{location}/entryGroups/{entry_group_id}`."##),
            ...
            ("locations-entry-groups-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_datacatalog1_beta1_cli/projects_locations-entry-groups-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("locations-entry-groups-patch",
                  ...
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Identifier. The resource name of the entry group in URL format. Example: * projects/{project_id}/locations/{location}/entryGroups/{entry_group_id} Note that this EntryGroup and its child resources may not actually be stored in the location in this name."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("locations-entry-groups-tags-delete",
                    Some(r##"Deletes a tag."##),
                    "Details at http://byron.github.io/google-apis-rs/google_datacatalog1_beta1_cli/projects_locations-entry-groups-tags-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The name of the tag to delete. Example: * projects/{project_id}/locations/{location}/entryGroups/{entry_group_id}/entries/{entry_id}/tags/{tag_id}"##),
            ...
            ("locations-entry-groups-tags-list",
                    Some(r##"Lists tags assigned to an Entry. The columns in the response are lowercased."##),
                    "Details at http://byron.github.io/google-apis-rs/google_datacatalog1_beta1_cli/projects_locations-entry-groups-tags-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The name of the Data Catalog resource to list the tags of. The resource could be an Entry or an EntryGroup. Examples: * projects/{project_id}/locations/{location}/entryGroups/{entry_group_id} * projects/{project_id}/locations/{location}/entryGroups/{entry_group_id}/entries/{entry_id}"##),
            ...
            ("locations-entry-groups-tags-patch",
                    Some(r##"Updates an existing tag."##),
                    "Details at http://byron.github.io/google-apis-rs/google_datacatalog1_beta1_cli/projects_locations-entry-groups-tags-patch",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Identifier. The resource name of the tag in URL format. Example: * projects/{project_id}/locations/{location}/entrygroups/{entry_group_id}/entries/{entry_id}/tags/{tag_id} where `tag_id` is a system-generated identifier. Note that this Tag may not actually be stored in the location in this name."##),
            ...
            ("locations-tag-templates-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_datacatalog1_beta1_cli/projects_locations-tag-templates-get",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-tag-templates-patch",
                  ...
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Identifier. The resource name of the tag template in URL format. Example: * projects/{project_id}/locations/{location}/tagTemplates/{tag_template_id} Note that this TagTemplate and its child resources may not actually be stored in the location in this name."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("locations-taxonomies-create",
                    Some(r##"Creates a taxonomy in the specified project."##),
                    "Details at http://byron.github.io/google-apis-rs/google_datacatalog1_beta1_cli/projects_locations-taxonomies-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("locations-taxonomies-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_datacatalog1_beta1_cli/projects_locations-taxonomies-get",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. Resource name of the requested taxonomy."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("locations-taxonomies-get-iam-policy",
                    Some(r##"Gets the IAM policy for a taxonomy or a policy tag."##),
                    "Details at http://byron.github.io/google-apis-rs/google_datacatalog1_beta1_cli/projects_locations-taxonomies-get-iam-policy",
                  vec![
                    (Some(r##"resource"##),
                     None,
                     Some(r##"REQUIRED: The resource for which the policy is being requested. See [Resource names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for this field."##),
            ...
            ("locations-taxonomies-patch",
                    Some(r##"Updates a taxonomy."##),
                    "Details at http://byron.github.io/google-apis-rs/google_datacatalog1_beta1_cli/projects_locations-taxonomies-patch",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-taxonomies-policy-tags-create",
                    Some(r##"Creates a policy tag in the specified taxonomy."##),
                    "Details at http://byron.github.io/google-apis-rs/google_datacatalog1_beta1_cli/projects_locations-taxonomies-policy-tags-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("locations-taxonomies-policy-tags-delete",
                    Some(r##"Deletes a policy tag. Also deletes all of its descendant policy tags."##),
                    "Details at http://byron.github.io/google-apis-rs/google_datacatalog1_beta1_cli/projects_locations-taxonomies-policy-tags-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-taxonomies-policy-tags-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_datacatalog1_beta1_cli/projects_locations-taxonomies-policy-tags-get",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. Resource name of the requested policy tag."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("locations-taxonomies-policy-tags-get-iam-policy",
                    Some(r##"Gets the IAM policy for a taxonomy or a policy tag."##),
                    "Details at http://byron.github.io/google-apis-rs/google_datacatalog1_beta1_cli/projects_locations-taxonomies-policy-tags-get-iam-policy",
                  vec![
                    (Some(r##"resource"##),
                     None,
                     Some(r##"REQUIRED: The resource for which the policy is being requested. See [Resource names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for this field."##),
            ...
            ("locations-taxonomies-policy-tags-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_datacatalog1_beta1_cli/projects_locations-taxonomies-policy-tags-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("locations-taxonomies-policy-tags-patch",
                    Some(r##"Updates a policy tag."##),
                    "Details at http://byron.github.io/google-apis-rs/google_datacatalog1_beta1_cli/projects_locations-taxonomies-policy-tags-patch",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-taxonomies-policy-tags-set-iam-policy",
                    Some(r##"Sets the IAM policy for a taxonomy or a policy tag."##),
                    "Details at http://byron.github.io/google-apis-rs/google_datacatalog1_beta1_cli/projects_locations-taxonomies-policy-tags-set-iam-policy",
                  vec![
                    (Some(r##"resource"##),
                     None,
                     Some(r##"REQUIRED: The resource for which the policy is being specified. See [Resource names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for this field."##),
            ...
            ("locations-taxonomies-set-iam-policy",
                    Some(r##"Sets the IAM policy for a taxonomy or a policy tag."##),
                    "Details at http://byron.github.io/google-apis-rs/google_datacatalog1_beta1_cli/projects_locations-taxonomies-set-iam-policy",
                  vec![
                    (Some(r##"resource"##),
                     None,
                     Some(r##"REQUIRED: The resource for which the policy is being specified. See [Resource names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for this field."##),
