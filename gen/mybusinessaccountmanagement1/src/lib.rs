...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/mybusinessaccountmanagement1).
//! # Features
//!
//! Handle the following *Resources* with ease from the central [hub](MyBusinessAccountManagement) ...
//!
//! * [accounts](api::Account)
//!  * [*admins create*](api::AccountAdminCreateCall), [*admins delete*](api::AccountAdminDeleteCall), [*admins list*](api::AccountAdminListCall), [*admins patch*](api::AccountAdminPatchCall), [*create*](api::AccountCreateCall), [*get*](api::AccountGetCall), [*invitations accept*](api::AccountInvitationAcceptCall), [*invitations decline*](api::AccountInvitationDeclineCall), [*invitations list*](api::AccountInvitationListCall), [*list*](api::AccountListCall) and [*patch*](api::AccountPatchCall)
//! * locations
//!  * [*admins create*](api::LocationAdminCreateCall), [*admins delete*](api::LocationAdminDeleteCall), [*admins list*](api::LocationAdminListCall), [*admins patch*](api::LocationAdminPatchCall) and [*transfer*](api::LocationTransferCall)
//!
//!
//!
//!
...
//!
//! * **[Hub](MyBusinessAccountManagement)**
...
pub mod api;
pub use api::MyBusinessAccountManagement;
