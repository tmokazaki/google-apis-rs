...
/// ```
#[derive(Clone)]
pub struct MyBusinessAccountManagement<C> {
...
impl<C> common::Hub for MyBusinessAccountManagement<C> {}

impl<'a, C> MyBusinessAccountManagement<C> {
    pub fn new<A: 'static + common::GetToken>(
        client: common::Client<C>,
        auth: A,
    ) -> MyBusinessAccountManagement<C> {
    ...
    /// It defaults to `https://mybusinessaccountmanagement.googleapis.com/`.
    ///
...
impl common::RequestValue for AcceptInvitationRequest {}
...
impl common::RequestValue for Admin {}
impl common::ResponseResult for Admin {}
...
impl common::RequestValue for DeclineInvitationRequest {}
...
impl common::Part for Invitation {}
...
impl common::ResponseResult for ListAccountAdminsResponse {}
...
impl common::ResponseResult for ListLocationAdminsResponse {}
...
impl common::Part for OrganizationInfo {}
...
impl common::Part for TargetLocation {}
...
impl common::RequestValue for TransferLocationRequest {}
...
where
    C: 'a,
{
    hub: &'a MyBusinessAccountManagement<C>,
}
...
impl<'a, C> AccountMethods<'a, C> {
    ...
    pub fn invitations_accept(
        &self,
        request: AcceptInvitationRequest,
        name: &str,
    ) -> AccountInvitationAcceptCall<'a, C> {
    ...
    pub fn invitations_decline(
        &self,
        request: DeclineInvitationRequest,
        name: &str,
    ) -> AccountInvitationDeclineCall<'a, C> {
    ...
    pub fn patch(&self, request: Account, name: &str) -> AccountPatchCall<'a, C> {
        AccountPatchCall {
            hub: self.hub,
            _request: request,
            _name: name.to_string(),
...
impl<'a, C> LocationMethods<'a, C> {
    ...
    pub fn admins_create(&self, request: Admin, parent: &str) -> LocationAdminCreateCall<'a, C> {
    ...
    pub fn admins_delete(&self, name: &str) -> LocationAdminDeleteCall<'a, C> {
    ...
    pub fn admins_list(&self, parent: &str) -> LocationAdminListCall<'a, C> {
    ...
    /// * `request` - No description provided.
    /// * `name` - Immutable. The resource name. For account admins, this is in the form: `accounts/{account_id}/admins/{admin_id}` For location admins, this is in the form: `locations/{location_id}/admins/{admin_id}` This field will be ignored if set during admin creation.
    pub fn admins_patch(&self, request: Admin, name: &str) -> LocationAdminPatchCall<'a, C> {
...
/// # extern crate hyper_rustls;
/// # extern crate google_mybusinessaccountmanagement1 as mybusinessaccountmanagement1;
/// use mybusinessaccountmanagement1::api::Admin;
/// # async fn dox() {
/// # use mybusinessaccountmanagement1::{MyBusinessAccountManagement, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
impl<'a, C> common::CallBuilder for AccountAdminCreateCall<'a, C> {}

impl<'a, C> AccountAdminCreateCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, Admin)> {
        use std::borrow::Cow;
        ...
        let mut url = self.hub._base_url.clone() + "v1/{+parent}/admins";
...
impl<'a, C> common::CallBuilder for AccountAdminDeleteCall<'a, C> {}

impl<'a, C> AccountAdminDeleteCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
...
impl<'a, C> common::CallBuilder for AccountAdminListCall<'a, C> {}

impl<'a, C> AccountAdminListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, ListAccountAdminsResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
...
impl<'a, C> common::CallBuilder for AccountAdminPatchCall<'a, C> {}

impl<'a, C> AccountAdminPatchCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    pub fn update_mask(mut self, new_value: common::FieldMask) -> AccountAdminPatchCall<'a, C> {
...
/// # extern crate hyper_rustls;
/// # extern crate google_mybusinessaccountmanagement1 as mybusinessaccountmanagement1;
/// use mybusinessaccountmanagement1::api::AcceptInvitationRequest;
/// # async fn dox() {
/// # use mybusinessaccountmanagement1::{MyBusinessAccountManagement, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
impl<'a, C> common::CallBuilder for AccountInvitationAcceptCall<'a, C> {}

impl<'a, C> AccountInvitationAcceptCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    pub fn request(
        mut self,
        new_value: AcceptInvitationRequest,
    ) -> AccountInvitationAcceptCall<'a, C> {
        self._request = new_value;
        self
    }
...
/// # extern crate hyper_rustls;
/// # extern crate google_mybusinessaccountmanagement1 as mybusinessaccountmanagement1;
/// use mybusinessaccountmanagement1::api::DeclineInvitationRequest;
/// # async fn dox() {
/// # use mybusinessaccountmanagement1::{MyBusinessAccountManagement, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
impl<'a, C> common::CallBuilder for AccountInvitationDeclineCall<'a, C> {}

impl<'a, C> AccountInvitationDeclineCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, Empty)> {
        ...
        params.push("alt", "json");
        let mut url = self.hub._base_url.clone() + "v1/{+name}:decline";
    ...
    pub fn request(
        mut self,
        new_value: DeclineInvitationRequest,
    ) -> AccountInvitationDeclineCall<'a, C> {
        self._request = new_value;
        self
    }
...
impl<'a, C> common::CallBuilder for AccountInvitationListCall<'a, C> {}

impl<'a, C> AccountInvitationListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, ListInvitationsResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
        ...
        params.push("alt", "json");
        let mut url = self.hub._base_url.clone() + "v1/{+parent}/invitations";
    ...
    pub fn filter(mut self, new_value: &str) -> AccountInvitationListCall<'a, C> {
...
/// # extern crate hyper_rustls;
/// # extern crate google_mybusinessaccountmanagement1 as mybusinessaccountmanagement1;
/// use mybusinessaccountmanagement1::api::Account;
/// # async fn dox() {
/// # use mybusinessaccountmanagement1::{MyBusinessAccountManagement, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
impl<'a, C> common::CallBuilder for AccountCreateCall<'a, C> {}

impl<'a, C> AccountCreateCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> AccountCreateCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    C: common::Connector,
{
    ...
    pub async fn doit(mut self) -> common::Result<(common::Response, ListAccountsResponse)> {
        ...
        for &field in ["alt", "parentAccount", "pageToken", "pageSize", "filter"].iter() {
            if self._additional_params.contains_key(field) {
                dlg.finished(false);
                return Err(common::Error::FieldClash(field));
            }
        ...
        if let Some(value) = self._parent_account.as_ref() {
            params.push("parentAccount", value);
        }
    ...
    pub fn parent_account(mut self, new_value: &str) -> AccountListCall<'a, C> {
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().patch(req, "name")
///              .validate_only(true)
///              .update_mask(FieldMask::new::<&str>(&[]))
///              .doit().await;
/// # }
    ...
    C: common::Connector,
{
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> AccountPatchCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    ...
    pub fn validate_only(mut self, new_value: bool) -> AccountPatchCall<'a, C> {
    ...
    ///
    /// Sets the *update mask* query property to the given value.
    pub fn update_mask(mut self, new_value: common::FieldMask) -> AccountPatchCall<'a, C> {
        self._update_mask = Some(new_value);
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
...
/// Invites the specified user to become an administrator for the specified location. The invitee must accept the invitation in order to be granted access to the location. See AcceptInvitation to programmatically accept an invitation.
///
/// A builder for the *admins.create* method supported by a *location* resource.
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.locations().admins_create(req, "parent")
///              .doit().await;
/// # }
/// ```
pub struct LocationAdminCreateCall<'a, C>
where
    C: 'a,
{
    hub: &'a MyBusinessAccountManagement<C>,
...
impl<'a, C> common::CallBuilder for LocationAdminCreateCall<'a, C> {}

impl<'a, C> LocationAdminCreateCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: Admin) -> LocationAdminCreateCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> LocationAdminCreateCall<'a, C> {
        self._parent = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> LocationAdminCreateCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
...
/// Removes the specified admin as a manager of the specified location.
///
/// A builder for the *admins.delete* method supported by a *location* resource.
/// It is not used directly, but through a [`LocationMethods`] instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.locations().admins_delete("name")
///              .doit().await;
/// # }
/// ```
pub struct LocationAdminDeleteCall<'a, C>
where
    C: 'a,
{
    hub: &'a MyBusinessAccountManagement<C>,
...
impl<'a, C> common::CallBuilder for LocationAdminDeleteCall<'a, C> {}

impl<'a, C> LocationAdminDeleteCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> LocationAdminDeleteCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> LocationAdminDeleteCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
...
/// Lists all of the admins for the specified location.
///
/// A builder for the *admins.list* method supported by a *location* resource.
/// It is not used directly, but through a [`LocationMethods`] instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.locations().admins_list("parent")
///              .doit().await;
/// # }
/// ```
pub struct LocationAdminListCall<'a, C>
where
    C: 'a,
{
    hub: &'a MyBusinessAccountManagement<C>,
...
impl<'a, C> common::CallBuilder for LocationAdminListCall<'a, C> {}

impl<'a, C> LocationAdminListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, ListLocationAdminsResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> LocationAdminListCall<'a, C> {
        self._parent = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> LocationAdminListCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
...
/// Updates the Admin for the specified location. Only the AdminRole of the Admin can be updated.
///
/// A builder for the *admins.patch* method supported by a *location* resource.
/// It is not used directly, but through a [`LocationMethods`] instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.locations().admins_patch(req, "name")
///              .update_mask(FieldMask::new::<&str>(&[]))
///              .doit().await;
/// # }
/// ```
pub struct LocationAdminPatchCall<'a, C>
where
    C: 'a,
{
    hub: &'a MyBusinessAccountManagement<C>,
...
impl<'a, C> common::CallBuilder for LocationAdminPatchCall<'a, C> {}

impl<'a, C> LocationAdminPatchCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: Admin) -> LocationAdminPatchCall<'a, C> {
        self._request = new_value;
        self
    }
    /// Immutable. The resource name. For account admins, this is in the form: `accounts/{account_id}/admins/{admin_id}` For location admins, this is in the form: `locations/{location_id}/admins/{admin_id}` This field will be ignored if set during admin creation.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> LocationAdminPatchCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// Required. The specific fields that should be updated. The only editable field is role.
    ///
    /// Sets the *update mask* query property to the given value.
    pub fn update_mask(mut self, new_value: common::FieldMask) -> LocationAdminPatchCall<'a, C> {
        self._update_mask = Some(new_value);
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> LocationAdminPatchCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
...
/// Moves a location from an account that the user owns to another account that the same user administers. The user must be an owner of the account the location is currently associated with and must also be at least a manager of the destination account.
///
/// A builder for the *transfer* method supported by a *location* resource.
/// It is not used directly, but through a [`LocationMethods`] instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_mybusinessaccountmanagement1 as mybusinessaccountmanagement1;
/// use mybusinessaccountmanagement1::api::TransferLocationRequest;
/// # async fn dox() {
/// # use mybusinessaccountmanagement1::{MyBusinessAccountManagement, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.locations().transfer(req, "name")
///              .doit().await;
/// # }
/// ```
pub struct LocationTransferCall<'a, C>
where
    C: 'a,
{
    hub: &'a MyBusinessAccountManagement<C>,
...
impl<'a, C> common::CallBuilder for LocationTransferCall<'a, C> {}

impl<'a, C> LocationTransferCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, Empty)> {
        ...
        params.push("alt", "json");
        let mut url = self.hub._base_url.clone() + "v1/{+name}:transfer";
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: TransferLocationRequest) -> LocationTransferCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> LocationTransferCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> LocationTransferCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
