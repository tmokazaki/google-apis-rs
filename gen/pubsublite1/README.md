...
You may alter the way an `doit()` method is called by providing a [delegate](https://docs.rs/google-pubsublite1/7.0.0+20240614/google_pubsublite1/common::Delegate) to the
