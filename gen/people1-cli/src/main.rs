...
use google_people1::{api, yup_oauth2, Error};
...
{
    async fn _contact_groups_batch_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
            ...
            .iter()
        {
            ...
            match key {
                ...
                "max-members" => {
                    call = call.max_members(
                        value
                            .map(|v| arg_from_str(v, err, "max-members", "int32"))
                            .unwrap_or(-0),
                    );
                }
                "group-fields" => {
                    call = call.group_fields(
                        value
                            .map(|v| arg_from_str(v, err, "group-fields", "google-fieldmask"))
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(
                                    ["group-fields", "max-members", "resource-names"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _contact_groups_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "contact-group.formatted-name" => Some((
                ...
                "contact-group.member-count" => Some((
                ...
                "contact-group.member-resource-names" => Some((
                ...
                "contact-group.metadata.deleted" => Some((
                    "contactGroup.metadata.deleted",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "contact-group.metadata.update-time" => Some((
                ...
                "contact-group.resource-name" => Some((
        ...
        let mut request: api::CreateContactGroupRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.contact_groups().create(request);
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _contact_groups_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .contact_groups()
            .delete(opt.value_of("resource-name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            .iter()
        {
            ...
            match key {
                "delete-contacts" => {
                    call = call.delete_contacts(
                        value
                            .map(|v| arg_from_str(v, err, "delete-contacts", "boolean"))
                            .unwrap_or(false),
                    );
                }
                _ => {
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                let mut v = Vec::new();
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(["delete-contacts"].iter().map(|v| *v));
                                v
                            }));
                    }
                }
    ...
    async fn _contact_groups_get(
        ...
        let mut call = self
            .hub
            .contact_groups()
            .get(opt.value_of("resource-name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                let mut v = Vec::new();
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(["group-fields", "max-members"].iter().map(|v| *v));
                                v
                            }));
                    }
                }
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["group-fields", "page-size", "page-token", "sync-token"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _contact_groups_members_modify(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec!["resource-names-to-add", "resource-names-to-remove"],
                    );
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
        ...
        let mut request: api::ModifyContactGroupMembersRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .contact_groups()
            .members_modify(request, opt.value_of("resource-name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _contact_groups_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::UpdateContactGroupRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .contact_groups()
            .update(request, opt.value_of("resource-name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _other_contacts_copy_other_contact_to_my_contacts_group(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion =
                        FieldCursor::did_you_mean(key, &vec!["copy-mask", "read-mask", "sources"]);
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
                        value.map(|v| v.to_string()),
        ...
        let mut request: api::CopyOtherContactToMyContactsGroupRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .other_contacts()
            .copy_other_contact_to_my_contacts_group(
                request,
                opt.value_of("resource-name").unwrap_or(""),
            );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _other_contacts_list(
            ...
            .iter()
        {
            ...
            match key {
                ...
                "request-sync-token" => {
                    call = call.request_sync_token(
                        value
                            .map(|v| arg_from_str(v, err, "request-sync-token", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "read-mask" => {
    ...
    async fn _other_contacts_search(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                let mut v = Vec::new();
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(["page-size", "query", "read-mask"].iter().map(|v| *v));
                                v
                            }));
                    }
                }
    ...
    async fn _people_batch_create_contacts(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::BatchCreateContactsRequest =
            serde_json::value::from_value(object).unwrap();
    ...
    async fn _people_batch_delete_contacts(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::BatchDeleteContactsRequest =
            serde_json::value::from_value(object).unwrap();
    ...
    async fn _people_batch_update_contacts(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec!["read-mask", "sources", "update-mask"],
                    );
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
        ...
        let mut request: api::BatchUpdateContactsRequest =
            serde_json::value::from_value(object).unwrap();
    ...
    async fn _people_connections_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .people()
            .connections_list(opt.value_of("resource-name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            .iter()
        {
            ...
            match key {
                ...
                "request-mask-include-field" => {
                    call = call.request_mask_include_field(
                        value
                            .map(|v| {
                                arg_from_str(
                                    v,
                ...
                "person-fields" => {
                    call = call.person_fields(
                        value
                            .map(|v| arg_from_str(v, err, "person-fields", "google-fieldmask"))
                            .unwrap_or(apis_common::FieldMask::default()),
                    );
                }
                "page-token" => {
    ...
    async fn _people_create_contact(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "metadata.linked-people-resource-names" => Some((
                    "metadata.linkedPeopleResourceNames",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "metadata.object-type" => Some((
                    "metadata.objectType",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                ...
                "metadata.previous-resource-names" => Some((
                    "metadata.previousResourceNames",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
        ...
        let mut request: api::Person = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.people().create_contact(request);
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _people_delete_contact(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .people()
            .delete_contact(opt.value_of("resource-name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _people_delete_contact_photo(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .people()
            .delete_contact_photo(opt.value_of("resource-name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["person-fields", "request-mask-include-field", "sources"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _people_get_batch_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _people_list_directory_people(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _people_search_contacts(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["page-size", "query", "read-mask", "sources"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _people_search_directory_people(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _people_update_contact(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .people()
            .update_contact(request, opt.value_of("resource-name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            .iter()
        {
            ...
            match key {
                "update-person-fields" => {
                    call = call.update_person_fields(
                        value
                            .map(|v| {
                                arg_from_str(v, err, "update-person-fields", "google-fieldmask")
                            })
                            .unwrap_or(apis_common::FieldMask::default()),
                    );
                }
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["person-fields", "sources", "update-person-fields"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _people_update_contact_photo(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec!["person-fields", "photo-bytes", "sources"],
                    );
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
        ...
        let mut request: api::UpdateContactPhotoRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .people()
            .update_contact_photo(request, opt.value_of("resource-name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _doit(
        ...
        match self.opt.subcommand() {
            ("contact-groups", Some(opt)) => match opt.subcommand() {
                ("batch-get", Some(opt)) => {
                ...
                ("members-modify", Some(opt)) => {
                    call_result = self
                        ._contact_groups_members_modify(opt, dry_run, &mut err)
                        .await;
                }
                ("update", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("contact-groups".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("other-contacts", Some(opt)) => match opt.subcommand() {
                ("copy-other-contact-to-my-contacts-group", Some(opt)) => {
                    call_result = self
                        ._other_contacts_copy_other_contact_to_my_contacts_group(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("other-contacts".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("people", Some(opt)) => match opt.subcommand() {
                ("batch-create-contacts", Some(opt)) => {
                    call_result = self
                        ._people_batch_create_contacts(opt, dry_run, &mut err)
                        .await;
                }
                ("batch-delete-contacts", Some(opt)) => {
                    call_result = self
                        ._people_batch_delete_contacts(opt, dry_run, &mut err)
                        .await;
                }
                ("batch-update-contacts", Some(opt)) => {
                    call_result = self
                        ._people_batch_update_contacts(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("delete-contact-photo", Some(opt)) => {
                    call_result = self
                        ._people_delete_contact_photo(opt, dry_run, &mut err)
                        .await;
                }
                ("get", Some(opt)) => {
                ...
                ("list-directory-people", Some(opt)) => {
                    call_result = self
                        ._people_list_directory_people(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("search-directory-people", Some(opt)) => {
                    call_result = self
                        ._people_search_directory_people(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("update-contact-photo", Some(opt)) => {
                    call_result = self
                        ._people_update_contact_photo(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("people".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            _ => {
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "people1-secret.json",
        ...
        .persist_tokens_to_disk(format!("{}/people1", config_dir))
        .build()
        .await
        .unwrap();
...
async fn main() {
    ...
    let arg_data = [
        ("contact-groups", "methods: 'batch-get', 'create', 'delete', 'get', 'list', 'members-modify' and 'update'", vec![
            ...
            ("create",
                    Some(r##"Create a new contact group owned by the authenticated user. Created contact group names must be unique to the users contact groups. Attempting to create a group with a duplicate name will return a HTTP 409 error. Mutate requests for the same user should be sent sequentially to avoid increased latency and failures."##),
                    "Details at http://byron.github.io/google-apis-rs/google_people1_cli/contact-groups_create",
                  vec![
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("delete",
                    Some(r##"Delete an existing contact group owned by the authenticated user by specifying a contact group resource name. Mutate requests for the same user should be sent sequentially to avoid increased latency and failures."##),
            ...
            ("update",
                    Some(r##"Update the name of an existing contact group owned by the authenticated user. Updated contact group names must be unique to the users contact groups. Attempting to create a group with a duplicate name will return a HTTP 409 error. Mutate requests for the same user should be sent sequentially to avoid increased latency and failures."##),
            ...
            ("copy-other-contact-to-my-contacts-group",
                    Some(r##"Copies an "Other contact" to a new contact in the user's "myContacts" group Mutate requests for the same user should be sent sequentially to avoid increased latency and failures."##),
            ...
            ("search",
                    Some(r##"Provides a list of contacts in the authenticated user's other contacts that matches the search query. The query matches on a contact's `names`, `emailAddresses`, and `phoneNumbers` fields that are from the OTHER_CONTACT source. **IMPORTANT**: Before searching, clients should send a warmup request with an empty query to update the cache. See https://developers.google.com/people/v1/other-contacts#search_the_users_other_contacts"##),
            ...
            ("batch-create-contacts",
                    Some(r##"Create a batch of new contacts and return the PersonResponses for the newly Mutate requests for the same user should be sent sequentially to avoid increased latency and failures."##),
            ...
            ("batch-delete-contacts",
                    Some(r##"Delete a batch of contacts. Any non-contact data will not be deleted. Mutate requests for the same user should be sent sequentially to avoid increased latency and failures."##),
            ...
            ("batch-update-contacts",
                    Some(r##"Update a batch of contacts and return a map of resource names to PersonResponses for the updated contacts. Mutate requests for the same user should be sent sequentially to avoid increased latency and failures."##),
            ...
            ("delete-contact",
                    Some(r##"Delete a contact person. Any non-contact data will not be deleted. Mutate requests for the same user should be sent sequentially to avoid increased latency and failures."##),
                    "Details at http://byron.github.io/google-apis-rs/google_people1_cli/people_delete-contact",
                  vec![
                    (Some(r##"resource-name"##),
                     None,
            ...
            ("delete-contact-photo",
                    Some(r##"Delete a contact's photo. Mutate requests for the same user should be done sequentially to avoid // lock contention."##),
            ...
            ("list-directory-people",
                    Some(r##"Provides a list of domain profiles and domain contacts in the authenticated user's domain directory. When the `sync_token` is specified, resources deleted since the last sync will be returned as a person with `PersonMetadata.deleted` set to true. When the `page_token` or `sync_token` is specified, all other request parameters must match the first call. Writes may have a propagation delay of several minutes for sync requests. Incremental syncs are not intended for read-after-write use cases. See example usage at [List the directory people that have changed](/people/v1/directory#list_the_directory_people_that_have_changed)."##),
            ...
            ("search-contacts",
                    Some(r##"Provides a list of contacts in the authenticated user's grouped contacts that matches the search query. The query matches on a contact's `names`, `nickNames`, `emailAddresses`, `phoneNumbers`, and `organizations` fields that are from the CONTACT source. **IMPORTANT**: Before searching, clients should send a warmup request with an empty query to update the cache. See https://developers.google.com/people/v1/contacts#search_the_users_contacts"##),
            ...
            ("update-contact-photo",
                    Some(r##"Update a contact's photo. Mutate requests for the same user should be sent sequentially to avoid increased latency and failures."##),
