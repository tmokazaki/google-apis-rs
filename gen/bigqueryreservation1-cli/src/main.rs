...
use google_bigqueryreservation1::{api, yup_oauth2, Error};
...
{
    async fn _projects_locations_capacity_commitments_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        ...
        let mut request: api::CapacityCommitment = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_capacity_commitments_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            .iter()
        {
            ...
            match key {
                "enforce-single-admin-project-per-org" => {
                    call = call.enforce_single_admin_project_per_org(
                        value
                            .map(|v| {
                                arg_from_str(
                                    v,
    ...
    async fn _projects_locations_capacity_commitments_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_capacity_commitments_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_capacity_commitments_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_capacity_commitments_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_capacity_commitments_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_capacity_commitments_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_capacity_commitments_merge(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion =
                        FieldCursor::did_you_mean(key, &vec!["capacity-commitment-ids"]);
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
                        value.map(|v| v.to_string()),
        ...
        let mut request: api::MergeCapacityCommitmentsRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_capacity_commitments_merge(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_capacity_commitments_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_capacity_commitments_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_capacity_commitments_split(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(key, &vec!["slot-count"]);
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
                        value.map(|v| v.to_string()),
        ...
        let mut request: api::SplitCapacityCommitmentRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_capacity_commitments_split(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_get_bi_reservation(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_get_bi_reservation(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_reservations_assignments_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec!["assignee", "job-type", "name", "state"],
                    );
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
        ...
        let mut request: api::Assignment = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_reservations_assignments_create(
                request,
            ...
            .iter()
        {
            ...
            match key {
                "assignment-id" => {
                    call = call.assignment_id(value.unwrap_or(""));
                }
                _ => {
                    let mut found = false;
                    for param in &self.gp {
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                let mut v = Vec::new();
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(["assignment-id"].iter().map(|v| *v));
                                v
                            }));
                    }
                }
    ...
    async fn _projects_locations_reservations_assignments_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_reservations_assignments_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_reservations_assignments_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_reservations_assignments_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_reservations_assignments_move(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion =
                        FieldCursor::did_you_mean(key, &vec!["assignment-id", "destination-id"]);
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
                        value.map(|v| v.to_string()),
        ...
        let mut request: api::MoveAssignmentRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_reservations_assignments_move(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_reservations_assignments_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_reservations_assignments_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_reservations_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "original-primary-location" => Some((
        ...
        let mut call = self
            .hub
            .projects()
            .locations_reservations_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_reservations_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_reservations_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_reservations_failover_reservation(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::FailoverReservationRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_reservations_failover_reservation(
                request,
    ...
    async fn _projects_locations_reservations_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_reservations_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_reservations_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_reservations_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_reservations_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_reservations_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_search_all_assignments(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_search_all_assignments(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_search_assignments(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_search_assignments(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_update_bi_reservation(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion =
                        FieldCursor::did_you_mean(key, &vec!["name", "size", "update-time"]);
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
                        value.map(|v| v.to_string()),
        ...
        let mut request: api::BiReservation = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_update_bi_reservation(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
        ...
        match self.opt.subcommand() {
            ("projects", Some(opt)) => match opt.subcommand() {
                ("locations-capacity-commitments-create", Some(opt)) => {
                    call_result = self
                        ._projects_locations_capacity_commitments_create(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-capacity-commitments-delete", Some(opt)) => {
                    call_result = self
                        ._projects_locations_capacity_commitments_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-capacity-commitments-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_capacity_commitments_get(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-capacity-commitments-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_capacity_commitments_list(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-capacity-commitments-merge", Some(opt)) => {
                    call_result = self
                        ._projects_locations_capacity_commitments_merge(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-capacity-commitments-patch", Some(opt)) => {
                    call_result = self
                        ._projects_locations_capacity_commitments_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-capacity-commitments-split", Some(opt)) => {
                    call_result = self
                        ._projects_locations_capacity_commitments_split(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-get-bi-reservation", Some(opt)) => {
                    call_result = self
                        ._projects_locations_get_bi_reservation(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-reservations-assignments-create", Some(opt)) => {
                    call_result = self
                        ._projects_locations_reservations_assignments_create(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-reservations-assignments-delete", Some(opt)) => {
                    call_result = self
                        ._projects_locations_reservations_assignments_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-reservations-assignments-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_reservations_assignments_list(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-reservations-assignments-move", Some(opt)) => {
                    call_result = self
                        ._projects_locations_reservations_assignments_move(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-reservations-assignments-patch", Some(opt)) => {
                    call_result = self
                        ._projects_locations_reservations_assignments_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-reservations-create", Some(opt)) => {
                    call_result = self
                        ._projects_locations_reservations_create(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-reservations-delete", Some(opt)) => {
                    call_result = self
                        ._projects_locations_reservations_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-reservations-failover-reservation", Some(opt)) => {
                    call_result = self
                        ._projects_locations_reservations_failover_reservation(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-reservations-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_reservations_get(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-reservations-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_reservations_list(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-reservations-patch", Some(opt)) => {
                    call_result = self
                        ._projects_locations_reservations_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-search-all-assignments", Some(opt)) => {
                    call_result = self
                        ._projects_locations_search_all_assignments(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-search-assignments", Some(opt)) => {
                    call_result = self
                        ._projects_locations_search_assignments(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-update-bi-reservation", Some(opt)) => {
                    call_result = self
                        ._projects_locations_update_bi_reservation(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "bigqueryreservation1-secret.json",
        ...
        .persist_tokens_to_disk(format!("{}/bigqueryreservation1", config_dir))
        .build()
        .await
        .unwrap();
...
async fn main() {
    ...
    let arg_data = [
        ("projects", "methods: 'locations-capacity-commitments-create', 'locations-capacity-commitments-delete', 'locations-capacity-commitments-get', 'locations-capacity-commitments-list', 'locations-capacity-commitments-merge', 'locations-capacity-commitments-patch', 'locations-capacity-commitments-split', 'locations-get-bi-reservation', 'locations-reservations-assignments-create', 'locations-reservations-assignments-delete', 'locations-reservations-assignments-list', 'locations-reservations-assignments-move', 'locations-reservations-assignments-patch', 'locations-reservations-create', 'locations-reservations-delete', 'locations-reservations-failover-reservation', 'locations-reservations-get', 'locations-reservations-list', 'locations-reservations-patch', 'locations-search-all-assignments', 'locations-search-assignments' and 'locations-update-bi-reservation'", vec![
            ...
            ("locations-capacity-commitments-get",
                    Some(r##"Returns information about the capacity commitment."##),
                    "Details at http://byron.github.io/google-apis-rs/google_bigqueryreservation1_cli/projects_locations-capacity-commitments-get",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-capacity-commitments-list",
                    Some(r##"Lists all the capacity commitments for the admin project."##),
                    "Details at http://byron.github.io/google-apis-rs/google_bigqueryreservation1_cli/projects_locations-capacity-commitments-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. Resource name of the parent reservation. E.g., `projects/myproject/locations/US`"##),
            ...
            ("locations-get-bi-reservation",
                    Some(r##"Retrieves a BI reservation."##),
                    "Details at http://byron.github.io/google-apis-rs/google_bigqueryreservation1_cli/projects_locations-get-bi-reservation",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-reservations-list",
                    Some(r##"Lists all the reservations for the project in the specified location."##),
                    "Details at http://byron.github.io/google-apis-rs/google_bigqueryreservation1_cli/projects_locations-reservations-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("locations-reservations-patch",
                    Some(r##"Updates an existing reservation resource."##),
                    "Details at http://byron.github.io/google-apis-rs/google_bigqueryreservation1_cli/projects_locations-reservations-patch",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-search-assignments",
                    Some(r##"Deprecated: Looks up assignments for a specified resource for a particular region. If the request is about a project: 1. Assignments created on the project will be returned if they exist. 2. Otherwise assignments created on the closest ancestor will be returned. 3. Assignments for different JobTypes will all be returned. The same logic applies if the request is about a folder. If the request is about an organization, then assignments created on the organization will be returned (organization doesn't have ancestors). Comparing to ListAssignments, there are some behavior differences: 1. permission on the assignee will be verified in this API. 2. Hierarchy lookup (project->folder->organization) happens in this API. 3. Parent here is `projects/*/locations/*`, instead of `projects/*/locations/*reservations/*`. **Note** "-" cannot be used for projects nor locations."##),
