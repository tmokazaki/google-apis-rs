...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/datafusion1).
//! # Features
//!
//! Handle the following *Resources* with ease from the central [hub](DataFusion) ...
//!
//! * projects
//!  * [*locations get*](api::ProjectLocationGetCall), [*locations instances create*](api::ProjectLocationInstanceCreateCall), [*locations instances delete*](api::ProjectLocationInstanceDeleteCall), [*locations instances dns peerings create*](api::ProjectLocationInstanceDnsPeeringCreateCall), [*locations instances dns peerings delete*](api::ProjectLocationInstanceDnsPeeringDeleteCall), [*locations instances dns peerings list*](api::ProjectLocationInstanceDnsPeeringListCall), [*locations instances get*](api::ProjectLocationInstanceGetCall), [*locations instances get iam policy*](api::ProjectLocationInstanceGetIamPolicyCall), [*locations instances list*](api::ProjectLocationInstanceListCall), [*locations instances patch*](api::ProjectLocationInstancePatchCall), [*locations instances restart*](api::ProjectLocationInstanceRestartCall), [*locations instances set iam policy*](api::ProjectLocationInstanceSetIamPolicyCall), [*locations instances test iam permissions*](api::ProjectLocationInstanceTestIamPermissionCall), [*locations list*](api::ProjectLocationListCall), [*locations operations cancel*](api::ProjectLocationOperationCancelCall), [*locations operations delete*](api::ProjectLocationOperationDeleteCall), [*locations operations get*](api::ProjectLocationOperationGetCall), [*locations operations list*](api::ProjectLocationOperationListCall) and [*locations versions list*](api::ProjectLocationVersionListCall)
//!
//!
//!
//!
