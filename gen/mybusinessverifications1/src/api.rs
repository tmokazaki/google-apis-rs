...
/// Central instance to access all MyBusinessVerifications related resource activities
///
/// # Examples
///
...
/// ```
#[derive(Clone)]
pub struct MyBusinessVerifications<C> {
...
impl<C> common::Hub for MyBusinessVerifications<C> {}

impl<'a, C> MyBusinessVerifications<C> {
    pub fn new<A: 'static + common::GetToken>(
        client: common::Client<C>,
        auth: A,
    ) -> MyBusinessVerifications<C> {
    ...
    /// It defaults to `https://mybusinessverifications.googleapis.com/`.
    ///
...
impl common::Part for AddressVerificationData {}
...
impl common::RequestValue for CompleteVerificationRequest {}
...
impl common::ResponseResult for CompleteVerificationResponse {}
...
impl common::Part for ComplyWithGuidelines {}
...
impl common::Part for EmailVerificationData {}
...
impl common::RequestValue for FetchVerificationOptionsRequest {}
...
impl common::ResponseResult for FetchVerificationOptionsResponse {}
...
impl common::ResponseResult for ListVerificationsResponse {}
...
impl common::Part for ResolveOwnershipConflict {}
...
impl common::Part for ServiceBusinessContext {}
...
impl common::Part for Verification {}
...
impl common::Part for VerificationOption {}
...
impl common::Part for VerificationToken {}
...
impl common::RequestValue for VerifyLocationRequest {}
...
impl common::ResponseResult for VerifyLocationResponse {}
...
impl common::ResponseResult for VoiceOfMerchantState {}
...
impl common::Part for WaitForVoiceOfMerchant {}
...
where
    C: 'a,
{
    hub: &'a MyBusinessVerifications<C>,
}
...
impl<'a, C> LocationMethods<'a, C> {
    ...
    pub fn fetch_verification_options(
        &self,
    ...
    pub fn get_voice_of_merchant_state(
        &self,
        name: &str,
...
/// Completes a `PENDING` verification. It is only necessary for non `AUTO` verification methods. `AUTO` verification request is instantly `VERIFIED` upon creation.
///
/// A builder for the *verifications.complete* method supported by a *location* resource.
...
/// # extern crate hyper_rustls;
/// # extern crate google_mybusinessverifications1 as mybusinessverifications1;
/// use mybusinessverifications1::api::CompleteVerificationRequest;
/// # async fn dox() {
/// # use mybusinessverifications1::{MyBusinessVerifications, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.locations().verifications_complete(req, "name")
///              .doit().await;
/// # }
/// ```
pub struct LocationVerificationCompleteCall<'a, C>
where
    C: 'a,
{
    hub: &'a MyBusinessVerifications<C>,
...
impl<'a, C> common::CallBuilder for LocationVerificationCompleteCall<'a, C> {}

impl<'a, C> LocationVerificationCompleteCall<'a, C>
where
    C: common::Connector,
{
    ...
    pub async fn doit(
        mut self,
    ) -> common::Result<(common::Response, CompleteVerificationResponse)> {
        use std::borrow::Cow;
    ...
    pub fn request(
        mut self,
        new_value: CompleteVerificationRequest,
    ) -> LocationVerificationCompleteCall<'a, C> {
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> LocationVerificationCompleteCall<'a, C> {
    ...
    pub fn param<T>(mut self, name: T, value: T) -> LocationVerificationCompleteCall<'a, C>
    where
        T: AsRef<str>,
    {
...
/// List verifications of a location, ordered by create time.
///
/// A builder for the *verifications.list* method supported by a *location* resource.
/// It is not used directly, but through a [`LocationMethods`] instance.
///
/// # Example
///
...
/// # }
/// ```
pub struct LocationVerificationListCall<'a, C>
where
    C: 'a,
{
    hub: &'a MyBusinessVerifications<C>,
...
impl<'a, C> common::CallBuilder for LocationVerificationListCall<'a, C> {}

impl<'a, C> LocationVerificationListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, ListVerificationsResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
        ...
        params.push("alt", "json");
        let mut url = self.hub._base_url.clone() + "v1/{+parent}/verifications";
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> LocationVerificationListCall<'a, C> {
    ...
    pub fn page_token(mut self, new_value: &str) -> LocationVerificationListCall<'a, C> {
    ...
    pub fn page_size(mut self, new_value: i32) -> LocationVerificationListCall<'a, C> {
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> LocationVerificationListCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
...
/// Reports all eligible verification options for a location in a specific language.
///
/// A builder for the *fetchVerificationOptions* method supported by a *location* resource.
/// It is not used directly, but through a [`LocationMethods`] instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_mybusinessverifications1 as mybusinessverifications1;
/// use mybusinessverifications1::api::FetchVerificationOptionsRequest;
/// # async fn dox() {
/// # use mybusinessverifications1::{MyBusinessVerifications, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.locations().fetch_verification_options(req, "location")
///              .doit().await;
/// # }
/// ```
pub struct LocationFetchVerificationOptionCall<'a, C>
where
    C: 'a,
{
    hub: &'a MyBusinessVerifications<C>,
...
impl<'a, C> common::CallBuilder for LocationFetchVerificationOptionCall<'a, C> {}

impl<'a, C> LocationFetchVerificationOptionCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(
        mut self,
    ) -> common::Result<(common::Response, FetchVerificationOptionsResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
        ...
        params.push("alt", "json");
        let mut url = self.hub._base_url.clone() + "v1/{+location}:fetchVerificationOptions";
    ...
    pub fn request(
        mut self,
        new_value: FetchVerificationOptionsRequest,
    ) -> LocationFetchVerificationOptionCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn location(mut self, new_value: &str) -> LocationFetchVerificationOptionCall<'a, C> {
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> LocationFetchVerificationOptionCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
...
/// Gets the VoiceOfMerchant state.
///
/// A builder for the *getVoiceOfMerchantState* method supported by a *location* resource.
/// It is not used directly, but through a [`LocationMethods`] instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.locations().get_voice_of_merchant_state("name")
///              .doit().await;
/// # }
/// ```
pub struct LocationGetVoiceOfMerchantStateCall<'a, C>
where
    C: 'a,
{
    hub: &'a MyBusinessVerifications<C>,
...
impl<'a, C> common::CallBuilder for LocationGetVoiceOfMerchantStateCall<'a, C> {}

impl<'a, C> LocationGetVoiceOfMerchantStateCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, VoiceOfMerchantState)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
        ...
        params.push("alt", "json");
        let mut url = self.hub._base_url.clone() + "v1/{+name}/VoiceOfMerchantState";
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> LocationGetVoiceOfMerchantStateCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> LocationGetVoiceOfMerchantStateCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
...
/// Starts the verification process for a location.
///
/// A builder for the *verify* method supported by a *location* resource.
/// It is not used directly, but through a [`LocationMethods`] instance.
///
/// # Example
///
...
/// # }
/// ```
pub struct LocationVerifyCall<'a, C>
where
    C: 'a,
{
    hub: &'a MyBusinessVerifications<C>,
...
impl<'a, C> common::CallBuilder for LocationVerifyCall<'a, C> {}

impl<'a, C> LocationVerifyCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, VerifyLocationResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: VerifyLocationRequest) -> LocationVerifyCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> LocationVerifyCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> LocationVerifyCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
