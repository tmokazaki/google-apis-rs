...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/cloudcommerceprocurement1).
//! # Features
//!
//! Handle the following *Resources* with ease from the central [hub](CloudCommercePartnerProcurementService) ...
//!
//! * providers
//!  * [*accounts approve*](api::ProviderAccountApproveCall), [*accounts get*](api::ProviderAccountGetCall), [*accounts list*](api::ProviderAccountListCall), [*accounts reject*](api::ProviderAccountRejectCall), [*accounts reset*](api::ProviderAccountResetCall), [*entitlements approve*](api::ProviderEntitlementApproveCall), [*entitlements approve plan change*](api::ProviderEntitlementApprovePlanChangeCall), [*entitlements get*](api::ProviderEntitlementGetCall), [*entitlements list*](api::ProviderEntitlementListCall), [*entitlements patch*](api::ProviderEntitlementPatchCall), [*entitlements reject*](api::ProviderEntitlementRejectCall), [*entitlements reject plan change*](api::ProviderEntitlementRejectPlanChangeCall) and [*entitlements suspend*](api::ProviderEntitlementSuspendCall)
//!
//!
//!
//!
...
//!
//! * **[Hub](CloudCommercePartnerProcurementService)**
...
pub mod api;
pub use api::CloudCommercePartnerProcurementService;
