...
/// ```
#[derive(Clone)]
pub struct CloudCommercePartnerProcurementService<C> {
...
impl<C> common::Hub for CloudCommercePartnerProcurementService<C> {}

impl<'a, C> CloudCommercePartnerProcurementService<C> {
    pub fn new<A: 'static + common::GetToken>(
        client: common::Client<C>,
        auth: A,
    ) -> CloudCommercePartnerProcurementService<C> {
        CloudCommercePartnerProcurementService {
            client,
            auth: Box::new(auth),
            _user_agent: "google-api-rust-client/7.0.0".to_string(),
            _base_url: "https://cloudcommerceprocurement.googleapis.com/".to_string(),
            _root_url: "https://cloudcommerceprocurement.googleapis.com/".to_string(),
        }
    }

    pub fn providers(&'a self) -> ProviderMethods<'a, C> {
        ProviderMethods { hub: self }
    }
    ...
    /// It defaults to `https://cloudcommerceprocurement.googleapis.com/`.
    ///
...
///
/// * [accounts reset providers](ProviderAccountResetCall) (request)
...
impl common::RequestValue for ResetAccountRequest {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [entitlements reject plan change providers](ProviderEntitlementRejectPlanChangeCall) (request)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
pub struct RejectEntitlementPlanChangeRequest {
    ...
    #[serde(rename = "pendingPlanName")]
    pub pending_plan_name: Option<String>,
}

impl common::RequestValue for RejectEntitlementPlanChangeRequest {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [accounts reject providers](ProviderAccountRejectCall) (request)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
...
impl common::RequestValue for RejectAccountRequest {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [accounts list providers](ProviderAccountListCall) (response)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [entitlements list providers](ProviderEntitlementListCall) (response)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
...
impl common::ResponseResult for ListEntitlementsResponse {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [entitlements get providers](ProviderEntitlementGetCall) (response)
/// * [entitlements patch providers](ProviderEntitlementPatchCall) (request|response)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
pub struct Entitlement {
    ...
    #[serde(rename = "quoteExternalName")]
    ...
    pub subscription_end_time: Option<chrono::DateTime<chrono::offset::Utc>>,
    ...
    #[serde(rename = "newOfferStartTime")]
    pub new_offer_start_time: Option<chrono::DateTime<chrono::offset::Utc>>,
    ...
    #[serde(rename = "newOfferEndTime")]
    pub new_offer_end_time: Option<chrono::DateTime<chrono::offset::Utc>>,
    ...
    #[serde(rename = "newPendingOfferDuration")]
    ...
    #[serde(rename = "offerEndTime")]
    pub offer_end_time: Option<chrono::DateTime<chrono::offset::Utc>>,
    ...
    #[serde(rename = "entitlementBenefitIds")]
    ...
    pub input_properties: Option<HashMap<String, serde_json::Value>>,
}

impl common::RequestValue for Entitlement {}
impl common::ResponseResult for Entitlement {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [accounts approve providers](ProviderAccountApproveCall) (request)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
...
impl common::RequestValue for ApproveAccountRequest {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [entitlements suspend providers](ProviderEntitlementSuspendCall) (response)
/// * [entitlements reject plan change providers](ProviderEntitlementRejectPlanChangeCall) (response)
/// * [entitlements approve providers](ProviderEntitlementApproveCall) (response)
/// * [entitlements approve plan change providers](ProviderEntitlementApprovePlanChangeCall) (response)
/// * [entitlements reject providers](ProviderEntitlementRejectCall) (response)
/// * [accounts approve providers](ProviderAccountApproveCall) (response)
/// * [accounts reject providers](ProviderAccountRejectCall) (response)
/// * [accounts reset providers](ProviderAccountResetCall) (response)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
pub struct Empty {
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [entitlements suspend providers](ProviderEntitlementSuspendCall) (request)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
...
impl common::RequestValue for SuspendEntitlementRequest {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [entitlements reject providers](ProviderEntitlementRejectCall) (request)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
...
impl common::RequestValue for RejectEntitlementRequest {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [accounts get providers](ProviderAccountGetCall) (response)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
pub struct Account {
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [entitlements approve providers](ProviderEntitlementApproveCall) (request)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [entitlements approve plan change providers](ProviderEntitlementApprovePlanChangeCall) (request)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
...
impl common::RequestValue for ApproveEntitlementPlanChangeRequest {}
...
where
    C: 'a,
{
    hub: &'a CloudCommercePartnerProcurementService<C>,
}

impl<'a, C> common::MethodsBuilder for ProviderMethods<'a, C> {}
...
impl<'a, C> ProviderMethods<'a, C> {
    ...
    pub fn entitlements_reject_plan_change(
        &self,
    ...
    /// * `request` - No description provided.
    /// * `name` - Required. The resource name of the entitlement.
    pub fn entitlements_approve_plan_change(
        &self,
...
/// Requests suspension of an active Entitlement. This is not yet supported.
///
/// A builder for the *entitlements.suspend* method supported by a *provider* resource.
/// It is not used directly, but through a [`ProviderMethods`] instance.
///
/// # Example
///
...
/// # }
/// ```
pub struct ProviderEntitlementSuspendCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudCommercePartnerProcurementService<C>,
    _request: SuspendEntitlementRequest,
    _name: String,
...
impl<'a, C> common::CallBuilder for ProviderEntitlementSuspendCall<'a, C> {}

impl<'a, C> ProviderEntitlementSuspendCall<'a, C>
where
    C: common::Connector,
{
    ...
    pub fn request(
        mut self,
        new_value: SuspendEntitlementRequest,
    ) -> ProviderEntitlementSuspendCall<'a, C> {
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProviderEntitlementSuspendCall<'a, C> {
    ...
    pub fn param<T>(mut self, name: T, value: T) -> ProviderEntitlementSuspendCall<'a, C>
    where
        T: AsRef<str>,
    {
    ...
    pub fn add_scope<St>(mut self, scope: St) -> ProviderEntitlementSuspendCall<'a, C>
    where
        St: AsRef<str>,
    {
    ...
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProviderEntitlementSuspendCall<'a, C>
    where
    ...
    /// for details).
    pub fn clear_scopes(mut self) -> ProviderEntitlementSuspendCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Rejects an entitlement plan change that is in the EntitlementState.ENTITLEMENT_PENDING_PLAN_CHANGE_APPROVAL state. This method is invoked by the provider to reject the plan change on the entitlement resource.
///
/// A builder for the *entitlements.rejectPlanChange* method supported by a *provider* resource.
/// It is not used directly, but through a [`ProviderMethods`] instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_cloudcommerceprocurement1 as cloudcommerceprocurement1;
/// use cloudcommerceprocurement1::api::RejectEntitlementPlanChangeRequest;
/// # async fn dox() {
/// # use cloudcommerceprocurement1::{CloudCommercePartnerProcurementService, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = RejectEntitlementPlanChangeRequest::default();
///
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.providers().entitlements_reject_plan_change(req, "name")
///              .doit().await;
/// # }
/// ```
pub struct ProviderEntitlementRejectPlanChangeCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudCommercePartnerProcurementService<C>,
...
impl<'a, C> common::CallBuilder for ProviderEntitlementRejectPlanChangeCall<'a, C> {}

impl<'a, C> ProviderEntitlementRejectPlanChangeCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, Empty)> {
        ...
        params.push("alt", "json");
        let mut url = self.hub._base_url.clone() + "v1/{+name}:rejectPlanChange";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string());
        }
    ...
    pub fn request(
        mut self,
        new_value: RejectEntitlementPlanChangeRequest,
    ) -> ProviderEntitlementRejectPlanChangeCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProviderEntitlementRejectPlanChangeCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *fields* (query-string) - Selector specifying which fields to include in a partial response.
    /// * *$.xgafv* (query-string) - V1 error format.
    pub fn param<T>(mut self, name: T, value: T) -> ProviderEntitlementRejectPlanChangeCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProviderEntitlementRejectPlanChangeCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProviderEntitlementRejectPlanChangeCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProviderEntitlementRejectPlanChangeCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Gets a requested Entitlement resource.
///
/// A builder for the *entitlements.get* method supported by a *provider* resource.
/// It is not used directly, but through a [`ProviderMethods`] instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.providers().entitlements_get("name")
///              .doit().await;
/// # }
/// ```
pub struct ProviderEntitlementGetCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudCommercePartnerProcurementService<C>,
...
impl<'a, C> common::CallBuilder for ProviderEntitlementGetCall<'a, C> {}

impl<'a, C> ProviderEntitlementGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, Entitlement)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProviderEntitlementGetCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    pub fn delegate(
        mut self,
        new_value: &'a mut dyn common::Delegate,
    ) -> ProviderEntitlementGetCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *fields* (query-string) - Selector specifying which fields to include in a partial response.
    /// * *$.xgafv* (query-string) - V1 error format.
    pub fn param<T>(mut self, name: T, value: T) -> ProviderEntitlementGetCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProviderEntitlementGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProviderEntitlementGetCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProviderEntitlementGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Approves an entitlement that is in the EntitlementState.ENTITLEMENT_ACTIVATION_REQUESTED state. This method is invoked by the provider to approve the creation of the entitlement resource.
///
/// A builder for the *entitlements.approve* method supported by a *provider* resource.
/// It is not used directly, but through a [`ProviderMethods`] instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_cloudcommerceprocurement1 as cloudcommerceprocurement1;
/// use cloudcommerceprocurement1::api::ApproveEntitlementRequest;
/// # async fn dox() {
/// # use cloudcommerceprocurement1::{CloudCommercePartnerProcurementService, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = ApproveEntitlementRequest::default();
///
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.providers().entitlements_approve(req, "name")
///              .doit().await;
/// # }
/// ```
pub struct ProviderEntitlementApproveCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudCommercePartnerProcurementService<C>,
...
impl<'a, C> common::CallBuilder for ProviderEntitlementApproveCall<'a, C> {}

impl<'a, C> ProviderEntitlementApproveCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    pub fn request(
        mut self,
        new_value: ApproveEntitlementRequest,
    ) -> ProviderEntitlementApproveCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProviderEntitlementApproveCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *fields* (query-string) - Selector specifying which fields to include in a partial response.
    /// * *$.xgafv* (query-string) - V1 error format.
    pub fn param<T>(mut self, name: T, value: T) -> ProviderEntitlementApproveCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProviderEntitlementApproveCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProviderEntitlementApproveCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProviderEntitlementApproveCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Lists Entitlements for which the provider has read access.
///
/// A builder for the *entitlements.list* method supported by a *provider* resource.
/// It is not used directly, but through a [`ProviderMethods`] instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.providers().entitlements_list("parent")
///              .page_token("amet.")
///              .page_size(-59)
///              .filter("amet.")
///              .doit().await;
/// # }
/// ```
pub struct ProviderEntitlementListCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudCommercePartnerProcurementService<C>,
...
impl<'a, C> common::CallBuilder for ProviderEntitlementListCall<'a, C> {}

impl<'a, C> ProviderEntitlementListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, ListEntitlementsResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> ProviderEntitlementListCall<'a, C> {
    ...
    pub fn page_token(mut self, new_value: &str) -> ProviderEntitlementListCall<'a, C> {
    ...
    pub fn page_size(mut self, new_value: i32) -> ProviderEntitlementListCall<'a, C> {
    ...
    pub fn filter(mut self, new_value: &str) -> ProviderEntitlementListCall<'a, C> {
    ...
    /// * *fields* (query-string) - Selector specifying which fields to include in a partial response.
    /// * *$.xgafv* (query-string) - V1 error format.
    pub fn param<T>(mut self, name: T, value: T) -> ProviderEntitlementListCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProviderEntitlementListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProviderEntitlementListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProviderEntitlementListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Approves an entitlement plan change that is in the EntitlementState.ENTITLEMENT_PENDING_PLAN_CHANGE_APPROVAL state. This method is invoked by the provider to approve the plan change on the entitlement resource.
///
/// A builder for the *entitlements.approvePlanChange* method supported by a *provider* resource.
/// It is not used directly, but through a [`ProviderMethods`] instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_cloudcommerceprocurement1 as cloudcommerceprocurement1;
/// use cloudcommerceprocurement1::api::ApproveEntitlementPlanChangeRequest;
/// # async fn dox() {
/// # use cloudcommerceprocurement1::{CloudCommercePartnerProcurementService, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = ApproveEntitlementPlanChangeRequest::default();
///
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.providers().entitlements_approve_plan_change(req, "name")
///              .doit().await;
/// # }
/// ```
pub struct ProviderEntitlementApprovePlanChangeCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudCommercePartnerProcurementService<C>,
...
impl<'a, C> common::CallBuilder for ProviderEntitlementApprovePlanChangeCall<'a, C> {}

impl<'a, C> ProviderEntitlementApprovePlanChangeCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, Empty)> {
        ...
        params.push("alt", "json");
        let mut url = self.hub._base_url.clone() + "v1/{+name}:approvePlanChange";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string());
        }
    ...
    pub fn request(
        mut self,
        new_value: ApproveEntitlementPlanChangeRequest,
    ) -> ProviderEntitlementApprovePlanChangeCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProviderEntitlementApprovePlanChangeCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *fields* (query-string) - Selector specifying which fields to include in a partial response.
    /// * *$.xgafv* (query-string) - V1 error format.
    pub fn param<T>(mut self, name: T, value: T) -> ProviderEntitlementApprovePlanChangeCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProviderEntitlementApprovePlanChangeCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProviderEntitlementApprovePlanChangeCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProviderEntitlementApprovePlanChangeCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Updates an existing Entitlement.
///
/// A builder for the *entitlements.patch* method supported by a *provider* resource.
/// It is not used directly, but through a [`ProviderMethods`] instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_cloudcommerceprocurement1 as cloudcommerceprocurement1;
/// use cloudcommerceprocurement1::api::Entitlement;
/// # async fn dox() {
/// # use cloudcommerceprocurement1::{CloudCommercePartnerProcurementService, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.providers().entitlements_patch(req, "name")
///              .update_mask(FieldMask::new::<&str>(&[]))
///              .doit().await;
/// # }
/// ```
pub struct ProviderEntitlementPatchCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudCommercePartnerProcurementService<C>,
...
impl<'a, C> common::CallBuilder for ProviderEntitlementPatchCall<'a, C> {}

impl<'a, C> ProviderEntitlementPatchCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: Entitlement) -> ProviderEntitlementPatchCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProviderEntitlementPatchCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    ...
    /// * *fields* (query-string) - Selector specifying which fields to include in a partial response.
    /// * *$.xgafv* (query-string) - V1 error format.
    pub fn param<T>(mut self, name: T, value: T) -> ProviderEntitlementPatchCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProviderEntitlementPatchCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProviderEntitlementPatchCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProviderEntitlementPatchCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Rejects an entitlement that is in the EntitlementState.ENTITLEMENT_ACTIVATION_REQUESTED state. This method is invoked by the provider to reject the creation of the entitlement resource.
///
/// A builder for the *entitlements.reject* method supported by a *provider* resource.
/// It is not used directly, but through a [`ProviderMethods`] instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_cloudcommerceprocurement1 as cloudcommerceprocurement1;
/// use cloudcommerceprocurement1::api::RejectEntitlementRequest;
/// # async fn dox() {
/// # use cloudcommerceprocurement1::{CloudCommercePartnerProcurementService, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = RejectEntitlementRequest::default();
///
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.providers().entitlements_reject(req, "name")
///              .doit().await;
/// # }
/// ```
pub struct ProviderEntitlementRejectCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudCommercePartnerProcurementService<C>,
...
impl<'a, C> common::CallBuilder for ProviderEntitlementRejectCall<'a, C> {}

impl<'a, C> ProviderEntitlementRejectCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    pub fn request(
        mut self,
        new_value: RejectEntitlementRequest,
    ) -> ProviderEntitlementRejectCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProviderEntitlementRejectCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *fields* (query-string) - Selector specifying which fields to include in a partial response.
    /// * *$.xgafv* (query-string) - V1 error format.
    pub fn param<T>(mut self, name: T, value: T) -> ProviderEntitlementRejectCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProviderEntitlementRejectCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProviderEntitlementRejectCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProviderEntitlementRejectCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Grants an approval on an Account.
///
/// A builder for the *accounts.approve* method supported by a *provider* resource.
/// It is not used directly, but through a [`ProviderMethods`] instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_cloudcommerceprocurement1 as cloudcommerceprocurement1;
/// use cloudcommerceprocurement1::api::ApproveAccountRequest;
/// # async fn dox() {
/// # use cloudcommerceprocurement1::{CloudCommercePartnerProcurementService, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = ApproveAccountRequest::default();
///
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.providers().accounts_approve(req, "name")
///              .doit().await;
/// # }
/// ```
pub struct ProviderAccountApproveCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudCommercePartnerProcurementService<C>,
...
impl<'a, C> common::CallBuilder for ProviderAccountApproveCall<'a, C> {}

impl<'a, C> ProviderAccountApproveCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    pub fn request(
        mut self,
        new_value: ApproveAccountRequest,
    ) -> ProviderAccountApproveCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProviderAccountApproveCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *fields* (query-string) - Selector specifying which fields to include in a partial response.
    /// * *$.xgafv* (query-string) - V1 error format.
    pub fn param<T>(mut self, name: T, value: T) -> ProviderAccountApproveCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProviderAccountApproveCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProviderAccountApproveCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProviderAccountApproveCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Rejects an approval on an Account.
///
/// A builder for the *accounts.reject* method supported by a *provider* resource.
/// It is not used directly, but through a [`ProviderMethods`] instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_cloudcommerceprocurement1 as cloudcommerceprocurement1;
/// use cloudcommerceprocurement1::api::RejectAccountRequest;
/// # async fn dox() {
/// # use cloudcommerceprocurement1::{CloudCommercePartnerProcurementService, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = RejectAccountRequest::default();
///
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.providers().accounts_reject(req, "name")
///              .doit().await;
/// # }
/// ```
pub struct ProviderAccountRejectCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudCommercePartnerProcurementService<C>,
    _request: RejectAccountRequest,
    _name: String,
    _delegate: Option<&'a mut dyn common::Delegate>,
    _additional_params: HashMap<String, String>,
    _scopes: BTreeSet<String>,
...
impl<'a, C> common::CallBuilder for ProviderAccountRejectCall<'a, C> {}

impl<'a, C> ProviderAccountRejectCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: RejectAccountRequest) -> ProviderAccountRejectCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProviderAccountRejectCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *fields* (query-string) - Selector specifying which fields to include in a partial response.
    /// * *$.xgafv* (query-string) - V1 error format.
    pub fn param<T>(mut self, name: T, value: T) -> ProviderAccountRejectCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProviderAccountRejectCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProviderAccountRejectCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProviderAccountRejectCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Resets an Account and cancels all associated Entitlements. Partner can only reset accounts they own rather than customer accounts.
///
/// A builder for the *accounts.reset* method supported by a *provider* resource.
/// It is not used directly, but through a [`ProviderMethods`] instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_cloudcommerceprocurement1 as cloudcommerceprocurement1;
/// use cloudcommerceprocurement1::api::ResetAccountRequest;
/// # async fn dox() {
/// # use cloudcommerceprocurement1::{CloudCommercePartnerProcurementService, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = ResetAccountRequest::default();
///
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.providers().accounts_reset(req, "name")
///              .doit().await;
/// # }
/// ```
pub struct ProviderAccountResetCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudCommercePartnerProcurementService<C>,
    _request: ResetAccountRequest,
    _name: String,
    _delegate: Option<&'a mut dyn common::Delegate>,
    _additional_params: HashMap<String, String>,
    _scopes: BTreeSet<String>,
...
impl<'a, C> common::CallBuilder for ProviderAccountResetCall<'a, C> {}

impl<'a, C> ProviderAccountResetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: ResetAccountRequest) -> ProviderAccountResetCall<'a, C> {
        self._request = new_value;
        self
    }
    /// Required. The resource name of the account.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProviderAccountResetCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *fields* (query-string) - Selector specifying which fields to include in a partial response.
    /// * *$.xgafv* (query-string) - V1 error format.
    pub fn param<T>(mut self, name: T, value: T) -> ProviderAccountResetCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProviderAccountResetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProviderAccountResetCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProviderAccountResetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Gets a requested Account resource.
///
/// A builder for the *accounts.get* method supported by a *provider* resource.
/// It is not used directly, but through a [`ProviderMethods`] instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.providers().accounts_get("name")
///              .doit().await;
/// # }
/// ```
pub struct ProviderAccountGetCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudCommercePartnerProcurementService<C>,
...
impl<'a, C> common::CallBuilder for ProviderAccountGetCall<'a, C> {}

impl<'a, C> ProviderAccountGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProviderAccountGetCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *fields* (query-string) - Selector specifying which fields to include in a partial response.
    /// * *$.xgafv* (query-string) - V1 error format.
    pub fn param<T>(mut self, name: T, value: T) -> ProviderAccountGetCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProviderAccountGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProviderAccountGetCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProviderAccountGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Lists Accounts that the provider has access to.
///
/// A builder for the *accounts.list* method supported by a *provider* resource.
/// It is not used directly, but through a [`ProviderMethods`] instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.providers().accounts_list("parent")
///              .page_token("ipsum")
///              .page_size(-88)
///              .doit().await;
/// # }
/// ```
pub struct ProviderAccountListCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudCommercePartnerProcurementService<C>,
...
impl<'a, C> common::CallBuilder for ProviderAccountListCall<'a, C> {}

impl<'a, C> ProviderAccountListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, ListAccountsResponse)> {
        ...
        params.push("alt", "json");
        let mut url = self.hub._base_url.clone() + "v1/{+parent}/accounts";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string());
        }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> ProviderAccountListCall<'a, C> {
        self._parent = new_value.to_string();
        self
    }
    /// The token for fetching the next page.
    ///
    /// Sets the *page token* query property to the given value.
    pub fn page_token(mut self, new_value: &str) -> ProviderAccountListCall<'a, C> {
        self._page_token = Some(new_value.to_string());
        self
    }
    ...
    ///
    /// Sets the *page size* query property to the given value.
    pub fn page_size(mut self, new_value: i32) -> ProviderAccountListCall<'a, C> {
        self._page_size = Some(new_value);
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *fields* (query-string) - Selector specifying which fields to include in a partial response.
    /// * *$.xgafv* (query-string) - V1 error format.
    pub fn param<T>(mut self, name: T, value: T) -> ProviderAccountListCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProviderAccountListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProviderAccountListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProviderAccountListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
