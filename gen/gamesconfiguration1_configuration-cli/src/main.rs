...
use google_gamesconfiguration1_configuration::{api, yup_oauth2, Error};
...
{
    async fn _achievement_configurations_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        ...
        let mut call = self
            ...
            .delete(opt.value_of("achievement-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _achievement_configurations_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .achievement_configurations()
            .get(opt.value_of("achievement-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _achievement_configurations_insert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "published.description.kind" => Some((
        ...
        let mut request: api::AchievementConfiguration =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .achievement_configurations()
            .insert(request, opt.value_of("application-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _achievement_configurations_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .achievement_configurations()
            .list(opt.value_of("application-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _achievement_configurations_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .achievement_configurations()
            .update(request, opt.value_of("achievement-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _leaderboard_configurations_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            ...
            .delete(opt.value_of("leaderboard-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _leaderboard_configurations_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _leaderboard_configurations_insert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "draft.score-format.currency-code" => Some((
                ...
                "draft.score-format.num-decimal-places" => Some((
                ...
                "draft.score-format.number-format-type" => Some((
                ...
                "draft.score-format.suffix.few.kind" => Some((
                ...
                "draft.score-format.suffix.many.kind" => Some((
                ...
                "draft.score-format.suffix.one.kind" => Some((
                ...
                "draft.score-format.suffix.other.kind" => Some((
                ...
                "draft.score-format.suffix.two.kind" => Some((
                ...
                "draft.score-format.suffix.zero.kind" => Some((
                ...
                "published.score-format.currency-code" => Some((
                ...
                "published.score-format.num-decimal-places" => Some((
                ...
                "published.score-format.number-format-type" => Some((
                ...
                "published.score-format.suffix.few.kind" => Some((
                ...
                "published.score-format.suffix.many.kind" => Some((
                ...
                "published.score-format.suffix.one.kind" => Some((
                ...
                "published.score-format.suffix.other.kind" => Some((
                ...
                "published.score-format.suffix.two.kind" => Some((
                ...
                "published.score-format.suffix.zero.kind" => Some((
        ...
        let mut request: api::LeaderboardConfiguration =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .leaderboard_configurations()
    ...
    async fn _leaderboard_configurations_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _leaderboard_configurations_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .leaderboard_configurations()
            .update(request, opt.value_of("leaderboard-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _doit(
        ...
        match self.opt.subcommand() {
            ("achievement-configurations", Some(opt)) => match opt.subcommand() {
                ("delete", Some(opt)) => {
                    call_result = self
                        ._achievement_configurations_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("get", Some(opt)) => {
                    call_result = self
                        ._achievement_configurations_get(opt, dry_run, &mut err)
                        .await;
                }
                ("insert", Some(opt)) => {
                    call_result = self
                        ._achievement_configurations_insert(opt, dry_run, &mut err)
                        .await;
                }
                ("list", Some(opt)) => {
                    call_result = self
                        ._achievement_configurations_list(opt, dry_run, &mut err)
                        .await;
                }
                ("update", Some(opt)) => {
                    call_result = self
                        ._achievement_configurations_update(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues.push(CLIError::MissingMethodError(
                        "achievement-configurations".to_string(),
                    ));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("leaderboard-configurations", Some(opt)) => match opt.subcommand() {
                ("delete", Some(opt)) => {
                    call_result = self
                        ._leaderboard_configurations_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("get", Some(opt)) => {
                    call_result = self
                        ._leaderboard_configurations_get(opt, dry_run, &mut err)
                        .await;
                }
                ("insert", Some(opt)) => {
                    call_result = self
                        ._leaderboard_configurations_insert(opt, dry_run, &mut err)
                        .await;
                }
                ("list", Some(opt)) => {
                    call_result = self
                        ._leaderboard_configurations_list(opt, dry_run, &mut err)
                        .await;
                }
                ("update", Some(opt)) => {
                    call_result = self
                        ._leaderboard_configurations_update(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues.push(CLIError::MissingMethodError(
                        "leaderboard-configurations".to_string(),
                    ));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "gamesconfiguration1-configuration-secret.json",
        ...
        .persist_tokens_to_disk(format!("{}/gamesconfiguration1-configuration", config_dir))
        .build()
        .await
        .unwrap();
