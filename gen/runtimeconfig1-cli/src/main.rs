...
use google_runtimeconfig1::{api, yup_oauth2, Error};
    ...
    C: apis_common::Connector,
{
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "runtimeconfig1-secret.json",
        ...
        .persist_tokens_to_disk(format!("{}/runtimeconfig1", config_dir))
        .build()
        .await
        .unwrap();
    ...
    let arg_data = [
        ("operations", "methods: 'cancel', 'delete' and 'list'", vec![
            ("cancel",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_runtimeconfig1_cli/operations_cancel",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("delete",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_runtimeconfig1_cli/operations_delete",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_runtimeconfig1_cli/operations_list",
                  vec![
                    (Some(r##"name"##),
                     None,
