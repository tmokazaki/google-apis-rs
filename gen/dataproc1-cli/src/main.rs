...
use google_dataproc1::{api, yup_oauth2, Error};
...
{
    async fn _projects_locations_autoscaling_policies_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
            ...
            .iter()
        {
            ...
            {
                "basic-algorithm.cooldown-period" => Some((
                ...
                "basic-algorithm.spark-standalone-config.graceful-decommission-timeout" => Some((
                    "basicAlgorithm.sparkStandaloneConfig.gracefulDecommissionTimeout",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "basic-algorithm.spark-standalone-config.remove-only-idle-workers" => Some((
                    "basicAlgorithm.sparkStandaloneConfig.removeOnlyIdleWorkers",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "basic-algorithm.spark-standalone-config.scale-down-factor" => Some((
                    "basicAlgorithm.sparkStandaloneConfig.scaleDownFactor",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "basic-algorithm.spark-standalone-config.scale-down-min-worker-fraction" => Some((
                    "basicAlgorithm.sparkStandaloneConfig.scaleDownMinWorkerFraction",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "basic-algorithm.spark-standalone-config.scale-up-factor" => Some((
                    "basicAlgorithm.sparkStandaloneConfig.scaleUpFactor",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "basic-algorithm.spark-standalone-config.scale-up-min-worker-fraction" => Some((
                    "basicAlgorithm.sparkStandaloneConfig.scaleUpMinWorkerFraction",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "basic-algorithm.yarn-config.graceful-decommission-timeout" => Some((
                ...
                "basic-algorithm.yarn-config.scale-down-factor" => Some((
                ...
                "basic-algorithm.yarn-config.scale-down-min-worker-fraction" => Some((
                ...
                "basic-algorithm.yarn-config.scale-up-factor" => Some((
                ...
                "basic-algorithm.yarn-config.scale-up-min-worker-fraction" => Some((
                ...
                "secondary-worker-config.max-instances" => Some((
                ...
                "secondary-worker-config.min-instances" => Some((
                ...
                "secondary-worker-config.weight" => Some((
                ...
                "worker-config.max-instances" => Some((
                ...
                "worker-config.min-instances" => Some((
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        ...
                        &vec![
                            ...
                            "scale-down-factor",
                            "scale-down-min-worker-fraction",
                            "scale-up-factor",
                            "scale-up-min-worker-fraction",
        ...
        let mut request: api::AutoscalingPolicy = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_autoscaling_policies_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_autoscaling_policies_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_autoscaling_policies_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_autoscaling_policies_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_autoscaling_policies_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_autoscaling_policies_get_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_autoscaling_policies_get_iam_policy(
                request,
    ...
    async fn _projects_locations_autoscaling_policies_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_autoscaling_policies_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_autoscaling_policies_set_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_locations_autoscaling_policies_test_iam_permissions(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_autoscaling_policies_test_iam_permissions(
                request,
                opt.value_of("resource").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_autoscaling_policies_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_autoscaling_policies_update(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_batches_analyze(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::AnalyzeBatchRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_batches_analyze(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_batches_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::Batch = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_batches_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_batches_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_batches_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_batches_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_batches_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_batches_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_batches_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_session_templates_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::SessionTemplate = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_session_templates_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_session_templates_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_session_templates_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_session_templates_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_session_templates_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_session_templates_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_session_templates_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_session_templates_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_session_templates_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_sessions_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::Session = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_sessions_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_sessions_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_sessions_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_sessions_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_sessions_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_sessions_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_sessions_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_sessions_terminate(
        ...
        let mut request: api::TerminateSessionRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_sessions_terminate(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_workflow_templates_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::WorkflowTemplate = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_workflow_templates_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_workflow_templates_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_workflow_templates_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            .iter()
        {
            ...
            match key {
                "version" => {
                    call = call.version(
                        value
                            .map(|v| arg_from_str(v, err, "version", "int32"))
                            .unwrap_or(-0),
                    );
                }
                _ => {
    ...
    async fn _projects_locations_workflow_templates_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_workflow_templates_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_workflow_templates_get_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_workflow_templates_get_iam_policy(
                request,
                opt.value_of("resource").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_workflow_templates_instantiate(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec!["parameters", "request-id", "version"],
                    );
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
        ...
        let mut request: api::InstantiateWorkflowTemplateRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_workflow_templates_instantiate(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_workflow_templates_instantiate_inline(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_locations_workflow_templates_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_workflow_templates_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_workflow_templates_set_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_workflow_templates_set_iam_policy(
                request,
                opt.value_of("resource").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_workflow_templates_test_iam_permissions(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_workflow_templates_test_iam_permissions(
                request,
                opt.value_of("resource").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_workflow_templates_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_workflow_templates_update(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_regions_autoscaling_policies_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .regions_autoscaling_policies_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_regions_autoscaling_policies_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .regions_autoscaling_policies_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_regions_autoscaling_policies_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .regions_autoscaling_policies_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_regions_autoscaling_policies_get_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_regions_autoscaling_policies_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .regions_autoscaling_policies_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_regions_autoscaling_policies_set_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_regions_autoscaling_policies_test_iam_permissions(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .regions_autoscaling_policies_test_iam_permissions(
                request,
                opt.value_of("resource").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_regions_autoscaling_policies_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .regions_autoscaling_policies_update(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_regions_clusters_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::Cluster = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.projects().regions_clusters_create(
            request,
            opt.value_of("project-id").unwrap_or(""),
            opt.value_of("region").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["action-on-failed-primary-workers", "request-id"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _projects_regions_clusters_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.projects().regions_clusters_delete(
            opt.value_of("project-id").unwrap_or(""),
            opt.value_of("region").unwrap_or(""),
            opt.value_of("cluster-name").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            ...
            .iter()
        {
            ...
            match key {
                ...
                "graceful-termination-timeout" => {
                    call = call.graceful_termination_timeout(
                        value
                            .map(|v| {
                                arg_from_str(
                                    v,
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["cluster-uuid", "graceful-termination-timeout", "request-id"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _projects_regions_clusters_diagnose(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                "diagnosis-interval.end-time" => Some((
                    "diagnosisInterval.endTime",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "diagnosis-interval.start-time" => Some((
                    "diagnosisInterval.startTime",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
        ...
        let mut request: api::DiagnoseClusterRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.projects().regions_clusters_diagnose(
            request,
            opt.value_of("project-id").unwrap_or(""),
            opt.value_of("region").unwrap_or(""),
            opt.value_of("cluster-name").unwrap_or(""),
    ...
    async fn _projects_regions_clusters_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.projects().regions_clusters_get(
            opt.value_of("project-id").unwrap_or(""),
            opt.value_of("region").unwrap_or(""),
            opt.value_of("cluster-name").unwrap_or(""),
        );
    ...
    async fn _projects_regions_clusters_get_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .regions_clusters_get_iam_policy(request, opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_regions_clusters_inject_credentials(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec!["cluster-uuid", "credentials-ciphertext"],
                    );
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
        ...
        let mut request: api::InjectCredentialsRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.projects().regions_clusters_inject_credentials(
            request,
            opt.value_of("project").unwrap_or(""),
            opt.value_of("region").unwrap_or(""),
            opt.value_of("cluster").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _projects_regions_clusters_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.projects().regions_clusters_list(
            opt.value_of("project-id").unwrap_or(""),
            opt.value_of("region").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _projects_regions_clusters_node_groups_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::NodeGroup = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .regions_clusters_node_groups_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["node-group-id", "parent-operation-id", "request-id"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _projects_regions_clusters_node_groups_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .regions_clusters_node_groups_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_regions_clusters_node_groups_repair(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec!["instance-names", "repair-action", "request-id"],
                    );
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
        ...
        let mut request: api::RepairNodeGroupRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .regions_clusters_node_groups_repair(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_regions_clusters_node_groups_resize(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                "graceful-decommission-timeout" => Some((
        ...
        let mut request: api::ResizeNodeGroupRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .regions_clusters_node_groups_resize(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_regions_clusters_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::Cluster = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.projects().regions_clusters_patch(
            request,
            opt.value_of("project-id").unwrap_or(""),
            opt.value_of("region").unwrap_or(""),
            opt.value_of("cluster-name").unwrap_or(""),
            ...
            .iter()
        {
            ...
            match key {
                ...
                "graceful-decommission-timeout" => {
                    call = call.graceful_decommission_timeout(
                        value
                            .map(|v| {
                                arg_from_str(
                                    v,
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["graceful-decommission-timeout", "request-id", "update-mask"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _projects_regions_clusters_repair(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::RepairClusterRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.projects().regions_clusters_repair(
            request,
            opt.value_of("project-id").unwrap_or(""),
            opt.value_of("region").unwrap_or(""),
            opt.value_of("cluster-name").unwrap_or(""),
    ...
    async fn _projects_regions_clusters_set_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .regions_clusters_set_iam_policy(request, opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_regions_clusters_start(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion =
                        FieldCursor::did_you_mean(key, &vec!["cluster-uuid", "request-id"]);
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
                        value.map(|v| v.to_string()),
        ...
        let mut request: api::StartClusterRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.projects().regions_clusters_start(
            request,
            opt.value_of("project-id").unwrap_or(""),
            opt.value_of("region").unwrap_or(""),
            opt.value_of("cluster-name").unwrap_or(""),
    ...
    async fn _projects_regions_clusters_stop(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::StopClusterRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.projects().regions_clusters_stop(
            request,
            opt.value_of("project-id").unwrap_or(""),
            opt.value_of("region").unwrap_or(""),
            opt.value_of("cluster-name").unwrap_or(""),
    ...
    async fn _projects_regions_clusters_test_iam_permissions(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .regions_clusters_test_iam_permissions(request, opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_regions_jobs_cancel(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::CancelJobRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.projects().regions_jobs_cancel(
            request,
            opt.value_of("project-id").unwrap_or(""),
            opt.value_of("region").unwrap_or(""),
    ...
    async fn _projects_regions_jobs_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.projects().regions_jobs_delete(
            opt.value_of("project-id").unwrap_or(""),
            opt.value_of("region").unwrap_or(""),
            opt.value_of("job-id").unwrap_or(""),
        );
    ...
    async fn _projects_regions_jobs_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.projects().regions_jobs_get(
            opt.value_of("project-id").unwrap_or(""),
            opt.value_of("region").unwrap_or(""),
            opt.value_of("job-id").unwrap_or(""),
        );
    ...
    async fn _projects_regions_jobs_get_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .regions_jobs_get_iam_policy(request, opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_regions_jobs_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.projects().regions_jobs_list(
            opt.value_of("project-id").unwrap_or(""),
            opt.value_of("region").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _projects_regions_jobs_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "driver-output-resource-uri" => Some((
                ...
                "driver-scheduling-config.memory-mb" => Some((
                ...
                "driver-scheduling-config.vcores" => Some((
                ...
                "flink-job.logging-config.driver-log-levels" => Some((
                    "flinkJob.loggingConfig.driverLogLevels",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Map,
                    },
                )),
                "flink-job.main-class" => Some((
                    "flinkJob.mainClass",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                ...
                "flink-job.main-jar-file-uri" => Some((
                ...
                "hadoop-job.logging-config.driver-log-levels" => Some((
                    "hadoopJob.loggingConfig.driverLogLevels",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Map,
                    },
                )),
                "hadoop-job.main-class" => Some((
                    "hadoopJob.mainClass",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                ...
                "hadoop-job.main-jar-file-uri" => Some((
                ...
                "hive-job.continue-on-failure" => Some((
                ...
                "hive-job.query-list.queries" => Some((
                ...
                "hive-job.script-variables" => Some((
                ...
                "pig-job.continue-on-failure" => Some((
                ...
                "pig-job.logging-config.driver-log-levels" => Some((
                    "pigJob.loggingConfig.driverLogLevels",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Map,
                    },
                )),
                "pig-job.properties" => Some((
                    "pigJob.properties",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Map,
                ...
                "pig-job.query-list.queries" => Some((
                    "pigJob.queryList.queries",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "pig-job.script-variables" => Some((
                ...
                "placement.cluster-uuid" => Some((
                    "placement.clusterUuid",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "presto-job.client-tags" => Some((
                ...
                "presto-job.continue-on-failure" => Some((
                ...
                "presto-job.logging-config.driver-log-levels" => Some((
                    "prestoJob.loggingConfig.driverLogLevels",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Map,
                    },
                )),
                "presto-job.output-format" => Some((
                ...
                "presto-job.query-file-uri" => Some((
                ...
                "presto-job.query-list.queries" => Some((
                ...
                "pyspark-job.jar-file-uris" => Some((
                ...
                "pyspark-job.logging-config.driver-log-levels" => Some((
                    "pysparkJob.loggingConfig.driverLogLevels",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Map,
                    },
                )),
                "pyspark-job.main-python-file-uri" => Some((
                ...
                "pyspark-job.python-file-uris" => Some((
                ...
                "scheduling.max-failures-per-hour" => Some((
                    "scheduling.maxFailuresPerHour",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                )),
                "scheduling.max-failures-total" => Some((
                ...
                "spark-job.logging-config.driver-log-levels" => Some((
                    "sparkJob.loggingConfig.driverLogLevels",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Map,
                    },
                )),
                "spark-job.main-class" => Some((
                    "sparkJob.mainClass",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                ...
                "spark-job.main-jar-file-uri" => Some((
                ...
                "spark-r-job.logging-config.driver-log-levels" => Some((
                    "sparkRJob.loggingConfig.driverLogLevels",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Map,
                    },
                )),
                "spark-r-job.main-r-file-uri" => Some((
                ...
                "spark-sql-job.jar-file-uris" => Some((
                ...
                "spark-sql-job.logging-config.driver-log-levels" => Some((
                    "sparkSqlJob.loggingConfig.driverLogLevels",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Map,
                    },
                )),
                "spark-sql-job.properties" => Some((
                ...
                "spark-sql-job.query-file-uri" => Some((
                ...
                "spark-sql-job.query-list.queries" => Some((
                    "sparkSqlJob.queryList.queries",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "spark-sql-job.script-variables" => Some((
                ...
                "trino-job.continue-on-failure" => Some((
                ...
                "trino-job.logging-config.driver-log-levels" => Some((
                    "trinoJob.loggingConfig.driverLogLevels",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Map,
                    },
                )),
                "trino-job.output-format" => Some((
                ...
                "trino-job.query-list.queries" => Some((
        ...
        let mut call = self.hub.projects().regions_jobs_patch(
            request,
            opt.value_of("project-id").unwrap_or(""),
            opt.value_of("region").unwrap_or(""),
            opt.value_of("job-id").unwrap_or(""),
    ...
    async fn _projects_regions_jobs_set_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .regions_jobs_set_iam_policy(request, opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_regions_jobs_submit(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "job.driver-control-files-uri" => Some((
                ...
                "job.driver-output-resource-uri" => Some((
                ...
                "job.driver-scheduling-config.memory-mb" => Some((
                    "job.driverSchedulingConfig.memoryMb",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                )),
                "job.driver-scheduling-config.vcores" => Some((
                    "job.driverSchedulingConfig.vcores",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                )),
                "job.flink-job.args" => Some((
                    "job.flinkJob.args",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                ...
                "job.flink-job.jar-file-uris" => Some((
                ...
                "job.flink-job.logging-config.driver-log-levels" => Some((
                    "job.flinkJob.loggingConfig.driverLogLevels",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Map,
                    },
                )),
                "job.flink-job.main-class" => Some((
                    "job.flinkJob.mainClass",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "job.flink-job.main-jar-file-uri" => Some((
                    "job.flinkJob.mainJarFileUri",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "job.flink-job.properties" => Some((
                    "job.flinkJob.properties",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Map,
                    },
                )),
                "job.flink-job.savepoint-uri" => Some((
                    "job.flinkJob.savepointUri",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "job.hadoop-job.archive-uris" => Some((
                    "job.hadoopJob.archiveUris",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "job.hadoop-job.args" => Some((
                    "job.hadoopJob.args",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                ...
                "job.hadoop-job.jar-file-uris" => Some((
                    "job.hadoopJob.jarFileUris",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "job.hadoop-job.logging-config.driver-log-levels" => Some((
                    "job.hadoopJob.loggingConfig.driverLogLevels",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Map,
                    },
                )),
                "job.hadoop-job.main-class" => Some((
                    "job.hadoopJob.mainClass",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "job.hadoop-job.main-jar-file-uri" => Some((
                    "job.hadoopJob.mainJarFileUri",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "job.hadoop-job.properties" => Some((
                    "job.hadoopJob.properties",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Map,
                    },
                )),
                "job.hive-job.continue-on-failure" => Some((
                    "job.hiveJob.continueOnFailure",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "job.hive-job.jar-file-uris" => Some((
                    "job.hiveJob.jarFileUris",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "job.hive-job.properties" => Some((
                    "job.hiveJob.properties",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Map,
                    },
                )),
                "job.hive-job.query-file-uri" => Some((
                    "job.hiveJob.queryFileUri",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "job.hive-job.query-list.queries" => Some((
                ...
                "job.hive-job.script-variables" => Some((
                    "job.hiveJob.scriptVariables",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Map,
                    },
                ...
                "job.pig-job.continue-on-failure" => Some((
                    "job.pigJob.continueOnFailure",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "job.pig-job.jar-file-uris" => Some((
                    "job.pigJob.jarFileUris",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "job.pig-job.logging-config.driver-log-levels" => Some((
                    "job.pigJob.loggingConfig.driverLogLevels",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Map,
                    },
                )),
                "job.pig-job.properties" => Some((
                    "job.pigJob.properties",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Map,
                    },
                )),
                "job.pig-job.query-file-uri" => Some((
                ...
                "job.pig-job.query-list.queries" => Some((
                ...
                "job.pig-job.script-variables" => Some((
                    "job.pigJob.scriptVariables",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Map,
                    },
                )),
                "job.placement.cluster-labels" => Some((
                    "job.placement.clusterLabels",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Map,
                    },
                )),
                "job.placement.cluster-name" => Some((
                ...
                "job.placement.cluster-uuid" => Some((
                ...
                "job.presto-job.client-tags" => Some((
                    "job.prestoJob.clientTags",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "job.presto-job.continue-on-failure" => Some((
                    "job.prestoJob.continueOnFailure",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "job.presto-job.logging-config.driver-log-levels" => Some((
                    "job.prestoJob.loggingConfig.driverLogLevels",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Map,
                    },
                )),
                "job.presto-job.output-format" => Some((
                    "job.prestoJob.outputFormat",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "job.presto-job.properties" => Some((
                    "job.prestoJob.properties",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Map,
                    },
                )),
                "job.presto-job.query-file-uri" => Some((
                    "job.prestoJob.queryFileUri",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "job.presto-job.query-list.queries" => Some((
                ...
                "job.pyspark-job.archive-uris" => Some((
                    "job.pysparkJob.archiveUris",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "job.pyspark-job.args" => Some((
                    "job.pysparkJob.args",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                ...
                "job.pyspark-job.file-uris" => Some((
                ...
                "job.pyspark-job.jar-file-uris" => Some((
                    "job.pysparkJob.jarFileUris",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "job.pyspark-job.logging-config.driver-log-levels" => Some((
                    "job.pysparkJob.loggingConfig.driverLogLevels",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Map,
                    },
                )),
                "job.pyspark-job.main-python-file-uri" => Some((
                    "job.pysparkJob.mainPythonFileUri",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "job.pyspark-job.properties" => Some((
                    "job.pysparkJob.properties",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Map,
                    },
                )),
                "job.pyspark-job.python-file-uris" => Some((
                    "job.pysparkJob.pythonFileUris",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                ...
                "job.scheduling.max-failures-per-hour" => Some((
                    "job.scheduling.maxFailuresPerHour",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                )),
                "job.scheduling.max-failures-total" => Some((
                    "job.scheduling.maxFailuresTotal",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                )),
                "job.spark-job.archive-uris" => Some((
                    "job.sparkJob.archiveUris",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "job.spark-job.args" => Some((
                    "job.sparkJob.args",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                ...
                "job.spark-job.file-uris" => Some((
                    "job.sparkJob.fileUris",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "job.spark-job.jar-file-uris" => Some((
                ...
                "job.spark-job.logging-config.driver-log-levels" => Some((
                    "job.sparkJob.loggingConfig.driverLogLevels",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Map,
                    },
                )),
                "job.spark-job.main-class" => Some((
                ...
                "job.spark-job.main-jar-file-uri" => Some((
                    "job.sparkJob.mainJarFileUri",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "job.spark-job.properties" => Some((
                    "job.sparkJob.properties",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Map,
                    },
                )),
                "job.spark-r-job.archive-uris" => Some((
                    "job.sparkRJob.archiveUris",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "job.spark-r-job.args" => Some((
                    "job.sparkRJob.args",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                ...
                "job.spark-r-job.file-uris" => Some((
                    "job.sparkRJob.fileUris",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "job.spark-r-job.logging-config.driver-log-levels" => Some((
                    "job.sparkRJob.loggingConfig.driverLogLevels",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Map,
                    },
                )),
                "job.spark-r-job.main-r-file-uri" => Some((
                    "job.sparkRJob.mainRFileUri",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "job.spark-r-job.properties" => Some((
                    "job.sparkRJob.properties",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Map,
                    },
                )),
                "job.spark-sql-job.jar-file-uris" => Some((
                    "job.sparkSqlJob.jarFileUris",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "job.spark-sql-job.logging-config.driver-log-levels" => Some((
                    "job.sparkSqlJob.loggingConfig.driverLogLevels",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Map,
                    },
                )),
                "job.spark-sql-job.properties" => Some((
                    "job.sparkSqlJob.properties",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Map,
                    },
                )),
                "job.spark-sql-job.query-file-uri" => Some((
                ...
                "job.spark-sql-job.query-list.queries" => Some((
                ...
                "job.spark-sql-job.script-variables" => Some((
                    "job.sparkSqlJob.scriptVariables",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Map,
                    },
                )),
                "job.status.details" => Some((
                    "job.status.details",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                ...
                "job.status.state-start-time" => Some((
                    "job.status.stateStartTime",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "job.status.substate" => Some((
                    "job.status.substate",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                ...
                "job.trino-job.client-tags" => Some((
                    "job.trinoJob.clientTags",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "job.trino-job.continue-on-failure" => Some((
                    "job.trinoJob.continueOnFailure",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "job.trino-job.logging-config.driver-log-levels" => Some((
                    "job.trinoJob.loggingConfig.driverLogLevels",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Map,
                    },
                )),
                "job.trino-job.output-format" => Some((
                    "job.trinoJob.outputFormat",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "job.trino-job.properties" => Some((
                    "job.trinoJob.properties",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Map,
                    },
                )),
                "job.trino-job.query-file-uri" => Some((
                    "job.trinoJob.queryFileUri",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "job.trino-job.query-list.queries" => Some((
        ...
        let mut request: api::SubmitJobRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.projects().regions_jobs_submit(
            request,
            opt.value_of("project-id").unwrap_or(""),
            opt.value_of("region").unwrap_or(""),
        );
    ...
    async fn _projects_regions_jobs_submit_as_operation(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::SubmitJobRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.projects().regions_jobs_submit_as_operation(
            request,
            opt.value_of("project-id").unwrap_or(""),
            opt.value_of("region").unwrap_or(""),
        );
    ...
    async fn _projects_regions_jobs_test_iam_permissions(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .regions_jobs_test_iam_permissions(request, opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_regions_operations_cancel(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .regions_operations_cancel(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_regions_operations_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .regions_operations_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_regions_operations_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .regions_operations_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_regions_operations_get_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .regions_operations_get_iam_policy(request, opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_regions_operations_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .regions_operations_list(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_regions_operations_set_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .regions_operations_set_iam_policy(request, opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_regions_operations_test_iam_permissions(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::TestIamPermissionsRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.projects().regions_operations_test_iam_permissions(
            request,
            opt.value_of("resource").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _projects_regions_workflow_templates_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .regions_workflow_templates_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_regions_workflow_templates_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .regions_workflow_templates_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_regions_workflow_templates_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .regions_workflow_templates_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_regions_workflow_templates_get_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .regions_workflow_templates_get_iam_policy(
                request,
                opt.value_of("resource").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_regions_workflow_templates_instantiate(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .regions_workflow_templates_instantiate(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_regions_workflow_templates_instantiate_inline(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .regions_workflow_templates_instantiate_inline(
                request,
                opt.value_of("parent").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_regions_workflow_templates_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .regions_workflow_templates_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_regions_workflow_templates_set_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .regions_workflow_templates_set_iam_policy(
                request,
                opt.value_of("resource").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_regions_workflow_templates_test_iam_permissions(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .regions_workflow_templates_test_iam_permissions(
                request,
                opt.value_of("resource").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_regions_workflow_templates_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .regions_workflow_templates_update(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
        ...
        match self.opt.subcommand() {
            ("projects", Some(opt)) => match opt.subcommand() {
                ("locations-autoscaling-policies-create", Some(opt)) => {
                    call_result = self
                        ._projects_locations_autoscaling_policies_create(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-autoscaling-policies-delete", Some(opt)) => {
                    call_result = self
                        ._projects_locations_autoscaling_policies_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-autoscaling-policies-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_autoscaling_policies_get(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-autoscaling-policies-get-iam-policy", Some(opt)) => {
                    call_result = self
                        ._projects_locations_autoscaling_policies_get_iam_policy(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-autoscaling-policies-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_autoscaling_policies_list(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-autoscaling-policies-set-iam-policy", Some(opt)) => {
                    call_result = self
                        ._projects_locations_autoscaling_policies_set_iam_policy(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-autoscaling-policies-test-iam-permissions", Some(opt)) => {
                    call_result = self
                        ._projects_locations_autoscaling_policies_test_iam_permissions(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-autoscaling-policies-update", Some(opt)) => {
                    call_result = self
                        ._projects_locations_autoscaling_policies_update(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-batches-analyze", Some(opt)) => {
                    call_result = self
                        ._projects_locations_batches_analyze(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-batches-create", Some(opt)) => {
                    call_result = self
                        ._projects_locations_batches_create(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-batches-delete", Some(opt)) => {
                    call_result = self
                        ._projects_locations_batches_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-batches-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_batches_get(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("locations-session-templates-create", Some(opt)) => {
                    call_result = self
                        ._projects_locations_session_templates_create(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-session-templates-delete", Some(opt)) => {
                    call_result = self
                        ._projects_locations_session_templates_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-session-templates-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_session_templates_get(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-session-templates-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_session_templates_list(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-session-templates-patch", Some(opt)) => {
                    call_result = self
                        ._projects_locations_session_templates_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-sessions-create", Some(opt)) => {
                    call_result = self
                        ._projects_locations_sessions_create(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-sessions-delete", Some(opt)) => {
                    call_result = self
                        ._projects_locations_sessions_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-sessions-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_sessions_get(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("locations-sessions-terminate", Some(opt)) => {
                    call_result = self
                        ._projects_locations_sessions_terminate(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-workflow-templates-create", Some(opt)) => {
                    call_result = self
                        ._projects_locations_workflow_templates_create(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-workflow-templates-delete", Some(opt)) => {
                    call_result = self
                        ._projects_locations_workflow_templates_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-workflow-templates-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_workflow_templates_get(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-workflow-templates-get-iam-policy", Some(opt)) => {
                    call_result = self
                        ._projects_locations_workflow_templates_get_iam_policy(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-workflow-templates-instantiate", Some(opt)) => {
                    call_result = self
                        ._projects_locations_workflow_templates_instantiate(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-workflow-templates-instantiate-inline", Some(opt)) => {
                    call_result = self
                        ._projects_locations_workflow_templates_instantiate_inline(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-workflow-templates-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_workflow_templates_list(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-workflow-templates-set-iam-policy", Some(opt)) => {
                    call_result = self
                        ._projects_locations_workflow_templates_set_iam_policy(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-workflow-templates-test-iam-permissions", Some(opt)) => {
                    call_result = self
                        ._projects_locations_workflow_templates_test_iam_permissions(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-workflow-templates-update", Some(opt)) => {
                    call_result = self
                        ._projects_locations_workflow_templates_update(opt, dry_run, &mut err)
                        .await;
                }
                ("regions-autoscaling-policies-create", Some(opt)) => {
                    call_result = self
                        ._projects_regions_autoscaling_policies_create(opt, dry_run, &mut err)
                        .await;
                }
                ("regions-autoscaling-policies-delete", Some(opt)) => {
                    call_result = self
                        ._projects_regions_autoscaling_policies_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("regions-autoscaling-policies-get", Some(opt)) => {
                    call_result = self
                        ._projects_regions_autoscaling_policies_get(opt, dry_run, &mut err)
                        .await;
                }
                ("regions-autoscaling-policies-get-iam-policy", Some(opt)) => {
                    call_result = self
                        ._projects_regions_autoscaling_policies_get_iam_policy(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("regions-autoscaling-policies-list", Some(opt)) => {
                    call_result = self
                        ._projects_regions_autoscaling_policies_list(opt, dry_run, &mut err)
                        .await;
                }
                ("regions-autoscaling-policies-set-iam-policy", Some(opt)) => {
                    call_result = self
                        ._projects_regions_autoscaling_policies_set_iam_policy(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("regions-autoscaling-policies-test-iam-permissions", Some(opt)) => {
                    call_result = self
                        ._projects_regions_autoscaling_policies_test_iam_permissions(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("regions-autoscaling-policies-update", Some(opt)) => {
                    call_result = self
                        ._projects_regions_autoscaling_policies_update(opt, dry_run, &mut err)
                        .await;
                }
                ("regions-clusters-create", Some(opt)) => {
                    call_result = self
                        ._projects_regions_clusters_create(opt, dry_run, &mut err)
                        .await;
                }
                ("regions-clusters-delete", Some(opt)) => {
                    call_result = self
                        ._projects_regions_clusters_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("regions-clusters-diagnose", Some(opt)) => {
                    call_result = self
                        ._projects_regions_clusters_diagnose(opt, dry_run, &mut err)
                        .await;
                }
                ("regions-clusters-get", Some(opt)) => {
                    call_result = self
                        ._projects_regions_clusters_get(opt, dry_run, &mut err)
                        .await;
                }
                ("regions-clusters-get-iam-policy", Some(opt)) => {
                    call_result = self
                        ._projects_regions_clusters_get_iam_policy(opt, dry_run, &mut err)
                        .await;
                }
                ("regions-clusters-inject-credentials", Some(opt)) => {
                    call_result = self
                        ._projects_regions_clusters_inject_credentials(opt, dry_run, &mut err)
                        .await;
                }
                ("regions-clusters-list", Some(opt)) => {
                    call_result = self
                        ._projects_regions_clusters_list(opt, dry_run, &mut err)
                        .await;
                }
                ("regions-clusters-node-groups-create", Some(opt)) => {
                    call_result = self
                        ._projects_regions_clusters_node_groups_create(opt, dry_run, &mut err)
                        .await;
                }
                ("regions-clusters-node-groups-get", Some(opt)) => {
                    call_result = self
                        ._projects_regions_clusters_node_groups_get(opt, dry_run, &mut err)
                        .await;
                }
                ("regions-clusters-node-groups-repair", Some(opt)) => {
                    call_result = self
                        ._projects_regions_clusters_node_groups_repair(opt, dry_run, &mut err)
                        .await;
                }
                ("regions-clusters-node-groups-resize", Some(opt)) => {
                    call_result = self
                        ._projects_regions_clusters_node_groups_resize(opt, dry_run, &mut err)
                        .await;
                }
                ("regions-clusters-patch", Some(opt)) => {
                    call_result = self
                        ._projects_regions_clusters_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("regions-clusters-repair", Some(opt)) => {
                    call_result = self
                        ._projects_regions_clusters_repair(opt, dry_run, &mut err)
                        .await;
                }
                ("regions-clusters-set-iam-policy", Some(opt)) => {
                    call_result = self
                        ._projects_regions_clusters_set_iam_policy(opt, dry_run, &mut err)
                        .await;
                }
                ("regions-clusters-start", Some(opt)) => {
                    call_result = self
                        ._projects_regions_clusters_start(opt, dry_run, &mut err)
                        .await;
                }
                ("regions-clusters-stop", Some(opt)) => {
                    call_result = self
                        ._projects_regions_clusters_stop(opt, dry_run, &mut err)
                        .await;
                }
                ("regions-clusters-test-iam-permissions", Some(opt)) => {
                    call_result = self
                        ._projects_regions_clusters_test_iam_permissions(opt, dry_run, &mut err)
                        .await;
                }
                ("regions-jobs-cancel", Some(opt)) => {
                    call_result = self
                        ._projects_regions_jobs_cancel(opt, dry_run, &mut err)
                        .await;
                }
                ("regions-jobs-delete", Some(opt)) => {
                    call_result = self
                        ._projects_regions_jobs_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("regions-jobs-get", Some(opt)) => {
                    call_result = self
                        ._projects_regions_jobs_get(opt, dry_run, &mut err)
                        .await;
                }
                ("regions-jobs-get-iam-policy", Some(opt)) => {
                    call_result = self
                        ._projects_regions_jobs_get_iam_policy(opt, dry_run, &mut err)
                        .await;
                }
                ("regions-jobs-list", Some(opt)) => {
                    call_result = self
                        ._projects_regions_jobs_list(opt, dry_run, &mut err)
                        .await;
                }
                ("regions-jobs-patch", Some(opt)) => {
                    call_result = self
                        ._projects_regions_jobs_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("regions-jobs-set-iam-policy", Some(opt)) => {
                    call_result = self
                        ._projects_regions_jobs_set_iam_policy(opt, dry_run, &mut err)
                        .await;
                }
                ("regions-jobs-submit", Some(opt)) => {
                    call_result = self
                        ._projects_regions_jobs_submit(opt, dry_run, &mut err)
                        .await;
                }
                ("regions-jobs-submit-as-operation", Some(opt)) => {
                    call_result = self
                        ._projects_regions_jobs_submit_as_operation(opt, dry_run, &mut err)
                        .await;
                }
                ("regions-jobs-test-iam-permissions", Some(opt)) => {
                    call_result = self
                        ._projects_regions_jobs_test_iam_permissions(opt, dry_run, &mut err)
                        .await;
                }
                ("regions-operations-cancel", Some(opt)) => {
                    call_result = self
                        ._projects_regions_operations_cancel(opt, dry_run, &mut err)
                        .await;
                }
                ("regions-operations-delete", Some(opt)) => {
                    call_result = self
                        ._projects_regions_operations_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("regions-operations-get", Some(opt)) => {
                    call_result = self
                        ._projects_regions_operations_get(opt, dry_run, &mut err)
                        .await;
                }
                ("regions-operations-get-iam-policy", Some(opt)) => {
                    call_result = self
                        ._projects_regions_operations_get_iam_policy(opt, dry_run, &mut err)
                        .await;
                }
                ("regions-operations-list", Some(opt)) => {
                    call_result = self
                        ._projects_regions_operations_list(opt, dry_run, &mut err)
                        .await;
                }
                ("regions-operations-set-iam-policy", Some(opt)) => {
                    call_result = self
                        ._projects_regions_operations_set_iam_policy(opt, dry_run, &mut err)
                        .await;
                }
                ("regions-operations-test-iam-permissions", Some(opt)) => {
                    call_result = self
                        ._projects_regions_operations_test_iam_permissions(opt, dry_run, &mut err)
                        .await;
                }
                ("regions-workflow-templates-create", Some(opt)) => {
                    call_result = self
                        ._projects_regions_workflow_templates_create(opt, dry_run, &mut err)
                        .await;
                }
                ("regions-workflow-templates-delete", Some(opt)) => {
                    call_result = self
                        ._projects_regions_workflow_templates_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("regions-workflow-templates-get", Some(opt)) => {
                    call_result = self
                        ._projects_regions_workflow_templates_get(opt, dry_run, &mut err)
                        .await;
                }
                ("regions-workflow-templates-get-iam-policy", Some(opt)) => {
                    call_result = self
                        ._projects_regions_workflow_templates_get_iam_policy(opt, dry_run, &mut err)
                        .await;
                }
                ("regions-workflow-templates-instantiate", Some(opt)) => {
                    call_result = self
                        ._projects_regions_workflow_templates_instantiate(opt, dry_run, &mut err)
                        .await;
                }
                ("regions-workflow-templates-instantiate-inline", Some(opt)) => {
                    call_result = self
                        ._projects_regions_workflow_templates_instantiate_inline(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("regions-workflow-templates-list", Some(opt)) => {
                    call_result = self
                        ._projects_regions_workflow_templates_list(opt, dry_run, &mut err)
                        .await;
                }
                ("regions-workflow-templates-set-iam-policy", Some(opt)) => {
                    call_result = self
                        ._projects_regions_workflow_templates_set_iam_policy(opt, dry_run, &mut err)
                        .await;
                }
                ("regions-workflow-templates-test-iam-permissions", Some(opt)) => {
                    call_result = self
                        ._projects_regions_workflow_templates_test_iam_permissions(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("regions-workflow-templates-update", Some(opt)) => {
                    call_result = self
                        ._projects_regions_workflow_templates_update(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "dataproc1-secret.json",
