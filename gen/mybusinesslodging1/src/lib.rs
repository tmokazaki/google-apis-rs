...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/mybusinesslodging1).
//! # Features
//!
//! Handle the following *Resources* with ease from the central [hub](MyBusinessLodging) ...
//!
//! * locations
//!  * [*get lodging*](api::LocationGetLodgingCall), [*lodging get google updated*](api::LocationLodgingGetGoogleUpdatedCall) and [*update lodging*](api::LocationUpdateLodgingCall)
//!
//!
//!
//!
