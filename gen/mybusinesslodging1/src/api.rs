...
/// ```
#[derive(Clone)]
pub struct MyBusinessLodging<C> {
...
impl<C> common::Hub for MyBusinessLodging<C> {}

impl<'a, C> MyBusinessLodging<C> {
...
impl common::Part for Accessibility {}
...
impl common::Part for Connectivity {}
...
impl common::Part for EcoCertification {}
...
impl common::Part for EnergyEfficiency {}
...
impl common::Part for EnhancedCleaning {}
...
impl common::Part for FoodAndDrink {}
...
impl common::ResponseResult for GetGoogleUpdatedLodgingResponse {}
...
impl common::Part for GuestUnitFeatures {}
...
impl common::Part for GuestUnitType {}
...
impl common::Part for HealthAndSafety {}
...
impl common::Part for Housekeeping {}
...
impl common::Part for IncreasedFoodSafety {}
...
impl common::Part for LanguageSpoken {}
...
impl common::Part for LivingArea {}
...
impl common::Part for LivingAreaAccessibility {}
...
impl common::Part for LivingAreaEating {}
...
impl common::Part for LivingAreaFeatures {}
...
impl common::Part for LivingAreaLayout {}
...
impl common::Part for LivingAreaSleeping {}
...
impl common::RequestValue for Lodging {}
impl common::ResponseResult for Lodging {}
...
impl common::Part for LodgingMetadata {}
...
impl common::Part for MinimizedContact {}
...
impl common::Part for PaymentOptions {}
...
impl common::Part for PersonalProtection {}
...
impl common::Part for PhysicalDistancing {}
...
impl common::Part for Sustainability {}
...
impl common::Part for SustainabilityCertifications {}
...
impl common::Part for SustainableSourcing {}
...
impl common::Part for Transportation {}
...
impl common::Part for ViewsFromUnit {}
...
impl common::Part for WasteReduction {}
...
impl common::Part for WaterConservation {}
...
impl<'a, C> LocationMethods<'a, C> {
    ...
    pub fn lodging_get_google_updated(
        &self,
        name: &str,
    ) -> LocationLodgingGetGoogleUpdatedCall<'a, C> {
    ...
    ///
    /// * `name` - Required. Google identifier for this location in the form: `locations/{location_id}/lodging`
    pub fn get_lodging(&self, name: &str) -> LocationGetLodgingCall<'a, C> {
    ...
    /// * `name` - Required. Google identifier for this location in the form: `locations/{location_id}/lodging`
    pub fn update_lodging(&self, request: Lodging, name: &str) -> LocationUpdateLodgingCall<'a, C> {
...
/// # }
/// ```
pub struct LocationLodgingGetGoogleUpdatedCall<'a, C>
where
    C: 'a,
{
    hub: &'a MyBusinessLodging<C>,
...
impl<'a, C> common::CallBuilder for LocationLodgingGetGoogleUpdatedCall<'a, C> {}

impl<'a, C> LocationLodgingGetGoogleUpdatedCall<'a, C>
where
    C: common::Connector,
{
    ...
    pub async fn doit(
        mut self,
    ) -> common::Result<(common::Response, GetGoogleUpdatedLodgingResponse)> {
        use std::borrow::Cow;
    ...
    pub fn name(mut self, new_value: &str) -> LocationLodgingGetGoogleUpdatedCall<'a, C> {
    ...
    pub fn param<T>(mut self, name: T, value: T) -> LocationLodgingGetGoogleUpdatedCall<'a, C>
    where
        T: AsRef<str>,
    {
...
/// # }
/// ```
pub struct LocationGetLodgingCall<'a, C>
where
    C: 'a,
{
    hub: &'a MyBusinessLodging<C>,
...
impl<'a, C> common::CallBuilder for LocationGetLodgingCall<'a, C> {}

impl<'a, C> LocationGetLodgingCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, Lodging)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> LocationGetLodgingCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// Required. The specific fields to return. Use "*" to include all fields. Repeated field items cannot be individually specified.
    ///
    /// Sets the *read mask* query property to the given value.
    pub fn read_mask(mut self, new_value: common::FieldMask) -> LocationGetLodgingCall<'a, C> {
        self._read_mask = Some(new_value);
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> LocationGetLodgingCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
...
/// # }
/// ```
pub struct LocationUpdateLodgingCall<'a, C>
where
    C: 'a,
{
    hub: &'a MyBusinessLodging<C>,
...
impl<'a, C> common::CallBuilder for LocationUpdateLodgingCall<'a, C> {}

impl<'a, C> LocationUpdateLodgingCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: Lodging) -> LocationUpdateLodgingCall<'a, C> {
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> LocationUpdateLodgingCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    ...
    pub fn update_mask(mut self, new_value: common::FieldMask) -> LocationUpdateLodgingCall<'a, C> {
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> LocationUpdateLodgingCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
