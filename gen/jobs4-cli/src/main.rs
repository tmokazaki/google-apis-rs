...
use google_jobs4::{api, yup_oauth2, Error};
    ...
    C: apis_common::Connector,
{
    ...
    async fn _projects_tenants_client_events_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::ClientEvent = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .tenants_client_events_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_tenants_companies_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "derived-info.headquarters-location.lat-lng.latitude" => Some((
                ...
                "derived-info.headquarters-location.lat-lng.longitude" => Some((
                    "derivedInfo.headquartersLocation.latLng.longitude",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "derived-info.headquarters-location.location-type" => Some((
                    "derivedInfo.headquartersLocation.locationType",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "derived-info.headquarters-location.postal-address.address-lines" => Some((
                    "derivedInfo.headquartersLocation.postalAddress.addressLines",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "derived-info.headquarters-location.postal-address.administrative-area" => Some((
                    "derivedInfo.headquartersLocation.postalAddress.administrativeArea",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "derived-info.headquarters-location.postal-address.language-code" => Some((
                    "derivedInfo.headquartersLocation.postalAddress.languageCode",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "derived-info.headquarters-location.postal-address.locality" => Some((
                    "derivedInfo.headquartersLocation.postalAddress.locality",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "derived-info.headquarters-location.postal-address.organization" => Some((
                    "derivedInfo.headquartersLocation.postalAddress.organization",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "derived-info.headquarters-location.postal-address.postal-code" => Some((
                    "derivedInfo.headquartersLocation.postalAddress.postalCode",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "derived-info.headquarters-location.postal-address.recipients" => Some((
                    "derivedInfo.headquartersLocation.postalAddress.recipients",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "derived-info.headquarters-location.postal-address.region-code" => Some((
                    "derivedInfo.headquartersLocation.postalAddress.regionCode",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "derived-info.headquarters-location.postal-address.revision" => Some((
                    "derivedInfo.headquartersLocation.postalAddress.revision",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                )),
                "derived-info.headquarters-location.postal-address.sorting-code" => Some((
                    "derivedInfo.headquartersLocation.postalAddress.sortingCode",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "derived-info.headquarters-location.postal-address.sublocality" => Some((
                    "derivedInfo.headquartersLocation.postalAddress.sublocality",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "derived-info.headquarters-location.radius-miles" => Some((
                    "derivedInfo.headquartersLocation.radiusMiles",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                ...
                "keyword-searchable-job-custom-attributes" => Some((
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        ...
                        &vec![
                            ...
                            "hiring-agency",
                            "image-uri",
                            "keyword-searchable-job-custom-attributes",
                            "language-code",
                            "lat-lng",
                            "latitude",
                            "locality",
        ...
        let mut request: api::Company = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .tenants_companies_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_tenants_companies_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .tenants_companies_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_tenants_companies_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .tenants_companies_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_tenants_companies_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .tenants_companies_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            .iter()
        {
            ...
            match key {
                "require-open-jobs" => {
                    call = call.require_open_jobs(
                        value
                            .map(|v| arg_from_str(v, err, "require-open-jobs", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "page-token" => {
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["page-size", "page-token", "require-open-jobs"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _projects_tenants_companies_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .tenants_companies_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_tenants_complete_query(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .tenants_complete_query(opt.value_of("tenant").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_tenants_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::Tenant = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .tenants_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_tenants_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .tenants_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_tenants_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .tenants_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_tenants_jobs_batch_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::BatchCreateJobsRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .tenants_jobs_batch_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_tenants_jobs_batch_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::BatchDeleteJobsRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .tenants_jobs_batch_delete(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_tenants_jobs_batch_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::BatchUpdateJobsRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .tenants_jobs_batch_update(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_tenants_jobs_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .tenants_jobs_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_tenants_jobs_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .tenants_jobs_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_tenants_jobs_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .tenants_jobs_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_tenants_jobs_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .tenants_jobs_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["filter", "job-view", "page-size", "page-token"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _projects_tenants_jobs_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .tenants_jobs_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_tenants_jobs_search(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::SearchJobsRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .tenants_jobs_search(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_tenants_jobs_search_for_alert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .tenants_jobs_search_for_alert(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_tenants_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .tenants_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_tenants_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .tenants_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
        ...
        match self.opt.subcommand() {
            ("projects", Some(opt)) => match opt.subcommand() {
                ...
                ("tenants-client-events-create", Some(opt)) => {
                    call_result = self
                        ._projects_tenants_client_events_create(opt, dry_run, &mut err)
                        .await;
                }
                ("tenants-companies-create", Some(opt)) => {
                    call_result = self
                        ._projects_tenants_companies_create(opt, dry_run, &mut err)
                        .await;
                }
                ("tenants-companies-delete", Some(opt)) => {
                    call_result = self
                        ._projects_tenants_companies_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("tenants-companies-get", Some(opt)) => {
                    call_result = self
                        ._projects_tenants_companies_get(opt, dry_run, &mut err)
                        .await;
                }
                ("tenants-companies-list", Some(opt)) => {
                    call_result = self
                        ._projects_tenants_companies_list(opt, dry_run, &mut err)
                        .await;
                }
                ("tenants-companies-patch", Some(opt)) => {
                    call_result = self
                        ._projects_tenants_companies_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("tenants-complete-query", Some(opt)) => {
                    call_result = self
                        ._projects_tenants_complete_query(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("tenants-jobs-batch-create", Some(opt)) => {
                    call_result = self
                        ._projects_tenants_jobs_batch_create(opt, dry_run, &mut err)
                        .await;
                }
                ("tenants-jobs-batch-delete", Some(opt)) => {
                    call_result = self
                        ._projects_tenants_jobs_batch_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("tenants-jobs-batch-update", Some(opt)) => {
                    call_result = self
                        ._projects_tenants_jobs_batch_update(opt, dry_run, &mut err)
                        .await;
                }
                ("tenants-jobs-create", Some(opt)) => {
                    call_result = self
                        ._projects_tenants_jobs_create(opt, dry_run, &mut err)
                        .await;
                }
                ("tenants-jobs-delete", Some(opt)) => {
                    call_result = self
                        ._projects_tenants_jobs_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("tenants-jobs-get", Some(opt)) => {
                    call_result = self
                        ._projects_tenants_jobs_get(opt, dry_run, &mut err)
                        .await;
                }
                ("tenants-jobs-list", Some(opt)) => {
                    call_result = self
                        ._projects_tenants_jobs_list(opt, dry_run, &mut err)
                        .await;
                }
                ("tenants-jobs-patch", Some(opt)) => {
                    call_result = self
                        ._projects_tenants_jobs_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("tenants-jobs-search", Some(opt)) => {
                    call_result = self
                        ._projects_tenants_jobs_search(opt, dry_run, &mut err)
                        .await;
                }
                ("tenants-jobs-search-for-alert", Some(opt)) => {
                    call_result = self
                        ._projects_tenants_jobs_search_for_alert(opt, dry_run, &mut err)
                        .await;
                }
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "jobs4-secret.json",
