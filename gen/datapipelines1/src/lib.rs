...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/datapipelines1).
//! # Features
//!
//! Handle the following *Resources* with ease from the central [hub](Datapipelines) ...
//!
//! * projects
//!  * [*locations pipelines create*](api::ProjectLocationPipelineCreateCall), [*locations pipelines delete*](api::ProjectLocationPipelineDeleteCall), [*locations pipelines get*](api::ProjectLocationPipelineGetCall), [*locations pipelines jobs list*](api::ProjectLocationPipelineJobListCall), [*locations pipelines list*](api::ProjectLocationPipelineListCall), [*locations pipelines patch*](api::ProjectLocationPipelinePatchCall), [*locations pipelines run*](api::ProjectLocationPipelineRunCall) and [*locations pipelines stop*](api::ProjectLocationPipelineStopCall)
//!
//!
//!
//!
