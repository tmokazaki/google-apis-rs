...
impl<C> common::Hub for Clouderrorreporting<C> {}

impl<'a, C> Clouderrorreporting<C> {
    pub fn new<A: 'static + common::GetToken>(
        client: common::Client<C>,
        auth: A,
    ) -> Clouderrorreporting<C> {
        Clouderrorreporting {
            client,
            auth: Box::new(auth),
...
impl common::ResponseResult for DeleteEventsResponse {}
...
impl common::Part for ErrorContext {}
...
impl common::Part for ErrorEvent {}
...
impl common::RequestValue for ErrorGroup {}
impl common::ResponseResult for ErrorGroup {}
...
pub struct ErrorGroupStats {
    ...
    pub first_seen_time: Option<chrono::DateTime<chrono::offset::Utc>>,
    /// Group data that is independent of the filter criteria.
    pub group: Option<ErrorGroup>,
    /// Approximate last occurrence that was ever seen for this group and which matches the given filter criteria, ignoring the time_range that was specified in the request.
    #[serde(rename = "lastSeenTime")]
    pub last_seen_time: Option<chrono::DateTime<chrono::offset::Utc>>,
...
impl common::Part for ErrorGroupStats {}
...
impl common::Part for HttpRequestContext {}
...
pub struct ListEventsResponse {
    ...
    pub time_range_begin: Option<chrono::DateTime<chrono::offset::Utc>>,
}

impl common::ResponseResult for ListEventsResponse {}
...
impl common::ResponseResult for ListGroupStatsResponse {}
...
impl common::ResponseResult for ReportErrorEventResponse {}
...
impl common::RequestValue for ReportedErrorEvent {}
...
impl common::Part for ServiceContext {}
...
impl common::Part for SourceLocation {}
...
impl common::Part for SourceReference {}
...
impl common::Part for TimedCount {}
...
impl common::Part for TrackingIssue {}
...
impl<'a, C> common::CallBuilder for ProjectEventListCall<'a, C> {}

impl<'a, C> ProjectEventListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, ListEventsResponse)> {
        use std::borrow::Cow;
    ...
    pub fn add_scope<St>(mut self, scope: St) -> ProjectEventListCall<'a, C>
    where
        St: AsRef<str>,
    {
    ...
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectEventListCall<'a, C>
    where
    ...
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectEventListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for ProjectEventReportCall<'a, C> {}

impl<'a, C> ProjectEventReportCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, ReportErrorEventResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectEventReportCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectEventReportCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectEventReportCall<'a, C> {
        self._scopes.clear();
        self
    }
}
    ...
    C: 'a,
{
    hub: &'a Clouderrorreporting<C>,
    _project_name: String,
    _timed_count_duration: Option<chrono::Duration>,
    _time_range_period: Option<String>,
    _service_filter_version: Option<String>,
    _service_filter_service: Option<String>,
    _service_filter_resource_type: Option<String>,
    ...
    _alignment_time: Option<chrono::DateTime<chrono::offset::Utc>>,
...
impl<'a, C> common::CallBuilder for ProjectGroupStatListCall<'a, C> {}

impl<'a, C> ProjectGroupStatListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, ListGroupStatsResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    ///
    /// Sets the *service filter.resource type* query property to the given value.
    pub fn service_filter_resource_type(
        mut self,
        new_value: &str,
    ) -> ProjectGroupStatListCall<'a, C> {
        self._service_filter_resource_type = Some(new_value.to_string());
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectGroupStatListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectGroupStatListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectGroupStatListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for ProjectGroupGetCall<'a, C> {}

impl<'a, C> ProjectGroupGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, ErrorGroup)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectGroupGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectGroupGetCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectGroupGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for ProjectGroupUpdateCall<'a, C> {}

impl<'a, C> ProjectGroupUpdateCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectGroupUpdateCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectGroupUpdateCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectGroupUpdateCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for ProjectDeleteEventCall<'a, C> {}

impl<'a, C> ProjectDeleteEventCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, DeleteEventsResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectDeleteEventCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectDeleteEventCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectDeleteEventCall<'a, C> {
        self._scopes.clear();
        self
    }
}
