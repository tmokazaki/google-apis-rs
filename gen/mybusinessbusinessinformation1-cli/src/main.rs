...
use google_mybusinessbusinessinformation1::{api, yup_oauth2, Error};
...
struct Engine<'n, C> {
    opt: ArgMatches<'n>,
    hub: api::MyBusinessBusinessInformation<C>,
    gp: Vec<&'static str>,
...
{
    async fn _accounts_locations_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
            ...
            .iter()
        {
            ...
            {
                "ad-words-location-extensions.ad-phone" => Some((
                ...
                "categories.primary-category.display-name" => Some((
                ...
                "categories.primary-category.name" => Some((
                ...
                "metadata.can-have-business-calls" => Some((
                    "metadata.canHaveBusinessCalls",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "metadata.can-have-food-menus" => Some((
                ...
                "metadata.can-modify-service-list" => Some((
                    "metadata.canModifyServiceList",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "metadata.can-operate-health-data" => Some((
                    "metadata.canOperateHealthData",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "metadata.can-operate-local-post" => Some((
                    "metadata.canOperateLocalPost",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "metadata.can-operate-lodging-data" => Some((
                    "metadata.canOperateLodgingData",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "metadata.duplicate-location" => Some((
                ...
                "metadata.has-google-updated" => Some((
                ...
                "metadata.has-pending-edits" => Some((
                ...
                "metadata.has-voice-of-merchant" => Some((
                ...
                "open-info.opening-date.day" => Some((
                    "openInfo.openingDate.day",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                )),
                "open-info.opening-date.month" => Some((
                    "openInfo.openingDate.month",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                )),
                "open-info.opening-date.year" => Some((
                    "openInfo.openingDate.year",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                )),
                "open-info.status" => Some((
                    "openInfo.status",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                ...
                "phone-numbers.additional-phones" => Some((
                ...
                "phone-numbers.primary-phone" => Some((
                ...
                "relationship-data.parent-chain" => Some((
                ...
                "relationship-data.parent-location.place-id" => Some((
                    "relationshipData.parentLocation.placeId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "relationship-data.parent-location.relation-type" => Some((
                    "relationshipData.parentLocation.relationType",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "service-area.business-type" => Some((
                ...
                "storefront-address.address-lines" => Some((
                ...
                "storefront-address.administrative-area" => Some((
                ...
                "storefront-address.language-code" => Some((
                ...
                "storefront-address.locality" => Some((
                ...
                "storefront-address.organization" => Some((
                ...
                "storefront-address.postal-code" => Some((
                ...
                "storefront-address.recipients" => Some((
                ...
                "storefront-address.region-code" => Some((
                ...
                "storefront-address.revision" => Some((
                    "storefrontAddress.revision",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                )),
                "storefront-address.sorting-code" => Some((
                ...
                "storefront-address.sublocality" => Some((
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        ...
                        &vec![
                            ...
                            "business-type",
                            "can-delete",
                            "can-have-business-calls",
                            "can-have-food-menus",
                            "can-modify-service-list",
                            "can-operate-health-data",
                            "can-operate-local-post",
                            "can-operate-lodging-data",
                            "can-reopen",
                            "categories",
                            "day",
                            "description",
        ...
        let mut request: api::Location = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .accounts()
            .locations_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_locations_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            match key {
                "show-all" => {
                    call = call.show_all(
                        value
                            .map(|v| arg_from_str(v, err, "show-all", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "region-code" => {
    ...
    async fn _categories_batch_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["language-code", "names", "region-code", "view"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _google_locations_search(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                "location.ad-words-location-extensions.ad-phone" => Some((
                ...
                "location.categories.primary-category.display-name" => Some((
                ...
                "location.categories.primary-category.name" => Some((
                ...
                "location.latlng.longitude" => Some((
                ...
                "location.metadata.can-delete" => Some((
                    "location.metadata.canDelete",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "location.metadata.can-have-business-calls" => Some((
                    "location.metadata.canHaveBusinessCalls",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "location.metadata.can-have-food-menus" => Some((
                ...
                "location.metadata.can-modify-service-list" => Some((
                    "location.metadata.canModifyServiceList",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "location.metadata.can-operate-health-data" => Some((
                    "location.metadata.canOperateHealthData",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "location.metadata.can-operate-local-post" => Some((
                    "location.metadata.canOperateLocalPost",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "location.metadata.can-operate-lodging-data" => Some((
                ...
                "location.metadata.duplicate-location" => Some((
                    "location.metadata.duplicateLocation",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "location.metadata.has-google-updated" => Some((
                ...
                "location.metadata.has-pending-edits" => Some((
                ...
                "location.metadata.has-voice-of-merchant" => Some((
                    "location.metadata.hasVoiceOfMerchant",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                ...
                "location.metadata.new-review-uri" => Some((
                ...
                "location.metadata.place-id" => Some((
                ...
                "location.open-info.can-reopen" => Some((
                ...
                "location.open-info.opening-date.day" => Some((
                ...
                "location.open-info.opening-date.month" => Some((
                ...
                "location.open-info.opening-date.year" => Some((
                ...
                "location.open-info.status" => Some((
                ...
                "location.phone-numbers.additional-phones" => Some((
                ...
                "location.phone-numbers.primary-phone" => Some((
                ...
                "location.profile.description" => Some((
                ...
                "location.relationship-data.parent-chain" => Some((
                    "location.relationshipData.parentChain",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "location.relationship-data.parent-location.place-id" => Some((
                    "location.relationshipData.parentLocation.placeId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "location.relationship-data.parent-location.relation-type" => Some((
                    "location.relationshipData.parentLocation.relationType",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "location.service-area.business-type" => Some((
                ...
                "location.service-area.region-code" => Some((
                ...
                "location.storefront-address.address-lines" => Some((
                ...
                "location.storefront-address.administrative-area" => Some((
                ...
                "location.storefront-address.language-code" => Some((
                    "location.storefrontAddress.languageCode",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "location.storefront-address.locality" => Some((
                ...
                "location.storefront-address.organization" => Some((
                    "location.storefrontAddress.organization",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "location.storefront-address.postal-code" => Some((
                ...
                "location.storefront-address.recipients" => Some((
                    "location.storefrontAddress.recipients",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "location.storefront-address.region-code" => Some((
                ...
                "location.storefront-address.revision" => Some((
                    "location.storefrontAddress.revision",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                )),
                "location.storefront-address.sorting-code" => Some((
                    "location.storefrontAddress.sortingCode",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "location.storefront-address.sublocality" => Some((
                    "location.storefrontAddress.sublocality",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
        ...
        let mut request: api::SearchGoogleLocationsRequest =
    ...
    async fn _locations_attributes_get_google_updated(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .locations()
            .attributes_get_google_updated(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _locations_get_attributes(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .locations()
            .get_attributes(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _locations_get_google_updated(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .locations()
            .get_google_updated(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _locations_update_attributes(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::Attributes = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .locations()
            .update_attributes(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            .iter()
        {
            ...
            match key {
                "attribute-mask" => {
                    call = call.attribute_mask(
                        value
                            .map(|v| arg_from_str(v, err, "attribute-mask", "google-fieldmask"))
                            .unwrap_or(apis_common::FieldMask::default()),
                    );
                }
                _ => {
        ...
        match self.opt.subcommand() {
            ("accounts", Some(opt)) => match opt.subcommand() {
                ("locations-create", Some(opt)) => {
                    call_result = self
                        ._accounts_locations_create(opt, dry_run, &mut err)
                        .await;
                }
            ...
            ("attributes", Some(opt)) => match opt.subcommand() {
                ("list", Some(opt)) => {
                    call_result = self._attributes_list(opt, dry_run, &mut err).await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("attributes".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("categories", Some(opt)) => match opt.subcommand() {
                ("batch-get", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("categories".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("chains", Some(opt)) => match opt.subcommand() {
                ("get", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("chains".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("google-locations", Some(opt)) => match opt.subcommand() {
                ("search", Some(opt)) => {
                    call_result = self._google_locations_search(opt, dry_run, &mut err).await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("google-locations".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("locations", Some(opt)) => match opt.subcommand() {
                ("attributes-get-google-updated", Some(opt)) => {
                    call_result = self
                        ._locations_attributes_get_google_updated(opt, dry_run, &mut err)
                        .await;
                }
                ("delete", Some(opt)) => {
                ...
                ("get-google-updated", Some(opt)) => {
                    call_result = self
                        ._locations_get_google_updated(opt, dry_run, &mut err)
                        .await;
                }
                ("patch", Some(opt)) => {
                ...
                ("update-attributes", Some(opt)) => {
                    call_result = self
                        ._locations_update_attributes(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "mybusinessbusinessinformation1-secret.json",
