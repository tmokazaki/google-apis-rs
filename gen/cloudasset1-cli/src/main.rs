...
use google_cloudasset1::{api, yup_oauth2, Error};
    ...
    C: apis_common::Connector,
{
    ...
    async fn _effective_iam_policies_batch_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            ...
            .batch_get(opt.value_of("scope").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _feeds_create(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "feed.condition.description" => Some((
                    "feed.condition.description",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "feed.condition.expression" => Some((
                    "feed.condition.expression",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "feed.condition.location" => Some((
                    "feed.condition.location",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "feed.condition.title" => Some((
                    "feed.condition.title",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "feed.content-type" => Some((
                    "feed.contentType",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                ...
                "feed.feed-output-config.pubsub-destination.topic" => Some((
                    "feed.feedOutputConfig.pubsubDestination.topic",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
        ...
        let mut request: api::CreateFeedRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .feeds()
    ...
    async fn _feeds_patch(
        ...
        let mut request: api::UpdateFeedRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .feeds()
    ...
    async fn _methods_analyze_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .methods()
            .analyze_iam_policy(opt.value_of("scope").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            .iter()
        {
            ...
            match key {
                ...
                "execution-timeout" => {
                    call = call.execution_timeout(
                        value
                            .map(|v| arg_from_str(v, err, "execution-timeout", "google-duration"))
                            .unwrap_or(chrono::Duration::seconds(0)),
                    );
                }
                "analysis-query-resource-selector-full-resource-name" => {
                    call = call
                        .analysis_query_resource_selector_full_resource_name(value.unwrap_or(""));
                }
                "analysis-query-options-output-resource-edges" => {
                    call = call.analysis_query_options_output_resource_edges(
                        value
                            .map(|v| {
                                arg_from_str(
                                    v,
                ...
                "analysis-query-options-output-group-edges" => {
                    call = call.analysis_query_options_output_group_edges(
                        value
                            .map(|v| {
                                arg_from_str(
                                    v,
                ...
                "analysis-query-options-expand-roles" => {
                    call = call.analysis_query_options_expand_roles(
                        value
                            .map(|v| {
                                arg_from_str(
                                    v,
                ...
                "analysis-query-options-expand-resources" => {
                    call = call.analysis_query_options_expand_resources(
                        value
                            .map(|v| {
                                arg_from_str(
                                    v,
                ...
                "analysis-query-options-expand-groups" => {
                    call = call.analysis_query_options_expand_groups(
                        value
                            .map(|v| {
                                arg_from_str(
                                    v,
                ...
                "analysis-query-options-analyze-service-account-impersonation" => {
                    call = call.analysis_query_options_analyze_service_account_impersonation(
                        value
                            .map(|v| {
                                arg_from_str(
                                    v,
                ...
                "analysis-query-condition-context-access-time" => {
                    call = call.analysis_query_condition_context_access_time(
                        value
                            .map(|v| {
                                arg_from_str(
                                    v,
    ...
    async fn _methods_analyze_iam_policy_longrunning(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                "analysis-query.access-selector.permissions" => Some((
                ...
                "analysis-query.access-selector.roles" => Some((
                ...
                "analysis-query.condition-context.access-time" => Some((
                ...
                "analysis-query.identity-selector.identity" => Some((
                ...
                "analysis-query.options.analyze-service-account-impersonation" => Some((
                ...
                "analysis-query.options.expand-groups" => Some((
                ...
                "analysis-query.options.expand-resources" => Some((
                ...
                "analysis-query.options.expand-roles" => Some((
                ...
                "analysis-query.options.output-group-edges" => Some((
                ...
                "analysis-query.options.output-resource-edges" => Some((
                ...
                "analysis-query.resource-selector.full-resource-name" => Some((
                ...
                "output-config.bigquery-destination.dataset" => Some((
                    "outputConfig.bigqueryDestination.dataset",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "output-config.bigquery-destination.partition-key" => Some((
                    "outputConfig.bigqueryDestination.partitionKey",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "output-config.bigquery-destination.table-prefix" => Some((
                    "outputConfig.bigqueryDestination.tablePrefix",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "output-config.bigquery-destination.write-disposition" => Some((
                    "outputConfig.bigqueryDestination.writeDisposition",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
        ...
        let mut request: api::AnalyzeIamPolicyLongrunningRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .methods()
            .analyze_iam_policy_longrunning(request, opt.value_of("scope").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _methods_analyze_move(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .methods()
            .analyze_move(opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _methods_analyze_org_policies(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .methods()
            .analyze_org_policies(opt.value_of("scope").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["constraint", "filter", "page-size", "page-token"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _methods_analyze_org_policy_governed_assets(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .methods()
            .analyze_org_policy_governed_assets(opt.value_of("scope").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _methods_analyze_org_policy_governed_containers(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .methods()
            .analyze_org_policy_governed_containers(opt.value_of("scope").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _methods_batch_get_assets_history(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .methods()
            .batch_get_assets_history(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            .iter()
        {
            ...
            match key {
                ...
                "read-time-window-start-time" => {
                    call = call.read_time_window_start_time(
                        value
                            .map(|v| {
                                arg_from_str(
                                    v,
                ...
                "read-time-window-end-time" => {
                    call = call.read_time_window_end_time(
                        value
                            .map(|v| {
                                arg_from_str(v, err, "read-time-window-end-time", "google-datetime")
                            })
                            .unwrap_or(chrono::Utc::now()),
                    );
                }
    ...
    async fn _methods_export_assets(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "output-config.bigquery-destination.force" => Some((
                    "outputConfig.bigqueryDestination.force",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "output-config.bigquery-destination.partition-spec.partition-key" => Some((
                    "outputConfig.bigqueryDestination.partitionSpec.partitionKey",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "output-config.bigquery-destination.separate-tables-per-asset-type" => Some((
                    "outputConfig.bigqueryDestination.separateTablesPerAssetType",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "output-config.bigquery-destination.table" => Some((
                    "outputConfig.bigqueryDestination.table",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                ...
                "output-config.gcs-destination.uri-prefix" => Some((
                    "outputConfig.gcsDestination.uriPrefix",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        ...
                        &vec![
                            ...
                            "read-time",
                            "relationship-types",
                            "separate-tables-per-asset-type",
                            "table",
                            "uri",
                            "uri-prefix",
                        ],
        ...
        let mut request: api::ExportAssetsRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .methods()
            .export_assets(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _methods_query_assets(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "read-time-window.end-time" => Some((
                ...
                "read-time-window.start-time" => Some((
        ...
        let mut request: api::QueryAssetsRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .methods()
            .query_assets(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _methods_search_all_iam_policies(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .methods()
            .search_all_iam_policies(opt.value_of("scope").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _methods_search_all_resources(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .methods()
            .search_all_resources(opt.value_of("scope").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _saved_queries_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _saved_queries_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _doit(
        ...
        match self.opt.subcommand() {
            ("assets", Some(opt)) => match opt.subcommand() {
                ("list", Some(opt)) => {
                    call_result = self._assets_list(opt, dry_run, &mut err).await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("assets".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("effective-iam-policies", Some(opt)) => match opt.subcommand() {
                ("batch-get", Some(opt)) => {
                    call_result = self
                        ._effective_iam_policies_batch_get(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues.push(CLIError::MissingMethodError(
                        "effective-iam-policies".to_string(),
                    ));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("feeds", Some(opt)) => match opt.subcommand() {
                ("create", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("feeds".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("methods", Some(opt)) => match opt.subcommand() {
                ("analyze-iam-policy", Some(opt)) => {
                    call_result = self
                        ._methods_analyze_iam_policy(opt, dry_run, &mut err)
                        .await;
                }
                ("analyze-iam-policy-longrunning", Some(opt)) => {
                    call_result = self
                        ._methods_analyze_iam_policy_longrunning(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("analyze-org-policies", Some(opt)) => {
                    call_result = self
                        ._methods_analyze_org_policies(opt, dry_run, &mut err)
                        .await;
                }
                ("analyze-org-policy-governed-assets", Some(opt)) => {
                    call_result = self
                        ._methods_analyze_org_policy_governed_assets(opt, dry_run, &mut err)
                        .await;
                }
                ("analyze-org-policy-governed-containers", Some(opt)) => {
                    call_result = self
                        ._methods_analyze_org_policy_governed_containers(opt, dry_run, &mut err)
                        .await;
                }
                ("batch-get-assets-history", Some(opt)) => {
                    call_result = self
                        ._methods_batch_get_assets_history(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("search-all-iam-policies", Some(opt)) => {
                    call_result = self
                        ._methods_search_all_iam_policies(opt, dry_run, &mut err)
                        .await;
                }
                ("search-all-resources", Some(opt)) => {
                    call_result = self
                        ._methods_search_all_resources(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
            ...
            ("saved-queries", Some(opt)) => match opt.subcommand() {
                ("create", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("saved-queries".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            _ => {
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "cloudasset1-secret.json",
        ...
        .persist_tokens_to_disk(format!("{}/cloudasset1", config_dir))
        .build()
        .await
        .unwrap();
