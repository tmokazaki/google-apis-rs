...
use google_servicedirectory1_beta1::{api, yup_oauth2, Error};
    ...
    C: apis_common::Connector,
{
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec!["create-time", "labels", "name", "uid", "update-time"],
                    );
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec!["create-time", "metadata", "name", "uid", "update-time"],
                    );
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
    ...
    async fn _projects_locations_namespaces_workloads_get_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_namespaces_workloads_get_iam_policy(
                request,
                opt.value_of("resource").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_namespaces_workloads_set_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_namespaces_workloads_set_iam_policy(
                request,
                opt.value_of("resource").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_namespaces_workloads_test_iam_permissions(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_namespaces_workloads_test_iam_permissions(
                request,
                opt.value_of("resource").unwrap_or(""),
            );
        for parg in opt
        ...
        match self.opt.subcommand() {
            ("projects", Some(opt)) => match opt.subcommand() {
                ...
                ("locations-namespaces-workloads-get-iam-policy", Some(opt)) => {
                    call_result = self
                        ._projects_locations_namespaces_workloads_get_iam_policy(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-namespaces-workloads-set-iam-policy", Some(opt)) => {
                    call_result = self
                        ._projects_locations_namespaces_workloads_set_iam_policy(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-namespaces-workloads-test-iam-permissions", Some(opt)) => {
                    call_result = self
                        ._projects_locations_namespaces_workloads_test_iam_permissions(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "servicedirectory1-beta1-secret.json",
        ...
        .persist_tokens_to_disk(format!("{}/servicedirectory1-beta1", config_dir))
        .build()
        .await
        .unwrap();
    ...
    let arg_data = [
        ("projects", "methods: 'locations-get', 'locations-list', 'locations-namespaces-create', 'locations-namespaces-delete', 'locations-namespaces-get', 'locations-namespaces-get-iam-policy', 'locations-namespaces-list', 'locations-namespaces-patch', 'locations-namespaces-services-create', 'locations-namespaces-services-delete', 'locations-namespaces-services-endpoints-create', 'locations-namespaces-services-endpoints-delete', 'locations-namespaces-services-endpoints-get', 'locations-namespaces-services-endpoints-list', 'locations-namespaces-services-endpoints-patch', 'locations-namespaces-services-get', 'locations-namespaces-services-get-iam-policy', 'locations-namespaces-services-list', 'locations-namespaces-services-patch', 'locations-namespaces-services-resolve', 'locations-namespaces-services-set-iam-policy', 'locations-namespaces-services-test-iam-permissions', 'locations-namespaces-set-iam-policy', 'locations-namespaces-test-iam-permissions', 'locations-namespaces-workloads-get-iam-policy', 'locations-namespaces-workloads-set-iam-policy' and 'locations-namespaces-workloads-test-iam-permissions'", vec![
            ...
            ("locations-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_servicedirectory1_beta1_cli/projects_locations-list",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-namespaces-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_servicedirectory1_beta1_cli/projects_locations-namespaces-get",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-namespaces-get-iam-policy",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_servicedirectory1_beta1_cli/projects_locations-namespaces-get-iam-policy",
                  vec![
                    (Some(r##"resource"##),
                     None,
            ...
            ("locations-namespaces-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_servicedirectory1_beta1_cli/projects_locations-namespaces-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("locations-namespaces-patch",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_servicedirectory1_beta1_cli/projects_locations-namespaces-patch",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-namespaces-services-endpoints-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_servicedirectory1_beta1_cli/projects_locations-namespaces-services-endpoints-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("locations-namespaces-services-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_servicedirectory1_beta1_cli/projects_locations-namespaces-services-get",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-namespaces-services-get-iam-policy",
                    Some(r##"Gets the IAM Policy for a resource"##),
                    "Details at http://byron.github.io/google-apis-rs/google_servicedirectory1_beta1_cli/projects_locations-namespaces-services-get-iam-policy",
                  vec![
                    (Some(r##"resource"##),
                     None,
                     Some(r##"REQUIRED: The resource for which the policy is being requested. See [Resource names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for this field."##),
            ...
            ("locations-namespaces-services-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_servicedirectory1_beta1_cli/projects_locations-namespaces-services-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("locations-namespaces-services-patch",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_servicedirectory1_beta1_cli/projects_locations-namespaces-services-patch",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-namespaces-services-set-iam-policy",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_servicedirectory1_beta1_cli/projects_locations-namespaces-services-set-iam-policy",
                  vec![
                    (Some(r##"resource"##),
                     None,
            ...
            ("locations-namespaces-services-test-iam-permissions",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_servicedirectory1_beta1_cli/projects_locations-namespaces-services-test-iam-permissions",
                  vec![
                    (Some(r##"resource"##),
                     None,
            ...
            ("locations-namespaces-set-iam-policy",
                    Some(r##"Sets the IAM Policy for a resource"##),
                    "Details at http://byron.github.io/google-apis-rs/google_servicedirectory1_beta1_cli/projects_locations-namespaces-set-iam-policy",
                  vec![
                    (Some(r##"resource"##),
                     None,
                     Some(r##"REQUIRED: The resource for which the policy is being specified. See [Resource names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for this field."##),
            ...
            ("locations-namespaces-test-iam-permissions",
                    Some(r##"Tests IAM permissions for a resource (namespace, service or service workload only)."##),
                    "Details at http://byron.github.io/google-apis-rs/google_servicedirectory1_beta1_cli/projects_locations-namespaces-test-iam-permissions",
                  vec![
                    (Some(r##"resource"##),
                     None,
                     Some(r##"REQUIRED: The resource for which the policy detail is being requested. See [Resource names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for this field."##),
