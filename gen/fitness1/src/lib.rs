...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/fitness1).
//! # Features
//!
//! Handle the following *Resources* with ease from the central [hub](Fitness) ...
//!
//! * users
//!  * [*data sources create*](api::UserDataSourceCreateCall), [*data sources data point changes list*](api::UserDataSourceDataPointChangeListCall), [*data sources datasets delete*](api::UserDataSourceDatasetDeleteCall), [*data sources datasets get*](api::UserDataSourceDatasetGetCall), [*data sources datasets patch*](api::UserDataSourceDatasetPatchCall), [*data sources delete*](api::UserDataSourceDeleteCall), [*data sources get*](api::UserDataSourceGetCall), [*data sources list*](api::UserDataSourceListCall), [*data sources update*](api::UserDataSourceUpdateCall), [*dataset aggregate*](api::UserDatasetAggregateCall), [*sessions delete*](api::UserSessionDeleteCall), [*sessions list*](api::UserSessionListCall) and [*sessions update*](api::UserSessionUpdateCall)
//!
//!
//!
//!
