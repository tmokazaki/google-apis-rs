...
impl AsRef<str> for Scope {
    fn as_ref(&self) -> &str {
        match *self {
            ...
            Scope::BloodGlucoseWrite => {
                "https://www.googleapis.com/auth/fitness.blood_glucose.write"
            }
            Scope::BloodPressureRead => {
                "https://www.googleapis.com/auth/fitness.blood_pressure.read"
            }
            Scope::BloodPressureWrite => {
            ...
            Scope::BodyTemperatureRead => {
                "https://www.googleapis.com/auth/fitness.body_temperature.read"
            }
            Scope::BodyTemperatureWrite => {
            ...
            Scope::OxygenSaturationRead => {
                "https://www.googleapis.com/auth/fitness.oxygen_saturation.read"
            }
            Scope::OxygenSaturationWrite => {
                "https://www.googleapis.com/auth/fitness.oxygen_saturation.write"
            }
            Scope::ReproductiveHealthRead => {
                "https://www.googleapis.com/auth/fitness.reproductive_health.read"
            }
            Scope::ReproductiveHealthWrite => {
...
impl<C> common::Hub for Fitness<C> {}

impl<'a, C> Fitness<C> {
    pub fn new<A: 'static + common::GetToken>(client: common::Client<C>, auth: A) -> Fitness<C> {
        Fitness {
            client,
            auth: Box::new(auth),
...
impl common::Part for AggregateBucket {}
...
impl common::Part for AggregateBy {}
...
impl common::RequestValue for AggregateRequest {}
...
impl common::ResponseResult for AggregateResponse {}
...
impl common::Part for BucketByActivity {}
...
impl common::Part for BucketBySession {}
...
impl common::Part for BucketByTime {}
...
impl common::Part for BucketByTimePeriod {}
...
impl common::Part for DataPoint {}
...
impl common::RequestValue for DataSource {}
...
impl common::Part for DataTypeField {}
...
impl common::ResponseResult for ListDataPointChangesResponse {}
...
impl common::RequestValue for Session {}
...
impl common::Part for ValueMapValEntry {}
...
impl<'a, C> UserMethods<'a, C> {
    ...
    pub fn data_sources_data_point_changes_list(
        &self,
        user_id: &str,
        data_source_id: &str,
    ) -> UserDataSourceDataPointChangeListCall<'a, C> {
    ...
    pub fn data_sources_datasets_delete(
        &self,
        user_id: &str,
        data_source_id: &str,
        dataset_id: &str,
    ) -> UserDataSourceDatasetDeleteCall<'a, C> {
    ...
    /// * `dataSourceId` - The data stream ID of the data source that created the dataset.
    /// * `datasetId` - Dataset identifier that is a composite of the minimum data point start time and maximum data point end time represented as nanoseconds from the epoch. The ID is formatted like: "startTime-endTime" where startTime and endTime are 64 bit integers.
    pub fn data_sources_datasets_get(
        &self,
        user_id: &str,
        data_source_id: &str,
        dataset_id: &str,
    ) -> UserDataSourceDatasetGetCall<'a, C> {
    ...
    pub fn data_sources_datasets_patch(
        &self,
        request: Dataset,
        user_id: &str,
        data_source_id: &str,
        dataset_id: &str,
    ) -> UserDataSourceDatasetPatchCall<'a, C> {
    ...
    pub fn data_sources_create(
        &self,
        request: DataSource,
        user_id: &str,
    ) -> UserDataSourceCreateCall<'a, C> {
    ...
    pub fn data_sources_delete(
        &self,
        user_id: &str,
        data_source_id: &str,
    ) -> UserDataSourceDeleteCall<'a, C> {
    ...
    pub fn data_sources_get(
        &self,
        user_id: &str,
        data_source_id: &str,
    ) -> UserDataSourceGetCall<'a, C> {
    ...
    pub fn data_sources_list(&self, user_id: &str) -> UserDataSourceListCall<'a, C> {
    ...
    pub fn data_sources_update(
        &self,
        request: DataSource,
        user_id: &str,
        data_source_id: &str,
    ) -> UserDataSourceUpdateCall<'a, C> {
    ...
    pub fn sessions_delete(&self, user_id: &str, session_id: &str) -> UserSessionDeleteCall<'a, C> {
    ...
    pub fn sessions_list(&self, user_id: &str) -> UserSessionListCall<'a, C> {
        UserSessionListCall {
            hub: self.hub,
            _user_id: user_id.to_string(),
...
/// # }
/// ```
pub struct UserDataSourceDataPointChangeListCall<'a, C>
where
    C: 'a,
{
    hub: &'a Fitness<C>,
...
impl<'a, C> common::CallBuilder for UserDataSourceDataPointChangeListCall<'a, C> {}

impl<'a, C> UserDataSourceDataPointChangeListCall<'a, C>
where
    C: common::Connector,
{
    ...
    pub async fn doit(
        mut self,
    ) -> common::Result<(common::Response, ListDataPointChangesResponse)> {
        use std::borrow::Cow;
        ...
        let mut url =
            self.hub._base_url.clone() + "{userId}/dataSources/{dataSourceId}/dataPointChanges";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::ActivityRead.as_ref().to_string());
        }

        #[allow(clippy::single_element_loop)]
        for &(find_this, param_name) in
            [("{userId}", "userId"), ("{dataSourceId}", "dataSourceId")].iter()
        {
    ...
    pub fn user_id(mut self, new_value: &str) -> UserDataSourceDataPointChangeListCall<'a, C> {
    ...
    pub fn page_token(mut self, new_value: &str) -> UserDataSourceDataPointChangeListCall<'a, C> {
    ...
    pub fn limit(mut self, new_value: i32) -> UserDataSourceDataPointChangeListCall<'a, C> {
    ...
    pub fn param<T>(mut self, name: T, value: T) -> UserDataSourceDataPointChangeListCall<'a, C>
    where
        T: AsRef<str>,
    {
    ...
    pub fn add_scope<St>(mut self, scope: St) -> UserDataSourceDataPointChangeListCall<'a, C>
    where
        St: AsRef<str>,
    {
    ...
    pub fn add_scopes<I, St>(mut self, scopes: I) -> UserDataSourceDataPointChangeListCall<'a, C>
    where
    ...
    /// for details).
    pub fn clear_scopes(mut self) -> UserDataSourceDataPointChangeListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct UserDataSourceDatasetDeleteCall<'a, C>
where
    C: 'a,
{
    hub: &'a Fitness<C>,
...
impl<'a, C> common::CallBuilder for UserDataSourceDatasetDeleteCall<'a, C> {}

impl<'a, C> UserDataSourceDatasetDeleteCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<common::Response> {
        ...
        let mut url =
            self.hub._base_url.clone() + "{userId}/dataSources/{dataSourceId}/datasets/{datasetId}";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::ActivityWrite.as_ref().to_string());
        }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn user_id(mut self, new_value: &str) -> UserDataSourceDatasetDeleteCall<'a, C> {
        self._user_id = new_value.to_string();
        self
    }
    /// The data stream ID of the data source that created the dataset.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn data_source_id(mut self, new_value: &str) -> UserDataSourceDatasetDeleteCall<'a, C> {
        self._data_source_id = new_value.to_string();
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn dataset_id(mut self, new_value: &str) -> UserDataSourceDatasetDeleteCall<'a, C> {
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> UserDataSourceDatasetDeleteCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> UserDataSourceDatasetDeleteCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> UserDataSourceDatasetDeleteCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> UserDataSourceDatasetDeleteCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct UserDataSourceDatasetGetCall<'a, C>
where
    C: 'a,
{
    hub: &'a Fitness<C>,
...
impl<'a, C> common::CallBuilder for UserDataSourceDatasetGetCall<'a, C> {}

impl<'a, C> UserDataSourceDatasetGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn user_id(mut self, new_value: &str) -> UserDataSourceDatasetGetCall<'a, C> {
        self._user_id = new_value.to_string();
        self
    }
    /// The data stream ID of the data source that created the dataset.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn data_source_id(mut self, new_value: &str) -> UserDataSourceDatasetGetCall<'a, C> {
        self._data_source_id = new_value.to_string();
        self
    }
    /// Dataset identifier that is a composite of the minimum data point start time and maximum data point end time represented as nanoseconds from the epoch. The ID is formatted like: "startTime-endTime" where startTime and endTime are 64 bit integers.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn dataset_id(mut self, new_value: &str) -> UserDataSourceDatasetGetCall<'a, C> {
        self._dataset_id = new_value.to_string();
        self
    }
    ...
    ///
    /// Sets the *page token* query property to the given value.
    pub fn page_token(mut self, new_value: &str) -> UserDataSourceDatasetGetCall<'a, C> {
        self._page_token = Some(new_value.to_string());
        self
    }
    ...
    ///
    /// Sets the *limit* query property to the given value.
    pub fn limit(mut self, new_value: i32) -> UserDataSourceDatasetGetCall<'a, C> {
        self._limit = Some(new_value);
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> UserDataSourceDatasetGetCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> UserDataSourceDatasetGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> UserDataSourceDatasetGetCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> UserDataSourceDatasetGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct UserDataSourceDatasetPatchCall<'a, C>
where
    C: 'a,
{
    hub: &'a Fitness<C>,
...
impl<'a, C> common::CallBuilder for UserDataSourceDatasetPatchCall<'a, C> {}

impl<'a, C> UserDataSourceDatasetPatchCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: Dataset) -> UserDataSourceDatasetPatchCall<'a, C> {
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn user_id(mut self, new_value: &str) -> UserDataSourceDatasetPatchCall<'a, C> {
        self._user_id = new_value.to_string();
        self
    }
    /// The data stream ID of the data source that created the dataset.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn data_source_id(mut self, new_value: &str) -> UserDataSourceDatasetPatchCall<'a, C> {
        self._data_source_id = new_value.to_string();
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn dataset_id(mut self, new_value: &str) -> UserDataSourceDatasetPatchCall<'a, C> {
        self._dataset_id = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> UserDataSourceDatasetPatchCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> UserDataSourceDatasetPatchCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> UserDataSourceDatasetPatchCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> UserDataSourceDatasetPatchCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct UserDataSourceCreateCall<'a, C>
where
    C: 'a,
{
    hub: &'a Fitness<C>,
...
impl<'a, C> common::CallBuilder for UserDataSourceCreateCall<'a, C> {}

impl<'a, C> UserDataSourceCreateCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: DataSource) -> UserDataSourceCreateCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn user_id(mut self, new_value: &str) -> UserDataSourceCreateCall<'a, C> {
        self._user_id = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> UserDataSourceCreateCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> UserDataSourceCreateCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> UserDataSourceCreateCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> UserDataSourceCreateCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct UserDataSourceDeleteCall<'a, C>
where
    C: 'a,
{
    hub: &'a Fitness<C>,
...
impl<'a, C> common::CallBuilder for UserDataSourceDeleteCall<'a, C> {}

impl<'a, C> UserDataSourceDeleteCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn user_id(mut self, new_value: &str) -> UserDataSourceDeleteCall<'a, C> {
        self._user_id = new_value.to_string();
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn data_source_id(mut self, new_value: &str) -> UserDataSourceDeleteCall<'a, C> {
        self._data_source_id = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> UserDataSourceDeleteCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> UserDataSourceDeleteCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> UserDataSourceDeleteCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> UserDataSourceDeleteCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct UserDataSourceGetCall<'a, C>
where
    C: 'a,
{
    hub: &'a Fitness<C>,
...
impl<'a, C> common::CallBuilder for UserDataSourceGetCall<'a, C> {}

impl<'a, C> UserDataSourceGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn user_id(mut self, new_value: &str) -> UserDataSourceGetCall<'a, C> {
        self._user_id = new_value.to_string();
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn data_source_id(mut self, new_value: &str) -> UserDataSourceGetCall<'a, C> {
        self._data_source_id = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> UserDataSourceGetCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> UserDataSourceGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> UserDataSourceGetCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> UserDataSourceGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct UserDataSourceListCall<'a, C>
where
    C: 'a,
{
    hub: &'a Fitness<C>,
...
impl<'a, C> common::CallBuilder for UserDataSourceListCall<'a, C> {}

impl<'a, C> UserDataSourceListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, ListDataSourcesResponse)> {
        ...
        let mut params = Params::with_capacity(4 + self._additional_params.len());
        params.push("userId", self._user_id);
        if !self._data_type_name.is_empty() {
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn user_id(mut self, new_value: &str) -> UserDataSourceListCall<'a, C> {
        self._user_id = new_value.to_string();
        self
    }
    ...
    pub fn add_data_type_name(mut self, new_value: &str) -> UserDataSourceListCall<'a, C> {
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> UserDataSourceListCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> UserDataSourceListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> UserDataSourceListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> UserDataSourceListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct UserDataSourceUpdateCall<'a, C>
where
    C: 'a,
{
    hub: &'a Fitness<C>,
...
impl<'a, C> common::CallBuilder for UserDataSourceUpdateCall<'a, C> {}

impl<'a, C> UserDataSourceUpdateCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: DataSource) -> UserDataSourceUpdateCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn user_id(mut self, new_value: &str) -> UserDataSourceUpdateCall<'a, C> {
        self._user_id = new_value.to_string();
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn data_source_id(mut self, new_value: &str) -> UserDataSourceUpdateCall<'a, C> {
        self._data_source_id = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> UserDataSourceUpdateCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> UserDataSourceUpdateCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> UserDataSourceUpdateCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> UserDataSourceUpdateCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct UserDatasetAggregateCall<'a, C>
where
    C: 'a,
{
    hub: &'a Fitness<C>,
...
impl<'a, C> common::CallBuilder for UserDatasetAggregateCall<'a, C> {}

impl<'a, C> UserDatasetAggregateCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, AggregateResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: AggregateRequest) -> UserDatasetAggregateCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn user_id(mut self, new_value: &str) -> UserDatasetAggregateCall<'a, C> {
        self._user_id = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> UserDatasetAggregateCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> UserDatasetAggregateCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> UserDatasetAggregateCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> UserDatasetAggregateCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct UserSessionDeleteCall<'a, C>
where
    C: 'a,
{
    hub: &'a Fitness<C>,
...
impl<'a, C> common::CallBuilder for UserSessionDeleteCall<'a, C> {}

impl<'a, C> UserSessionDeleteCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<common::Response> {
        ...
        #[allow(clippy::single_element_loop)]
        for &(find_this, param_name) in
            [("{userId}", "userId"), ("{sessionId}", "sessionId")].iter()
        {
            url = params.uri_replacement(url, param_name, find_this, false);
        }
        {
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn user_id(mut self, new_value: &str) -> UserSessionDeleteCall<'a, C> {
        self._user_id = new_value.to_string();
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn session_id(mut self, new_value: &str) -> UserSessionDeleteCall<'a, C> {
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> UserSessionDeleteCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> UserSessionDeleteCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> UserSessionDeleteCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> UserSessionDeleteCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct UserSessionListCall<'a, C>
where
    C: 'a,
{
    hub: &'a Fitness<C>,
...
impl<'a, C> common::CallBuilder for UserSessionListCall<'a, C> {}

impl<'a, C> UserSessionListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, ListSessionsResponse)> {
        ...
        if !self._activity_type.is_empty() {
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn user_id(mut self, new_value: &str) -> UserSessionListCall<'a, C> {
        self._user_id = new_value.to_string();
        self
    }
    ...
    pub fn start_time(mut self, new_value: &str) -> UserSessionListCall<'a, C> {
    ...
    ///
    /// Sets the *page token* query property to the given value.
    pub fn page_token(mut self, new_value: &str) -> UserSessionListCall<'a, C> {
        self._page_token = Some(new_value.to_string());
        self
    }
    ...
    pub fn include_deleted(mut self, new_value: bool) -> UserSessionListCall<'a, C> {
    ...
    pub fn end_time(mut self, new_value: &str) -> UserSessionListCall<'a, C> {
    ...
    /// Each appended value will retain its original ordering and be '/'-separated in the URL's parameters.
    pub fn add_activity_type(mut self, new_value: i32) -> UserSessionListCall<'a, C> {
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> UserSessionListCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> UserSessionListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> UserSessionListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> UserSessionListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct UserSessionUpdateCall<'a, C>
where
    C: 'a,
{
    hub: &'a Fitness<C>,
...
impl<'a, C> common::CallBuilder for UserSessionUpdateCall<'a, C> {}

impl<'a, C> UserSessionUpdateCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: Session) -> UserSessionUpdateCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn user_id(mut self, new_value: &str) -> UserSessionUpdateCall<'a, C> {
        self._user_id = new_value.to_string();
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn session_id(mut self, new_value: &str) -> UserSessionUpdateCall<'a, C> {
        self._session_id = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> UserSessionUpdateCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> UserSessionUpdateCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> UserSessionUpdateCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> UserSessionUpdateCall<'a, C> {
        self._scopes.clear();
        self
    }
}
