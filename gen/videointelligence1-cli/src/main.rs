...
use google_videointelligence1::{api, yup_oauth2, Error};
...
struct Engine<'n, C> {
    opt: ArgMatches<'n>,
    hub: api::CloudVideoIntelligence<C>,
    gp: Vec<&'static str>,
...
{
    async fn _operations_projects_locations_operations_cancel(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        ...
        let mut call = self
            .hub
            .operations()
            .projects_locations_operations_cancel(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _operations_projects_locations_operations_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _operations_projects_locations_operations_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_locations_operations_cancel(
        ...
        let mut request: api::GoogleLongrunning_CancelOperationRequest =
    ...
    async fn _videos_annotate(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "video-context.explicit-content-detection-config.model" => Some((
                ...
                "video-context.face-detection-config.include-attributes" => Some((
                    "videoContext.faceDetectionConfig.includeAttributes",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "video-context.face-detection-config.include-bounding-boxes" => Some((
                    "videoContext.faceDetectionConfig.includeBoundingBoxes",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "video-context.face-detection-config.model" => Some((
                    "videoContext.faceDetectionConfig.model",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "video-context.label-detection-config.frame-confidence-threshold" => Some((
                    "videoContext.labelDetectionConfig.frameConfidenceThreshold",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "video-context.label-detection-config.label-detection-mode" => Some((
                    "videoContext.labelDetectionConfig.labelDetectionMode",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "video-context.label-detection-config.model" => Some((
                    "videoContext.labelDetectionConfig.model",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "video-context.label-detection-config.stationary-camera" => Some((
                    "videoContext.labelDetectionConfig.stationaryCamera",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "video-context.label-detection-config.video-confidence-threshold" => Some((
                    "videoContext.labelDetectionConfig.videoConfidenceThreshold",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "video-context.object-tracking-config.model" => Some((
                    "videoContext.objectTrackingConfig.model",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "video-context.person-detection-config.include-attributes" => Some((
                    "videoContext.personDetectionConfig.includeAttributes",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "video-context.person-detection-config.include-bounding-boxes" => Some((
                    "videoContext.personDetectionConfig.includeBoundingBoxes",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "video-context.person-detection-config.include-pose-landmarks" => Some((
                    "videoContext.personDetectionConfig.includePoseLandmarks",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "video-context.shot-change-detection-config.model" => Some((
                    "videoContext.shotChangeDetectionConfig.model",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "video-context.speech-transcription-config.audio-tracks" => Some((
                    "videoContext.speechTranscriptionConfig.audioTracks",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Vec,
                    },
                )),
                "video-context.speech-transcription-config.diarization-speaker-count" => Some((
                    "videoContext.speechTranscriptionConfig.diarizationSpeakerCount",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                )),
                "video-context.speech-transcription-config.enable-automatic-punctuation" => Some((
                    "videoContext.speechTranscriptionConfig.enableAutomaticPunctuation",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "video-context.speech-transcription-config.enable-speaker-diarization" => Some((
                    "videoContext.speechTranscriptionConfig.enableSpeakerDiarization",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "video-context.speech-transcription-config.enable-word-confidence" => Some((
                    "videoContext.speechTranscriptionConfig.enableWordConfidence",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "video-context.speech-transcription-config.filter-profanity" => Some((
                    "videoContext.speechTranscriptionConfig.filterProfanity",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "video-context.speech-transcription-config.language-code" => Some((
                    "videoContext.speechTranscriptionConfig.languageCode",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "video-context.speech-transcription-config.max-alternatives" => Some((
                    "videoContext.speechTranscriptionConfig.maxAlternatives",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                )),
                "video-context.text-detection-config.language-hints" => Some((
                    "videoContext.textDetectionConfig.languageHints",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "video-context.text-detection-config.model" => Some((
                    "videoContext.textDetectionConfig.model",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
        ...
        let mut request: api::GoogleCloudVideointelligenceV1_AnnotateVideoRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.videos().annotate(request);
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
        ...
        match self.opt.subcommand() {
            ("operations", Some(opt)) => match opt.subcommand() {
                ("projects-locations-operations-cancel", Some(opt)) => {
                    call_result = self
                        ._operations_projects_locations_operations_cancel(opt, dry_run, &mut err)
                        .await;
                }
                ("projects-locations-operations-delete", Some(opt)) => {
                    call_result = self
                        ._operations_projects_locations_operations_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("projects-locations-operations-get", Some(opt)) => {
                    call_result = self
                        ._operations_projects_locations_operations_get(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
            ...
            ("videos", Some(opt)) => match opt.subcommand() {
                ("annotate", Some(opt)) => {
                    call_result = self._videos_annotate(opt, dry_run, &mut err).await;
                }
                _ => {
                    err.issues
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "videointelligence1-secret.json",
        ...
        .persist_tokens_to_disk(format!("{}/videointelligence1", config_dir))
        .build()
        .await
        .unwrap();
        ...
        let engine = Engine {
            opt,
            hub: api::CloudVideoIntelligence::new(client, auth),
            gp: vec![
                "$-xgafv",
                "access-token",
                "alt",
...
async fn main() {
    ...
    let arg_data = [
        ("operations", "methods: 'projects-locations-operations-cancel', 'projects-locations-operations-delete' and 'projects-locations-operations-get'", vec![
            ...
            ("videos", "methods: 'annotate'", vec![
            ("annotate",
                    Some(r##"Performs asynchronous video annotation. Progress and results can be retrieved through the `google.longrunning.Operations` interface. `Operation.metadata` contains `AnnotateVideoProgress` (progress). `Operation.response` contains `AnnotateVideoResponse` (results)."##),
                    "Details at http://byron.github.io/google-apis-rs/google_videointelligence1_cli/videos_annotate",
                  vec![
                    (Some(r##"kv"##),
                     Some(r##"r"##),
                     Some(r##"Set various fields of the request structure, matching the key=value form"##),
