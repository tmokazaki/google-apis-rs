...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/games1).
//! # Features
//!
//! Handle the following *Resources* with ease from the central [hub](Games) ...
//!
//! * accesstokens
//!  * [*generate play grouping api token*](api::AccesstokenGeneratePlayGroupingApiTokenCall) and [*generate recall play grouping api token*](api::AccesstokenGenerateRecallPlayGroupingApiTokenCall)
//! * [achievement definitions](api::AchievementDefinition)
//!  * [*list*](api::AchievementDefinitionListCall)
//! * achievements
//!  * [*increment*](api::AchievementIncrementCall), [*list*](api::AchievementListCall), [*reveal*](api::AchievementRevealCall), [*set steps at least*](api::AchievementSetStepsAtLeastCall), [*unlock*](api::AchievementUnlockCall) and [*update multiple*](api::AchievementUpdateMultipleCall)
//! * [applications](api::Application)
//!  * [*get*](api::ApplicationGetCall), [*get end point*](api::ApplicationGetEndPointCall), [*played*](api::ApplicationPlayedCall) and [*verify*](api::ApplicationVerifyCall)
//! * events
//!  * [*list by player*](api::EventListByPlayerCall), [*list definitions*](api::EventListDefinitionCall) and [*record*](api::EventRecordCall)
//! * [leaderboards](api::Leaderboard)
//!  * [*get*](api::LeaderboardGetCall) and [*list*](api::LeaderboardListCall)
//! * metagame
...
//! * recall
//!  * [*games player tokens*](api::RecallGamesPlayerTokenCall), [*last token from all developer games*](api::RecallLastTokenFromAllDeveloperGameCall), [*link persona*](api::RecallLinkPersonaCall), [*reset persona*](api::RecallResetPersonaCall), [*retrieve tokens*](api::RecallRetrieveTokenCall) and [*unlink persona*](api::RecallUnlinkPersonaCall)
//! * revisions
//!  * [*check*](api::RevisionCheckCall)
//! * scores
//!  * [*get*](api::ScoreGetCall), [*list*](api::ScoreListCall), [*list window*](api::ScoreListWindowCall), [*submit*](api::ScoreSubmitCall) and [*submit multiple*](api::ScoreSubmitMultipleCall)
//! * [snapshots](api::Snapshot)
//!  * [*get*](api::SnapshotGetCall) and [*list*](api::SnapshotListCall)
//! * stats
//!  * [*get*](api::StatGetCall)
//!
//!
