...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/groupsmigration1).
//! # Features
//!
//! Handle the following *Resources* with ease from the central [hub](GroupsMigration) ...
//!
//! * archive
//!  * [*insert*](api::ArchiveInsertCall)
//!
//!
//! Upload supported by ...
//!
//! * [*insert archive*](api::ArchiveInsertCall)
//!
//!
//!
