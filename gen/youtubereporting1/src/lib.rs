...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/youtubereporting1).
//! # Features
//!
//! Handle the following *Resources* with ease from the central [hub](YouTubeReporting) ...
//!
//! * [jobs](api::Job)
//!  * [*create*](api::JobCreateCall), [*delete*](api::JobDeleteCall), [*get*](api::JobGetCall), [*list*](api::JobListCall), [*reports get*](api::JobReportGetCall) and [*reports list*](api::JobReportListCall)
//! * media
//!  * [*download*](api::MediaDownloadCall)
//! * [report types](api::ReportType)
//!  * [*list*](api::ReportTypeListCall)
//!
//!
