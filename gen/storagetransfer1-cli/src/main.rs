...
use google_storagetransfer1::{api, yup_oauth2, Error};
...
{
    async fn _google_service_accounts_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
    ...
    async fn _projects_agent_pools_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            {
                "bandwidth-limit.limit-mbps" => Some((
        ...
        let mut request: api::AgentPool = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .agent_pools_create(request, opt.value_of("project-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_agent_pools_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .agent_pools_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_agent_pools_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .agent_pools_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_agent_pools_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .agent_pools_list(opt.value_of("project-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_agent_pools_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .agent_pools_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _transfer_jobs_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::TransferJob = serde_json::value::from_value(object).unwrap();
    ...
    async fn _transfer_jobs_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.transfer_jobs().delete(
            opt.value_of("job-name").unwrap_or(""),
    ...
    async fn _transfer_jobs_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.transfer_jobs().get(
            opt.value_of("job-name").unwrap_or(""),
            opt.value_of("project-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _transfer_jobs_list(
        ...
        let mut call = self
            .hub
            .transfer_jobs()
            .list(opt.value_of("filter").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _transfer_jobs_patch(
        ...
        let mut request: api::UpdateTransferJobRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .transfer_jobs()
            .patch(request, opt.value_of("job-name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _transfer_jobs_run(
        ...
        let mut request: api::RunTransferJobRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .transfer_jobs()
            .run(request, opt.value_of("job-name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _transfer_operations_cancel(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _transfer_operations_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _transfer_operations_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.transfer_operations().list(
            opt.value_of("name").unwrap_or(""),
            opt.value_of("filter").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _transfer_operations_pause(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::PauseTransferOperationRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .transfer_operations()
            .pause(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _transfer_operations_resume(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::ResumeTransferOperationRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .transfer_operations()
            .resume(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _doit(
        ...
        match self.opt.subcommand() {
            ("google-service-accounts", Some(opt)) => match opt.subcommand() {
                ("get", Some(opt)) => {
                    call_result = self
                        ._google_service_accounts_get(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues.push(CLIError::MissingMethodError(
                        "google-service-accounts".to_string(),
                    ));
            ...
            ("projects", Some(opt)) => match opt.subcommand() {
                ("agent-pools-create", Some(opt)) => {
                    call_result = self
                        ._projects_agent_pools_create(opt, dry_run, &mut err)
                        .await;
                }
                ("agent-pools-delete", Some(opt)) => {
                    call_result = self
                        ._projects_agent_pools_delete(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("agent-pools-list", Some(opt)) => {
                    call_result = self
                        ._projects_agent_pools_list(opt, dry_run, &mut err)
                        .await;
                }
                ("agent-pools-patch", Some(opt)) => {
                    call_result = self
                        ._projects_agent_pools_patch(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
            ...
            ("transfer-jobs", Some(opt)) => match opt.subcommand() {
                ("create", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("transfer-jobs".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("transfer-operations", Some(opt)) => match opt.subcommand() {
                ("cancel", Some(opt)) => {
                    call_result = self
                        ._transfer_operations_cancel(opt, dry_run, &mut err)
                        .await;
                }
                ("get", Some(opt)) => {
                ...
                ("pause", Some(opt)) => {
                    call_result = self
                        ._transfer_operations_pause(opt, dry_run, &mut err)
                        .await;
                }
                ("resume", Some(opt)) => {
                    call_result = self
                        ._transfer_operations_resume(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues.push(CLIError::MissingMethodError(
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "storagetransfer1-secret.json",
