...
impl<C> common::Hub for Assuredworkloads<C> {}

impl<'a, C> Assuredworkloads<C> {
...
impl common::RequestValue for GoogleCloudAssuredworkloadsV1AcknowledgeViolationRequest {}
...
impl common::ResponseResult for GoogleCloudAssuredworkloadsV1AcknowledgeViolationResponse {}
...
impl common::ResponseResult for GoogleCloudAssuredworkloadsV1AnalyzeWorkloadMoveResponse {}
...
impl common::Part for GoogleCloudAssuredworkloadsV1AssetMoveAnalysis {}
...
impl common::ResponseResult for GoogleCloudAssuredworkloadsV1EnableResourceMonitoringResponse {}
...
impl common::ResponseResult for GoogleCloudAssuredworkloadsV1ListViolationsResponse {}
...
impl common::ResponseResult for GoogleCloudAssuredworkloadsV1ListWorkloadsResponse {}
...
impl common::Part for GoogleCloudAssuredworkloadsV1MoveAnalysisGroup {}
...
impl common::Part for GoogleCloudAssuredworkloadsV1MoveAnalysisResult {}
...
impl common::Part for GoogleCloudAssuredworkloadsV1MoveImpact {}
...
impl common::RequestValue for GoogleCloudAssuredworkloadsV1MutatePartnerPermissionsRequest {}
...
impl common::RequestValue for GoogleCloudAssuredworkloadsV1RestrictAllowedResourcesRequest {}
...
impl common::ResponseResult for GoogleCloudAssuredworkloadsV1RestrictAllowedResourcesResponse {}
...
pub struct GoogleCloudAssuredworkloadsV1Violation {
    ...
    pub acknowledgement_time: Option<chrono::DateTime<chrono::offset::Utc>>,
    ...
    pub begin_time: Option<chrono::DateTime<chrono::offset::Utc>>,
    ...
    pub resolve_time: Option<chrono::DateTime<chrono::offset::Utc>>,
...
impl common::ResponseResult for GoogleCloudAssuredworkloadsV1Violation {}
...
impl common::Part for GoogleCloudAssuredworkloadsV1ViolationExceptionContext {}
...
impl common::Part for GoogleCloudAssuredworkloadsV1ViolationRemediation {}
...
impl common::Part for GoogleCloudAssuredworkloadsV1ViolationRemediationInstructions {}
...
impl common::Part for GoogleCloudAssuredworkloadsV1ViolationRemediationInstructionsConsole {}
...
impl common::Part for GoogleCloudAssuredworkloadsV1ViolationRemediationInstructionsGcloud {}
...
impl common::RequestValue for GoogleCloudAssuredworkloadsV1Workload {}
impl common::ResponseResult for GoogleCloudAssuredworkloadsV1Workload {}
...
impl common::Part for GoogleCloudAssuredworkloadsV1WorkloadComplianceStatus {}
...
impl common::Part for GoogleCloudAssuredworkloadsV1WorkloadEkmProvisioningResponse {}
...
impl common::Part for GoogleCloudAssuredworkloadsV1WorkloadKMSSettings {}
...
impl common::Part for GoogleCloudAssuredworkloadsV1WorkloadPartnerPermissions {}
...
impl common::Part for GoogleCloudAssuredworkloadsV1WorkloadResourceInfo {}
...
impl common::Part for GoogleCloudAssuredworkloadsV1WorkloadResourceSettings {}
...
impl common::Part for GoogleCloudAssuredworkloadsV1WorkloadSaaEnrollmentResponse {}
...
impl<'a, C> OrganizationMethods<'a, C> {
    ...
    pub fn locations_workloads_violations_acknowledge(
        &self,
    ...
    pub fn locations_workloads_violations_get(
        &self,
        name: &str,
    ...
    pub fn locations_workloads_violations_list(
        &self,
        parent: &str,
    ...
    pub fn locations_workloads_analyze_workload_move(
        &self,
        target: &str,
    ...
    pub fn locations_workloads_create(
        &self,
    ...
    pub fn locations_workloads_delete(
        &self,
        name: &str,
    ...
    ///
    /// * `name` - Required. The `name` field is used to identify the workload. Format: organizations/{org_id}/locations/{location_id}/workloads/{workload_id}
    pub fn locations_workloads_enable_resource_monitoring(
        &self,
        name: &str,
    ...
    pub fn locations_workloads_get(
        &self,
        name: &str,
    ...
    pub fn locations_workloads_list(
        &self,
        parent: &str,
    ...
    /// * `request` - No description provided.
    /// * `name` - Required. The `name` field is used to identify the workload. Format: organizations/{org_id}/locations/{location_id}/workloads/{workload_id}
    pub fn locations_workloads_mutate_partner_permissions(
        &self,
    ...
    pub fn locations_workloads_patch(
        &self,
        request: GoogleCloudAssuredworkloadsV1Workload,
        name: &str,
    ...
    pub fn locations_workloads_restrict_allowed_resources(
        &self,
...
/// # }
/// ```
pub struct OrganizationLocationWorkloadViolationAcknowledgeCall<'a, C>
where
    C: 'a,
{
    hub: &'a Assuredworkloads<C>,
...
impl<'a, C> common::CallBuilder for OrganizationLocationWorkloadViolationAcknowledgeCall<'a, C> {}

impl<'a, C> OrganizationLocationWorkloadViolationAcknowledgeCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    pub fn request(
        mut self,
        new_value: GoogleCloudAssuredworkloadsV1AcknowledgeViolationRequest,
    ) -> OrganizationLocationWorkloadViolationAcknowledgeCall<'a, C> {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> OrganizationLocationWorkloadViolationAcknowledgeCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct OrganizationLocationWorkloadViolationGetCall<'a, C>
where
    C: 'a,
{
    hub: &'a Assuredworkloads<C>,
...
impl<'a, C> common::CallBuilder for OrganizationLocationWorkloadViolationGetCall<'a, C> {}

impl<'a, C> OrganizationLocationWorkloadViolationGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(
        mut self,
    ) -> common::Result<(common::Response, GoogleCloudAssuredworkloadsV1Violation)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> OrganizationLocationWorkloadViolationGetCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> OrganizationLocationWorkloadViolationGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> OrganizationLocationWorkloadViolationGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct OrganizationLocationWorkloadViolationListCall<'a, C>
where
    C: 'a,
{
    hub: &'a Assuredworkloads<C>,
    ...
    _page_token: Option<String>,
    _page_size: Option<i32>,
    _interval_start_time: Option<chrono::DateTime<chrono::offset::Utc>>,
    _interval_end_time: Option<chrono::DateTime<chrono::offset::Utc>>,
    _filter: Option<String>,
    _delegate: Option<&'a mut dyn common::Delegate>,
    _additional_params: HashMap<String, String>,
    _scopes: BTreeSet<String>,
...
impl<'a, C> common::CallBuilder for OrganizationLocationWorkloadViolationListCall<'a, C> {}

impl<'a, C> OrganizationLocationWorkloadViolationListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> OrganizationLocationWorkloadViolationListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct OrganizationLocationWorkloadAnalyzeWorkloadMoveCall<'a, C>
where
    C: 'a,
{
    hub: &'a Assuredworkloads<C>,
...
impl<'a, C> common::CallBuilder for OrganizationLocationWorkloadAnalyzeWorkloadMoveCall<'a, C> {}

impl<'a, C> OrganizationLocationWorkloadAnalyzeWorkloadMoveCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> OrganizationLocationWorkloadAnalyzeWorkloadMoveCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct OrganizationLocationWorkloadCreateCall<'a, C>
where
    C: 'a,
{
    hub: &'a Assuredworkloads<C>,
...
impl<'a, C> common::CallBuilder for OrganizationLocationWorkloadCreateCall<'a, C> {}

impl<'a, C> OrganizationLocationWorkloadCreateCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    pub fn request(
        mut self,
        new_value: GoogleCloudAssuredworkloadsV1Workload,
    ) -> OrganizationLocationWorkloadCreateCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> OrganizationLocationWorkloadCreateCall<'a, C> {
        self._parent = new_value.to_string();
        self
    }
    ...
    pub fn external_id(mut self, new_value: &str) -> OrganizationLocationWorkloadCreateCall<'a, C> {
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> OrganizationLocationWorkloadCreateCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> OrganizationLocationWorkloadCreateCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> OrganizationLocationWorkloadCreateCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> OrganizationLocationWorkloadCreateCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct OrganizationLocationWorkloadDeleteCall<'a, C>
where
    C: 'a,
{
    hub: &'a Assuredworkloads<C>,
...
impl<'a, C> common::CallBuilder for OrganizationLocationWorkloadDeleteCall<'a, C> {}

impl<'a, C> OrganizationLocationWorkloadDeleteCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> OrganizationLocationWorkloadDeleteCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// Optional. The etag of the workload. If this is provided, it must match the server's etag.
    ...
    pub fn etag(mut self, new_value: &str) -> OrganizationLocationWorkloadDeleteCall<'a, C> {
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> OrganizationLocationWorkloadDeleteCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> OrganizationLocationWorkloadDeleteCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> OrganizationLocationWorkloadDeleteCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> OrganizationLocationWorkloadDeleteCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct OrganizationLocationWorkloadEnableResourceMonitoringCall<'a, C>
where
    C: 'a,
{
    hub: &'a Assuredworkloads<C>,
...
impl<'a, C> common::CallBuilder
    for OrganizationLocationWorkloadEnableResourceMonitoringCall<'a, C>
{
}

impl<'a, C> OrganizationLocationWorkloadEnableResourceMonitoringCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
...
/// # }
/// ```
pub struct OrganizationLocationWorkloadGetCall<'a, C>
where
    C: 'a,
{
    hub: &'a Assuredworkloads<C>,
...
impl<'a, C> common::CallBuilder for OrganizationLocationWorkloadGetCall<'a, C> {}

impl<'a, C> OrganizationLocationWorkloadGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(
        mut self,
    ) -> common::Result<(common::Response, GoogleCloudAssuredworkloadsV1Workload)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> OrganizationLocationWorkloadGetCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> OrganizationLocationWorkloadGetCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> OrganizationLocationWorkloadGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> OrganizationLocationWorkloadGetCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> OrganizationLocationWorkloadGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct OrganizationLocationWorkloadListCall<'a, C>
where
    C: 'a,
{
    hub: &'a Assuredworkloads<C>,
...
impl<'a, C> common::CallBuilder for OrganizationLocationWorkloadListCall<'a, C> {}

impl<'a, C> OrganizationLocationWorkloadListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> OrganizationLocationWorkloadListCall<'a, C> {
        self._parent = new_value.to_string();
        self
    }
    ...
    ///
    /// Sets the *page token* query property to the given value.
    pub fn page_token(mut self, new_value: &str) -> OrganizationLocationWorkloadListCall<'a, C> {
        self._page_token = Some(new_value.to_string());
        self
    }
    /// Page size.
    ///
    /// Sets the *page size* query property to the given value.
    pub fn page_size(mut self, new_value: i32) -> OrganizationLocationWorkloadListCall<'a, C> {
        self._page_size = Some(new_value);
        self
    }
    ...
    ///
    /// Sets the *filter* query property to the given value.
    pub fn filter(mut self, new_value: &str) -> OrganizationLocationWorkloadListCall<'a, C> {
        self._filter = Some(new_value.to_string());
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> OrganizationLocationWorkloadListCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> OrganizationLocationWorkloadListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> OrganizationLocationWorkloadListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> OrganizationLocationWorkloadListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct OrganizationLocationWorkloadMutatePartnerPermissionCall<'a, C>
where
    C: 'a,
{
    hub: &'a Assuredworkloads<C>,
...
impl<'a, C> common::CallBuilder for OrganizationLocationWorkloadMutatePartnerPermissionCall<'a, C> {}

impl<'a, C> OrganizationLocationWorkloadMutatePartnerPermissionCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    pub fn request(
        mut self,
        new_value: GoogleCloudAssuredworkloadsV1MutatePartnerPermissionsRequest,
    ) -> OrganizationLocationWorkloadMutatePartnerPermissionCall<'a, C> {
        self._request = new_value;
        self
    }
...
/// # }
/// ```
pub struct OrganizationLocationWorkloadPatchCall<'a, C>
where
    C: 'a,
{
    hub: &'a Assuredworkloads<C>,
...
impl<'a, C> common::CallBuilder for OrganizationLocationWorkloadPatchCall<'a, C> {}

impl<'a, C> OrganizationLocationWorkloadPatchCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> OrganizationLocationWorkloadPatchCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> OrganizationLocationWorkloadPatchCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> OrganizationLocationWorkloadPatchCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> OrganizationLocationWorkloadPatchCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> OrganizationLocationWorkloadPatchCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct OrganizationLocationWorkloadRestrictAllowedResourceCall<'a, C>
where
    C: 'a,
{
    hub: &'a Assuredworkloads<C>,
...
impl<'a, C> common::CallBuilder for OrganizationLocationWorkloadRestrictAllowedResourceCall<'a, C> {}

impl<'a, C> OrganizationLocationWorkloadRestrictAllowedResourceCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    pub fn request(
        mut self,
        new_value: GoogleCloudAssuredworkloadsV1RestrictAllowedResourcesRequest,
    ) -> OrganizationLocationWorkloadRestrictAllowedResourceCall<'a, C> {
        self._request = new_value;
        self
    }
