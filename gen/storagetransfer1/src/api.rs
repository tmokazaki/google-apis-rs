...
impl<C> common::Hub for Storagetransfer<C> {}

impl<'a, C> Storagetransfer<C> {
    ...
    pub fn google_service_accounts(&'a self) -> GoogleServiceAccountMethods<'a, C> {
        GoogleServiceAccountMethods { hub: self }
    }
    pub fn projects(&'a self) -> ProjectMethods<'a, C> {
        ProjectMethods { hub: self }
    }
    pub fn transfer_jobs(&'a self) -> TransferJobMethods<'a, C> {
        TransferJobMethods { hub: self }
    }
    pub fn transfer_operations(&'a self) -> TransferOperationMethods<'a, C> {
...
impl common::RequestValue for AgentPool {}
impl common::ResponseResult for AgentPool {}
...
impl common::Part for AwsAccessKey {}
...
impl common::Part for AwsS3CompatibleData {}
...
pub struct AwsS3Data {
    ...
    #[serde(rename = "managedPrivateNetwork")]
...
impl common::Part for AwsS3Data {}
...
impl common::Part for AzureBlobStorageData {}
...
impl common::Part for AzureCredentials {}
...
impl common::Part for BandwidthLimit {}
...
impl common::Part for ErrorLogEntry {}
...
impl common::Part for ErrorSummary {}
...
pub struct EventStream {
    ...
    pub event_stream_expiration_time: Option<chrono::DateTime<chrono::offset::Utc>>,
    /// Specifies the date and time that Storage Transfer Service starts listening for events from this stream. If no start time is specified or start time is in the past, Storage Transfer Service starts listening immediately.
    #[serde(rename = "eventStreamStartTime")]
    pub event_stream_start_time: Option<chrono::DateTime<chrono::offset::Utc>>,
...
impl common::Part for EventStream {}
...
impl common::Resource for GoogleServiceAccount {}
impl common::ResponseResult for GoogleServiceAccount {}
...
impl common::ResponseResult for ListAgentPoolsResponse {}
...
impl common::ResponseResult for ListTransferJobsResponse {}
...
impl common::Part for MetadataOptions {}
...
pub struct ObjectConditions {
    ...
    pub last_modified_before: Option<chrono::DateTime<chrono::offset::Utc>>,
    ...
    pub last_modified_since: Option<chrono::DateTime<chrono::offset::Utc>>,
    ...
    pub max_time_elapsed_since_last_modification: Option<chrono::Duration>,
    ...
    #[serde_as(as = "Option<common::serde::duration::Wrapper>")]
    pub min_time_elapsed_since_last_modification: Option<chrono::Duration>,
}

impl common::Part for ObjectConditions {}
...
impl common::RequestValue for PauseTransferOperationRequest {}
...
impl common::Part for PosixFilesystem {}
...
impl common::Part for ReplicationSpec {}
...
impl common::RequestValue for ResumeTransferOperationRequest {}
...
impl common::RequestValue for RunTransferJobRequest {}
...
impl common::Part for S3CompatibleMetadata {}
...
impl common::Part for TransferCounters {}
...
pub struct TransferJob {
    ...
    pub last_modification_time: Option<chrono::DateTime<chrono::offset::Utc>>,
...
impl common::RequestValue for TransferJob {}
impl common::Resource for TransferJob {}
impl common::ResponseResult for TransferJob {}
...
impl common::Part for TransferManifest {}
...
impl common::Resource for TransferOperation {}
...
impl common::Part for TransferOptions {}
...
impl common::Part for TransferSpec {}
...
pub struct UpdateTransferJobRequest {
    ...
    pub update_transfer_job_field_mask: Option<common::FieldMask>,
}

impl common::RequestValue for UpdateTransferJobRequest {}
...
/// # }
/// ```
pub struct GoogleServiceAccountMethods<'a, C>
where
    C: 'a,
{
    hub: &'a Storagetransfer<C>,
}

impl<'a, C> common::MethodsBuilder for GoogleServiceAccountMethods<'a, C> {}

impl<'a, C> GoogleServiceAccountMethods<'a, C> {
    ...
    pub fn get(&self, project_id: &str) -> GoogleServiceAccountGetCall<'a, C> {
...
impl<'a, C> ProjectMethods<'a, C> {
    ...
    pub fn agent_pools_create(
        &self,
        request: AgentPool,
        project_id: &str,
    ) -> ProjectAgentPoolCreateCall<'a, C> {
    ...
    pub fn agent_pools_delete(&self, name: &str) -> ProjectAgentPoolDeleteCall<'a, C> {
    ...
    pub fn agent_pools_get(&self, name: &str) -> ProjectAgentPoolGetCall<'a, C> {
    ...
    pub fn agent_pools_list(&self, project_id: &str) -> ProjectAgentPoolListCall<'a, C> {
    ...
    pub fn agent_pools_patch(
        &self,
        request: AgentPool,
        name: &str,
    ) -> ProjectAgentPoolPatchCall<'a, C> {
...
/// # }
/// ```
pub struct TransferJobMethods<'a, C>
where
    C: 'a,
{
    hub: &'a Storagetransfer<C>,
...
impl<'a, C> common::MethodsBuilder for TransferJobMethods<'a, C> {}

impl<'a, C> TransferJobMethods<'a, C> {
    /// Create a builder to help you perform the following task:
    ///
    ...
    ///
    /// * `request` - No description provided.
    pub fn create(&self, request: TransferJob) -> TransferJobCreateCall<'a, C> {
    ...
    /// * `projectId` - Required. The ID of the Google Cloud project that owns the job.
    pub fn delete(&self, job_name: &str, project_id: &str) -> TransferJobDeleteCall<'a, C> {
    ...
    /// * `projectId` - Required. The ID of the Google Cloud project that owns the job.
    pub fn get(&self, job_name: &str, project_id: &str) -> TransferJobGetCall<'a, C> {
        TransferJobGetCall {
            hub: self.hub,
            _job_name: job_name.to_string(),
            _project_id: project_id.to_string(),
    ...
    pub fn list(&self, filter: &str) -> TransferJobListCall<'a, C> {
        TransferJobListCall {
            hub: self.hub,
    ...
    pub fn run(&self, request: RunTransferJobRequest, job_name: &str) -> TransferJobRunCall<'a, C> {
        TransferJobRunCall {
            hub: self.hub,
            _request: request,
            _job_name: job_name.to_string(),
...
/// # }
/// ```
pub struct TransferOperationMethods<'a, C>
where
    C: 'a,
{
    hub: &'a Storagetransfer<C>,
...
impl<'a, C> common::MethodsBuilder for TransferOperationMethods<'a, C> {}

impl<'a, C> TransferOperationMethods<'a, C> {
    /// Create a builder to help you perform the following task:
    ///
    ...
    pub fn cancel(
        ...
        name: &str,
    ) -> TransferOperationCancelCall<'a, C> {
    ...
    pub fn get(&self, name: &str) -> TransferOperationGetCall<'a, C> {
    ...
    pub fn list(&self, name: &str, filter: &str) -> TransferOperationListCall<'a, C> {
    ...
    pub fn pause(
        ...
        name: &str,
    ) -> TransferOperationPauseCall<'a, C> {
    ...
    pub fn resume(
        ...
        name: &str,
    ) -> TransferOperationResumeCall<'a, C> {
...
/// # }
/// ```
pub struct GoogleServiceAccountGetCall<'a, C>
where
    C: 'a,
{
    hub: &'a Storagetransfer<C>,
...
impl<'a, C> common::CallBuilder for GoogleServiceAccountGetCall<'a, C> {}

impl<'a, C> GoogleServiceAccountGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, GoogleServiceAccount)> {
        use std::borrow::Cow;
    ...
    pub fn project_id(mut self, new_value: &str) -> GoogleServiceAccountGetCall<'a, C> {
    ...
    ) -> GoogleServiceAccountGetCall<'a, C> {
    ...
    pub fn param<T>(mut self, name: T, value: T) -> GoogleServiceAccountGetCall<'a, C>
    where
        T: AsRef<str>,
    {
    ...
    pub fn add_scope<St>(mut self, scope: St) -> GoogleServiceAccountGetCall<'a, C>
    where
        St: AsRef<str>,
    {
    ...
    pub fn add_scopes<I, St>(mut self, scopes: I) -> GoogleServiceAccountGetCall<'a, C>
    where
    ...
    /// for details).
    pub fn clear_scopes(mut self) -> GoogleServiceAccountGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectAgentPoolCreateCall<'a, C>
where
    C: 'a,
{
    hub: &'a Storagetransfer<C>,
...
impl<'a, C> common::CallBuilder for ProjectAgentPoolCreateCall<'a, C> {}

impl<'a, C> ProjectAgentPoolCreateCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, AgentPool)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
        ...
        params.push("projectId", self._project_id);
        if let Some(value) = self._agent_pool_id.as_ref() {
            params.push("agentPoolId", value);
        }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: AgentPool) -> ProjectAgentPoolCreateCall<'a, C> {
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn project_id(mut self, new_value: &str) -> ProjectAgentPoolCreateCall<'a, C> {
        self._project_id = new_value.to_string();
        self
    }
    ...
    pub fn agent_pool_id(mut self, new_value: &str) -> ProjectAgentPoolCreateCall<'a, C> {
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectAgentPoolCreateCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectAgentPoolCreateCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectAgentPoolCreateCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectAgentPoolCreateCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectAgentPoolDeleteCall<'a, C>
where
    C: 'a,
{
    hub: &'a Storagetransfer<C>,
...
impl<'a, C> common::CallBuilder for ProjectAgentPoolDeleteCall<'a, C> {}

impl<'a, C> ProjectAgentPoolDeleteCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectAgentPoolDeleteCall<'a, C> {
    ...
    pub fn delegate(
        mut self,
        new_value: &'a mut dyn common::Delegate,
    ) -> ProjectAgentPoolDeleteCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectAgentPoolDeleteCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectAgentPoolDeleteCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectAgentPoolDeleteCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectAgentPoolDeleteCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectAgentPoolGetCall<'a, C>
where
    C: 'a,
{
    hub: &'a Storagetransfer<C>,
...
impl<'a, C> common::CallBuilder for ProjectAgentPoolGetCall<'a, C> {}

impl<'a, C> ProjectAgentPoolGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectAgentPoolGetCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectAgentPoolGetCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectAgentPoolGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectAgentPoolGetCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectAgentPoolGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectAgentPoolListCall<'a, C>
where
    C: 'a,
{
    hub: &'a Storagetransfer<C>,
...
impl<'a, C> common::CallBuilder for ProjectAgentPoolListCall<'a, C> {}

impl<'a, C> ProjectAgentPoolListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, ListAgentPoolsResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn project_id(mut self, new_value: &str) -> ProjectAgentPoolListCall<'a, C> {
        self._project_id = new_value.to_string();
        self
    }
    /// The list page token.
    ...
    pub fn page_token(mut self, new_value: &str) -> ProjectAgentPoolListCall<'a, C> {
    ...
    pub fn page_size(mut self, new_value: i32) -> ProjectAgentPoolListCall<'a, C> {
    ...
    pub fn filter(mut self, new_value: &str) -> ProjectAgentPoolListCall<'a, C> {
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectAgentPoolListCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectAgentPoolListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectAgentPoolListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectAgentPoolListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectAgentPoolPatchCall<'a, C>
where
    C: 'a,
{
    hub: &'a Storagetransfer<C>,
...
impl<'a, C> common::CallBuilder for ProjectAgentPoolPatchCall<'a, C> {}

impl<'a, C> ProjectAgentPoolPatchCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: AgentPool) -> ProjectAgentPoolPatchCall<'a, C> {
        self._request = new_value;
        self
    }
    /// Required. Specifies a unique string that identifies the agent pool. Format: `projects/{project_id}/agentPools/{agent_pool_id}`
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectAgentPoolPatchCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    ...
    pub fn update_mask(mut self, new_value: common::FieldMask) -> ProjectAgentPoolPatchCall<'a, C> {
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectAgentPoolPatchCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectAgentPoolPatchCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectAgentPoolPatchCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectAgentPoolPatchCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct TransferJobCreateCall<'a, C>
where
    C: 'a,
{
    hub: &'a Storagetransfer<C>,
...
impl<'a, C> common::CallBuilder for TransferJobCreateCall<'a, C> {}

impl<'a, C> TransferJobCreateCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, TransferJob)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: TransferJob) -> TransferJobCreateCall<'a, C> {
        self._request = new_value;
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> TransferJobCreateCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> TransferJobCreateCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> TransferJobCreateCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> TransferJobCreateCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Deletes a transfer job. Deleting a transfer job sets its status to DELETED.
///
/// A builder for the *delete* method supported by a *transferJob* resource.
/// It is not used directly, but through a [`TransferJobMethods`] instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.transfer_jobs().delete("jobName", "projectId")
///              .doit().await;
/// # }
/// ```
pub struct TransferJobDeleteCall<'a, C>
where
    C: 'a,
{
    hub: &'a Storagetransfer<C>,
...
impl<'a, C> common::CallBuilder for TransferJobDeleteCall<'a, C> {}

impl<'a, C> TransferJobDeleteCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, Empty)> {
        ...
        params.push("jobName", self._job_name);
        params.push("projectId", self._project_id);
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn job_name(mut self, new_value: &str) -> TransferJobDeleteCall<'a, C> {
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn project_id(mut self, new_value: &str) -> TransferJobDeleteCall<'a, C> {
        self._project_id = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> TransferJobDeleteCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> TransferJobDeleteCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> TransferJobDeleteCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> TransferJobDeleteCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct TransferJobGetCall<'a, C>
where
    C: 'a,
{
    hub: &'a Storagetransfer<C>,
...
impl<'a, C> common::CallBuilder for TransferJobGetCall<'a, C> {}

impl<'a, C> TransferJobGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn job_name(mut self, new_value: &str) -> TransferJobGetCall<'a, C> {
        self._job_name = new_value.to_string();
        self
    }
    /// Required. The ID of the Google Cloud project that owns the job.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn project_id(mut self, new_value: &str) -> TransferJobGetCall<'a, C> {
        self._project_id = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> TransferJobGetCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> TransferJobGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> TransferJobGetCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> TransferJobGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct TransferJobListCall<'a, C>
where
    C: 'a,
{
    hub: &'a Storagetransfer<C>,
...
impl<'a, C> common::CallBuilder for TransferJobListCall<'a, C> {}

impl<'a, C> TransferJobListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, ListTransferJobsResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
        ...
        let mut params = Params::with_capacity(5 + self._additional_params.len());
        params.push("filter", self._filter);
        if let Some(value) = self._page_token.as_ref() {
            params.push("pageToken", value);
        }
        if let Some(value) = self._page_size.as_ref() {
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn filter(mut self, new_value: &str) -> TransferJobListCall<'a, C> {
    ...
    ///
    /// Sets the *page token* query property to the given value.
    pub fn page_token(mut self, new_value: &str) -> TransferJobListCall<'a, C> {
        self._page_token = Some(new_value.to_string());
        self
    }
    /// The list page size. The max allowed value is 256.
    ///
    /// Sets the *page size* query property to the given value.
    pub fn page_size(mut self, new_value: i32) -> TransferJobListCall<'a, C> {
        self._page_size = Some(new_value);
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> TransferJobListCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> TransferJobListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> TransferJobListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> TransferJobListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct TransferJobPatchCall<'a, C>
where
    C: 'a,
{
    hub: &'a Storagetransfer<C>,
...
impl<'a, C> common::CallBuilder for TransferJobPatchCall<'a, C> {}

impl<'a, C> TransferJobPatchCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: UpdateTransferJobRequest) -> TransferJobPatchCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn job_name(mut self, new_value: &str) -> TransferJobPatchCall<'a, C> {
        self._job_name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> TransferJobPatchCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> TransferJobPatchCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> TransferJobPatchCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> TransferJobPatchCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct TransferJobRunCall<'a, C>
where
    C: 'a,
{
    hub: &'a Storagetransfer<C>,
...
impl<'a, C> common::CallBuilder for TransferJobRunCall<'a, C> {}

impl<'a, C> TransferJobRunCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: RunTransferJobRequest) -> TransferJobRunCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn job_name(mut self, new_value: &str) -> TransferJobRunCall<'a, C> {
        self._job_name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> TransferJobRunCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> TransferJobRunCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> TransferJobRunCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> TransferJobRunCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct TransferOperationCancelCall<'a, C>
where
    C: 'a,
{
    hub: &'a Storagetransfer<C>,
...
impl<'a, C> common::CallBuilder for TransferOperationCancelCall<'a, C> {}

impl<'a, C> TransferOperationCancelCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> TransferOperationCancelCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> TransferOperationCancelCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> TransferOperationCancelCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> TransferOperationCancelCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> TransferOperationCancelCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct TransferOperationGetCall<'a, C>
where
    C: 'a,
{
    hub: &'a Storagetransfer<C>,
...
impl<'a, C> common::CallBuilder for TransferOperationGetCall<'a, C> {}

impl<'a, C> TransferOperationGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> TransferOperationGetCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> TransferOperationGetCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> TransferOperationGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> TransferOperationGetCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> TransferOperationGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct TransferOperationListCall<'a, C>
where
    C: 'a,
{
    hub: &'a Storagetransfer<C>,
...
impl<'a, C> common::CallBuilder for TransferOperationListCall<'a, C> {}

impl<'a, C> TransferOperationListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> TransferOperationListCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// Required. A list of query parameters specified as JSON text in the form of: `{"projectId":"my_project_id", "jobNames":["jobid1","jobid2",...], "jobNamePattern": "job_name_pattern", "operationNames":["opid1","opid2",...], "operationNamePattern": "operation_name_pattern", "minCreationTime": "min_creation_time", "maxCreationTime": "max_creation_time", "transferStatuses":["status1","status2",...]}` Since `jobNames`, `operationNames`, and `transferStatuses` support multiple values, they must be specified with array notation. `projectId` is the only argument that is required. If specified, `jobNamePattern` and `operationNamePattern` must match the full job or operation name respectively. '*' is a wildcard matching 0 or more characters. `minCreationTime` and `maxCreationTime` should be timestamps encoded as a string in the [RFC 3339](https://www.ietf.org/rfc/rfc3339.txt) format. The valid values for `transferStatuses` are case-insensitive: IN_PROGRESS, PAUSED, SUCCESS, FAILED, and ABORTED.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn filter(mut self, new_value: &str) -> TransferOperationListCall<'a, C> {
        self._filter = new_value.to_string();
        self
    }
    /// The list page token.
    ///
    /// Sets the *page token* query property to the given value.
    pub fn page_token(mut self, new_value: &str) -> TransferOperationListCall<'a, C> {
        self._page_token = Some(new_value.to_string());
        self
    }
    /// The list page size. The max allowed value is 256.
    ///
    /// Sets the *page size* query property to the given value.
    pub fn page_size(mut self, new_value: i32) -> TransferOperationListCall<'a, C> {
        self._page_size = Some(new_value);
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> TransferOperationListCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> TransferOperationListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> TransferOperationListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> TransferOperationListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct TransferOperationPauseCall<'a, C>
where
    C: 'a,
{
    hub: &'a Storagetransfer<C>,
...
impl<'a, C> common::CallBuilder for TransferOperationPauseCall<'a, C> {}

impl<'a, C> TransferOperationPauseCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    pub fn request(
        mut self,
        new_value: PauseTransferOperationRequest,
    ) -> TransferOperationPauseCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> TransferOperationPauseCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> TransferOperationPauseCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> TransferOperationPauseCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> TransferOperationPauseCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> TransferOperationPauseCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct TransferOperationResumeCall<'a, C>
where
    C: 'a,
{
    hub: &'a Storagetransfer<C>,
...
impl<'a, C> common::CallBuilder for TransferOperationResumeCall<'a, C> {}

impl<'a, C> TransferOperationResumeCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    pub fn request(
        mut self,
        new_value: ResumeTransferOperationRequest,
    ) -> TransferOperationResumeCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> TransferOperationResumeCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> TransferOperationResumeCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> TransferOperationResumeCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> TransferOperationResumeCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> TransferOperationResumeCall<'a, C> {
        self._scopes.clear();
        self
    }
}
