...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/storagetransfer1).
//! # Features
//!
//! Handle the following *Resources* with ease from the central [hub](Storagetransfer) ...
//!
//! * [google service accounts](api::GoogleServiceAccount)
//!  * [*get*](api::GoogleServiceAccountGetCall)
//! * projects
