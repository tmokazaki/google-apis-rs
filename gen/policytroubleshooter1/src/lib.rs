...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/policytroubleshooter1).
//! # Features
//!
//! Handle the following *Resources* with ease from the central [hub](PolicyTroubleshooter) ...
//!
//! * iam
//!  * [*troubleshoot*](api::IamTroubleshootCall)
//!
//!
//!
//!
...
pub mod api;
pub use api::PolicyTroubleshooter;
