...
use google_composer1::{api, yup_oauth2, Error};
...
{
    async fn _projects_locations_environments_check_upgrade(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        ...
        let mut request: api::CheckUpgradeRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.projects().locations_environments_check_upgrade(
            request,
    ...
    async fn _projects_locations_environments_database_failover(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::DatabaseFailoverRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_environments_database_failover(
                request,
                opt.value_of("environment").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_environments_execute_airflow_command(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec!["command", "parameters", "subcommand"],
                    );
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
        ...
        let mut request: api::ExecuteAirflowCommandRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_environments_execute_airflow_command(
                request,
                opt.value_of("environment").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_environments_fetch_database_properties(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_environments_fetch_database_properties(
                opt.value_of("environment").unwrap_or(""),
            );
        for parg in opt
            .values_of("v")
    ...
    async fn _projects_locations_environments_load_snapshot(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                "skip-airflow-overrides-setting" => Some((
                ...
                "skip-environment-variables-setting" => Some((
                ...
                "skip-pypi-packages-installation" => Some((
        ...
        let mut request: api::LoadSnapshotRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.projects().locations_environments_load_snapshot(
            request,
            opt.value_of("environment").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _projects_locations_environments_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_environments_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_environments_poll_airflow_command(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec!["execution-id", "next-line-number", "pod", "pod-namespace"],
                    );
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
        ...
        let mut request: api::PollAirflowCommandRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_environments_poll_airflow_command(
                request,
                opt.value_of("environment").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_environments_save_snapshot(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::SaveSnapshotRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.projects().locations_environments_save_snapshot(
            request,
            opt.value_of("environment").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _projects_locations_environments_stop_airflow_command(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec!["execution-id", "force", "pod", "pod-namespace"],
                    );
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
        ...
        let mut request: api::StopAirflowCommandRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_environments_stop_airflow_command(
                request,
                opt.value_of("environment").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_environments_user_workloads_config_maps_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::UserWorkloadsConfigMap =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_environments_user_workloads_config_maps_create(
                request,
    ...
    async fn _projects_locations_environments_user_workloads_config_maps_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_environments_user_workloads_config_maps_delete(
    ...
    async fn _projects_locations_environments_user_workloads_config_maps_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_environments_user_workloads_config_maps_get(
                opt.value_of("name").unwrap_or(""),
            );
        for parg in opt
            .values_of("v")
    ...
    async fn _projects_locations_environments_user_workloads_config_maps_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_locations_environments_user_workloads_config_maps_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_environments_user_workloads_config_maps_update(
                request,
                opt.value_of("name").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_environments_user_workloads_secrets_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::UserWorkloadsSecret = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_environments_user_workloads_secrets_create(
                request,
                opt.value_of("parent").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_environments_user_workloads_secrets_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_locations_environments_user_workloads_secrets_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_environments_user_workloads_secrets_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_environments_user_workloads_secrets_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_environments_user_workloads_secrets_list(
                opt.value_of("parent").unwrap_or(""),
            );
        for parg in opt
            .values_of("v")
    ...
    async fn _projects_locations_environments_user_workloads_secrets_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_environments_user_workloads_secrets_update(
                request,
                opt.value_of("name").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_environments_workloads_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_environments_workloads_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_image_versions_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_image_versions_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            .iter()
        {
            ...
            match key {
                ...
                "include-past-releases" => {
                    call = call.include_past_releases(
                        value
                            .map(|v| arg_from_str(v, err, "include-past-releases", "boolean"))
                            .unwrap_or(false),
                    );
                }
                _ => {
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["include-past-releases", "page-size", "page-token"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
        ...
        match self.opt.subcommand() {
            ("projects", Some(opt)) => match opt.subcommand() {
                ("locations-environments-check-upgrade", Some(opt)) => {
                    call_result = self
                        ._projects_locations_environments_check_upgrade(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("locations-environments-database-failover", Some(opt)) => {
                    call_result = self
                        ._projects_locations_environments_database_failover(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("locations-environments-execute-airflow-command", Some(opt)) => {
                    call_result = self
                        ._projects_locations_environments_execute_airflow_command(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-environments-fetch-database-properties", Some(opt)) => {
                    call_result = self
                        ._projects_locations_environments_fetch_database_properties(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ...
                ("locations-environments-load-snapshot", Some(opt)) => {
                    call_result = self
                        ._projects_locations_environments_load_snapshot(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-environments-patch", Some(opt)) => {
                    call_result = self
                        ._projects_locations_environments_patch(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("locations-environments-save-snapshot", Some(opt)) => {
                    call_result = self
                        ._projects_locations_environments_save_snapshot(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-environments-stop-airflow-command", Some(opt)) => {
                    call_result = self
                        ._projects_locations_environments_stop_airflow_command(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-environments-user-workloads-config-maps-create", Some(opt)) => {
                    call_result = self
                        ._projects_locations_environments_user_workloads_config_maps_create(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-environments-user-workloads-config-maps-delete", Some(opt)) => {
                    call_result = self
                        ._projects_locations_environments_user_workloads_config_maps_delete(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-environments-user-workloads-config-maps-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_environments_user_workloads_config_maps_get(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-environments-user-workloads-config-maps-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_environments_user_workloads_config_maps_list(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-environments-user-workloads-config-maps-update", Some(opt)) => {
                    call_result = self
                        ._projects_locations_environments_user_workloads_config_maps_update(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-environments-user-workloads-secrets-create", Some(opt)) => {
                    call_result = self
                        ._projects_locations_environments_user_workloads_secrets_create(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-environments-user-workloads-secrets-delete", Some(opt)) => {
                    call_result = self
                        ._projects_locations_environments_user_workloads_secrets_delete(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-environments-user-workloads-secrets-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_environments_user_workloads_secrets_get(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-environments-user-workloads-secrets-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_environments_user_workloads_secrets_list(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-environments-user-workloads-secrets-update", Some(opt)) => {
                    call_result = self
                        ._projects_locations_environments_user_workloads_secrets_update(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-environments-workloads-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_environments_workloads_list(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-image-versions-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_image_versions_list(opt, dry_run, &mut err)
                        .await;
                }
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "composer1-secret.json",
