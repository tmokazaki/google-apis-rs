...
use google_jobs3::{api, yup_oauth2, Error};
...
{
    async fn _projects_client_events_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "client-event.extra-info" => Some((
                    "clientEvent.extraInfo",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Map,
                    },
                )),
                "client-event.job-event.jobs" => Some((
                    "clientEvent.jobEvent.jobs",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "client-event.job-event.type" => Some((
                    "clientEvent.jobEvent.type",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "client-event.parent-event-id" => Some((
                    "clientEvent.parentEventId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "client-event.request-id" => Some((
        ...
        let mut request: api::CreateClientEventRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .client_events_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_companies_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "company.derived-info.headquarters-location.lat-lng.latitude" => Some((
                    "company.derivedInfo.headquartersLocation.latLng.latitude",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "company.derived-info.headquarters-location.lat-lng.longitude" => Some((
                    "company.derivedInfo.headquartersLocation.latLng.longitude",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "company.derived-info.headquarters-location.location-type" => Some((
                    "company.derivedInfo.headquartersLocation.locationType",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "company.derived-info.headquarters-location.postal-address.address-lines" => {
                    Some((
                        "company.derivedInfo.headquartersLocation.postalAddress.addressLines",
                        JsonTypeInfo {
                            jtype: JsonType::String,
                            ctype: ComplexType::Vec,
                        },
                ...
                "company.derived-info.headquarters-location.postal-address.administrative-area" => {
                    Some((
                        "company.derivedInfo.headquartersLocation.postalAddress.administrativeArea",
                        JsonTypeInfo {
                            jtype: JsonType::String,
                            ctype: ComplexType::Pod,
                        },
                ...
                "company.derived-info.headquarters-location.postal-address.language-code" => {
                    Some((
                        "company.derivedInfo.headquartersLocation.postalAddress.languageCode",
                        JsonTypeInfo {
                            jtype: JsonType::String,
                            ctype: ComplexType::Pod,
                        },
                ...
                "company.derived-info.headquarters-location.postal-address.locality" => Some((
                    "company.derivedInfo.headquartersLocation.postalAddress.locality",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "company.derived-info.headquarters-location.postal-address.organization" => Some((
                    "company.derivedInfo.headquartersLocation.postalAddress.organization",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "company.derived-info.headquarters-location.postal-address.postal-code" => Some((
                    "company.derivedInfo.headquartersLocation.postalAddress.postalCode",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "company.derived-info.headquarters-location.postal-address.recipients" => Some((
                    "company.derivedInfo.headquartersLocation.postalAddress.recipients",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "company.derived-info.headquarters-location.postal-address.region-code" => Some((
                    "company.derivedInfo.headquartersLocation.postalAddress.regionCode",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "company.derived-info.headquarters-location.postal-address.revision" => Some((
                    "company.derivedInfo.headquartersLocation.postalAddress.revision",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                )),
                "company.derived-info.headquarters-location.postal-address.sorting-code" => Some((
                    "company.derivedInfo.headquartersLocation.postalAddress.sortingCode",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "company.derived-info.headquarters-location.postal-address.sublocality" => Some((
                    "company.derivedInfo.headquartersLocation.postalAddress.sublocality",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "company.derived-info.headquarters-location.radius-in-miles" => Some((
                    "company.derivedInfo.headquartersLocation.radiusInMiles",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "company.display-name" => Some((
                    "company.displayName",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                ...
                "company.headquarters-address" => Some((
                ...
                "company.keyword-searchable-job-custom-attributes" => Some((
        ...
        let mut request: api::CreateCompanyRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .companies_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_companies_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .companies_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_companies_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .companies_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_companies_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .companies_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_companies_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::UpdateCompanyRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .companies_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_complete(
        ...
        let mut call = self
            .hub
            .projects()
            .complete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_jobs_batch_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .jobs_batch_delete(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_jobs_create(
        ...
        let mut request: api::CreateJobRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
    ...
    async fn _projects_jobs_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_jobs_patch(
        ...
        let mut request: api::UpdateJobRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
    ...
    async fn _projects_jobs_search(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .jobs_search(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_jobs_search_for_alert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .jobs_search_for_alert(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
        ...
        match self.opt.subcommand() {
            ("projects", Some(opt)) => match opt.subcommand() {
                ("client-events-create", Some(opt)) => {
                    call_result = self
                        ._projects_client_events_create(opt, dry_run, &mut err)
                        .await;
                }
                ("companies-create", Some(opt)) => {
                    call_result = self
                        ._projects_companies_create(opt, dry_run, &mut err)
                        .await;
                }
                ("companies-delete", Some(opt)) => {
                    call_result = self
                        ._projects_companies_delete(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("jobs-batch-delete", Some(opt)) => {
                    call_result = self
                        ._projects_jobs_batch_delete(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("jobs-search-for-alert", Some(opt)) => {
                    call_result = self
                        ._projects_jobs_search_for_alert(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "jobs3-secret.json",
        ...
        .persist_tokens_to_disk(format!("{}/jobs3", config_dir))
        .build()
        .await
        .unwrap();
