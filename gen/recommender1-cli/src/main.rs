...
use google_recommender1::{api, yup_oauth2, Error};
    ...
    C: apis_common::Connector,
{
    ...
    async fn _billing_accounts_locations_insight_types_insights_mark_accepted(
        ...
        let mut request: api::GoogleCloudRecommenderV1MarkInsightAcceptedRequest =
    ...
    async fn _billing_accounts_locations_insight_types_update_config(
        ...
        let mut request: api::GoogleCloudRecommenderV1InsightTypeConfig =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .billing_accounts()
    ...
    async fn _billing_accounts_locations_recommenders_recommendations_mark_claimed(
        ...
        let mut request: api::GoogleCloudRecommenderV1MarkRecommendationClaimedRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .billing_accounts()
    ...
    async fn _billing_accounts_locations_recommenders_recommendations_mark_dismissed(
        ...
        let mut request: api::GoogleCloudRecommenderV1MarkRecommendationDismissedRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .billing_accounts()
    ...
    async fn _billing_accounts_locations_recommenders_recommendations_mark_failed(
        ...
        let mut request: api::GoogleCloudRecommenderV1MarkRecommendationFailedRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .billing_accounts()
    ...
    async fn _billing_accounts_locations_recommenders_recommendations_mark_succeeded(
        ...
        let mut request: api::GoogleCloudRecommenderV1MarkRecommendationSucceededRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .billing_accounts()
    ...
    async fn _billing_accounts_locations_recommenders_update_config(
        ...
        let mut request: api::GoogleCloudRecommenderV1RecommenderConfig =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .billing_accounts()
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "recommender1-secret.json",
        ...
        .persist_tokens_to_disk(format!("{}/recommender1", config_dir))
        .build()
        .await
        .unwrap();
