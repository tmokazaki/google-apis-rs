...
impl<C> common::Hub for FirebaseML<C> {}

impl<'a, C> FirebaseML<C> {
    pub fn new<A: 'static + common::GetToken>(client: common::Client<C>, auth: A) -> FirebaseML<C> {
        FirebaseML {
            client,
            auth: Box::new(auth),
