...
impl common::ResponseResult for ListOrganizationsResponse {}
...
/// * [list organizations](OrganizationListCall) (none)
...
impl common::RequestValue for Organization {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [create projects](ProjectCreateCall) (request|response)
...
impl<'a, C> OrganizationMethods<'a, C> {
    ...
    pub fn list(&self) -> OrganizationListCall<'a, C> {
    ...
    pub fn update(&self, request: Organization, name: &str) -> OrganizationUpdateCall<'a, C> {
    ...
    C: common::Connector,
{
    ...
    pub fn organization_id(mut self, new_value: &str) -> OrganizationGetCall<'a, C> {
...
/// # extern crate hyper_rustls;
/// # extern crate google_cloudresourcemanager1_beta1 as cloudresourcemanager1_beta1;
/// use cloudresourcemanager1_beta1::api::GetIamPolicyRequest;
/// # async fn dox() {
/// # use cloudresourcemanager1_beta1::{CloudResourceManager, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
/// # }
/// ```
pub struct OrganizationListCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudResourceManager<C>,
...
impl<'a, C> common::CallBuilder for OrganizationListCall<'a, C> {}

impl<'a, C> OrganizationListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, ListOrganizationsResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    pub fn page_token(mut self, new_value: &str) -> OrganizationListCall<'a, C> {
    ...
    pub fn page_size(mut self, new_value: i32) -> OrganizationListCall<'a, C> {
    ...
    pub fn filter(mut self, new_value: &str) -> OrganizationListCall<'a, C> {
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> OrganizationListCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> OrganizationListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> OrganizationListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> OrganizationListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # extern crate hyper_rustls;
/// # extern crate google_cloudresourcemanager1_beta1 as cloudresourcemanager1_beta1;
/// use cloudresourcemanager1_beta1::api::SetIamPolicyRequest;
/// # async fn dox() {
/// # use cloudresourcemanager1_beta1::{CloudResourceManager, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
/// # extern crate hyper_rustls;
/// # extern crate google_cloudresourcemanager1_beta1 as cloudresourcemanager1_beta1;
/// use cloudresourcemanager1_beta1::api::TestIamPermissionsRequest;
/// # async fn dox() {
/// # use cloudresourcemanager1_beta1::{CloudResourceManager, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
/// # extern crate hyper_rustls;
/// # extern crate google_cloudresourcemanager1_beta1 as cloudresourcemanager1_beta1;
/// use cloudresourcemanager1_beta1::api::Organization;
/// # async fn dox() {
/// # use cloudresourcemanager1_beta1::{CloudResourceManager, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
/// # }
/// ```
pub struct OrganizationUpdateCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudResourceManager<C>,
...
impl<'a, C> common::CallBuilder for OrganizationUpdateCall<'a, C> {}

impl<'a, C> OrganizationUpdateCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: Organization) -> OrganizationUpdateCall<'a, C> {
        self._request = new_value;
        self
    }
    /// Output only. The resource name of the organization. This is the organization's relative path in the API. Its format is "organizations/[organization_id]". For example, "organizations/1234".
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> OrganizationUpdateCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> OrganizationUpdateCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> OrganizationUpdateCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> OrganizationUpdateCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> OrganizationUpdateCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # extern crate hyper_rustls;
/// # extern crate google_cloudresourcemanager1_beta1 as cloudresourcemanager1_beta1;
/// use cloudresourcemanager1_beta1::api::Project;
/// # async fn dox() {
/// # use cloudresourcemanager1_beta1::{CloudResourceManager, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
    ...
    C: common::Connector,
{
    ...
    pub async fn doit(mut self) -> common::Result<(common::Response, Project)> {
        ...
        let mut params = Params::with_capacity(4 + self._additional_params.len());
        if let Some(value) = self._use_legacy_stack.as_ref() {
    ...
    pub fn use_legacy_stack(mut self, new_value: bool) -> ProjectCreateCall<'a, C> {
...
/// # extern crate hyper_rustls;
/// # extern crate google_cloudresourcemanager1_beta1 as cloudresourcemanager1_beta1;
/// use cloudresourcemanager1_beta1::api::GetAncestryRequest;
/// # async fn dox() {
/// # use cloudresourcemanager1_beta1::{CloudResourceManager, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
/// # extern crate hyper_rustls;
/// # extern crate google_cloudresourcemanager1_beta1 as cloudresourcemanager1_beta1;
/// use cloudresourcemanager1_beta1::api::UndeleteProjectRequest;
/// # async fn dox() {
/// # use cloudresourcemanager1_beta1::{CloudResourceManager, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
