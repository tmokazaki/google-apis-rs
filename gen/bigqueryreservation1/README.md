...
You may alter the way an `doit()` method is called by providing a [delegate](https://docs.rs/google-bigqueryreservation1/7.0.0+20240611/google_bigqueryreservation1/common::Delegate) to the
