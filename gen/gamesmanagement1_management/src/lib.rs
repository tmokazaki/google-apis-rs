...
//!
//! * achievements
//!  * [*reset*](api::AchievementResetCall), [*reset all*](api::AchievementResetAllCall), [*reset all for all players*](api::AchievementResetAllForAllPlayerCall), [*reset for all players*](api::AchievementResetForAllPlayerCall) and [*reset multiple for all players*](api::AchievementResetMultipleForAllPlayerCall)
//! * applications
//!  * [*list hidden*](api::ApplicationListHiddenCall)
//! * events
//!  * [*reset*](api::EventResetCall), [*reset all*](api::EventResetAllCall), [*reset all for all players*](api::EventResetAllForAllPlayerCall), [*reset for all players*](api::EventResetForAllPlayerCall) and [*reset multiple for all players*](api::EventResetMultipleForAllPlayerCall)
//! * [players](api::Player)
//!  * [*hide*](api::PlayerHideCall) and [*unhide*](api::PlayerUnhideCall)
//! * scores
//!  * [*reset*](api::ScoreResetCall), [*reset all*](api::ScoreResetAllCall), [*reset all for all players*](api::ScoreResetAllForAllPlayerCall), [*reset for all players*](api::ScoreResetForAllPlayerCall) and [*reset multiple for all players*](api::ScoreResetMultipleForAllPlayerCall)
//!
//!
//!
//!
