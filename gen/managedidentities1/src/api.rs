...
/// ```
#[derive(Clone)]
pub struct ManagedServiceForMicrosoftActiveDirectoryConsumerAPI<C> {
...
impl<C> common::Hub for ManagedServiceForMicrosoftActiveDirectoryConsumerAPI<C> {}

impl<'a, C> ManagedServiceForMicrosoftActiveDirectoryConsumerAPI<C> {
    pub fn new<A: 'static + common::GetToken>(
        client: common::Client<C>,
        auth: A,
    ) -> ManagedServiceForMicrosoftActiveDirectoryConsumerAPI<C> {
...
impl common::RequestValue for AttachTrustRequest {}
...
impl common::Part for Certificate {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [locations global domains check migration permission projects](ProjectLocationGlobalDomainCheckMigrationPermissionCall) (request)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
...
impl common::RequestValue for CheckMigrationPermissionRequest {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [locations global domains check migration permission projects](ProjectLocationGlobalDomainCheckMigrationPermissionCall) (response)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
pub struct CheckMigrationPermissionResponse {
    /// The state of SID filtering of all the domains which has trust established.
    #[serde(rename = "onpremDomains")]
    pub onprem_domains: Option<Vec<OnPremDomainSIDDetails>>,
    /// The state of DomainMigration.
    pub state: Option<String>,
}

impl common::ResponseResult for CheckMigrationPermissionResponse {}
...
impl common::RequestValue for DetachTrustRequest {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [locations global domains disable migration projects](ProjectLocationGlobalDomainDisableMigrationCall) (request)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
...
impl common::RequestValue for DisableMigrationRequest {}
...
impl common::RequestValue for Domain {}
impl common::ResponseResult for Domain {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [locations global domains domain join machine projects](ProjectLocationGlobalDomainDomainJoinMachineCall) (request)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
pub struct DomainJoinMachineRequest {
    ...
    #[serde(rename = "vmIdToken")]
    pub vm_id_token: Option<String>,
}

impl common::RequestValue for DomainJoinMachineRequest {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [locations global domains domain join machine projects](ProjectLocationGlobalDomainDomainJoinMachineCall) (response)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
pub struct DomainJoinMachineResponse {
    /// Offline domain join blob as the response
    #[serde(rename = "domainJoinBlob")]
    pub domain_join_blob: Option<String>,
}

impl common::ResponseResult for DomainJoinMachineResponse {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [locations global domains enable migration projects](ProjectLocationGlobalDomainEnableMigrationCall) (request)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
pub struct EnableMigrationRequest {
    /// Required. List of the on-prem domains to be migrated.
    #[serde(rename = "migratingDomains")]
    pub migrating_domains: Option<Vec<OnPremDomainDetails>>,
}

impl common::RequestValue for EnableMigrationRequest {}
...
impl common::RequestValue for ExtendSchemaRequest {}
...
impl common::RequestValue for LDAPSSettings {}
impl common::ResponseResult for LDAPSSettings {}
...
impl common::ResponseResult for ListDomainsResponse {}
...
impl common::ResponseResult for ListPeeringsResponse {}
...
impl common::ResponseResult for ListSqlIntegrationsResponse {}
...
pub struct OnPremDomainDetails {
    ...
    #[serde(rename = "disableSidFiltering")]
...
impl common::Part for OnPremDomainDetails {}
...
pub struct OnPremDomainSIDDetails {
    ...
    #[serde(rename = "sidFilteringState")]
    pub sid_filtering_state: Option<String>,
}

impl common::Part for OnPremDomainSIDDetails {}
...
/// * [locations global domains disable migration projects](ProjectLocationGlobalDomainDisableMigrationCall) (response)
/// * [locations global domains enable migration projects](ProjectLocationGlobalDomainEnableMigrationCall) (response)
...
impl common::RequestValue for Peering {}
impl common::ResponseResult for Peering {}
...
impl common::RequestValue for ReconfigureTrustRequest {}
...
impl common::RequestValue for ResetAdminPasswordRequest {}
...
impl common::ResponseResult for ResetAdminPasswordResponse {}
...
impl common::RequestValue for RestoreDomainRequest {}
...
impl common::ResponseResult for SqlIntegration {}
...
pub struct Trust {
    ...
    pub last_trust_heartbeat_time: Option<chrono::DateTime<chrono::offset::Utc>>,
...
impl common::RequestValue for ValidateTrustRequest {}
...
where
    C: 'a,
{
    hub: &'a ManagedServiceForMicrosoftActiveDirectoryConsumerAPI<C>,
}
...
impl<'a, C> ProjectMethods<'a, C> {
    ...
    pub fn locations_global_domains_backups_create(
        &self,
        request: Backup,
        parent: &str,
    ) -> ProjectLocationGlobalDomainBackupCreateCall<'a, C> {
    ...
    pub fn locations_global_domains_backups_delete(
        &self,
        name: &str,
    ) -> ProjectLocationGlobalDomainBackupDeleteCall<'a, C> {
    ...
    ///
    /// * `name` - Required. The backup resource name using the form: `projects/{project_id}/locations/global/domains/{domain_name}/backups/{backup_id}`
    pub fn locations_global_domains_backups_get(
        &self,
        name: &str,
    ) -> ProjectLocationGlobalDomainBackupGetCall<'a, C> {
    ...
    pub fn locations_global_domains_backups_get_iam_policy(
        &self,
        resource: &str,
    ) -> ProjectLocationGlobalDomainBackupGetIamPolicyCall<'a, C> {
    ...
    ///
    /// * `parent` - Required. The domain resource name using the form: `projects/{project_id}/locations/global/domains/{domain_name}`
    pub fn locations_global_domains_backups_list(
        &self,
        parent: &str,
    ) -> ProjectLocationGlobalDomainBackupListCall<'a, C> {
    ...
    pub fn locations_global_domains_backups_patch(
        &self,
        request: Backup,
        name: &str,
    ) -> ProjectLocationGlobalDomainBackupPatchCall<'a, C> {
    ...
    pub fn locations_global_domains_backups_set_iam_policy(
        &self,
        request: SetIamPolicyRequest,
        resource: &str,
    ) -> ProjectLocationGlobalDomainBackupSetIamPolicyCall<'a, C> {
    ...
    pub fn locations_global_domains_backups_test_iam_permissions(
        &self,
        request: TestIamPermissionsRequest,
        resource: &str,
    ) -> ProjectLocationGlobalDomainBackupTestIamPermissionCall<'a, C> {
    ...
    pub fn locations_global_domains_sql_integrations_get(
        &self,
        name: &str,
    ) -> ProjectLocationGlobalDomainSqlIntegrationGetCall<'a, C> {
    ...
    pub fn locations_global_domains_sql_integrations_list(
        &self,
        parent: &str,
    ) -> ProjectLocationGlobalDomainSqlIntegrationListCall<'a, C> {
    ...
    pub fn locations_global_domains_attach_trust(
        &self,
        request: AttachTrustRequest,
        name: &str,
    ) -> ProjectLocationGlobalDomainAttachTrustCall<'a, C> {
    ...
    pub fn locations_global_domains_check_migration_permission(
        &self,
        request: CheckMigrationPermissionRequest,
        domain: &str,
    ) -> ProjectLocationGlobalDomainCheckMigrationPermissionCall<'a, C> {
        ProjectLocationGlobalDomainCheckMigrationPermissionCall {
            hub: self.hub,
            _request: request,
    ...
    pub fn locations_global_domains_create(
        &self,
        request: Domain,
        parent: &str,
    ) -> ProjectLocationGlobalDomainCreateCall<'a, C> {
    ...
    pub fn locations_global_domains_delete(
        &self,
        name: &str,
    ) -> ProjectLocationGlobalDomainDeleteCall<'a, C> {
    ...
    /// * `request` - No description provided.
    /// * `name` - Required. The resource domain name, project name, and location using the form: `projects/{project_id}/locations/global/domains/{domain_name}`
    pub fn locations_global_domains_detach_trust(
        &self,
        request: DetachTrustRequest,
        name: &str,
    ) -> ProjectLocationGlobalDomainDetachTrustCall<'a, C> {
    ...
    /// * `request` - No description provided.
    /// * `domain` - Required. The domain resource name using the form: `projects/{project_id}/locations/global/domains/{domain_name}`
    pub fn locations_global_domains_disable_migration(
        &self,
        request: DisableMigrationRequest,
        domain: &str,
    ) -> ProjectLocationGlobalDomainDisableMigrationCall<'a, C> {
        ProjectLocationGlobalDomainDisableMigrationCall {
            hub: self.hub,
            _request: request,
            _domain: domain.to_string(),
            _delegate: Default::default(),
    ...
    /// * `request` - No description provided.
    /// * `domain` - Required. The domain resource name using the form: projects/{project_id}/locations/global/domains/{domain_name}
    pub fn locations_global_domains_domain_join_machine(
        &self,
        request: DomainJoinMachineRequest,
        domain: &str,
    ) -> ProjectLocationGlobalDomainDomainJoinMachineCall<'a, C> {
        ProjectLocationGlobalDomainDomainJoinMachineCall {
            hub: self.hub,
            _request: request,
            _domain: domain.to_string(),
            _delegate: Default::default(),
    ...
    /// * `request` - No description provided.
    /// * `domain` - Required. The domain resource name using the form: `projects/{project_id}/locations/global/domains/{domain_name}`
    pub fn locations_global_domains_enable_migration(
        &self,
        request: EnableMigrationRequest,
        domain: &str,
    ) -> ProjectLocationGlobalDomainEnableMigrationCall<'a, C> {
    ...
    /// * `request` - No description provided.
    /// * `domain` - Required. The domain resource name using the form: `projects/{project_id}/locations/global/domains/{domain_name}`
    pub fn locations_global_domains_extend_schema(
        &self,
        request: ExtendSchemaRequest,
        domain: &str,
    ) -> ProjectLocationGlobalDomainExtendSchemaCall<'a, C> {
    ...
    ///
    /// * `name` - Required. The domain resource name using the form: `projects/{project_id}/locations/global/domains/{domain_name}`
    pub fn locations_global_domains_get(
        &self,
        name: &str,
    ) -> ProjectLocationGlobalDomainGetCall<'a, C> {
    ...
    ///
    /// * `resource` - REQUIRED: The resource for which the policy is being requested. See [Resource names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for this field.
    pub fn locations_global_domains_get_iam_policy(
        &self,
        resource: &str,
    ) -> ProjectLocationGlobalDomainGetIamPolicyCall<'a, C> {
    ...
    ///
    /// * `name` - Required. The domain resource name using the form: `projects/{project_id}/locations/global/domains/{domain_name}`
    pub fn locations_global_domains_get_ldapssettings(
        &self,
        name: &str,
    ) -> ProjectLocationGlobalDomainGetLdapssettingCall<'a, C> {
    ...
    pub fn locations_global_domains_list(
        &self,
        parent: &str,
    ) -> ProjectLocationGlobalDomainListCall<'a, C> {
    ...
    pub fn locations_global_domains_patch(
        &self,
        request: Domain,
        name: &str,
    ) -> ProjectLocationGlobalDomainPatchCall<'a, C> {
    ...
    /// * `request` - No description provided.
    /// * `name` - Required. The resource domain name, project name and location using the form: `projects/{project_id}/locations/global/domains/{domain_name}`
    pub fn locations_global_domains_reconfigure_trust(
        &self,
        request: ReconfigureTrustRequest,
        name: &str,
    ) -> ProjectLocationGlobalDomainReconfigureTrustCall<'a, C> {
    ...
    /// * `request` - No description provided.
    /// * `name` - Required. The domain resource name using the form: `projects/{project_id}/locations/global/domains/{domain_name}`
    pub fn locations_global_domains_reset_admin_password(
        &self,
        request: ResetAdminPasswordRequest,
        name: &str,
    ) -> ProjectLocationGlobalDomainResetAdminPasswordCall<'a, C> {
    ...
    pub fn locations_global_domains_restore(
        &self,
        request: RestoreDomainRequest,
        name: &str,
    ) -> ProjectLocationGlobalDomainRestoreCall<'a, C> {
    ...
    /// * `request` - No description provided.
    /// * `resource` - REQUIRED: The resource for which the policy is being specified. See [Resource names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for this field.
    pub fn locations_global_domains_set_iam_policy(
        &self,
        request: SetIamPolicyRequest,
        resource: &str,
    ) -> ProjectLocationGlobalDomainSetIamPolicyCall<'a, C> {
    ...
    /// * `request` - No description provided.
    /// * `resource` - REQUIRED: The resource for which the policy detail is being requested. See [Resource names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for this field.
    pub fn locations_global_domains_test_iam_permissions(
        &self,
        request: TestIamPermissionsRequest,
        resource: &str,
    ) -> ProjectLocationGlobalDomainTestIamPermissionCall<'a, C> {
    ...
    pub fn locations_global_domains_update_ldapssettings(
        &self,
        request: LDAPSSettings,
        name: &str,
    ) -> ProjectLocationGlobalDomainUpdateLdapssettingCall<'a, C> {
    ...
    /// * `request` - No description provided.
    /// * `name` - Required. The resource domain name, project name, and location using the form: `projects/{project_id}/locations/global/domains/{domain_name}`
    pub fn locations_global_domains_validate_trust(
        &self,
        request: ValidateTrustRequest,
        name: &str,
    ) -> ProjectLocationGlobalDomainValidateTrustCall<'a, C> {
    ...
    pub fn locations_global_peerings_create(
        &self,
        request: Peering,
        parent: &str,
    ) -> ProjectLocationGlobalPeeringCreateCall<'a, C> {
    ...
    pub fn locations_global_peerings_delete(
        &self,
        name: &str,
    ) -> ProjectLocationGlobalPeeringDeleteCall<'a, C> {
    ...
    ///
    /// * `name` - Required. Peering resource name using the form: `projects/{project_id}/locations/global/peerings/{peering_id}`
    pub fn locations_global_peerings_get(
        &self,
        name: &str,
    ) -> ProjectLocationGlobalPeeringGetCall<'a, C> {
    ...
    ///
    /// * `resource` - REQUIRED: The resource for which the policy is being requested. See [Resource names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for this field.
    pub fn locations_global_peerings_get_iam_policy(
        &self,
        resource: &str,
    ) -> ProjectLocationGlobalPeeringGetIamPolicyCall<'a, C> {
    ...
    pub fn locations_global_peerings_list(
        &self,
        parent: &str,
    ) -> ProjectLocationGlobalPeeringListCall<'a, C> {
    ...
    pub fn locations_global_peerings_patch(
        &self,
        request: Peering,
        name: &str,
    ) -> ProjectLocationGlobalPeeringPatchCall<'a, C> {
    ...
    /// * `request` - No description provided.
    /// * `resource` - REQUIRED: The resource for which the policy is being specified. See [Resource names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for this field.
    pub fn locations_global_peerings_set_iam_policy(
        &self,
        request: SetIamPolicyRequest,
        resource: &str,
    ) -> ProjectLocationGlobalPeeringSetIamPolicyCall<'a, C> {
    ...
    /// * `request` - No description provided.
    /// * `resource` - REQUIRED: The resource for which the policy detail is being requested. See [Resource names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for this field.
    pub fn locations_global_peerings_test_iam_permissions(
        &self,
        request: TestIamPermissionsRequest,
        resource: &str,
    ) -> ProjectLocationGlobalPeeringTestIamPermissionCall<'a, C> {
...
/// # }
/// ```
pub struct ProjectLocationGlobalDomainBackupCreateCall<'a, C>
where
    C: 'a,
{
    hub: &'a ManagedServiceForMicrosoftActiveDirectoryConsumerAPI<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationGlobalDomainBackupCreateCall<'a, C> {}

impl<'a, C> ProjectLocationGlobalDomainBackupCreateCall<'a, C>
where
    C: common::Connector,
{
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> ProjectLocationGlobalDomainBackupCreateCall<'a, C> {
    ...
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationGlobalDomainBackupCreateCall<'a, C>
    where
        St: AsRef<str>,
    {
    ...
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationGlobalDomainBackupCreateCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationGlobalDomainBackupDeleteCall<'a, C>
where
    C: 'a,
{
    hub: &'a ManagedServiceForMicrosoftActiveDirectoryConsumerAPI<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationGlobalDomainBackupDeleteCall<'a, C> {}

impl<'a, C> ProjectLocationGlobalDomainBackupDeleteCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationGlobalDomainBackupDeleteCall<'a, C> {
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationGlobalDomainBackupDeleteCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationGlobalDomainBackupDeleteCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationGlobalDomainBackupGetCall<'a, C>
where
    C: 'a,
{
    hub: &'a ManagedServiceForMicrosoftActiveDirectoryConsumerAPI<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationGlobalDomainBackupGetCall<'a, C> {}

impl<'a, C> ProjectLocationGlobalDomainBackupGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationGlobalDomainBackupGetCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationGlobalDomainBackupGetCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationGlobalDomainBackupGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationGlobalDomainBackupGetCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationGlobalDomainBackupGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationGlobalDomainBackupGetIamPolicyCall<'a, C>
where
    C: 'a,
{
    hub: &'a ManagedServiceForMicrosoftActiveDirectoryConsumerAPI<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationGlobalDomainBackupGetIamPolicyCall<'a, C> {}

impl<'a, C> ProjectLocationGlobalDomainBackupGetIamPolicyCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationGlobalDomainBackupGetIamPolicyCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationGlobalDomainBackupListCall<'a, C>
where
    C: 'a,
{
    hub: &'a ManagedServiceForMicrosoftActiveDirectoryConsumerAPI<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationGlobalDomainBackupListCall<'a, C> {}

impl<'a, C> ProjectLocationGlobalDomainBackupListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> ProjectLocationGlobalDomainBackupListCall<'a, C> {
        self._parent = new_value.to_string();
        self
    }
    ...
    pub fn page_size(mut self, new_value: i32) -> ProjectLocationGlobalDomainBackupListCall<'a, C> {
    ...
    pub fn order_by(mut self, new_value: &str) -> ProjectLocationGlobalDomainBackupListCall<'a, C> {
    ...
    pub fn filter(mut self, new_value: &str) -> ProjectLocationGlobalDomainBackupListCall<'a, C> {
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationGlobalDomainBackupListCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationGlobalDomainBackupListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationGlobalDomainBackupListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationGlobalDomainBackupPatchCall<'a, C>
where
    C: 'a,
{
    hub: &'a ManagedServiceForMicrosoftActiveDirectoryConsumerAPI<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationGlobalDomainBackupPatchCall<'a, C> {}

impl<'a, C> ProjectLocationGlobalDomainBackupPatchCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationGlobalDomainBackupPatchCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationGlobalDomainBackupPatchCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationGlobalDomainBackupPatchCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationGlobalDomainBackupSetIamPolicyCall<'a, C>
where
    C: 'a,
{
    hub: &'a ManagedServiceForMicrosoftActiveDirectoryConsumerAPI<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationGlobalDomainBackupSetIamPolicyCall<'a, C> {}

impl<'a, C> ProjectLocationGlobalDomainBackupSetIamPolicyCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationGlobalDomainBackupSetIamPolicyCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationGlobalDomainBackupTestIamPermissionCall<'a, C>
where
    C: 'a,
{
    hub: &'a ManagedServiceForMicrosoftActiveDirectoryConsumerAPI<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationGlobalDomainBackupTestIamPermissionCall<'a, C> {}

impl<'a, C> ProjectLocationGlobalDomainBackupTestIamPermissionCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationGlobalDomainBackupTestIamPermissionCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationGlobalDomainSqlIntegrationGetCall<'a, C>
where
    C: 'a,
{
    hub: &'a ManagedServiceForMicrosoftActiveDirectoryConsumerAPI<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationGlobalDomainSqlIntegrationGetCall<'a, C> {}

impl<'a, C> ProjectLocationGlobalDomainSqlIntegrationGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, SqlIntegration)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationGlobalDomainSqlIntegrationGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationGlobalDomainSqlIntegrationListCall<'a, C>
where
    C: 'a,
{
    hub: &'a ManagedServiceForMicrosoftActiveDirectoryConsumerAPI<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationGlobalDomainSqlIntegrationListCall<'a, C> {}

impl<'a, C> ProjectLocationGlobalDomainSqlIntegrationListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, ListSqlIntegrationsResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationGlobalDomainSqlIntegrationListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationGlobalDomainAttachTrustCall<'a, C>
where
    C: 'a,
{
    hub: &'a ManagedServiceForMicrosoftActiveDirectoryConsumerAPI<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationGlobalDomainAttachTrustCall<'a, C> {}

impl<'a, C> ProjectLocationGlobalDomainAttachTrustCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationGlobalDomainAttachTrustCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationGlobalDomainAttachTrustCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationGlobalDomainAttachTrustCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// CheckMigrationPermission API gets the current state of DomainMigration
///
/// A builder for the *locations.global.domains.checkMigrationPermission* method supported by a *project* resource.
/// It is not used directly, but through a [`ProjectMethods`] instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_managedidentities1 as managedidentities1;
/// use managedidentities1::api::CheckMigrationPermissionRequest;
/// # async fn dox() {
/// # use managedidentities1::{ManagedServiceForMicrosoftActiveDirectoryConsumerAPI, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = CheckMigrationPermissionRequest::default();
///
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().locations_global_domains_check_migration_permission(req, "domain")
///              .doit().await;
/// # }
/// ```
pub struct ProjectLocationGlobalDomainCheckMigrationPermissionCall<'a, C>
where
    C: 'a,
{
    hub: &'a ManagedServiceForMicrosoftActiveDirectoryConsumerAPI<C>,
    _request: CheckMigrationPermissionRequest,
    _domain: String,
    _delegate: Option<&'a mut dyn common::Delegate>,
    _additional_params: HashMap<String, String>,
    _scopes: BTreeSet<String>,
...
impl<'a, C> common::CallBuilder for ProjectLocationGlobalDomainCheckMigrationPermissionCall<'a, C> {}

impl<'a, C> ProjectLocationGlobalDomainCheckMigrationPermissionCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(
        mut self,
    ) -> common::Result<(common::Response, CheckMigrationPermissionResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
        ...
        params.push("alt", "json");
        let mut url = self.hub._base_url.clone() + "v1/{+domain}:checkMigrationPermission";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string());
        }
        ...
        #[allow(clippy::single_element_loop)]
        for &(find_this, param_name) in [("{+domain}", "domain")].iter() {
            url = params.uri_replacement(url, param_name, find_this, true);
        }
        {
            let to_remove = ["domain"];
            params.remove_params(&to_remove);
        }
    ...
    pub fn request(
        mut self,
        new_value: CheckMigrationPermissionRequest,
    ) -> ProjectLocationGlobalDomainCheckMigrationPermissionCall<'a, C> {
        self._request = new_value;
        self
    }
    /// Required. The domain resource name using the form: `projects/{project_id}/locations/global/domains/{domain_name}`
    ///
    /// Sets the *domain* path property to the given value.
    ///
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn domain(
...
/// # }
/// ```
pub struct ProjectLocationGlobalDomainCreateCall<'a, C>
where
    C: 'a,
{
    hub: &'a ManagedServiceForMicrosoftActiveDirectoryConsumerAPI<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationGlobalDomainCreateCall<'a, C> {}

impl<'a, C> ProjectLocationGlobalDomainCreateCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, Operation)> {
        ...
        let mut params = Params::with_capacity(5 + self._additional_params.len());
        params.push("parent", self._parent);
        if let Some(value) = self._domain_name.as_ref() {
            params.push("domainName", value);
        }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: Domain) -> ProjectLocationGlobalDomainCreateCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> ProjectLocationGlobalDomainCreateCall<'a, C> {
        self._parent = new_value.to_string();
        self
    }
    ...
    pub fn domain_name(mut self, new_value: &str) -> ProjectLocationGlobalDomainCreateCall<'a, C> {
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationGlobalDomainCreateCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationGlobalDomainCreateCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationGlobalDomainCreateCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationGlobalDomainCreateCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationGlobalDomainDeleteCall<'a, C>
where
    C: 'a,
{
    hub: &'a ManagedServiceForMicrosoftActiveDirectoryConsumerAPI<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationGlobalDomainDeleteCall<'a, C> {}

impl<'a, C> ProjectLocationGlobalDomainDeleteCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationGlobalDomainDeleteCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationGlobalDomainDeleteCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationGlobalDomainDeleteCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationGlobalDomainDeleteCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationGlobalDomainDeleteCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationGlobalDomainDetachTrustCall<'a, C>
where
    C: 'a,
{
    hub: &'a ManagedServiceForMicrosoftActiveDirectoryConsumerAPI<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationGlobalDomainDetachTrustCall<'a, C> {}

impl<'a, C> ProjectLocationGlobalDomainDetachTrustCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationGlobalDomainDetachTrustCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationGlobalDomainDetachTrustCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationGlobalDomainDetachTrustCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Disable Domain Migration
///
/// A builder for the *locations.global.domains.disableMigration* method supported by a *project* resource.
/// It is not used directly, but through a [`ProjectMethods`] instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_managedidentities1 as managedidentities1;
/// use managedidentities1::api::DisableMigrationRequest;
/// # async fn dox() {
/// # use managedidentities1::{ManagedServiceForMicrosoftActiveDirectoryConsumerAPI, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = DisableMigrationRequest::default();
///
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().locations_global_domains_disable_migration(req, "domain")
///              .doit().await;
/// # }
/// ```
pub struct ProjectLocationGlobalDomainDisableMigrationCall<'a, C>
where
    C: 'a,
{
    hub: &'a ManagedServiceForMicrosoftActiveDirectoryConsumerAPI<C>,
    _request: DisableMigrationRequest,
    _domain: String,
    _delegate: Option<&'a mut dyn common::Delegate>,
    _additional_params: HashMap<String, String>,
    _scopes: BTreeSet<String>,
...
impl<'a, C> common::CallBuilder for ProjectLocationGlobalDomainDisableMigrationCall<'a, C> {}

impl<'a, C> ProjectLocationGlobalDomainDisableMigrationCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, Operation)> {
        ...
        params.push("alt", "json");
        let mut url = self.hub._base_url.clone() + "v1/{+domain}:disableMigration";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string());
        }
    ...
    pub fn request(
        mut self,
        new_value: DisableMigrationRequest,
    ) -> ProjectLocationGlobalDomainDisableMigrationCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationGlobalDomainDisableMigrationCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// DomainJoinMachine API joins a Compute Engine VM to the domain
///
/// A builder for the *locations.global.domains.domainJoinMachine* method supported by a *project* resource.
/// It is not used directly, but through a [`ProjectMethods`] instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_managedidentities1 as managedidentities1;
/// use managedidentities1::api::DomainJoinMachineRequest;
/// # async fn dox() {
/// # use managedidentities1::{ManagedServiceForMicrosoftActiveDirectoryConsumerAPI, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = DomainJoinMachineRequest::default();
///
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().locations_global_domains_domain_join_machine(req, "domain")
///              .doit().await;
/// # }
/// ```
pub struct ProjectLocationGlobalDomainDomainJoinMachineCall<'a, C>
where
    C: 'a,
{
    hub: &'a ManagedServiceForMicrosoftActiveDirectoryConsumerAPI<C>,
    _request: DomainJoinMachineRequest,
    _domain: String,
    _delegate: Option<&'a mut dyn common::Delegate>,
    _additional_params: HashMap<String, String>,
    _scopes: BTreeSet<String>,
...
impl<'a, C> common::CallBuilder for ProjectLocationGlobalDomainDomainJoinMachineCall<'a, C> {}

impl<'a, C> ProjectLocationGlobalDomainDomainJoinMachineCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, DomainJoinMachineResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
        ...
        params.push("alt", "json");
        let mut url = self.hub._base_url.clone() + "v1/{+domain}:domainJoinMachine";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string());
        }
    ...
    pub fn request(
        mut self,
        new_value: DomainJoinMachineRequest,
    ) -> ProjectLocationGlobalDomainDomainJoinMachineCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationGlobalDomainDomainJoinMachineCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Enable Domain Migration
///
/// A builder for the *locations.global.domains.enableMigration* method supported by a *project* resource.
/// It is not used directly, but through a [`ProjectMethods`] instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_managedidentities1 as managedidentities1;
/// use managedidentities1::api::EnableMigrationRequest;
/// # async fn dox() {
/// # use managedidentities1::{ManagedServiceForMicrosoftActiveDirectoryConsumerAPI, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = EnableMigrationRequest::default();
///
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().locations_global_domains_enable_migration(req, "domain")
///              .doit().await;
/// # }
/// ```
pub struct ProjectLocationGlobalDomainEnableMigrationCall<'a, C>
where
    C: 'a,
{
    hub: &'a ManagedServiceForMicrosoftActiveDirectoryConsumerAPI<C>,
    _request: EnableMigrationRequest,
    _domain: String,
    _delegate: Option<&'a mut dyn common::Delegate>,
    _additional_params: HashMap<String, String>,
    _scopes: BTreeSet<String>,
...
impl<'a, C> common::CallBuilder for ProjectLocationGlobalDomainEnableMigrationCall<'a, C> {}

impl<'a, C> ProjectLocationGlobalDomainEnableMigrationCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, Operation)> {
        ...
        params.push("alt", "json");
        let mut url = self.hub._base_url.clone() + "v1/{+domain}:enableMigration";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string());
        }
    ...
    pub fn request(
        mut self,
        new_value: EnableMigrationRequest,
    ) -> ProjectLocationGlobalDomainEnableMigrationCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationGlobalDomainEnableMigrationCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Extend Schema for Domain
///
/// A builder for the *locations.global.domains.extendSchema* method supported by a *project* resource.
/// It is not used directly, but through a [`ProjectMethods`] instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_managedidentities1 as managedidentities1;
/// use managedidentities1::api::ExtendSchemaRequest;
/// # async fn dox() {
/// # use managedidentities1::{ManagedServiceForMicrosoftActiveDirectoryConsumerAPI, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = ExtendSchemaRequest::default();
///
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().locations_global_domains_extend_schema(req, "domain")
///              .doit().await;
/// # }
/// ```
pub struct ProjectLocationGlobalDomainExtendSchemaCall<'a, C>
where
    C: 'a,
{
    hub: &'a ManagedServiceForMicrosoftActiveDirectoryConsumerAPI<C>,
    _request: ExtendSchemaRequest,
    _domain: String,
    _delegate: Option<&'a mut dyn common::Delegate>,
    _additional_params: HashMap<String, String>,
    _scopes: BTreeSet<String>,
...
impl<'a, C> common::CallBuilder for ProjectLocationGlobalDomainExtendSchemaCall<'a, C> {}

impl<'a, C> ProjectLocationGlobalDomainExtendSchemaCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, Operation)> {
        ...
        params.push("alt", "json");
        let mut url = self.hub._base_url.clone() + "v1/{+domain}:extendSchema";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string());
        }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn domain(mut self, new_value: &str) -> ProjectLocationGlobalDomainExtendSchemaCall<'a, C> {
        self._domain = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationGlobalDomainExtendSchemaCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationGlobalDomainExtendSchemaCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationGlobalDomainGetCall<'a, C>
where
    C: 'a,
{
    hub: &'a ManagedServiceForMicrosoftActiveDirectoryConsumerAPI<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationGlobalDomainGetCall<'a, C> {}

impl<'a, C> ProjectLocationGlobalDomainGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, Domain)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationGlobalDomainGetCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationGlobalDomainGetCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationGlobalDomainGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationGlobalDomainGetCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationGlobalDomainGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationGlobalDomainGetIamPolicyCall<'a, C>
where
    C: 'a,
{
    hub: &'a ManagedServiceForMicrosoftActiveDirectoryConsumerAPI<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationGlobalDomainGetIamPolicyCall<'a, C> {}

impl<'a, C> ProjectLocationGlobalDomainGetIamPolicyCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationGlobalDomainGetIamPolicyCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationGlobalDomainGetIamPolicyCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationGlobalDomainGetLdapssettingCall<'a, C>
where
    C: 'a,
{
    hub: &'a ManagedServiceForMicrosoftActiveDirectoryConsumerAPI<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationGlobalDomainGetLdapssettingCall<'a, C> {}

impl<'a, C> ProjectLocationGlobalDomainGetLdapssettingCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, LDAPSSettings)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationGlobalDomainGetLdapssettingCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationGlobalDomainListCall<'a, C>
where
    C: 'a,
{
    hub: &'a ManagedServiceForMicrosoftActiveDirectoryConsumerAPI<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationGlobalDomainListCall<'a, C> {}

impl<'a, C> ProjectLocationGlobalDomainListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, ListDomainsResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> ProjectLocationGlobalDomainListCall<'a, C> {
        self._parent = new_value.to_string();
        self
    }
    ...
    ///
    /// Sets the *page token* query property to the given value.
    pub fn page_token(mut self, new_value: &str) -> ProjectLocationGlobalDomainListCall<'a, C> {
        self._page_token = Some(new_value.to_string());
        self
    }
    ...
    ///
    /// Sets the *page size* query property to the given value.
    pub fn page_size(mut self, new_value: i32) -> ProjectLocationGlobalDomainListCall<'a, C> {
        self._page_size = Some(new_value);
        self
    }
    ...
    ///
    /// Sets the *order by* query property to the given value.
    pub fn order_by(mut self, new_value: &str) -> ProjectLocationGlobalDomainListCall<'a, C> {
        self._order_by = Some(new_value.to_string());
        self
    }
    ...
    ///
    /// Sets the *filter* query property to the given value.
    pub fn filter(mut self, new_value: &str) -> ProjectLocationGlobalDomainListCall<'a, C> {
        self._filter = Some(new_value.to_string());
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationGlobalDomainListCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationGlobalDomainListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationGlobalDomainListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationGlobalDomainListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationGlobalDomainPatchCall<'a, C>
where
    C: 'a,
{
    hub: &'a ManagedServiceForMicrosoftActiveDirectoryConsumerAPI<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationGlobalDomainPatchCall<'a, C> {}

impl<'a, C> ProjectLocationGlobalDomainPatchCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: Domain) -> ProjectLocationGlobalDomainPatchCall<'a, C> {
        self._request = new_value;
        self
    }
    /// Required. The unique name of the domain using the form: `projects/{project_id}/locations/global/domains/{domain_name}`.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationGlobalDomainPatchCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationGlobalDomainPatchCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationGlobalDomainPatchCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationGlobalDomainPatchCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationGlobalDomainPatchCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationGlobalDomainReconfigureTrustCall<'a, C>
where
    C: 'a,
{
    hub: &'a ManagedServiceForMicrosoftActiveDirectoryConsumerAPI<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationGlobalDomainReconfigureTrustCall<'a, C> {}

impl<'a, C> ProjectLocationGlobalDomainReconfigureTrustCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    pub fn request(
        mut self,
        new_value: ReconfigureTrustRequest,
    ) -> ProjectLocationGlobalDomainReconfigureTrustCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationGlobalDomainReconfigureTrustCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationGlobalDomainResetAdminPasswordCall<'a, C>
where
    C: 'a,
{
    hub: &'a ManagedServiceForMicrosoftActiveDirectoryConsumerAPI<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationGlobalDomainResetAdminPasswordCall<'a, C> {}

impl<'a, C> ProjectLocationGlobalDomainResetAdminPasswordCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, ResetAdminPasswordResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    pub fn request(
        mut self,
        new_value: ResetAdminPasswordRequest,
    ) -> ProjectLocationGlobalDomainResetAdminPasswordCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationGlobalDomainResetAdminPasswordCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationGlobalDomainRestoreCall<'a, C>
where
    C: 'a,
{
    hub: &'a ManagedServiceForMicrosoftActiveDirectoryConsumerAPI<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationGlobalDomainRestoreCall<'a, C> {}

impl<'a, C> ProjectLocationGlobalDomainRestoreCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    pub fn request(
        mut self,
        new_value: RestoreDomainRequest,
    ) -> ProjectLocationGlobalDomainRestoreCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationGlobalDomainRestoreCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationGlobalDomainRestoreCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationGlobalDomainRestoreCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationGlobalDomainRestoreCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationGlobalDomainRestoreCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationGlobalDomainSetIamPolicyCall<'a, C>
where
    C: 'a,
{
    hub: &'a ManagedServiceForMicrosoftActiveDirectoryConsumerAPI<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationGlobalDomainSetIamPolicyCall<'a, C> {}

impl<'a, C> ProjectLocationGlobalDomainSetIamPolicyCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationGlobalDomainSetIamPolicyCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationGlobalDomainSetIamPolicyCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationGlobalDomainTestIamPermissionCall<'a, C>
where
    C: 'a,
{
    hub: &'a ManagedServiceForMicrosoftActiveDirectoryConsumerAPI<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationGlobalDomainTestIamPermissionCall<'a, C> {}

impl<'a, C> ProjectLocationGlobalDomainTestIamPermissionCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationGlobalDomainTestIamPermissionCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationGlobalDomainUpdateLdapssettingCall<'a, C>
where
    C: 'a,
{
    hub: &'a ManagedServiceForMicrosoftActiveDirectoryConsumerAPI<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationGlobalDomainUpdateLdapssettingCall<'a, C> {}

impl<'a, C> ProjectLocationGlobalDomainUpdateLdapssettingCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationGlobalDomainUpdateLdapssettingCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationGlobalDomainValidateTrustCall<'a, C>
where
    C: 'a,
{
    hub: &'a ManagedServiceForMicrosoftActiveDirectoryConsumerAPI<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationGlobalDomainValidateTrustCall<'a, C> {}

impl<'a, C> ProjectLocationGlobalDomainValidateTrustCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    pub fn request(
        mut self,
        new_value: ValidateTrustRequest,
    ) -> ProjectLocationGlobalDomainValidateTrustCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationGlobalDomainValidateTrustCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationGlobalDomainValidateTrustCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationGlobalDomainValidateTrustCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
///              .peering_id("sadipscing")
///              .doit().await;
/// # }
/// ```
pub struct ProjectLocationGlobalPeeringCreateCall<'a, C>
where
    C: 'a,
{
    hub: &'a ManagedServiceForMicrosoftActiveDirectoryConsumerAPI<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationGlobalPeeringCreateCall<'a, C> {}

impl<'a, C> ProjectLocationGlobalPeeringCreateCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, Operation)> {
        ...
        let mut params = Params::with_capacity(5 + self._additional_params.len());
        params.push("parent", self._parent);
        if let Some(value) = self._peering_id.as_ref() {
            params.push("peeringId", value);
        }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: Peering) -> ProjectLocationGlobalPeeringCreateCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> ProjectLocationGlobalPeeringCreateCall<'a, C> {
        self._parent = new_value.to_string();
        self
    }
    ...
    pub fn peering_id(mut self, new_value: &str) -> ProjectLocationGlobalPeeringCreateCall<'a, C> {
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationGlobalPeeringCreateCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationGlobalPeeringCreateCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationGlobalPeeringCreateCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationGlobalPeeringCreateCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationGlobalPeeringDeleteCall<'a, C>
where
    C: 'a,
{
    hub: &'a ManagedServiceForMicrosoftActiveDirectoryConsumerAPI<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationGlobalPeeringDeleteCall<'a, C> {}

impl<'a, C> ProjectLocationGlobalPeeringDeleteCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationGlobalPeeringDeleteCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationGlobalPeeringDeleteCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationGlobalPeeringDeleteCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationGlobalPeeringDeleteCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationGlobalPeeringDeleteCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationGlobalPeeringGetCall<'a, C>
where
    C: 'a,
{
    hub: &'a ManagedServiceForMicrosoftActiveDirectoryConsumerAPI<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationGlobalPeeringGetCall<'a, C> {}

impl<'a, C> ProjectLocationGlobalPeeringGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, Peering)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationGlobalPeeringGetCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationGlobalPeeringGetCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationGlobalPeeringGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationGlobalPeeringGetCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationGlobalPeeringGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationGlobalPeeringGetIamPolicyCall<'a, C>
where
    C: 'a,
{
    hub: &'a ManagedServiceForMicrosoftActiveDirectoryConsumerAPI<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationGlobalPeeringGetIamPolicyCall<'a, C> {}

impl<'a, C> ProjectLocationGlobalPeeringGetIamPolicyCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationGlobalPeeringGetIamPolicyCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationGlobalPeeringGetIamPolicyCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationGlobalPeeringListCall<'a, C>
where
    C: 'a,
{
    hub: &'a ManagedServiceForMicrosoftActiveDirectoryConsumerAPI<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationGlobalPeeringListCall<'a, C> {}

impl<'a, C> ProjectLocationGlobalPeeringListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, ListPeeringsResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> ProjectLocationGlobalPeeringListCall<'a, C> {
        self._parent = new_value.to_string();
        self
    }
    /// Optional. The next_page_token value returned from a previous List request, if any.
    ///
    /// Sets the *page token* query property to the given value.
    pub fn page_token(mut self, new_value: &str) -> ProjectLocationGlobalPeeringListCall<'a, C> {
        self._page_token = Some(new_value.to_string());
        self
    }
    /// Optional. The maximum number of items to return. If not specified, a default value of 1000 will be used by the service. Regardless of the page_size value, the response may include a partial list and a caller should only rely on response's next_page_token to determine if there are more instances left to be queried.
    ///
    /// Sets the *page size* query property to the given value.
    pub fn page_size(mut self, new_value: i32) -> ProjectLocationGlobalPeeringListCall<'a, C> {
        self._page_size = Some(new_value);
        self
    }
    /// Optional. Specifies the ordering of results following syntax at https://cloud.google.com/apis/design/design_patterns#sorting_order.
    ///
    /// Sets the *order by* query property to the given value.
    pub fn order_by(mut self, new_value: &str) -> ProjectLocationGlobalPeeringListCall<'a, C> {
        self._order_by = Some(new_value.to_string());
        self
    }
    ...
    ///
    /// Sets the *filter* query property to the given value.
    pub fn filter(mut self, new_value: &str) -> ProjectLocationGlobalPeeringListCall<'a, C> {
        self._filter = Some(new_value.to_string());
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationGlobalPeeringListCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationGlobalPeeringListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationGlobalPeeringListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationGlobalPeeringListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationGlobalPeeringPatchCall<'a, C>
where
    C: 'a,
{
    hub: &'a ManagedServiceForMicrosoftActiveDirectoryConsumerAPI<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationGlobalPeeringPatchCall<'a, C> {}

impl<'a, C> ProjectLocationGlobalPeeringPatchCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: Peering) -> ProjectLocationGlobalPeeringPatchCall<'a, C> {
        self._request = new_value;
        self
    }
    /// Output only. Unique name of the peering in this scope including projects and location using the form: `projects/{project_id}/locations/global/peerings/{peering_id}`.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationGlobalPeeringPatchCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationGlobalPeeringPatchCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationGlobalPeeringPatchCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationGlobalPeeringPatchCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationGlobalPeeringPatchCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationGlobalPeeringSetIamPolicyCall<'a, C>
where
    C: 'a,
{
    hub: &'a ManagedServiceForMicrosoftActiveDirectoryConsumerAPI<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationGlobalPeeringSetIamPolicyCall<'a, C> {}

impl<'a, C> ProjectLocationGlobalPeeringSetIamPolicyCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationGlobalPeeringSetIamPolicyCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationGlobalPeeringSetIamPolicyCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationGlobalPeeringTestIamPermissionCall<'a, C>
where
    C: 'a,
{
    hub: &'a ManagedServiceForMicrosoftActiveDirectoryConsumerAPI<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationGlobalPeeringTestIamPermissionCall<'a, C> {}

impl<'a, C> ProjectLocationGlobalPeeringTestIamPermissionCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationGlobalPeeringTestIamPermissionCall<'a, C> {
        self._scopes.clear();
        self
    }
}
