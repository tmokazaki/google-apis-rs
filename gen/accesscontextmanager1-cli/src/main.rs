...
use google_accesscontextmanager1::{api, yup_oauth2, Error};
...
struct Engine<'n, C> {
    opt: ArgMatches<'n>,
    hub: api::AccessContextManager<C>,
    gp: Vec<&'static str>,
...
{
    async fn _access_policies_access_levels_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        ...
        let mut request: api::AccessLevel = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .access_policies()
            .access_levels_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _access_policies_access_levels_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .access_policies()
            .access_levels_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _access_policies_access_levels_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .access_policies()
            .access_levels_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _access_policies_access_levels_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .access_policies()
            .access_levels_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["access-level-format", "page-size", "page-token"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _access_policies_access_levels_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .access_policies()
            .access_levels_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _access_policies_access_levels_replace_all(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::ReplaceAccessLevelsRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .access_policies()
            .access_levels_replace_all(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _access_policies_access_levels_test_iam_permissions(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .access_policies()
            .access_levels_test_iam_permissions(request, opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _access_policies_authorized_orgs_descs_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::AuthorizedOrgsDesc = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .access_policies()
            .authorized_orgs_descs_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _access_policies_authorized_orgs_descs_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .access_policies()
            .authorized_orgs_descs_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _access_policies_authorized_orgs_descs_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .access_policies()
            .authorized_orgs_descs_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _access_policies_authorized_orgs_descs_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .access_policies()
            .authorized_orgs_descs_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _access_policies_authorized_orgs_descs_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .access_policies()
            .authorized_orgs_descs_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _access_policies_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec!["etag", "name", "parent", "scopes", "title"],
                    );
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
        ...
        let mut request: api::AccessPolicy = serde_json::value::from_value(object).unwrap();
    ...
    async fn _access_policies_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _access_policies_get_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _access_policies_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _access_policies_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _access_policies_service_perimeters_commit(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::CommitServicePerimetersRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .access_policies()
            .service_perimeters_commit(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _access_policies_service_perimeters_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "spec.vpc-accessible-services.allowed-services" => Some((
                ...
                "spec.vpc-accessible-services.enable-restriction" => Some((
                ...
                "status.restricted-services" => Some((
                ...
                "status.vpc-accessible-services.allowed-services" => Some((
                ...
                "status.vpc-accessible-services.enable-restriction" => Some((
                ...
                "use-explicit-dry-run-spec" => Some((
        ...
        let mut request: api::ServicePerimeter = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .access_policies()
            .service_perimeters_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _access_policies_service_perimeters_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .access_policies()
            .service_perimeters_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _access_policies_service_perimeters_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .access_policies()
            .service_perimeters_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _access_policies_service_perimeters_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .access_policies()
            .service_perimeters_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _access_policies_service_perimeters_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .access_policies()
            .service_perimeters_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _access_policies_service_perimeters_replace_all(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::ReplaceServicePerimetersRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .access_policies()
            .service_perimeters_replace_all(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _access_policies_service_perimeters_test_iam_permissions(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .access_policies()
            .service_perimeters_test_iam_permissions(
                request,
    ...
    async fn _access_policies_set_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _access_policies_test_iam_permissions(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _organizations_gcp_user_access_bindings_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::GcpUserAccessBinding = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .organizations()
            .gcp_user_access_bindings_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _organizations_gcp_user_access_bindings_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .organizations()
            .gcp_user_access_bindings_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _organizations_gcp_user_access_bindings_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .organizations()
            .gcp_user_access_bindings_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _organizations_gcp_user_access_bindings_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .organizations()
            .gcp_user_access_bindings_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _organizations_gcp_user_access_bindings_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .organizations()
            .gcp_user_access_bindings_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _doit(
        ...
        match self.opt.subcommand() {
            ("access-policies", Some(opt)) => match opt.subcommand() {
                ("access-levels-create", Some(opt)) => {
                    call_result = self
                        ._access_policies_access_levels_create(opt, dry_run, &mut err)
                        .await;
                }
                ("access-levels-delete", Some(opt)) => {
                    call_result = self
                        ._access_policies_access_levels_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("access-levels-get", Some(opt)) => {
                    call_result = self
                        ._access_policies_access_levels_get(opt, dry_run, &mut err)
                        .await;
                }
                ("access-levels-list", Some(opt)) => {
                    call_result = self
                        ._access_policies_access_levels_list(opt, dry_run, &mut err)
                        .await;
                }
                ("access-levels-patch", Some(opt)) => {
                    call_result = self
                        ._access_policies_access_levels_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("access-levels-replace-all", Some(opt)) => {
                    call_result = self
                        ._access_policies_access_levels_replace_all(opt, dry_run, &mut err)
                        .await;
                }
                ("access-levels-test-iam-permissions", Some(opt)) => {
                    call_result = self
                        ._access_policies_access_levels_test_iam_permissions(opt, dry_run, &mut err)
                        .await;
                }
                ("authorized-orgs-descs-create", Some(opt)) => {
                    call_result = self
                        ._access_policies_authorized_orgs_descs_create(opt, dry_run, &mut err)
                        .await;
                }
                ("authorized-orgs-descs-delete", Some(opt)) => {
                    call_result = self
                        ._access_policies_authorized_orgs_descs_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("authorized-orgs-descs-get", Some(opt)) => {
                    call_result = self
                        ._access_policies_authorized_orgs_descs_get(opt, dry_run, &mut err)
                        .await;
                }
                ("authorized-orgs-descs-list", Some(opt)) => {
                    call_result = self
                        ._access_policies_authorized_orgs_descs_list(opt, dry_run, &mut err)
                        .await;
                }
                ("authorized-orgs-descs-patch", Some(opt)) => {
                    call_result = self
                        ._access_policies_authorized_orgs_descs_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("create", Some(opt)) => {
                ...
                ("get-iam-policy", Some(opt)) => {
                    call_result = self
                        ._access_policies_get_iam_policy(opt, dry_run, &mut err)
                        .await;
                }
                ("list", Some(opt)) => {
                ...
                ("service-perimeters-commit", Some(opt)) => {
                    call_result = self
                        ._access_policies_service_perimeters_commit(opt, dry_run, &mut err)
                        .await;
                }
                ("service-perimeters-create", Some(opt)) => {
                    call_result = self
                        ._access_policies_service_perimeters_create(opt, dry_run, &mut err)
                        .await;
                }
                ("service-perimeters-delete", Some(opt)) => {
                    call_result = self
                        ._access_policies_service_perimeters_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("service-perimeters-get", Some(opt)) => {
                    call_result = self
                        ._access_policies_service_perimeters_get(opt, dry_run, &mut err)
                        .await;
                }
                ("service-perimeters-list", Some(opt)) => {
                    call_result = self
                        ._access_policies_service_perimeters_list(opt, dry_run, &mut err)
                        .await;
                }
                ("service-perimeters-patch", Some(opt)) => {
                    call_result = self
                        ._access_policies_service_perimeters_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("service-perimeters-replace-all", Some(opt)) => {
                    call_result = self
                        ._access_policies_service_perimeters_replace_all(opt, dry_run, &mut err)
                        .await;
                }
                ("service-perimeters-test-iam-permissions", Some(opt)) => {
                    call_result = self
                        ._access_policies_service_perimeters_test_iam_permissions(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("set-iam-policy", Some(opt)) => {
                    call_result = self
                        ._access_policies_set_iam_policy(opt, dry_run, &mut err)
                        .await;
                }
                ("test-iam-permissions", Some(opt)) => {
                    call_result = self
                        ._access_policies_test_iam_permissions(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("access-policies".to_string()));
            ...
            ("organizations", Some(opt)) => match opt.subcommand() {
                ("gcp-user-access-bindings-create", Some(opt)) => {
                    call_result = self
                        ._organizations_gcp_user_access_bindings_create(opt, dry_run, &mut err)
                        .await;
                }
                ("gcp-user-access-bindings-delete", Some(opt)) => {
                    call_result = self
                        ._organizations_gcp_user_access_bindings_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("gcp-user-access-bindings-get", Some(opt)) => {
                    call_result = self
                        ._organizations_gcp_user_access_bindings_get(opt, dry_run, &mut err)
                        .await;
                }
                ("gcp-user-access-bindings-list", Some(opt)) => {
                    call_result = self
                        ._organizations_gcp_user_access_bindings_list(opt, dry_run, &mut err)
                        .await;
                }
                ("gcp-user-access-bindings-patch", Some(opt)) => {
                    call_result = self
                        ._organizations_gcp_user_access_bindings_patch(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "accesscontextmanager1-secret.json",
...
async fn main() {
    ...
    let arg_data = [
        ("access-policies", "methods: 'access-levels-create', 'access-levels-delete', 'access-levels-get', 'access-levels-list', 'access-levels-patch', 'access-levels-replace-all', 'access-levels-test-iam-permissions', 'authorized-orgs-descs-create', 'authorized-orgs-descs-delete', 'authorized-orgs-descs-get', 'authorized-orgs-descs-list', 'authorized-orgs-descs-patch', 'create', 'delete', 'get', 'get-iam-policy', 'list', 'patch', 'service-perimeters-commit', 'service-perimeters-create', 'service-perimeters-delete', 'service-perimeters-get', 'service-perimeters-list', 'service-perimeters-patch', 'service-perimeters-replace-all', 'service-perimeters-test-iam-permissions', 'set-iam-policy' and 'test-iam-permissions'", vec![
            ("access-levels-create",
                    Some(r##"Creates an access level. The long-running operation from this RPC has a successful status after the access level propagates to long-lasting storage. If access levels contain errors, an error response is returned for the first error encountered."##),
            ...
            ("access-levels-delete",
                    Some(r##"Deletes an access level based on the resource name. The long-running operation from this RPC has a successful status after the access level has been removed from long-lasting storage."##),
            ...
            ("access-levels-get",
                    Some(r##"Gets an access level based on the resource name."##),
            ...
            ("access-levels-list",
                    Some(r##"Lists all access levels for an access policy."##),
            ...
            ("access-levels-patch",
                    Some(r##"Updates an access level. The long-running operation from this RPC has a successful status after the changes to the access level propagate to long-lasting storage. If access levels contain errors, an error response is returned for the first error encountered."##),
                    "Details at http://byron.github.io/google-apis-rs/google_accesscontextmanager1_cli/access-policies_access-levels-patch",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Identifier. Resource name for the `AccessLevel`. Format: `accessPolicies/{access_policy}/accessLevels/{access_level}`. The `access_level` component must begin with a letter, followed by alphanumeric characters or `_`. Its maximum length is 50 characters. After you create an `AccessLevel`, you cannot change its `name`."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("access-levels-replace-all",
                    Some(r##"Replaces all existing access levels in an access policy with the access levels provided. This is done atomically. The long-running operation from this RPC has a successful status after all replacements propagate to long-lasting storage. If the replacement contains errors, an error response is returned for the first error encountered. Upon error, the replacement is cancelled, and existing access levels are not affected. The Operation.response field contains ReplaceAccessLevelsResponse. Removing access levels contained in existing service perimeters result in an error."##),
            ...
            ("access-levels-test-iam-permissions",
                    Some(r##"Returns the IAM permissions that the caller has on the specified Access Context Manager resource. The resource can be an AccessPolicy, AccessLevel, or ServicePerimeter. This method does not support other resources."##),
                    "Details at http://byron.github.io/google-apis-rs/google_accesscontextmanager1_cli/access-policies_access-levels-test-iam-permissions",
                  vec![
                    (Some(r##"resource"##),
                     None,
            ...
            ("authorized-orgs-descs-create",
                  ...
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. Resource name for the access policy which owns this Authorized Orgs Desc. Format: `accessPolicies/{policy_id}`"##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("authorized-orgs-descs-delete",
                  ...
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. Resource name for the Authorized Orgs Desc. Format: `accessPolicies/{policy_id}/authorizedOrgsDesc/{authorized_orgs_desc_id}`"##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("authorized-orgs-descs-get",
                  ...
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. Resource name for the Authorized Orgs Desc. Format: `accessPolicies/{policy_id}/authorizedOrgsDescs/{authorized_orgs_descs_id}`"##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("authorized-orgs-descs-list",
                    Some(r##"Lists all authorized orgs descs for an access policy."##),
                    "Details at http://byron.github.io/google-apis-rs/google_accesscontextmanager1_cli/access-policies_authorized-orgs-descs-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. Resource name for the access policy to list Authorized Orgs Desc from. Format: `accessPolicies/{policy_id}`"##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("create",
                    Some(r##"Creates an access policy. This method fails if the organization already has an access policy. The long-running operation has a successful status after the access policy propagates to long-lasting storage. Syntactic and basic semantic errors are returned in `metadata` as a BadRequest proto."##),
            ...
            ("delete",
                    Some(r##"Deletes an access policy based on the resource name. The long-running operation has a successful status after the access policy is removed from long-lasting storage."##),
            ...
            ("get",
                    Some(r##"Returns an access policy based on the name."##),
            ...
            ("get-iam-policy",
                    Some(r##"Gets the IAM policy for the specified Access Context Manager access policy."##),
                    "Details at http://byron.github.io/google-apis-rs/google_accesscontextmanager1_cli/access-policies_get-iam-policy",
                  vec![
                    (Some(r##"resource"##),
                     None,
            ...
            ("list",
                    Some(r##"Lists all access policies in an organization."##),
            ...
            ("patch",
                    Some(r##"Updates an access policy. The long-running operation from this RPC has a successful status after the changes to the access policy propagate to long-lasting storage."##),
                    "Details at http://byron.github.io/google-apis-rs/google_accesscontextmanager1_cli/access-policies_patch",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Output only. Identifier. Resource name of the `AccessPolicy`. Format: `accessPolicies/{access_policy}`"##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("service-perimeters-commit",
                    Some(r##"Commits the dry-run specification for all the service perimeters in an access policy. A commit operation on a service perimeter involves copying its `spec` field to the `status` field of the service perimeter. Only service perimeters with `use_explicit_dry_run_spec` field set to true are affected by a commit operation. The long-running operation from this RPC has a successful status after the dry-run specifications for all the service perimeters have been committed. If a commit fails, it causes the long-running operation to return an error response and the entire commit operation is cancelled. When successful, the Operation.response field contains CommitServicePerimetersResponse. The `dry_run` and the `spec` fields are cleared after a successful commit operation."##),
            ...
            ("service-perimeters-create",
                    Some(r##"Creates a service perimeter. The long-running operation from this RPC has a successful status after the service perimeter propagates to long-lasting storage. If a service perimeter contains errors, an error response is returned for the first error encountered."##),
            ...
            ("service-perimeters-delete",
                    Some(r##"Deletes a service perimeter based on the resource name. The long-running operation from this RPC has a successful status after the service perimeter is removed from long-lasting storage."##),
            ...
            ("service-perimeters-get",
                    Some(r##"Gets a service perimeter based on the resource name."##),
            ...
            ("service-perimeters-list",
                    Some(r##"Lists all service perimeters for an access policy."##),
            ...
            ("service-perimeters-patch",
                    Some(r##"Updates a service perimeter. The long-running operation from this RPC has a successful status after the service perimeter propagates to long-lasting storage. If a service perimeter contains errors, an error response is returned for the first error encountered."##),
                    "Details at http://byron.github.io/google-apis-rs/google_accesscontextmanager1_cli/access-policies_service-perimeters-patch",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Identifier. Resource name for the `ServicePerimeter`. Format: `accessPolicies/{access_policy}/servicePerimeters/{service_perimeter}`. The `service_perimeter` component must begin with a letter, followed by alphanumeric characters or `_`. After you create a `ServicePerimeter`, you cannot change its `name`."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("service-perimeters-test-iam-permissions",
                    Some(r##"Returns the IAM permissions that the caller has on the specified Access Context Manager resource. The resource can be an AccessPolicy, AccessLevel, or ServicePerimeter. This method does not support other resources."##),
                    "Details at http://byron.github.io/google-apis-rs/google_accesscontextmanager1_cli/access-policies_service-perimeters-test-iam-permissions",
                  vec![
                    (Some(r##"resource"##),
                     None,
                     Some(r##"REQUIRED: The resource for which the policy detail is being requested. See [Resource names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for this field."##),
            ...
            ("set-iam-policy",
                    Some(r##"Sets the IAM policy for the specified Access Context Manager access policy. This method replaces the existing IAM policy on the access policy. The IAM policy controls the set of users who can perform specific operations on the Access Context Manager access policy."##),
                    "Details at http://byron.github.io/google-apis-rs/google_accesscontextmanager1_cli/access-policies_set-iam-policy",
                  vec![
                    (Some(r##"resource"##),
                     None,
            ...
            ("test-iam-permissions",
                    Some(r##"Returns the IAM permissions that the caller has on the specified Access Context Manager resource. The resource can be an AccessPolicy, AccessLevel, or ServicePerimeter. This method does not support other resources."##),
                    "Details at http://byron.github.io/google-apis-rs/google_accesscontextmanager1_cli/access-policies_test-iam-permissions",
                  vec![
                    (Some(r##"resource"##),
                     None,
                     Some(r##"REQUIRED: The resource for which the policy detail is being requested. See [Resource names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for this field."##),
            ...
            ("gcp-user-access-bindings-create",
                    Some(r##"Creates a GcpUserAccessBinding. If the client specifies a name, the server ignores it. Fails if a resource already exists with the same group_key. Completion of this long-running operation does not necessarily signify that the new binding is deployed onto all affected users, which may take more time."##),
