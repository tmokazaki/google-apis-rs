...
/// ```
#[derive(Clone)]
pub struct ManufacturerCenter<C> {
...
impl<C> common::Hub for ManufacturerCenter<C> {}

impl<'a, C> ManufacturerCenter<C> {
    pub fn new<A: 'static + common::GetToken>(
        client: common::Client<C>,
        auth: A,
    ) -> ManufacturerCenter<C> {
        ManufacturerCenter {
            client,
            auth: Box::new(auth),
...
pub struct Attributes {
    ...
    #[serde(rename = "virtualModelLink")]
    pub virtual_model_link: Option<String>,
}

impl common::RequestValue for Attributes {}
...
impl common::Part for DestinationStatus {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [languages product certifications delete accounts](AccountLanguageProductCertificationDeleteCall) (response)
...
impl common::Part for FeatureDescription {}
...
impl common::Part for FloatUnit {}
...
impl common::Part for GoogleShoppingManufacturersV1ProductCertification {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [languages product certifications list accounts](AccountLanguageProductCertificationListCall) (response)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
pub struct ListProductCertificationsResponse {
    ...
    #[serde(rename = "productCertifications")]
    pub product_certifications: Option<Vec<ProductCertification>>,
}

impl common::ResponseResult for ListProductCertificationsResponse {}
...
impl common::Part for Nutrition {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [languages product certifications get accounts](AccountLanguageProductCertificationGetCall) (response)
/// * [languages product certifications patch accounts](AccountLanguageProductCertificationPatchCall) (request|response)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
...
impl common::RequestValue for ProductCertification {}
impl common::ResponseResult for ProductCertification {}
...
impl common::Part for ProductDetail {}
...
impl common::Part for VoluntaryNutritionFact {}
...
/// // like `languages_product_certifications_delete(...)`, `languages_product_certifications_get(...)`, `languages_product_certifications_list(...)`, `languages_product_certifications_patch(...)`, `products_delete(...)`, `products_get(...)`, `products_list(...)` and `products_update(...)`
...
impl<'a, C> AccountMethods<'a, C> {
    ...
    /// # Arguments
    ///
    /// * `name` - Required. The name of the product certification to delete. Format: accounts/{account}/languages/{language_code}/productCertifications/{id}
    pub fn languages_product_certifications_delete(
        &self,
        name: &str,
    ) -> AccountLanguageProductCertificationDeleteCall<'a, C> {
        AccountLanguageProductCertificationDeleteCall {
            hub: self.hub,
    ...
    /// # Arguments
    ///
    /// * `name` - Required. The name of the product certification to get. Format: accounts/{account}/languages/{language_code}/productCertifications/{id}
    pub fn languages_product_certifications_get(
        &self,
        name: &str,
    ) -> AccountLanguageProductCertificationGetCall<'a, C> {
        AccountLanguageProductCertificationGetCall {
            hub: self.hub,
            _name: name.to_string(),
            _delegate: Default::default(),
            _additional_params: Default::default(),
    ...
    /// # Arguments
    ///
    /// * `parent` - Required. The parent, which owns this collection of product certifications. Format: accounts/{account}/languages/{language_code}
    pub fn languages_product_certifications_list(
        &self,
        parent: &str,
    ) -> AccountLanguageProductCertificationListCall<'a, C> {
        AccountLanguageProductCertificationListCall {
            hub: self.hub,
    ...
    pub fn languages_product_certifications_patch(
        &self,
        request: ProductCertification,
        name: &str,
    ) -> AccountLanguageProductCertificationPatchCall<'a, C> {
        AccountLanguageProductCertificationPatchCall {
            hub: self.hub,
            _request: request,
            _name: name.to_string(),
    ...
    pub fn products_delete(&self, parent: &str, name: &str) -> AccountProductDeleteCall<'a, C> {
    ...
    /// * `parent` - Parent ID in the format `accounts/{account_id}`. `account_id` - The ID of the Manufacturer Center account.
    /// * `name` - Name in the format `{target_country}:{content_language}:{product_id}`. `target_country` - The target country of the product as a CLDR territory code (for example, US). `content_language` - The content language of the product as a two-letter ISO 639-1 language code (for example, en). `product_id` - The ID of the product. For more information, see https://support.google.com/manufacturers/answer/6124116#id.
    pub fn products_get(&self, parent: &str, name: &str) -> AccountProductGetCall<'a, C> {
    ...
    ///
    /// * `parent` - Parent ID in the format `accounts/{account_id}`. `account_id` - The ID of the Manufacturer Center account.
    pub fn products_list(&self, parent: &str) -> AccountProductListCall<'a, C> {
...
/// Deletes a product certification by its name. This method can only be called by certification bodies.
///
/// A builder for the *languages.productCertifications.delete* method supported by a *account* resource.
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().languages_product_certifications_delete("name")
///              .doit().await;
/// # }
/// ```
pub struct AccountLanguageProductCertificationDeleteCall<'a, C>
where
    C: 'a,
{
    hub: &'a ManufacturerCenter<C>,
...
impl<'a, C> common::CallBuilder for AccountLanguageProductCertificationDeleteCall<'a, C> {}

impl<'a, C> AccountLanguageProductCertificationDeleteCall<'a, C>
where
    C: common::Connector,
{
    ...
    pub async fn doit(mut self) -> common::Result<(common::Response, Empty)> {
        ...
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::Manufacturercenter.as_ref().to_string());
        }
    ...
    pub fn name(mut self, new_value: &str) -> AccountLanguageProductCertificationDeleteCall<'a, C> {
    ...
    /// for details).
    pub fn clear_scopes(mut self) -> AccountLanguageProductCertificationDeleteCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Gets a product certification by its name. This method can only be called by certification bodies.
///
/// A builder for the *languages.productCertifications.get* method supported by a *account* resource.
/// It is not used directly, but through a [`AccountMethods`] instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().languages_product_certifications_get("name")
///              .doit().await;
/// # }
/// ```
pub struct AccountLanguageProductCertificationGetCall<'a, C>
where
    C: 'a,
{
    hub: &'a ManufacturerCenter<C>,
...
impl<'a, C> common::CallBuilder for AccountLanguageProductCertificationGetCall<'a, C> {}

impl<'a, C> AccountLanguageProductCertificationGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, ProductCertification)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> AccountLanguageProductCertificationGetCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> AccountLanguageProductCertificationGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> AccountLanguageProductCertificationGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Lists product certifications from a specified certification body. This method can only be called by certification bodies.
///
/// A builder for the *languages.productCertifications.list* method supported by a *account* resource.
/// It is not used directly, but through a [`AccountMethods`] instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().languages_product_certifications_list("parent")
///              .page_token("takimata")
///              .page_size(-52)
///              .doit().await;
/// # }
/// ```
pub struct AccountLanguageProductCertificationListCall<'a, C>
where
    C: 'a,
{
    hub: &'a ManufacturerCenter<C>,
...
impl<'a, C> common::CallBuilder for AccountLanguageProductCertificationListCall<'a, C> {}

impl<'a, C> AccountLanguageProductCertificationListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(
        mut self,
    ) -> common::Result<(common::Response, ListProductCertificationsResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
        ...
        params.push("alt", "json");
        let mut url = self.hub._base_url.clone() + "v1/{+parent}/productCertifications";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::Manufacturercenter.as_ref().to_string());
        }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> AccountLanguageProductCertificationListCall<'a, C> {
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> AccountLanguageProductCertificationListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> AccountLanguageProductCertificationListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Updates (or creates if allow_missing = true) a product certification which links certifications with products. This method can only be called by certification bodies.
///
/// A builder for the *languages.productCertifications.patch* method supported by a *account* resource.
/// It is not used directly, but through a [`AccountMethods`] instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_manufacturers1 as manufacturers1;
/// use manufacturers1::api::ProductCertification;
/// # async fn dox() {
/// # use manufacturers1::{ManufacturerCenter, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = ProductCertification::default();
///
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.accounts().languages_product_certifications_patch(req, "name")
///              .update_mask(FieldMask::new::<&str>(&[]))
///              .doit().await;
/// # }
/// ```
pub struct AccountLanguageProductCertificationPatchCall<'a, C>
where
    C: 'a,
{
    hub: &'a ManufacturerCenter<C>,
    _request: ProductCertification,
    _name: String,
...
impl<'a, C> common::CallBuilder for AccountLanguageProductCertificationPatchCall<'a, C> {}

impl<'a, C> AccountLanguageProductCertificationPatchCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    pub fn request(
        mut self,
        new_value: ProductCertification,
    ) -> AccountLanguageProductCertificationPatchCall<'a, C> {
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> AccountLanguageProductCertificationPatchCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> AccountLanguageProductCertificationPatchCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> AccountLanguageProductCertificationPatchCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct AccountProductDeleteCall<'a, C>
where
    C: 'a,
{
    hub: &'a ManufacturerCenter<C>,
...
impl<'a, C> common::CallBuilder for AccountProductDeleteCall<'a, C> {}

impl<'a, C> AccountProductDeleteCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> AccountProductDeleteCall<'a, C> {
        self._parent = new_value.to_string();
        self
    }
    /// Name in the format `{target_country}:{content_language}:{product_id}`. `target_country` - The target country of the product as a CLDR territory code (for example, US). `content_language` - The content language of the product as a two-letter ISO 639-1 language code (for example, en). `product_id` - The ID of the product. For more information, see https://support.google.com/manufacturers/answer/6124116#id.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> AccountProductDeleteCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> AccountProductDeleteCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> AccountProductDeleteCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> AccountProductDeleteCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> AccountProductDeleteCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct AccountProductGetCall<'a, C>
where
    C: 'a,
{
    hub: &'a ManufacturerCenter<C>,
...
impl<'a, C> common::CallBuilder for AccountProductGetCall<'a, C> {}

impl<'a, C> AccountProductGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> AccountProductGetCall<'a, C> {
        self._parent = new_value.to_string();
        self
    }
    /// Name in the format `{target_country}:{content_language}:{product_id}`. `target_country` - The target country of the product as a CLDR territory code (for example, US). `content_language` - The content language of the product as a two-letter ISO 639-1 language code (for example, en). `product_id` - The ID of the product. For more information, see https://support.google.com/manufacturers/answer/6124116#id.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> AccountProductGetCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    ...
    pub fn add_include(mut self, new_value: &str) -> AccountProductGetCall<'a, C> {
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> AccountProductGetCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> AccountProductGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> AccountProductGetCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> AccountProductGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
///              .page_token("ea")
///              .page_size(-55)
///              .add_include("invidunt")
///              .doit().await;
/// # }
/// ```
pub struct AccountProductListCall<'a, C>
where
    C: 'a,
{
    hub: &'a ManufacturerCenter<C>,
...
impl<'a, C> common::CallBuilder for AccountProductListCall<'a, C> {}

impl<'a, C> AccountProductListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> AccountProductListCall<'a, C> {
        self._parent = new_value.to_string();
        self
    }
    ...
    ///
    /// Sets the *page token* query property to the given value.
    pub fn page_token(mut self, new_value: &str) -> AccountProductListCall<'a, C> {
        self._page_token = Some(new_value.to_string());
        self
    }
    ...
    ///
    /// Sets the *page size* query property to the given value.
    pub fn page_size(mut self, new_value: i32) -> AccountProductListCall<'a, C> {
        self._page_size = Some(new_value);
        self
    }
    /// The information to be included in the response. Only sections listed here will be returned.
    ...
    /// Append the given value to the *include* query property.
    /// Each appended value will retain its original ordering and be '/'-separated in the URL's parameters.
    pub fn add_include(mut self, new_value: &str) -> AccountProductListCall<'a, C> {
        self._include.push(new_value.to_string());
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> AccountProductListCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> AccountProductListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> AccountProductListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> AccountProductListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct AccountProductUpdateCall<'a, C>
where
    C: 'a,
{
    hub: &'a ManufacturerCenter<C>,
...
impl<'a, C> common::CallBuilder for AccountProductUpdateCall<'a, C> {}

impl<'a, C> AccountProductUpdateCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: Attributes) -> AccountProductUpdateCall<'a, C> {
        self._request = new_value;
        self
    }
    /// Parent ID in the format `accounts/{account_id}`. `account_id` - The ID of the Manufacturer Center account.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> AccountProductUpdateCall<'a, C> {
        self._parent = new_value.to_string();
        self
    }
    /// Name in the format `{target_country}:{content_language}:{product_id}`. `target_country` - The target country of the product as a CLDR territory code (for example, US). `content_language` - The content language of the product as a two-letter ISO 639-1 language code (for example, en). `product_id` - The ID of the product. For more information, see https://support.google.com/manufacturers/answer/6124116#id.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> AccountProductUpdateCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> AccountProductUpdateCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> AccountProductUpdateCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> AccountProductUpdateCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> AccountProductUpdateCall<'a, C> {
        self._scopes.clear();
        self
    }
}
