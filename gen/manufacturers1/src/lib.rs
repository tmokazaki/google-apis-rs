...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/manufacturers1).
//! # Features
//!
...
pub mod api;
pub use api::ManufacturerCenter;
