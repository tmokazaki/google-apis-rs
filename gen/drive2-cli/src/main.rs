...
use google_drive2::{api, yup_oauth2, Error};
    ...
    C: apis_common::Connector,
{
    async fn _about_get(
            ...
            .iter()
        {
            ...
            match key {
                "start-change-id" => {
                    call = call.start_change_id(
                        value
                            .map(|v| arg_from_str(v, err, "start-change-id", "int64"))
                            .unwrap_or(-0),
                    );
                }
                "max-change-id-count" => {
                    call = call.max_change_id_count(
                        value
                            .map(|v| arg_from_str(v, err, "max-change-id-count", "int64"))
                            .unwrap_or(-0),
                    );
                }
                "include-subscribed" => {
                    call = call.include_subscribed(
                        value
                            .map(|v| arg_from_str(v, err, "include-subscribed", "boolean"))
                            .unwrap_or(false),
                    );
                }
                _ => {
    ...
    async fn _changes_get(
        ...
        let mut call = self
            .hub
            .changes()
            .get(opt.value_of("change-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            .iter()
        {
            ...
            match key {
                ...
                "supports-team-drives" => {
                    call = call.supports_team_drives(
                        value
                            .map(|v| arg_from_str(v, err, "supports-team-drives", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "supports-all-drives" => {
                    call = call.supports_all_drives(
                        value
                            .map(|v| arg_from_str(v, err, "supports-all-drives", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "drive-id" => {
    ...
    async fn _changes_get_start_page_token(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            match key {
                ...
                "include-team-drive-items" => {
                    call = call.include_team_drive_items(
                        value
                            .map(|v| arg_from_str(v, err, "include-team-drive-items", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "include-subscribed" => {
                ...
                "include-items-from-all-drives" => {
                    call = call.include_items_from_all_drives(
                        value
                            .map(|v| {
                                arg_from_str(v, err, "include-items-from-all-drives", "boolean")
                            })
                            .unwrap_or(false),
                    );
                }
                ...
                "include-corpus-removals" => {
                    call = call.include_corpus_removals(
                        value
                            .map(|v| arg_from_str(v, err, "include-corpus-removals", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "drive-id" => {
    ...
    async fn _children_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.children().delete(
            opt.value_of("folder-id").unwrap_or(""),
            opt.value_of("child-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            ...
            .iter()
        {
            ...
            match key {
                "enforce-single-parent" => {
                    call = call.enforce_single_parent(
                        value
                            .map(|v| arg_from_str(v, err, "enforce-single-parent", "boolean"))
                            .unwrap_or(false),
                    );
                }
                _ => {
    ...
    async fn _children_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.children().get(
            opt.value_of("folder-id").unwrap_or(""),
            opt.value_of("child-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _children_insert(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec!["child-link", "id", "kind", "self-link"],
                    );
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
        ...
        let mut request: api::ChildReference = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .children()
            .insert(request, opt.value_of("folder-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _children_list(
        ...
        let mut call = self
            .hub
            .children()
            .list(opt.value_of("folder-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["max-results", "order-by", "page-token", "q"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _comments_delete(
        ...
        let mut call = self.hub.comments().delete(
            opt.value_of("file-id").unwrap_or(""),
            opt.value_of("comment-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _comments_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.comments().get(
            opt.value_of("file-id").unwrap_or(""),
            opt.value_of("comment-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _comments_insert(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "author.is-authenticated-user" => Some((
        ...
        let mut call = self
            .hub
            .comments()
            .insert(request, opt.value_of("file-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _comments_list(
        ...
        let mut call = self
            .hub
            .comments()
            .list(opt.value_of("file-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _comments_patch(
        ...
        let mut request: api::Comment = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.comments().patch(
            request,
            opt.value_of("file-id").unwrap_or(""),
            opt.value_of("comment-id").unwrap_or(""),
        );
    ...
    async fn _comments_update(
        ...
        let mut request: api::Comment = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.comments().update(
            request,
            opt.value_of("file-id").unwrap_or(""),
            opt.value_of("comment-id").unwrap_or(""),
        );
    ...
    async fn _drives_delete(
        ...
        let mut call = self
            .hub
            .drives()
            .delete(opt.value_of("drive-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            .iter()
        {
            ...
            match key {
                "use-domain-admin-access" => {
                    call = call.use_domain_admin_access(
                        value
                            .map(|v| arg_from_str(v, err, "use-domain-admin-access", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "allow-item-deletion" => {
                    call = call.allow_item_deletion(
                        value
                            .map(|v| arg_from_str(v, err, "allow-item-deletion", "boolean"))
                            .unwrap_or(false),
                    );
                }
                _ => {
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["allow-item-deletion", "use-domain-admin-access"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _drives_get(
        ...
        let mut call = self
            .hub
            .drives()
            .get(opt.value_of("drive-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _drives_hide(
        ...
        let mut call = self
            .hub
            .drives()
            .hide(opt.value_of("drive-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _drives_insert(
        ...
        let mut request: api::Drive = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .drives()
            .insert(request, opt.value_of("request-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["max-results", "page-token", "q", "use-domain-admin-access"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _drives_unhide(
        ...
        let mut call = self
            .hub
            .drives()
            .unhide(opt.value_of("drive-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _drives_update(
        ...
        let mut call = self
            .hub
            .drives()
            .update(request, opt.value_of("drive-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _files_copy(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "capabilities.can-accept-ownership" => Some((
                ...
                "capabilities.can-add-children" => Some((
                ...
                "capabilities.can-add-folder-from-another-drive" => Some((
                ...
                "capabilities.can-add-my-drive-parent" => Some((
                ...
                "capabilities.can-change-copy-requires-writer-permission" => Some((
                ...
                "capabilities.can-change-restricted-download" => Some((
                ...
                "capabilities.can-change-security-update-enabled" => Some((
                ...
                "capabilities.can-delete-children" => Some((
                ...
                "capabilities.can-list-children" => Some((
                ...
                "capabilities.can-modify-content" => Some((
                ...
                "capabilities.can-modify-content-restriction" => Some((
                ...
                "capabilities.can-modify-editor-content-restriction" => Some((
                ...
                "capabilities.can-modify-labels" => Some((
                ...
                "capabilities.can-modify-owner-content-restriction" => Some((
                ...
                "capabilities.can-move-children-out-of-drive" => Some((
                ...
                "capabilities.can-move-children-out-of-team-drive" => Some((
                ...
                "capabilities.can-move-children-within-drive" => Some((
                ...
                "capabilities.can-move-children-within-team-drive" => Some((
                ...
                "capabilities.can-move-item-into-team-drive" => Some((
                ...
                "capabilities.can-move-item-out-of-drive" => Some((
                ...
                "capabilities.can-move-item-out-of-team-drive" => Some((
                ...
                "capabilities.can-move-item-within-drive" => Some((
                ...
                "capabilities.can-move-item-within-team-drive" => Some((
                ...
                "capabilities.can-move-team-drive-item" => Some((
                ...
                "capabilities.can-read-drive" => Some((
                ...
                "capabilities.can-read-labels" => Some((
                ...
                "capabilities.can-read-revisions" => Some((
                ...
                "capabilities.can-read-team-drive" => Some((
                ...
                "capabilities.can-remove-children" => Some((
                ...
                "capabilities.can-remove-content-restriction" => Some((
                ...
                "capabilities.can-remove-my-drive-parent" => Some((
                ...
                "capabilities.can-trash-children" => Some((
                ...
                "copy-requires-writer-permission" => Some((
                ...
                "has-augmented-permissions" => Some((
                ...
                "image-media-metadata.aperture" => Some((
                ...
                "image-media-metadata.camera-make" => Some((
                ...
                "image-media-metadata.camera-model" => Some((
                ...
                "image-media-metadata.color-space" => Some((
                ...
                "image-media-metadata.date" => Some((
                ...
                "image-media-metadata.exposure-bias" => Some((
                ...
                "image-media-metadata.exposure-mode" => Some((
                ...
                "image-media-metadata.exposure-time" => Some((
                ...
                "image-media-metadata.flash-used" => Some((
                ...
                "image-media-metadata.focal-length" => Some((
                ...
                "image-media-metadata.height" => Some((
                ...
                "image-media-metadata.iso-speed" => Some((
                ...
                "image-media-metadata.lens" => Some((
                ...
                "image-media-metadata.location.altitude" => Some((
                ...
                "image-media-metadata.location.latitude" => Some((
                ...
                "image-media-metadata.location.longitude" => Some((
                ...
                "image-media-metadata.max-aperture-value" => Some((
                ...
                "image-media-metadata.metering-mode" => Some((
                ...
                "image-media-metadata.rotation" => Some((
                ...
                "image-media-metadata.sensor" => Some((
                ...
                "image-media-metadata.subject-distance" => Some((
                ...
                "image-media-metadata.white-balance" => Some((
                ...
                "image-media-metadata.width" => Some((
                ...
                "last-modifying-user.display-name" => Some((
                ...
                "last-modifying-user.email-address" => Some((
                ...
                "last-modifying-user.is-authenticated-user" => Some((
                ...
                "last-modifying-user.permission-id" => Some((
                ...
                "last-modifying-user.picture.url" => Some((
                ...
                "link-share-metadata.security-update-eligible" => Some((
                ...
                "link-share-metadata.security-update-enabled" => Some((
                ...
                "sharing-user.display-name" => Some((
                ...
                "sharing-user.email-address" => Some((
                ...
                "sharing-user.is-authenticated-user" => Some((
                ...
                "sharing-user.permission-id" => Some((
                ...
                "shortcut-details.target-id" => Some((
                ...
                "shortcut-details.target-mime-type" => Some((
                ...
                "shortcut-details.target-resource-key" => Some((
                ...
                "trashing-user.display-name" => Some((
                ...
                "trashing-user.email-address" => Some((
                ...
                "trashing-user.is-authenticated-user" => Some((
                ...
                "trashing-user.permission-id" => Some((
                ...
                "trashing-user.picture.url" => Some((
                ...
                "user-permission.additional-roles" => Some((
                ...
                "user-permission.email-address" => Some((
                ...
                "user-permission.expiration-date" => Some((
                ...
                "user-permission.pending-owner" => Some((
                    "userPermission.pendingOwner",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "user-permission.photo-link" => Some((
                ...
                "user-permission.self-link" => Some((
                ...
                "user-permission.with-link" => Some((
                ...
                "video-media-metadata.duration-millis" => Some((
                ...
                "video-media-metadata.height" => Some((
                ...
                "video-media-metadata.width" => Some((
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        ...
                        &vec![
                            ...
                            "can-change-restricted-download",
        ...
        let mut request: api::File = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .files()
            .copy(request, opt.value_of("file-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            .iter()
        {
            ...
            match key {
                ...
                "pinned" => {
                    call = call.pinned(
                        value
                            .map(|v| arg_from_str(v, err, "pinned", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "ocr-language" => {
                ...
                "ocr" => {
                    call = call.ocr(
                        value
                            .map(|v| arg_from_str(v, err, "ocr", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "include-permissions-for-view" => {
                ...
                "convert" => {
                    call = call.convert(
                        value
                            .map(|v| arg_from_str(v, err, "convert", "boolean"))
                            .unwrap_or(false),
                    );
                }
                _ => {
    ...
    async fn _files_delete(
        ...
        let mut call = self
            .hub
            .files()
            .delete(opt.value_of("file-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _files_export(
        ...
        let mut call = self.hub.files().export(
            opt.value_of("file-id").unwrap_or(""),
            opt.value_of("mime-type").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _files_get(
            ...
            .iter()
        {
            ...
            match key {
                "update-viewed-date" => {
                    call = call.update_viewed_date(
                        value
                            .map(|v| arg_from_str(v, err, "update-viewed-date", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "supports-team-drives" => {
                ...
                "acknowledge-abuse" => {
                    call = call.acknowledge_abuse(
                        value
                            .map(|v| arg_from_str(v, err, "acknowledge-abuse", "boolean"))
                            .unwrap_or(false),
                    );
                }
                _ => {
            ...
            .iter()
        {
            ...
            match key {
                ...
                "use-content-as-indexable-text" => {
                    call = call.use_content_as_indexable_text(
                        value
                            .map(|v| {
                                arg_from_str(v, err, "use-content-as-indexable-text", "boolean")
                            })
                            .unwrap_or(false),
                    );
                }
    ...
    async fn _files_list_labels(
        ...
        let mut call = self
            .hub
            .files()
            .list_labels(opt.value_of("file-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _files_modify_labels(
        ...
        let mut request: api::ModifyLabelsRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .files()
            .modify_labels(request, opt.value_of("file-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _files_patch(
        ...
        let mut call = self
            .hub
            .files()
            .patch(request, opt.value_of("file-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            .iter()
        {
            ...
            match key {
                ...
                "set-modified-date" => {
                    call = call.set_modified_date(
                        value
                            .map(|v| arg_from_str(v, err, "set-modified-date", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "remove-parents" => {
                ...
                "new-revision" => {
                    call = call.new_revision(
                        value
                            .map(|v| arg_from_str(v, err, "new-revision", "boolean"))
                            .unwrap_or(false),
                    );
                }
    ...
    async fn _files_touch(
        ...
        let mut call = self
            .hub
            .files()
            .touch(opt.value_of("file-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _files_trash(
        ...
        let mut call = self
            .hub
            .files()
            .trash(opt.value_of("file-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _files_untrash(
        ...
        let mut call = self
            .hub
            .files()
            .untrash(opt.value_of("file-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _files_update(
        ...
        let mut call = self
            .hub
            .files()
            .update(request, opt.value_of("file-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _files_watch(
        ...
        let mut call = self
            .hub
            .files()
            .watch(request, opt.value_of("file-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _parents_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.parents().delete(
            opt.value_of("file-id").unwrap_or(""),
            opt.value_of("parent-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _parents_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.parents().get(
            opt.value_of("file-id").unwrap_or(""),
            opt.value_of("parent-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _parents_insert(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec!["id", "is-root", "kind", "parent-link", "self-link"],
                    );
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
        ...
        let mut request: api::ParentReference = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .parents()
            .insert(request, opt.value_of("file-id").unwrap_or(""));
    ...
    async fn _permissions_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.permissions().delete(
            opt.value_of("file-id").unwrap_or(""),
            opt.value_of("permission-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _permissions_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.permissions().get(
            opt.value_of("file-id").unwrap_or(""),
            opt.value_of("permission-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _permissions_get_id_for_email(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .permissions()
            .get_id_for_email(opt.value_of("email").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _permissions_insert(
        ...
        let mut request: api::Permission = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .permissions()
            .insert(request, opt.value_of("file-id").unwrap_or(""));
            ...
            .iter()
        {
            ...
            match key {
                ...
                "send-notification-emails" => {
                    call = call.send_notification_emails(
                        value
                            .map(|v| arg_from_str(v, err, "send-notification-emails", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "move-to-new-owners-root" => {
                    call = call.move_to_new_owners_root(
                        value
                            .map(|v| arg_from_str(v, err, "move-to-new-owners-root", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "enforce-single-parent" => {
    ...
    async fn _permissions_patch(
        ...
        let mut request: api::Permission = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.permissions().patch(
            request,
            opt.value_of("file-id").unwrap_or(""),
            opt.value_of("permission-id").unwrap_or(""),
        );
            ...
            .iter()
        {
            ...
            match key {
                ...
                "transfer-ownership" => {
                    call = call.transfer_ownership(
                        value
                            .map(|v| arg_from_str(v, err, "transfer-ownership", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "supports-team-drives" => {
                ...
                "remove-expiration" => {
                    call = call.remove_expiration(
                        value
                            .map(|v| arg_from_str(v, err, "remove-expiration", "boolean"))
                            .unwrap_or(false),
                    );
                }
                _ => {
    ...
    async fn _permissions_update(
        ...
        let mut request: api::Permission = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.permissions().update(
            request,
            opt.value_of("file-id").unwrap_or(""),
            opt.value_of("permission-id").unwrap_or(""),
        );
    ...
    async fn _properties_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.properties().delete(
            opt.value_of("file-id").unwrap_or(""),
            opt.value_of("property-key").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _properties_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.properties().get(
            opt.value_of("file-id").unwrap_or(""),
            opt.value_of("property-key").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _properties_insert(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec!["etag", "key", "kind", "self-link", "value", "visibility"],
                    );
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
        ...
        let mut request: api::Property = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .properties()
            .insert(request, opt.value_of("file-id").unwrap_or(""));
    ...
    async fn _properties_patch(
        ...
        let mut request: api::Property = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.properties().patch(
            request,
            opt.value_of("file-id").unwrap_or(""),
            opt.value_of("property-key").unwrap_or(""),
        );
    ...
    async fn _properties_update(
        ...
        let mut request: api::Property = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.properties().update(
            request,
            opt.value_of("file-id").unwrap_or(""),
            opt.value_of("property-key").unwrap_or(""),
        );
    ...
    async fn _replies_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.replies().delete(
            opt.value_of("file-id").unwrap_or(""),
            opt.value_of("comment-id").unwrap_or(""),
            opt.value_of("reply-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _replies_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.replies().get(
            opt.value_of("file-id").unwrap_or(""),
            opt.value_of("comment-id").unwrap_or(""),
            opt.value_of("reply-id").unwrap_or(""),
        );
    ...
    async fn _replies_insert(
        ...
        let mut request: api::CommentReply = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.replies().insert(
            request,
            opt.value_of("file-id").unwrap_or(""),
            opt.value_of("comment-id").unwrap_or(""),
        );
    ...
    async fn _replies_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.replies().list(
            opt.value_of("file-id").unwrap_or(""),
            opt.value_of("comment-id").unwrap_or(""),
        );
        for parg in opt
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["include-deleted", "max-results", "page-token"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _replies_patch(
        ...
        let mut request: api::CommentReply = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.replies().patch(
            request,
            opt.value_of("file-id").unwrap_or(""),
            opt.value_of("comment-id").unwrap_or(""),
            opt.value_of("reply-id").unwrap_or(""),
    ...
    async fn _replies_update(
        ...
        let mut request: api::CommentReply = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.replies().update(
            request,
            opt.value_of("file-id").unwrap_or(""),
            opt.value_of("comment-id").unwrap_or(""),
            opt.value_of("reply-id").unwrap_or(""),
    ...
    async fn _revisions_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.revisions().delete(
            opt.value_of("file-id").unwrap_or(""),
            opt.value_of("revision-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _revisions_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.revisions().get(
            opt.value_of("file-id").unwrap_or(""),
            opt.value_of("revision-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _revisions_patch(
        ...
        let mut request: api::Revision = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.revisions().patch(
            request,
            opt.value_of("file-id").unwrap_or(""),
            opt.value_of("revision-id").unwrap_or(""),
        );
    ...
    async fn _revisions_update(
        ...
        let mut request: api::Revision = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.revisions().update(
            request,
            opt.value_of("file-id").unwrap_or(""),
            opt.value_of("revision-id").unwrap_or(""),
        );
    ...
    async fn _teamdrives_delete(
        ...
        let mut call = self
            .hub
            .teamdrives()
            .delete(opt.value_of("team-drive-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _teamdrives_get(
        ...
        let mut call = self
            .hub
            .teamdrives()
            .get(opt.value_of("team-drive-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _teamdrives_insert(
        ...
        let mut request: api::TeamDrive = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .teamdrives()
            .insert(request, opt.value_of("request-id").unwrap_or(""));
    ...
    async fn _teamdrives_update(
        ...
        let mut call = self
            .hub
            .teamdrives()
            .update(request, opt.value_of("team-drive-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _doit(
        ...
        match self.opt.subcommand() {
            ("about", Some(opt)) => match opt.subcommand() {
                ("get", Some(opt)) => {
                    call_result = self._about_get(opt, dry_run, &mut err).await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("about".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("apps", Some(opt)) => match opt.subcommand() {
                ("get", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("apps".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("changes", Some(opt)) => match opt.subcommand() {
                ("get", Some(opt)) => {
                    call_result = self._changes_get(opt, dry_run, &mut err).await;
                }
                ("get-start-page-token", Some(opt)) => {
                    call_result = self
                        ._changes_get_start_page_token(opt, dry_run, &mut err)
                        .await;
                }
                ("list", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("changes".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ...
            ("children", Some(opt)) => match opt.subcommand() {
                ("delete", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("children".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ...
            ("drives", Some(opt)) => match opt.subcommand() {
                ("delete", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("drives".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("files", Some(opt)) => match opt.subcommand() {
                ("copy", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("files".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("parents", Some(opt)) => match opt.subcommand() {
                ("delete", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("parents".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("permissions", Some(opt)) => match opt.subcommand() {
                ("delete", Some(opt)) => {
                ...
                ("get-id-for-email", Some(opt)) => {
                    call_result = self
                        ._permissions_get_id_for_email(opt, dry_run, &mut err)
                        .await;
                }
                ("insert", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("permissions".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ...
            ("replies", Some(opt)) => match opt.subcommand() {
                ("delete", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("replies".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("revisions", Some(opt)) => match opt.subcommand() {
                ("delete", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("revisions".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("teamdrives", Some(opt)) => match opt.subcommand() {
                ("delete", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("teamdrives".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            _ => {
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "drive2-secret.json",
