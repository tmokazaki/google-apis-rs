...
use google_tpu1::{api, yup_oauth2, Error};
...
{
    async fn _projects_locations_accelerator_types_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_accelerator_types_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_accelerator_types_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_accelerator_types_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_nodes_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "scheduling-config.preemptible" => Some((
                ...
                "scheduling-config.reserved" => Some((
        ...
        let mut request: api::Node = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_nodes_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_nodes_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_nodes_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_nodes_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_nodes_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_nodes_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_nodes_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_nodes_reimage(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::ReimageNodeRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_nodes_reimage(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_nodes_start(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::StartNodeRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_nodes_start(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_nodes_stop(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::StopNodeRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_nodes_stop(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_tensorflow_versions_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_tensorflow_versions_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_tensorflow_versions_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_tensorflow_versions_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
        ...
        match self.opt.subcommand() {
            ("projects", Some(opt)) => match opt.subcommand() {
                ("locations-accelerator-types-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_accelerator_types_get(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-accelerator-types-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_accelerator_types_list(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("locations-nodes-create", Some(opt)) => {
                    call_result = self
                        ._projects_locations_nodes_create(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-nodes-delete", Some(opt)) => {
                    call_result = self
                        ._projects_locations_nodes_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-nodes-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_nodes_get(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-nodes-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_nodes_list(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-nodes-reimage", Some(opt)) => {
                    call_result = self
                        ._projects_locations_nodes_reimage(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-nodes-start", Some(opt)) => {
                    call_result = self
                        ._projects_locations_nodes_start(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-nodes-stop", Some(opt)) => {
                    call_result = self
                        ._projects_locations_nodes_stop(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("locations-tensorflow-versions-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_tensorflow_versions_get(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-tensorflow-versions-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_tensorflow_versions_list(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "tpu1-secret.json",
        ...
        .persist_tokens_to_disk(format!("{}/tpu1", config_dir))
        .build()
        .await
        .unwrap();
    ...
    let arg_data = [
        ("projects", "methods: 'locations-accelerator-types-get', 'locations-accelerator-types-list', 'locations-get', 'locations-list', 'locations-nodes-create', 'locations-nodes-delete', 'locations-nodes-get', 'locations-nodes-list', 'locations-nodes-reimage', 'locations-nodes-start', 'locations-nodes-stop', 'locations-operations-cancel', 'locations-operations-delete', 'locations-operations-get', 'locations-operations-list', 'locations-tensorflow-versions-get' and 'locations-tensorflow-versions-list'", vec![
            ("locations-accelerator-types-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_tpu1_cli/projects_locations-accelerator-types-get",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The resource name."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("locations-accelerator-types-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_tpu1_cli/projects_locations-accelerator-types-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("locations-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_tpu1_cli/projects_locations-get",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_tpu1_cli/projects_locations-list",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-nodes-create",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_tpu1_cli/projects_locations-nodes-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The parent resource name."##),
            ...
            ("locations-nodes-delete",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_tpu1_cli/projects_locations-nodes-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The resource name."##),
            ...
            ("locations-nodes-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_tpu1_cli/projects_locations-nodes-get",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The resource name."##),
            ...
            ("locations-nodes-list",
                    Some(r##"Lists nodes."##),
                    "Details at http://byron.github.io/google-apis-rs/google_tpu1_cli/projects_locations-nodes-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The parent resource name."##),
            ...
            ("locations-nodes-reimage",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_tpu1_cli/projects_locations-nodes-reimage",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-nodes-start",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_tpu1_cli/projects_locations-nodes-start",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"The resource name."##),
            ...
            ("locations-nodes-stop",
                    Some(r##"Stops a node, this operation is only available with single TPU nodes."##),
                    "Details at http://byron.github.io/google-apis-rs/google_tpu1_cli/projects_locations-nodes-stop",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"The resource name."##),
            ...
            ("locations-operations-cancel",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_tpu1_cli/projects_locations-operations-cancel",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-operations-delete",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_tpu1_cli/projects_locations-operations-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-operations-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_tpu1_cli/projects_locations-operations-get",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-operations-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_tpu1_cli/projects_locations-operations-list",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-tensorflow-versions-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_tpu1_cli/projects_locations-tensorflow-versions-get",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The resource name."##),
            ...
            ("locations-tensorflow-versions-list",
                    Some(r##"List TensorFlow versions supported by this API."##),
                    "Details at http://byron.github.io/google-apis-rs/google_tpu1_cli/projects_locations-tensorflow-versions-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The parent resource name."##),
