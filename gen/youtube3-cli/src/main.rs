...
use google_youtube3::{api, yup_oauth2, Error};
...
{
    async fn _abuse_reports_insert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec!["description", "id", "subject", "type-id", "url"],
                    );
        ...
        let mut request: api::AbuseReport = serde_json::value::from_value(object).unwrap();
    ...
    async fn _activities_list(
            ...
            .iter()
        {
            ...
            match key {
                ...
                "published-before" => {
                    call = call.published_before(
                        value
                            .map(|v| arg_from_str(v, err, "published-before", "google-datetime"))
                            .unwrap_or(chrono::Utc::now()),
                    );
                }
                "published-after" => {
                    call = call.published_after(
                        value
                            .map(|v| arg_from_str(v, err, "published-after", "google-datetime"))
                            .unwrap_or(chrono::Utc::now()),
                    );
                }
                "page-token" => {
                ...
                "mine" => {
                    call = call.mine(
                        value
                            .map(|v| arg_from_str(v, err, "mine", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "max-results" => {
                ...
                "home" => {
                    call = call.home(
                        value
                            .map(|v| arg_from_str(v, err, "home", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "channel-id" => {
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["on-behalf-of", "on-behalf-of-content-owner"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _captions_download(
        ...
        let mut call = self
            .hub
            .captions()
            .download(opt.value_of("id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _captions_insert(
        ...
        let mut request: api::Caption = serde_json::value::from_value(object).unwrap();
            ...
            .iter()
        {
            ...
            match key {
                "sync" => {
                    call = call.sync(
                        value
                            .map(|v| arg_from_str(v, err, "sync", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "on-behalf-of-content-owner" => {
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["on-behalf-of", "on-behalf-of-content-owner", "sync"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _captions_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.captions().list(
            &opt.values_of("part")
                .map(|i| i.collect())
                .unwrap_or(Vec::new())
                .iter()
                .map(|&v| v.to_string())
                .collect::<Vec<String>>(),
            opt.value_of("video-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["id", "on-behalf-of", "on-behalf-of-content-owner"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _channel_banners_insert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::ChannelBannerResource =
    ...
    async fn _channel_sections_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _channel_sections_insert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "content-details.playlists" => Some((
        ...
        let mut request: api::ChannelSection = serde_json::value::from_value(object).unwrap();
    ...
    async fn _channel_sections_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.channel_sections().list(
            &opt.values_of("part")
                .map(|i| i.collect())
                .unwrap_or(Vec::new())
                .iter()
    ...
    async fn _channel_sections_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _channels_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.channels().list(
            &opt.values_of("part")
                .map(|i| i.collect())
                .unwrap_or(Vec::new())
                .iter()
            ...
            .iter()
        {
            ...
            match key {
                ...
                "my-subscribers" => {
                    call = call.my_subscribers(
                        value
                            .map(|v| arg_from_str(v, err, "my-subscribers", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "mine" => {
                ...
                "managed-by-me" => {
                    call = call.managed_by_me(
                        value
                            .map(|v| arg_from_str(v, err, "managed-by-me", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "id" => {
    ...
    async fn _comment_threads_insert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "snippet.top-level-comment.id" => Some((
                ...
                "snippet.top-level-comment.kind" => Some((
                ...
                "snippet.top-level-comment.snippet.author-channel-id.value" => Some((
                ...
                "snippet.top-level-comment.snippet.author-channel-url" => Some((
                ...
                "snippet.top-level-comment.snippet.author-display-name" => Some((
                ...
                "snippet.top-level-comment.snippet.author-profile-image-url" => Some((
                ...
                "snippet.top-level-comment.snippet.can-rate" => Some((
                ...
                "snippet.top-level-comment.snippet.channel-id" => Some((
                ...
                "snippet.top-level-comment.snippet.like-count" => Some((
                ...
                "snippet.top-level-comment.snippet.moderation-status" => Some((
                ...
                "snippet.top-level-comment.snippet.parent-id" => Some((
                ...
                "snippet.top-level-comment.snippet.text-display" => Some((
                ...
                "snippet.top-level-comment.snippet.text-original" => Some((
                ...
                "snippet.top-level-comment.snippet.updated-at" => Some((
                ...
                "snippet.top-level-comment.snippet.video-id" => Some((
                ...
                "snippet.top-level-comment.snippet.viewer-rating" => Some((
                ...
                "snippet.total-reply-count" => Some((
        ...
        let mut request: api::CommentThread = serde_json::value::from_value(object).unwrap();
    ...
    async fn _comment_threads_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.comment_threads().list(
            &opt.values_of("part")
                .map(|i| i.collect())
                .unwrap_or(Vec::new())
                .iter()
    ...
    async fn _comments_insert(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "snippet.author-channel-id.value" => Some((
                ...
                "snippet.author-channel-url" => Some((
                ...
                "snippet.author-display-name" => Some((
                ...
                "snippet.author-profile-image-url" => Some((
                ...
                "snippet.moderation-status" => Some((
        ...
        let mut request: api::Comment = serde_json::value::from_value(object).unwrap();
    ...
    async fn _comments_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.comments().list(
            &opt.values_of("part")
                .map(|i| i.collect())
                .unwrap_or(Vec::new())
                .iter()
    ...
    async fn _comments_mark_as_spam(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.comments().mark_as_spam(
            &opt.values_of("id")
                .map(|i| i.collect())
                .unwrap_or(Vec::new())
                .iter()
    ...
    async fn _comments_set_moderation_status(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.comments().set_moderation_status(
            &opt.values_of("id")
                .map(|i| i.collect())
                .unwrap_or(Vec::new())
                .iter()
                .map(|&v| v.to_string())
                .collect::<Vec<String>>(),
            opt.value_of("moderation-status").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            ...
            .iter()
        {
            ...
            match key {
                "ban-author" => {
                    call = call.ban_author(
                        value
                            .map(|v| arg_from_str(v, err, "ban-author", "boolean"))
                            .unwrap_or(false),
                    );
                }
                _ => {
    ...
    async fn _i18n_languages_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.i18n_languages().list(
            &opt.values_of("part")
                .map(|i| i.collect())
                .unwrap_or(Vec::new())
                .iter()
    ...
    async fn _i18n_regions_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.i18n_regions().list(
            &opt.values_of("part")
                .map(|i| i.collect())
                .unwrap_or(Vec::new())
                .iter()
    ...
    async fn _live_broadcasts_bind(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.live_broadcasts().bind(
    ...
    async fn _live_broadcasts_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _live_broadcasts_insert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                "content-details.bound-stream-id" => Some((
                ...
                "content-details.bound-stream-last-update-time-ms" => Some((
                ...
                "content-details.closed-captions-type" => Some((
                ...
                "content-details.enable-auto-start" => Some((
                ...
                "content-details.enable-auto-stop" => Some((
                ...
                "content-details.enable-closed-captions" => Some((
                ...
                "content-details.enable-content-encryption" => Some((
                ...
                "content-details.enable-dvr" => Some((
                ...
                "content-details.enable-embed" => Some((
                ...
                "content-details.enable-low-latency" => Some((
                ...
                "content-details.latency-preference" => Some((
                ...
                "content-details.monitor-stream.broadcast-stream-delay-ms" => Some((
                ...
                "content-details.monitor-stream.embed-html" => Some((
                ...
                "content-details.monitor-stream.enable-monitor-stream" => Some((
                ...
                "content-details.projection" => Some((
                ...
                "content-details.record-from-start" => Some((
                ...
                "content-details.start-with-slate" => Some((
                ...
                "content-details.stereo-layout" => Some((
                    "contentDetails.stereoLayout",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                ...
                "monetization-details.cuepoint-schedule.enabled" => Some((
                ...
                "monetization-details.cuepoint-schedule.pause-ads-until" => Some((
                ...
                "monetization-details.cuepoint-schedule.repeat-interval-secs" => Some((
                ...
                "monetization-details.cuepoint-schedule.schedule-strategy" => Some((
                ...
                "snippet.actual-start-time" => Some((
                ...
                "snippet.is-default-broadcast" => Some((
                ...
                "snippet.scheduled-end-time" => Some((
                ...
                "snippet.scheduled-start-time" => Some((
                ...
                "snippet.thumbnails.default.height" => Some((
                ...
                "snippet.thumbnails.default.url" => Some((
                ...
                "snippet.thumbnails.default.width" => Some((
                ...
                "snippet.thumbnails.high.height" => Some((
                ...
                "snippet.thumbnails.high.url" => Some((
                ...
                "snippet.thumbnails.high.width" => Some((
                ...
                "snippet.thumbnails.maxres.height" => Some((
                ...
                "snippet.thumbnails.maxres.url" => Some((
                ...
                "snippet.thumbnails.maxres.width" => Some((
                ...
                "snippet.thumbnails.medium.height" => Some((
                ...
                "snippet.thumbnails.medium.url" => Some((
                ...
                "snippet.thumbnails.medium.width" => Some((
                ...
                "snippet.thumbnails.standard.height" => Some((
                ...
                "snippet.thumbnails.standard.url" => Some((
                ...
                "snippet.thumbnails.standard.width" => Some((
                ...
                "statistics.concurrent-viewers" => Some((
                ...
                "status.live-broadcast-priority" => Some((
                    "status.liveBroadcastPriority",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "status.made-for-kids" => Some((
                    "status.madeForKids",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                ...
                "status.self-declared-made-for-kids" => Some((
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        ...
                        &vec![
                            ...
                            "actual-start-time",
                            "bound-stream-id",
                            "bound-stream-last-update-time-ms",
                            "broadcast-stream-delay-ms",
                            "channel-id",
                            ...
                            "enable-embed",
                            "enable-low-latency",
                            "enable-monitor-stream",
                            "enabled",
                            "etag",
                            "height",
                            "high",
                            "id",
                            "is-default-broadcast",
                            "kind",
                            "latency-preference",
                            "life-cycle-status",
                            "live-broadcast-priority",
                            "live-chat-id",
                            "made-for-kids",
                            "maxres",
                            "medium",
        ...
        let mut request: api::LiveBroadcast = serde_json::value::from_value(object).unwrap();
    ...
    async fn _live_broadcasts_insert_cuepoint(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::Cuepoint = serde_json::value::from_value(object).unwrap();
    ...
    async fn _live_broadcasts_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.live_broadcasts().list(
            &opt.values_of("part")
                .map(|i| i.collect())
                .unwrap_or(Vec::new())
                .iter()
    ...
    async fn _live_broadcasts_transition(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.live_broadcasts().transition(
            opt.value_of("broadcast-status").unwrap_or(""),
            opt.value_of("id").unwrap_or(""),
            &opt.values_of("part")
                .map(|i| i.collect())
                .unwrap_or(Vec::new())
    ...
    async fn _live_broadcasts_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _live_chat_bans_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _live_chat_bans_insert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "snippet.ban-duration-seconds" => Some((
                ...
                "snippet.banned-user-details.channel-id" => Some((
                ...
                "snippet.banned-user-details.channel-url" => Some((
                ...
                "snippet.banned-user-details.display-name" => Some((
                ...
                "snippet.banned-user-details.profile-image-url" => Some((
        ...
        let mut request: api::LiveChatBan = serde_json::value::from_value(object).unwrap();
    ...
    async fn _live_chat_messages_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _live_chat_messages_insert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::LiveChatMessage = serde_json::value::from_value(object).unwrap();
    ...
    async fn _live_chat_messages_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.live_chat_messages().list(
            opt.value_of("live-chat-id").unwrap_or(""),
            &opt.values_of("part")
                .map(|i| i.collect())
                .unwrap_or(Vec::new())
                .iter()
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["hl", "max-results", "page-token", "profile-image-size"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _live_chat_messages_transition(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _live_chat_moderators_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _live_chat_moderators_insert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "snippet.moderator-details.channel-id" => Some((
                ...
                "snippet.moderator-details.channel-url" => Some((
                ...
                "snippet.moderator-details.display-name" => Some((
                ...
                "snippet.moderator-details.profile-image-url" => Some((
        ...
        let mut request: api::LiveChatModerator = serde_json::value::from_value(object).unwrap();
    ...
    async fn _live_chat_moderators_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.live_chat_moderators().list(
            opt.value_of("live-chat-id").unwrap_or(""),
            &opt.values_of("part")
                .map(|i| i.collect())
                .unwrap_or(Vec::new())
    ...
    async fn _live_streams_insert(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "cdn.ingestion-info.backup-ingestion-address" => Some((
                ...
                "cdn.ingestion-info.ingestion-address" => Some((
                ...
                "cdn.ingestion-info.rtmps-backup-ingestion-address" => Some((
                ...
                "cdn.ingestion-info.rtmps-ingestion-address" => Some((
                ...
                "cdn.ingestion-info.stream-name" => Some((
                ...
                "content-details.closed-captions-ingestion-url" => Some((
                ...
                "content-details.is-reusable" => Some((
                ...
                "snippet.is-default-stream" => Some((
                ...
                "status.health-status.last-update-time-seconds" => Some((
                ...
                "status.health-status.status" => Some((
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec![
                            "backup-ingestion-address",
                            "cdn",
                            "channel-id",
                            "closed-captions-ingestion-url",
                            "content-details",
                            "description",
                            "etag",
                            "format",
                            ...
                            "published-at",
                            "resolution",
                            "rtmps-backup-ingestion-address",
                            "rtmps-ingestion-address",
                            "snippet",
                            "status",
                            "stream-name",
                            "stream-status",
        ...
        let mut request: api::LiveStream = serde_json::value::from_value(object).unwrap();
    ...
    async fn _live_streams_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.live_streams().list(
            &opt.values_of("part")
                .map(|i| i.collect())
                .unwrap_or(Vec::new())
                .iter()
    ...
    async fn _members_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.members().list(
            &opt.values_of("part")
                .map(|i| i.collect())
                .unwrap_or(Vec::new())
                .iter()
    ...
    async fn _memberships_levels_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.memberships_levels().list(
            &opt.values_of("part")
                .map(|i| i.collect())
                .unwrap_or(Vec::new())
                .iter()
    ...
    async fn _playlist_images_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _playlist_images_insert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::PlaylistImage = serde_json::value::from_value(object).unwrap();
    ...
    async fn _playlist_images_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _playlist_images_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _playlist_items_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _playlist_items_insert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "content-details.video-published-at" => Some((
                ...
                "snippet.resource-id.channel-id" => Some((
                ...
                "snippet.resource-id.playlist-id" => Some((
                ...
                "snippet.resource-id.video-id" => Some((
                ...
                "snippet.video-owner-channel-id" => Some((
                ...
                "snippet.video-owner-channel-title" => Some((
        ...
        let mut request: api::PlaylistItem = serde_json::value::from_value(object).unwrap();
    ...
    async fn _playlist_items_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.playlist_items().list(
            &opt.values_of("part")
                .map(|i| i.collect())
                .unwrap_or(Vec::new())
                .iter()
    ...
    async fn _playlist_items_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _playlists_insert(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                "content-details.item-count" => Some((
                ...
                "snippet.localized.description" => Some((
                ...
                "snippet.thumbnail-video-id" => Some((
                    "snippet.thumbnailVideoId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
        ...
        let mut request: api::Playlist = serde_json::value::from_value(object).unwrap();
    ...
    async fn _playlists_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.playlists().list(
            &opt.values_of("part")
                .map(|i| i.collect())
                .unwrap_or(Vec::new())
                .iter()
    ...
    async fn _search_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.search().list(
            &opt.values_of("part")
                .map(|i| i.collect())
                .unwrap_or(Vec::new())
                .iter()
            ...
            .iter()
        {
            ...
            match key {
                ...
                "for-mine" => {
                    call = call.for_mine(
                        value
                            .map(|v| arg_from_str(v, err, "for-mine", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "for-developer" => {
                    call = call.for_developer(
                        value
                            .map(|v| arg_from_str(v, err, "for-developer", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "for-content-owner" => {
                    call = call.for_content_owner(
                        value
                            .map(|v| arg_from_str(v, err, "for-content-owner", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "event-type" => {
    ...
    async fn _subscriptions_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _subscriptions_insert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                "content-details.activity-type" => Some((
                ...
                "content-details.new-item-count" => Some((
                ...
                "content-details.total-item-count" => Some((
                ...
                "subscriber-snippet.channel-id" => Some((
                ...
                "subscriber-snippet.description" => Some((
                ...
                "subscriber-snippet.thumbnails.default.height" => Some((
                ...
                "subscriber-snippet.thumbnails.default.url" => Some((
                ...
                "subscriber-snippet.thumbnails.default.width" => Some((
                ...
                "subscriber-snippet.thumbnails.high.height" => Some((
                ...
                "subscriber-snippet.thumbnails.high.url" => Some((
                ...
                "subscriber-snippet.thumbnails.high.width" => Some((
                ...
                "subscriber-snippet.thumbnails.maxres.height" => Some((
                ...
                "subscriber-snippet.thumbnails.maxres.url" => Some((
                ...
                "subscriber-snippet.thumbnails.maxres.width" => Some((
                ...
                "subscriber-snippet.thumbnails.medium.height" => Some((
                ...
                "subscriber-snippet.thumbnails.medium.url" => Some((
                ...
                "subscriber-snippet.thumbnails.medium.width" => Some((
                ...
                "subscriber-snippet.thumbnails.standard.height" => Some((
                ...
                "subscriber-snippet.thumbnails.standard.url" => Some((
                ...
                "subscriber-snippet.thumbnails.standard.width" => Some((
            ...
            .iter()
        {
            ...
            match key {
                ...
                "my-recent-subscribers" => {
                    call = call.my_recent_subscribers(
                        value
                            .map(|v| arg_from_str(v, err, "my-recent-subscribers", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "mine" => {
    ...
    async fn _super_chat_events_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.super_chat_events().list(
            &opt.values_of("part")
                .map(|i| i.collect())
                .unwrap_or(Vec::new())
                .iter()
    ...
    async fn _tests_insert(
        ...
        let mut request: api::TestItem = serde_json::value::from_value(object).unwrap();
    ...
    async fn _third_party_links_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.third_party_links().delete(
            opt.value_of("linking-token").unwrap_or(""),
    ...
    async fn _third_party_links_insert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "snippet.channel-to-store-link.billing-details.billing-status" => Some((
                    "snippet.channelToStoreLink.billingDetails.billingStatus",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                ...
                "snippet.channel-to-store-link.store-name" => Some((
                    "snippet.channelToStoreLink.storeName",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "snippet.channel-to-store-link.store-url" => Some((
                    "snippet.channelToStoreLink.storeUrl",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
        ...
        let mut request: api::ThirdPartyLink = serde_json::value::from_value(object).unwrap();
    ...
    async fn _third_party_links_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.third_party_links().list(
            &opt.values_of("part")
                .map(|i| i.collect())
                .unwrap_or(Vec::new())
                .iter()
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["external-channel-id", "linking-token", "type"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _third_party_links_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _thumbnails_set(
        ...
        let mut call = self
            .hub
            .thumbnails()
            .set(opt.value_of("video-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _video_abuse_report_reasons_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.video_abuse_report_reasons().list(
            &opt.values_of("part")
                .map(|i| i.collect())
                .unwrap_or(Vec::new())
                .iter()
    ...
    async fn _video_categories_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.video_categories().list(
            &opt.values_of("part")
                .map(|i| i.collect())
                .unwrap_or(Vec::new())
                .iter()
    ...
    async fn _videos_get_rating(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.videos().get_rating(
            &opt.values_of("id")
                .map(|i| i.collect())
                .unwrap_or(Vec::new())
                .iter()
    ...
    async fn _videos_insert(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                "age-gating.alcohol-content" => Some((
                    "ageGating.alcoholContent",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "age-gating.restricted" => Some((
                    "ageGating.restricted",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "age-gating.video-game-rating" => Some((
                    "ageGating.videoGameRating",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "content-details.caption" => Some((
                ...
                "content-details.content-rating.acb-rating" => Some((
                ...
                "content-details.content-rating.agcom-rating" => Some((
                ...
                "content-details.content-rating.anatel-rating" => Some((
                ...
                "content-details.content-rating.bbfc-rating" => Some((
                ...
                "content-details.content-rating.bfvc-rating" => Some((
                ...
                "content-details.content-rating.bmukk-rating" => Some((
                ...
                "content-details.content-rating.catv-rating" => Some((
                ...
                "content-details.content-rating.catvfr-rating" => Some((
                ...
                "content-details.content-rating.cbfc-rating" => Some((
                ...
                "content-details.content-rating.ccc-rating" => Some((
                ...
                "content-details.content-rating.cce-rating" => Some((
                ...
                "content-details.content-rating.chfilm-rating" => Some((
                ...
                "content-details.content-rating.chvrs-rating" => Some((
                ...
                "content-details.content-rating.cicf-rating" => Some((
                ...
                "content-details.content-rating.cna-rating" => Some((
                ...
                "content-details.content-rating.cnc-rating" => Some((
                ...
                "content-details.content-rating.csa-rating" => Some((
                ...
                "content-details.content-rating.cscf-rating" => Some((
                ...
                "content-details.content-rating.czfilm-rating" => Some((
                ...
                "content-details.content-rating.djctq-rating" => Some((
                ...
                "content-details.content-rating.djctq-rating-reasons" => Some((
                ...
                "content-details.content-rating.ecbmct-rating" => Some((
                ...
                "content-details.content-rating.eefilm-rating" => Some((
                ...
                "content-details.content-rating.egfilm-rating" => Some((
                ...
                "content-details.content-rating.eirin-rating" => Some((
                ...
                "content-details.content-rating.fcbm-rating" => Some((
                ...
                "content-details.content-rating.fco-rating" => Some((
                ...
                "content-details.content-rating.fmoc-rating" => Some((
                ...
                "content-details.content-rating.fpb-rating" => Some((
                ...
                "content-details.content-rating.fpb-rating-reasons" => Some((
                ...
                "content-details.content-rating.fsk-rating" => Some((
                ...
                "content-details.content-rating.grfilm-rating" => Some((
                ...
                "content-details.content-rating.icaa-rating" => Some((
                ...
                "content-details.content-rating.ifco-rating" => Some((
                ...
                "content-details.content-rating.ilfilm-rating" => Some((
                ...
                "content-details.content-rating.incaa-rating" => Some((
                ...
                "content-details.content-rating.kfcb-rating" => Some((
                ...
                "content-details.content-rating.kijkwijzer-rating" => Some((
                ...
                "content-details.content-rating.kmrb-rating" => Some((
                ...
                "content-details.content-rating.lsf-rating" => Some((
                ...
                "content-details.content-rating.mccaa-rating" => Some((
                ...
                "content-details.content-rating.mccyp-rating" => Some((
                ...
                "content-details.content-rating.mcst-rating" => Some((
                ...
                "content-details.content-rating.mda-rating" => Some((
                ...
                "content-details.content-rating.medietilsynet-rating" => Some((
                ...
                "content-details.content-rating.meku-rating" => Some((
                ...
                "content-details.content-rating.mena-mpaa-rating" => Some((
                    "contentDetails.contentRating.menaMpaaRating",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "content-details.content-rating.mibac-rating" => Some((
                ...
                "content-details.content-rating.moc-rating" => Some((
                ...
                "content-details.content-rating.moctw-rating" => Some((
                ...
                "content-details.content-rating.mpaa-rating" => Some((
                ...
                "content-details.content-rating.mpaat-rating" => Some((
                ...
                "content-details.content-rating.mtrcb-rating" => Some((
                ...
                "content-details.content-rating.nbc-rating" => Some((
                ...
                "content-details.content-rating.nbcpl-rating" => Some((
                ...
                "content-details.content-rating.nfrc-rating" => Some((
                ...
                "content-details.content-rating.nfvcb-rating" => Some((
                ...
                "content-details.content-rating.nkclv-rating" => Some((
                ...
                "content-details.content-rating.nmc-rating" => Some((
                    "contentDetails.contentRating.nmcRating",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "content-details.content-rating.oflc-rating" => Some((
                ...
                "content-details.content-rating.pefilm-rating" => Some((
                ...
                "content-details.content-rating.rcnof-rating" => Some((
                ...
                "content-details.content-rating.resorteviolencia-rating" => Some((
                ...
                "content-details.content-rating.rtc-rating" => Some((
                ...
                "content-details.content-rating.rte-rating" => Some((
                ...
                "content-details.content-rating.russia-rating" => Some((
                ...
                "content-details.content-rating.skfilm-rating" => Some((
                ...
                "content-details.content-rating.smais-rating" => Some((
                ...
                "content-details.content-rating.smsa-rating" => Some((
                ...
                "content-details.content-rating.tvpg-rating" => Some((
                ...
                "content-details.content-rating.yt-rating" => Some((
                ...
                "content-details.country-restriction.allowed" => Some((
                    "contentDetails.countryRestriction.allowed",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "content-details.country-restriction.exception" => Some((
                    "contentDetails.countryRestriction.exception",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "content-details.definition" => Some((
                ...
                "content-details.dimension" => Some((
                ...
                "content-details.has-custom-thumbnail" => Some((
                ...
                "content-details.licensed-content" => Some((
                ...
                "content-details.region-restriction.allowed" => Some((
                ...
                "content-details.region-restriction.blocked" => Some((
                ...
                "file-details.creation-time" => Some((
                ...
                "live-streaming-details.active-live-chat-id" => Some((
                ...
                "live-streaming-details.actual-end-time" => Some((
                ...
                "live-streaming-details.actual-start-time" => Some((
                ...
                "live-streaming-details.concurrent-viewers" => Some((
                ...
                "live-streaming-details.scheduled-end-time" => Some((
                ...
                "live-streaming-details.scheduled-start-time" => Some((
                ...
                "monetization-details.access.allowed" => Some((
                    "monetizationDetails.access.allowed",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "monetization-details.access.exception" => Some((
                    "monetizationDetails.access.exception",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                ...
                "processing-details.editor-suggestions-availability" => Some((
                ...
                "processing-details.file-details-availability" => Some((
                ...
                "processing-details.processing-failure-reason" => Some((
                ...
                "processing-details.processing-issues-availability" => Some((
                ...
                "processing-details.processing-progress.parts-processed" => Some((
                ...
                "processing-details.processing-progress.parts-total" => Some((
                ...
                "processing-details.processing-progress.time-left-ms" => Some((
                ...
                "processing-details.processing-status" => Some((
                ...
                "processing-details.tag-suggestions-availability" => Some((
                ...
                "processing-details.thumbnails-availability" => Some((
                ...
                "recording-details.location.altitude" => Some((
                ...
                "recording-details.location.latitude" => Some((
                ...
                "recording-details.location.longitude" => Some((
                ...
                "recording-details.location-description" => Some((
                ...
                "recording-details.recording-date" => Some((
                ...
                "snippet.default-audio-language" => Some((
                ...
                "snippet.live-broadcast-content" => Some((
                ...
                "statistics.favorite-count" => Some((
                ...
                "status.public-stats-viewable" => Some((
                ...
                "suggestions.editor-suggestions" => Some((
                ...
                "suggestions.processing-errors" => Some((
                ...
                "suggestions.processing-hints" => Some((
                ...
                "suggestions.processing-warnings" => Some((
                ...
                "topic-details.relevant-topic-ids" => Some((
                ...
                "topic-details.topic-categories" => Some((
        ...
        let mut request: api::Video = serde_json::value::from_value(object).unwrap();
            ...
            .iter()
        {
            ...
            match key {
                "stabilize" => {
                    call = call.stabilize(
                        value
                            .map(|v| arg_from_str(v, err, "stabilize", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "on-behalf-of-content-owner-channel" => {
                ...
                "notify-subscribers" => {
                    call = call.notify_subscribers(
                        value
                            .map(|v| arg_from_str(v, err, "notify-subscribers", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "auto-levels" => {
                    call = call.auto_levels(
                        value
                            .map(|v| arg_from_str(v, err, "auto-levels", "boolean"))
                            .unwrap_or(false),
                    );
                }
                _ => {
    ...
    async fn _videos_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.videos().list(
            &opt.values_of("part")
                .map(|i| i.collect())
                .unwrap_or(Vec::new())
                .iter()
            ...
            .iter()
        {
            ...
            match key {
                ...
                "max-width" => {
                    call = call.max_width(
                        value
                            .map(|v| arg_from_str(v, err, "max-width", "int32"))
                            .unwrap_or(-0),
                    );
                }
                "max-results" => {
                ...
                "max-height" => {
                    call = call.max_height(
                        value
                            .map(|v| arg_from_str(v, err, "max-height", "int32"))
                            .unwrap_or(-0),
                    );
                }
                "locale" => {
    ...
    async fn _videos_rate(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.videos().rate(
            opt.value_of("id").unwrap_or(""),
            opt.value_of("rating").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _videos_report_abuse(
        ...
        let mut request: api::VideoAbuseReport = serde_json::value::from_value(object).unwrap();
    ...
    async fn _watermarks_set(
        ...
        let mut request: api::InvideoBranding = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .watermarks()
            .set(request, opt.value_of("channel-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _watermarks_unset(
        ...
        let mut call = self
            .hub
            .watermarks()
            .unset(opt.value_of("channel-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _doit(
        ...
        match self.opt.subcommand() {
            ("abuse-reports", Some(opt)) => match opt.subcommand() {
                ("insert", Some(opt)) => {
                    call_result = self._abuse_reports_insert(opt, dry_run, &mut err).await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("abuse-reports".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("activities", Some(opt)) => match opt.subcommand() {
                ("list", Some(opt)) => {
                    call_result = self._activities_list(opt, dry_run, &mut err).await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("activities".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("captions", Some(opt)) => match opt.subcommand() {
                ("delete", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("captions".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("channel-banners", Some(opt)) => match opt.subcommand() {
                ("insert", Some(opt)) => {
                    call_result = self._channel_banners_insert(opt, dry_run, &mut err).await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("channel-banners".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("channel-sections", Some(opt)) => match opt.subcommand() {
                ("delete", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("channel-sections".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("channels", Some(opt)) => match opt.subcommand() {
                ("list", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("channels".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("comment-threads", Some(opt)) => match opt.subcommand() {
                ("insert", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("comment-threads".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("comments", Some(opt)) => match opt.subcommand() {
                ("delete", Some(opt)) => {
                ...
                ("set-moderation-status", Some(opt)) => {
                    call_result = self
                        ._comments_set_moderation_status(opt, dry_run, &mut err)
                        .await;
                }
                ("update", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("comments".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("i18n-languages", Some(opt)) => match opt.subcommand() {
                ("list", Some(opt)) => {
                    call_result = self._i18n_languages_list(opt, dry_run, &mut err).await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("i18n-languages".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("i18n-regions", Some(opt)) => match opt.subcommand() {
                ("list", Some(opt)) => {
                    call_result = self._i18n_regions_list(opt, dry_run, &mut err).await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("i18n-regions".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("live-broadcasts", Some(opt)) => match opt.subcommand() {
                ("bind", Some(opt)) => {
                ...
                ("insert-cuepoint", Some(opt)) => {
                    call_result = self
                        ._live_broadcasts_insert_cuepoint(opt, dry_run, &mut err)
                        .await;
                }
                ("list", Some(opt)) => {
                ...
                ("transition", Some(opt)) => {
                    call_result = self
                        ._live_broadcasts_transition(opt, dry_run, &mut err)
                        .await;
                }
                ("update", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("live-broadcasts".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("live-chat-bans", Some(opt)) => match opt.subcommand() {
                ("delete", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("live-chat-bans".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("live-chat-messages", Some(opt)) => match opt.subcommand() {
                ("delete", Some(opt)) => {
                    call_result = self
                        ._live_chat_messages_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("insert", Some(opt)) => {
                    call_result = self
                        ._live_chat_messages_insert(opt, dry_run, &mut err)
                        .await;
                }
                ("list", Some(opt)) => {
                ...
                ("transition", Some(opt)) => {
                    call_result = self
                        ._live_chat_messages_transition(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
            ...
            ("live-chat-moderators", Some(opt)) => match opt.subcommand() {
                ("delete", Some(opt)) => {
                    call_result = self
                        ._live_chat_moderators_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("insert", Some(opt)) => {
                    call_result = self
                        ._live_chat_moderators_insert(opt, dry_run, &mut err)
                        .await;
                }
                ("list", Some(opt)) => {
                    call_result = self
                        ._live_chat_moderators_list(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues.push(CLIError::MissingMethodError(
                        "live-chat-moderators".to_string(),
                    ));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("live-streams", Some(opt)) => match opt.subcommand() {
                ("delete", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("live-streams".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("members", Some(opt)) => match opt.subcommand() {
                ("list", Some(opt)) => {
                    call_result = self._members_list(opt, dry_run, &mut err).await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("members".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("memberships-levels", Some(opt)) => match opt.subcommand() {
                ("list", Some(opt)) => {
                    call_result = self._memberships_levels_list(opt, dry_run, &mut err).await;
                }
                _ => {
                    err.issues.push(CLIError::MissingMethodError(
                        "memberships-levels".to_string(),
                    ));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("playlist-images", Some(opt)) => match opt.subcommand() {
                ("delete", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("playlist-images".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("playlist-items", Some(opt)) => match opt.subcommand() {
                ("delete", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("playlist-items".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("playlists", Some(opt)) => match opt.subcommand() {
                ("delete", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("playlists".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("search", Some(opt)) => match opt.subcommand() {
                ("list", Some(opt)) => {
                    call_result = self._search_list(opt, dry_run, &mut err).await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("search".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("subscriptions", Some(opt)) => match opt.subcommand() {
                ("delete", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("subscriptions".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("super-chat-events", Some(opt)) => match opt.subcommand() {
                ("list", Some(opt)) => {
                    call_result = self._super_chat_events_list(opt, dry_run, &mut err).await;
                }
                _ => {
                    err.issues.push(CLIError::MissingMethodError(
                        "super-chat-events".to_string(),
                    ));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("tests", Some(opt)) => match opt.subcommand() {
                ("insert", Some(opt)) => {
                    call_result = self._tests_insert(opt, dry_run, &mut err).await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("tests".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("third-party-links", Some(opt)) => match opt.subcommand() {
                ("delete", Some(opt)) => {
                ...
                _ => {
                    err.issues.push(CLIError::MissingMethodError(
                        "third-party-links".to_string(),
                    ));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("thumbnails", Some(opt)) => match opt.subcommand() {
                ("set", Some(opt)) => {
                    call_result = self._thumbnails_set(opt, dry_run, &mut err).await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("thumbnails".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("video-abuse-report-reasons", Some(opt)) => match opt.subcommand() {
                ("list", Some(opt)) => {
                    call_result = self
                        ._video_abuse_report_reasons_list(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues.push(CLIError::MissingMethodError(
                        "video-abuse-report-reasons".to_string(),
                    ));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("video-categories", Some(opt)) => match opt.subcommand() {
                ("list", Some(opt)) => {
                    call_result = self._video_categories_list(opt, dry_run, &mut err).await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("video-categories".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("videos", Some(opt)) => match opt.subcommand() {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("videos".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("watermarks", Some(opt)) => match opt.subcommand() {
                ("set", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("watermarks".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("youtube", Some(opt)) => match opt.subcommand() {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("youtube".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            _ => {
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(
                &config_dir,
                "youtube3-secret.json",
                "{
  \"installed\": {
