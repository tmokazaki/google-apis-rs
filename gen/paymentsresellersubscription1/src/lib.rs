...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/paymentsresellersubscription1).
//! # Features
//!
...
//!
//! * **[Hub](PaymentsResellerSubscription)**
...
pub mod api;
pub use api::PaymentsResellerSubscription;
