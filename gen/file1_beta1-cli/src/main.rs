...
use google_file1_beta1::{api, yup_oauth2, Error};
...
{
    async fn _projects_locations_backups_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_backups_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_backups_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_backups_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_instances_create(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "directory-services.managed-active-directory.computer" => Some((
                    "directoryServices.managedActiveDirectory.computer",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "directory-services.managed-active-directory.domain" => Some((
                    "directoryServices.managedActiveDirectory.domain",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
    ...
    async fn _projects_locations_instances_promote_replica(
        ...
        let mut request: api::PromoteReplicaRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_instances_promote_replica(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_instances_restore(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec!["file-share", "source-backup", "source-snapshot"],
                    );
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
        ...
        let mut request: api::RestoreInstanceRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
    ...
    async fn _projects_locations_instances_revert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(key, &vec!["target-snapshot-id"]);
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
                        value.map(|v| v.to_string()),
        ...
        let mut request: api::RevertInstanceRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_instances_revert(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_instances_shares_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::Share = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_instances_shares_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            .iter()
        {
            ...
            match key {
                "share-id" => {
                    call = call.share_id(value.unwrap_or(""));
                }
                _ => {
                    let mut found = false;
                    for param in &self.gp {
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                let mut v = Vec::new();
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(["share-id"].iter().map(|v| *v));
                                v
                            }));
                    }
                }
    ...
    async fn _projects_locations_instances_shares_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_instances_shares_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_instances_shares_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_instances_shares_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_instances_shares_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_instances_shares_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_instances_shares_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_instances_shares_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_instances_snapshots_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::Snapshot = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_instances_snapshots_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_instances_snapshots_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_instances_snapshots_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_instances_snapshots_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_instances_snapshots_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_instances_snapshots_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_instances_snapshots_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_instances_snapshots_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_instances_snapshots_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
        ...
        match self.opt.subcommand() {
            ("projects", Some(opt)) => match opt.subcommand() {
                ("locations-backups-create", Some(opt)) => {
                    call_result = self
                        ._projects_locations_backups_create(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("locations-backups-patch", Some(opt)) => {
                    call_result = self
                        ._projects_locations_backups_patch(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("locations-instances-revert", Some(opt)) => {
                    call_result = self
                        ._projects_locations_instances_revert(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-instances-shares-create", Some(opt)) => {
                    call_result = self
                        ._projects_locations_instances_shares_create(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-instances-shares-delete", Some(opt)) => {
                    call_result = self
                        ._projects_locations_instances_shares_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-instances-shares-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_instances_shares_get(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-instances-shares-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_instances_shares_list(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-instances-shares-patch", Some(opt)) => {
                    call_result = self
                        ._projects_locations_instances_shares_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-instances-snapshots-create", Some(opt)) => {
                    call_result = self
                        ._projects_locations_instances_snapshots_create(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-instances-snapshots-delete", Some(opt)) => {
                    call_result = self
                        ._projects_locations_instances_snapshots_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-instances-snapshots-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_instances_snapshots_get(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-instances-snapshots-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_instances_snapshots_list(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-instances-snapshots-patch", Some(opt)) => {
                    call_result = self
                        ._projects_locations_instances_snapshots_patch(opt, dry_run, &mut err)
                        .await;
                }
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "file1-beta1-secret.json",
        ...
        .persist_tokens_to_disk(format!("{}/file1-beta1", config_dir))
        .build()
        .await
        .unwrap();
        ...
        ("projects", "methods: 'locations-backups-create', 'locations-backups-delete', 'locations-backups-get', 'locations-backups-list', 'locations-backups-patch', 'locations-get', 'locations-instances-create', 'locations-instances-delete', 'locations-instances-get', 'locations-instances-list', 'locations-instances-patch', 'locations-instances-promote-replica', 'locations-instances-restore', 'locations-instances-revert', 'locations-instances-shares-create', 'locations-instances-shares-delete', 'locations-instances-shares-get', 'locations-instances-shares-list', 'locations-instances-shares-patch', 'locations-instances-snapshots-create', 'locations-instances-snapshots-delete', 'locations-instances-snapshots-get', 'locations-instances-snapshots-list', 'locations-instances-snapshots-patch', 'locations-list', 'locations-operations-cancel', 'locations-operations-delete', 'locations-operations-get' and 'locations-operations-list'", vec![
            ("locations-backups-create",
                  ...
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The backup's project and location, in the format `projects/{project_id}/locations/{location}`. In Filestore, backup locations map to Google Cloud regions, for example **us-west1**."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("locations-backups-list",
                  ...
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The project and location for which to retrieve backup information, in the format `projects/{project_id}/locations/{location}`. In Filestore, backup locations map to Google Cloud regions, for example **us-west1**. To retrieve backup information for all locations, use "-" for the `{location}` value."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("locations-instances-create",
                  ...
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The instance's project and location, in the format `projects/{project_id}/locations/{location}`. In Filestore, locations map to Google Cloud zones, for example **us-west1-b**."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("locations-instances-list",
                  ...
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The project and location for which to retrieve instance information, in the format `projects/{project_id}/locations/{location}`. In Cloud Filestore, locations map to Google Cloud zones, for example **us-west1-b**. To retrieve instance information for all locations, use "-" for the `{location}` value."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("locations-instances-revert",
                    Some(r##"Revert an existing instance's file system to a specified snapshot."##),
                    "Details at http://byron.github.io/google-apis-rs/google_file1_beta1_cli/projects_locations-instances-revert",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The resource name of the instance, in the format `projects/{project_id}/locations/{location_id}/instances/{instance_id}`."##),
            ...
            ("locations-instances-shares-create",
                    Some(r##"Creates a share."##),
                    "Details at http://byron.github.io/google-apis-rs/google_file1_beta1_cli/projects_locations-instances-shares-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The Filestore Instance to create the share for, in the format `projects/{project_id}/locations/{location}/instances/{instance_id}`"##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("locations-instances-shares-delete",
                    Some(r##"Deletes a share."##),
                    "Details at http://byron.github.io/google-apis-rs/google_file1_beta1_cli/projects_locations-instances-shares-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The share resource name, in the format `projects/{project_id}/locations/{location}/instances/{instance_id}/share/{share_id}`"##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("locations-instances-shares-get",
                    Some(r##"Gets the details of a specific share."##),
                    "Details at http://byron.github.io/google-apis-rs/google_file1_beta1_cli/projects_locations-instances-shares-get",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The share resource name, in the format `projects/{project_id}/locations/{location}/instances/{instance_id}/shares/{share_id}`"##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("locations-instances-shares-list",
                    Some(r##"Lists all shares for a specified instance."##),
                    "Details at http://byron.github.io/google-apis-rs/google_file1_beta1_cli/projects_locations-instances-shares-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The instance for which to retrieve share information, in the format `projects/{project_id}/locations/{location}/instances/{instance_id}`."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("locations-instances-shares-patch",
                    Some(r##"Updates the settings of a specific share."##),
                    "Details at http://byron.github.io/google-apis-rs/google_file1_beta1_cli/projects_locations-instances-shares-patch",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Output only. The resource name of the share, in the format `projects/{project_id}/locations/{location_id}/instances/{instance_id}/shares/{share_id}`."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("locations-instances-snapshots-create",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_file1_beta1_cli/projects_locations-instances-snapshots-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("locations-instances-snapshots-delete",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_file1_beta1_cli/projects_locations-instances-snapshots-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-instances-snapshots-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_file1_beta1_cli/projects_locations-instances-snapshots-get",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The snapshot resource name, in the format `projects/{project_id}/locations/{location}/instances/{instance_id}/snapshots/{snapshot_id}`"##),
            ...
            ("locations-instances-snapshots-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_file1_beta1_cli/projects_locations-instances-snapshots-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("locations-instances-snapshots-patch",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_file1_beta1_cli/projects_locations-instances-snapshots-patch",
                  vec![
                    (Some(r##"name"##),
                     None,
