...
use google_androiddeviceprovisioning1::{api, yup_oauth2, Error};
...
struct Engine<'n, C> {
    opt: ArgMatches<'n>,
    hub: api::AndroidProvisioningPartner<C>,
    gp: Vec<&'static str>,
...
{
    async fn _customers_configurations_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        ...
        let mut request: api::Configuration = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .customers()
            .configurations_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _customers_configurations_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .customers()
            .configurations_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _customers_configurations_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _customers_configurations_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _customers_configurations_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .customers()
            .configurations_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _customers_devices_apply_configuration(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "device.device-identifier.chrome-os-attested-device-id" => Some((
                    "device.deviceIdentifier.chromeOsAttestedDeviceId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "device.device-identifier.device-type" => Some((
                    "device.deviceIdentifier.deviceType",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "device.device-identifier.imei" => Some((
                ...
                "device.device-identifier.model" => Some((
                ...
                "device.device-identifier.serial-number" => Some((
        ...
        let mut request: api::CustomerApplyConfigurationRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .customers()
            .devices_apply_configuration(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            ...
            .iter()
        {
            ...
            match key {
                ...
                "page-size" => {
                    call = call.page_size(
                        value
                            .map(|v| arg_from_str(v, err, "page-size", "int64"))
                            .unwrap_or(-0),
                    );
                }
                _ => {
    ...
    async fn _customers_devices_remove_configuration(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::CustomerRemoveConfigurationRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .customers()
            .devices_remove_configuration(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _customers_devices_unclaim(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::CustomerUnclaimDeviceRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .customers()
            .devices_unclaim(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _customers_dpcs_list(
        ...
        let mut call = self
            .hub
            .customers()
            .dpcs_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _partners_customers_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "customer.google-workspace-account.customer-id" => Some((
                    "customer.googleWorkspaceAccount.customerId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "customer.google-workspace-account.pre-provisioning-tokens" => Some((
                    "customer.googleWorkspaceAccount.preProvisioningTokens",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "customer.language-code" => Some((
                ...
                "customer.skip-welcome-email" => Some((
                    "customer.skipWelcomeEmail",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "customer.terms-status" => Some((
        ...
        let mut request: api::CreateCustomerRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .partners()
    ...
    async fn _partners_customers_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _partners_devices_claim(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "device-identifier.chrome-os-attested-device-id" => Some((
                ...
                "device-identifier.device-type" => Some((
                ...
                "device-identifier.serial-number" => Some((
                ...
                "google-workspace-customer-id" => Some((
    ...
    async fn _partners_devices_claim_async(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _partners_devices_find_by_identifier(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _partners_devices_find_by_owner(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _partners_devices_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _partners_devices_get_sim_lock_state(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _partners_devices_metadata(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion =
                        FieldCursor::did_you_mean(key, &vec!["device-metadata", "entries"]);
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
                        value.map(|v| v.to_string()),
    ...
    async fn _partners_devices_unclaim(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "vacation-mode-expire-time" => Some((
    ...
    async fn _partners_devices_unclaim_async(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _partners_devices_update_metadata_async(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _partners_vendors_customers_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .partners()
            .vendors_customers_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _partners_vendors_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .partners()
            .vendors_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
        ...
        match self.opt.subcommand() {
            ("customers", Some(opt)) => match opt.subcommand() {
                ("configurations-create", Some(opt)) => {
                    call_result = self
                        ._customers_configurations_create(opt, dry_run, &mut err)
                        .await;
                }
                ("configurations-delete", Some(opt)) => {
                    call_result = self
                        ._customers_configurations_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("configurations-get", Some(opt)) => {
                    call_result = self
                        ._customers_configurations_get(opt, dry_run, &mut err)
                        .await;
                }
                ("configurations-list", Some(opt)) => {
                    call_result = self
                        ._customers_configurations_list(opt, dry_run, &mut err)
                        .await;
                }
                ("configurations-patch", Some(opt)) => {
                    call_result = self
                        ._customers_configurations_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("devices-apply-configuration", Some(opt)) => {
                    call_result = self
                        ._customers_devices_apply_configuration(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("devices-remove-configuration", Some(opt)) => {
                    call_result = self
                        ._customers_devices_remove_configuration(opt, dry_run, &mut err)
                        .await;
                }
                ("devices-unclaim", Some(opt)) => {
                    call_result = self
                        ._customers_devices_unclaim(opt, dry_run, &mut err)
                        .await;
                }
                ("dpcs-list", Some(opt)) => {
            ...
            ("partners", Some(opt)) => match opt.subcommand() {
                ("customers-create", Some(opt)) => {
                    call_result = self
                        ._partners_customers_create(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("devices-claim-async", Some(opt)) => {
                    call_result = self
                        ._partners_devices_claim_async(opt, dry_run, &mut err)
                        .await;
                }
                ("devices-find-by-identifier", Some(opt)) => {
                    call_result = self
                        ._partners_devices_find_by_identifier(opt, dry_run, &mut err)
                        .await;
                }
                ("devices-find-by-owner", Some(opt)) => {
                    call_result = self
                        ._partners_devices_find_by_owner(opt, dry_run, &mut err)
                        .await;
                }
                ("devices-get", Some(opt)) => {
                    call_result = self._partners_devices_get(opt, dry_run, &mut err).await;
                }
                ("devices-get-sim-lock-state", Some(opt)) => {
                    call_result = self
                        ._partners_devices_get_sim_lock_state(opt, dry_run, &mut err)
                        .await;
                }
                ("devices-metadata", Some(opt)) => {
                    call_result = self
                        ._partners_devices_metadata(opt, dry_run, &mut err)
                        .await;
                }
                ("devices-unclaim", Some(opt)) => {
                ...
                ("devices-unclaim-async", Some(opt)) => {
                    call_result = self
                        ._partners_devices_unclaim_async(opt, dry_run, &mut err)
                        .await;
                }
                ("devices-update-metadata-async", Some(opt)) => {
                    call_result = self
                        ._partners_devices_update_metadata_async(opt, dry_run, &mut err)
                        .await;
                }
                ("vendors-customers-list", Some(opt)) => {
                    call_result = self
                        ._partners_vendors_customers_list(opt, dry_run, &mut err)
                        .await;
                }
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "androiddeviceprovisioning1-secret.json",
...
async fn main() {
    ...
    let arg_data = [
        ("customers", "methods: 'configurations-create', 'configurations-delete', 'configurations-get', 'configurations-list', 'configurations-patch', 'devices-apply-configuration', 'devices-get', 'devices-list', 'devices-remove-configuration', 'devices-unclaim', 'dpcs-list' and 'list'", vec![
            ...
            ("partners", "methods: 'customers-create', 'customers-list', 'devices-claim', 'devices-claim-async', 'devices-find-by-identifier', 'devices-find-by-owner', 'devices-get', 'devices-get-sim-lock-state', 'devices-metadata', 'devices-unclaim', 'devices-unclaim-async', 'devices-update-metadata-async', 'vendors-customers-list' and 'vendors-list'", vec![
            ("customers-create",
            ...
            ("devices-get-sim-lock-state",
                    Some(r##"Gets a device's SIM lock state."##),
                    "Details at http://byron.github.io/google-apis-rs/google_androiddeviceprovisioning1_cli/partners_devices-get-sim-lock-state",
                  vec![
                    (Some(r##"partner-id"##),
                     None,
