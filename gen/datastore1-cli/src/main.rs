...
use google_datastore1::{api, yup_oauth2, Error};
...
{
    async fn _projects_allocate_ids(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        ...
        let mut request: api::AllocateIdsRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .allocate_ids(request, opt.value_of("project-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_begin_transaction(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "transaction-options.read-only.read-time" => Some((
                ...
                "transaction-options.read-write.previous-transaction" => Some((
                    "transactionOptions.readWrite.previousTransaction",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
        ...
        let mut call = self
            .hub
            .projects()
            .begin_transaction(request, opt.value_of("project-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_commit(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "single-use-transaction.read-only.read-time" => Some((
                ...
                "single-use-transaction.read-write.previous-transaction" => Some((
                    "singleUseTransaction.readWrite.previousTransaction",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
        ...
        let mut call = self
            .hub
            .projects()
            .commit(request, opt.value_of("project-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_export(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "entity-filter.namespace-ids" => Some((
        ...
        let mut request: api::GoogleDatastoreAdminV1ExportEntitiesRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .export(request, opt.value_of("project-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_import(
        ...
        let mut request: api::GoogleDatastoreAdminV1ImportEntitiesRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .import(request, opt.value_of("project-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_indexes_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec!["ancestor", "index-id", "kind", "project-id", "state"],
                    );
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
        ...
        let mut request: api::GoogleDatastoreAdminV1Index =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .indexes_create(request, opt.value_of("project-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_indexes_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.projects().indexes_delete(
            opt.value_of("project-id").unwrap_or(""),
            opt.value_of("index-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _projects_indexes_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.projects().indexes_get(
            opt.value_of("project-id").unwrap_or(""),
            opt.value_of("index-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _projects_indexes_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .indexes_list(opt.value_of("project-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_lookup(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "read-options.new-transaction.read-only.read-time" => Some((
                ...
                "read-options.new-transaction.read-write.previous-transaction" => Some((
                    "readOptions.newTransaction.readWrite.previousTransaction",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "read-options.read-consistency" => Some((
        ...
        let mut request: api::LookupRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .lookup(request, opt.value_of("project-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_reserve_ids(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::ReserveIdsRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .reserve_ids(request, opt.value_of("project-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_rollback(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion =
                        FieldCursor::did_you_mean(key, &vec!["database-id", "transaction"]);
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
                        value.map(|v| v.to_string()),
        ...
        let mut call = self
            .hub
            .projects()
            .rollback(request, opt.value_of("project-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_run_aggregation_query(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    ...
                    "aggregation-query.nested-query.filter.property-filter.value.entity-value.key.partition-id.database-id" => Some(("aggregationQuery.nestedQuery.filter.propertyFilter.value.entityValue.key.partitionId.databaseId", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    ...
                    "aggregation-query.nested-query.filter.property-filter.value.key-value.partition-id.database-id" => Some(("aggregationQuery.nestedQuery.filter.propertyFilter.value.keyValue.partitionId.databaseId", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
        ...
        let mut call = self
            .hub
            .projects()
            .run_aggregation_query(request, opt.value_of("project-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_run_query(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "partition-id.namespace-id" => Some((
                ...
                "query.filter.composite-filter.op" => Some((
                    "query.filter.compositeFilter.op",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "query.filter.property-filter.op" => Some((
                    "query.filter.propertyFilter.op",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "query.filter.property-filter.property.name" => Some((
                    "query.filter.propertyFilter.property.name",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "query.filter.property-filter.value.blob-value" => Some((
                    "query.filter.propertyFilter.value.blobValue",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "query.filter.property-filter.value.boolean-value" => Some((
                    "query.filter.propertyFilter.value.booleanValue",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "query.filter.property-filter.value.double-value" => Some((
                    "query.filter.propertyFilter.value.doubleValue",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "query.filter.property-filter.value.entity-value.key.partition-id.database-id" => {
                    Some((
                        "query.filter.propertyFilter.value.entityValue.key.partitionId.databaseId",
                        JsonTypeInfo {
                            jtype: JsonType::String,
                            ctype: ComplexType::Pod,
                        },
                ...
                "query.filter.property-filter.value.entity-value.key.partition-id.namespace-id" => {
                    Some((
                        "query.filter.propertyFilter.value.entityValue.key.partitionId.namespaceId",
                        JsonTypeInfo {
                            jtype: JsonType::String,
                            ctype: ComplexType::Pod,
                        },
                ...
                "query.filter.property-filter.value.entity-value.key.partition-id.project-id" => {
                    Some((
                        "query.filter.propertyFilter.value.entityValue.key.partitionId.projectId",
                        JsonTypeInfo {
                            jtype: JsonType::String,
                            ctype: ComplexType::Pod,
                        },
                ...
                "query.filter.property-filter.value.exclude-from-indexes" => Some((
                    "query.filter.propertyFilter.value.excludeFromIndexes",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "query.filter.property-filter.value.geo-point-value.latitude" => Some((
                    "query.filter.propertyFilter.value.geoPointValue.latitude",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "query.filter.property-filter.value.geo-point-value.longitude" => Some((
                    "query.filter.propertyFilter.value.geoPointValue.longitude",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "query.filter.property-filter.value.integer-value" => Some((
                    "query.filter.propertyFilter.value.integerValue",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "query.filter.property-filter.value.key-value.partition-id.database-id" => Some((
                    "query.filter.propertyFilter.value.keyValue.partitionId.databaseId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "query.filter.property-filter.value.key-value.partition-id.namespace-id" => Some((
                    "query.filter.propertyFilter.value.keyValue.partitionId.namespaceId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "query.filter.property-filter.value.key-value.partition-id.project-id" => Some((
                    "query.filter.propertyFilter.value.keyValue.partitionId.projectId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "query.filter.property-filter.value.meaning" => Some((
                    "query.filter.propertyFilter.value.meaning",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                )),
                "query.filter.property-filter.value.null-value" => Some((
                    "query.filter.propertyFilter.value.nullValue",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "query.filter.property-filter.value.string-value" => Some((
                    "query.filter.propertyFilter.value.stringValue",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "query.filter.property-filter.value.timestamp-value" => Some((
                    "query.filter.propertyFilter.value.timestampValue",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
        ...
        let mut call = self
            .hub
            .projects()
            .run_query(request, opt.value_of("project-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
        ...
        match self.opt.subcommand() {
            ("projects", Some(opt)) => match opt.subcommand() {
                ...
                ("begin-transaction", Some(opt)) => {
                    call_result = self
                        ._projects_begin_transaction(opt, dry_run, &mut err)
                        .await;
                }
                ("commit", Some(opt)) => {
                ...
                ("run-aggregation-query", Some(opt)) => {
                    call_result = self
                        ._projects_run_aggregation_query(opt, dry_run, &mut err)
                        .await;
                }
                ("run-query", Some(opt)) => {
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "datastore1-secret.json",
        ...
        .persist_tokens_to_disk(format!("{}/datastore1", config_dir))
        .build()
        .await
        .unwrap();
...
async fn main() {
    ...
    let arg_data = [
        ("projects", "methods: 'allocate-ids', 'begin-transaction', 'commit', 'export', 'import', 'indexes-create', 'indexes-delete', 'indexes-get', 'indexes-list', 'lookup', 'operations-cancel', 'operations-delete', 'operations-get', 'operations-list', 'reserve-ids', 'rollback', 'run-aggregation-query' and 'run-query'", vec![
            ("allocate-ids",
            ...
            ("run-aggregation-query",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_datastore1_cli/projects_run-aggregation-query",
                  vec![
                    (Some(r##"project-id"##),
                     None,
                     Some(r##"Required. The ID of the project against which to make the request."##),
