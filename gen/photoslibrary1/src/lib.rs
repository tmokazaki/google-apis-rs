...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/photoslibrary1).
//! # Features
//!
//! Handle the following *Resources* with ease from the central [hub](PhotosLibrary) ...
//!
//! * [albums](api::Album)
//!  * [*add enrichment*](api::AlbumAddEnrichmentCall), [*batch add media items*](api::AlbumBatchAddMediaItemCall), [*batch remove media items*](api::AlbumBatchRemoveMediaItemCall), [*create*](api::AlbumCreateCall), [*get*](api::AlbumGetCall), [*list*](api::AlbumListCall), [*patch*](api::AlbumPatchCall), [*share*](api::AlbumShareCall) and [*unshare*](api::AlbumUnshareCall)
//! * [media items](api::MediaItem)
//!  * [*batch create*](api::MediaItemBatchCreateCall), [*batch get*](api::MediaItemBatchGetCall), [*get*](api::MediaItemGetCall), [*list*](api::MediaItemListCall), [*patch*](api::MediaItemPatchCall) and [*search*](api::MediaItemSearchCall)
//! * shared albums
//!  * [*get*](api::SharedAlbumGetCall), [*join*](api::SharedAlbumJoinCall), [*leave*](api::SharedAlbumLeaveCall) and [*list*](api::SharedAlbumListCall)
//!
//!
//!
//!
