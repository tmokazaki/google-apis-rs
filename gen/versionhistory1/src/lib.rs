...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/versionhistory1).
//! # Features
//!
//! Handle the following *Resources* with ease from the central [hub](VersionHistory) ...
//!
//! * [platforms](api::Platform)
//!  * [*channels list*](api::PlatformChannelListCall), [*channels versions list*](api::PlatformChannelVersionListCall), [*channels versions releases list*](api::PlatformChannelVersionReleaseListCall) and [*list*](api::PlatformListCall)
//!
//!
//!
//!
