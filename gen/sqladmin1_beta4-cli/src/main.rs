...
use google_sqladmin1_beta4::{api, yup_oauth2, Error};
    ...
    C: apis_common::Connector,
{
    ...
    async fn _instances_restore_backup(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                "restore-backup-context.backup-run-id" => Some((
                ...
                "restore-backup-context.instance-id" => Some((
                ...
                "restore-backup-context.kind" => Some((
                ...
                "restore-backup-context.project" => Some((
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "sqladmin1-beta4-secret.json",
        ...
        .persist_tokens_to_disk(format!("{}/sqladmin1-beta4", config_dir))
        .build()
        .await
        .unwrap();
        ...
        ("backup-runs", "methods: 'delete', 'get', 'insert' and 'list'", vec![
            ("delete",
                  ...
                  vec![
                    ...
                    (Some(r##"id"##),
                     None,
                     Some(r##"The ID of the backup run to delete. To find a backup run ID, use the [list](https://cloud.google.com/sql/docs/mysql/admin-api/rest/v1beta4/backupRuns/list) method."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("generate-ephemeral",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_sqladmin1_beta4_cli/connect_generate-ephemeral",
                  vec![
                    (Some(r##"project"##),
                     None,
                     Some(r##"Project ID of the project that contains the instance."##),
            ...
            ("get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_sqladmin1_beta4_cli/connect_get",
                  vec![
                    (Some(r##"project"##),
                     None,
                     Some(r##"Project ID of the project that contains the instance."##),
            ...
            ("acquire-ssrs-lease",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_sqladmin1_beta4_cli/instances_acquire-ssrs-lease",
                  vec![
                    (Some(r##"project"##),
                     None,
                     Some(r##"Required. ID of the project that contains the instance (Example: project-id)."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"instance"##),
                     None,
            ...
            ("demote",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_sqladmin1_beta4_cli/instances_demote",
                  vec![
                    (Some(r##"project"##),
                     None,
                     Some(r##"Required. The project ID of the project that contains the instance."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"instance"##),
                     None,
                     Some(r##"Required. The name of the Cloud SQL instance."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("export",
                  ...
                  vec![
                    ...
                    (Some(r##"instance"##),
                     None,
                     Some(r##"The Cloud SQL instance ID. This doesn't include the project ID."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("reencrypt",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_sqladmin1_beta4_cli/instances_reencrypt",
                  vec![
                    (Some(r##"project"##),
                     None,
                     Some(r##"ID of the project that contains the instance."##),
            ...
            ("release-ssrs-lease",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_sqladmin1_beta4_cli/instances_release-ssrs-lease",
                  vec![
                    (Some(r##"project"##),
                     None,
                     Some(r##"Required. The ID of the project that contains the instance (Example: project-id)."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"instance"##),
                     None,
                     Some(r##"Required. The Cloud SQL instance ID. This doesn't include the project ID. It's composed of lowercase letters, numbers, and hyphens, and it must start with a letter. The total length must be 98 characters or less (Example: instance-id)."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("switchover",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_sqladmin1_beta4_cli/instances_switchover",
                  vec![
                    (Some(r##"project"##),
                     None,
            ...
            ("cancel",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_sqladmin1_beta4_cli/operations_cancel",
                  vec![
                    (Some(r##"project"##),
                     None,
                     Some(r##"Project ID of the project that contains the instance."##),
            ...
            ("instances-get-disk-shrink-config",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_sqladmin1_beta4_cli/projects_instances-get-disk-shrink-config",
                  vec![
                    (Some(r##"project"##),
                     None,
                     Some(r##"Project ID of the project that contains the instance."##),
            ...
            ("instances-get-latest-recovery-time",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_sqladmin1_beta4_cli/projects_instances-get-latest-recovery-time",
                  vec![
                    (Some(r##"project"##),
                     None,
                     Some(r##"Project ID of the project that contains the instance."##),
            ...
            ("instances-perform-disk-shrink",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_sqladmin1_beta4_cli/projects_instances-perform-disk-shrink",
                  vec![
                    (Some(r##"project"##),
                     None,
                     Some(r##"Project ID of the project that contains the instance."##),
            ...
            ("instances-reschedule-maintenance",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_sqladmin1_beta4_cli/projects_instances-reschedule-maintenance",
                  vec![
                    (Some(r##"project"##),
                     None,
                     Some(r##"ID of the project that contains the instance."##),
            ...
            ("instances-reset-replica-size",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_sqladmin1_beta4_cli/projects_instances-reset-replica-size",
                  vec![
                    (Some(r##"project"##),
                     None,
                     Some(r##"ID of the project that contains the read replica."##),
            ...
            ("instances-start-external-sync",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_sqladmin1_beta4_cli/projects_instances-start-external-sync",
                  vec![
                    (Some(r##"project"##),
                     None,
                     Some(r##"ID of the project that contains the instance."##),
            ...
            ("instances-verify-external-sync-settings",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_sqladmin1_beta4_cli/projects_instances-verify-external-sync-settings",
                  vec![
                    (Some(r##"project"##),
                     None,
                     Some(r##"Project ID of the project that contains the instance."##),
            ...
            ("list",
                    Some(r##"Lists all available machine types (tiers) for Cloud SQL, for example, `db-custom-1-3840`. For related information, see [Pricing](/sql/pricing)."##),
