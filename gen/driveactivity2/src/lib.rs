...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/driveactivity2).
//! # Features
//!
//! Handle the following *Resources* with ease from the central [hub](DriveActivityHub) ...
//!
//! * activity
//!  * [*query*](api::ActivityQueryCall)
//!
//!
//!
//!
