...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/cloudasset1_beta1).
//! # Features
//!
//! Handle the following *Resources* with ease from the central [hub](CloudAsset) ...
//!
//! * folders
//!  * [*export assets*](api::FolderExportAssetCall) and [*operations get*](api::FolderOperationGetCall)
//! * organizations
//!  * [*batch get assets history*](api::OrganizationBatchGetAssetsHistoryCall), [*export assets*](api::OrganizationExportAssetCall) and [*operations get*](api::OrganizationOperationGetCall)
//! * projects
//!  * [*batch get assets history*](api::ProjectBatchGetAssetsHistoryCall), [*export assets*](api::ProjectExportAssetCall) and [*operations get*](api::ProjectOperationGetCall)
//!
//!
//!
//!
