...
impl<C> common::Hub for Transcoder<C> {}

impl<'a, C> Transcoder<C> {
    pub fn new<A: 'static + common::GetToken>(client: common::Client<C>, auth: A) -> Transcoder<C> {
        Transcoder {
            client,
            auth: Box::new(auth),
...
impl common::Part for Aes128Encryption {}
...
impl common::Part for Animation {}
...
impl common::Part for AnimationEnd {}
...
impl common::Part for AnimationFade {}
...
impl common::Part for AnimationStatic {}
...
impl common::Part for AudioMapping {}
...
impl common::Part for AudioStream {}
...
impl common::Part for BwdifConfig {}
...
impl common::Part for DashConfig {}
...
impl common::Part for Deinterlace {}
...
impl common::Part for DrmSystems {}
...
impl common::Part for ElementaryStream {}
...
impl common::Part for Fmp4Config {}
...
pub struct H264CodecSettings {
    ...
    #[serde_as(as = "Option<common::serde::duration::Wrapper>")]
    pub gop_duration: Option<chrono::Duration>,
...
impl common::Part for H264CodecSettings {}
...
impl common::Part for H264ColorFormatHLG {}
...
impl common::Part for H264ColorFormatSDR {}
...
impl common::Part for H265CodecSettings {}
...
impl common::Part for H265ColorFormatHDR10 {}
...
impl common::Part for H265ColorFormatHLG {}
...
impl common::Part for H265ColorFormatSDR {}
...
impl common::Part for JobConfig {}
...
impl common::RequestValue for JobTemplate {}
impl common::ResponseResult for JobTemplate {}
...
impl common::ResponseResult for ListJobTemplatesResponse {}
...
impl common::Part for MpegCommonEncryption {}
...
impl common::Part for MuxStream {}
...
impl common::Part for NormalizedCoordinate {}
...
impl common::Part for Playready {}
...
impl common::Part for PreprocessingConfig {}
...
impl common::Part for SampleAesEncryption {}
...
impl common::Part for SecretManagerSource {}
...
pub struct SegmentSettings {
    ...
    #[serde_as(as = "Option<common::serde::duration::Wrapper>")]
    pub segment_duration: Option<chrono::Duration>,
}

impl common::Part for SegmentSettings {}
...
impl common::Part for SpriteSheet {}
...
impl common::Part for TextMapping {}
...
impl common::Part for TextStream {}
...
impl common::Part for Vp9CodecSettings {}
...
impl common::Part for Vp9ColorFormatHLG {}
...
impl common::Part for Vp9ColorFormatSDR {}
...
impl common::Part for YadifConfig {}
...
impl<'a, C> ProjectMethods<'a, C> {
    ...
    pub fn locations_job_templates_create(
        &self,
        request: JobTemplate,
        parent: &str,
    ...
    pub fn locations_job_templates_delete(
        &self,
        name: &str,
    ...
    pub fn locations_job_templates_get(
        &self,
        name: &str,
    ...
    pub fn locations_job_templates_list(
        &self,
        parent: &str,
...
/// # }
/// ```
pub struct ProjectLocationJobTemplateCreateCall<'a, C>
where
    C: 'a,
{
    hub: &'a Transcoder<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationJobTemplateCreateCall<'a, C> {}

impl<'a, C> ProjectLocationJobTemplateCreateCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, JobTemplate)> {
        use std::borrow::Cow;
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> ProjectLocationJobTemplateCreateCall<'a, C> {
    ...
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationJobTemplateCreateCall<'a, C>
    where
        T: AsRef<str>,
    {
    ...
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationJobTemplateCreateCall<'a, C>
    where
        St: AsRef<str>,
    {
    ...
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationJobTemplateCreateCall<'a, C>
    where
    ...
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationJobTemplateCreateCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationJobTemplateDeleteCall<'a, C>
where
    C: 'a,
{
    hub: &'a Transcoder<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationJobTemplateDeleteCall<'a, C> {}

impl<'a, C> ProjectLocationJobTemplateDeleteCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationJobTemplateDeleteCall<'a, C> {
    ...
    pub fn allow_missing(mut self, new_value: bool) -> ProjectLocationJobTemplateDeleteCall<'a, C> {
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationJobTemplateDeleteCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationJobTemplateDeleteCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationJobTemplateDeleteCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationJobTemplateDeleteCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationJobTemplateGetCall<'a, C>
where
    C: 'a,
{
    hub: &'a Transcoder<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationJobTemplateGetCall<'a, C> {}

impl<'a, C> ProjectLocationJobTemplateGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationJobTemplateGetCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationJobTemplateGetCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationJobTemplateGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationJobTemplateGetCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationJobTemplateGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationJobTemplateListCall<'a, C>
where
    C: 'a,
{
    hub: &'a Transcoder<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationJobTemplateListCall<'a, C> {}

impl<'a, C> ProjectLocationJobTemplateListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, ListJobTemplatesResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> ProjectLocationJobTemplateListCall<'a, C> {
        self._parent = new_value.to_string();
        self
    }
    ...
    pub fn page_token(mut self, new_value: &str) -> ProjectLocationJobTemplateListCall<'a, C> {
    ...
    pub fn page_size(mut self, new_value: i32) -> ProjectLocationJobTemplateListCall<'a, C> {
    ...
    pub fn order_by(mut self, new_value: &str) -> ProjectLocationJobTemplateListCall<'a, C> {
    ...
    pub fn filter(mut self, new_value: &str) -> ProjectLocationJobTemplateListCall<'a, C> {
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationJobTemplateListCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationJobTemplateListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationJobTemplateListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationJobTemplateListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
    ...
    C: common::Connector,
{
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: Job) -> ProjectLocationJobCreateCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    C: common::Connector,
{
    ...
    ///
    /// Sets the *allow missing* query property to the given value.
    pub fn allow_missing(mut self, new_value: bool) -> ProjectLocationJobDeleteCall<'a, C> {
        self._allow_missing = Some(new_value);
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    C: common::Connector,
{
    ...
    ///
    /// Sets the *order by* query property to the given value.
    pub fn order_by(mut self, new_value: &str) -> ProjectLocationJobListCall<'a, C> {
        self._order_by = Some(new_value.to_string());
        self
    }
    /// The filter expression, following the syntax outlined in https://google.aip.dev/160.
    ///
    /// Sets the *filter* query property to the given value.
    pub fn filter(mut self, new_value: &str) -> ProjectLocationJobListCall<'a, C> {
        self._filter = Some(new_value.to_string());
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
