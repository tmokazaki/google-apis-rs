...
use google_run1::{api, yup_oauth2, Error};
...
{
    async fn _namespaces_authorizeddomains_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        ...
        let mut call = self
            .hub
            .namespaces()
            .authorizeddomains_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _namespaces_configurations_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .namespaces()
            .configurations_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _namespaces_configurations_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .namespaces()
            .configurations_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            .iter()
        {
            ...
            match key {
                "watch" => {
                    call = call.watch(
                        value
                            .map(|v| arg_from_str(v, err, "watch", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "resource-version" => {
                ...
                "include-uninitialized" => {
                    call = call.include_uninitialized(
                        value
                            .map(|v| arg_from_str(v, err, "include-uninitialized", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "field-selector" => {
    ...
    async fn _namespaces_domainmappings_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "status.mapped-route-name" => Some((
                    "status.mappedRouteName",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
        ...
        let mut call = self
            .hub
            .namespaces()
            .domainmappings_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _namespaces_domainmappings_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .namespaces()
            .domainmappings_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["api-version", "dry-run", "kind", "propagation-policy"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _namespaces_domainmappings_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .namespaces()
            .domainmappings_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _namespaces_domainmappings_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .namespaces()
            .domainmappings_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _namespaces_executions_cancel(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::CancelExecutionRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .namespaces()
            .executions_cancel(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _namespaces_executions_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .namespaces()
            .executions_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["api-version", "kind", "propagation-policy"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _namespaces_executions_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .namespaces()
            .executions_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _namespaces_executions_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .namespaces()
            .executions_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _namespaces_jobs_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "spec.start-execution-token" => Some((
                ...
                "spec.template.spec.parallelism" => Some((
                ...
                "spec.template.spec.task-count" => Some((
                ...
                "spec.template.spec.template.spec.max-retries" => Some((
                ...
                "spec.template.spec.template.spec.timeout-seconds" => Some((
                ...
                "status.latest-created-execution.name" => Some((
    ...
    async fn _namespaces_jobs_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .namespaces()
            .jobs_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _namespaces_jobs_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _namespaces_jobs_replace_job(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .namespaces()
            .jobs_replace_job(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _namespaces_jobs_run(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "overrides.timeout-seconds" => Some((
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec!["overrides", "task-count", "timeout-seconds"],
                    );
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
        ...
        let mut request: api::RunJobRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .namespaces()
            .jobs_run(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _namespaces_revisions_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .namespaces()
            .revisions_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _namespaces_revisions_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .namespaces()
            .revisions_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _namespaces_revisions_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .namespaces()
            .revisions_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _namespaces_routes_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .namespaces()
            .routes_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _namespaces_routes_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .namespaces()
            .routes_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _namespaces_services_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .namespaces()
            .services_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _namespaces_services_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .namespaces()
            .services_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _namespaces_services_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _namespaces_services_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _namespaces_services_replace_service(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .namespaces()
            .services_replace_service(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _namespaces_tasks_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .namespaces()
            .tasks_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _namespaces_tasks_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .namespaces()
            .tasks_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_authorizeddomains_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_authorizeddomains_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_configurations_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_configurations_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_configurations_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_configurations_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_domainmappings_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_domainmappings_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_domainmappings_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_domainmappings_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_domainmappings_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_domainmappings_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_domainmappings_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_domainmappings_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_revisions_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_revisions_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_revisions_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_revisions_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_revisions_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_revisions_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_routes_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_routes_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_routes_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_routes_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_services_replace_service(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_services_replace_service(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _doit(
        ...
        match self.opt.subcommand() {
            ("namespaces", Some(opt)) => match opt.subcommand() {
                ("authorizeddomains-list", Some(opt)) => {
                    call_result = self
                        ._namespaces_authorizeddomains_list(opt, dry_run, &mut err)
                        .await;
                }
                ("configurations-get", Some(opt)) => {
                    call_result = self
                        ._namespaces_configurations_get(opt, dry_run, &mut err)
                        .await;
                }
                ("configurations-list", Some(opt)) => {
                    call_result = self
                        ._namespaces_configurations_list(opt, dry_run, &mut err)
                        .await;
                }
                ("domainmappings-create", Some(opt)) => {
                    call_result = self
                        ._namespaces_domainmappings_create(opt, dry_run, &mut err)
                        .await;
                }
                ("domainmappings-delete", Some(opt)) => {
                    call_result = self
                        ._namespaces_domainmappings_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("domainmappings-get", Some(opt)) => {
                    call_result = self
                        ._namespaces_domainmappings_get(opt, dry_run, &mut err)
                        .await;
                }
                ("domainmappings-list", Some(opt)) => {
                    call_result = self
                        ._namespaces_domainmappings_list(opt, dry_run, &mut err)
                        .await;
                }
                ("executions-cancel", Some(opt)) => {
                    call_result = self
                        ._namespaces_executions_cancel(opt, dry_run, &mut err)
                        .await;
                }
                ("executions-delete", Some(opt)) => {
                    call_result = self
                        ._namespaces_executions_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("executions-get", Some(opt)) => {
                    call_result = self
                        ._namespaces_executions_get(opt, dry_run, &mut err)
                        .await;
                }
                ("executions-list", Some(opt)) => {
                    call_result = self
                        ._namespaces_executions_list(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("jobs-replace-job", Some(opt)) => {
                    call_result = self
                        ._namespaces_jobs_replace_job(opt, dry_run, &mut err)
                        .await;
                }
                ("jobs-run", Some(opt)) => {
                ...
                ("revisions-delete", Some(opt)) => {
                    call_result = self
                        ._namespaces_revisions_delete(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("revisions-list", Some(opt)) => {
                    call_result = self
                        ._namespaces_revisions_list(opt, dry_run, &mut err)
                        .await;
                }
                ("routes-get", Some(opt)) => {
                ...
                ("services-create", Some(opt)) => {
                    call_result = self
                        ._namespaces_services_create(opt, dry_run, &mut err)
                        .await;
                }
                ("services-delete", Some(opt)) => {
                    call_result = self
                        ._namespaces_services_delete(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("services-replace-service", Some(opt)) => {
                    call_result = self
                        ._namespaces_services_replace_service(opt, dry_run, &mut err)
                        .await;
                }
                ("tasks-get", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("namespaces".to_string()));
            ...
            ("projects", Some(opt)) => match opt.subcommand() {
                ("authorizeddomains-list", Some(opt)) => {
                    call_result = self
                        ._projects_authorizeddomains_list(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-authorizeddomains-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_authorizeddomains_list(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-configurations-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_configurations_get(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-configurations-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_configurations_list(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-domainmappings-create", Some(opt)) => {
                    call_result = self
                        ._projects_locations_domainmappings_create(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-domainmappings-delete", Some(opt)) => {
                    call_result = self
                        ._projects_locations_domainmappings_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-domainmappings-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_domainmappings_get(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-domainmappings-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_domainmappings_list(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("locations-revisions-delete", Some(opt)) => {
                    call_result = self
                        ._projects_locations_revisions_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-revisions-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_revisions_get(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-revisions-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_revisions_list(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-routes-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_routes_get(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-routes-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_routes_list(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("locations-services-replace-service", Some(opt)) => {
                    call_result = self
                        ._projects_locations_services_replace_service(opt, dry_run, &mut err)
                        .await;
                }
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "run1-secret.json",
