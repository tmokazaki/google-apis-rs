...
impl<C> common::Hub for Texttospeech<C> {}

impl<'a, C> Texttospeech<C> {
    ...
    pub fn text(&'a self) -> TextMethods<'a, C> {
        TextMethods { hub: self }
    }
    pub fn voices(&'a self) -> VoiceMethods<'a, C> {
...
impl common::Part for AudioConfig {}
...
impl common::Part for CustomVoiceParams {}
...
/// * [locations synthesize long audio projects](ProjectLocationSynthesizeLongAudioCall) (response)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
...
impl common::Part for SynthesisInput {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [locations synthesize long audio projects](ProjectLocationSynthesizeLongAudioCall) (request)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
...
impl common::RequestValue for SynthesizeLongAudioRequest {}
...
impl common::RequestValue for SynthesizeSpeechRequest {}
...
impl<'a, C> ProjectMethods<'a, C> {
    ...
    pub fn locations_synthesize_long_audio(
        &self,
        request: SynthesizeLongAudioRequest,
        parent: &str,
    ) -> ProjectLocationSynthesizeLongAudioCall<'a, C> {
...
impl<'a, C> common::MethodsBuilder for TextMethods<'a, C> {}

impl<'a, C> TextMethods<'a, C> {
    /// Create a builder to help you perform the following task:
    ///
    ...
    ///
    /// * `request` - No description provided.
    pub fn synthesize(&self, request: SynthesizeSpeechRequest) -> TextSynthesizeCall<'a, C> {
        TextSynthesizeCall {
            hub: self.hub,
            _request: request,
            _delegate: Default::default(),
...
impl<'a, C> common::MethodsBuilder for VoiceMethods<'a, C> {}

impl<'a, C> VoiceMethods<'a, C> {
    /// Create a builder to help you perform the following task:
    ///
    /// Returns a list of Voice supported for synthesis.
    pub fn list(&self) -> VoiceListCall<'a, C> {
        VoiceListCall {
            hub: self.hub,
...
/// Synthesizes long form text asynchronously.
///
/// A builder for the *locations.synthesizeLongAudio* method supported by a *project* resource.
/// It is not used directly, but through a [`ProjectMethods`] instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_texttospeech1 as texttospeech1;
/// use texttospeech1::api::SynthesizeLongAudioRequest;
/// # async fn dox() {
/// # use texttospeech1::{Texttospeech, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = SynthesizeLongAudioRequest::default();
///
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().locations_synthesize_long_audio(req, "parent")
///              .doit().await;
/// # }
/// ```
pub struct ProjectLocationSynthesizeLongAudioCall<'a, C>
where
    C: 'a,
{
    hub: &'a Texttospeech<C>,
    _request: SynthesizeLongAudioRequest,
    _parent: String,
    _delegate: Option<&'a mut dyn common::Delegate>,
    _additional_params: HashMap<String, String>,
    _scopes: BTreeSet<String>,
...
impl<'a, C> common::CallBuilder for ProjectLocationSynthesizeLongAudioCall<'a, C> {}

impl<'a, C> ProjectLocationSynthesizeLongAudioCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, Operation)> {
        ...
        params.push("alt", "json");
        let mut url = self.hub._base_url.clone() + "v1/{+parent}:synthesizeLongAudio";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string());
        }
    ...
    pub fn request(
        mut self,
        new_value: SynthesizeLongAudioRequest,
    ) -> ProjectLocationSynthesizeLongAudioCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> ProjectLocationSynthesizeLongAudioCall<'a, C> {
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationSynthesizeLongAudioCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationSynthesizeLongAudioCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationSynthesizeLongAudioCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationSynthesizeLongAudioCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct TextSynthesizeCall<'a, C>
where
    C: 'a,
{
    hub: &'a Texttospeech<C>,
...
impl<'a, C> common::CallBuilder for TextSynthesizeCall<'a, C> {}

impl<'a, C> TextSynthesizeCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, SynthesizeSpeechResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: SynthesizeSpeechRequest) -> TextSynthesizeCall<'a, C> {
        self._request = new_value;
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> TextSynthesizeCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> TextSynthesizeCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> TextSynthesizeCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> TextSynthesizeCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for VoiceListCall<'a, C> {}

impl<'a, C> VoiceListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, ListVoicesResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    pub fn language_code(mut self, new_value: &str) -> VoiceListCall<'a, C> {
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> VoiceListCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> VoiceListCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> VoiceListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> VoiceListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> VoiceListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
