...
use google_tagmanager2::{api, yup_oauth2, Error};
...
{
    async fn _accounts_containers_combine(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_combine(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            .iter()
        {
            ...
            match key {
                ...
                "allow-user-permission-feature-update" => {
                    call = call.allow_user_permission_feature_update(
                        value
                            .map(|v| {
                                arg_from_str(
                                    v,
    ...
    async fn _accounts_containers_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "features.support-built-in-variables" => Some((
                ...
                "features.support-environments" => Some((
                ...
                "features.support-gtag-configs" => Some((
                ...
                "features.support-templates" => Some((
                ...
                "features.support-transformations" => Some((
                ...
                "features.support-triggers" => Some((
                ...
                "features.support-user-permissions" => Some((
                ...
                "features.support-variables" => Some((
                ...
                "features.support-versions" => Some((
                ...
                "features.support-workspaces" => Some((
        ...
        let mut request: api::Container = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .accounts()
            .containers_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_delete(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_destinations_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_destinations_get(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_destinations_link(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_destinations_link(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["allow-user-permission-feature-update", "destination-id"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _accounts_containers_destinations_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_destinations_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_environments_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::Environment = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .accounts()
            .containers_environments_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_environments_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_environments_delete(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_environments_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_environments_get(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_environments_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_environments_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_environments_reauthorize(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_environments_reauthorize(request, opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_environments_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_environments_update(request, opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_get(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_lookup(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _accounts_containers_move_tag_id(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_move_tag_id(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            .iter()
        {
            ...
            match key {
                ...
                "copy-users" => {
                    call = call.copy_users(
                        value
                            .map(|v| arg_from_str(v, err, "copy-users", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "copy-terms-of-service" => {
                    call = call.copy_terms_of_service(
                        value
                            .map(|v| arg_from_str(v, err, "copy-terms-of-service", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "copy-settings" => {
                    call = call.copy_settings(
                        value
                            .map(|v| arg_from_str(v, err, "copy-settings", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "allow-user-permission-feature-update" => {
    ...
    async fn _accounts_containers_snippet(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_snippet(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_update(request, opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_version_headers_latest(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_version_headers_latest(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_version_headers_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_version_headers_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            .iter()
        {
            ...
            match key {
                ...
                "include-deleted" => {
                    call = call.include_deleted(
                        value
                            .map(|v| arg_from_str(v, err, "include-deleted", "boolean"))
                            .unwrap_or(false),
                    );
                }
                _ => {
    ...
    async fn _accounts_containers_versions_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_versions_delete(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_versions_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_versions_get(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_versions_live(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_versions_live(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_versions_publish(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_versions_publish(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_versions_set_latest(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_versions_set_latest(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_versions_undelete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_versions_undelete(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_versions_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "container.features.support-built-in-variables" => Some((
                    "container.features.supportBuiltInVariables",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "container.features.support-clients" => Some((
                    "container.features.supportClients",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "container.features.support-environments" => Some((
                    "container.features.supportEnvironments",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "container.features.support-folders" => Some((
                    "container.features.supportFolders",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "container.features.support-gtag-configs" => Some((
                    "container.features.supportGtagConfigs",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "container.features.support-tags" => Some((
                    "container.features.supportTags",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "container.features.support-templates" => Some((
                    "container.features.supportTemplates",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "container.features.support-transformations" => Some((
                    "container.features.supportTransformations",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "container.features.support-triggers" => Some((
                    "container.features.supportTriggers",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "container.features.support-user-permissions" => Some((
                    "container.features.supportUserPermissions",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "container.features.support-variables" => Some((
                    "container.features.supportVariables",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "container.features.support-versions" => Some((
                    "container.features.supportVersions",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "container.features.support-workspaces" => Some((
                    "container.features.supportWorkspaces",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "container.features.support-zones" => Some((
                    "container.features.supportZones",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "container.fingerprint" => Some((
                ...
                "container.tag-manager-url" => Some((
                ...
                "container.tagging-server-urls" => Some((
                    "container.taggingServerUrls",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "container.usage-context" => Some((
        ...
        let mut request: api::ContainerVersion = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .accounts()
            .containers_versions_update(request, opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_built_in_variables_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_built_in_variables_create(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_built_in_variables_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_built_in_variables_delete(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_built_in_variables_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_built_in_variables_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_built_in_variables_revert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_built_in_variables_revert(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_clients_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_clients_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_clients_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_clients_delete(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_clients_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_clients_get(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_clients_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_clients_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_clients_revert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_clients_revert(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_clients_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_clients_update(request, opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::Workspace = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_create_version(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::CreateContainerVersionRequestVersionOptions =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_create_version(request, opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_delete(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_folders_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::Folder = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_folders_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_folders_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_folders_delete(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_folders_entities(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_folders_entities(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_folders_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_folders_get(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_folders_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_folders_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_folders_move_entities_to_folder(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_folders_move_entities_to_folder(
                request,
                opt.value_of("path").unwrap_or(""),
            );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["tag-id", "trigger-id", "variable-id"].iter().map(|v| *v),
                                );
                                v
                            }));
                    }
    ...
    async fn _accounts_containers_workspaces_folders_revert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_folders_revert(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_folders_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_folders_update(request, opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_get(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_get_status(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_get_status(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_gtag_config_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::GtagConfig = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_gtag_config_create(
                request,
    ...
    async fn _accounts_containers_workspaces_gtag_config_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_gtag_config_delete(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_gtag_config_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_gtag_config_get(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_gtag_config_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_gtag_config_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_gtag_config_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_gtag_config_update(request, opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_quick_preview(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_quick_preview(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_resolve_conflict(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                "built-in-variable.account-id" => Some((
                ...
                "built-in-variable.container-id" => Some((
                ...
                "built-in-variable.workspace-id" => Some((
                ...
                "client.tag-manager-url" => Some((
                    "client.tagManagerUrl",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                ...
                "custom-template.account-id" => Some((
                    "customTemplate.accountId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "custom-template.container-id" => Some((
                    "customTemplate.containerId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "custom-template.fingerprint" => Some((
                    "customTemplate.fingerprint",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                ...
                "custom-template.gallery-reference.is-modified" => Some((
                    "customTemplate.galleryReference.isModified",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "custom-template.gallery-reference.owner" => Some((
                    "customTemplate.galleryReference.owner",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "custom-template.gallery-reference.repository" => Some((
                    "customTemplate.galleryReference.repository",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                ...
                "custom-template.gallery-reference.version" => Some((
                    "customTemplate.galleryReference.version",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "custom-template.name" => Some((
                    "customTemplate.name",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                ...
                "custom-template.tag-manager-url" => Some((
                    "customTemplate.tagManagerUrl",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "custom-template.template-data" => Some((
                ...
                "custom-template.template-id" => Some((
                ...
                "custom-template.workspace-id" => Some((
                    "customTemplate.workspaceId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "folder.account-id" => Some((
                    "folder.accountId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                ...
                "gtag-config.account-id" => Some((
                    "gtagConfig.accountId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "gtag-config.container-id" => Some((
                    "gtagConfig.containerId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "gtag-config.fingerprint" => Some((
                    "gtagConfig.fingerprint",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "gtag-config.gtag-config-id" => Some((
                ...
                "gtag-config.tag-manager-url" => Some((
                    "gtagConfig.tagManagerUrl",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "gtag-config.type" => Some((
                    "gtagConfig.type",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                ...
                "gtag-config.workspace-id" => Some((
                    "gtagConfig.workspaceId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                ...
                "tag.consent-settings.consent-status" => Some((
                ...
                "tag.consent-settings.consent-type.is-weak-reference" => Some((
                    "tag.consentSettings.consentType.isWeakReference",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "tag.consent-settings.consent-type.key" => Some((
                    "tag.consentSettings.consentType.key",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "tag.consent-settings.consent-type.type" => Some((
                    "tag.consentSettings.consentType.type",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "tag.consent-settings.consent-type.value" => Some((
                    "tag.consentSettings.consentType.value",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "tag.container-id" => Some((
                    "tag.containerId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                ...
                "tag.monitoring-metadata.is-weak-reference" => Some((
                    "tag.monitoringMetadata.isWeakReference",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "tag.monitoring-metadata.key" => Some((
                    "tag.monitoringMetadata.key",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "tag.monitoring-metadata.type" => Some((
                    "tag.monitoringMetadata.type",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "tag.monitoring-metadata.value" => Some((
                    "tag.monitoringMetadata.value",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "tag.monitoring-metadata-tag-name-key" => Some((
                    "tag.monitoringMetadataTagNameKey",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                ...
                "tag.priority.is-weak-reference" => Some((
                    "tag.priority.isWeakReference",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "tag.priority.key" => Some((
                    "tag.priority.key",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                ...
                "transformation.account-id" => Some((
                ...
                "transformation.container-id" => Some((
                    "transformation.containerId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "transformation.fingerprint" => Some((
                ...
                "transformation.parent-folder-id" => Some((
                    "transformation.parentFolderId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "transformation.path" => Some((
                    "transformation.path",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                ...
                "transformation.tag-manager-url" => Some((
                    "transformation.tagManagerUrl",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "transformation.transformation-id" => Some((
                ...
                "transformation.workspace-id" => Some((
                    "transformation.workspaceId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.account-id" => Some((
                    "trigger.accountId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                ...
                "trigger.check-validation.is-weak-reference" => Some((
                    "trigger.checkValidation.isWeakReference",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.check-validation.key" => Some((
                    "trigger.checkValidation.key",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.check-validation.type" => Some((
                    "trigger.checkValidation.type",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.check-validation.value" => Some((
                    "trigger.checkValidation.value",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.container-id" => Some((
                    "trigger.containerId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                ...
                "trigger.continuous-time-min-milliseconds.is-weak-reference" => Some((
                    "trigger.continuousTimeMinMilliseconds.isWeakReference",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.continuous-time-min-milliseconds.key" => Some((
                    "trigger.continuousTimeMinMilliseconds.key",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.continuous-time-min-milliseconds.type" => Some((
                    "trigger.continuousTimeMinMilliseconds.type",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.continuous-time-min-milliseconds.value" => Some((
                    "trigger.continuousTimeMinMilliseconds.value",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.event-name.is-weak-reference" => Some((
                    "trigger.eventName.isWeakReference",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.event-name.key" => Some((
                ...
                "trigger.event-name.type" => Some((
                    "trigger.eventName.type",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.event-name.value" => Some((
                ...
                "trigger.horizontal-scroll-percentage-list.is-weak-reference" => Some((
                    "trigger.horizontalScrollPercentageList.isWeakReference",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.horizontal-scroll-percentage-list.key" => Some((
                    "trigger.horizontalScrollPercentageList.key",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.horizontal-scroll-percentage-list.type" => Some((
                    "trigger.horizontalScrollPercentageList.type",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.horizontal-scroll-percentage-list.value" => Some((
                    "trigger.horizontalScrollPercentageList.value",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.interval.is-weak-reference" => Some((
                    "trigger.interval.isWeakReference",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.interval.key" => Some((
                    "trigger.interval.key",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.interval.type" => Some((
                ...
                "trigger.interval-seconds.is-weak-reference" => Some((
                    "trigger.intervalSeconds.isWeakReference",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.interval-seconds.key" => Some((
                    "trigger.intervalSeconds.key",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.interval-seconds.type" => Some((
                    "trigger.intervalSeconds.type",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.interval-seconds.value" => Some((
                    "trigger.intervalSeconds.value",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.limit.is-weak-reference" => Some((
                    "trigger.limit.isWeakReference",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.limit.key" => Some((
                    "trigger.limit.key",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                ...
                "trigger.max-timer-length-seconds.is-weak-reference" => Some((
                    "trigger.maxTimerLengthSeconds.isWeakReference",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.max-timer-length-seconds.key" => Some((
                    "trigger.maxTimerLengthSeconds.key",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.max-timer-length-seconds.type" => Some((
                    "trigger.maxTimerLengthSeconds.type",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.max-timer-length-seconds.value" => Some((
                    "trigger.maxTimerLengthSeconds.value",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                ...
                "trigger.selector.is-weak-reference" => Some((
                    "trigger.selector.isWeakReference",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.selector.key" => Some((
                    "trigger.selector.key",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.selector.type" => Some((
                ...
                "trigger.total-time-min-milliseconds.is-weak-reference" => Some((
                    "trigger.totalTimeMinMilliseconds.isWeakReference",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.total-time-min-milliseconds.key" => Some((
                    "trigger.totalTimeMinMilliseconds.key",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.total-time-min-milliseconds.type" => Some((
                    "trigger.totalTimeMinMilliseconds.type",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.total-time-min-milliseconds.value" => Some((
                    "trigger.totalTimeMinMilliseconds.value",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.trigger-id" => Some((
                    "trigger.triggerId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                ...
                "trigger.unique-trigger-id.is-weak-reference" => Some((
                    "trigger.uniqueTriggerId.isWeakReference",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.unique-trigger-id.key" => Some((
                    "trigger.uniqueTriggerId.key",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.unique-trigger-id.type" => Some((
                    "trigger.uniqueTriggerId.type",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.unique-trigger-id.value" => Some((
                    "trigger.uniqueTriggerId.value",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.vertical-scroll-percentage-list.is-weak-reference" => Some((
                    "trigger.verticalScrollPercentageList.isWeakReference",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.vertical-scroll-percentage-list.key" => Some((
                    "trigger.verticalScrollPercentageList.key",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.vertical-scroll-percentage-list.type" => Some((
                    "trigger.verticalScrollPercentageList.type",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.vertical-scroll-percentage-list.value" => Some((
                    "trigger.verticalScrollPercentageList.value",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.visibility-selector.is-weak-reference" => Some((
                    "trigger.visibilitySelector.isWeakReference",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.visibility-selector.key" => Some((
                    "trigger.visibilitySelector.key",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.visibility-selector.type" => Some((
                    "trigger.visibilitySelector.type",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.visibility-selector.value" => Some((
                    "trigger.visibilitySelector.value",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.visible-percentage-max.is-weak-reference" => Some((
                    "trigger.visiblePercentageMax.isWeakReference",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.visible-percentage-max.key" => Some((
                    "trigger.visiblePercentageMax.key",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.visible-percentage-max.type" => Some((
                    "trigger.visiblePercentageMax.type",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.visible-percentage-max.value" => Some((
                    "trigger.visiblePercentageMax.value",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.visible-percentage-min.is-weak-reference" => Some((
                    "trigger.visiblePercentageMin.isWeakReference",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.visible-percentage-min.key" => Some((
                    "trigger.visiblePercentageMin.key",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.visible-percentage-min.type" => Some((
                    "trigger.visiblePercentageMin.type",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.visible-percentage-min.value" => Some((
                    "trigger.visiblePercentageMin.value",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.wait-for-tags.is-weak-reference" => Some((
                    "trigger.waitForTags.isWeakReference",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.wait-for-tags.key" => Some((
                    "trigger.waitForTags.key",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.wait-for-tags.type" => Some((
                    "trigger.waitForTags.type",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.wait-for-tags.value" => Some((
                    "trigger.waitForTags.value",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.wait-for-tags-timeout.is-weak-reference" => Some((
                    "trigger.waitForTagsTimeout.isWeakReference",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.wait-for-tags-timeout.key" => Some((
                    "trigger.waitForTagsTimeout.key",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.wait-for-tags-timeout.type" => Some((
                    "trigger.waitForTagsTimeout.type",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.wait-for-tags-timeout.value" => Some((
                    "trigger.waitForTagsTimeout.value",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "trigger.workspace-id" => Some((
                    "trigger.workspaceId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                ...
                "variable.disabling-trigger-id" => Some((
                ...
                "variable.enabling-trigger-id" => Some((
                ...
                "variable.format-value.case-conversion-type" => Some((
                    "variable.formatValue.caseConversionType",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "variable.format-value.convert-false-to-value.is-weak-reference" => Some((
                    "variable.formatValue.convertFalseToValue.isWeakReference",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "variable.format-value.convert-false-to-value.key" => Some((
                    "variable.formatValue.convertFalseToValue.key",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "variable.format-value.convert-false-to-value.type" => Some((
                    "variable.formatValue.convertFalseToValue.type",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "variable.format-value.convert-false-to-value.value" => Some((
                    "variable.formatValue.convertFalseToValue.value",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "variable.format-value.convert-null-to-value.is-weak-reference" => Some((
                    "variable.formatValue.convertNullToValue.isWeakReference",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "variable.format-value.convert-null-to-value.key" => Some((
                    "variable.formatValue.convertNullToValue.key",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "variable.format-value.convert-null-to-value.type" => Some((
                    "variable.formatValue.convertNullToValue.type",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "variable.format-value.convert-null-to-value.value" => Some((
                    "variable.formatValue.convertNullToValue.value",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "variable.format-value.convert-true-to-value.is-weak-reference" => Some((
                    "variable.formatValue.convertTrueToValue.isWeakReference",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "variable.format-value.convert-true-to-value.key" => Some((
                    "variable.formatValue.convertTrueToValue.key",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "variable.format-value.convert-true-to-value.type" => Some((
                    "variable.formatValue.convertTrueToValue.type",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "variable.format-value.convert-true-to-value.value" => Some((
                    "variable.formatValue.convertTrueToValue.value",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "variable.format-value.convert-undefined-to-value.is-weak-reference" => Some((
                    "variable.formatValue.convertUndefinedToValue.isWeakReference",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "variable.format-value.convert-undefined-to-value.key" => Some((
                    "variable.formatValue.convertUndefinedToValue.key",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "variable.format-value.convert-undefined-to-value.type" => Some((
                    "variable.formatValue.convertUndefinedToValue.type",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "variable.format-value.convert-undefined-to-value.value" => Some((
                    "variable.formatValue.convertUndefinedToValue.value",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                ...
                "variable.parent-folder-id" => Some((
                ...
                "variable.schedule-end-ms" => Some((
                    "variable.scheduleEndMs",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "variable.schedule-start-ms" => Some((
                    "variable.scheduleStartMs",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "variable.tag-manager-url" => Some((
                ...
                "zone.boundary.custom-evaluation-trigger-id" => Some((
                ...
                "zone.type-restriction.enable" => Some((
                    "zone.typeRestriction.enable",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "zone.type-restriction.whitelisted-type-id" => Some((
                    "zone.typeRestriction.whitelistedTypeId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "zone.workspace-id" => Some((
                    "zone.workspaceId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        ...
                        &vec![
                            ...
                            "convert-false-to-value",
                            "convert-null-to-value",
                            "convert-true-to-value",
                            "convert-undefined-to-value",
                            "custom-evaluation-trigger-id",
                            "custom-template",
        ...
        let mut request: api::Entity = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_resolve_conflict(request, opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_sync(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_sync(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_tags_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "consent-settings.consent-status" => Some((
                ...
                "consent-settings.consent-type.is-weak-reference" => Some((
                ...
                "consent-settings.consent-type.key" => Some((
                ...
                "consent-settings.consent-type.type" => Some((
                ...
                "consent-settings.consent-type.value" => Some((
                ...
                "monitoring-metadata.is-weak-reference" => Some((
                ...
                "monitoring-metadata.value" => Some((
                ...
                "monitoring-metadata-tag-name-key" => Some((
                ...
                "priority.is-weak-reference" => Some((
        ...
        let mut request: api::Tag = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_tags_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_tags_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_tags_delete(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_tags_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_tags_get(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_tags_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_tags_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_tags_revert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_tags_revert(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_tags_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_tags_update(request, opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_templates_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "gallery-reference.is-modified" => Some((
                ...
                "gallery-reference.repository" => Some((
                ...
                "gallery-reference.version" => Some((
        ...
        let mut request: api::CustomTemplate = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_templates_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_templates_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_templates_delete(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_templates_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_templates_get(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_templates_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_templates_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_templates_revert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_templates_revert(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_templates_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_templates_update(request, opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_transformations_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::Transformation = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .accounts()
    ...
    async fn _accounts_containers_workspaces_transformations_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_transformations_delete(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_transformations_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_transformations_get(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_transformations_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_transformations_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_transformations_revert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_transformations_revert(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_transformations_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _accounts_containers_workspaces_triggers_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "check-validation.is-weak-reference" => Some((
                ...
                "continuous-time-min-milliseconds.is-weak-reference" => Some((
                ...
                "continuous-time-min-milliseconds.key" => Some((
                ...
                "continuous-time-min-milliseconds.type" => Some((
                ...
                "continuous-time-min-milliseconds.value" => Some((
                ...
                "event-name.is-weak-reference" => Some((
                ...
                "horizontal-scroll-percentage-list.is-weak-reference" => Some((
                ...
                "horizontal-scroll-percentage-list.key" => Some((
                ...
                "horizontal-scroll-percentage-list.type" => Some((
                ...
                "horizontal-scroll-percentage-list.value" => Some((
                ...
                "interval.is-weak-reference" => Some((
                ...
                "interval-seconds.is-weak-reference" => Some((
                ...
                "max-timer-length-seconds.is-weak-reference" => Some((
                ...
                "max-timer-length-seconds.key" => Some((
                ...
                "max-timer-length-seconds.type" => Some((
                ...
                "max-timer-length-seconds.value" => Some((
                ...
                "selector.is-weak-reference" => Some((
                ...
                "total-time-min-milliseconds.is-weak-reference" => Some((
                ...
                "total-time-min-milliseconds.key" => Some((
                ...
                "total-time-min-milliseconds.type" => Some((
                ...
                "total-time-min-milliseconds.value" => Some((
                ...
                "unique-trigger-id.is-weak-reference" => Some((
                ...
                "vertical-scroll-percentage-list.is-weak-reference" => Some((
                ...
                "vertical-scroll-percentage-list.key" => Some((
                ...
                "vertical-scroll-percentage-list.type" => Some((
                ...
                "vertical-scroll-percentage-list.value" => Some((
                ...
                "visibility-selector.is-weak-reference" => Some((
                ...
                "visibility-selector.value" => Some((
                ...
                "visible-percentage-max.is-weak-reference" => Some((
                ...
                "visible-percentage-max.key" => Some((
                ...
                "visible-percentage-max.type" => Some((
                ...
                "visible-percentage-max.value" => Some((
                ...
                "visible-percentage-min.is-weak-reference" => Some((
                ...
                "visible-percentage-min.key" => Some((
                ...
                "visible-percentage-min.type" => Some((
                ...
                "visible-percentage-min.value" => Some((
                ...
                "wait-for-tags.is-weak-reference" => Some((
                ...
                "wait-for-tags-timeout.is-weak-reference" => Some((
                ...
                "wait-for-tags-timeout.key" => Some((
                ...
                "wait-for-tags-timeout.type" => Some((
                ...
                "wait-for-tags-timeout.value" => Some((
        ...
        let mut request: api::Trigger = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_triggers_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_triggers_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_triggers_delete(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_triggers_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_triggers_get(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_triggers_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_triggers_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_triggers_revert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_triggers_revert(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_triggers_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_triggers_update(request, opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_update(request, opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_variables_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "format-value.case-conversion-type" => Some((
                ...
                "format-value.convert-false-to-value.is-weak-reference" => Some((
                ...
                "format-value.convert-false-to-value.key" => Some((
                ...
                "format-value.convert-false-to-value.type" => Some((
                ...
                "format-value.convert-false-to-value.value" => Some((
                ...
                "format-value.convert-null-to-value.is-weak-reference" => Some((
                ...
                "format-value.convert-null-to-value.key" => Some((
                ...
                "format-value.convert-null-to-value.type" => Some((
                ...
                "format-value.convert-null-to-value.value" => Some((
                ...
                "format-value.convert-true-to-value.is-weak-reference" => Some((
                ...
                "format-value.convert-true-to-value.key" => Some((
                ...
                "format-value.convert-true-to-value.type" => Some((
                ...
                "format-value.convert-true-to-value.value" => Some((
                ...
                "format-value.convert-undefined-to-value.is-weak-reference" => Some((
                ...
                "format-value.convert-undefined-to-value.key" => Some((
                ...
                "format-value.convert-undefined-to-value.type" => Some((
                ...
                "format-value.convert-undefined-to-value.value" => Some((
        ...
        let mut request: api::Variable = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_variables_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_variables_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_variables_delete(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_variables_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_variables_get(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_variables_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_variables_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_variables_revert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_variables_revert(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_variables_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_variables_update(request, opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_zones_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "boundary.custom-evaluation-trigger-id" => Some((
                ...
                "type-restriction.whitelisted-type-id" => Some((
        ...
        let mut request: api::Zone = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_zones_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_zones_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_zones_delete(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_zones_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_zones_get(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_zones_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_zones_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_zones_revert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_zones_revert(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_containers_workspaces_zones_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .containers_workspaces_zones_update(request, opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_list(
            ...
            .iter()
        {
            ...
            match key {
                ...
                "include-google-tags" => {
                    call = call.include_google_tags(
                        value
                            .map(|v| arg_from_str(v, err, "include-google-tags", "boolean"))
                            .unwrap_or(false),
                    );
                }
                _ => {
    ...
    async fn _accounts_update(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "features.support-multiple-containers" => Some((
        ...
        let mut call = self
            .hub
            .accounts()
            .update(request, opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_user_permissions_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                "account-access.permission" => Some((
        ...
        let mut request: api::UserPermission = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .accounts()
            .user_permissions_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_user_permissions_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .user_permissions_delete(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_user_permissions_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .user_permissions_get(opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_user_permissions_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .user_permissions_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _accounts_user_permissions_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .accounts()
            .user_permissions_update(request, opt.value_of("path").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _doit(
        ...
        match self.opt.subcommand() {
            ("accounts", Some(opt)) => match opt.subcommand() {
                ("containers-combine", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_combine(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-create", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_create(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-delete", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-destinations-get", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_destinations_get(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-destinations-link", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_destinations_link(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-destinations-list", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_destinations_list(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-environments-create", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_environments_create(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-environments-delete", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_environments_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-environments-get", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_environments_get(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-environments-list", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_environments_list(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-environments-reauthorize", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_environments_reauthorize(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-environments-update", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_environments_update(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("containers-lookup", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_lookup(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-move-tag-id", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_move_tag_id(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-snippet", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_snippet(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-update", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_update(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-version-headers-latest", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_version_headers_latest(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-version-headers-list", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_version_headers_list(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-versions-delete", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_versions_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-versions-get", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_versions_get(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-versions-live", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_versions_live(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-versions-publish", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_versions_publish(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-versions-set-latest", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_versions_set_latest(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-versions-undelete", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_versions_undelete(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-versions-update", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_versions_update(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-built-in-variables-create", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_built_in_variables_create(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("containers-workspaces-built-in-variables-delete", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_built_in_variables_delete(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("containers-workspaces-built-in-variables-list", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_built_in_variables_list(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("containers-workspaces-built-in-variables-revert", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_built_in_variables_revert(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ...
                ("containers-workspaces-clients-delete", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_clients_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-clients-get", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_clients_get(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-clients-list", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_clients_list(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-clients-revert", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_clients_revert(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-clients-update", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_clients_update(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-create", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_create(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-create-version", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_create_version(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-delete", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-folders-create", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_folders_create(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-folders-delete", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_folders_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-folders-entities", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_folders_entities(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-folders-get", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_folders_get(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-folders-list", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_folders_list(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-folders-move-entities-to-folder", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_folders_move_entities_to_folder(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("containers-workspaces-folders-revert", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_folders_revert(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-folders-update", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_folders_update(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-get", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_get(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-get-status", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_get_status(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-gtag-config-create", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_gtag_config_create(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-gtag-config-delete", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_gtag_config_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-gtag-config-get", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_gtag_config_get(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-gtag-config-list", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_gtag_config_list(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-gtag-config-update", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_gtag_config_update(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-list", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_list(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-quick-preview", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_quick_preview(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-resolve-conflict", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_resolve_conflict(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-sync", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_sync(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-tags-create", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_tags_create(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-tags-delete", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_tags_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-tags-get", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_tags_get(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-tags-list", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_tags_list(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-tags-revert", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_tags_revert(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-tags-update", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_tags_update(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-templates-create", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_templates_create(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-templates-delete", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_templates_delete(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("containers-workspaces-templates-list", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_templates_list(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-templates-revert", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_templates_revert(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-templates-update", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_templates_update(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-transformations-create", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_transformations_create(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("containers-workspaces-transformations-delete", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_transformations_delete(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("containers-workspaces-transformations-get", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_transformations_get(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-transformations-list", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_transformations_list(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("containers-workspaces-transformations-revert", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_transformations_revert(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("containers-workspaces-transformations-update", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_transformations_update(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("containers-workspaces-triggers-create", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_triggers_create(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-triggers-delete", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_triggers_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-triggers-get", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_triggers_get(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-triggers-list", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_triggers_list(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-triggers-revert", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_triggers_revert(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-triggers-update", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_triggers_update(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-update", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_update(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-variables-create", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_variables_create(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-variables-delete", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_variables_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-variables-get", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_variables_get(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-variables-list", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_variables_list(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-variables-revert", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_variables_revert(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-variables-update", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_variables_update(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-zones-create", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_zones_create(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-zones-delete", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_zones_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-zones-get", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_zones_get(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-zones-list", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_zones_list(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-zones-revert", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_zones_revert(opt, dry_run, &mut err)
                        .await;
                }
                ("containers-workspaces-zones-update", Some(opt)) => {
                    call_result = self
                        ._accounts_containers_workspaces_zones_update(opt, dry_run, &mut err)
                        .await;
                }
                ("get", Some(opt)) => {
                ...
                ("user-permissions-create", Some(opt)) => {
                    call_result = self
                        ._accounts_user_permissions_create(opt, dry_run, &mut err)
                        .await;
                }
                ("user-permissions-delete", Some(opt)) => {
                    call_result = self
                        ._accounts_user_permissions_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("user-permissions-get", Some(opt)) => {
                    call_result = self
                        ._accounts_user_permissions_get(opt, dry_run, &mut err)
                        .await;
                }
                ("user-permissions-list", Some(opt)) => {
                    call_result = self
                        ._accounts_user_permissions_list(opt, dry_run, &mut err)
                        .await;
                }
                ("user-permissions-update", Some(opt)) => {
                    call_result = self
                        ._accounts_user_permissions_update(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("accounts".to_string()));
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "tagmanager2-secret.json",
