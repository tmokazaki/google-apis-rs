...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/libraryagent1).
//! # Features
//!
//! Handle the following *Resources* with ease from the central [hub](Libraryagent) ...
//!
//! * shelves
//!  * [*books borrow*](api::ShelfBookBorrowCall), [*books get*](api::ShelfBookGetCall), [*books list*](api::ShelfBookListCall), [*books return*](api::ShelfBookReturnCall), [*get*](api::ShelfGetCall) and [*list*](api::ShelfListCall)
//!
//!
//!
//!
