...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/ondemandscanning1).
//! # Features
//!
//! Handle the following *Resources* with ease from the central [hub](OnDemandScanning) ...
//!
//! * projects
...
//!              .timeout(chrono::Duration::seconds(6137916))
//!              .doit().await;
//!
//! match result {
//!     Err(e) => match e {
