...
impl<C> common::Hub for OnDemandScanning<C> {}

impl<'a, C> OnDemandScanning<C> {
...
impl common::RequestValue for AnalyzePackagesRequestV1 {}
...
impl common::Part for BinarySourceInfo {}
...
impl common::Part for LanguagePackageDependency {}
...
impl common::ResponseResult for ListVulnerabilitiesResponseV1 {}
...
impl common::Part for Maintainer {}
...
impl common::Part for Occurrence {}
...
impl common::Part for PackageData {}
...
impl common::Part for PackageVersion {}
...
impl<'a, C> ProjectMethods<'a, C> {
    ...
    pub fn locations_scans_vulnerabilities_list(
        &self,
        parent: &str,
    ) -> ProjectLocationScanVulnerabilityListCall<'a, C> {
    ...
    pub fn locations_scans_analyze_packages(
        ...
        parent: &str,
    ) -> ProjectLocationScanAnalyzePackageCall<'a, C> {
    ...
    C: common::Connector,
{
    ...
    pub async fn doit(mut self) -> common::Result<(common::Response, Operation)> {
        ...
        if let Some(value) = self._timeout.as_ref() {
            params.push("timeout", common::serde::duration::to_string(&value));
        }
...
/// # }
/// ```
pub struct ProjectLocationScanVulnerabilityListCall<'a, C>
where
    C: 'a,
{
    hub: &'a OnDemandScanning<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationScanVulnerabilityListCall<'a, C> {}

impl<'a, C> ProjectLocationScanVulnerabilityListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(
        mut self,
    ) -> common::Result<(common::Response, ListVulnerabilitiesResponseV1)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> ProjectLocationScanVulnerabilityListCall<'a, C> {
    ...
    ///
    /// Sets the *page size* query property to the given value.
    pub fn page_size(mut self, new_value: i32) -> ProjectLocationScanVulnerabilityListCall<'a, C> {
        self._page_size = Some(new_value);
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationScanVulnerabilityListCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationScanVulnerabilityListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationScanVulnerabilityListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationScanVulnerabilityListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationScanAnalyzePackageCall<'a, C>
where
    C: 'a,
{
    hub: &'a OnDemandScanning<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationScanAnalyzePackageCall<'a, C> {}

impl<'a, C> ProjectLocationScanAnalyzePackageCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    pub fn request(
        mut self,
        new_value: AnalyzePackagesRequestV1,
    ) -> ProjectLocationScanAnalyzePackageCall<'a, C> {
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> ProjectLocationScanAnalyzePackageCall<'a, C> {
        self._parent = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationScanAnalyzePackageCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationScanAnalyzePackageCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationScanAnalyzePackageCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationScanAnalyzePackageCall<'a, C> {
        self._scopes.clear();
        self
    }
}
