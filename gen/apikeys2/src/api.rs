...
impl<C> common::Hub for ApiKeysService<C> {}

impl<'a, C> ApiKeysService<C> {
    ...
    pub fn keys(&'a self) -> KeyMethods<'a, C> {
        KeyMethods { hub: self }
    }
...
impl common::Part for V2AndroidApplication {}
...
impl common::Part for V2AndroidKeyRestrictions {}
...
impl common::Part for V2ApiTarget {}
...
impl common::Part for V2BrowserKeyRestrictions {}
...
impl common::ResponseResult for V2GetKeyStringResponse {}
...
impl common::Part for V2IosKeyRestrictions {}
...
impl common::RequestValue for V2Key {}
impl common::ResponseResult for V2Key {}
...
impl common::ResponseResult for V2ListKeysResponse {}
...
impl common::ResponseResult for V2LookupKeyResponse {}
...
impl common::Part for V2Restrictions {}
...
impl common::Part for V2ServerKeyRestrictions {}
...
impl common::RequestValue for V2UndeleteKeyRequest {}
...
/// # }
/// ```
pub struct KeyMethods<'a, C>
where
    C: 'a,
{
    hub: &'a ApiKeysService<C>,
}

impl<'a, C> common::MethodsBuilder for KeyMethods<'a, C> {}
...
impl<'a, C> ProjectMethods<'a, C> {
    ...
    pub fn locations_keys_get_key_string(
        &self,
        name: &str,
    ...
    pub fn locations_keys_undelete(
        &self,
...
/// # }
/// ```
pub struct KeyLookupKeyCall<'a, C>
where
    C: 'a,
{
    hub: &'a ApiKeysService<C>,
...
impl<'a, C> common::CallBuilder for KeyLookupKeyCall<'a, C> {}

impl<'a, C> KeyLookupKeyCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, V2LookupKeyResponse)> {
        use std::borrow::Cow;
        ...
        if let Some(value) = self._key_string.as_ref() {
            params.push("keyString", value);
        }
    ...
    pub fn key_string(mut self, new_value: &str) -> KeyLookupKeyCall<'a, C> {
    ...
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> KeyLookupKeyCall<'a, C> {
    ...
    pub fn param<T>(mut self, name: T, value: T) -> KeyLookupKeyCall<'a, C>
    where
        T: AsRef<str>,
    {
    ...
    pub fn add_scope<St>(mut self, scope: St) -> KeyLookupKeyCall<'a, C>
    where
        St: AsRef<str>,
    {
    ...
    pub fn add_scopes<I, St>(mut self, scopes: I) -> KeyLookupKeyCall<'a, C>
    where
    ...
    /// for details).
    pub fn clear_scopes(mut self) -> KeyLookupKeyCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationKeyCreateCall<'a, C>
where
    C: 'a,
{
    hub: &'a ApiKeysService<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationKeyCreateCall<'a, C> {}

impl<'a, C> ProjectLocationKeyCreateCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: V2Key) -> ProjectLocationKeyCreateCall<'a, C> {
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> ProjectLocationKeyCreateCall<'a, C> {
    ...
    pub fn key_id(mut self, new_value: &str) -> ProjectLocationKeyCreateCall<'a, C> {
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationKeyCreateCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationKeyCreateCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationKeyCreateCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationKeyCreateCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationKeyDeleteCall<'a, C>
where
    C: 'a,
{
    hub: &'a ApiKeysService<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationKeyDeleteCall<'a, C> {}

impl<'a, C> ProjectLocationKeyDeleteCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationKeyDeleteCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    ...
    pub fn etag(mut self, new_value: &str) -> ProjectLocationKeyDeleteCall<'a, C> {
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationKeyDeleteCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationKeyDeleteCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationKeyDeleteCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationKeyDeleteCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationKeyGetCall<'a, C>
where
    C: 'a,
{
    hub: &'a ApiKeysService<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationKeyGetCall<'a, C> {}

impl<'a, C> ProjectLocationKeyGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, V2Key)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationKeyGetCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationKeyGetCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationKeyGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationKeyGetCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationKeyGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationKeyGetKeyStringCall<'a, C>
where
    C: 'a,
{
    hub: &'a ApiKeysService<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationKeyGetKeyStringCall<'a, C> {}

impl<'a, C> ProjectLocationKeyGetKeyStringCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, V2GetKeyStringResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationKeyGetKeyStringCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationKeyGetKeyStringCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationKeyGetKeyStringCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationKeyGetKeyStringCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationKeyGetKeyStringCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationKeyListCall<'a, C>
where
    C: 'a,
{
    hub: &'a ApiKeysService<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationKeyListCall<'a, C> {}

impl<'a, C> ProjectLocationKeyListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, V2ListKeysResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> ProjectLocationKeyListCall<'a, C> {
        self._parent = new_value.to_string();
        self
    }
    ...
    pub fn show_deleted(mut self, new_value: bool) -> ProjectLocationKeyListCall<'a, C> {
    ...
    pub fn page_token(mut self, new_value: &str) -> ProjectLocationKeyListCall<'a, C> {
    ...
    pub fn page_size(mut self, new_value: i32) -> ProjectLocationKeyListCall<'a, C> {
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationKeyListCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationKeyListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationKeyListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationKeyListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationKeyPatchCall<'a, C>
where
    C: 'a,
{
    hub: &'a ApiKeysService<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationKeyPatchCall<'a, C> {}

impl<'a, C> ProjectLocationKeyPatchCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: V2Key) -> ProjectLocationKeyPatchCall<'a, C> {
        self._request = new_value;
        self
    }
    /// Output only. The resource name of the key. The `name` has the form: `projects//locations/global/keys/`. For example: `projects/123456867718/locations/global/keys/b7ff1f9f-8275-410a-94dd-3855ee9b5dd2` NOTE: Key is a global resource; hence the only supported value for location is `global`.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationKeyPatchCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationKeyPatchCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationKeyPatchCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationKeyPatchCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationKeyPatchCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationKeyUndeleteCall<'a, C>
where
    C: 'a,
{
    hub: &'a ApiKeysService<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationKeyUndeleteCall<'a, C> {}

impl<'a, C> ProjectLocationKeyUndeleteCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    pub fn request(
        mut self,
        new_value: V2UndeleteKeyRequest,
    ) -> ProjectLocationKeyUndeleteCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationKeyUndeleteCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationKeyUndeleteCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationKeyUndeleteCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationKeyUndeleteCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationKeyUndeleteCall<'a, C> {
        self._scopes.clear();
        self
    }
}
