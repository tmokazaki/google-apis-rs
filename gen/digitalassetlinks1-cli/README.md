...
Find the source code [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/digitalassetlinks1-cli).

# Usage

This documentation was generated from the *digitalassetlinks* API at revision *20240622*. The CLI is at version *7.0.0*.

```bash
digitalassetlinks1 [options]
        assetlinks
                bulk-check (-r <kv>)... [-p <v>]... [-o <out>]
                check [-p <v>]... [-o <out>]
        statements
                list [-p <v>]... [-o <out>]
