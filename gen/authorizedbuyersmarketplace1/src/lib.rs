...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/authorizedbuyersmarketplace1).
//! # Features
//!
...
//!
//! * **[Hub](AuthorizedBuyersMarketplace)**
...
pub mod api;
pub use api::AuthorizedBuyersMarketplace;
