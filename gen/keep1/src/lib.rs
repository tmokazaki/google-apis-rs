...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/keep1).
//! # Features
//!
//! Handle the following *Resources* with ease from the central [hub](Keep) ...
//!
//! * media
//!  * [*download*](api::MediaDownloadCall)
//! * [notes](api::Note)
//!  * [*create*](api::NoteCreateCall), [*delete*](api::NoteDeleteCall), [*get*](api::NoteGetCall), [*list*](api::NoteListCall), [*permissions batch create*](api::NotePermissionBatchCreateCall) and [*permissions batch delete*](api::NotePermissionBatchDeleteCall)
//!
//!
