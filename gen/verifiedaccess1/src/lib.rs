...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/verifiedaccess1).
//! # Features
//!
//! Handle the following *Resources* with ease from the central [hub](Verifiedaccess) ...
//!
//! * [challenge](api::Challenge)
//!  * [*create*](api::ChallengeCreateCall) and [*verify*](api::ChallengeVerifyCall)
//!
//!
//!
//!
