...
use google_cloudresourcemanager1::{api, yup_oauth2, Error};
...
{
    async fn _folders_clear_org_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        ...
        let mut request: api::ClearOrgPolicyRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .folders()
            .clear_org_policy(request, opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _folders_get_effective_org_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(key, &vec!["constraint"]);
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
                        value.map(|v| v.to_string()),
        ...
        let mut request: api::GetEffectiveOrgPolicyRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .folders()
            .get_effective_org_policy(request, opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _folders_get_org_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::GetOrgPolicyRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .folders()
            .get_org_policy(request, opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _folders_list_available_org_policy_constraints(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::ListAvailableOrgPolicyConstraintsRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .folders()
            .list_available_org_policy_constraints(request, opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _folders_list_org_policies(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::ListOrgPoliciesRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .folders()
            .list_org_policies(request, opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _folders_set_org_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                "policy.boolean-policy.enforced" => Some((
                ...
                "policy.list-policy.all-values" => Some((
                ...
                "policy.list-policy.allowed-values" => Some((
                ...
                "policy.list-policy.denied-values" => Some((
                ...
                "policy.list-policy.inherit-from-parent" => Some((
                    "policy.listPolicy.inheritFromParent",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "policy.list-policy.suggested-value" => Some((
                    "policy.listPolicy.suggestedValue",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "policy.update-time" => Some((
                    "policy.updateTime",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
        ...
        let mut request: api::SetOrgPolicyRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .folders()
            .set_org_policy(request, opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _organizations_clear_org_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _organizations_get_effective_org_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _organizations_get_org_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _organizations_list_available_org_policy_constraints(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _organizations_list_org_policies(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _organizations_search(
        ...
        let mut request: api::SearchOrganizationsRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.organizations().search(request);
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _organizations_set_org_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_clear_org_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_delete(
        ...
        let mut call = self
            .hub
            .projects()
            .delete(opt.value_of("project-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_get(
        ...
        let mut call = self
            .hub
            .projects()
            .get(opt.value_of("project-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_get_ancestry(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::GetAncestryRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .get_ancestry(request, opt.value_of("project-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_get_effective_org_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_get_org_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_list_available_org_policy_constraints(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_list_org_policies(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_set_org_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_undelete(
        ...
        let mut call = self
            .hub
            .projects()
            .undelete(request, opt.value_of("project-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_update(
        ...
        let mut call = self
            .hub
            .projects()
            .update(request, opt.value_of("project-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
        ...
        match self.opt.subcommand() {
            ("folders", Some(opt)) => match opt.subcommand() {
                ...
                ("get-effective-org-policy", Some(opt)) => {
                    call_result = self
                        ._folders_get_effective_org_policy(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("list-available-org-policy-constraints", Some(opt)) => {
                    call_result = self
                        ._folders_list_available_org_policy_constraints(opt, dry_run, &mut err)
                        .await;
                }
                ("list-org-policies", Some(opt)) => {
                    call_result = self
                        ._folders_list_org_policies(opt, dry_run, &mut err)
                        .await;
                }
            ...
            ("organizations", Some(opt)) => match opt.subcommand() {
                ("clear-org-policy", Some(opt)) => {
                    call_result = self
                        ._organizations_clear_org_policy(opt, dry_run, &mut err)
                        .await;
                }
                ("get", Some(opt)) => {
                ...
                ("get-effective-org-policy", Some(opt)) => {
                    call_result = self
                        ._organizations_get_effective_org_policy(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("get-org-policy", Some(opt)) => {
                    call_result = self
                        ._organizations_get_org_policy(opt, dry_run, &mut err)
                        .await;
                }
                ("list-available-org-policy-constraints", Some(opt)) => {
                    call_result = self
                        ._organizations_list_available_org_policy_constraints(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("list-org-policies", Some(opt)) => {
                    call_result = self
                        ._organizations_list_org_policies(opt, dry_run, &mut err)
                        .await;
                }
                ("search", Some(opt)) => {
                ...
                ("set-org-policy", Some(opt)) => {
                    call_result = self
                        ._organizations_set_org_policy(opt, dry_run, &mut err)
                        .await;
                }
            ...
            ("projects", Some(opt)) => match opt.subcommand() {
                ("clear-org-policy", Some(opt)) => {
                    call_result = self
                        ._projects_clear_org_policy(opt, dry_run, &mut err)
                        .await;
                }
                ("create", Some(opt)) => {
                ...
                ("get-effective-org-policy", Some(opt)) => {
                    call_result = self
                        ._projects_get_effective_org_policy(opt, dry_run, &mut err)
                        .await;
                }
                ("get-iam-policy", Some(opt)) => {
                ...
                ("list-available-org-policy-constraints", Some(opt)) => {
                    call_result = self
                        ._projects_list_available_org_policy_constraints(opt, dry_run, &mut err)
                        .await;
                }
                ("list-org-policies", Some(opt)) => {
                    call_result = self
                        ._projects_list_org_policies(opt, dry_run, &mut err)
                        .await;
                }
                ("set-iam-policy", Some(opt)) => {
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "cloudresourcemanager1-secret.json",
...
async fn main() {
    ...
    let arg_data = [
        ("folders", "methods: 'clear-org-policy', 'get-effective-org-policy', 'get-org-policy', 'list-available-org-policy-constraints', 'list-org-policies' and 'set-org-policy'", vec![
            ("clear-org-policy",
                    Some(r##"Clears a `Policy` from a resource."##),
                    "Details at http://byron.github.io/google-apis-rs/google_cloudresourcemanager1_cli/folders_clear-org-policy",
                  vec![
                    (Some(r##"resource"##),
                     None,
                     Some(r##"Name of the resource for the `Policy` to clear."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("get-effective-org-policy",
                  ...
                  vec![
                    (Some(r##"resource"##),
                     None,
                     Some(r##"The name of the resource to start computing the effective `Policy`."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("get-org-policy",
                  ...
                  vec![
                    (Some(r##"resource"##),
                     None,
                     Some(r##"Name of the resource the `Policy` is set on."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("list-available-org-policy-constraints",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_cloudresourcemanager1_cli/folders_list-available-org-policy-constraints",
                  vec![
                    (Some(r##"resource"##),
                     None,
                     Some(r##"Name of the resource to list `Constraints` for."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("list-org-policies",
                    Some(r##"Lists all the `Policies` set for a particular resource."##),
                    "Details at http://byron.github.io/google-apis-rs/google_cloudresourcemanager1_cli/folders_list-org-policies",
                  vec![
                    (Some(r##"resource"##),
                     None,
                     Some(r##"Name of the resource to list Policies for."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("set-org-policy",
                  ...
                  vec![
                    (Some(r##"resource"##),
                     None,
                     Some(r##"Resource name of the resource to attach the `Policy`."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("organizations", "methods: 'clear-org-policy', 'get', 'get-effective-org-policy', 'get-iam-policy', 'get-org-policy', 'list-available-org-policy-constraints', 'list-org-policies', 'search', 'set-iam-policy', 'set-org-policy' and 'test-iam-permissions'", vec![
            ("clear-org-policy",
                    Some(r##"Clears a `Policy` from a resource."##),
                    "Details at http://byron.github.io/google-apis-rs/google_cloudresourcemanager1_cli/organizations_clear-org-policy",
                  vec![
                    (Some(r##"resource"##),
                     None,
                     Some(r##"Name of the resource for the `Policy` to clear."##),
            ...
            ("get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_cloudresourcemanager1_cli/organizations_get",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("list-available-org-policy-constraints",
                    Some(r##"Lists `Constraints` that could be applied on the specified resource."##),
                    "Details at http://byron.github.io/google-apis-rs/google_cloudresourcemanager1_cli/organizations_list-available-org-policy-constraints",
                  vec![
                    (Some(r##"resource"##),
                     None,
                     Some(r##"Name of the resource to list `Constraints` for."##),
            ...
            ("list-org-policies",
                    Some(r##"Lists all the `Policies` set for a particular resource."##),
                    "Details at http://byron.github.io/google-apis-rs/google_cloudresourcemanager1_cli/organizations_list-org-policies",
                  vec![
                    (Some(r##"resource"##),
                     None,
                     Some(r##"Name of the resource to list Policies for."##),
            ...
            ("projects", "methods: 'clear-org-policy', 'create', 'delete', 'get', 'get-ancestry', 'get-effective-org-policy', 'get-iam-policy', 'get-org-policy', 'list', 'list-available-org-policy-constraints', 'list-org-policies', 'set-iam-policy', 'set-org-policy', 'test-iam-permissions', 'undelete' and 'update'", vec![
            ("clear-org-policy",
                    Some(r##"Clears a `Policy` from a resource."##),
                    "Details at http://byron.github.io/google-apis-rs/google_cloudresourcemanager1_cli/projects_clear-org-policy",
                  vec![
                    (Some(r##"resource"##),
                     None,
                     Some(r##"Name of the resource for the `Policy` to clear."##),
            ...
            ("list-available-org-policy-constraints",
                    Some(r##"Lists `Constraints` that could be applied on the specified resource."##),
                    "Details at http://byron.github.io/google-apis-rs/google_cloudresourcemanager1_cli/projects_list-available-org-policy-constraints",
                  vec![
                    (Some(r##"resource"##),
                     None,
                     Some(r##"Name of the resource to list `Constraints` for."##),
            ...
            ("list-org-policies",
                    Some(r##"Lists all the `Policies` set for a particular resource."##),
                    "Details at http://byron.github.io/google-apis-rs/google_cloudresourcemanager1_cli/projects_list-org-policies",
                  vec![
                    (Some(r##"resource"##),
                     None,
                     Some(r##"Name of the resource to list Policies for."##),
