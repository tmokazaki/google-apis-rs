...
use google_cloudtasks2_beta3::{api, yup_oauth2, Error};
    ...
    C: apis_common::Connector,
{
    ...
    async fn _projects_locations_queues_create(
            ...
            .iter()
        {
            ...
            {
                "app-engine-http-queue.app-engine-routing-override.host" => Some((
                    "appEngineHttpQueue.appEngineRoutingOverride.host",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "app-engine-http-queue.app-engine-routing-override.instance" => Some((
                    "appEngineHttpQueue.appEngineRoutingOverride.instance",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "app-engine-http-queue.app-engine-routing-override.service" => Some((
                    "appEngineHttpQueue.appEngineRoutingOverride.service",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "app-engine-http-queue.app-engine-routing-override.version" => Some((
                    "appEngineHttpQueue.appEngineRoutingOverride.version",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "cloudtasks2-beta3-secret.json",
    ...
    let arg_data = [
        ("projects", "methods: 'locations-get', 'locations-get-cmek-config', 'locations-list', 'locations-queues-create', 'locations-queues-delete', 'locations-queues-get', 'locations-queues-get-iam-policy', 'locations-queues-list', 'locations-queues-patch', 'locations-queues-pause', 'locations-queues-purge', 'locations-queues-resume', 'locations-queues-set-iam-policy', 'locations-queues-tasks-buffer', 'locations-queues-tasks-create', 'locations-queues-tasks-delete', 'locations-queues-tasks-get', 'locations-queues-tasks-list', 'locations-queues-tasks-run', 'locations-queues-test-iam-permissions' and 'locations-update-cmek-config'", vec![
            ...
            ("locations-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_cloudtasks2_beta3_cli/projects_locations-list",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-queues-get",
                    Some(r##"Gets a queue."##),
                    "Details at http://byron.github.io/google-apis-rs/google_cloudtasks2_beta3_cli/projects_locations-queues-get",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-queues-get-iam-policy",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_cloudtasks2_beta3_cli/projects_locations-queues-get-iam-policy",
                  vec![
                    (Some(r##"resource"##),
                     None,
            ...
            ("locations-queues-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_cloudtasks2_beta3_cli/projects_locations-queues-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("locations-queues-pause",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_cloudtasks2_beta3_cli/projects_locations-queues-pause",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-queues-purge",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_cloudtasks2_beta3_cli/projects_locations-queues-purge",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The queue name. For example: `projects/PROJECT_ID/location/LOCATION_ID/queues/QUEUE_ID`"##),
            ...
            ("locations-queues-set-iam-policy",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_cloudtasks2_beta3_cli/projects_locations-queues-set-iam-policy",
                  vec![
                    (Some(r##"resource"##),
                     None,
            ...
            ("locations-queues-tasks-delete",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_cloudtasks2_beta3_cli/projects_locations-queues-tasks-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-queues-tasks-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_cloudtasks2_beta3_cli/projects_locations-queues-tasks-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The queue name. For example: `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID`"##),
            ...
            ("locations-queues-tasks-run",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_cloudtasks2_beta3_cli/projects_locations-queues-tasks-run",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The task name. For example: `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID/tasks/TASK_ID`"##),
            ...
            ("locations-queues-test-iam-permissions",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_cloudtasks2_beta3_cli/projects_locations-queues-test-iam-permissions",
                  vec![
                    (Some(r##"resource"##),
                     None,
