...
Find the source code [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/drive3-cli).

# Usage

This documentation was generated from the *drive* API at revision *20240618*. The CLI is at version *7.0.0*.
