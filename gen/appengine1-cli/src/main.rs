...
use google_appengine1::{api, yup_oauth2, Error};
...
{
    async fn _apps_authorized_certificates_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        ...
        let mut call = self
            .hub
            .apps()
            .authorized_certificates_create(request, opt.value_of("apps-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _apps_authorized_certificates_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.apps().authorized_certificates_delete(
    ...
    async fn _apps_authorized_certificates_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.apps().authorized_certificates_get(
            opt.value_of("apps-id").unwrap_or(""),
            opt.value_of("authorized-certificates-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _apps_authorized_certificates_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .apps()
            .authorized_certificates_list(opt.value_of("apps-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _apps_authorized_certificates_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::AuthorizedCertificate =
            serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.apps().authorized_certificates_patch(
            request,
            opt.value_of("apps-id").unwrap_or(""),
            opt.value_of("authorized-certificates-id").unwrap_or(""),
        );
    ...
    async fn _apps_authorized_domains_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .apps()
            .authorized_domains_list(opt.value_of("apps-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _apps_domain_mappings_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .apps()
            .domain_mappings_create(request, opt.value_of("apps-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _apps_domain_mappings_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.apps().domain_mappings_delete(
            opt.value_of("apps-id").unwrap_or(""),
    ...
    async fn _apps_domain_mappings_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.apps().domain_mappings_get(
            opt.value_of("apps-id").unwrap_or(""),
            opt.value_of("domain-mappings-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _apps_domain_mappings_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .apps()
            .domain_mappings_list(opt.value_of("apps-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _apps_domain_mappings_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::DomainMapping = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.apps().domain_mappings_patch(
            request,
            opt.value_of("apps-id").unwrap_or(""),
            opt.value_of("domain-mappings-id").unwrap_or(""),
        );
    ...
    async fn _apps_firewall_ingress_rules_batch_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::BatchUpdateIngressRulesRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .apps()
            .firewall_ingress_rules_batch_update(request, opt.value_of("apps-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _apps_firewall_ingress_rules_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec!["action", "description", "priority", "source-range"],
                    );
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
        ...
        let mut request: api::FirewallRule = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .apps()
            .firewall_ingress_rules_create(request, opt.value_of("apps-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _apps_firewall_ingress_rules_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.apps().firewall_ingress_rules_delete(
            opt.value_of("apps-id").unwrap_or(""),
            opt.value_of("ingress-rules-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _apps_firewall_ingress_rules_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.apps().firewall_ingress_rules_get(
            opt.value_of("apps-id").unwrap_or(""),
            opt.value_of("ingress-rules-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _apps_firewall_ingress_rules_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .apps()
            .firewall_ingress_rules_list(opt.value_of("apps-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["matching-address", "page-size", "page-token"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _apps_firewall_ingress_rules_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::FirewallRule = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.apps().firewall_ingress_rules_patch(
            request,
            opt.value_of("apps-id").unwrap_or(""),
            opt.value_of("ingress-rules-id").unwrap_or(""),
        );
    ...
    async fn _apps_list_runtimes(
        ...
        let mut call = self
            .hub
            .apps()
            .list_runtimes(opt.value_of("apps-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _apps_locations_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.apps().locations_get(
            opt.value_of("apps-id").unwrap_or(""),
    ...
    async fn _apps_locations_list(
        ...
        let mut call = self
            .hub
            .apps()
            .locations_list(opt.value_of("apps-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _apps_operations_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.apps().operations_get(
            opt.value_of("apps-id").unwrap_or(""),
            opt.value_of("operations-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _apps_operations_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .apps()
            .operations_list(opt.value_of("apps-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _apps_patch(
        ...
        let mut call = self
            .hub
            .apps()
            .patch(request, opt.value_of("apps-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _apps_repair(
        ...
        let mut request: api::RepairApplicationRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .apps()
            .repair(request, opt.value_of("apps-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _apps_services_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.apps().services_delete(
            opt.value_of("apps-id").unwrap_or(""),
    ...
    async fn _apps_services_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.apps().services_get(
            opt.value_of("apps-id").unwrap_or(""),
            opt.value_of("services-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _apps_services_list(
        ...
        let mut call = self
            .hub
            .apps()
            .services_list(opt.value_of("apps-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _apps_services_patch(
        ...
        let mut call = self.hub.apps().services_patch(
            request,
            opt.value_of("apps-id").unwrap_or(""),
            opt.value_of("services-id").unwrap_or(""),
        );
    ...
    async fn _apps_services_versions_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self.hub.apps().services_versions_create(
            request,
            opt.value_of("apps-id").unwrap_or(""),
            opt.value_of("services-id").unwrap_or(""),
        );
    ...
    async fn _apps_services_versions_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.apps().services_versions_delete(
            opt.value_of("apps-id").unwrap_or(""),
            opt.value_of("services-id").unwrap_or(""),
    ...
    async fn _apps_services_versions_get(
        ...
        let mut call = self.hub.apps().services_versions_get(
            opt.value_of("apps-id").unwrap_or(""),
            opt.value_of("services-id").unwrap_or(""),
            opt.value_of("versions-id").unwrap_or(""),
        );
    ...
    async fn _apps_services_versions_instances_debug(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::DebugInstanceRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.apps().services_versions_instances_debug(
            request,
            opt.value_of("apps-id").unwrap_or(""),
            opt.value_of("services-id").unwrap_or(""),
            opt.value_of("versions-id").unwrap_or(""),
            opt.value_of("instances-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _apps_services_versions_instances_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.apps().services_versions_instances_delete(
            opt.value_of("apps-id").unwrap_or(""),
            opt.value_of("services-id").unwrap_or(""),
            opt.value_of("versions-id").unwrap_or(""),
            opt.value_of("instances-id").unwrap_or(""),
    ...
    async fn _apps_services_versions_instances_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.apps().services_versions_instances_get(
            opt.value_of("apps-id").unwrap_or(""),
            opt.value_of("services-id").unwrap_or(""),
            opt.value_of("versions-id").unwrap_or(""),
            opt.value_of("instances-id").unwrap_or(""),
    ...
    async fn _apps_services_versions_instances_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.apps().services_versions_instances_list(
            opt.value_of("apps-id").unwrap_or(""),
            opt.value_of("services-id").unwrap_or(""),
            opt.value_of("versions-id").unwrap_or(""),
        );
    ...
    async fn _apps_services_versions_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.apps().services_versions_list(
            opt.value_of("apps-id").unwrap_or(""),
            opt.value_of("services-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _apps_services_versions_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::Version = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.apps().services_versions_patch(
            request,
            opt.value_of("apps-id").unwrap_or(""),
            opt.value_of("services-id").unwrap_or(""),
            opt.value_of("versions-id").unwrap_or(""),
    ...
    async fn _projects_locations_applications_authorized_domains_list(
        ...
        let mut call = self
            .hub
            .projects()
            .locations_applications_authorized_domains_list(
        ...
        match self.opt.subcommand() {
            ("apps", Some(opt)) => match opt.subcommand() {
                ("authorized-certificates-create", Some(opt)) => {
                    call_result = self
                        ._apps_authorized_certificates_create(opt, dry_run, &mut err)
                        .await;
                }
                ("authorized-certificates-delete", Some(opt)) => {
                    call_result = self
                        ._apps_authorized_certificates_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("authorized-certificates-get", Some(opt)) => {
                    call_result = self
                        ._apps_authorized_certificates_get(opt, dry_run, &mut err)
                        .await;
                }
                ("authorized-certificates-list", Some(opt)) => {
                    call_result = self
                        ._apps_authorized_certificates_list(opt, dry_run, &mut err)
                        .await;
                }
                ("authorized-certificates-patch", Some(opt)) => {
                    call_result = self
                        ._apps_authorized_certificates_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("authorized-domains-list", Some(opt)) => {
                    call_result = self
                        ._apps_authorized_domains_list(opt, dry_run, &mut err)
                        .await;
                }
                ("create", Some(opt)) => {
                ...
                ("domain-mappings-create", Some(opt)) => {
                    call_result = self
                        ._apps_domain_mappings_create(opt, dry_run, &mut err)
                        .await;
                }
                ("domain-mappings-delete", Some(opt)) => {
                    call_result = self
                        ._apps_domain_mappings_delete(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("domain-mappings-list", Some(opt)) => {
                    call_result = self
                        ._apps_domain_mappings_list(opt, dry_run, &mut err)
                        .await;
                }
                ("domain-mappings-patch", Some(opt)) => {
                    call_result = self
                        ._apps_domain_mappings_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("firewall-ingress-rules-batch-update", Some(opt)) => {
                    call_result = self
                        ._apps_firewall_ingress_rules_batch_update(opt, dry_run, &mut err)
                        .await;
                }
                ("firewall-ingress-rules-create", Some(opt)) => {
                    call_result = self
                        ._apps_firewall_ingress_rules_create(opt, dry_run, &mut err)
                        .await;
                }
                ("firewall-ingress-rules-delete", Some(opt)) => {
                    call_result = self
                        ._apps_firewall_ingress_rules_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("firewall-ingress-rules-get", Some(opt)) => {
                    call_result = self
                        ._apps_firewall_ingress_rules_get(opt, dry_run, &mut err)
                        .await;
                }
                ("firewall-ingress-rules-list", Some(opt)) => {
                    call_result = self
                        ._apps_firewall_ingress_rules_list(opt, dry_run, &mut err)
                        .await;
                }
                ("firewall-ingress-rules-patch", Some(opt)) => {
                    call_result = self
                        ._apps_firewall_ingress_rules_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("get", Some(opt)) => {
                ...
                ("services-versions-create", Some(opt)) => {
                    call_result = self
                        ._apps_services_versions_create(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("services-versions-instances-debug", Some(opt)) => {
                    call_result = self
                        ._apps_services_versions_instances_debug(opt, dry_run, &mut err)
                        .await;
                }
                ("services-versions-instances-delete", Some(opt)) => {
                    call_result = self
                        ._apps_services_versions_instances_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("services-versions-instances-get", Some(opt)) => {
                    call_result = self
                        ._apps_services_versions_instances_get(opt, dry_run, &mut err)
                        .await;
                }
                ("services-versions-instances-list", Some(opt)) => {
                    call_result = self
                        ._apps_services_versions_instances_list(opt, dry_run, &mut err)
                        .await;
                }
                ("services-versions-list", Some(opt)) => {
                    call_result = self
                        ._apps_services_versions_list(opt, dry_run, &mut err)
                        .await;
                }
                ("services-versions-patch", Some(opt)) => {
                    call_result = self
                        ._apps_services_versions_patch(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "appengine1-secret.json",
