...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/servicecontrol1).
//! # Features
//!
//! Handle the following *Resources* with ease from the central [hub](ServiceControl) ...
//!
//! * services
//!  * [*allocate quota*](api::ServiceAllocateQuotaCall), [*check*](api::ServiceCheckCall) and [*report*](api::ServiceReportCall)
//!
//!
//!
//!
