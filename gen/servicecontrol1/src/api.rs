...
impl<C> common::Hub for ServiceControl<C> {}

impl<'a, C> ServiceControl<C> {
...
impl common::Part for AllocateInfo {}
...
impl common::RequestValue for AllocateQuotaRequest {}
...
impl common::ResponseResult for AllocateQuotaResponse {}
...
impl common::Part for AttributeValue {}
...
impl common::Part for Attributes {}
...
impl common::Part for CheckError {}
...
impl common::Part for CheckInfo {}
...
impl common::RequestValue for CheckRequest {}
...
impl common::Part for ConsumerInfo {}
...
impl common::Part for ExplicitBuckets {}
...
impl common::Part for ExponentialBuckets {}
...
impl common::Part for LinearBuckets {}
...
impl common::Part for MetricValueSet {}
...
impl common::Part for Operation {}
...
impl common::Part for QuotaError {}
...
impl common::Part for QuotaInfo {}
...
impl common::Part for QuotaOperation {}
...
impl common::Part for QuotaProperties {}
...
impl common::Part for ReportError {}
...
impl common::ResponseResult for ReportResponse {}
...
impl common::Part for ResourceInfo {}
...
impl common::Part for TraceSpan {}
...
impl common::Part for TruncatableString {}
...
/// # }
/// ```
pub struct ServiceAllocateQuotaCall<'a, C>
where
    C: 'a,
{
    hub: &'a ServiceControl<C>,
...
impl<'a, C> common::CallBuilder for ServiceAllocateQuotaCall<'a, C> {}

impl<'a, C> ServiceAllocateQuotaCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, AllocateQuotaResponse)> {
        use std::borrow::Cow;
    ...
    pub fn request(mut self, new_value: AllocateQuotaRequest) -> ServiceAllocateQuotaCall<'a, C> {
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn service_name(mut self, new_value: &str) -> ServiceAllocateQuotaCall<'a, C> {
    ...
    pub fn param<T>(mut self, name: T, value: T) -> ServiceAllocateQuotaCall<'a, C>
    where
        T: AsRef<str>,
    {
    ...
    pub fn add_scope<St>(mut self, scope: St) -> ServiceAllocateQuotaCall<'a, C>
    where
        St: AsRef<str>,
    {
    ...
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ServiceAllocateQuotaCall<'a, C>
    where
    ...
    /// for details).
    pub fn clear_scopes(mut self) -> ServiceAllocateQuotaCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ServiceCheckCall<'a, C>
where
    C: 'a,
{
    hub: &'a ServiceControl<C>,
...
impl<'a, C> common::CallBuilder for ServiceCheckCall<'a, C> {}

impl<'a, C> ServiceCheckCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, CheckResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: CheckRequest) -> ServiceCheckCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn service_name(mut self, new_value: &str) -> ServiceCheckCall<'a, C> {
        self._service_name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> ServiceCheckCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ServiceCheckCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ServiceCheckCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ServiceCheckCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ServiceCheckCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ServiceReportCall<'a, C>
where
    C: 'a,
{
    hub: &'a ServiceControl<C>,
...
impl<'a, C> common::CallBuilder for ServiceReportCall<'a, C> {}

impl<'a, C> ServiceReportCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, ReportResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: ReportRequest) -> ServiceReportCall<'a, C> {
        self._request = new_value;
        self
    }
    /// The service name as specified in its service configuration. For example, `"pubsub.googleapis.com"`. See [google.api.Service](https://cloud.google.com/service-management/reference/rpc/google.api#google.api.Service) for the definition of a service name.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn service_name(mut self, new_value: &str) -> ServiceReportCall<'a, C> {
        self._service_name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> ServiceReportCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ServiceReportCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ServiceReportCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ServiceReportCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ServiceReportCall<'a, C> {
        self._scopes.clear();
        self
    }
}
