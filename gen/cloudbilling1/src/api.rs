...
impl AsRef<str> for Scope {
    fn as_ref(&self) -> &str {
        match *self {
            ...
            Scope::CloudBillingReadonly => "https://www.googleapis.com/auth/cloud-billing.readonly",
...
impl<C> common::Hub for Cloudbilling<C> {}

impl<'a, C> Cloudbilling<C> {
...
impl common::Part for AggregationInfo {}
...
/// * [sub accounts create billing accounts](BillingAccountSubAccountCreateCall) (request|response)
/// * [sub accounts list billing accounts](BillingAccountSubAccountListCall) (none)
...
/// * [move billing accounts](BillingAccountMoveCall) (response)
...
/// * [billing accounts create organizations](OrganizationBillingAccountCreateCall) (request|response)
/// * [billing accounts move organizations](OrganizationBillingAccountMoveCall) (response)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
...
impl common::RequestValue for BillingAccount {}
impl common::Resource for BillingAccount {}
impl common::ResponseResult for BillingAccount {}
...
impl common::Part for GeoTaxonomy {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [sub accounts list billing accounts](BillingAccountSubAccountListCall) (response)
/// * [list billing accounts](BillingAccountListCall) (response)
/// * [billing accounts list organizations](OrganizationBillingAccountListCall) (response)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
...
impl common::ResponseResult for ListBillingAccountsResponse {}
...
impl common::ResponseResult for ListProjectBillingInfoResponse {}
...
impl common::ResponseResult for ListSkusResponse {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [move billing accounts](BillingAccountMoveCall) (request)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
...
impl common::RequestValue for MoveBillingAccountRequest {}
...
impl common::Part for PricingExpression {}
...
impl common::RequestValue for ProjectBillingInfo {}
impl common::ResponseResult for ProjectBillingInfo {}
...
impl common::Resource for Service {}
...
impl<'a, C> BillingAccountMethods<'a, C> {
    ...
    pub fn sub_accounts_create(
        &self,
        request: BillingAccount,
        parent: &str,
    ) -> BillingAccountSubAccountCreateCall<'a, C> {
        BillingAccountSubAccountCreateCall {
            hub: self.hub,
            _request: request,
    ...
    pub fn sub_accounts_list(&self, parent: &str) -> BillingAccountSubAccountListCall<'a, C> {
        BillingAccountSubAccountListCall {
            hub: self.hub,
            _parent: parent.to_string(),
            _page_token: Default::default(),
            _page_size: Default::default(),
...
impl<'a, C> OrganizationMethods<'a, C> {
    ...
    pub fn billing_accounts_create(
        ...
        OrganizationBillingAccountCreateCall {
            hub: self.hub,
            _request: request,
            _parent: parent.to_string(),
            _delegate: Default::default(),
    ...
    pub fn billing_accounts_list(&self, parent: &str) -> OrganizationBillingAccountListCall<'a, C> {
        OrganizationBillingAccountListCall {
            hub: self.hub,
            _parent: parent.to_string(),
            _page_token: Default::default(),
            _page_size: Default::default(),
    ...
    /// # Arguments
    ///
    /// * `destinationParent` - Required. The resource name of the Organization to move the billing account under. Must be of the form `organizations/{organization_id}`.
    /// * `name` - Required. The resource name of the billing account to move. Must be of the form `billingAccounts/{billing_account_id}`. The specified billing account cannot be a subaccount, since a subaccount always belongs to the same organization as its parent account.
    pub fn billing_accounts_move(
        &self,
        destination_parent: &str,
        name: &str,
    ) -> OrganizationBillingAccountMoveCall<'a, C> {
        OrganizationBillingAccountMoveCall {
            hub: self.hub,
            _destination_parent: destination_parent.to_string(),
            _name: name.to_string(),
            _delegate: Default::default(),
            _additional_params: Default::default(),
            _scopes: Default::default(),
...
impl<'a, C> ProjectMethods<'a, C> {
    ...
    pub fn get_billing_info(&self, name: &str) -> ProjectGetBillingInfoCall<'a, C> {
    ...
    pub fn update_billing_info(
        ...
        name: &str,
    ) -> ProjectUpdateBillingInfoCall<'a, C> {
...
impl<'a, C> ServiceMethods<'a, C> {
    ...
    /// # Arguments
    ///
    /// * `parent` - Required. The name of the service. Example: "services/6F81-5844-456A"
    pub fn skus_list(&self, parent: &str) -> ServiceSkuListCall<'a, C> {
        ServiceSkuListCall {
            hub: self.hub,
            _parent: parent.to_string(),
...
/// # }
/// ```
pub struct BillingAccountProjectListCall<'a, C>
where
    C: 'a,
{
    hub: &'a Cloudbilling<C>,
...
impl<'a, C> common::CallBuilder for BillingAccountProjectListCall<'a, C> {}

impl<'a, C> BillingAccountProjectListCall<'a, C>
where
    C: common::Connector,
{
    ...
    pub async fn doit(
        mut self,
    ) -> common::Result<(common::Response, ListProjectBillingInfoResponse)> {
        use std::borrow::Cow;
        ...
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::CloudBillingReadonly.as_ref().to_string());
        }
    ...
    pub fn name(mut self, new_value: &str) -> BillingAccountProjectListCall<'a, C> {
    ...
    pub fn page_token(mut self, new_value: &str) -> BillingAccountProjectListCall<'a, C> {
    ...
    pub fn page_size(mut self, new_value: i32) -> BillingAccountProjectListCall<'a, C> {
    ...
    ) -> BillingAccountProjectListCall<'a, C> {
    ...
    pub fn param<T>(mut self, name: T, value: T) -> BillingAccountProjectListCall<'a, C>
    where
        T: AsRef<str>,
    {
    ...
    pub fn add_scope<St>(mut self, scope: St) -> BillingAccountProjectListCall<'a, C>
    where
        St: AsRef<str>,
    {
    ...
    pub fn add_scopes<I, St>(mut self, scopes: I) -> BillingAccountProjectListCall<'a, C>
    where
    ...
    /// for details).
    pub fn clear_scopes(mut self) -> BillingAccountProjectListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// This method creates [billing subaccounts](https://cloud.google.com/billing/docs/concepts#subaccounts). Google Cloud resellers should use the Channel Services APIs, [accounts.customers.create](https://cloud.google.com/channel/docs/reference/rest/v1/accounts.customers/create) and [accounts.customers.entitlements.create](https://cloud.google.com/channel/docs/reference/rest/v1/accounts.customers.entitlements/create). When creating a subaccount, the current authenticated user must have the `billing.accounts.update` IAM permission on the parent account, which is typically given to billing account [administrators](https://cloud.google.com/billing/docs/how-to/billing-access). This method will return an error if the parent account has not been provisioned for subaccounts.
///
/// A builder for the *subAccounts.create* method supported by a *billingAccount* resource.
/// It is not used directly, but through a [`BillingAccountMethods`] instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_cloudbilling1 as cloudbilling1;
/// use cloudbilling1::api::BillingAccount;
/// # async fn dox() {
/// # use cloudbilling1::{Cloudbilling, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.billing_accounts().sub_accounts_create(req, "parent")
///              .doit().await;
/// # }
/// ```
pub struct BillingAccountSubAccountCreateCall<'a, C>
where
    C: 'a,
{
    hub: &'a Cloudbilling<C>,
...
impl<'a, C> common::CallBuilder for BillingAccountSubAccountCreateCall<'a, C> {}

impl<'a, C> BillingAccountSubAccountCreateCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, BillingAccount)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
        ...
        params.push("alt", "json");
        let mut url = self.hub._base_url.clone() + "v1/{+parent}/subAccounts";
        if self._scopes.is_empty() {
            self._scopes
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> BillingAccountSubAccountCreateCall<'a, C> {
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> BillingAccountSubAccountCreateCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> BillingAccountSubAccountCreateCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> BillingAccountSubAccountCreateCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> BillingAccountSubAccountCreateCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Lists the billing accounts that the current authenticated user has permission to [view](https://cloud.google.com/billing/docs/how-to/billing-access).
///
/// A builder for the *subAccounts.list* method supported by a *billingAccount* resource.
/// It is not used directly, but through a [`BillingAccountMethods`] instance.
///
/// # Example
///
...
/// # }
/// ```
pub struct BillingAccountSubAccountListCall<'a, C>
where
    C: 'a,
{
    hub: &'a Cloudbilling<C>,
...
impl<'a, C> common::CallBuilder for BillingAccountSubAccountListCall<'a, C> {}

impl<'a, C> BillingAccountSubAccountListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, ListBillingAccountsResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> BillingAccountSubAccountListCall<'a, C> {
        self._parent = new_value.to_string();
        self
    }
    ...
    ///
    /// Sets the *page token* query property to the given value.
    pub fn page_token(mut self, new_value: &str) -> BillingAccountSubAccountListCall<'a, C> {
        self._page_token = Some(new_value.to_string());
        self
    }
    /// Requested page size. The maximum page size is 100; this is also the default.
    ///
    /// Sets the *page size* query property to the given value.
    pub fn page_size(mut self, new_value: i32) -> BillingAccountSubAccountListCall<'a, C> {
        self._page_size = Some(new_value);
        self
    }
    ...
    pub fn filter(mut self, new_value: &str) -> BillingAccountSubAccountListCall<'a, C> {
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> BillingAccountSubAccountListCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> BillingAccountSubAccountListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> BillingAccountSubAccountListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> BillingAccountSubAccountListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct BillingAccountCreateCall<'a, C>
where
    C: 'a,
{
    hub: &'a Cloudbilling<C>,
...
impl<'a, C> common::CallBuilder for BillingAccountCreateCall<'a, C> {}

impl<'a, C> BillingAccountCreateCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: BillingAccount) -> BillingAccountCreateCall<'a, C> {
        self._request = new_value;
        self
    }
    /// Optional. The parent to create a billing account from. Format: - `billingAccounts/{billing_account_id}`, for example, `billingAccounts/012345-567890-ABCDEF`
    ...
    pub fn parent(mut self, new_value: &str) -> BillingAccountCreateCall<'a, C> {
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> BillingAccountCreateCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> BillingAccountCreateCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> BillingAccountCreateCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> BillingAccountCreateCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct BillingAccountGetCall<'a, C>
where
    C: 'a,
{
    hub: &'a Cloudbilling<C>,
...
impl<'a, C> common::CallBuilder for BillingAccountGetCall<'a, C> {}

impl<'a, C> BillingAccountGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> BillingAccountGetCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> BillingAccountGetCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> BillingAccountGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> BillingAccountGetCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> BillingAccountGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct BillingAccountGetIamPolicyCall<'a, C>
where
    C: 'a,
{
    hub: &'a Cloudbilling<C>,
...
impl<'a, C> common::CallBuilder for BillingAccountGetIamPolicyCall<'a, C> {}

impl<'a, C> BillingAccountGetIamPolicyCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn resource(mut self, new_value: &str) -> BillingAccountGetIamPolicyCall<'a, C> {
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> BillingAccountGetIamPolicyCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> BillingAccountGetIamPolicyCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> BillingAccountGetIamPolicyCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> BillingAccountGetIamPolicyCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct BillingAccountListCall<'a, C>
where
    C: 'a,
{
    hub: &'a Cloudbilling<C>,
...
impl<'a, C> common::CallBuilder for BillingAccountListCall<'a, C> {}

impl<'a, C> BillingAccountListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    ///
    /// Sets the *parent* query property to the given value.
    pub fn parent(mut self, new_value: &str) -> BillingAccountListCall<'a, C> {
        self._parent = Some(new_value.to_string());
        self
    }
    /// A token identifying a page of results to return. This should be a `next_page_token` value returned from a previous `ListBillingAccounts` call. If unspecified, the first page of results is returned.
    ///
    /// Sets the *page token* query property to the given value.
    pub fn page_token(mut self, new_value: &str) -> BillingAccountListCall<'a, C> {
        self._page_token = Some(new_value.to_string());
        self
    }
    /// Requested page size. The maximum page size is 100; this is also the default.
    ///
    /// Sets the *page size* query property to the given value.
    pub fn page_size(mut self, new_value: i32) -> BillingAccountListCall<'a, C> {
        self._page_size = Some(new_value);
        self
    }
    /// Options for how to filter the returned billing accounts. This only supports filtering for [subaccounts](https://cloud.google.com/billing/docs/concepts) under a single provided parent billing account. (for example, `master_billing_account=billingAccounts/012345-678901-ABCDEF`). Boolean algebra and other fields are not currently supported.
    ///
    /// Sets the *filter* query property to the given value.
    pub fn filter(mut self, new_value: &str) -> BillingAccountListCall<'a, C> {
        self._filter = Some(new_value.to_string());
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> BillingAccountListCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> BillingAccountListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> BillingAccountListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> BillingAccountListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Changes which parent organization a billing account belongs to.
///
/// A builder for the *move* method supported by a *billingAccount* resource.
/// It is not used directly, but through a [`BillingAccountMethods`] instance.
///
/// # Example
///
...
/// # extern crate hyper_rustls;
/// # extern crate google_cloudbilling1 as cloudbilling1;
/// use cloudbilling1::api::MoveBillingAccountRequest;
/// # async fn dox() {
/// # use cloudbilling1::{Cloudbilling, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = MoveBillingAccountRequest::default();
///
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.billing_accounts().move_(req, "name")
///              .doit().await;
/// # }
/// ```
pub struct BillingAccountMoveCall<'a, C>
where
    C: 'a,
{
    hub: &'a Cloudbilling<C>,
    _request: MoveBillingAccountRequest,
    _name: String,
    _delegate: Option<&'a mut dyn common::Delegate>,
    _additional_params: HashMap<String, String>,
    _scopes: BTreeSet<String>,
...
impl<'a, C> common::CallBuilder for BillingAccountMoveCall<'a, C> {}

impl<'a, C> BillingAccountMoveCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    pub fn request(
        mut self,
        new_value: MoveBillingAccountRequest,
    ) -> BillingAccountMoveCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> BillingAccountMoveCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> BillingAccountMoveCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> BillingAccountMoveCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> BillingAccountMoveCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> BillingAccountMoveCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct BillingAccountPatchCall<'a, C>
where
    C: 'a,
{
    hub: &'a Cloudbilling<C>,
...
impl<'a, C> common::CallBuilder for BillingAccountPatchCall<'a, C> {}

impl<'a, C> BillingAccountPatchCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: BillingAccount) -> BillingAccountPatchCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> BillingAccountPatchCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    ...
    pub fn update_mask(mut self, new_value: common::FieldMask) -> BillingAccountPatchCall<'a, C> {
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> BillingAccountPatchCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> BillingAccountPatchCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> BillingAccountPatchCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> BillingAccountPatchCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # extern crate hyper_rustls;
/// # extern crate google_cloudbilling1 as cloudbilling1;
/// use cloudbilling1::api::SetIamPolicyRequest;
/// # async fn dox() {
/// # use cloudbilling1::{Cloudbilling, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
/// # }
/// ```
pub struct BillingAccountSetIamPolicyCall<'a, C>
where
    C: 'a,
{
    hub: &'a Cloudbilling<C>,
...
impl<'a, C> common::CallBuilder for BillingAccountSetIamPolicyCall<'a, C> {}

impl<'a, C> BillingAccountSetIamPolicyCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn resource(mut self, new_value: &str) -> BillingAccountSetIamPolicyCall<'a, C> {
        self._resource = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> BillingAccountSetIamPolicyCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> BillingAccountSetIamPolicyCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> BillingAccountSetIamPolicyCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> BillingAccountSetIamPolicyCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # extern crate hyper_rustls;
/// # extern crate google_cloudbilling1 as cloudbilling1;
/// use cloudbilling1::api::TestIamPermissionsRequest;
/// # async fn dox() {
/// # use cloudbilling1::{Cloudbilling, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
/// # }
/// ```
pub struct BillingAccountTestIamPermissionCall<'a, C>
where
    C: 'a,
{
    hub: &'a Cloudbilling<C>,
...
impl<'a, C> common::CallBuilder for BillingAccountTestIamPermissionCall<'a, C> {}

impl<'a, C> BillingAccountTestIamPermissionCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn resource(mut self, new_value: &str) -> BillingAccountTestIamPermissionCall<'a, C> {
        self._resource = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> BillingAccountTestIamPermissionCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> BillingAccountTestIamPermissionCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> BillingAccountTestIamPermissionCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> BillingAccountTestIamPermissionCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// This method creates [billing subaccounts](https://cloud.google.com/billing/docs/concepts#subaccounts). Google Cloud resellers should use the Channel Services APIs, [accounts.customers.create](https://cloud.google.com/channel/docs/reference/rest/v1/accounts.customers/create) and [accounts.customers.entitlements.create](https://cloud.google.com/channel/docs/reference/rest/v1/accounts.customers.entitlements/create). When creating a subaccount, the current authenticated user must have the `billing.accounts.update` IAM permission on the parent account, which is typically given to billing account [administrators](https://cloud.google.com/billing/docs/how-to/billing-access). This method will return an error if the parent account has not been provisioned for subaccounts.
///
/// A builder for the *billingAccounts.create* method supported by a *organization* resource.
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.organizations().billing_accounts_create(req, "parent")
///              .doit().await;
/// # }
/// ```
pub struct OrganizationBillingAccountCreateCall<'a, C>
where
    C: 'a,
{
    hub: &'a Cloudbilling<C>,
...
impl<'a, C> common::CallBuilder for OrganizationBillingAccountCreateCall<'a, C> {}

impl<'a, C> OrganizationBillingAccountCreateCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, BillingAccount)> {
        ...
        params.push("alt", "json");
        let mut url = self.hub._base_url.clone() + "v1/{+parent}/billingAccounts";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string());
        }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> OrganizationBillingAccountCreateCall<'a, C> {
        self._parent = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> OrganizationBillingAccountCreateCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> OrganizationBillingAccountCreateCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> OrganizationBillingAccountCreateCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> OrganizationBillingAccountCreateCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Lists the billing accounts that the current authenticated user has permission to [view](https://cloud.google.com/billing/docs/how-to/billing-access).
///
/// A builder for the *billingAccounts.list* method supported by a *organization* resource.
/// It is not used directly, but through a [`OrganizationMethods`] instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.organizations().billing_accounts_list("parent")
///              .page_token("dolor")
///              .page_size(-56)
///              .filter("eos")
///              .doit().await;
/// # }
/// ```
pub struct OrganizationBillingAccountListCall<'a, C>
where
    C: 'a,
{
    hub: &'a Cloudbilling<C>,
...
impl<'a, C> common::CallBuilder for OrganizationBillingAccountListCall<'a, C> {}

impl<'a, C> OrganizationBillingAccountListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> OrganizationBillingAccountListCall<'a, C> {
        self._parent = new_value.to_string();
        self
    }
    /// A token identifying a page of results to return. This should be a `next_page_token` value returned from a previous `ListBillingAccounts` call. If unspecified, the first page of results is returned.
    ///
    /// Sets the *page token* query property to the given value.
    pub fn page_token(mut self, new_value: &str) -> OrganizationBillingAccountListCall<'a, C> {
        self._page_token = Some(new_value.to_string());
        self
    }
    /// Requested page size. The maximum page size is 100; this is also the default.
    ///
    /// Sets the *page size* query property to the given value.
    pub fn page_size(mut self, new_value: i32) -> OrganizationBillingAccountListCall<'a, C> {
        self._page_size = Some(new_value);
        self
    }
    /// Options for how to filter the returned billing accounts. This only supports filtering for [subaccounts](https://cloud.google.com/billing/docs/concepts) under a single provided parent billing account. (for example, `master_billing_account=billingAccounts/012345-678901-ABCDEF`). Boolean algebra and other fields are not currently supported.
    ///
    /// Sets the *filter* query property to the given value.
    pub fn filter(mut self, new_value: &str) -> OrganizationBillingAccountListCall<'a, C> {
        self._filter = Some(new_value.to_string());
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> OrganizationBillingAccountListCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> OrganizationBillingAccountListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> OrganizationBillingAccountListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> OrganizationBillingAccountListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Changes which parent organization a billing account belongs to.
///
/// A builder for the *billingAccounts.move* method supported by a *organization* resource.
/// It is not used directly, but through a [`OrganizationMethods`] instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.organizations().billing_accounts_move("destinationParent", "name")
///              .doit().await;
/// # }
/// ```
pub struct OrganizationBillingAccountMoveCall<'a, C>
where
    C: 'a,
{
    hub: &'a Cloudbilling<C>,
...
impl<'a, C> common::CallBuilder for OrganizationBillingAccountMoveCall<'a, C> {}

impl<'a, C> OrganizationBillingAccountMoveCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, BillingAccount)> {
        ...
        for &field in ["alt", "destinationParent", "name"].iter() {
            if self._additional_params.contains_key(field) {
                dlg.finished(false);
                return Err(common::Error::FieldClash(field));
            }
        ...
        let mut params = Params::with_capacity(4 + self._additional_params.len());
        params.push("destinationParent", self._destination_parent);
        params.push("name", self._name);

        params.extend(self._additional_params.iter());

        params.push("alt", "json");
        let mut url = self.hub._base_url.clone() + "v1/{+destinationParent}/{+name}:move";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string());
        }
        ...
        {
            let to_remove = ["name", "destinationParent"];
            params.remove_params(&to_remove);
        }
    ...
    /// Required. The resource name of the Organization to move the billing account under. Must be of the form `organizations/{organization_id}`.
    ///
    /// Sets the *destination parent* path property to the given value.
    ///
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn destination_parent(
        ...
        self._destination_parent = new_value.to_string();
        self
    }
    /// Required. The resource name of the billing account to move. Must be of the form `billingAccounts/{billing_account_id}`. The specified billing account cannot be a subaccount, since a subaccount always belongs to the same organization as its parent account.
    ///
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> OrganizationBillingAccountMoveCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> OrganizationBillingAccountMoveCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> OrganizationBillingAccountMoveCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> OrganizationBillingAccountMoveCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> OrganizationBillingAccountMoveCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectGetBillingInfoCall<'a, C>
where
    C: 'a,
{
    hub: &'a Cloudbilling<C>,
...
impl<'a, C> common::CallBuilder for ProjectGetBillingInfoCall<'a, C> {}

impl<'a, C> ProjectGetBillingInfoCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, ProjectBillingInfo)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectGetBillingInfoCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectGetBillingInfoCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectGetBillingInfoCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectGetBillingInfoCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectGetBillingInfoCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # extern crate hyper_rustls;
/// # extern crate google_cloudbilling1 as cloudbilling1;
/// use cloudbilling1::api::ProjectBillingInfo;
/// # async fn dox() {
/// # use cloudbilling1::{Cloudbilling, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
/// # }
/// ```
pub struct ProjectUpdateBillingInfoCall<'a, C>
where
    C: 'a,
{
    hub: &'a Cloudbilling<C>,
...
impl<'a, C> common::CallBuilder for ProjectUpdateBillingInfoCall<'a, C> {}

impl<'a, C> ProjectUpdateBillingInfoCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: ProjectBillingInfo) -> ProjectUpdateBillingInfoCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectUpdateBillingInfoCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectUpdateBillingInfoCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectUpdateBillingInfoCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectUpdateBillingInfoCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectUpdateBillingInfoCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ServiceSkuListCall<'a, C>
where
    C: 'a,
{
    hub: &'a Cloudbilling<C>,
...
impl<'a, C> common::CallBuilder for ServiceSkuListCall<'a, C> {}

impl<'a, C> ServiceSkuListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, ListSkusResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> ServiceSkuListCall<'a, C> {
        self._parent = new_value.to_string();
        self
    }
    ...
    ///
    /// Sets the *page token* query property to the given value.
    pub fn page_token(mut self, new_value: &str) -> ServiceSkuListCall<'a, C> {
        self._page_token = Some(new_value.to_string());
        self
    }
    ...
    ///
    /// Sets the *page size* query property to the given value.
    pub fn page_size(mut self, new_value: i32) -> ServiceSkuListCall<'a, C> {
        self._page_size = Some(new_value);
        self
    }
    ...
    pub fn currency_code(mut self, new_value: &str) -> ServiceSkuListCall<'a, C> {
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ServiceSkuListCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ServiceSkuListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ServiceSkuListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ServiceSkuListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
