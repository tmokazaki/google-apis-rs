...
use google_datafusion1::{api, yup_oauth2, Error};
    ...
    C: apis_common::Connector,
{
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "datafusion1-secret.json",
        ...
        .persist_tokens_to_disk(format!("{}/datafusion1", config_dir))
        .build()
        .await
        .unwrap();
...
async fn main() {
    ...
    let arg_data = [
        ("projects", "methods: 'locations-get', 'locations-instances-create', 'locations-instances-delete', 'locations-instances-dns-peerings-create', 'locations-instances-dns-peerings-delete', 'locations-instances-dns-peerings-list', 'locations-instances-get', 'locations-instances-get-iam-policy', 'locations-instances-list', 'locations-instances-patch', 'locations-instances-restart', 'locations-instances-set-iam-policy', 'locations-instances-test-iam-permissions', 'locations-list', 'locations-operations-cancel', 'locations-operations-delete', 'locations-operations-get', 'locations-operations-list' and 'locations-versions-list'", vec![
            ("locations-get",
                    Some(r##"Gets information about a location."##),
                    "Details at http://byron.github.io/google-apis-rs/google_datafusion1_cli/projects_locations-get",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-instances-create",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_datafusion1_cli/projects_locations-instances-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("locations-instances-delete",
                    Some(r##"Deletes a single Date Fusion instance."##),
                    "Details at http://byron.github.io/google-apis-rs/google_datafusion1_cli/projects_locations-instances-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-instances-dns-peerings-create",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_datafusion1_cli/projects_locations-instances-dns-peerings-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("locations-instances-dns-peerings-delete",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_datafusion1_cli/projects_locations-instances-dns-peerings-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-instances-dns-peerings-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_datafusion1_cli/projects_locations-instances-dns-peerings-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("locations-instances-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_datafusion1_cli/projects_locations-instances-get",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The instance resource name in the format projects/{project}/locations/{location}/instances/{instance}."##),
            ...
            ("locations-instances-get-iam-policy",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_datafusion1_cli/projects_locations-instances-get-iam-policy",
                  vec![
                    (Some(r##"resource"##),
                     None,
            ...
            ("locations-instances-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_datafusion1_cli/projects_locations-instances-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("locations-instances-patch",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_datafusion1_cli/projects_locations-instances-patch",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-instances-restart",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_datafusion1_cli/projects_locations-instances-restart",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-instances-set-iam-policy",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_datafusion1_cli/projects_locations-instances-set-iam-policy",
                  vec![
                    (Some(r##"resource"##),
                     None,
            ...
            ("locations-instances-test-iam-permissions",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_datafusion1_cli/projects_locations-instances-test-iam-permissions",
                  vec![
                    (Some(r##"resource"##),
                     None,
            ...
            ("locations-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_datafusion1_cli/projects_locations-list",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-operations-cancel",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_datafusion1_cli/projects_locations-operations-cancel",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-operations-delete",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_datafusion1_cli/projects_locations-operations-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-operations-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_datafusion1_cli/projects_locations-operations-get",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-operations-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_datafusion1_cli/projects_locations-operations-list",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-versions-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_datafusion1_cli/projects_locations-versions-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
