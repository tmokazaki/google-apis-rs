...
use google_calendar3::{api, yup_oauth2, Error};
...
{
    async fn _acl_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.acl().delete(
            opt.value_of("calendar-id").unwrap_or(""),
            opt.value_of("rule-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _acl_insert(
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec!["etag", "id", "kind", "role", "scope", "type", "value"],
                    );
        ...
        let mut request: api::AclRule = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .acl()
            .insert(request, opt.value_of("calendar-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            .iter()
        {
            ...
            match key {
                "send-notifications" => {
                    call = call.send_notifications(
                        value
                            .map(|v| arg_from_str(v, err, "send-notifications", "boolean"))
                            .unwrap_or(false),
                    );
                }
                _ => {
    ...
    async fn _acl_list(
        ...
        let mut call = self
            .hub
            .acl()
            .list(opt.value_of("calendar-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["max-results", "page-token", "show-deleted", "sync-token"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _acl_patch(
        ...
        let mut request: api::AclRule = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.acl().patch(
            request,
            opt.value_of("calendar-id").unwrap_or(""),
            opt.value_of("rule-id").unwrap_or(""),
        );
    ...
    async fn _acl_update(
        ...
        let mut request: api::AclRule = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.acl().update(
            request,
            opt.value_of("calendar-id").unwrap_or(""),
            opt.value_of("rule-id").unwrap_or(""),
        );
    ...
    async fn _acl_watch(
        ...
        let mut call = self
            .hub
            .acl()
            .watch(request, opt.value_of("calendar-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _calendar_list_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .calendar_list()
            .delete(opt.value_of("calendar-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _calendar_list_get(
        ...
        let mut call = self
            .hub
            .calendar_list()
            .get(opt.value_of("calendar-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _calendar_list_insert(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::CalendarListEntry = serde_json::value::from_value(object).unwrap();
            ...
            .iter()
        {
            ...
            match key {
                "color-rgb-format" => {
                    call = call.color_rgb_format(
                        value
                            .map(|v| arg_from_str(v, err, "color-rgb-format", "boolean"))
                            .unwrap_or(false),
                    );
                }
                _ => {
    ...
    async fn _calendar_list_list(
            ...
            .iter()
        {
            ...
            match key {
                ...
                "show-hidden" => {
                    call = call.show_hidden(
                        value
                            .map(|v| arg_from_str(v, err, "show-hidden", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "show-deleted" => {
    ...
    async fn _calendar_list_patch(
        ...
        let mut call = self
            .hub
            .calendar_list()
            .patch(request, opt.value_of("calendar-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _calendar_list_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .calendar_list()
            .update(request, opt.value_of("calendar-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _calendars_clear(
        ...
        let mut call = self
            .hub
            .calendars()
            .clear(opt.value_of("calendar-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _calendars_insert(
        ...
        let mut request: api::Calendar = serde_json::value::from_value(object).unwrap();
    ...
    async fn _events_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.events().delete(
            opt.value_of("calendar-id").unwrap_or(""),
            opt.value_of("event-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _events_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.events().get(
            opt.value_of("calendar-id").unwrap_or(""),
            opt.value_of("event-id").unwrap_or(""),
        );
        for parg in opt
            ...
            .iter()
        {
            ...
            match key {
                ...
                "max-attendees" => {
                    call = call.max_attendees(
                        value
                            .map(|v| arg_from_str(v, err, "max-attendees", "int32"))
                            .unwrap_or(-0),
                    );
                }
                "always-include-email" => {
                    call = call.always_include_email(
                        value
                            .map(|v| arg_from_str(v, err, "always-include-email", "boolean"))
                            .unwrap_or(false),
                    );
                }
                _ => {
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["always-include-email", "max-attendees", "time-zone"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _events_import(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "conference-data.conference-id" => Some((
                ...
                "conference-data.conference-solution.icon-uri" => Some((
                ...
                "conference-data.conference-solution.key.type" => Some((
                ...
                "conference-data.conference-solution.name" => Some((
                ...
                "conference-data.create-request.conference-solution-key.type" => Some((
                ...
                "conference-data.create-request.request-id" => Some((
                ...
                "conference-data.create-request.status.status-code" => Some((
                ...
                "conference-data.parameters.add-on-parameters.parameters" => Some((
                ...
                "conference-data.signature" => Some((
                ...
                "extended-properties.private" => Some((
                ...
                "extended-properties.shared" => Some((
                ...
                "focus-time-properties.auto-decline-mode" => Some((
                ...
                "focus-time-properties.chat-status" => Some((
                ...
                "focus-time-properties.decline-message" => Some((
                ...
                "guests-can-see-other-guests" => Some((
                ...
                "original-start-time.date-time" => Some((
                ...
                "original-start-time.time-zone" => Some((
                ...
                "out-of-office-properties.auto-decline-mode" => Some((
                ...
                "out-of-office-properties.decline-message" => Some((
                ...
                "working-location-properties.custom-location.label" => Some((
                ...
                "working-location-properties.office-location.building-id" => Some((
                ...
                "working-location-properties.office-location.desk-id" => Some((
                ...
                "working-location-properties.office-location.floor-id" => Some((
                ...
                "working-location-properties.office-location.floor-section-id" => Some((
                ...
                "working-location-properties.office-location.label" => Some((
                ...
                "working-location-properties.type" => Some((
        ...
        let mut request: api::Event = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .events()
            .import(request, opt.value_of("calendar-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            .iter()
        {
            ...
            match key {
                "supports-attachments" => {
                    call = call.supports_attachments(
                        value
                            .map(|v| arg_from_str(v, err, "supports-attachments", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "conference-data-version" => {
                    call = call.conference_data_version(
                        value
                            .map(|v| arg_from_str(v, err, "conference-data-version", "int32"))
                            .unwrap_or(-0),
                    );
                }
                _ => {
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["conference-data-version", "supports-attachments"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _events_instances(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.events().instances(
            opt.value_of("calendar-id").unwrap_or(""),
            opt.value_of("event-id").unwrap_or(""),
        );
        for parg in opt
            ...
            .iter()
        {
            ...
            match key {
                ...
                "time-min" => {
                    call = call.time_min(
                        value
                            .map(|v| arg_from_str(v, err, "time-min", "date-time"))
                ...
                "time-max" => {
                    call = call.time_max(
                        value
                            .map(|v| arg_from_str(v, err, "time-max", "date-time"))
                            .unwrap_or(chrono::Utc::now()),
                    );
                }
                "show-deleted" => {
    ...
    async fn _events_list(
            ...
            .iter()
        {
            ...
            match key {
                "updated-min" => {
                    call = call.updated_min(
                        value
                            .map(|v| arg_from_str(v, err, "updated-min", "date-time"))
                            .unwrap_or(chrono::Utc::now()),
                    );
                }
                "time-zone" => {
                ...
                "single-events" => {
                    call = call.single_events(
                        value
                            .map(|v| arg_from_str(v, err, "single-events", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "show-hidden-invitations" => {
                    call = call.show_hidden_invitations(
                        value
                            .map(|v| arg_from_str(v, err, "show-hidden-invitations", "boolean"))
                            .unwrap_or(false),
                    );
                }
                "show-deleted" => {
    ...
    async fn _events_move(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.events().move_(
            opt.value_of("calendar-id").unwrap_or(""),
            opt.value_of("event-id").unwrap_or(""),
            opt.value_of("destination").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _events_patch(
        ...
        let mut request: api::Event = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.events().patch(
            request,
            opt.value_of("calendar-id").unwrap_or(""),
            opt.value_of("event-id").unwrap_or(""),
        );
    ...
    async fn _events_quick_add(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.events().quick_add(
            opt.value_of("calendar-id").unwrap_or(""),
            opt.value_of("text").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _events_update(
        ...
        let mut request: api::Event = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.events().update(
            request,
            opt.value_of("calendar-id").unwrap_or(""),
            opt.value_of("event-id").unwrap_or(""),
        );
    ...
    async fn _freebusy_query(
        ...
        let mut request: api::FreeBusyRequest = serde_json::value::from_value(object).unwrap();
    ...
    async fn _settings_get(
        ...
        let mut call = self
            .hub
            .settings()
            .get(opt.value_of("setting").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["max-results", "page-token", "sync-token"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _doit(
        ...
        match self.opt.subcommand() {
            ("acl", Some(opt)) => match opt.subcommand() {
                ("delete", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("acl".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("calendar-list", Some(opt)) => match opt.subcommand() {
                ("delete", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("calendar-list".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("calendars", Some(opt)) => match opt.subcommand() {
                ("clear", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("calendars".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ...
            ("colors", Some(opt)) => match opt.subcommand() {
                ("get", Some(opt)) => {
                    call_result = self._colors_get(opt, dry_run, &mut err).await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("colors".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ...
            ("freebusy", Some(opt)) => match opt.subcommand() {
                ("query", Some(opt)) => {
                    call_result = self._freebusy_query(opt, dry_run, &mut err).await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("freebusy".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            ("settings", Some(opt)) => match opt.subcommand() {
                ("get", Some(opt)) => {
                ...
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("settings".to_string()));
                    writeln!(std::io::stderr(), "{}\n", opt.usage()).ok();
                }
            },
            _ => {
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "calendar3-secret.json",
