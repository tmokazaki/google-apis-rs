...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/places1).
//! # Features
//!
//! Handle the following *Resources* with ease from the central [hub](MapsPlaces) ...
//!
//! * places
//!  * [*autocomplete*](api::PlaceAutocompleteCall), [*get*](api::PlaceGetCall), [*photos get media*](api::PlacePhotoGetMediaCall), [*search nearby*](api::PlaceSearchNearbyCall) and [*search text*](api::PlaceSearchTextCall)
//!
//!
//!
//!
