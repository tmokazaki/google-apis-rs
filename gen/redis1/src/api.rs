...
impl<C> common::Hub for CloudRedis<C> {}

impl<'a, C> CloudRedis<C> {
    pub fn new<A: 'static + common::GetToken>(client: common::Client<C>, auth: A) -> CloudRedis<C> {
        CloudRedis {
            client,
            auth: Box::new(auth),
...
impl common::Part for AOFConfig {}
...
///
/// * [locations clusters get certificate authority projects](ProjectLocationClusterGetCertificateAuthorityCall) (response)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
pub struct CertificateAuthority {
    /// no description provided
    #[serde(rename = "managedServerCa")]
...
/// * [locations clusters patch projects](ProjectLocationClusterPatchCall) (request)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
pub struct Cluster {
    /// Optional. The authorization mode of the Redis cluster. If not provided, auth feature is disabled for the cluster.
    #[serde(rename = "authorizationMode")]
    ...
    #[serde(rename = "discoveryEndpoints")]
    ...
    #[serde(rename = "zoneDistributionConfig")]
    pub zone_distribution_config: Option<ZoneDistributionConfig>,
}

impl common::RequestValue for Cluster {}
...
impl common::Part for ClusterPersistenceConfig {}
...
impl common::Part for DiscoveryEndpoint {}
...
impl common::RequestValue for ExportInstanceRequest {}
...
impl common::RequestValue for FailoverInstanceRequest {}
...
impl common::RequestValue for ImportInstanceRequest {}
...
impl common::ResponseResult for InstanceAuthString {}
...
impl common::Part for MaintenanceSchedule {}
...
impl common::Part for ManagedCertificateAuthority {}
...
/// * [locations clusters patch projects](ProjectLocationClusterPatchCall) (response)
...
pub struct PersistenceConfig {
    ...
    pub rdb_next_snapshot_time: Option<chrono::DateTime<chrono::offset::Utc>>,
    ...
    pub rdb_snapshot_start_time: Option<chrono::DateTime<chrono::offset::Utc>>,
}

impl common::Part for PersistenceConfig {}
...
impl common::Part for RDBConfig {}
...
impl common::RequestValue for RescheduleMaintenanceRequest {}
...
impl common::Part for StateInfo {}
...
impl common::Part for TlsCertificate {}
...
impl common::Part for WeeklyMaintenanceWindow {}
...
impl common::Part for ZoneDistributionConfig {}
...
impl<'a, C> ProjectMethods<'a, C> {
    ...
    /// * `parent` - Required. The resource name of the cluster location using the form: `projects/{project_id}/locations/{location_id}` where `location_id` refers to a GCP region.
    ...
    /// # Arguments
    ///
    /// * `name` - Required. Redis cluster resource name using the form: `projects/{project_id}/locations/{location_id}/clusters/{cluster_id}` where `location_id` refers to a GCP region.
    ...
    /// # Arguments
    ///
    /// * `name` - Required. Redis cluster certificate authority resource name using the form: `projects/{project_id}/locations/{location_id}/clusters/{cluster_id}/certificateAuthority` where `location_id` refers to a GCP region.
    pub fn locations_clusters_get_certificate_authority(
        &self,
        name: &str,
    ) -> ProjectLocationClusterGetCertificateAuthorityCall<'a, C> {
    ...
    ///
    /// * `request` - No description provided.
    /// * `name` - Required. Identifier. Unique name of the resource in this scope including project and location using the form: `projects/{project_id}/locations/{location_id}/clusters/{cluster_id}`
    pub fn locations_clusters_patch(
        &self,
        request: Cluster,
        name: &str,
    ) -> ProjectLocationClusterPatchCall<'a, C> {
        ProjectLocationClusterPatchCall {
            hub: self.hub,
            _request: request,
            _name: name.to_string(),
    ...
    pub fn locations_instances_export(
        ...
        name: &str,
    ) -> ProjectLocationInstanceExportCall<'a, C> {
    ...
    pub fn locations_instances_failover(
        ...
        name: &str,
    ) -> ProjectLocationInstanceFailoverCall<'a, C> {
    ...
    ///
    /// * `name` - Required. Redis instance resource name using the form: `projects/{project_id}/locations/{location_id}/instances/{instance_id}` where `location_id` refers to a GCP region.
    pub fn locations_instances_get_auth_string(
        &self,
        name: &str,
    ) -> ProjectLocationInstanceGetAuthStringCall<'a, C> {
    ...
    pub fn locations_instances_import(
        ...
        name: &str,
    ) -> ProjectLocationInstanceImportCall<'a, C> {
    ...
    /// * `request` - No description provided.
    /// * `name` - Required. Redis instance resource name using the form: `projects/{project_id}/locations/{location_id}/instances/{instance_id}` where `location_id` refers to a GCP region.
    pub fn locations_instances_reschedule_maintenance(
        &self,
        request: RescheduleMaintenanceRequest,
        name: &str,
    ) -> ProjectLocationInstanceRescheduleMaintenanceCall<'a, C> {
    ...
    C: common::Connector,
{
    ...
    pub async fn doit(mut self) -> common::Result<(common::Response, Operation)> {
        ...
        for &field in ["alt", "parent", "requestId", "clusterId"].iter() {
    ...
    pub fn request(mut self, new_value: Cluster) -> ProjectLocationClusterCreateCall<'a, C> {
    ...
    pub fn request_id(mut self, new_value: &str) -> ProjectLocationClusterCreateCall<'a, C> {
    ...
    pub fn cluster_id(mut self, new_value: &str) -> ProjectLocationClusterCreateCall<'a, C> {
    ...
    C: common::Connector,
{
    ...
    ///
    /// Sets the *request id* query property to the given value.
    pub fn request_id(mut self, new_value: &str) -> ProjectLocationClusterDeleteCall<'a, C> {
        self._request_id = Some(new_value.to_string());
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
...
/// Gets the details of certificate authority information for Redis cluster.
///
/// A builder for the *locations.clusters.getCertificateAuthority* method supported by a *project* resource.
/// It is not used directly, but through a [`ProjectMethods`] instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().locations_clusters_get_certificate_authority("name")
///              .doit().await;
/// # }
/// ```
pub struct ProjectLocationClusterGetCertificateAuthorityCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudRedis<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationClusterGetCertificateAuthorityCall<'a, C> {}

impl<'a, C> ProjectLocationClusterGetCertificateAuthorityCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationClusterGetCertificateAuthorityCall<'a, C> {
        self._scopes.clear();
        self
    }
}
    ...
    C: common::Connector,
{
    ...
    pub fn page_token(mut self, new_value: &str) -> ProjectLocationClusterListCall<'a, C> {
    ...
    pub fn page_size(mut self, new_value: i32) -> ProjectLocationClusterListCall<'a, C> {
...
/// Updates the metadata and configuration of a specific Redis cluster. Completed longrunning.Operation will contain the new cluster object in the response field. The returned operation is automatically deleted after a few hours, so there is no need to call DeleteOperation.
///
/// A builder for the *locations.clusters.patch* method supported by a *project* resource.
/// It is not used directly, but through a [`ProjectMethods`] instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.projects().locations_clusters_patch(req, "name")
///              .update_mask(FieldMask::new::<&str>(&[]))
///              .request_id("invidunt")
///              .doit().await;
/// # }
/// ```
pub struct ProjectLocationClusterPatchCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudRedis<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationClusterPatchCall<'a, C> {}

impl<'a, C> ProjectLocationClusterPatchCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: Cluster) -> ProjectLocationClusterPatchCall<'a, C> {
        self._request = new_value;
        self
    }
    /// Required. Identifier. Unique name of the resource in this scope including project and location using the form: `projects/{project_id}/locations/{location_id}/clusters/{cluster_id}`
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationClusterPatchCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    ...
    ///
    /// Sets the *request id* query property to the given value.
    pub fn request_id(mut self, new_value: &str) -> ProjectLocationClusterPatchCall<'a, C> {
        self._request_id = Some(new_value.to_string());
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationClusterPatchCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationClusterPatchCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationClusterPatchCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationClusterPatchCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationInstanceExportCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudRedis<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationInstanceExportCall<'a, C> {}

impl<'a, C> ProjectLocationInstanceExportCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    pub fn request(
        mut self,
        new_value: ExportInstanceRequest,
    ) -> ProjectLocationInstanceExportCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationInstanceExportCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationInstanceExportCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationInstanceExportCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationInstanceExportCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationInstanceExportCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationInstanceFailoverCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudRedis<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationInstanceFailoverCall<'a, C> {}

impl<'a, C> ProjectLocationInstanceFailoverCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    pub fn request(
        mut self,
        new_value: FailoverInstanceRequest,
    ) -> ProjectLocationInstanceFailoverCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationInstanceFailoverCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationInstanceFailoverCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationInstanceFailoverCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationInstanceFailoverCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationInstanceFailoverCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationInstanceGetAuthStringCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudRedis<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationInstanceGetAuthStringCall<'a, C> {}

impl<'a, C> ProjectLocationInstanceGetAuthStringCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, InstanceAuthString)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationInstanceGetAuthStringCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationInstanceGetAuthStringCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationInstanceGetAuthStringCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationInstanceGetAuthStringCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationInstanceGetAuthStringCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationInstanceImportCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudRedis<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationInstanceImportCall<'a, C> {}

impl<'a, C> ProjectLocationInstanceImportCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    pub fn request(
        mut self,
        new_value: ImportInstanceRequest,
    ) -> ProjectLocationInstanceImportCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> ProjectLocationInstanceImportCall<'a, C> {
        self._name = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectLocationInstanceImportCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectLocationInstanceImportCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectLocationInstanceImportCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationInstanceImportCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectLocationInstanceRescheduleMaintenanceCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudRedis<C>,
...
impl<'a, C> common::CallBuilder for ProjectLocationInstanceRescheduleMaintenanceCall<'a, C> {}

impl<'a, C> ProjectLocationInstanceRescheduleMaintenanceCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    pub fn request(
        mut self,
        new_value: RescheduleMaintenanceRequest,
    ) -> ProjectLocationInstanceRescheduleMaintenanceCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectLocationInstanceRescheduleMaintenanceCall<'a, C> {
        self._scopes.clear();
        self
    }
}
