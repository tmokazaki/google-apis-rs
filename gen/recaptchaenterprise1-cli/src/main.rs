...
use google_recaptchaenterprise1::{api, yup_oauth2, Error};
...
{
    async fn _projects_assessments_annotate(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "transaction-event.event-time" => Some((
                ...
                "transaction-event.event-type" => Some((
        ...
        let mut request: api::GoogleCloudRecaptchaenterpriseV1AnnotateAssessmentRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .assessments_annotate(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_assessments_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                "account-defender-assessment.labels" => Some((
                ...
                "account-verification.language-code" => Some((
                ...
                "account-verification.latest-verification-result" => Some((
                    "accountVerification.latestVerificationResult",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "account-verification.username" => Some((
                ...
                "event.firewall-policy-evaluation" => Some((
                ...
                "event.transaction-data.billing-address.address" => Some((
                    "event.transactionData.billingAddress.address",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "event.transaction-data.billing-address.administrative-area" => Some((
                    "event.transactionData.billingAddress.administrativeArea",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "event.transaction-data.billing-address.locality" => Some((
                    "event.transactionData.billingAddress.locality",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "event.transaction-data.billing-address.postal-code" => Some((
                    "event.transactionData.billingAddress.postalCode",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "event.transaction-data.billing-address.recipient" => Some((
                    "event.transactionData.billingAddress.recipient",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "event.transaction-data.billing-address.region-code" => Some((
                    "event.transactionData.billingAddress.regionCode",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "event.transaction-data.card-bin" => Some((
                    "event.transactionData.cardBin",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "event.transaction-data.card-last-four" => Some((
                    "event.transactionData.cardLastFour",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "event.transaction-data.currency-code" => Some((
                    "event.transactionData.currencyCode",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "event.transaction-data.gateway-info.avs-response-code" => Some((
                    "event.transactionData.gatewayInfo.avsResponseCode",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "event.transaction-data.gateway-info.cvv-response-code" => Some((
                    "event.transactionData.gatewayInfo.cvvResponseCode",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "event.transaction-data.gateway-info.gateway-response-code" => Some((
                    "event.transactionData.gatewayInfo.gatewayResponseCode",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "event.transaction-data.gateway-info.name" => Some((
                    "event.transactionData.gatewayInfo.name",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "event.transaction-data.payment-method" => Some((
                    "event.transactionData.paymentMethod",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "event.transaction-data.shipping-address.address" => Some((
                    "event.transactionData.shippingAddress.address",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "event.transaction-data.shipping-address.administrative-area" => Some((
                    "event.transactionData.shippingAddress.administrativeArea",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "event.transaction-data.shipping-address.locality" => Some((
                    "event.transactionData.shippingAddress.locality",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "event.transaction-data.shipping-address.postal-code" => Some((
                    "event.transactionData.shippingAddress.postalCode",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "event.transaction-data.shipping-address.recipient" => Some((
                    "event.transactionData.shippingAddress.recipient",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "event.transaction-data.shipping-address.region-code" => Some((
                    "event.transactionData.shippingAddress.regionCode",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "event.transaction-data.shipping-value" => Some((
                    "event.transactionData.shippingValue",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "event.transaction-data.transaction-id" => Some((
                    "event.transactionData.transactionId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "event.transaction-data.user.account-id" => Some((
                    "event.transactionData.user.accountId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "event.transaction-data.user.creation-ms" => Some((
                    "event.transactionData.user.creationMs",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "event.transaction-data.user.email" => Some((
                    "event.transactionData.user.email",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "event.transaction-data.user.email-verified" => Some((
                    "event.transactionData.user.emailVerified",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "event.transaction-data.user.phone-number" => Some((
                    "event.transactionData.user.phoneNumber",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "event.transaction-data.user.phone-verified" => Some((
                    "event.transactionData.user.phoneVerified",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "event.transaction-data.value" => Some((
                    "event.transactionData.value",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "event.user-agent" => Some((
                    "event.userAgent",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                ...
                "event.user-info.account-id" => Some((
                    "event.userInfo.accountId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "event.user-info.create-account-time" => Some((
                    "event.userInfo.createAccountTime",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "event.user-ip-address" => Some((
                    "event.userIpAddress",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                ...
                "event.waf-token-assessment" => Some((
                ...
                "firewall-policy-assessment.error.code" => Some((
                    "firewallPolicyAssessment.error.code",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                )),
                "firewall-policy-assessment.error.message" => Some((
                    "firewallPolicyAssessment.error.message",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "firewall-policy-assessment.firewall-policy.condition" => Some((
                    "firewallPolicyAssessment.firewallPolicy.condition",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "firewall-policy-assessment.firewall-policy.description" => Some((
                    "firewallPolicyAssessment.firewallPolicy.description",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "firewall-policy-assessment.firewall-policy.name" => Some((
                    "firewallPolicyAssessment.firewallPolicy.name",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "firewall-policy-assessment.firewall-policy.path" => Some((
                    "firewallPolicyAssessment.firewallPolicy.path",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "fraud-prevention-assessment.behavioral-trust-verdict.trust" => Some((
                ...
                "fraud-prevention-assessment.card-testing-verdict.risk" => Some((
                    "fraudPreventionAssessment.cardTestingVerdict.risk",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "fraud-prevention-assessment.stolen-instrument-verdict.risk" => Some((
                    "fraudPreventionAssessment.stolenInstrumentVerdict.risk",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "fraud-prevention-assessment.transaction-risk" => Some((
                ...
                "fraud-signals.card-signals.card-labels" => Some((
                    "fraudSignals.cardSignals.cardLabels",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "fraud-signals.user-signals.active-days-lower-bound" => Some((
                    "fraudSignals.userSignals.activeDaysLowerBound",
                    JsonTypeInfo {
                        jtype: JsonType::Int,
                        ctype: ComplexType::Pod,
                    },
                )),
                "fraud-signals.user-signals.synthetic-risk" => Some((
                    "fraudSignals.userSignals.syntheticRisk",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                ...
                "phone-fraud-assessment.sms-toll-fraud-verdict.reasons" => Some((
                    "phoneFraudAssessment.smsTollFraudVerdict.reasons",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "phone-fraud-assessment.sms-toll-fraud-verdict.risk" => Some((
                    "phoneFraudAssessment.smsTollFraudVerdict.risk",
                    JsonTypeInfo {
                        jtype: JsonType::Float,
                        ctype: ComplexType::Pod,
                    },
                )),
                "private-password-leak-verification.encrypted-leak-match-prefixes" => Some((
                ...
                "private-password-leak-verification.encrypted-user-credentials-hash" => Some((
                ...
                "private-password-leak-verification.lookup-hash-prefix" => Some((
                ...
                "private-password-leak-verification.reencrypted-user-credentials-hash" => Some((
                ...
                "token-properties.android-package-name" => Some((
                ...
                "token-properties.create-time" => Some((
                ...
                "token-properties.hostname" => Some((
                ...
                "token-properties.invalid-reason" => Some((
                ...
                "token-properties.ios-bundle-id" => Some((
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        ...
                        &vec![
                            ...
                            "email",
                            "email-verified",
                            "encrypted-leak-match-prefixes",
                            "encrypted-user-credentials-hash",
                            "error",
                            "event",
                            "expected-action",
                            "express",
                            ...
                            "reasons",
                            "recipient",
                            "reencrypted-user-credentials-hash",
                            "region-code",
                            "requested-uri",
                            "risk",
                            "risk-analysis",
        ...
        let mut request: api::GoogleCloudRecaptchaenterpriseV1Assessment =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .assessments_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_firewallpolicies_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec!["condition", "description", "name", "path"],
                    );
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
        ...
        let mut request: api::GoogleCloudRecaptchaenterpriseV1FirewallPolicy =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .firewallpolicies_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_firewallpolicies_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .firewallpolicies_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_firewallpolicies_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .firewallpolicies_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_firewallpolicies_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .firewallpolicies_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_firewallpolicies_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .firewallpolicies_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_firewallpolicies_reorder(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::GoogleCloudRecaptchaenterpriseV1ReorderFirewallPoliciesRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .firewallpolicies_reorder(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_keys_create(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                "android-settings.allow-all-package-names" => Some((
                ...
                "android-settings.allowed-package-names" => Some((
                ...
                "android-settings.support-non-google-app-store-distribution" => Some((
                    "androidSettings.supportNonGoogleAppStoreDistribution",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                ...
                "ios-settings.allow-all-bundle-ids" => Some((
                ...
                "ios-settings.allowed-bundle-ids" => Some((
                ...
                "ios-settings.apple-developer-id.key-id" => Some((
                    "iosSettings.appleDeveloperId.keyId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "ios-settings.apple-developer-id.private-key" => Some((
                    "iosSettings.appleDeveloperId.privateKey",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "ios-settings.apple-developer-id.team-id" => Some((
                    "iosSettings.appleDeveloperId.teamId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                ...
                "testing-options.testing-challenge" => Some((
                ...
                "testing-options.testing-score" => Some((
                ...
                "web-settings.allow-all-domains" => Some((
                ...
                "web-settings.allow-amp-traffic" => Some((
                ...
                "web-settings.allowed-domains" => Some((
                ...
                "web-settings.challenge-security-preference" => Some((
        ...
        let mut request: api::GoogleCloudRecaptchaenterpriseV1Key =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .keys_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_keys_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .keys_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_keys_get(
        ...
        let mut call = self
            .hub
            .projects()
            .keys_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_keys_get_metrics(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .keys_get_metrics(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_keys_list(
        ...
        let mut call = self
            .hub
            .projects()
            .keys_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_keys_migrate(
        ...
        let mut request: api::GoogleCloudRecaptchaenterpriseV1MigrateKeyRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .keys_migrate(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_keys_patch(
        ...
        let mut call = self
            .hub
            .projects()
            .keys_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_keys_retrieve_legacy_secret_key(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .keys_retrieve_legacy_secret_key(opt.value_of("key").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_relatedaccountgroupmemberships_search(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        key,
                        &vec!["account-id", "hashed-account-id", "page-size", "page-token"],
                    );
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
        ...
        let mut request: api::GoogleCloudRecaptchaenterpriseV1SearchRelatedAccountGroupMembershipsRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .relatedaccountgroupmemberships_search(request, opt.value_of("project").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_relatedaccountgroups_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .relatedaccountgroups_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_relatedaccountgroups_memberships_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .relatedaccountgroups_memberships_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
        ...
        match self.opt.subcommand() {
            ("projects", Some(opt)) => match opt.subcommand() {
                ("assessments-annotate", Some(opt)) => {
                    call_result = self
                        ._projects_assessments_annotate(opt, dry_run, &mut err)
                        .await;
                }
                ("assessments-create", Some(opt)) => {
                    call_result = self
                        ._projects_assessments_create(opt, dry_run, &mut err)
                        .await;
                }
                ("firewallpolicies-create", Some(opt)) => {
                    call_result = self
                        ._projects_firewallpolicies_create(opt, dry_run, &mut err)
                        .await;
                }
                ("firewallpolicies-delete", Some(opt)) => {
                    call_result = self
                        ._projects_firewallpolicies_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("firewallpolicies-get", Some(opt)) => {
                    call_result = self
                        ._projects_firewallpolicies_get(opt, dry_run, &mut err)
                        .await;
                }
                ("firewallpolicies-list", Some(opt)) => {
                    call_result = self
                        ._projects_firewallpolicies_list(opt, dry_run, &mut err)
                        .await;
                }
                ("firewallpolicies-patch", Some(opt)) => {
                    call_result = self
                        ._projects_firewallpolicies_patch(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("keys-get-metrics", Some(opt)) => {
                    call_result = self
                        ._projects_keys_get_metrics(opt, dry_run, &mut err)
                        .await;
                }
                ("keys-list", Some(opt)) => {
                ...
                ("keys-retrieve-legacy-secret-key", Some(opt)) => {
                    call_result = self
                        ._projects_keys_retrieve_legacy_secret_key(opt, dry_run, &mut err)
                        .await;
                }
                ("relatedaccountgroupmemberships-search", Some(opt)) => {
                    call_result = self
                        ._projects_relatedaccountgroupmemberships_search(opt, dry_run, &mut err)
                        .await;
                }
                ("relatedaccountgroups-list", Some(opt)) => {
                    call_result = self
                        ._projects_relatedaccountgroups_list(opt, dry_run, &mut err)
                        .await;
                }
                ("relatedaccountgroups-memberships-list", Some(opt)) => {
                    call_result = self
                        ._projects_relatedaccountgroups_memberships_list(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "recaptchaenterprise1-secret.json",
