...
impl<C> common::Hub for FirebaseDynamicLinks<C> {}
...
impl common::Part for AnalyticsInfo {}
...
impl common::Part for AndroidInfo {}
...
impl common::RequestValue for CreateManagedShortLinkRequest {}
...
impl common::ResponseResult for CreateManagedShortLinkResponse {}
...
impl common::RequestValue for CreateShortDynamicLinkRequest {}
...
impl common::ResponseResult for CreateShortDynamicLinkResponse {}
...
impl common::Part for DesktopInfo {}
...
impl common::Part for DynamicLinkEventStat {}
...
impl common::Part for DynamicLinkInfo {}
...
impl common::ResponseResult for DynamicLinkStats {}
...
impl common::Part for DynamicLinkWarning {}
...
impl common::RequestValue for GetIosPostInstallAttributionRequest {}
...
impl common::ResponseResult for GetIosPostInstallAttributionResponse {}
...
impl common::RequestValue for GetIosReopenAttributionRequest {}
...
impl common::ResponseResult for GetIosReopenAttributionResponse {}
...
impl common::Part for GooglePlayAnalytics {}
...
impl common::Part for ITunesConnectAnalytics {}
...
impl common::Resource for ManagedShortLink {}
...
impl common::Part for SocialMetaTagInfo {}
...
impl<'a, C> common::MethodsBuilder for ManagedShortLinkMethods<'a, C> {}
...
impl<'a, C> ManagedShortLinkMethods<'a, C> {
    ...
    pub fn create(
        &self,
        request: CreateManagedShortLinkRequest,
    ) -> ManagedShortLinkCreateCall<'a, C> {
...
impl<'a, C> common::MethodsBuilder for ShortLinkMethods<'a, C> {}
...
impl<'a, C> MethodMethods<'a, C> {
    ...
    pub fn install_attribution(
        &self,
        request: GetIosPostInstallAttributionRequest,
    ) -> MethodInstallAttributionCall<'a, C> {
    ...
    pub fn reopen_attribution(
        &self,
        request: GetIosReopenAttributionRequest,
    ) -> MethodReopenAttributionCall<'a, C> {
...
impl<'a, C> common::CallBuilder for ManagedShortLinkCreateCall<'a, C> {}

impl<'a, C> ManagedShortLinkCreateCall<'a, C>
where
    C: common::Connector,
{
    ...
    pub async fn doit(
        mut self,
    ) -> common::Result<(common::Response, CreateManagedShortLinkResponse)> {
        use std::borrow::Cow;
    ...
    pub fn request(
        mut self,
        new_value: CreateManagedShortLinkRequest,
    ) -> ManagedShortLinkCreateCall<'a, C> {
    ...
    pub fn add_scope<St>(mut self, scope: St) -> ManagedShortLinkCreateCall<'a, C>
    where
        St: AsRef<str>,
    {
    ...
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ManagedShortLinkCreateCall<'a, C>
    where
    ...
    /// for details).
    pub fn clear_scopes(mut self) -> ManagedShortLinkCreateCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for ShortLinkCreateCall<'a, C> {}

impl<'a, C> ShortLinkCreateCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(
        mut self,
    ) -> common::Result<(common::Response, CreateShortDynamicLinkResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    pub fn request(
        mut self,
        new_value: CreateShortDynamicLinkRequest,
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ShortLinkCreateCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ShortLinkCreateCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ShortLinkCreateCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for MethodGetLinkStatCall<'a, C> {}

impl<'a, C> MethodGetLinkStatCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, DynamicLinkStats)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    pub fn duration_days(mut self, new_value: i64) -> MethodGetLinkStatCall<'a, C> {
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> MethodGetLinkStatCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> MethodGetLinkStatCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> MethodGetLinkStatCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for MethodInstallAttributionCall<'a, C> {}

impl<'a, C> MethodInstallAttributionCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(
        mut self,
    ) -> common::Result<(common::Response, GetIosPostInstallAttributionResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    pub fn request(
        mut self,
        new_value: GetIosPostInstallAttributionRequest,
    ) -> MethodInstallAttributionCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> MethodInstallAttributionCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> MethodInstallAttributionCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> MethodInstallAttributionCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for MethodReopenAttributionCall<'a, C> {}

impl<'a, C> MethodReopenAttributionCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(
        mut self,
    ) -> common::Result<(common::Response, GetIosReopenAttributionResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    pub fn request(
        mut self,
        new_value: GetIosReopenAttributionRequest,
    ) -> MethodReopenAttributionCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> MethodReopenAttributionCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> MethodReopenAttributionCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> MethodReopenAttributionCall<'a, C> {
        self._scopes.clear();
        self
    }
}
