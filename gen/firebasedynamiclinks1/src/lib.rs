...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/firebasedynamiclinks1).
//! # Features
//!
//! Handle the following *Resources* with ease from the central [hub](FirebaseDynamicLinks) ...
//!
//! * [managed short links](api::ManagedShortLink)
//!  * [*create*](api::ManagedShortLinkCreateCall)
//! * short links
//!  * [*create*](api::ShortLinkCreateCall)
//!
//! Other activities are ...
//!
//! * [get link stats](api::MethodGetLinkStatCall)
//! * [install attribution](api::MethodInstallAttributionCall)
//! * [reopen attribution](api::MethodReopenAttributionCall)
//!
//!
//!
...
pub mod api;
pub use api::FirebaseDynamicLinks;
