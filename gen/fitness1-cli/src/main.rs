...
use google_fitness1::{api, yup_oauth2, Error};
...
{
    async fn _users_data_sources_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        ...
        let mut request: api::DataSource = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .users()
            .data_sources_create(request, opt.value_of("user-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _users_data_sources_data_point_changes_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.users().data_sources_data_point_changes_list(
            opt.value_of("user-id").unwrap_or(""),
            opt.value_of("data-source-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _users_data_sources_datasets_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.users().data_sources_datasets_delete(
            opt.value_of("user-id").unwrap_or(""),
            opt.value_of("data-source-id").unwrap_or(""),
    ...
    async fn _users_data_sources_datasets_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.users().data_sources_datasets_get(
            opt.value_of("user-id").unwrap_or(""),
            opt.value_of("data-source-id").unwrap_or(""),
            opt.value_of("dataset-id").unwrap_or(""),
        );
    ...
    async fn _users_data_sources_datasets_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self.hub.users().data_sources_datasets_patch(
            request,
            opt.value_of("user-id").unwrap_or(""),
            opt.value_of("data-source-id").unwrap_or(""),
            opt.value_of("dataset-id").unwrap_or(""),
    ...
    async fn _users_data_sources_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.users().data_sources_delete(
            opt.value_of("user-id").unwrap_or(""),
            opt.value_of("data-source-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _users_data_sources_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.users().data_sources_get(
            opt.value_of("user-id").unwrap_or(""),
            opt.value_of("data-source-id").unwrap_or(""),
        );
        for parg in opt
    ...
    async fn _users_data_sources_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .users()
            .data_sources_list(opt.value_of("user-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _users_data_sources_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::DataSource = serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.users().data_sources_update(
            request,
            opt.value_of("user-id").unwrap_or(""),
            opt.value_of("data-source-id").unwrap_or(""),
        );
    ...
    async fn _users_dataset_aggregate(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                "bucket-by-activity-segment.activity-data-source-id" => Some((
                ...
                "bucket-by-activity-segment.min-duration-millis" => Some((
                ...
                "bucket-by-activity-type.activity-data-source-id" => Some((
                ...
                "bucket-by-activity-type.min-duration-millis" => Some((
                ...
                "bucket-by-session.min-duration-millis" => Some((
                ...
                "bucket-by-time.duration-millis" => Some((
                ...
                "bucket-by-time.period.time-zone-id" => Some((
                ...
                "bucket-by-time.period.type" => Some((
                ...
                "bucket-by-time.period.value" => Some((
                ...
                "filtered-data-quality-standard" => Some((
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        ...
                        &vec![
                            ...
                            "duration-millis",
                            "end-time-millis",
                            "filtered-data-quality-standard",
                            "min-duration-millis",
                            "period",
                            "start-time-millis",
                            "time-zone-id",
        ...
        let mut request: api::AggregateRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .users()
            .dataset_aggregate(request, opt.value_of("user-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _users_sessions_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ) -> Result<(), DoitError> {
        let mut call = self.hub.users().sessions_delete(
            opt.value_of("user-id").unwrap_or(""),
            opt.value_of("session-id").unwrap_or(""),
        );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _users_sessions_list(
        ...
        let mut call = self
            .hub
            .users()
            .sessions_list(opt.value_of("user-id").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            .iter()
        {
            ...
            match key {
                ...
                "activity-type" => {
                    call = call.add_activity_type(
                        value
                            .map(|v| arg_from_str(v, err, "activity-type", "int32"))
                            .unwrap_or(-0),
                    );
                }
                _ => {
    ...
    async fn _users_sessions_update(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self.hub.users().sessions_update(
            request,
            opt.value_of("user-id").unwrap_or(""),
            opt.value_of("session-id").unwrap_or(""),
        );
        ...
        match self.opt.subcommand() {
            ("users", Some(opt)) => match opt.subcommand() {
                ("data-sources-create", Some(opt)) => {
                    call_result = self
                        ._users_data_sources_create(opt, dry_run, &mut err)
                        .await;
                }
                ("data-sources-data-point-changes-list", Some(opt)) => {
                    call_result = self
                        ._users_data_sources_data_point_changes_list(opt, dry_run, &mut err)
                        .await;
                }
                ("data-sources-datasets-delete", Some(opt)) => {
                    call_result = self
                        ._users_data_sources_datasets_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("data-sources-datasets-get", Some(opt)) => {
                    call_result = self
                        ._users_data_sources_datasets_get(opt, dry_run, &mut err)
                        .await;
                }
                ("data-sources-datasets-patch", Some(opt)) => {
                    call_result = self
                        ._users_data_sources_datasets_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("data-sources-delete", Some(opt)) => {
                    call_result = self
                        ._users_data_sources_delete(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("data-sources-update", Some(opt)) => {
                    call_result = self
                        ._users_data_sources_update(opt, dry_run, &mut err)
                        .await;
                }
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "fitness1-secret.json",
        ...
        .persist_tokens_to_disk(format!("{}/fitness1", config_dir))
        .build()
        .await
        .unwrap();
