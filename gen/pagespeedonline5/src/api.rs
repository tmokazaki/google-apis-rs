...
impl<C> common::Hub for PagespeedInsights<C> {}
...
impl common::Part for AuditRefs {}
...
impl common::Part for CategoryGroupV5 {}
...
impl common::Part for ConfigSettings {}
...
impl common::Part for LhrEntity {}
...
impl common::Part for LighthouseAuditResultV5 {}
...
impl common::Part for LighthouseCategoryV5 {}
...
impl common::Part for PagespeedApiLoadingExperienceV5 {}
...
impl common::ResponseResult for PagespeedApiPagespeedResponseV5 {}
...
impl common::Part for PagespeedVersion {}
...
impl common::Part for RendererFormattedStrings {}
...
impl common::Part for RuntimeError {}
...
impl common::Part for StackPack {}
...
impl common::Part for UserPageLoadMetricV5 {}
    ...
    C: common::Connector,
{
    ...
    pub async fn doit(
        mut self,
    ) -> common::Result<(common::Response, PagespeedApiPagespeedResponseV5)> {
        use std::borrow::Cow;
    ...
    pub fn add_scope<St>(mut self, scope: St) -> PagespeedapiRunpagespeedCall<'a, C>
    where
        St: AsRef<str>,
    {
    ...
    pub fn add_scopes<I, St>(mut self, scopes: I) -> PagespeedapiRunpagespeedCall<'a, C>
    where
    ...
    /// for details).
    pub fn clear_scopes(mut self) -> PagespeedapiRunpagespeedCall<'a, C> {
        self._scopes.clear();
        self
    }
}
