...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/pagespeedonline5).
//! # Features
//!
//! Handle the following *Resources* with ease from the central [hub](PagespeedInsights) ...
//!
//! * pagespeedapi
//!  * [*runpagespeed*](api::PagespeedapiRunpagespeedCall)
//!
//!
//!
//!
