...
impl<C> common::Hub for Digitalassetlinks<C> {}
...
impl common::Part for AndroidAppAsset {}
...
impl common::RequestValue for BulkCheckRequest {}
...
impl common::ResponseResult for BulkCheckResponse {}
...
impl common::Part for CertificateInfo {}
...
impl common::ResponseResult for ListResponse {}
...
impl common::Resource for Statement {}
...
impl common::Part for StatementTemplate {}
...
impl<'a, C> common::MethodsBuilder for AssetlinkMethods<'a, C> {}
...
impl<'a, C> AssetlinkMethods<'a, C> {
    ...
    pub fn bulk_check(&self, request: BulkCheckRequest) -> AssetlinkBulkCheckCall<'a, C> {
...
impl<'a, C> common::MethodsBuilder for StatementMethods<'a, C> {}
...
/// # }
/// ```
pub struct AssetlinkBulkCheckCall<'a, C>
where
    C: 'a,
{
    hub: &'a Digitalassetlinks<C>,
...
impl<'a, C> common::CallBuilder for AssetlinkBulkCheckCall<'a, C> {}

impl<'a, C> AssetlinkBulkCheckCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, BulkCheckResponse)> {
        use std::borrow::Cow;
    ...
    pub fn request(mut self, new_value: BulkCheckRequest) -> AssetlinkBulkCheckCall<'a, C> {
    ...
    pub fn param<T>(mut self, name: T, value: T) -> AssetlinkBulkCheckCall<'a, C>
    where
        T: AsRef<str>,
    {
...
impl<'a, C> common::CallBuilder for AssetlinkCheckCall<'a, C> {}

impl<'a, C> AssetlinkCheckCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, CheckResponse)> {
        ...
        if let Some(value) = self
            ._target_android_app_certificate_sha256_fingerprint
            .as_ref()
        {
        ...
        if let Some(value) = self
            ._source_android_app_certificate_sha256_fingerprint
            .as_ref()
        {
    ...
    pub fn target_android_app_certificate_sha256_fingerprint(
        mut self,
        new_value: &str,
    ) -> AssetlinkCheckCall<'a, C> {
...
impl<'a, C> common::CallBuilder for StatementListCall<'a, C> {}

impl<'a, C> StatementListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, ListResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> StatementListCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
