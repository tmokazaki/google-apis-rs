...
use google_iap1::{api, yup_oauth2, Error};
...
{
    async fn _methods_get_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
    ...
    async fn _methods_get_iap_settings(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .methods()
            .get_iap_settings(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _methods_set_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _methods_test_iam_permissions(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _methods_update_iap_settings(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    "access-settings.allowed-domains-settings.domains" => Some(("accessSettings.allowedDomainsSettings.domains", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Vec })),
                    "access-settings.allowed-domains-settings.enable" => Some(("accessSettings.allowedDomainsSettings.enable", JsonTypeInfo { jtype: JsonType::Boolean, ctype: ComplexType::Pod })),
                    ...
                    "application-settings.attribute-propagation-settings.enable" => Some(("applicationSettings.attributePropagationSettings.enable", JsonTypeInfo { jtype: JsonType::Boolean, ctype: ComplexType::Pod })),
                    "application-settings.attribute-propagation-settings.expression" => Some(("applicationSettings.attributePropagationSettings.expression", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "application-settings.attribute-propagation-settings.output-credentials" => Some(("applicationSettings.attributePropagationSettings.outputCredentials", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Vec })),
        ...
        let mut request: api::IapSettings = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .methods()
            .update_iap_settings(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _methods_validate_attribute_expression(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .methods()
            .validate_attribute_expression(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_brands_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::Brand = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .brands_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_brands_get(
        ...
        let mut call = self
            .hub
            .projects()
            .brands_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_brands_identity_aware_proxy_clients_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion =
                        FieldCursor::did_you_mean(key, &vec!["display-name", "name", "secret"]);
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
                        value.map(|v| v.to_string()),
        ...
        let mut request: api::IdentityAwareProxyClient =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .brands_identity_aware_proxy_clients_create(
                request,
    ...
    async fn _projects_brands_identity_aware_proxy_clients_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .brands_identity_aware_proxy_clients_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_brands_identity_aware_proxy_clients_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .brands_identity_aware_proxy_clients_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_brands_identity_aware_proxy_clients_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .brands_identity_aware_proxy_clients_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_brands_identity_aware_proxy_clients_reset_secret(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::ResetIdentityAwareProxyClientSecretRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .brands_identity_aware_proxy_clients_reset_secret(
                request,
    ...
    async fn _projects_brands_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .brands_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_iap_tunnel_locations_dest_groups_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion =
                        FieldCursor::did_you_mean(key, &vec!["cidrs", "fqdns", "name"]);
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
                        value.map(|v| v.to_string()),
        ...
        let mut request: api::TunnelDestGroup = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .iap_tunnel_locations_dest_groups_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            .iter()
        {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "tunnel-dest-group-id" => {
                    call = call.tunnel_dest_group_id(value.unwrap_or(""));
                }
                _ => {
                    let mut found = false;
                    for param in &self.gp {
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                let mut v = Vec::new();
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(["tunnel-dest-group-id"].iter().map(|v| *v));
                                v
                            }));
                    }
                }
    ...
    async fn _projects_iap_tunnel_locations_dest_groups_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .iap_tunnel_locations_dest_groups_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_iap_tunnel_locations_dest_groups_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .iap_tunnel_locations_dest_groups_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_iap_tunnel_locations_dest_groups_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .iap_tunnel_locations_dest_groups_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_iap_tunnel_locations_dest_groups_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .iap_tunnel_locations_dest_groups_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _doit(
        ...
        match self.opt.subcommand() {
            ("methods", Some(opt)) => match opt.subcommand() {
                ...
                ("test-iam-permissions", Some(opt)) => {
                    call_result = self
                        ._methods_test_iam_permissions(opt, dry_run, &mut err)
                        .await;
                }
                ("update-iap-settings", Some(opt)) => {
                    call_result = self
                        ._methods_update_iap_settings(opt, dry_run, &mut err)
                        .await;
                }
                ("validate-attribute-expression", Some(opt)) => {
                    call_result = self
                        ._methods_validate_attribute_expression(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
                        .push(CLIError::MissingMethodError("methods".to_string()));
            ...
            ("projects", Some(opt)) => match opt.subcommand() {
                ...
                ("brands-identity-aware-proxy-clients-create", Some(opt)) => {
                    call_result = self
                        ._projects_brands_identity_aware_proxy_clients_create(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("brands-identity-aware-proxy-clients-delete", Some(opt)) => {
                    call_result = self
                        ._projects_brands_identity_aware_proxy_clients_delete(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("brands-identity-aware-proxy-clients-get", Some(opt)) => {
                    call_result = self
                        ._projects_brands_identity_aware_proxy_clients_get(opt, dry_run, &mut err)
                        .await;
                }
                ("brands-identity-aware-proxy-clients-list", Some(opt)) => {
                    call_result = self
                        ._projects_brands_identity_aware_proxy_clients_list(opt, dry_run, &mut err)
                        .await;
                }
                ("brands-identity-aware-proxy-clients-reset-secret", Some(opt)) => {
                    call_result = self
                        ._projects_brands_identity_aware_proxy_clients_reset_secret(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ...
                ("iap-tunnel-locations-dest-groups-create", Some(opt)) => {
                    call_result = self
                        ._projects_iap_tunnel_locations_dest_groups_create(opt, dry_run, &mut err)
                        .await;
                }
                ("iap-tunnel-locations-dest-groups-delete", Some(opt)) => {
                    call_result = self
                        ._projects_iap_tunnel_locations_dest_groups_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("iap-tunnel-locations-dest-groups-get", Some(opt)) => {
                    call_result = self
                        ._projects_iap_tunnel_locations_dest_groups_get(opt, dry_run, &mut err)
                        .await;
                }
                ("iap-tunnel-locations-dest-groups-list", Some(opt)) => {
                    call_result = self
                        ._projects_iap_tunnel_locations_dest_groups_list(opt, dry_run, &mut err)
                        .await;
                }
                ("iap-tunnel-locations-dest-groups-patch", Some(opt)) => {
                    call_result = self
                        ._projects_iap_tunnel_locations_dest_groups_patch(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "iap1-secret.json",
...
async fn main() {
    ...
    let arg_data = [
        ("methods", "methods: 'get-iam-policy', 'get-iap-settings', 'set-iam-policy', 'test-iam-permissions', 'update-iap-settings' and 'validate-attribute-expression'", vec![
            ...
            ("get-iap-settings",
                    Some(r##"Gets the IAP settings on a particular IAP protected resource."##),
                    "Details at http://byron.github.io/google-apis-rs/google_iap1_cli/methods_get-iap-settings",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("brands-get",
                    Some(r##"Retrieves the OAuth brand of the project."##),
                    "Details at http://byron.github.io/google-apis-rs/google_iap1_cli/projects_brands-get",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("brands-identity-aware-proxy-clients-list",
                    Some(r##"Lists the existing clients for the brand."##),
                    "Details at http://byron.github.io/google-apis-rs/google_iap1_cli/projects_brands-identity-aware-proxy-clients-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("brands-list",
                    Some(r##"Lists the existing brands for the project."##),
                    "Details at http://byron.github.io/google-apis-rs/google_iap1_cli/projects_brands-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("iap-tunnel-locations-dest-groups-create",
                    Some(r##"Creates a new TunnelDestGroup."##),
                    "Details at http://byron.github.io/google-apis-rs/google_iap1_cli/projects_iap-tunnel-locations-dest-groups-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. Google Cloud Project ID and location. In the following format: `projects/{project_number/id}/iap_tunnel/locations/{location}`."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("iap-tunnel-locations-dest-groups-delete",
                    Some(r##"Deletes a TunnelDestGroup."##),
                    "Details at http://byron.github.io/google-apis-rs/google_iap1_cli/projects_iap-tunnel-locations-dest-groups-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. Name of the TunnelDestGroup to delete. In the following format: `projects/{project_number/id}/iap_tunnel/locations/{location}/destGroups/{dest_group}`."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("iap-tunnel-locations-dest-groups-get",
                    Some(r##"Retrieves an existing TunnelDestGroup."##),
                    "Details at http://byron.github.io/google-apis-rs/google_iap1_cli/projects_iap-tunnel-locations-dest-groups-get",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. Name of the TunnelDestGroup to be fetched. In the following format: `projects/{project_number/id}/iap_tunnel/locations/{location}/destGroups/{dest_group}`."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("iap-tunnel-locations-dest-groups-list",
                    Some(r##"Lists the existing TunnelDestGroups. To group across all locations, use a `-` as the location ID. For example: `/v1/projects/123/iap_tunnel/locations/-/destGroups`"##),
                    "Details at http://byron.github.io/google-apis-rs/google_iap1_cli/projects_iap-tunnel-locations-dest-groups-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. Google Cloud Project ID and location. In the following format: `projects/{project_number/id}/iap_tunnel/locations/{location}`. A `-` can be used for the location to group across all locations."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("iap-tunnel-locations-dest-groups-patch",
                    Some(r##"Updates a TunnelDestGroup."##),
                    "Details at http://byron.github.io/google-apis-rs/google_iap1_cli/projects_iap-tunnel-locations-dest-groups-patch",
                  vec![
                    (Some(r##"name"##),
                     None,
