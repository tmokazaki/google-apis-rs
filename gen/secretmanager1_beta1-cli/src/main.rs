...
use google_secretmanager1_beta1::{api, yup_oauth2, Error};
    ...
    C: apis_common::Connector,
{
    ...
    async fn _projects_secrets_add_version(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(key, &vec!["data", "payload"]);
    ...
    async fn _projects_secrets_create(
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion =
                        FieldCursor::did_you_mean(key, &vec!["create-time", "labels", "name"]);
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
                        value.map(|v| v.to_string()),
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "secretmanager1-beta1-secret.json",
        ...
        .persist_tokens_to_disk(format!("{}/secretmanager1-beta1", config_dir))
        .build()
        .await
        .unwrap();
...
async fn main() {
    ...
    let arg_data = [
        ("projects", "methods: 'locations-get', 'locations-list', 'secrets-add-version', 'secrets-create', 'secrets-delete', 'secrets-get', 'secrets-get-iam-policy', 'secrets-list', 'secrets-patch', 'secrets-set-iam-policy', 'secrets-test-iam-permissions', 'secrets-versions-access', 'secrets-versions-destroy', 'secrets-versions-disable', 'secrets-versions-enable', 'secrets-versions-get' and 'secrets-versions-list'", vec![
            ("locations-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_secretmanager1_beta1_cli/projects_locations-get",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_secretmanager1_beta1_cli/projects_locations-list",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("secrets-add-version",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_secretmanager1_beta1_cli/projects_secrets-add-version",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("secrets-create",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_secretmanager1_beta1_cli/projects_secrets-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("secrets-delete",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_secretmanager1_beta1_cli/projects_secrets-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("secrets-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_secretmanager1_beta1_cli/projects_secrets-get",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The resource name of the Secret, in the format `projects/*/secrets/*`."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("secrets-get-iam-policy",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_secretmanager1_beta1_cli/projects_secrets-get-iam-policy",
                  vec![
                    (Some(r##"resource"##),
                     None,
            ...
            ("secrets-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_secretmanager1_beta1_cli/projects_secrets-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("secrets-patch",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_secretmanager1_beta1_cli/projects_secrets-patch",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("secrets-set-iam-policy",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_secretmanager1_beta1_cli/projects_secrets-set-iam-policy",
                  vec![
                    (Some(r##"resource"##),
                     None,
            ...
            ("secrets-test-iam-permissions",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_secretmanager1_beta1_cli/projects_secrets-test-iam-permissions",
                  vec![
                    (Some(r##"resource"##),
                     None,
            ...
            ("secrets-versions-access",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_secretmanager1_beta1_cli/projects_secrets-versions-access",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("secrets-versions-destroy",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_secretmanager1_beta1_cli/projects_secrets-versions-destroy",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("secrets-versions-disable",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_secretmanager1_beta1_cli/projects_secrets-versions-disable",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("secrets-versions-enable",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_secretmanager1_beta1_cli/projects_secrets-versions-enable",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("secrets-versions-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_secretmanager1_beta1_cli/projects_secrets-versions-get",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("secrets-versions-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_secretmanager1_beta1_cli/projects_secrets-versions-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
    ...
    let mut app = App::new("secretmanager1-beta1")
           ...
           .after_help("All documentation details can be found at http://byron.github.io/google-apis-rs/google_secretmanager1_beta1_cli")
