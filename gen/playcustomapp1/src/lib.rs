...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/playcustomapp1).
//! # Features
//!
//! Handle the following *Resources* with ease from the central [hub](Playcustomapp) ...
//!
//! * accounts
//!  * [*custom apps create*](api::AccountCustomAppCreateCall)
//!
//!
//! Upload supported by ...
//!
//! * [*custom apps create accounts*](api::AccountCustomAppCreateCall)
//!
//!
//!
...
//! // Values shown here are possibly random and not representative !
//! let result = hub.accounts().custom_apps_create(req, -33)
