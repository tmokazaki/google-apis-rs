...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/factchecktools1_alpha1).
//! # Features
//!
//! Handle the following *Resources* with ease from the central [hub](FactCheckTools) ...
//!
//! * claims
//!  * [*image search*](api::ClaimImageSearchCall) and [*search*](api::ClaimSearchCall)
//! * pages
//!  * [*create*](api::PageCreateCall), [*delete*](api::PageDeleteCall), [*get*](api::PageGetCall), [*list*](api::PageListCall) and [*update*](api::PageUpdateCall)
//!
//!
//!
//!
