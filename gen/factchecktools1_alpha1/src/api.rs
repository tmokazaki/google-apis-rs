...
impl AsRef<str> for Scope {
    fn as_ref(&self) -> &str {
        match *self {
            Scope::Full => "https://www.googleapis.com/auth/factchecktools",
...
impl<C> common::Hub for FactCheckTools<C> {}
...
pub struct GoogleFactcheckingFactchecktoolsV1alpha1Claim {
    ...
    pub claim_date: Option<chrono::DateTime<chrono::offset::Utc>>,
...
impl common::Part for GoogleFactcheckingFactchecktoolsV1alpha1Claim {}
...
impl common::Part for GoogleFactcheckingFactchecktoolsV1alpha1ClaimAuthor {}
...
impl common::Part for GoogleFactcheckingFactchecktoolsV1alpha1ClaimRating {}
...
pub struct GoogleFactcheckingFactchecktoolsV1alpha1ClaimReview {
    ...
    pub review_date: Option<chrono::DateTime<chrono::offset::Utc>>,
...
impl common::Part for GoogleFactcheckingFactchecktoolsV1alpha1ClaimReview {}
...
impl common::Part for GoogleFactcheckingFactchecktoolsV1alpha1ClaimReviewAuthor {}
...
impl common::Part for GoogleFactcheckingFactchecktoolsV1alpha1ClaimReviewMarkup {}
...
impl common::RequestValue for GoogleFactcheckingFactchecktoolsV1alpha1ClaimReviewMarkupPage {}
impl common::ResponseResult for GoogleFactcheckingFactchecktoolsV1alpha1ClaimReviewMarkupPage {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [image search claims](ClaimImageSearchCall) (response)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
...
pub struct GoogleFactcheckingFactchecktoolsV1alpha1FactCheckedClaimImageSearchResponseResult {
    ...
    pub claim: Option<GoogleFactcheckingFactchecktoolsV1alpha1Claim>,
}

impl common::Part
    for GoogleFactcheckingFactchecktoolsV1alpha1FactCheckedClaimImageSearchResponseResult
{
}
...
impl common::Part for GoogleFactcheckingFactchecktoolsV1alpha1Publisher {}
...
/// Search through fact-checked claims using an image as the query.
///
/// A builder for the *imageSearch* method supported by a *claim* resource.
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.claims().image_search()
///              .page_token("ipsum")
///              .page_size(-28)
///              .offset(-27)
...
/// # }
/// ```
pub struct ClaimImageSearchCall<'a, C>
where
    C: 'a,
{
    hub: &'a FactCheckTools<C>,
...
impl<'a, C> common::CallBuilder for ClaimImageSearchCall<'a, C> {}

impl<'a, C> ClaimImageSearchCall<'a, C>
where
    C: common::Connector,
{
    ...
    pub async fn doit(
        ...
        if let Some(value) = self._image_uri.as_ref() {
            params.push("imageUri", value);
        }

        params.extend(self._additional_params.iter());

        params.push("alt", "json");
        let mut url = self.hub._base_url.clone() + "v1alpha1/claims:imageSearch";
    ...
    pub fn page_token(mut self, new_value: &str) -> ClaimImageSearchCall<'a, C> {
    ...
    pub fn page_size(mut self, new_value: i32) -> ClaimImageSearchCall<'a, C> {
    ...
    pub fn offset(mut self, new_value: i32) -> ClaimImageSearchCall<'a, C> {
    ...
    pub fn language_code(mut self, new_value: &str) -> ClaimImageSearchCall<'a, C> {
    ...
    ///
    /// Sets the *image uri* query property to the given value.
    pub fn image_uri(mut self, new_value: &str) -> ClaimImageSearchCall<'a, C> {
        self._image_uri = Some(new_value.to_string());
        self
    }
    ...
    pub fn param<T>(mut self, name: T, value: T) -> ClaimImageSearchCall<'a, C>
    where
        T: AsRef<str>,
    {
...
///              .review_publisher_site_filter("amet.")
///              .query("takimata")
///              .page_token("amet.")
///              .page_size(-20)
///              .offset(-55)
...
impl<'a, C> common::CallBuilder for ClaimSearchCall<'a, C> {}

impl<'a, C> ClaimSearchCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(
        ...
        if let Some(value) = self._review_publisher_site_filter.as_ref() {
            params.push("reviewPublisherSiteFilter", value);
        }
        ...
        if let Some(value) = self._max_age_days.as_ref() {
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> ClaimSearchCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
...
impl<'a, C> common::CallBuilder for PageCreateCall<'a, C> {}

impl<'a, C> PageCreateCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    pub fn request(
        mut self,
        new_value: GoogleFactcheckingFactchecktoolsV1alpha1ClaimReviewMarkupPage,
    ) -> PageCreateCall<'a, C> {
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> PageCreateCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    pub fn add_scope<St>(mut self, scope: St) -> PageCreateCall<'a, C>
    where
        St: AsRef<str>,
    {
    ...
    pub fn add_scopes<I, St>(mut self, scopes: I) -> PageCreateCall<'a, C>
    where
    ...
    /// for details).
    pub fn clear_scopes(mut self) -> PageCreateCall<'a, C> {
        self._scopes.clear();
        self
    }
}
    ...
    C: common::Connector,
{
    ...
    pub async fn doit(
        ...
        if let Some(value) = self._organization.as_ref() {
            params.push("organization", value);
        }
        if let Some(value) = self._offset.as_ref() {
            params.push("offset", value.to_string());
        }
