...
impl<C> common::Hub for WebRisk<C> {}

impl<'a, C> WebRisk<C> {
    pub fn new<A: 'static + common::GetToken>(client: common::Client<C>, auth: A) -> WebRisk<C> {
        WebRisk {
            client,
            auth: Box::new(auth),
    ...
    pub fn hashes(&'a self) -> HashMethods<'a, C> {
        HashMethods { hub: self }
    }
    ...
    pub fn uris(&'a self) -> UriMethods<'a, C> {
        UriMethods { hub: self }
    }
...
pub struct GoogleCloudWebriskV1ComputeThreatListDiffResponse {
    ...
    pub recommended_next_diff: Option<chrono::DateTime<chrono::offset::Utc>>,
...
impl common::ResponseResult for GoogleCloudWebriskV1ComputeThreatListDiffResponse {}
...
impl common::Part for GoogleCloudWebriskV1ComputeThreatListDiffResponseChecksum {}
...
impl common::Part for GoogleCloudWebriskV1RawHashes {}
...
impl common::Part for GoogleCloudWebriskV1RawIndices {}
...
impl common::Part for GoogleCloudWebriskV1RiceDeltaEncoding {}
...
pub struct GoogleCloudWebriskV1SearchHashesResponse {
    ...
    pub negative_expire_time: Option<chrono::DateTime<chrono::offset::Utc>>,
...
impl common::ResponseResult for GoogleCloudWebriskV1SearchHashesResponse {}
...
impl common::Part for GoogleCloudWebriskV1SearchHashesResponseThreatHash {}
...
impl common::ResponseResult for GoogleCloudWebriskV1SearchUrisResponse {}
...
impl common::Part for GoogleCloudWebriskV1SearchUrisResponseThreatUri {}
...
impl common::RequestValue for GoogleCloudWebriskV1Submission {}
impl common::ResponseResult for GoogleCloudWebriskV1Submission {}
...
impl common::Part for GoogleCloudWebriskV1ThreatEntryAdditions {}
...
impl common::Part for GoogleCloudWebriskV1ThreatEntryRemovals {}
...
impl<'a, C> common::MethodsBuilder for HashMethods<'a, C> {}

impl<'a, C> HashMethods<'a, C> {
    /// Create a builder to help you perform the following task:
    ///
    /// Gets the full hashes that match the requested hash prefix. This is used after a hash prefix is looked up in a threatList and there is a match. The client side threatList only holds partial hashes so the client must query this method to determine if there is a full hash match of a threat.
    pub fn search(&self) -> HashSearchCall<'a, C> {
        HashSearchCall {
            hub: self.hub,
...
impl<'a, C> ProjectMethods<'a, C> {
    ...
    pub fn submissions_create(
        &self,
        request: GoogleCloudWebriskV1Submission,
        parent: &str,
    ) -> ProjectSubmissionCreateCall<'a, C> {
...
impl<'a, C> ThreatListMethods<'a, C> {
    ...
    pub fn compute_diff(&self) -> ThreatListComputeDiffCall<'a, C> {
...
impl<'a, C> common::MethodsBuilder for UriMethods<'a, C> {}
...
/// Gets the full hashes that match the requested hash prefix. This is used after a hash prefix is looked up in a threatList and there is a match. The client side threatList only holds partial hashes so the client must query this method to determine if there is a full hash match of a threat.
///
/// A builder for the *search* method supported by a *hash* resource.
/// It is not used directly, but through a [`HashMethods`] instance.
///
/// # Example
///
...
/// # }
/// ```
pub struct HashSearchCall<'a, C>
where
    C: 'a,
{
    hub: &'a WebRisk<C>,
    _threat_types: Vec<String>,
    _hash_prefix: Option<Vec<u8>>,
    _delegate: Option<&'a mut dyn common::Delegate>,
    _additional_params: HashMap<String, String>,
    _scopes: BTreeSet<String>,
}

impl<'a, C> common::CallBuilder for HashSearchCall<'a, C> {}

impl<'a, C> HashSearchCall<'a, C>
where
    C: common::Connector,
{
    ...
    pub async fn doit(
        mut self,
    ) -> common::Result<(common::Response, GoogleCloudWebriskV1SearchHashesResponse)> {
        use std::borrow::Cow;
        ...
        if !self._threat_types.is_empty() {
            for f in self._threat_types.iter() {
                params.push("threatTypes", f);
            }
        }
    ...
    pub fn add_threat_types(mut self, new_value: &str) -> HashSearchCall<'a, C> {
    ...
    pub fn hash_prefix(mut self, new_value: Vec<u8>) -> HashSearchCall<'a, C> {
        self._hash_prefix = Some(new_value);
        self
    }
    ...
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> HashSearchCall<'a, C> {
    ...
    pub fn param<T>(mut self, name: T, value: T) -> HashSearchCall<'a, C>
    where
        T: AsRef<str>,
    {
    ...
    pub fn add_scope<St>(mut self, scope: St) -> HashSearchCall<'a, C>
    where
        St: AsRef<str>,
    {
    ...
    pub fn add_scopes<I, St>(mut self, scopes: I) -> HashSearchCall<'a, C>
    where
    ...
    /// for details).
    pub fn clear_scopes(mut self) -> HashSearchCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ProjectSubmissionCreateCall<'a, C>
where
    C: 'a,
{
    hub: &'a WebRisk<C>,
...
impl<'a, C> common::CallBuilder for ProjectSubmissionCreateCall<'a, C> {}

impl<'a, C> ProjectSubmissionCreateCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(
        mut self,
    ) -> common::Result<(common::Response, GoogleCloudWebriskV1Submission)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    pub fn request(
        mut self,
        new_value: GoogleCloudWebriskV1Submission,
    ) -> ProjectSubmissionCreateCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> ProjectSubmissionCreateCall<'a, C> {
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ProjectSubmissionCreateCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ProjectSubmissionCreateCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectSubmissionCreateCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectSubmissionCreateCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ThreatListComputeDiffCall<'a, C>
where
    C: 'a,
{
    hub: &'a WebRisk<C>,
    _version_token: Option<Vec<u8>>,
...
impl<'a, C> common::CallBuilder for ThreatListComputeDiffCall<'a, C> {}

impl<'a, C> ThreatListComputeDiffCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(
        ...
        if !self._constraints_supported_compressions.is_empty() {
            for f in self._constraints_supported_compressions.iter() {
                params.push("constraints.supportedCompressions", f);
            }
        }
        if let Some(value) = self._constraints_max_diff_entries.as_ref() {
            params.push("constraints.maxDiffEntries", value.to_string());
        }
        if let Some(value) = self._constraints_max_database_entries.as_ref() {
    ...
    pub fn version_token(mut self, new_value: Vec<u8>) -> ThreatListComputeDiffCall<'a, C> {
        self._version_token = Some(new_value);
        self
    }
    ...
    pub fn threat_type(mut self, new_value: &str) -> ThreatListComputeDiffCall<'a, C> {
    ...
    pub fn add_constraints_supported_compressions(
        mut self,
        new_value: &str,
    ) -> ThreatListComputeDiffCall<'a, C> {
        self._constraints_supported_compressions
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ThreatListComputeDiffCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ThreatListComputeDiffCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ThreatListComputeDiffCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ThreatListComputeDiffCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for UriSearchCall<'a, C> {}

impl<'a, C> UriSearchCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(
        mut self,
    ) -> common::Result<(common::Response, GoogleCloudWebriskV1SearchUrisResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    pub fn uri(mut self, new_value: &str) -> UriSearchCall<'a, C> {
    ...
    /// Append the given value to the *threat types* query property.
    /// Each appended value will retain its original ordering and be '/'-separated in the URL's parameters.
    pub fn add_threat_types(mut self, new_value: &str) -> UriSearchCall<'a, C> {
        self._threat_types.push(new_value.to_string());
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> UriSearchCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> UriSearchCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> UriSearchCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> UriSearchCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> UriSearchCall<'a, C> {
        self._scopes.clear();
        self
    }
}
