...
impl<C> common::Hub for FirebaseCloudMessaging<C> {}

impl<'a, C> FirebaseCloudMessaging<C> {
    pub fn new<A: 'static + common::GetToken>(
        client: common::Client<C>,
        auth: A,
    ) -> FirebaseCloudMessaging<C> {
...
impl common::Part for AndroidConfig {}
...
impl common::Part for AndroidFcmOptions {}
...
pub struct AndroidNotification {
    ...
    #[serde_as(as = "Option<Vec<common::serde::duration::Wrapper>>")]
    pub vibrate_timings: Option<Vec<chrono::Duration>>,
...
impl common::Part for AndroidNotification {}
...
impl common::Part for ApnsConfig {}
...
impl common::Part for ApnsFcmOptions {}
...
impl common::Part for FcmOptions {}
...
pub struct LightSettings {
    ...
    #[serde_as(as = "Option<common::serde::duration::Wrapper>")]
    pub light_off_duration: Option<chrono::Duration>,
    ...
    #[serde_as(as = "Option<common::serde::duration::Wrapper>")]
    pub light_on_duration: Option<chrono::Duration>,
}

impl common::Part for LightSettings {}
...
impl common::RequestValue for SendMessageRequest {}
...
impl common::Part for WebpushConfig {}
...
impl common::Part for WebpushFcmOptions {}
...
impl<'a, C> common::CallBuilder for ProjectMessageSendCall<'a, C> {}

impl<'a, C> ProjectMessageSendCall<'a, C>
where
    C: common::Connector,
{
    ...
    pub fn add_scope<St>(mut self, scope: St) -> ProjectMessageSendCall<'a, C>
    where
        St: AsRef<str>,
    {
    ...
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ProjectMessageSendCall<'a, C>
    where
    ...
    /// for details).
    pub fn clear_scopes(mut self) -> ProjectMessageSendCall<'a, C> {
        self._scopes.clear();
        self
    }
}
