...
use google_cloudasset1_beta1::{api, yup_oauth2, Error};
...
{
    async fn _folders_export_assets(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
    ...
    async fn _folders_operations_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _organizations_batch_get_assets_history(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _organizations_export_assets(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _organizations_operations_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_batch_get_assets_history(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_export_assets(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        match self.opt.subcommand() {
            ...
            ("organizations", Some(opt)) => match opt.subcommand() {
                ("batch-get-assets-history", Some(opt)) => {
                    call_result = self
                        ._organizations_batch_get_assets_history(opt, dry_run, &mut err)
                        .await;
                }
                ("export-assets", Some(opt)) => {
                    call_result = self
                        ._organizations_export_assets(opt, dry_run, &mut err)
                        .await;
                }
                ("operations-get", Some(opt)) => {
                    call_result = self
                        ._organizations_operations_get(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
            ...
            ("projects", Some(opt)) => match opt.subcommand() {
                ("batch-get-assets-history", Some(opt)) => {
                    call_result = self
                        ._projects_batch_get_assets_history(opt, dry_run, &mut err)
                        .await;
                }
                ("export-assets", Some(opt)) => {
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "cloudasset1-beta1-secret.json",
        ...
        .persist_tokens_to_disk(format!("{}/cloudasset1-beta1", config_dir))
        .build()
        .await
        .unwrap();
