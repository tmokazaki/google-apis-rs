...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/cloudasset1).
//! # Features
//!
//! Handle the following *Resources* with ease from the central [hub](CloudAsset) ...
//!
//! * [assets](api::Asset)
//!  * [*list*](api::AssetListCall)
//! * [effective iam policies](api::EffectiveIamPolicy)
//!  * [*batch get*](api::EffectiveIamPolicyBatchGetCall)
//! * [feeds](api::Feed)
//!  * [*create*](api::FeedCreateCall), [*delete*](api::FeedDeleteCall), [*get*](api::FeedGetCall), [*list*](api::FeedListCall) and [*patch*](api::FeedPatchCall)
//! * [operations](api::Operation)
//!  * [*get*](api::OperationGetCall)
//! * [saved queries](api::SavedQuery)
//!  * [*create*](api::SavedQueryCreateCall), [*delete*](api::SavedQueryDeleteCall), [*get*](api::SavedQueryGetCall), [*list*](api::SavedQueryListCall) and [*patch*](api::SavedQueryPatchCall)
//!
//! Other activities are ...
//!
//! * [analyze iam policy](api::MethodAnalyzeIamPolicyCall)
//! * [analyze iam policy longrunning](api::MethodAnalyzeIamPolicyLongrunningCall)
//! * [analyze move](api::MethodAnalyzeMoveCall)
//! * [analyze org policies](api::MethodAnalyzeOrgPolicyCall)
//! * [analyze org policy governed assets](api::MethodAnalyzeOrgPolicyGovernedAssetCall)
//! * [analyze org policy governed containers](api::MethodAnalyzeOrgPolicyGovernedContainerCall)
//! * [batch get assets history](api::MethodBatchGetAssetsHistoryCall)
//! * [export assets](api::MethodExportAssetCall)
//! * [query assets](api::MethodQueryAssetCall)
//! * [search all iam policies](api::MethodSearchAllIamPolicyCall)
//! * [search all resources](api::MethodSearchAllResourceCall)
//!
//!
//!
