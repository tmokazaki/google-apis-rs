...
use google_firebaseml1::{api, yup_oauth2, Error};
    ...
    C: apis_common::Connector,
{
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "firebaseml1-secret.json",
        ...
        .persist_tokens_to_disk(format!("{}/firebaseml1", config_dir))
        .build()
        .await
        .unwrap();
        ...
        let engine = Engine {
            opt,
            hub: api::FirebaseML::new(client, auth),
            gp: vec![
                "$-xgafv",
                "access-token",
                "alt",
    ...
    let arg_data = [
        ("operations", "methods: 'cancel', 'delete' and 'list'", vec![
            ("cancel",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_firebaseml1_cli/operations_cancel",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("delete",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_firebaseml1_cli/operations_delete",
                  vec![
                    (Some(r##"name"##),
                     None,
