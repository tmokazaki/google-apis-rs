...
use google_bigquerydatatransfer1::{api, yup_oauth2, Error};
...
struct Engine<'n, C> {
    opt: ArgMatches<'n>,
    hub: api::BigQueryDataTransfer<C>,
    gp: Vec<&'static str>,
...
{
    async fn _projects_data_sources_check_valid_creds(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        ...
        let mut request: api::CheckValidCredsRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .data_sources_check_valid_creds(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_data_sources_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .data_sources_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_data_sources_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .data_sources_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_enroll_data_sources(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::EnrollDataSourcesRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .enroll_data_sources(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_data_sources_check_valid_creds(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_data_sources_check_valid_creds(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_data_sources_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_data_sources_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_data_sources_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_data_sources_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_enroll_data_sources(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_enroll_data_sources(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_transfer_configs_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "email-preferences.enable-failure-email" => Some((
                ...
                "schedule-options.disable-auto-scheduling" => Some((
                ...
                "schedule-options.end-time" => Some((
                ...
                "schedule-options.start-time" => Some((
        ...
        let mut request: api::TransferConfig = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_transfer_configs_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["authorization-code", "service-account-name", "version-info"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _projects_locations_transfer_configs_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_transfer_configs_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_transfer_configs_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_transfer_configs_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_transfer_configs_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_transfer_configs_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            .iter()
        {
            ...
            match key {
                ...
                "data-source-ids" => {
                    call = call.add_data_source_ids(value.unwrap_or(""));
                }
                _ => {
                    let mut found = false;
                    for param in &self.gp {
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["data-source-ids", "page-size", "page-token"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _projects_locations_transfer_configs_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_transfer_configs_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_transfer_configs_runs_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_transfer_configs_runs_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_transfer_configs_runs_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_transfer_configs_runs_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_transfer_configs_runs_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_transfer_configs_runs_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            .iter()
        {
            ...
            match key {
                ...
                "run-attempt" => {
                    call = call.run_attempt(value.unwrap_or(""));
                }
                "page-token" => {
                    call = call.page_token(value.unwrap_or(""));
                }
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["page-size", "page-token", "run-attempt", "states"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _projects_locations_transfer_configs_runs_transfer_logs_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_transfer_configs_runs_transfer_logs_list(
            ...
            .iter()
        {
            ...
            match key {
                ...
                "message-types" => {
                    call = call.add_message_types(value.unwrap_or(""));
                }
                _ => {
                    let mut found = false;
                    for param in &self.gp {
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["message-types", "page-size", "page-token"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _projects_locations_transfer_configs_schedule_runs(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion =
                        FieldCursor::did_you_mean(key, &vec!["end-time", "start-time"]);
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
                        value.map(|v| v.to_string()),
        ...
        let mut request: api::ScheduleTransferRunsRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_transfer_configs_schedule_runs(
                request,
                opt.value_of("parent").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_transfer_configs_start_manual_runs(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "requested-time-range.end-time" => Some((
                ...
                "requested-time-range.start-time" => Some((
        ...
        let mut request: api::StartManualTransferRunsRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_transfer_configs_start_manual_runs(
                request,
                opt.value_of("parent").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_unenroll_data_sources(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::UnenrollDataSourcesRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_unenroll_data_sources(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_transfer_configs_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .transfer_configs_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_transfer_configs_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .transfer_configs_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_transfer_configs_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .transfer_configs_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_transfer_configs_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .transfer_configs_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_transfer_configs_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .transfer_configs_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_transfer_configs_runs_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .transfer_configs_runs_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_transfer_configs_runs_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .transfer_configs_runs_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_transfer_configs_runs_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .transfer_configs_runs_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_transfer_configs_runs_transfer_logs_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .transfer_configs_runs_transfer_logs_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_transfer_configs_schedule_runs(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .transfer_configs_schedule_runs(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_transfer_configs_start_manual_runs(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .transfer_configs_start_manual_runs(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
        ...
        match self.opt.subcommand() {
            ("projects", Some(opt)) => match opt.subcommand() {
                ("data-sources-check-valid-creds", Some(opt)) => {
                    call_result = self
                        ._projects_data_sources_check_valid_creds(opt, dry_run, &mut err)
                        .await;
                }
                ("data-sources-get", Some(opt)) => {
                    call_result = self
                        ._projects_data_sources_get(opt, dry_run, &mut err)
                        .await;
                }
                ("data-sources-list", Some(opt)) => {
                    call_result = self
                        ._projects_data_sources_list(opt, dry_run, &mut err)
                        .await;
                }
                ("enroll-data-sources", Some(opt)) => {
                    call_result = self
                        ._projects_enroll_data_sources(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-data-sources-check-valid-creds", Some(opt)) => {
                    call_result = self
                        ._projects_locations_data_sources_check_valid_creds(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-data-sources-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_data_sources_get(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-data-sources-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_data_sources_list(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-enroll-data-sources", Some(opt)) => {
                    call_result = self
                        ._projects_locations_enroll_data_sources(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("locations-transfer-configs-create", Some(opt)) => {
                    call_result = self
                        ._projects_locations_transfer_configs_create(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-transfer-configs-delete", Some(opt)) => {
                    call_result = self
                        ._projects_locations_transfer_configs_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-transfer-configs-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_transfer_configs_get(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-transfer-configs-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_transfer_configs_list(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-transfer-configs-patch", Some(opt)) => {
                    call_result = self
                        ._projects_locations_transfer_configs_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-transfer-configs-runs-delete", Some(opt)) => {
                    call_result = self
                        ._projects_locations_transfer_configs_runs_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-transfer-configs-runs-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_transfer_configs_runs_get(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-transfer-configs-runs-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_transfer_configs_runs_list(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("locations-transfer-configs-schedule-runs", Some(opt)) => {
                    call_result = self
                        ._projects_locations_transfer_configs_schedule_runs(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-transfer-configs-start-manual-runs", Some(opt)) => {
                    call_result = self
                        ._projects_locations_transfer_configs_start_manual_runs(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-unenroll-data-sources", Some(opt)) => {
                    call_result = self
                        ._projects_locations_unenroll_data_sources(opt, dry_run, &mut err)
                        .await;
                }
                ("transfer-configs-create", Some(opt)) => {
                    call_result = self
                        ._projects_transfer_configs_create(opt, dry_run, &mut err)
                        .await;
                }
                ("transfer-configs-delete", Some(opt)) => {
                    call_result = self
                        ._projects_transfer_configs_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("transfer-configs-get", Some(opt)) => {
                    call_result = self
                        ._projects_transfer_configs_get(opt, dry_run, &mut err)
                        .await;
                }
                ("transfer-configs-list", Some(opt)) => {
                    call_result = self
                        ._projects_transfer_configs_list(opt, dry_run, &mut err)
                        .await;
                }
                ("transfer-configs-patch", Some(opt)) => {
                    call_result = self
                        ._projects_transfer_configs_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("transfer-configs-runs-delete", Some(opt)) => {
                    call_result = self
                        ._projects_transfer_configs_runs_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("transfer-configs-runs-get", Some(opt)) => {
                    call_result = self
                        ._projects_transfer_configs_runs_get(opt, dry_run, &mut err)
                        .await;
                }
                ("transfer-configs-runs-list", Some(opt)) => {
                    call_result = self
                        ._projects_transfer_configs_runs_list(opt, dry_run, &mut err)
                        .await;
                }
                ("transfer-configs-runs-transfer-logs-list", Some(opt)) => {
                    call_result = self
                        ._projects_transfer_configs_runs_transfer_logs_list(opt, dry_run, &mut err)
                        .await;
                }
                ("transfer-configs-schedule-runs", Some(opt)) => {
                    call_result = self
                        ._projects_transfer_configs_schedule_runs(opt, dry_run, &mut err)
                        .await;
                }
                ("transfer-configs-start-manual-runs", Some(opt)) => {
                    call_result = self
                        ._projects_transfer_configs_start_manual_runs(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "bigquerydatatransfer1-secret.json",
...
async fn main() {
    ...
    let arg_data = [
        ("projects", "methods: 'data-sources-check-valid-creds', 'data-sources-get', 'data-sources-list', 'enroll-data-sources', 'locations-data-sources-check-valid-creds', 'locations-data-sources-get', 'locations-data-sources-list', 'locations-enroll-data-sources', 'locations-get', 'locations-list', 'locations-transfer-configs-create', 'locations-transfer-configs-delete', 'locations-transfer-configs-get', 'locations-transfer-configs-list', 'locations-transfer-configs-patch', 'locations-transfer-configs-runs-delete', 'locations-transfer-configs-runs-get', 'locations-transfer-configs-runs-list', 'locations-transfer-configs-runs-transfer-logs-list', 'locations-transfer-configs-schedule-runs', 'locations-transfer-configs-start-manual-runs', 'locations-unenroll-data-sources', 'transfer-configs-create', 'transfer-configs-delete', 'transfer-configs-get', 'transfer-configs-list', 'transfer-configs-patch', 'transfer-configs-runs-delete', 'transfer-configs-runs-get', 'transfer-configs-runs-list', 'transfer-configs-runs-transfer-logs-list', 'transfer-configs-schedule-runs' and 'transfer-configs-start-manual-runs'", vec![
            ...
            ("enroll-data-sources",
                    Some(r##"Enroll data sources in a user project. This allows users to create transfer configurations for these data sources. They will also appear in the ListDataSources RPC and as such, will appear in the [BigQuery UI](https://console.cloud.google.com/bigquery), and the documents can be found in the public guide for [BigQuery Web UI](https://cloud.google.com/bigquery/bigquery-web-ui) and [Data Transfer Service](https://cloud.google.com/bigquery/docs/working-with-transfers)."##),
                    "Details at http://byron.github.io/google-apis-rs/google_bigquerydatatransfer1_cli/projects_enroll-data-sources",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The name of the project resource in the form: `projects/{project_id}`"##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("locations-enroll-data-sources",
                    Some(r##"Enroll data sources in a user project. This allows users to create transfer configurations for these data sources. They will also appear in the ListDataSources RPC and as such, will appear in the [BigQuery UI](https://console.cloud.google.com/bigquery), and the documents can be found in the public guide for [BigQuery Web UI](https://cloud.google.com/bigquery/bigquery-web-ui) and [Data Transfer Service](https://cloud.google.com/bigquery/docs/working-with-transfers)."##),
                    "Details at http://byron.github.io/google-apis-rs/google_bigquerydatatransfer1_cli/projects_locations-enroll-data-sources",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The name of the project resource in the form: `projects/{project_id}`"##),
            ...
            ("locations-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_bigquerydatatransfer1_cli/projects_locations-list",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-transfer-configs-create",
                    Some(r##"Creates a new data transfer configuration."##),
                    "Details at http://byron.github.io/google-apis-rs/google_bigquerydatatransfer1_cli/projects_locations-transfer-configs-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("locations-transfer-configs-get",
                    Some(r##"Returns information about a data transfer config."##),
                    "Details at http://byron.github.io/google-apis-rs/google_bigquerydatatransfer1_cli/projects_locations-transfer-configs-get",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The field will contain name of the resource requested, for example: `projects/{project_id}/transferConfigs/{config_id}` or `projects/{project_id}/locations/{location_id}/transferConfigs/{config_id}`"##),
            ...
            ("locations-transfer-configs-list",
                    Some(r##"Returns information about all transfer configs owned by a project in the specified location."##),
                    "Details at http://byron.github.io/google-apis-rs/google_bigquerydatatransfer1_cli/projects_locations-transfer-configs-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("locations-transfer-configs-patch",
                  ...
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Identifier. The resource name of the transfer config. Transfer config names have the form either `projects/{project_id}/locations/{region}/transferConfigs/{config_id}` or `projects/{project_id}/transferConfigs/{config_id}`, where `config_id` is usually a UUID, even though it is not guaranteed or required. The name is ignored when creating a transfer config."##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("locations-transfer-configs-runs-delete",
                    Some(r##"Deletes the specified transfer run."##),
                    "Details at http://byron.github.io/google-apis-rs/google_bigquerydatatransfer1_cli/projects_locations-transfer-configs-runs-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-transfer-configs-runs-get",
                    Some(r##"Returns information about the particular transfer run."##),
                    "Details at http://byron.github.io/google-apis-rs/google_bigquerydatatransfer1_cli/projects_locations-transfer-configs-runs-get",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The field will contain name of the resource requested, for example: `projects/{project_id}/transferConfigs/{config_id}/runs/{run_id}` or `projects/{project_id}/locations/{location_id}/transferConfigs/{config_id}/runs/{run_id}`"##),
            ...
            ("locations-transfer-configs-runs-list",
                    Some(r##"Returns information about running and completed transfer runs."##),
                    "Details at http://byron.github.io/google-apis-rs/google_bigquerydatatransfer1_cli/projects_locations-transfer-configs-runs-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("locations-transfer-configs-runs-transfer-logs-list",
                    Some(r##"Returns log messages for the transfer run."##),
                    "Details at http://byron.github.io/google-apis-rs/google_bigquerydatatransfer1_cli/projects_locations-transfer-configs-runs-transfer-logs-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("transfer-configs-get",
                    Some(r##"Returns information about a data transfer config."##),
                    "Details at http://byron.github.io/google-apis-rs/google_bigquerydatatransfer1_cli/projects_transfer-configs-get",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The field will contain name of the resource requested, for example: `projects/{project_id}/transferConfigs/{config_id}` or `projects/{project_id}/locations/{location_id}/transferConfigs/{config_id}`"##),
            ...
            ("transfer-configs-list",
                    Some(r##"Returns information about all transfer configs owned by a project in the specified location."##),
                    "Details at http://byron.github.io/google-apis-rs/google_bigquerydatatransfer1_cli/projects_transfer-configs-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The BigQuery project id for which transfer configs should be returned: `projects/{project_id}` or `projects/{project_id}/locations/{location_id}`"##),
            ...
            ("transfer-configs-runs-delete",
                    Some(r##"Deletes the specified transfer run."##),
                    "Details at http://byron.github.io/google-apis-rs/google_bigquerydatatransfer1_cli/projects_transfer-configs-runs-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The field will contain name of the resource requested, for example: `projects/{project_id}/transferConfigs/{config_id}/runs/{run_id}` or `projects/{project_id}/locations/{location_id}/transferConfigs/{config_id}/runs/{run_id}`"##),
            ...
            ("transfer-configs-runs-get",
                    Some(r##"Returns information about the particular transfer run."##),
                    "Details at http://byron.github.io/google-apis-rs/google_bigquerydatatransfer1_cli/projects_transfer-configs-runs-get",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The field will contain name of the resource requested, for example: `projects/{project_id}/transferConfigs/{config_id}/runs/{run_id}` or `projects/{project_id}/locations/{location_id}/transferConfigs/{config_id}/runs/{run_id}`"##),
            ...
            ("transfer-configs-runs-list",
                    Some(r##"Returns information about running and completed transfer runs."##),
                    "Details at http://byron.github.io/google-apis-rs/google_bigquerydatatransfer1_cli/projects_transfer-configs-runs-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. Name of transfer configuration for which transfer runs should be retrieved. Format of transfer configuration resource name is: `projects/{project_id}/transferConfigs/{config_id}` or `projects/{project_id}/locations/{location_id}/transferConfigs/{config_id}`."##),
            ...
            ("transfer-configs-runs-transfer-logs-list",
                    Some(r##"Returns log messages for the transfer run."##),
                    "Details at http://byron.github.io/google-apis-rs/google_bigquerydatatransfer1_cli/projects_transfer-configs-runs-transfer-logs-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. Transfer run name in the form: `projects/{project_id}/transferConfigs/{config_id}/runs/{run_id}` or `projects/{project_id}/locations/{location_id}/transferConfigs/{config_id}/runs/{run_id}`"##),
