...
//!
//! * customers
//!  * [*deployments create*](api::CustomerDeploymentCreateCall), [*deployments delete*](api::CustomerDeploymentDeleteCall), [*deployments devices create*](api::CustomerDeploymentDeviceCreateCall), [*deployments devices create signed*](api::CustomerDeploymentDeviceCreateSignedCall), [*deployments devices list*](api::CustomerDeploymentDeviceListCall), [*deployments get*](api::CustomerDeploymentGetCall), [*deployments list*](api::CustomerDeploymentListCall), [*deployments move*](api::CustomerDeploymentMoveCall), [*deployments patch*](api::CustomerDeploymentPatchCall), [*devices create*](api::CustomerDeviceCreateCall), [*devices create signed*](api::CustomerDeviceCreateSignedCall), [*devices delete*](api::CustomerDeviceDeleteCall), [*devices get*](api::CustomerDeviceGetCall), [*devices list*](api::CustomerDeviceListCall), [*devices move*](api::CustomerDeviceMoveCall), [*devices patch*](api::CustomerDevicePatchCall), [*devices sign device*](api::CustomerDeviceSignDeviceCall), [*devices update signed*](api::CustomerDeviceUpdateSignedCall), [*get*](api::CustomerGetCall), [*list*](api::CustomerListCall), [*list gcp project deployments*](api::CustomerListGcpProjectDeploymentCall), [*list legacy organizations*](api::CustomerListLegacyOrganizationCall), [*migrate organization*](api::CustomerMigrateOrganizationCall), [*nodes create*](api::CustomerNodeCreateCall), [*nodes delete*](api::CustomerNodeDeleteCall), [*nodes deployments create*](api::CustomerNodeDeploymentCreateCall), [*nodes deployments list*](api::CustomerNodeDeploymentListCall), [*nodes devices create*](api::CustomerNodeDeviceCreateCall), [*nodes devices create signed*](api::CustomerNodeDeviceCreateSignedCall), [*nodes devices list*](api::CustomerNodeDeviceListCall), [*nodes get*](api::CustomerNodeGetCall), [*nodes list*](api::CustomerNodeListCall), [*nodes move*](api::CustomerNodeMoveCall), [*nodes nodes create*](api::CustomerNodeNodeCreateCall), [*nodes nodes list*](api::CustomerNodeNodeListCall), [*nodes patch*](api::CustomerNodePatchCall), [*patch*](api::CustomerPatchCall), [*provision deployment*](api::CustomerProvisionDeploymentCall) and [*setup sas analytics*](api::CustomerSetupSasAnalyticCall)
//! * deployments
//!  * [*devices delete*](api::DeploymentDeviceDeleteCall), [*devices get*](api::DeploymentDeviceGetCall), [*devices move*](api::DeploymentDeviceMoveCall), [*devices patch*](api::DeploymentDevicePatchCall), [*devices sign device*](api::DeploymentDeviceSignDeviceCall), [*devices update signed*](api::DeploymentDeviceUpdateSignedCall) and [*get*](api::DeploymentGetCall)
//! * installer
//!  * [*generate secret*](api::InstallerGenerateSecretCall) and [*validate*](api::InstallerValidateCall)
//! * nodes
//!  * [*deployments delete*](api::NodeDeploymentDeleteCall), [*deployments devices create*](api::NodeDeploymentDeviceCreateCall), [*deployments devices create signed*](api::NodeDeploymentDeviceCreateSignedCall), [*deployments devices list*](api::NodeDeploymentDeviceListCall), [*deployments get*](api::NodeDeploymentGetCall), [*deployments list*](api::NodeDeploymentListCall), [*deployments move*](api::NodeDeploymentMoveCall), [*deployments patch*](api::NodeDeploymentPatchCall), [*devices create*](api::NodeDeviceCreateCall), [*devices create signed*](api::NodeDeviceCreateSignedCall), [*devices delete*](api::NodeDeviceDeleteCall), [*devices get*](api::NodeDeviceGetCall), [*devices list*](api::NodeDeviceListCall), [*devices move*](api::NodeDeviceMoveCall), [*devices patch*](api::NodeDevicePatchCall), [*devices sign device*](api::NodeDeviceSignDeviceCall), [*devices update signed*](api::NodeDeviceUpdateSignedCall), [*get*](api::NodeGetCall), [*nodes create*](api::NodeNodeCreateCall), [*nodes delete*](api::NodeNodeDeleteCall), [*nodes deployments create*](api::NodeNodeDeploymentCreateCall), [*nodes deployments list*](api::NodeNodeDeploymentListCall), [*nodes devices create*](api::NodeNodeDeviceCreateCall), [*nodes devices create signed*](api::NodeNodeDeviceCreateSignedCall), [*nodes devices list*](api::NodeNodeDeviceListCall), [*nodes get*](api::NodeNodeGetCall), [*nodes list*](api::NodeNodeListCall), [*nodes move*](api::NodeNodeMoveCall), [*nodes nodes create*](api::NodeNodeNodeCreateCall), [*nodes nodes list*](api::NodeNodeNodeListCall) and [*nodes patch*](api::NodeNodePatchCall)
//! * policies
//!  * [*get*](api::PolicyGetCall), [*set*](api::PolicySetCall) and [*test*](api::PolicyTestCall)
//!
//!
//!
//!
