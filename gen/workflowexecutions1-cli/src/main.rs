...
use google_workflowexecutions1::{api, yup_oauth2, Error};
...
{
    async fn _projects_locations_workflows_executions_callbacks_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_workflows_executions_callbacks_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_workflows_executions_cancel(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_workflows_executions_cancel(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_workflows_executions_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "disable-concurrency-quota-overflow-buffering" => Some((
    ...
    async fn _projects_locations_workflows_executions_export_data(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_workflows_executions_export_data(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_workflows_executions_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_workflows_executions_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_workflows_executions_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_workflows_executions_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_workflows_executions_step_entries_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_workflows_executions_step_entries_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_workflows_executions_step_entries_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_workflows_executions_step_entries_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            .iter()
        {
            ...
            match key {
                "skip" => {
                    call = call.skip(
                        value
                            .map(|v| arg_from_str(v, err, "skip", "int32"))
                            .unwrap_or(-0),
                    );
                }
                "page-token" => {
    ...
    async fn _projects_locations_workflows_trigger_pubsub_execution(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::TriggerPubsubExecutionRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_workflows_trigger_pubsub_execution(
                request,
                opt.value_of("workflow").unwrap_or(""),
            );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
        ...
        match self.opt.subcommand() {
            ("projects", Some(opt)) => match opt.subcommand() {
                ("locations-workflows-executions-callbacks-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_workflows_executions_callbacks_list(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-workflows-executions-cancel", Some(opt)) => {
                    call_result = self
                        ._projects_locations_workflows_executions_cancel(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("locations-workflows-executions-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_workflows_executions_get(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-workflows-executions-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_workflows_executions_list(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-workflows-executions-step-entries-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_workflows_executions_step_entries_get(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-workflows-executions-step-entries-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_workflows_executions_step_entries_list(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-workflows-trigger-pubsub-execution", Some(opt)) => {
                    call_result = self
                        ._projects_locations_workflows_trigger_pubsub_execution(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "workflowexecutions1-secret.json",
        ...
        let engine = Engine {
            opt,
            hub: api::WorkflowExecutions::new(client, auth),
            gp: vec![
                "$-xgafv",
                "access-token",
                "alt",
        ...
        ("projects", "methods: 'locations-workflows-executions-callbacks-list', 'locations-workflows-executions-cancel', 'locations-workflows-executions-create', 'locations-workflows-executions-export-data', 'locations-workflows-executions-get', 'locations-workflows-executions-list', 'locations-workflows-executions-step-entries-get', 'locations-workflows-executions-step-entries-list' and 'locations-workflows-trigger-pubsub-execution'", vec![
            ...
            ("locations-workflows-executions-cancel",
                  ...
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. Name of the execution to be cancelled. Format: projects/{project}/locations/{location}/workflows/{workflow}/executions/{execution}"##),
                     Some(true),
                     Some(false)),
                    (Some(r##"kv"##),
                     Some(r##"r"##),
            ...
            ("locations-workflows-executions-get",
                    Some(r##"Returns an execution of the given name."##),
                    "Details at http://byron.github.io/google-apis-rs/google_workflowexecutions1_cli/projects_locations-workflows-executions-get",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. Name of the execution to be retrieved. Format: projects/{project}/locations/{location}/workflows/{workflow}/executions/{execution}"##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
            ...
            ("locations-workflows-executions-list",
                    Some(r##"Returns a list of executions which belong to the workflow with the given name. The method returns executions of all workflow revisions. Returned executions are ordered by their start time (newest first)."##),
                    "Details at http://byron.github.io/google-apis-rs/google_workflowexecutions1_cli/projects_locations-workflows-executions-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. Name of the workflow for which the executions should be listed. Format: projects/{project}/locations/{location}/workflows/{workflow}"##),
                     Some(true),
                     Some(false)),
                    (Some(r##"v"##),
                     Some(r##"p"##),
