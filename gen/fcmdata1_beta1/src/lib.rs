...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/fcmdata1_beta1).
//! # Features
//!
//! Handle the following *Resources* with ease from the central [hub](Fcmdata) ...
//!
//! * projects
//!  * [*android apps delivery data list*](api::ProjectAndroidAppDeliveryDataListCall)
//!
//!
//!
//!
