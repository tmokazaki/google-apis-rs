...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/sourcerepo1).
//! # Features
//!
//! Handle the following *Resources* with ease from the central [hub](CloudSourceRepositories) ...
//!
//! * projects
//!  * [*get config*](api::ProjectGetConfigCall), [*repos create*](api::ProjectRepoCreateCall), [*repos delete*](api::ProjectRepoDeleteCall), [*repos get*](api::ProjectRepoGetCall), [*repos get iam policy*](api::ProjectRepoGetIamPolicyCall), [*repos list*](api::ProjectRepoListCall), [*repos patch*](api::ProjectRepoPatchCall), [*repos set iam policy*](api::ProjectRepoSetIamPolicyCall), [*repos sync*](api::ProjectRepoSyncCall), [*repos test iam permissions*](api::ProjectRepoTestIamPermissionCall) and [*update config*](api::ProjectUpdateConfigCall)
//!
//!
//!
//!
...
pub mod api;
pub use api::CloudSourceRepositories;
