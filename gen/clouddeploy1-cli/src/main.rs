...
use google_clouddeploy1::{api, yup_oauth2, Error};
...
{
    async fn _projects_locations_custom_target_types_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "custom-actions.deploy-action" => Some((
                    "customActions.deployAction",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "custom-actions.render-action" => Some((
                    "customActions.renderAction",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "custom-target-type-id" => Some((
                    "customTargetTypeId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
        ...
        let mut request: api::CustomTargetType = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_custom_target_types_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(
                                    ["custom-target-type-id", "request-id", "validate-only"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _projects_locations_custom_target_types_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_custom_target_types_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["allow-missing", "etag", "request-id", "validate-only"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _projects_locations_custom_target_types_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_custom_target_types_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_custom_target_types_get_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_custom_target_types_get_iam_policy(opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_custom_target_types_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_custom_target_types_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_custom_target_types_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_custom_target_types_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_custom_target_types_set_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_custom_target_types_set_iam_policy(
                request,
    ...
    async fn _projects_locations_delivery_pipelines_automation_runs_cancel(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::CancelAutomationRunRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_delivery_pipelines_automation_runs_cancel(
                request,
    ...
    async fn _projects_locations_delivery_pipelines_automation_runs_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_delivery_pipelines_automation_runs_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_delivery_pipelines_automation_runs_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_delivery_pipelines_automation_runs_list(
    ...
    async fn _projects_locations_delivery_pipelines_automations_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::Automation = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_delivery_pipelines_automations_create(
                request,
                opt.value_of("parent").unwrap_or(""),
            );
        for parg in opt
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["automation-id", "request-id", "validate-only"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _projects_locations_delivery_pipelines_automations_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_delivery_pipelines_automations_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_delivery_pipelines_automations_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_delivery_pipelines_automations_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_delivery_pipelines_automations_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_delivery_pipelines_automations_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_delivery_pipelines_automations_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_delivery_pipelines_automations_patch(
                request,
                opt.value_of("name").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_delivery_pipelines_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "condition.pipeline-ready-condition.status" => Some((
                    "condition.pipelineReadyCondition.status",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "condition.pipeline-ready-condition.update-time" => Some((
                    "condition.pipelineReadyCondition.updateTime",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "condition.targets-present-condition.missing-targets" => Some((
                ...
                "condition.targets-present-condition.status" => Some((
                    "condition.targetsPresentCondition.status",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
                )),
                "condition.targets-present-condition.update-time" => Some((
                    "condition.targetsPresentCondition.updateTime",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "condition.targets-type-condition.error-details" => Some((
                    "condition.targetsTypeCondition.errorDetails",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "condition.targets-type-condition.status" => Some((
                    "condition.targetsTypeCondition.status",
                    JsonTypeInfo {
                        jtype: JsonType::Boolean,
                        ctype: ComplexType::Pod,
                    },
        ...
        let mut request: api::DeliveryPipeline = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_delivery_pipelines_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["delivery-pipeline-id", "request-id", "validate-only"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _projects_locations_delivery_pipelines_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_delivery_pipelines_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_delivery_pipelines_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_delivery_pipelines_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_delivery_pipelines_get_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_delivery_pipelines_get_iam_policy(opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_delivery_pipelines_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_delivery_pipelines_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_delivery_pipelines_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_delivery_pipelines_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_delivery_pipelines_releases_abandon(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::AbandonReleaseRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
    ...
    async fn _projects_locations_delivery_pipelines_releases_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["release-id", "request-id", "validate-only"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _projects_locations_delivery_pipelines_releases_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_delivery_pipelines_releases_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_delivery_pipelines_releases_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_delivery_pipelines_releases_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_delivery_pipelines_releases_rollouts_advance(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::AdvanceRolloutRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
    ...
    async fn _projects_locations_delivery_pipelines_releases_rollouts_approve(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::ApproveRolloutRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
    ...
    async fn _projects_locations_delivery_pipelines_releases_rollouts_cancel(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::CancelRolloutRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_delivery_pipelines_releases_rollouts_cancel(
                request,
                opt.value_of("name").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_delivery_pipelines_releases_rollouts_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "metadata.automation.advance-automation-runs" => Some((
                    "metadata.automation.advanceAutomationRuns",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "metadata.automation.promote-automation-run" => Some((
                    "metadata.automation.promoteAutomationRun",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "metadata.automation.repair-automation-runs" => Some((
                    "metadata.automation.repairAutomationRuns",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "metadata.cloud-run.job" => Some((
                    "metadata.cloudRun.job",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "metadata.cloud-run.revision" => Some((
                ...
                "metadata.cloud-run.service" => Some((
                    "metadata.cloudRun.service",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "metadata.cloud-run.service-urls" => Some((
                    "metadata.cloudRun.serviceUrls",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "metadata.custom.values" => Some((
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(
                        ...
                        &vec![
                            ...
                            "metadata",
                            "name",
                            "promote-automation-run",
                            "repair-automation-runs",
                            "revision",
                            "rollback-of-rollout",
                            "rolled-back-by-rollouts",
                            "service",
                            "service-urls",
                            "state",
                            "target-id",
        ...
        let mut request: api::Rollout = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
    ...
    async fn _projects_locations_delivery_pipelines_releases_rollouts_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_delivery_pipelines_releases_rollouts_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_delivery_pipelines_releases_rollouts_ignore_job(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::IgnoreJobRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_delivery_pipelines_releases_rollouts_ignore_job(
                request,
                opt.value_of("rollout").unwrap_or(""),
            );
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
    ...
    async fn _projects_locations_delivery_pipelines_releases_rollouts_job_runs_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
    ...
    async fn _projects_locations_delivery_pipelines_releases_rollouts_job_runs_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_delivery_pipelines_releases_rollouts_job_runs_list(
                opt.value_of("parent").unwrap_or(""),
            );
        for parg in opt
            .values_of("v")
    ...
    async fn _projects_locations_delivery_pipelines_releases_rollouts_job_runs_terminate(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::TerminateJobRunRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_delivery_pipelines_releases_rollouts_job_runs_terminate(
                request,
                opt.value_of("name").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_delivery_pipelines_releases_rollouts_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_delivery_pipelines_releases_rollouts_list(
                opt.value_of("parent").unwrap_or(""),
            );
        for parg in opt
            .values_of("v")
    ...
    async fn _projects_locations_delivery_pipelines_releases_rollouts_retry_job(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::RetryJobRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_delivery_pipelines_releases_rollouts_retry_job(
                request,
                opt.value_of("rollout").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_delivery_pipelines_rollback_target(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "rollback-config.rollout.annotations" => Some((
                    "rollbackConfig.rollout.annotations",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Map,
                    },
                )),
                "rollback-config.rollout.approval-state" => Some((
                    "rollbackConfig.rollout.approvalState",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "rollback-config.rollout.approve-time" => Some((
                    "rollbackConfig.rollout.approveTime",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "rollback-config.rollout.controller-rollout" => Some((
                    "rollbackConfig.rollout.controllerRollout",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "rollback-config.rollout.create-time" => Some((
                    "rollbackConfig.rollout.createTime",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "rollback-config.rollout.deploy-end-time" => Some((
                    "rollbackConfig.rollout.deployEndTime",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "rollback-config.rollout.deploy-failure-cause" => Some((
                    "rollbackConfig.rollout.deployFailureCause",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "rollback-config.rollout.deploy-start-time" => Some((
                    "rollbackConfig.rollout.deployStartTime",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "rollback-config.rollout.deploying-build" => Some((
                    "rollbackConfig.rollout.deployingBuild",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "rollback-config.rollout.description" => Some((
                    "rollbackConfig.rollout.description",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "rollback-config.rollout.enqueue-time" => Some((
                    "rollbackConfig.rollout.enqueueTime",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "rollback-config.rollout.etag" => Some((
                    "rollbackConfig.rollout.etag",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "rollback-config.rollout.failure-reason" => Some((
                    "rollbackConfig.rollout.failureReason",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "rollback-config.rollout.labels" => Some((
                    "rollbackConfig.rollout.labels",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Map,
                    },
                )),
                "rollback-config.rollout.metadata.automation.advance-automation-runs" => Some((
                    "rollbackConfig.rollout.metadata.automation.advanceAutomationRuns",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "rollback-config.rollout.metadata.automation.promote-automation-run" => Some((
                    "rollbackConfig.rollout.metadata.automation.promoteAutomationRun",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "rollback-config.rollout.metadata.automation.repair-automation-runs" => Some((
                    "rollbackConfig.rollout.metadata.automation.repairAutomationRuns",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "rollback-config.rollout.metadata.cloud-run.job" => Some((
                    "rollbackConfig.rollout.metadata.cloudRun.job",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "rollback-config.rollout.metadata.cloud-run.revision" => Some((
                    "rollbackConfig.rollout.metadata.cloudRun.revision",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "rollback-config.rollout.metadata.cloud-run.service" => Some((
                    "rollbackConfig.rollout.metadata.cloudRun.service",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "rollback-config.rollout.metadata.cloud-run.service-urls" => Some((
                    "rollbackConfig.rollout.metadata.cloudRun.serviceUrls",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "rollback-config.rollout.metadata.custom.values" => Some((
                    "rollbackConfig.rollout.metadata.custom.values",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Map,
                    },
                )),
                "rollback-config.rollout.name" => Some((
                    "rollbackConfig.rollout.name",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "rollback-config.rollout.rollback-of-rollout" => Some((
                    "rollbackConfig.rollout.rollbackOfRollout",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "rollback-config.rollout.rolled-back-by-rollouts" => Some((
                    "rollbackConfig.rollout.rolledBackByRollouts",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Vec,
                    },
                )),
                "rollback-config.rollout.state" => Some((
                    "rollbackConfig.rollout.state",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "rollback-config.rollout.target-id" => Some((
                    "rollbackConfig.rollout.targetId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "rollback-config.rollout.uid" => Some((
                    "rollbackConfig.rollout.uid",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
                )),
                "rollback-config.starting-phase-id" => Some((
                    "rollbackConfig.startingPhaseId",
                    JsonTypeInfo {
                        jtype: JsonType::String,
                        ctype: ComplexType::Pod,
                    },
        ...
        let mut request: api::RollbackTargetRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_delivery_pipelines_rollback_target(
                request,
                opt.value_of("name").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_delivery_pipelines_set_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_delivery_pipelines_set_iam_policy(
                request,
                opt.value_of("resource").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_delivery_pipelines_test_iam_permissions(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_delivery_pipelines_test_iam_permissions(
                request,
                opt.value_of("resource").unwrap_or(""),
            );
        for parg in opt
    ...
    async fn _projects_locations_get_config(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_get_config(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_targets_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "anthos-cluster.membership" => Some((
                ...
                "custom-target.custom-target-type" => Some((
        ...
        let mut request: api::Target = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_targets_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
                    ...
                    if !found {
                        err.issues
                            .push(CLIError::UnknownParameter(key.to_string(), {
                                ...
                                v.extend(self.gp.iter().map(|v| *v));
                                v.extend(
                                    ["request-id", "target-id", "validate-only"]
                                        .iter()
                                        .map(|v| *v),
                                );
                                v
    ...
    async fn _projects_locations_targets_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_targets_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_targets_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_targets_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_targets_get_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_targets_get_iam_policy(opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_targets_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_targets_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_targets_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_targets_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_targets_set_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_targets_set_iam_policy(request, opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_targets_test_iam_permissions(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::TestIamPermissionsRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self.hub.projects().locations_targets_test_iam_permissions(
            request,
            opt.value_of("resource").unwrap_or(""),
        );
        for parg in opt
        ...
        match self.opt.subcommand() {
            ("projects", Some(opt)) => match opt.subcommand() {
                ("locations-custom-target-types-create", Some(opt)) => {
                    call_result = self
                        ._projects_locations_custom_target_types_create(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-custom-target-types-delete", Some(opt)) => {
                    call_result = self
                        ._projects_locations_custom_target_types_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-custom-target-types-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_custom_target_types_get(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-custom-target-types-get-iam-policy", Some(opt)) => {
                    call_result = self
                        ._projects_locations_custom_target_types_get_iam_policy(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-custom-target-types-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_custom_target_types_list(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-custom-target-types-patch", Some(opt)) => {
                    call_result = self
                        ._projects_locations_custom_target_types_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-custom-target-types-set-iam-policy", Some(opt)) => {
                    call_result = self
                        ._projects_locations_custom_target_types_set_iam_policy(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-delivery-pipelines-automation-runs-cancel", Some(opt)) => {
                    call_result = self
                        ._projects_locations_delivery_pipelines_automation_runs_cancel(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-delivery-pipelines-automation-runs-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_delivery_pipelines_automation_runs_get(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-delivery-pipelines-automation-runs-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_delivery_pipelines_automation_runs_list(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-delivery-pipelines-automations-create", Some(opt)) => {
                    call_result = self
                        ._projects_locations_delivery_pipelines_automations_create(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-delivery-pipelines-automations-delete", Some(opt)) => {
                    call_result = self
                        ._projects_locations_delivery_pipelines_automations_delete(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-delivery-pipelines-automations-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_delivery_pipelines_automations_get(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-delivery-pipelines-automations-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_delivery_pipelines_automations_list(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-delivery-pipelines-automations-patch", Some(opt)) => {
                    call_result = self
                        ._projects_locations_delivery_pipelines_automations_patch(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-delivery-pipelines-create", Some(opt)) => {
                    call_result = self
                        ._projects_locations_delivery_pipelines_create(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-delivery-pipelines-delete", Some(opt)) => {
                    call_result = self
                        ._projects_locations_delivery_pipelines_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-delivery-pipelines-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_delivery_pipelines_get(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-delivery-pipelines-get-iam-policy", Some(opt)) => {
                    call_result = self
                        ._projects_locations_delivery_pipelines_get_iam_policy(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-delivery-pipelines-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_delivery_pipelines_list(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-delivery-pipelines-patch", Some(opt)) => {
                    call_result = self
                        ._projects_locations_delivery_pipelines_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-delivery-pipelines-releases-abandon", Some(opt)) => {
                    call_result = self
                        ._projects_locations_delivery_pipelines_releases_abandon(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-delivery-pipelines-releases-create", Some(opt)) => {
                    call_result = self
                        ._projects_locations_delivery_pipelines_releases_create(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-delivery-pipelines-releases-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_delivery_pipelines_releases_get(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-delivery-pipelines-releases-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_delivery_pipelines_releases_list(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-delivery-pipelines-releases-rollouts-advance", Some(opt)) => {
                    call_result = self
                        ._projects_locations_delivery_pipelines_releases_rollouts_advance(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-delivery-pipelines-releases-rollouts-approve", Some(opt)) => {
                    call_result = self
                        ._projects_locations_delivery_pipelines_releases_rollouts_approve(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-delivery-pipelines-releases-rollouts-cancel", Some(opt)) => {
                    call_result = self
                        ._projects_locations_delivery_pipelines_releases_rollouts_cancel(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-delivery-pipelines-releases-rollouts-create", Some(opt)) => {
                    call_result = self
                        ._projects_locations_delivery_pipelines_releases_rollouts_create(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-delivery-pipelines-releases-rollouts-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_delivery_pipelines_releases_rollouts_get(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-delivery-pipelines-releases-rollouts-ignore-job", Some(opt)) => {
                    call_result = self
                        ._projects_locations_delivery_pipelines_releases_rollouts_ignore_job(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-delivery-pipelines-releases-rollouts-job-runs-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_delivery_pipelines_releases_rollouts_job_runs_get(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-delivery-pipelines-releases-rollouts-job-runs-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_delivery_pipelines_releases_rollouts_job_runs_list(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ...
                ("locations-delivery-pipelines-releases-rollouts-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_delivery_pipelines_releases_rollouts_list(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-delivery-pipelines-releases-rollouts-retry-job", Some(opt)) => {
                    call_result = self
                        ._projects_locations_delivery_pipelines_releases_rollouts_retry_job(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-delivery-pipelines-rollback-target", Some(opt)) => {
                    call_result = self
                        ._projects_locations_delivery_pipelines_rollback_target(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-delivery-pipelines-set-iam-policy", Some(opt)) => {
                    call_result = self
                        ._projects_locations_delivery_pipelines_set_iam_policy(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ("locations-delivery-pipelines-test-iam-permissions", Some(opt)) => {
                    call_result = self
                        ._projects_locations_delivery_pipelines_test_iam_permissions(
                            opt, dry_run, &mut err,
                        )
                        .await;
                }
                ...
                ("locations-get-config", Some(opt)) => {
                    call_result = self
                        ._projects_locations_get_config(opt, dry_run, &mut err)
                        .await;
                }
                ...
                ("locations-targets-create", Some(opt)) => {
                    call_result = self
                        ._projects_locations_targets_create(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-targets-delete", Some(opt)) => {
                    call_result = self
                        ._projects_locations_targets_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-targets-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_targets_get(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-targets-get-iam-policy", Some(opt)) => {
                    call_result = self
                        ._projects_locations_targets_get_iam_policy(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-targets-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_targets_list(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-targets-patch", Some(opt)) => {
                    call_result = self
                        ._projects_locations_targets_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-targets-set-iam-policy", Some(opt)) => {
                    call_result = self
                        ._projects_locations_targets_set_iam_policy(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-targets-test-iam-permissions", Some(opt)) => {
                    call_result = self
                        ._projects_locations_targets_test_iam_permissions(opt, dry_run, &mut err)
                        .await;
                }
                _ => {
                    err.issues
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "clouddeploy1-secret.json",
        ...
        .persist_tokens_to_disk(format!("{}/clouddeploy1", config_dir))
        .build()
        .await
        .unwrap();
