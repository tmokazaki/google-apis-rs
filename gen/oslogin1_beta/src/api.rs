...
impl<C> common::Hub for CloudOSLogin<C> {}
...
impl common::ResponseResult for ImportSshPublicKeyResponse {}
...
impl common::ResponseResult for LoginProfile {}
...
impl common::Part for PosixAccount {}
...
impl common::Part for SecurityKey {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [projects locations sign ssh public key users](UserProjectLocationSignSshPublicKeyCall) (request)
/// * [projects zones sign ssh public key users](UserProjectZoneSignSshPublicKeyCall) (request)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
...
impl common::RequestValue for SignSshPublicKeyRequest {}
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
///
/// * [projects locations sign ssh public key users](UserProjectLocationSignSshPublicKeyCall) (response)
/// * [projects zones sign ssh public key users](UserProjectZoneSignSshPublicKeyCall) (response)
#[cfg_attr(feature = "utoipa", derive(utoipa::ToSchema))]
#[serde_with::serde_as]
#[derive(Default, Clone, Debug, serde::Serialize, serde::Deserialize)]
pub struct SignSshPublicKeyResponse {
    /// The signed SSH public key to use in the SSH handshake.
    #[serde(rename = "signedSshPublicKey")]
    pub signed_ssh_public_key: Option<String>,
}

impl common::ResponseResult for SignSshPublicKeyResponse {}
...
impl common::RequestValue for SshPublicKey {}
impl common::ResponseResult for SshPublicKey {}
...
impl common::Part for UniversalTwoFactor {}
...
/// // like `get_login_profile(...)`, `import_ssh_public_key(...)`, `projects_delete(...)`, `projects_locations_sign_ssh_public_key(...)`, `projects_zones_sign_ssh_public_key(...)`, `ssh_public_keys_create(...)`, `ssh_public_keys_delete(...)`, `ssh_public_keys_get(...)` and `ssh_public_keys_patch(...)`
...
impl<'a, C> UserMethods<'a, C> {
    ...
    pub fn projects_locations_sign_ssh_public_key(
        &self,
        request: SignSshPublicKeyRequest,
        parent: &str,
    ) -> UserProjectLocationSignSshPublicKeyCall<'a, C> {
        UserProjectLocationSignSshPublicKeyCall {
            hub: self.hub,
            _request: request,
    ...
    /// * `request` - No description provided.
    /// * `parent` - The parent project and region for the signing request.
    pub fn projects_zones_sign_ssh_public_key(
        &self,
        request: SignSshPublicKeyRequest,
        parent: &str,
    ) -> UserProjectZoneSignSshPublicKeyCall<'a, C> {
        UserProjectZoneSignSshPublicKeyCall {
            hub: self.hub,
            _request: request,
            _parent: parent.to_string(),
            _delegate: Default::default(),
...
/// Signs an SSH public key for a user to authenticate to an instance.
///
/// A builder for the *projects.locations.signSshPublicKey* method supported by a *user* resource.
...
/// # extern crate hyper_rustls;
/// # extern crate google_oslogin1_beta as oslogin1_beta;
/// use oslogin1_beta::api::SignSshPublicKeyRequest;
/// # async fn dox() {
/// # use oslogin1_beta::{CloudOSLogin, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
/// # let secret: yup_oauth2::ApplicationSecret = Default::default();
...
/// // into the respective structure. Some of the parts shown here might not be applicable !
/// // Values shown here are possibly random and not representative !
/// let mut req = SignSshPublicKeyRequest::default();
///
/// // You can configure optional parameters by calling the respective setters at will, and
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.users().projects_locations_sign_ssh_public_key(req, "parent")
///              .doit().await;
/// # }
/// ```
pub struct UserProjectLocationSignSshPublicKeyCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudOSLogin<C>,
    _request: SignSshPublicKeyRequest,
    _parent: String,
...
impl<'a, C> common::CallBuilder for UserProjectLocationSignSshPublicKeyCall<'a, C> {}

impl<'a, C> UserProjectLocationSignSshPublicKeyCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, SignSshPublicKeyResponse)> {
        use std::borrow::Cow;
        ...
        let mut url = self.hub._base_url.clone() + "v1beta/{+parent}:signSshPublicKey";
    ...
    pub fn request(
        mut self,
        new_value: SignSshPublicKeyRequest,
    ) -> UserProjectLocationSignSshPublicKeyCall<'a, C> {
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> UserProjectLocationSignSshPublicKeyCall<'a, C> {
    ...
    pub fn param<T>(mut self, name: T, value: T) -> UserProjectLocationSignSshPublicKeyCall<'a, C>
    where
        T: AsRef<str>,
    {
    ...
    pub fn add_scope<St>(mut self, scope: St) -> UserProjectLocationSignSshPublicKeyCall<'a, C>
    where
        St: AsRef<str>,
    {
    ...
    pub fn add_scopes<I, St>(mut self, scopes: I) -> UserProjectLocationSignSshPublicKeyCall<'a, C>
    where
    ...
    /// for details).
    pub fn clear_scopes(mut self) -> UserProjectLocationSignSshPublicKeyCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Signs an SSH public key for a user to authenticate to an instance.
///
/// A builder for the *projects.zones.signSshPublicKey* method supported by a *user* resource.
/// It is not used directly, but through a [`UserMethods`] instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.users().projects_zones_sign_ssh_public_key(req, "parent")
///              .doit().await;
/// # }
/// ```
pub struct UserProjectZoneSignSshPublicKeyCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudOSLogin<C>,
...
impl<'a, C> common::CallBuilder for UserProjectZoneSignSshPublicKeyCall<'a, C> {}

impl<'a, C> UserProjectZoneSignSshPublicKeyCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> UserProjectZoneSignSshPublicKeyCall<'a, C> {
        self._parent = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> UserProjectZoneSignSshPublicKeyCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> UserProjectZoneSignSshPublicKeyCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> UserProjectZoneSignSshPublicKeyCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> UserProjectZoneSignSshPublicKeyCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for UserProjectDeleteCall<'a, C> {}

impl<'a, C> UserProjectDeleteCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> UserProjectDeleteCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> UserProjectDeleteCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> UserProjectDeleteCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// Create an SSH public key
///
/// A builder for the *sshPublicKeys.create* method supported by a *user* resource.
/// It is not used directly, but through a [`UserMethods`] instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.users().ssh_public_keys_create(req, "parent")
///              .doit().await;
/// # }
/// ```
pub struct UserSshPublicKeyCreateCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudOSLogin<C>,
...
impl<'a, C> common::CallBuilder for UserSshPublicKeyCreateCall<'a, C> {}

impl<'a, C> UserSshPublicKeyCreateCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, SshPublicKey)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
        ...
        params.push("alt", "json");
        let mut url = self.hub._base_url.clone() + "v1beta/{+parent}/sshPublicKeys";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string());
        }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: SshPublicKey) -> UserSshPublicKeyCreateCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn parent(mut self, new_value: &str) -> UserSshPublicKeyCreateCall<'a, C> {
        self._parent = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> UserSshPublicKeyCreateCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> UserSshPublicKeyCreateCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> UserSshPublicKeyCreateCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> UserSshPublicKeyCreateCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for UserSshPublicKeyDeleteCall<'a, C> {}

impl<'a, C> UserSshPublicKeyDeleteCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> UserSshPublicKeyDeleteCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> UserSshPublicKeyDeleteCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> UserSshPublicKeyDeleteCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for UserSshPublicKeyGetCall<'a, C> {}

impl<'a, C> UserSshPublicKeyGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> UserSshPublicKeyGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> UserSshPublicKeyGetCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> UserSshPublicKeyGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for UserSshPublicKeyPatchCall<'a, C> {}

impl<'a, C> UserSshPublicKeyPatchCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    pub fn update_mask(mut self, new_value: common::FieldMask) -> UserSshPublicKeyPatchCall<'a, C> {
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> UserSshPublicKeyPatchCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> UserSshPublicKeyPatchCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> UserSshPublicKeyPatchCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for UserGetLoginProfileCall<'a, C> {}

impl<'a, C> UserGetLoginProfileCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, LoginProfile)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
        ...
        for &field in ["alt", "name", "view", "systemId", "projectId"].iter() {
            if self._additional_params.contains_key(field) {
                dlg.finished(false);
                return Err(common::Error::FieldClash(field));
            }
        ...
        if let Some(value) = self._system_id.as_ref() {
            params.push("systemId", value);
        }
    ...
    pub fn view(mut self, new_value: &str) -> UserGetLoginProfileCall<'a, C> {
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> UserGetLoginProfileCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> UserGetLoginProfileCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> UserGetLoginProfileCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for UserImportSshPublicKeyCall<'a, C> {}

impl<'a, C> UserImportSshPublicKeyCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, ImportSshPublicKeyResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
        ...
        for &field in ["alt", "parent", "view", "regions", "projectId"].iter() {
            if self._additional_params.contains_key(field) {
                dlg.finished(false);
                return Err(common::Error::FieldClash(field));
            }
    ...
    ///
    /// Sets the *view* query property to the given value.
    pub fn view(mut self, new_value: &str) -> UserImportSshPublicKeyCall<'a, C> {
        self._view = Some(new_value.to_string());
        self
    }
    ...
    pub fn add_regions(mut self, new_value: &str) -> UserImportSshPublicKeyCall<'a, C> {
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> UserImportSshPublicKeyCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> UserImportSshPublicKeyCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> UserImportSshPublicKeyCall<'a, C> {
        self._scopes.clear();
        self
    }
}
