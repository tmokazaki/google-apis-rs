...
The [delegate trait](https://docs.rs/google-networkconnectivity1/7.0.0+20240618/google_networkconnectivity1/common::Delegate) is default-implemented, allowing you to customize it with minimal effort.
