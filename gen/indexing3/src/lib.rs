...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/indexing3).
//! # Features
//!
//! Handle the following *Resources* with ease from the central [hub](Indexing) ...
//!
//! * [url notifications](api::UrlNotification)
//!  * [*get metadata*](api::UrlNotificationGetMetadataCall) and [*publish*](api::UrlNotificationPublishCall)
//!
//!
//!
//!
