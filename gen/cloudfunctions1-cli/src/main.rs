...
use google_cloudfunctions1::{api, yup_oauth2, Error};
    ...
    C: apis_common::Connector,
{
    ...
    async fn _projects_locations_functions_call(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(key, &vec!["data"]);
        ...
        let mut request: api::CallFunctionRequest = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_functions_call(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_functions_create(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                "build-environment-variables" => Some((
                ...
                "https-trigger.security-level" => Some((
                ...
                "on-deploy-update-policy.runtime-version" => Some((
                ...
                "source-repository.deployed-url" => Some((
                ...
                "vpc-connector-egress-settings" => Some((
        ...
        let mut request: api::CloudFunction = serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_functions_create(request, opt.value_of("location").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_functions_delete(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_functions_delete(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_functions_generate_download_url(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
            ...
            .iter()
        {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> = match &temp_cursor.to_string()[..]
            {
                ...
                _ => {
                    let suggestion = FieldCursor::did_you_mean(key, &vec!["version-id"]);
                    err.issues.push(CLIError::Field(FieldError::Unknown(
                        temp_cursor.to_string(),
                        suggestion,
                        value.map(|v| v.to_string()),
        ...
        let mut request: api::GenerateDownloadUrlRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_functions_generate_download_url(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_functions_generate_upload_url(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut request: api::GenerateUploadUrlRequest =
            serde_json::value::from_value(object).unwrap();
        let mut call = self
            .hub
            .projects()
            .locations_functions_generate_upload_url(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_functions_get(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_functions_get(opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
            .iter()
        {
            ...
            match key {
                "version-id" => {
                    call = call.version_id(
                        value
                            .map(|v| arg_from_str(v, err, "version-id", "int64"))
                            .unwrap_or(-0),
                    );
                }
                _ => {
    ...
    async fn _projects_locations_functions_get_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_functions_get_iam_policy(opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_functions_list(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_functions_list(opt.value_of("parent").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_functions_patch(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_functions_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_functions_set_iam_policy(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_functions_set_iam_policy(request, opt.value_of("resource").unwrap_or(""));
        for parg in opt
            .values_of("v")
            .map(|i| i.collect())
            .unwrap_or(Vec::new())
    ...
    async fn _projects_locations_functions_test_iam_permissions(
        &self,
        opt: &ArgMatches<'n>,
        dry_run: bool,
        err: &mut InvalidOptionsError,
        ...
        let mut call = self
            .hub
            .projects()
            .locations_functions_test_iam_permissions(
                request,
        ...
        match self.opt.subcommand() {
            ...
            ("projects", Some(opt)) => match opt.subcommand() {
                ("locations-functions-call", Some(opt)) => {
                    call_result = self
                        ._projects_locations_functions_call(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-functions-create", Some(opt)) => {
                    call_result = self
                        ._projects_locations_functions_create(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-functions-delete", Some(opt)) => {
                    call_result = self
                        ._projects_locations_functions_delete(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-functions-generate-download-url", Some(opt)) => {
                    call_result = self
                        ._projects_locations_functions_generate_download_url(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-functions-generate-upload-url", Some(opt)) => {
                    call_result = self
                        ._projects_locations_functions_generate_upload_url(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-functions-get", Some(opt)) => {
                    call_result = self
                        ._projects_locations_functions_get(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-functions-get-iam-policy", Some(opt)) => {
                    call_result = self
                        ._projects_locations_functions_get_iam_policy(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-functions-list", Some(opt)) => {
                    call_result = self
                        ._projects_locations_functions_list(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-functions-patch", Some(opt)) => {
                    call_result = self
                        ._projects_locations_functions_patch(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-functions-set-iam-policy", Some(opt)) => {
                    call_result = self
                        ._projects_locations_functions_set_iam_policy(opt, dry_run, &mut err)
                        .await;
                }
                ("locations-functions-test-iam-permissions", Some(opt)) => {
                    call_result = self
                        ._projects_locations_functions_test_iam_permissions(opt, dry_run, &mut err)
                        .await;
                }
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "cloudfunctions1-secret.json",
    ...
    let arg_data = [
        ("operations", "methods: 'get' and 'list'", vec![
            ...
            ("locations-functions-get",
                    Some(r##"Returns a function with the given name from the requested project."##),
                    "Details at http://byron.github.io/google-apis-rs/google_cloudfunctions1_cli/projects_locations-functions-get",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-functions-list",
                    Some(r##"Returns a list of functions that belong to the requested project."##),
                    "Details at http://byron.github.io/google-apis-rs/google_cloudfunctions1_cli/projects_locations-functions-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("locations-functions-patch",
                    Some(r##"Updates existing function."##),
                    "Details at http://byron.github.io/google-apis-rs/google_cloudfunctions1_cli/projects_locations-functions-patch",
                  vec![
                    (Some(r##"name"##),
                     None,
