...
use google_domains1_beta1::{api, yup_oauth2, Error};
    ...
    C: apis_common::Connector,
{
    ...
    async fn new(opt: ArgMatches<'n>, connector: C) -> Result<Engine<'n, C>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match common::application_secret_from_directory(&config_dir, "domains1-beta1-secret.json",
        ...
        .persist_tokens_to_disk(format!("{}/domains1-beta1", config_dir))
        .build()
        .await
        .unwrap();
